...
from ngsi_ld_models.models.subscription_fragment_on_change import SubscriptionFragmentOnChange  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestSubscriptionFragmentOnChange(unittest.TestCase):
    """SubscriptionFragmentOnChange unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SubscriptionFragmentOnChange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionFragmentOnChange`
        """
        model = ngsi_ld_models.models.subscription_fragment_on_change.SubscriptionFragmentOnChange()  # noqa: E501
        if include_optional :
            return SubscriptionFragmentOnChange(
                id = '', 
                type = 'Subscription', 
                subscription_name = '', 
                description = '', 
    ...
    def testSubscriptionFragmentOnChange(self):
        """Test SubscriptionFragmentOnChange"""
