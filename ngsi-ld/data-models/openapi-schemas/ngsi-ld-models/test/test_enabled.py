...
from ngsi_ld_models.models.enabled import Enabled  # noqa: E501
...
class TestEnabled(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `Enabled`
        """
        model = ngsi_ld_models.models.enabled.Enabled()  # noqa: E501
        if include_optional :
            return Enabled(
                type = 'Property', 
                value = True, 
