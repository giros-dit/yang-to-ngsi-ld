...
from ngsi_ld_models.models.geo_property_input import GeoPropertyInput  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestGeoPropertyInput(unittest.TestCase):
    """GeoPropertyInput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GeoPropertyInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoPropertyInput`
        """
        model = ngsi_ld_models.models.geo_property_input.GeoPropertyInput()  # noqa: E501
        if include_optional :
            return GeoPropertyInput(
                type = 'GeoProperty', 
                value = None, 
