...
from ngsi_ld_models.models.name_all_of import NameAllOf  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestNameAllOf(unittest.TestCase):
    """NameAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `NameAllOf`
        """
        model = ngsi_ld_models.models.name_all_of.NameAllOf()  # noqa: E501
        if include_optional :
            return NameAllOf(
                value = ''
            )
