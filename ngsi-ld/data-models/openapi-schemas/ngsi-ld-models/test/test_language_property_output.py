...
from ngsi_ld_models.models.language_property_output import LanguagePropertyOutput  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestLanguagePropertyOutput(unittest.TestCase):
    """LanguagePropertyOutput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test LanguagePropertyOutput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LanguagePropertyOutput`
        """
        model = ngsi_ld_models.models.language_property_output.LanguagePropertyOutput()  # noqa: E501
        if include_optional :
            return LanguagePropertyOutput(
    ...
    def testLanguagePropertyOutput(self):
        """Test LanguagePropertyOutput"""
