...
from ngsi_ld_models.models.query_temporal_all_of import QueryTemporalAllOf  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestQueryTemporalAllOf(unittest.TestCase):
    """QueryTemporalAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test QueryTemporalAllOf
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryTemporalAllOf`
        """
        model = ngsi_ld_models.models.query_temporal_all_of.QueryTemporalAllOf()  # noqa: E501
        if include_optional :
            return QueryTemporalAllOf(
    ...
    def testQueryTemporalAllOf(self):
        """Test QueryTemporalAllOf"""
