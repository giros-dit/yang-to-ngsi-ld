...
from ngsi_ld_models.models.entity_input import EntityInput  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestEntityInput(unittest.TestCase):
    """EntityInput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `EntityInput`
        """
        model = ngsi_ld_models.models.entity_input.EntityInput()  # noqa: E501
        if include_optional :
            return EntityInput(
                id = '', 
                type = '', 
