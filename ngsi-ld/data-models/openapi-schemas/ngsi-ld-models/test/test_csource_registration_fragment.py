...
from ngsi_ld_models.models.csource_registration_fragment import CsourceRegistrationFragment  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestCsourceRegistrationFragment(unittest.TestCase):
    """CsourceRegistrationFragment unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CsourceRegistrationFragment
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CsourceRegistrationFragment`
        """
        model = ngsi_ld_models.models.csource_registration_fragment.CsourceRegistrationFragment()  # noqa: E501
        if include_optional :
            return CsourceRegistrationFragment(
                id = '', 
    ...
    def testCsourceRegistrationFragment(self):
        """Test CsourceRegistrationFragment"""
