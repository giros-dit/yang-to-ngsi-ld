...
from ngsi_ld_models.models.geo_property_common import GeoPropertyCommon  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestGeoPropertyCommon(unittest.TestCase):
    """GeoPropertyCommon unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GeoPropertyCommon
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GeoPropertyCommon`
        """
        model = ngsi_ld_models.models.geo_property_common.GeoPropertyCommon()  # noqa: E501
        if include_optional :
            return GeoPropertyCommon(
                type = 'GeoProperty', 
                value = None, 
    ...
    def testGeoPropertyCommon(self):
        """Test GeoPropertyCommon"""
