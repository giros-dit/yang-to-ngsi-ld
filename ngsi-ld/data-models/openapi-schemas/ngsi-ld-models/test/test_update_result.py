...
from ngsi_ld_models.models.update_result import UpdateResult  # noqa: E501
...
class TestUpdateResult(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = ngsi_ld_models.models.update_result.UpdateResult()  # noqa: E501
        if include_optional :
            return UpdateResult(
                updated = [
                    ''
                ...
                not_updated = [
                    ngsi_ld_models.models.not_updated_details.NotUpdatedDetails(
                        attribute_name = '', 
                        reason = '', 
                        registration_id = '', )
                    ]
