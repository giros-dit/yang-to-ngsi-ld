...
from ngsi_ld_models.models.subscription_fragment_periodic import SubscriptionFragmentPeriodic  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestSubscriptionFragmentPeriodic(unittest.TestCase):
    """SubscriptionFragmentPeriodic unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test SubscriptionFragmentPeriodic
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionFragmentPeriodic`
        """
        model = ngsi_ld_models.models.subscription_fragment_periodic.SubscriptionFragmentPeriodic()  # noqa: E501
        if include_optional :
            return SubscriptionFragmentPeriodic(
                id = '', 
                type = 'Subscription', 
                subscription_name = '', 
                description = '', 
    ...
    def testSubscriptionFragmentPeriodic(self):
        """Test SubscriptionFragmentPeriodic"""
