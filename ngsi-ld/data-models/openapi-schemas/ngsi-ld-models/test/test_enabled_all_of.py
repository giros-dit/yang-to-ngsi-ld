...
from ngsi_ld_models.models.enabled_all_of import EnabledAllOf  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestEnabledAllOf(unittest.TestCase):
    """EnabledAllOf unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # uncomment below to create an instance of `EnabledAllOf`
        """
        model = ngsi_ld_models.models.enabled_all_of.EnabledAllOf()  # noqa: E501
        if include_optional :
            return EnabledAllOf(
                value = True
            )
