...
from ngsi_ld_models.models.query_entity_georel_parameter import QueryEntityGeorelParameter  # noqa: E501
...
class TestQueryEntityGeorelParameter(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        """Test QueryEntityGeorelParameter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueryEntityGeorelParameter`
        """
        model = ngsi_ld_models.models.query_entity_georel_parameter.QueryEntityGeorelParameter()  # noqa: E501
        if include_optional :
    ...
    def testQueryEntityGeorelParameter(self):
        """Test QueryEntityGeorelParameter"""
