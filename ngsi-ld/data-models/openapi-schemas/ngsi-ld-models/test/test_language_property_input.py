...
from ngsi_ld_models.models.language_property_input import LanguagePropertyInput  # noqa: E501
from ngsi_ld_models.rest import ApiException

class TestLanguagePropertyInput(unittest.TestCase):
    """LanguagePropertyInput unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test LanguagePropertyInput
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LanguagePropertyInput`
        """
        model = ngsi_ld_models.models.language_property_input.LanguagePropertyInput()  # noqa: E501
        if include_optional :
            return LanguagePropertyInput(
    ...
    def testLanguagePropertyInput(self):
        """Test LanguagePropertyInput"""
