...
class QueryTemporal200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryTemporal200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryTemporal200Response:
        """Create an instance of QueryTemporal200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryTemporal200Response.parse_obj(obj)

        _obj = QueryTemporal200Response.parse_obj({
