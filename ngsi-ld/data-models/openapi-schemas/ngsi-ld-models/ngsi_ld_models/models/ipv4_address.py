...
class Ipv4Address(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='Ipv4Address', description="NGSI-LD Entity identifier. It has to be Ipv4Address.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Ipv4Address'):
            raise ValueError("must be one of enum values ('Ipv4Address')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Ipv4Address',
