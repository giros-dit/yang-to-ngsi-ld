...
class RetrieveTemporal200Response(BaseModel):
    """
    ...
    __properties = ["@context", "id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetrieveTemporal200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetrieveTemporal200Response:
        """Create an instance of RetrieveTemporal200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetrieveTemporal200Response.parse_obj(obj)

        _obj = RetrieveTemporal200Response.parse_obj({
