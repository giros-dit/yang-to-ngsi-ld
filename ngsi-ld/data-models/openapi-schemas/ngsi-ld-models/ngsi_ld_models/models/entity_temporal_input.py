...
class EntityTemporalInput(BaseModel):
    """
    EntityTemporalInput
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityTemporalInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityTemporalInput:
        """Create an instance of EntityTemporalInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityTemporalInput.parse_obj(obj)

        _obj = EntityTemporalInput.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
