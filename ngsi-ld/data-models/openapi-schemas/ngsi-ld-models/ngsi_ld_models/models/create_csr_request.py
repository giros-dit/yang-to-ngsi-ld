...
class CreateCSRRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCSRRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCSRRequest:
        """Create an instance of CreateCSRRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCSRRequest.parse_obj(obj)

        _obj = CreateCSRRequest.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
