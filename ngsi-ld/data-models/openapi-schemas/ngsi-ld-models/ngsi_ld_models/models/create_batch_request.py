...
class CreateBatchRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBatchRequest:
        """Create an instance of CreateBatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBatchRequest.parse_obj(obj)

        _obj = CreateBatchRequest.parse_obj({
