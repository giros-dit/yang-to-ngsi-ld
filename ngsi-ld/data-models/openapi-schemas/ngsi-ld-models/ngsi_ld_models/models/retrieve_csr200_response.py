...
class RetrieveCSR200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetrieveCSR200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetrieveCSR200Response:
        """Create an instance of RetrieveCSR200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetrieveCSR200Response.parse_obj(obj)

        _obj = RetrieveCSR200Response.parse_obj({
