...
class OutErrors(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutErrors:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutErrors:
        """Create an instance of OutErrors from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutErrors.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OutErrors) in the input: " + obj)

        _obj = OutErrors.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
