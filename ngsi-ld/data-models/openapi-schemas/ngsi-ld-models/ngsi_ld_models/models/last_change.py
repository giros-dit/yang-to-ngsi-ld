...
class LastChange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LastChange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LastChange:
        """Create an instance of LastChange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LastChange.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LastChange) in the input: " + obj)

        _obj = LastChange.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
