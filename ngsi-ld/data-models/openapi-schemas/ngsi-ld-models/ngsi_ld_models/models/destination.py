...
class Destination(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='Destination', description="NGSI-LD Entity identifier. It has to be Destination.")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Destination',
