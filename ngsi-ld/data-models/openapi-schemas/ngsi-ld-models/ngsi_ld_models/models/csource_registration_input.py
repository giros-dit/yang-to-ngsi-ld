...
class CsourceRegistrationInput(BaseModel):
    """
    ...
    information: conlist(RegistrationInfo, min_items=1) = Field(..., description="Describes the Entities, Properties and Relationships for which the Context Source may be able to provide information. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CsourceRegistrationInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CsourceRegistrationInput:
        """Create an instance of CsourceRegistrationInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CsourceRegistrationInput.parse_obj(obj)

        _obj = CsourceRegistrationInput.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
