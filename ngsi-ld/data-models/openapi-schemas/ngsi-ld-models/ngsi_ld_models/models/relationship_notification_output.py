...
class RelationshipNotificationOutput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipNotificationOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipNotificationOutput:
        """Create an instance of RelationshipNotificationOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipNotificationOutput.parse_obj(obj)

        _obj = RelationshipNotificationOutput.parse_obj({
            "type": obj.get("type"),
