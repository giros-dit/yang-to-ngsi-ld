...
class QueryTemporalAllOf(BaseModel):
    """
    QueryTemporalAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryTemporalAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryTemporalAllOf:
        """Create an instance of QueryTemporalAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryTemporalAllOf.parse_obj(obj)
