...
class LanguagePropertyCommon(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguagePropertyCommon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanguagePropertyCommon:
        """Create an instance of LanguagePropertyCommon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LanguagePropertyCommon.parse_obj(obj)

        _obj = LanguagePropertyCommon.parse_obj({
            "type": obj.get("type"),
