...
class CsourceRegistrationOutputAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CsourceRegistrationOutputAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CsourceRegistrationOutputAllOf:
        """Create an instance of CsourceRegistrationOutputAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CsourceRegistrationOutputAllOf.parse_obj(obj)

        _obj = CsourceRegistrationOutputAllOf.parse_obj({
