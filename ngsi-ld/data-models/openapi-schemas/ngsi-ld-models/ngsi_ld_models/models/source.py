...
class Source(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='Source', description="NGSI-LD Entity identifier. It has to be Source.")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Source',
