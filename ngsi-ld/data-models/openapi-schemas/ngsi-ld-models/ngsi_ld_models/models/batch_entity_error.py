...
class BatchEntityError(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BatchEntityError:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BatchEntityError:
        """Create an instance of BatchEntityError from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BatchEntityError.parse_obj(obj)

        _obj = BatchEntityError.parse_obj({
