...
class EnabledAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EnabledAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EnabledAllOf:
        """Create an instance of EnabledAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EnabledAllOf.parse_obj(obj)

        _obj = EnabledAllOf.parse_obj({
            "value": obj.get("value")
        })
