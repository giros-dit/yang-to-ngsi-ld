...
class TerminationPoint(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='TerminationPoint', description="NGSI-LD Entity identifier. It has to be TerminationPoint.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('TerminationPoint'):
            raise ValueError("must be one of enum values ('TerminationPoint')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'TerminationPoint',
            ...
            "tpId": TpId.from_dict(obj.get("tpId")) if obj.get("tpId") is not None else None,
