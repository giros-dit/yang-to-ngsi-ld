...
class Ipv6Neighbor(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='Ipv6Neighbor', description="NGSI-LD Entity identifier. It has to be Ipv6Neighbor.")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('Ipv6Neighbor'):
            raise ValueError("must be one of enum values ('Ipv6Neighbor')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Ipv6Neighbor',
