...
class ListContexts200Response1OneOf(BaseModel):
    """
    ListContexts200Response1OneOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListContexts200Response1OneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListContexts200Response1OneOf:
        """Create an instance of ListContexts200Response1OneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ListContexts200Response1OneOf.parse_obj(obj)

        _obj = ListContexts200Response1OneOf.parse_obj({
