...
class PhysAddressAllOf(BaseModel):
    """
    PhysAddressAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysAddressAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysAddressAllOf:
        """Create an instance of PhysAddressAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhysAddressAllOf.parse_obj(obj)

        _obj = PhysAddressAllOf.parse_obj({
            "value": obj.get("value")
        })
