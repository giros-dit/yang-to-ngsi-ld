...
class Enabled(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Enabled:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Enabled:
        """Create an instance of Enabled from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Enabled.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Enabled) in the input: " + obj)

        _obj = Enabled.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
