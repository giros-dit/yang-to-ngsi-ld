...
class IfIndex(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IfIndex:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IfIndex:
        """Create an instance of IfIndex from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IfIndex.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in IfIndex) in the input: " + obj)

        _obj = IfIndex.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
