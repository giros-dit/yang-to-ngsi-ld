...
class QuerySubscription200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QuerySubscription200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QuerySubscription200Response:
        """Create an instance of QuerySubscription200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QuerySubscription200Response.parse_obj(obj)

        _obj = QuerySubscription200Response.parse_obj({
