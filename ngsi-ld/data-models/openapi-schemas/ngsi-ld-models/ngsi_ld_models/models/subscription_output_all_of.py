...
class SubscriptionOutputAllOf(BaseModel):
    """
    ...
    __properties = ["createdAt", "modifiedAt", "deletedAt", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionOutputAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionOutputAllOf:
        """Create an instance of SubscriptionOutputAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionOutputAllOf.parse_obj(obj)

        _obj = SubscriptionOutputAllOf.parse_obj({
