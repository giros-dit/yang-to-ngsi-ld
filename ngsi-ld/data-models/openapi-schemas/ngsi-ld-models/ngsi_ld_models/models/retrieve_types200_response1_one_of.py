...
class RetrieveTypes200Response1OneOf(BaseModel):
    """
    RetrieveTypes200Response1OneOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetrieveTypes200Response1OneOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetrieveTypes200Response1OneOf:
        """Create an instance of RetrieveTypes200Response1OneOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetrieveTypes200Response1OneOf.parse_obj(obj)

        _obj = RetrieveTypes200Response1OneOf.parse_obj({
