...
class LanguagePropertyNotificationOutputAllOf(BaseModel):
    """
    LanguagePropertyNotificationOutputAllOf
    """
    ...
    __properties = ["previousLanguageMap"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguagePropertyNotificationOutputAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanguagePropertyNotificationOutputAllOf:
        """Create an instance of LanguagePropertyNotificationOutputAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LanguagePropertyNotificationOutputAllOf.parse_obj(obj)

        _obj = LanguagePropertyNotificationOutputAllOf.parse_obj({
