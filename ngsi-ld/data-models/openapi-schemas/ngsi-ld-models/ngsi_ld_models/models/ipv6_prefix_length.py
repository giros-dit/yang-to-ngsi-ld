...
class Ipv6PrefixLength(BaseModel):
    """
    The length of the IPv6 subnet prefix.   # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Ipv6PrefixLength) in the input: " + _key)
