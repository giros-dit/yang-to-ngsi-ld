...
class QueryEntity200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryEntity200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryEntity200Response:
        """Create an instance of QueryEntity200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryEntity200Response.parse_obj(obj)
