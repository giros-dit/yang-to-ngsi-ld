...
class PropertyCommon(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PropertyCommon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PropertyCommon:
        """Create an instance of PropertyCommon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PropertyCommon.parse_obj(obj)

        _obj = PropertyCommon.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
