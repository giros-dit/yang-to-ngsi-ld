...
class TemporalQueryBatchRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TemporalQueryBatchRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TemporalQueryBatchRequest:
        """Create an instance of TemporalQueryBatchRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TemporalQueryBatchRequest.parse_obj(obj)

        _obj = TemporalQueryBatchRequest.parse_obj({
            "type": obj.get("type"),
