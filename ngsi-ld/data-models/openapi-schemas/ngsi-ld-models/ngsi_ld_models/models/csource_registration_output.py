...
class CsourceRegistrationOutput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CsourceRegistrationOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CsourceRegistrationOutput:
        """Create an instance of CsourceRegistrationOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CsourceRegistrationOutput.parse_obj(obj)

        _obj = CsourceRegistrationOutput.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
