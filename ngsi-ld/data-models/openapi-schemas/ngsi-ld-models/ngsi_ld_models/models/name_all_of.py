...
class NameAllOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NameAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NameAllOf:
        """Create an instance of NameAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NameAllOf.parse_obj(obj)

        _obj = NameAllOf.parse_obj({
            "value": obj.get("value")
        })
