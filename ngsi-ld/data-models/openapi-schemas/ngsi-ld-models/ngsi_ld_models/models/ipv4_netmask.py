...
class Ipv4Netmask(BaseModel):
    """
    The IPv4 subnet specified as a netmask.   # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Ipv4Netmask) in the input: " + _key)
