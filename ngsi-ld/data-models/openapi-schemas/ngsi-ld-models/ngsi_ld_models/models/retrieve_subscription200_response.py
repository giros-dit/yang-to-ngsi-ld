...
class RetrieveSubscription200Response(BaseModel):
    """
    ...
    __properties = ["@context", "id", "type", "subscriptionName", "description", "entities", "notificationTrigger", "q", "geoQ", "csf", "isActive", "notification", "expiresAt", "temporalQ", "scopeQ", "lang", "timeInterval", "watchedAttributes", "throttling", "createdAt", "modifiedAt", "deletedAt", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetrieveSubscription200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetrieveSubscription200Response:
        """Create an instance of RetrieveSubscription200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetrieveSubscription200Response.parse_obj(obj)

        _obj = RetrieveSubscription200Response.parse_obj({
