...
class GeoPropertyOutput(BaseModel):
    """
    GeoPropertyOutput
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeoPropertyOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeoPropertyOutput:
        """Create an instance of GeoPropertyOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeoPropertyOutput.parse_obj(obj)

        _obj = GeoPropertyOutput.parse_obj({
            "type": obj.get("type"),
