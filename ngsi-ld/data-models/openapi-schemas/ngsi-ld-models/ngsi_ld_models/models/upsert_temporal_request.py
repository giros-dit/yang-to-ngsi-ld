...
class UpsertTemporalRequest(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpsertTemporalRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpsertTemporalRequest:
        """Create an instance of UpsertTemporalRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpsertTemporalRequest.parse_obj(obj)

        _obj = UpsertTemporalRequest.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
