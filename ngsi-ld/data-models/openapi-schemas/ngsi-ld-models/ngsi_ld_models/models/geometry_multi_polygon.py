...
class GeometryMultiPolygon(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeometryMultiPolygon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeometryMultiPolygon:
        """Create an instance of GeometryMultiPolygon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeometryMultiPolygon.parse_obj(obj)

        _obj = GeometryMultiPolygon.parse_obj({
            "type": obj.get("type"),
