...
class GeometryLineString(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeometryLineString:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeometryLineString:
        """Create an instance of GeometryLineString from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeometryLineString.parse_obj(obj)

        _obj = GeometryLineString.parse_obj({
            "type": obj.get("type"),
