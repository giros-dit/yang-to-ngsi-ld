...
class Speed(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Speed:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Speed:
        """Create an instance of Speed from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Speed.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Speed) in the input: " + obj)

        _obj = Speed.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
