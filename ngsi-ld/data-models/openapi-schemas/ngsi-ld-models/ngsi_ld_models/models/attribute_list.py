...
class AttributeList(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AttributeList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AttributeList:
        """Create an instance of AttributeList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AttributeList.parse_obj(obj)

        _obj = AttributeList.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
