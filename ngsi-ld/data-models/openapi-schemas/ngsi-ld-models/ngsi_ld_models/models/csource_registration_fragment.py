...
class CsourceRegistrationFragment(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CsourceRegistrationFragment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CsourceRegistrationFragment:
        """Create an instance of CsourceRegistrationFragment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CsourceRegistrationFragment.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CsourceRegistrationFragment) in the input: " + obj)

        _obj = CsourceRegistrationFragment.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
