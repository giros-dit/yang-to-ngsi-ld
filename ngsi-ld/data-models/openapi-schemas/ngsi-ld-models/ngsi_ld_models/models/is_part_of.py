...
class IsPartOf(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IsPartOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IsPartOf:
        """Create an instance of IsPartOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IsPartOf.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in IsPartOf) in the input: " + obj)

        _obj = IsPartOf.parse_obj({
            "type": obj.get("type"),
