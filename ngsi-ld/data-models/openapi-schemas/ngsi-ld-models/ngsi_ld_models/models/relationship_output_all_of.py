...
class RelationshipOutputAllOf(BaseModel):
    """
    ...
    __properties = ["createdAt", "modifiedAt", "deletedAt", "instanceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipOutputAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipOutputAllOf:
        """Create an instance of RelationshipOutputAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipOutputAllOf.parse_obj(obj)

        _obj = RelationshipOutputAllOf.parse_obj({
