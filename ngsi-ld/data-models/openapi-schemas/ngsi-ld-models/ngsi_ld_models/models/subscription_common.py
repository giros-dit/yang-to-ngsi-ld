...
class SubscriptionCommon(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionCommon:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionCommon:
        """Create an instance of SubscriptionCommon from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionCommon.parse_obj(obj)

        _obj = SubscriptionCommon.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
