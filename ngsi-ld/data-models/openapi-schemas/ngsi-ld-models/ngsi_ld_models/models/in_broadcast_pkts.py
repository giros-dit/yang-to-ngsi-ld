...
class InBroadcastPkts(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InBroadcastPkts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InBroadcastPkts:
        """Create an instance of InBroadcastPkts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InBroadcastPkts.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InBroadcastPkts) in the input: " + obj)

        _obj = InBroadcastPkts.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
