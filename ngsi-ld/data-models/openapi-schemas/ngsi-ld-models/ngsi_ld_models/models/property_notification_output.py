...
class PropertyNotificationOutput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PropertyNotificationOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PropertyNotificationOutput:
        """Create an instance of PropertyNotificationOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PropertyNotificationOutput.parse_obj(obj)

        _obj = PropertyNotificationOutput.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
