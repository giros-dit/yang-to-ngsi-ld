...
class SubscriptionFragmentPeriodic(BaseModel):
    """
    ...
    entities: Optional[conlist(EntitySelector, min_items=1)] = Field(None, description="Entities subscribed. ")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionFragmentPeriodic:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionFragmentPeriodic:
        """Create an instance of SubscriptionFragmentPeriodic from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionFragmentPeriodic.parse_obj(obj)

        _obj = SubscriptionFragmentPeriodic.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
