...
class Ipv4(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='Ipv4', description="NGSI-LD Entity identifier. It has to be Ipv4.")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Ipv4',
