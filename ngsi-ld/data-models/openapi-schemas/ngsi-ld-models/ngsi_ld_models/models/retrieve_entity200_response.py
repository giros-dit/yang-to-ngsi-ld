...
class RetrieveEntity200Response(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetrieveEntity200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetrieveEntity200Response:
        """Create an instance of RetrieveEntity200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetrieveEntity200Response.parse_obj(obj)
