...
class OutMulticastPkts(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutMulticastPkts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutMulticastPkts:
        """Create an instance of OutMulticastPkts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutMulticastPkts.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OutMulticastPkts) in the input: " + obj)

        _obj = OutMulticastPkts.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
