...
class RetrieveContext200Response(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RetrieveContext200Response:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RetrieveContext200Response:
        """Create an instance of RetrieveContext200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RetrieveContext200Response.parse_obj(obj)

        _obj = RetrieveContext200Response.parse_obj({
