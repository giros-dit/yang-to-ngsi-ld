...
class OutUnicastPkts(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutUnicastPkts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutUnicastPkts:
        """Create an instance of OutUnicastPkts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutUnicastPkts.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OutUnicastPkts) in the input: " + obj)

        _obj = OutUnicastPkts.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
