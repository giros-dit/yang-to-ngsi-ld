...
class NetworkLinkDestination(BaseModel):
    """
    NGSI-LD Entity Type that represents the logical source of a particular link.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='NetworkLinkDestination', description="NGSI-LD Entity identifier. It has to be NetworkLinkDestination.")
    ...
    dest_node: DestNode = Field(alias="destNode")
    dest_tp: DestTp = Field(alias="destTp")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "destNode": DestNode.from_dict(obj.get("destNode")) if obj.get("destNode") is not None else None,
            "destTp": DestTp.from_dict(obj.get("destTp")) if obj.get("destTp") is not None else None,
