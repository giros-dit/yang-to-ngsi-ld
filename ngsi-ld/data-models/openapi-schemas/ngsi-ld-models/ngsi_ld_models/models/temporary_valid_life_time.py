...
class TemporaryValidLifeTime(BaseModel):
    """
    The time period during which the temporary address is valid.   # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in TemporaryValidLifeTime) in the input: " + _key)
