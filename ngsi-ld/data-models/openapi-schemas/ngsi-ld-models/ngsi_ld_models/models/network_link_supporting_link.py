...
class NetworkLinkSupportingLink(BaseModel):
    """
    NGSI-LD Entity Type that identifies the underlay link or links on which this link depends.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='NetworkLinkSupportingLink', description="NGSI-LD Entity identifier. It has to be NetworkLinkSupportingLink.")
    ...
    link_ref: LinkRef = Field(alias="linkRef")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "linkRef": LinkRef.from_dict(obj.get("linkRef")) if obj.get("linkRef") is not None else None,
