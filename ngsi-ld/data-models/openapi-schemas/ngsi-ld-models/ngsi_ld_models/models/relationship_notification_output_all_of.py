...
class RelationshipNotificationOutputAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipNotificationOutputAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipNotificationOutputAllOf:
        """Create an instance of RelationshipNotificationOutputAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipNotificationOutputAllOf.parse_obj(obj)

        _obj = RelationshipNotificationOutputAllOf.parse_obj({
