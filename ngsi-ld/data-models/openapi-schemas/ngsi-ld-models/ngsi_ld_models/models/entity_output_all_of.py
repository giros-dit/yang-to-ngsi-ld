...
class EntityOutputAllOf(BaseModel):
    """
    EntityOutputAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EntityOutputAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EntityOutputAllOf:
        """Create an instance of EntityOutputAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EntityOutputAllOf.parse_obj(obj)

        _obj = EntityOutputAllOf.parse_obj({
