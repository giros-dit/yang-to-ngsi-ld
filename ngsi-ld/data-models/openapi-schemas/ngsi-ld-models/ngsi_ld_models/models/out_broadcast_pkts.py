...
class OutBroadcastPkts(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutBroadcastPkts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutBroadcastPkts:
        """Create an instance of OutBroadcastPkts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutBroadcastPkts.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OutBroadcastPkts) in the input: " + obj)

        _obj = OutBroadcastPkts.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
