...
class InUnicastPkts(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InUnicastPkts:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InUnicastPkts:
        """Create an instance of InUnicastPkts from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InUnicastPkts.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InUnicastPkts) in the input: " + obj)

        _obj = InUnicastPkts.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
