...
class QueryEntity200ResponseAllOf(BaseModel):
    """
    QueryEntity200ResponseAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueryEntity200ResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueryEntity200ResponseAllOf:
        """Create an instance of QueryEntity200ResponseAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueryEntity200ResponseAllOf.parse_obj(obj)

        _obj = QueryEntity200ResponseAllOf.parse_obj({
