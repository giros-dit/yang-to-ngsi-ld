...
class LinkUpDownTrapEnable(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LinkUpDownTrapEnable:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LinkUpDownTrapEnable:
        """Create an instance of LinkUpDownTrapEnable from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LinkUpDownTrapEnable.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LinkUpDownTrapEnable) in the input: " + obj)

        _obj = LinkUpDownTrapEnable.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
