...
class OutOctets(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutOctets:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutOctets:
        """Create an instance of OutOctets from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutOctets.parse_obj(obj)

        # raise errors for additional fields in the input
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OutOctets) in the input: " + obj)

        _obj = OutOctets.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
