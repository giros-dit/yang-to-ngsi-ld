...
class PropertyOutputAllOf(BaseModel):
    """
    PropertyOutputAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PropertyOutputAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PropertyOutputAllOf:
        """Create an instance of PropertyOutputAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PropertyOutputAllOf.parse_obj(obj)

        _obj = PropertyOutputAllOf.parse_obj({
