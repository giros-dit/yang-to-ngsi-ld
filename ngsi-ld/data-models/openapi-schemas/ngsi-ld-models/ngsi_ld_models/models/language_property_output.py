...
class LanguagePropertyOutput(BaseModel):
    """
    ...
    __properties = ["type", "languageMap", "observedAt", "datasetId", "createdAt", "modifiedAt", "deletedAt", "instanceId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LanguagePropertyOutput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LanguagePropertyOutput:
        """Create an instance of LanguagePropertyOutput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LanguagePropertyOutput.parse_obj(obj)

        _obj = LanguagePropertyOutput.parse_obj({
            "type": obj.get("type"),
