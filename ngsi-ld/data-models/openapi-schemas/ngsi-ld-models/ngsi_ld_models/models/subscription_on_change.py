...
class SubscriptionOnChange(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionOnChange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionOnChange:
        """Create an instance of SubscriptionOnChange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionOnChange.parse_obj(obj)

        _obj = SubscriptionOnChange.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
