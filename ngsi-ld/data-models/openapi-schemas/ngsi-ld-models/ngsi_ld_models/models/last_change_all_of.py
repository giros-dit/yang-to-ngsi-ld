...
class LastChangeAllOf(BaseModel):
    """
    LastChangeAllOf
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LastChangeAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LastChangeAllOf:
        """Create an instance of LastChangeAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LastChangeAllOf.parse_obj(obj)

        _obj = LastChangeAllOf.parse_obj({
            "value": obj.get("value")
        })
