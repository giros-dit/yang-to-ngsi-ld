...
class GeoPropertyInput(BaseModel):
    """
    GeoPropertyInput
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeoPropertyInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeoPropertyInput:
        """Create an instance of GeoPropertyInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeoPropertyInput.parse_obj(obj)

        _obj = GeoPropertyInput.parse_obj({
            "type": obj.get("type"),
