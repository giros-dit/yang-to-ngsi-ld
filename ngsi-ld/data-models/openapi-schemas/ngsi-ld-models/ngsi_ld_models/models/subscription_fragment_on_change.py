...
class SubscriptionFragmentOnChange(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SubscriptionFragmentOnChange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SubscriptionFragmentOnChange:
        """Create an instance of SubscriptionFragmentOnChange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SubscriptionFragmentOnChange.parse_obj(obj)

        _obj = SubscriptionFragmentOnChange.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
