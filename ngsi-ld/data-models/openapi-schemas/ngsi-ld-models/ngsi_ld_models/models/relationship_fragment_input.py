...
class RelationshipFragmentInput(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RelationshipFragmentInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RelationshipFragmentInput:
        """Create an instance of RelationshipFragmentInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RelationshipFragmentInput.parse_obj(obj)

        _obj = RelationshipFragmentInput.parse_obj({
            "type": obj.get("type"),
