...
class PropertyNotificationOutputAllOf(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PropertyNotificationOutputAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PropertyNotificationOutputAllOf:
        """Create an instance of PropertyNotificationOutputAllOf from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PropertyNotificationOutputAllOf.parse_obj(obj)
