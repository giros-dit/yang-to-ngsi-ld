...
class PropertyFragmentInput(BaseModel):
    """
    PropertyFragmentInput
    """
    type: Optional[StrictStr] = Field(None, description="Node type. ")
    value: Optional[Any] = Field(None, description="Any JSON value as defined by IETF RFC 8259.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PropertyFragmentInput:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PropertyFragmentInput:
        """Create an instance of PropertyFragmentInput from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PropertyFragmentInput.parse_obj(obj)

        _obj = PropertyFragmentInput.parse_obj({
            "type": obj.get("type"),
            "value": obj.get("value"),
