...
```python
from ngsi_ld_models.models.subscription_output import SubscriptionOutput

# TODO update the JSON string below
json = "{}"
# create an instance of SubscriptionOutput from a JSON string
subscription_output_instance = SubscriptionOutput.from_json(json)
# print the JSON string representation of the object
print SubscriptionOutput.to_json()

# convert the object into a dict
subscription_output_dict = subscription_output_instance.to_dict()
# create an instance of SubscriptionOutput from a dict
subscription_output_form_dict = subscription_output.from_dict(subscription_output_dict)
```
