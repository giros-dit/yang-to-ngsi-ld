...
```python
from ngsi_ld_models.models.subscription_fragment import SubscriptionFragment

# TODO update the JSON string below
json = "{}"
# create an instance of SubscriptionFragment from a JSON string
subscription_fragment_instance = SubscriptionFragment.from_json(json)
# print the JSON string representation of the object
print SubscriptionFragment.to_json()

# convert the object into a dict
subscription_fragment_dict = subscription_fragment_instance.to_dict()
# create an instance of SubscriptionFragment from a dict
subscription_fragment_form_dict = subscription_fragment.from_dict(subscription_fragment_dict)
```
