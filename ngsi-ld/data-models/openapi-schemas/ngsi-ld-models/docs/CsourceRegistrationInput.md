...
json = "{}"
# create an instance of CsourceRegistrationInput from a JSON string
csource_registration_input_instance = CsourceRegistrationInput.from_json(json)
# print the JSON string representation of the object
print CsourceRegistrationInput.to_json()

# convert the object into a dict
csource_registration_input_dict = csource_registration_input_instance.to_dict()
# create an instance of CsourceRegistrationInput from a dict
csource_registration_input_form_dict = csource_registration_input.from_dict(csource_registration_input_dict)
```
