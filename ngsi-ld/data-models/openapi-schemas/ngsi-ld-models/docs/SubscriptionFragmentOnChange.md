...
```python
from ngsi_ld_models.models.subscription_fragment_on_change import SubscriptionFragmentOnChange

# TODO update the JSON string below
json = "{}"
# create an instance of SubscriptionFragmentOnChange from a JSON string
subscription_fragment_on_change_instance = SubscriptionFragmentOnChange.from_json(json)
# print the JSON string representation of the object
print SubscriptionFragmentOnChange.to_json()

# convert the object into a dict
subscription_fragment_on_change_dict = subscription_fragment_on_change_instance.to_dict()
# create an instance of SubscriptionFragmentOnChange from a dict
subscription_fragment_on_change_form_dict = subscription_fragment_on_change.from_dict(subscription_fragment_on_change_dict)
```
