...
```python
from ngsi_ld_models.models.subscription_fragment_periodic import SubscriptionFragmentPeriodic

# TODO update the JSON string below
json = "{}"
# create an instance of SubscriptionFragmentPeriodic from a JSON string
subscription_fragment_periodic_instance = SubscriptionFragmentPeriodic.from_json(json)
# print the JSON string representation of the object
print SubscriptionFragmentPeriodic.to_json()

# convert the object into a dict
subscription_fragment_periodic_dict = subscription_fragment_periodic_instance.to_dict()
# create an instance of SubscriptionFragmentPeriodic from a dict
subscription_fragment_periodic_form_dict = subscription_fragment_periodic.from_dict(subscription_fragment_periodic_dict)
```
