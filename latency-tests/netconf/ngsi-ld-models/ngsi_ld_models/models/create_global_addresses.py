...
class CreateGlobalAddresses(BaseModel):
    """
    If enabled, the host creates global addresses.   # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateGlobalAddresses) in the input: " + _key)
