...
class SubscriptionCommon(BaseModel):
    """
    5.2.12 represents a Context Subscription.   # noqa: E501
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "subscriptionName", "description", "entities", "notificationTrigger", "q", "geoQ", "csf", "isActive", "notification", "expiresAt", "temporalQ", "scopeQ", "lang", "createdAt", "modifiedAt", "deletedAt", "status"]
