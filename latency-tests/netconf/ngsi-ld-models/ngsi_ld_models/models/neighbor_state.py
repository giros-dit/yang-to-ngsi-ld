...
class NeighborState(BaseModel):
    """
    NGSI-LD Property Type. The Neighbor Unreachability Detection state of this entry.  # noqa: E501
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('incomplete', 'reachable', 'stale', 'delay', 'probe'):
            raise ValueError("must be one of enum values ('incomplete', 'reachable', 'stale', 'delay', 'probe')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in NeighborState) in the input: " + _key)
