...
class NetworkLink(BaseModel):
    ...
    link_id: LinkId = Field(alias="linkId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "linkId", "isPartOf"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('NetworkLink'):
            raise ValueError("must be one of enum values ('NetworkLink')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkLink',
            ...
            "linkId": LinkId.from_dict(obj.get("linkId")) if obj.get("linkId") is not None else None,
