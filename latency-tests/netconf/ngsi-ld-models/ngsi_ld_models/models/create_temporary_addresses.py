...
class CreateTemporaryAddresses(BaseModel):
    """
    If enabled, the host creates temporary addresses.   # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in CreateTemporaryAddresses) in the input: " + _key)
