...
class NeighborOrigin(BaseModel):
    """
    NGSI-LD Property Type. The origin of this neighbor entry.  # noqa: E501
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('other', 'static', 'dynamic'):
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in NeighborOrigin) in the input: " + _key)
