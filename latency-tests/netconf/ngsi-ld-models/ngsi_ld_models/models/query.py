...
class Query(BaseModel):
    """
    5.2.23 This datatype represents the information that is required in order to convey a query when a \"Query Entities\" operation is to be performed (as pe clause 5.7.2).   # noqa: E501
    """
