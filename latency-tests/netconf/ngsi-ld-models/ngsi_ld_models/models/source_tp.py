...
class SourceTp(BaseModel):
    """
    NGSI-LD Relationship Type. Relationship to the termination point identifier.  This termination point is located within the source node and terminates the link.    # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SourceTp) in the input: " + _key)
