...
class IpEnabled(BaseModel):
    """
    Controls whether IPv4/Ipv6 is enabled or disabled on this interface. When IPv4/Ipv6  is enabled, this interface is connected to an IPv4/Ipv6  stack, and the interface can send and receive IPv4/Ipv6  packets.   # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in IpEnabled) in the input: " + _key)
