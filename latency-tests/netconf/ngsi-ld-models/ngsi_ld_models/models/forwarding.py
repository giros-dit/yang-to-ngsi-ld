...
class Forwarding(BaseModel):
    """
    Controls IPv4/Ipv6  packet forwarding of datagrams received by, but not addressed to, this interface. IPv4/Ipv6 routers forward datagrams. IPv4/Ipv6 hosts do not (except those source-routed via the host).   # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Forwarding) in the input: " + _key)
