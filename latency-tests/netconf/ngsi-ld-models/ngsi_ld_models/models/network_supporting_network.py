...
class NetworkSupportingNetwork(BaseModel):
    """
    NGSI-LD Entity Type that represents an underlay network. An underlay network, used to represent layered network topologies.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='NetworkSupportingNetwork', description="NGSI-LD Entity identifier. It has to be NetworkSupportingNetwork.")
