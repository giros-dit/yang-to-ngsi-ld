...
class DestTp(BaseModel):
    """
    NGSI-LD Relationship Type. Relationship to the termination point identifier.  This termination point is located within the destination node and terminates the link.   # noqa: E501
    """
