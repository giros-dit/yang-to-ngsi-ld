...
```python
from ngsi_ld_models.models.query_csr200_response_inner import QueryCSR200ResponseInner
...
query_csr200_response_inner_form_dict = query_csr200_response_inner.from_dict(query_csr200_response_inner_dict)
```
