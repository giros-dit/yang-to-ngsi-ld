...
class InterfaceIpv6Address(BaseModel):
    """
    NGSI-LD Entity Type that represents the IPv6 address on interfaces of a YANG model-based network device.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='InterfaceIpv6Address', description="NGSI-LD Entity identifier. It has to be InterfaceIpv6Address.")
    ...
    ip: Ipv6Ip
    prefix_length: Optional[Ipv6PrefixLength] = Field(default=None, alias="prefixLength")
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('InterfaceIpv6Address'):
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "prefixLength": Ipv6PrefixLength.from_dict(obj.get("prefixLength")) if obj.get("prefixLength") is not None else None,
