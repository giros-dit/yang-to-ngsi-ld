...
class InterfaceIpv6Neighbor(BaseModel):
    """
    NGSI-LD Entity Type that represents a list of mappings from IPv6 addresses to link-layer addresses. Entries in this list in the intended configuration are used as static entries in the Neighbor Cache. In the operational state, this list represents the Neighbor Cache.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='InterfaceIpv6Neighbor', description="NGSI-LD Entity identifier. It has to be InterfaceIpv6Neighbor.")
    ...
    is_router: Optional[IsRouter] = Field(default=None, alias="isRouter")
    state: Optional[NeighborState] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ip", "linkLayerAddress", "origin", "isRouter", "state", "isPartOf"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('InterfaceIpv6Neighbor'):
            raise ValueError("must be one of enum values ('InterfaceIpv6Neighbor')")
        return value
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceIpv6Neighbor',
            ...
            "ip": Ipv6Ip.from_dict(obj.get("ip")) if obj.get("ip") is not None else None,
            ...
            "isRouter": IsRouter.from_dict(obj.get("isRouter")) if obj.get("isRouter") is not None else None,
            "state": NeighborState.from_dict(obj.get("state")) if obj.get("state") is not None else None,
