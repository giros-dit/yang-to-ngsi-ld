...
class LinkLayerAddress(BaseModel):
    """
    NGSI-LD Property Type. The link-layer address of the neighbor node.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LinkLayerAddress) in the input: " + _key)
