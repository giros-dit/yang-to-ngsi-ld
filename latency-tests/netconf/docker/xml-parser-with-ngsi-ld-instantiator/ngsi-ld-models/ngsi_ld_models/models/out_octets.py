...
class OutOctets(BaseModel):
    """
    NGSI-LD Property Type. The total number of octets transmitted out of the interface, including framing characters.   # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in OutOctets) in the input: " + _key)
