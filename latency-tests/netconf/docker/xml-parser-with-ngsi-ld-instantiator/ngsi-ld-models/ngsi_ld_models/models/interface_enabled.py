...
class InterfaceEnabled(BaseModel):
    """
    NGSI-LD Property Type. The configured, desired state of the interface.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceEnabled) in the input: " + _key)
