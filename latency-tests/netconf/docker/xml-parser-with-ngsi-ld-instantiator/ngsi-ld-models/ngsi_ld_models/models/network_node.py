...
class NetworkNode(BaseModel):
    """
    NGSI-LD Entity Type that represents a node. The inventory of node within the network.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='NetworkNode', description="NGSI-LD Entity identifier. It has to be NetworkNode.")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "nodeId": NodeId.from_dict(obj.get("nodeId")) if obj.get("nodeId") is not None else None,
