...
class InterfaceIpv4(BaseModel):
    """
    NGSI-LD Entity Type that represents the IPv4 parameters on interfaces of a YANG model-based network device.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='InterfaceIpv4', description="NGSI-LD Entity identifier. It has to be InterfaceIpv4.")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "mtu": Ipv4Mtu.from_dict(obj.get("mtu")) if obj.get("mtu") is not None else None,
