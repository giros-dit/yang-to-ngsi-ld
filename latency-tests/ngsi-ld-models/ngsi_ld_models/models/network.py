...
class Network(BaseModel):
    """
    NGSI-LD Entity Type that represents a network. A network typically contains an inventory of nodes, topological information, and layering information.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='Network', description="NGSI-LD Entity identifier. It has to be Network.")
    ...
    network_id: NetworkId = Field(alias="networkId")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "networkId": NetworkId.from_dict(obj.get("networkId")) if obj.get("networkId") is not None else None
        })
