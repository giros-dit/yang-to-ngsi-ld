...
class TemperatureSensor(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "temperature"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('TemperatureSensor'):
            raise ValueError("must be one of enum values ('TemperatureSensor')")
        return value
