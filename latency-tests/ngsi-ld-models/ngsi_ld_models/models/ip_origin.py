...
class IpOrigin(BaseModel):
    """
    NGSI-LD Property Type. The origin of the IPv4/IPv6 address.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in IpOrigin) in the input: " + _key)
