...
```python
from ngsi_ld_models.models.create_csr_request1 import CreateCSRRequest1
...
create_csr_request1_form_dict = create_csr_request1.from_dict(create_csr_request1_dict)
```
