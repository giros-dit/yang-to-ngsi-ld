...
class TestInterfaceRoutedVlanIpv6UnnumberedStateEnabled(unittest.TestCase):
    """InterfaceRoutedVlanIpv6UnnumberedStateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6UnnumberedStateEnabled:
        """Test InterfaceRoutedVlanIpv6UnnumberedStateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6UnnumberedStateEnabled`
        """
        model = InterfaceRoutedVlanIpv6UnnumberedStateEnabled()
        if include_optional:
            return InterfaceRoutedVlanIpv6UnnumberedStateEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6UnnumberedStateEnabled(self):
        """Test InterfaceRoutedVlanIpv6UnnumberedStateEnabled"""
