...
class TestInterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface:
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface"""
