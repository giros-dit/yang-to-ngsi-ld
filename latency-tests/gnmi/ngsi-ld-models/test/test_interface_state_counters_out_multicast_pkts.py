...
class TestInterfaceStateCountersOutMulticastPkts(unittest.TestCase):
    """InterfaceStateCountersOutMulticastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersOutMulticastPkts:
        """Test InterfaceStateCountersOutMulticastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersOutMulticastPkts`
        """
        model = InterfaceStateCountersOutMulticastPkts()
        if include_optional:
            return InterfaceStateCountersOutMulticastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersOutMulticastPkts(self):
        """Test InterfaceStateCountersOutMulticastPkts"""
