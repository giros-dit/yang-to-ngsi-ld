...
class TestInterfaceRoutedVlanIpv4AddressesAddressState(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressState:
        """Test InterfaceRoutedVlanIpv4AddressesAddressState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressState`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressState()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressState(
                id = '',
                type = 'InterfaceRoutedVlanIpv4AddressesAddressState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressState(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressState"""
