...
class TestInterfaceRoutedVlanIpv6NeighborsNeighbor(unittest.TestCase):
    """InterfaceRoutedVlanIpv6NeighborsNeighbor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6NeighborsNeighbor:
        """Test InterfaceRoutedVlanIpv6NeighborsNeighbor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6NeighborsNeighbor`
        """
        model = InterfaceRoutedVlanIpv6NeighborsNeighbor()
        if include_optional:
            return InterfaceRoutedVlanIpv6NeighborsNeighbor(
                id = '',
                type = 'InterfaceRoutedVlanIpv6NeighborsNeighbor',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6NeighborsNeighbor(self):
        """Test InterfaceRoutedVlanIpv6NeighborsNeighbor"""
