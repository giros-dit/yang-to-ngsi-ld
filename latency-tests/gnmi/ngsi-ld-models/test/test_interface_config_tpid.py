...
class TestInterfaceConfigTpid(unittest.TestCase):
    """InterfaceConfigTpid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigTpid:
        """Test InterfaceConfigTpid
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigTpid`
        """
        model = InterfaceConfigTpid()
        if include_optional:
            return InterfaceConfigTpid(
                type = 'Relationship',
                object = 'urn:ngsi-ld:YANGIdentity:oc-vlan-types:TPID_0X8100',
    ...
    def testInterfaceConfigTpid(self):
        """Test InterfaceConfigTpid"""
