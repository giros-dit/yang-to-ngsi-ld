...
class TestInterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface:
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigSubinterface"""
