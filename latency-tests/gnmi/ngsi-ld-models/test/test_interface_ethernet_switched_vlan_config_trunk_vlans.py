...
class TestInterfaceEthernetSwitchedVlanConfigTrunkVlans(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanConfigTrunkVlans unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanConfigTrunkVlans:
        """Test InterfaceEthernetSwitchedVlanConfigTrunkVlans
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanConfigTrunkVlans`
        """
        model = InterfaceEthernetSwitchedVlanConfigTrunkVlans()
        if include_optional:
            return InterfaceEthernetSwitchedVlanConfigTrunkVlans(
                type = 'Property',
                value = '',
    ...
    def testInterfaceEthernetSwitchedVlanConfigTrunkVlans(self):
        """Test InterfaceEthernetSwitchedVlanConfigTrunkVlans"""
