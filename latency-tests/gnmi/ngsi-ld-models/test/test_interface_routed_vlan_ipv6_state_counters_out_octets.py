...
class TestInterfaceRoutedVlanIpv6StateCountersOutOctets(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersOutOctets:
        """Test InterfaceRoutedVlanIpv6StateCountersOutOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersOutOctets`
        """
        model = InterfaceRoutedVlanIpv6StateCountersOutOctets()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersOutOctets(self):
        """Test InterfaceRoutedVlanIpv6StateCountersOutOctets"""
