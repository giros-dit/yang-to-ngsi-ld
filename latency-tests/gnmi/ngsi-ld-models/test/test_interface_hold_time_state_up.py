...
class TestInterfaceHoldTimeStateUp(unittest.TestCase):
    """InterfaceHoldTimeStateUp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceHoldTimeStateUp:
        """Test InterfaceHoldTimeStateUp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceHoldTimeStateUp`
        """
        model = InterfaceHoldTimeStateUp()
        if include_optional:
            return InterfaceHoldTimeStateUp(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceHoldTimeStateUp(self):
        """Test InterfaceHoldTimeStateUp"""
