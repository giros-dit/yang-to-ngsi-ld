...
class TestVlanStateStatus(unittest.TestCase):
    """VlanStateStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanStateStatus:
        """Test VlanStateStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanStateStatus`
        """
        model = VlanStateStatus()
        if include_optional:
            return VlanStateStatus(
                type = 'Property',
                value = 'ACTIVE',
