...
class TestInterfaceSubinterfacesSubinterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterface:
        """Test InterfaceSubinterfacesSubinterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterface`
        """
        model = InterfaceSubinterfacesSubinterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterface(
                id = '',
                type = 'InterfaceSubinterfacesSubinterface',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterface(self):
        """Test InterfaceSubinterfacesSubinterface"""
