...
class TestInterfaceRoutedVlanIpv4StateDhcpClient(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateDhcpClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateDhcpClient:
        """Test InterfaceRoutedVlanIpv4StateDhcpClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateDhcpClient`
        """
        model = InterfaceRoutedVlanIpv4StateDhcpClient()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateDhcpClient(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv4StateDhcpClient(self):
        """Test InterfaceRoutedVlanIpv4StateDhcpClient"""
