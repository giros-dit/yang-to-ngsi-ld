...
class TestInterfaceEthernetSwitchedVlanStateTrunkVlans(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanStateTrunkVlans unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanStateTrunkVlans:
        """Test InterfaceEthernetSwitchedVlanStateTrunkVlans
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanStateTrunkVlans`
        """
        model = InterfaceEthernetSwitchedVlanStateTrunkVlans()
        if include_optional:
            return InterfaceEthernetSwitchedVlanStateTrunkVlans(
                type = 'Property',
                value = '',
    ...
    def testInterfaceEthernetSwitchedVlanStateTrunkVlans(self):
        """Test InterfaceEthernetSwitchedVlanStateTrunkVlans"""
