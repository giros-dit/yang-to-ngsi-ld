...
class TestInterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors"""
