...
class TestInterfaceEthernetStateEnableFlowControl(unittest.TestCase):
    """InterfaceEthernetStateEnableFlowControl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStateEnableFlowControl:
        """Test InterfaceEthernetStateEnableFlowControl
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStateEnableFlowControl`
        """
        model = InterfaceEthernetStateEnableFlowControl()
        if include_optional:
            return InterfaceEthernetStateEnableFlowControl(
                type = 'Property',
                value = True,
    ...
    def testInterfaceEthernetStateEnableFlowControl(self):
        """Test InterfaceEthernetStateEnableFlowControl"""
