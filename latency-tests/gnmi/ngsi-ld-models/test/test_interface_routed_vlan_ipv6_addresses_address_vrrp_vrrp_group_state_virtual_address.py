...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress(
                type = 'Property',
                value = '',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress"""
