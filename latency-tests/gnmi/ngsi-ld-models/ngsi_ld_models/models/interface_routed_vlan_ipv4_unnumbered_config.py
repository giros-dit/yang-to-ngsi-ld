...
class InterfaceRoutedVlanIpv4UnnumberedConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4UnnumberedConfig.")
    ...
    enabled: Optional[InterfaceRoutedVlanIpv4UnnumberedConfigEnabled] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4UnnumberedConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4UnnumberedConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4UnnumberedConfig',
            ...
            "enabled": InterfaceRoutedVlanIpv4UnnumberedConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
