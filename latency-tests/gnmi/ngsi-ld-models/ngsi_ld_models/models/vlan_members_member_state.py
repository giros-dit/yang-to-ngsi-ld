...
class VlanMembersMemberState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be VlanMembersMemberState.")
    ...
    interface: Optional[VlanMembersMemberStateInterface] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "interface", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('VlanMembersMemberState'):
            raise ValueError("must be one of enum values ('VlanMembersMemberState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'VlanMembersMemberState',
            ...
            "interface": VlanMembersMemberStateInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
