...
class InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroup(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroup.")
    ...
    virtual_router_id: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupVirtualRouterId] = Field(default=None, alias="virtualRouterId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "virtualRouterId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroup'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroup')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroup',
            ...
            "virtualRouterId": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupVirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
