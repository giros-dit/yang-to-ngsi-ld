...
class InterfaceRoutedVlanIpv6AddressesAddressConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6AddressesAddressConfig.")
    ...
    ip: Optional[InterfaceRoutedVlanIpv6AddressesAddressConfigIp] = None
    prefix_length: InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength = Field(alias="prefixLength")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6AddressesAddressConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6AddressesAddressConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6AddressesAddressConfig',
            ...
            "ip": InterfaceRoutedVlanIpv6AddressesAddressConfigIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
