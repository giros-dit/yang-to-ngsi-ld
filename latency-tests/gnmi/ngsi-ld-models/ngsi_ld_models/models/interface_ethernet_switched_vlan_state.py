...
class InterfaceEthernetSwitchedVlanState(BaseModel):
    """
    State variables for VLANs  YANG module: openconfig-vlan.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetSwitchedVlanState.")
    ...
    interface_mode: Optional[InterfaceEthernetSwitchedVlanStateInterfaceMode] = Field(default=None, alias="interfaceMode")
    native_vlan: Optional[InterfaceEthernetSwitchedVlanStateNativeVlan] = Field(default=None, alias="nativeVlan")
    access_vlan: Optional[InterfaceEthernetSwitchedVlanStateAccessVlan] = Field(default=None, alias="accessVlan")
    trunk_vlans: Optional[InterfaceEthernetSwitchedVlanStateTrunkVlans] = Field(default=None, alias="trunkVlans")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceEthernetSwitchedVlanState'):
            raise ValueError("must be one of enum values ('InterfaceEthernetSwitchedVlanState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetSwitchedVlanState',
            ...
            "interfaceMode": InterfaceEthernetSwitchedVlanStateInterfaceMode.from_dict(obj["interfaceMode"]) if obj.get("interfaceMode") is not None else None,
            "nativeVlan": InterfaceEthernetSwitchedVlanStateNativeVlan.from_dict(obj["nativeVlan"]) if obj.get("nativeVlan") is not None else None,
            "accessVlan": InterfaceEthernetSwitchedVlanStateAccessVlan.from_dict(obj["accessVlan"]) if obj.get("accessVlan") is not None else None,
            "trunkVlans": InterfaceEthernetSwitchedVlanStateTrunkVlans.from_dict(obj["trunkVlans"]) if obj.get("trunkVlans") is not None else None,
