...
class InterfaceEthernetConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetConfig.")
    ...
    mac_address: Optional[InterfaceEthernetConfigMacAddress] = Field(default=None, alias="macAddress")
    auto_negotiate: Optional[InterfaceEthernetConfigAutoNegotiate] = Field(default=None, alias="autoNegotiate")
    duplex_mode: Optional[InterfaceEthernetConfigDuplexMode] = Field(default=None, alias="duplexMode")
    port_speed: Optional[InterfaceEthernetConfigPortSpeed] = Field(default=None, alias="portSpeed")
    enable_flow_control: Optional[InterfaceEthernetConfigEnableFlowControl] = Field(default=None, alias="enableFlowControl")
    aggregate_id: Optional[InterfaceEthernetConfigAggregateId] = Field(default=None, alias="aggregateId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "macAddress", "autoNegotiate", "duplexMode", "portSpeed", "enableFlowControl", "aggregateId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceEthernetConfig'):
            raise ValueError("must be one of enum values ('InterfaceEthernetConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetConfig',
            ...
            "macAddress": InterfaceEthernetConfigMacAddress.from_dict(obj["macAddress"]) if obj.get("macAddress") is not None else None,
            "autoNegotiate": InterfaceEthernetConfigAutoNegotiate.from_dict(obj["autoNegotiate"]) if obj.get("autoNegotiate") is not None else None,
            "duplexMode": InterfaceEthernetConfigDuplexMode.from_dict(obj["duplexMode"]) if obj.get("duplexMode") is not None else None,
            "portSpeed": InterfaceEthernetConfigPortSpeed.from_dict(obj["portSpeed"]) if obj.get("portSpeed") is not None else None,
            "enableFlowControl": InterfaceEthernetConfigEnableFlowControl.from_dict(obj["enableFlowControl"]) if obj.get("enableFlowControl") is not None else None,
            "aggregateId": InterfaceEthernetConfigAggregateId.from_dict(obj["aggregateId"]) if obj.get("aggregateId") is not None else None,
