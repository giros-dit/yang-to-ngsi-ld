...
class InterfaceSubinterfacesSubinterfaceIpv6State(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6State.")
    ...
    enabled: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateEnabled] = None
    mtu: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateMtu] = None
    dup_addr_detect_transmits: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits] = Field(default=None, alias="dupAddrDetectTransmits")
    dhcp_client: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateDhcpClient] = Field(default=None, alias="dhcpClient")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6State'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6State')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6State',
            ...
            "enabled": InterfaceSubinterfacesSubinterfaceIpv6StateEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "mtu": InterfaceSubinterfacesSubinterfaceIpv6StateMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dupAddrDetectTransmits": InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits.from_dict(obj["dupAddrDetectTransmits"]) if obj.get("dupAddrDetectTransmits") is not None else None,
            "dhcpClient": InterfaceSubinterfacesSubinterfaceIpv6StateDhcpClient.from_dict(obj["dhcpClient"]) if obj.get("dhcpClient") is not None else None,
