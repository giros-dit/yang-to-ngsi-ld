...
class TestInterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength:
        """Test InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength"""
