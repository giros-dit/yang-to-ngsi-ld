...
class TestInterfaceAggregationSwitchedVlanStateAccessVlan(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanStateAccessVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanStateAccessVlan:
        """Test InterfaceAggregationSwitchedVlanStateAccessVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanStateAccessVlan`
        """
        model = InterfaceAggregationSwitchedVlanStateAccessVlan()
        if include_optional:
            return InterfaceAggregationSwitchedVlanStateAccessVlan(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceAggregationSwitchedVlanStateAccessVlan(self):
        """Test InterfaceAggregationSwitchedVlanStateAccessVlan"""
