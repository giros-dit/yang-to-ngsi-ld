...
class TestVlanMembersMemberState(unittest.TestCase):
    """VlanMembersMemberState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanMembersMemberState:
        """Test VlanMembersMemberState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanMembersMemberState`
        """
        model = VlanMembersMemberState()
        if include_optional:
            return VlanMembersMemberState(
                id = '',
                type = 'VlanMembersMemberState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testVlanMembersMemberState(self):
        """Test VlanMembersMemberState"""
