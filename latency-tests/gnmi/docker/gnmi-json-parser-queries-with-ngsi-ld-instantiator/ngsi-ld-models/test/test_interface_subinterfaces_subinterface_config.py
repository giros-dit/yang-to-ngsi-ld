...
class TestInterfaceSubinterfacesSubinterfaceConfig(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceConfig:
        """Test InterfaceSubinterfacesSubinterfaceConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceConfig`
        """
        model = InterfaceSubinterfacesSubinterfaceConfig()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceConfig(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceConfig(self):
        """Test InterfaceSubinterfacesSubinterfaceConfig"""
