...
class TestInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress:
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress"""
