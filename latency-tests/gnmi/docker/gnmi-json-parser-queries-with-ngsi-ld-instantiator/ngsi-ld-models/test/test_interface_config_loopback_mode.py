...
class TestInterfaceConfigLoopbackMode(unittest.TestCase):
    """InterfaceConfigLoopbackMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigLoopbackMode:
        """Test InterfaceConfigLoopbackMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigLoopbackMode`
        """
        model = InterfaceConfigLoopbackMode()
        if include_optional:
            return InterfaceConfigLoopbackMode(
                type = 'Property',
                value = True,
    ...
    def testInterfaceConfigLoopbackMode(self):
        """Test InterfaceConfigLoopbackMode"""
