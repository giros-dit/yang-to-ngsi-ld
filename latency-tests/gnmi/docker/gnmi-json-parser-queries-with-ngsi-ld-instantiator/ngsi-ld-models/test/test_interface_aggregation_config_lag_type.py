...
class TestInterfaceAggregationConfigLagType(unittest.TestCase):
    """InterfaceAggregationConfigLagType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationConfigLagType:
        """Test InterfaceAggregationConfigLagType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationConfigLagType`
        """
        model = InterfaceAggregationConfigLagType()
        if include_optional:
            return InterfaceAggregationConfigLagType(
                type = 'Property',
                value = 'LACP',
    ...
    def testInterfaceAggregationConfigLagType(self):
        """Test InterfaceAggregationConfigLagType"""
