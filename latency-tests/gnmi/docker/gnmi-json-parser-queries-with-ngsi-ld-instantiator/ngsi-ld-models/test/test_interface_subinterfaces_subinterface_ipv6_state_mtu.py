...
class TestInterfaceSubinterfacesSubinterfaceIpv6StateMtu(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6StateMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6StateMtu:
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6StateMtu`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6StateMtu()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6StateMtu(
                type = 'Property',
                value = 1280,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6StateMtu(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateMtu"""
