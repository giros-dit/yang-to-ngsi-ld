...
class TestInterfaceRoutedVlanIpv6State(unittest.TestCase):
    """InterfaceRoutedVlanIpv6State unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6State:
        """Test InterfaceRoutedVlanIpv6State
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6State`
        """
        model = InterfaceRoutedVlanIpv6State()
        if include_optional:
            return InterfaceRoutedVlanIpv6State(
                id = '',
                type = 'InterfaceRoutedVlanIpv6State',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6State(self):
        """Test InterfaceRoutedVlanIpv6State"""
