...
class TestInterfaceAggregationSwitchedVlanStateNativeVlan(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanStateNativeVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanStateNativeVlan:
        """Test InterfaceAggregationSwitchedVlanStateNativeVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanStateNativeVlan`
        """
        model = InterfaceAggregationSwitchedVlanStateNativeVlan()
        if include_optional:
            return InterfaceAggregationSwitchedVlanStateNativeVlan(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceAggregationSwitchedVlanStateNativeVlan(self):
        """Test InterfaceAggregationSwitchedVlanStateNativeVlan"""
