...
class TestInterfaceStateCountersCarrierTransitions(unittest.TestCase):
    """InterfaceStateCountersCarrierTransitions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersCarrierTransitions:
        """Test InterfaceStateCountersCarrierTransitions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersCarrierTransitions`
        """
        model = InterfaceStateCountersCarrierTransitions()
        if include_optional:
            return InterfaceStateCountersCarrierTransitions(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersCarrierTransitions(self):
        """Test InterfaceStateCountersCarrierTransitions"""
