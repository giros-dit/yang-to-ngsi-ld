...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval"""
