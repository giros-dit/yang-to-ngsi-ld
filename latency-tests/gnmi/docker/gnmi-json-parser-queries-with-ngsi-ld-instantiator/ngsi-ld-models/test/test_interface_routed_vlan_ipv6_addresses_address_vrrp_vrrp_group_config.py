...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig"""
