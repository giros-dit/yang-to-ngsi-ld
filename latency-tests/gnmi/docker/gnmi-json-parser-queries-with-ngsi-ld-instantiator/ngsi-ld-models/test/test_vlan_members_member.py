...
class TestVlanMembersMember(unittest.TestCase):
    """VlanMembersMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanMembersMember:
        """Test VlanMembersMember
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanMembersMember`
        """
        model = VlanMembersMember()
        if include_optional:
            return VlanMembersMember(
                id = '',
                type = 'VlanMembersMember',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testVlanMembersMember(self):
        """Test VlanMembersMember"""
