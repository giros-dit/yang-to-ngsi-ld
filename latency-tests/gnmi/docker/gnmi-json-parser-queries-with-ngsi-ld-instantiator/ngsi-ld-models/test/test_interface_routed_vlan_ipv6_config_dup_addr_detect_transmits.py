...
class TestInterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits(unittest.TestCase):
    """InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits:
        """Test InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits`
        """
        model = InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits()
        if include_optional:
            return InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits(self):
        """Test InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits"""
