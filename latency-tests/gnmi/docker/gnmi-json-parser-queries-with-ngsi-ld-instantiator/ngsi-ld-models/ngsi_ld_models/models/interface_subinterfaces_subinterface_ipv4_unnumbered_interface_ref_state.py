...
class InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefState.")
    ...
    interface: Optional[InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface] = None
    subinterface: Optional[InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefState',
            ...
            "interface": InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "subinterface": InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
