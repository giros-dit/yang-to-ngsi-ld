...
class Vlan(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be Vlan.")
    ...
    vlan_id: Optional[VlanVlanId] = Field(default=None, alias="vlanId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "vlanId"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('Vlan'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Vlan',
            ...
            "vlanId": VlanVlanId.from_dict(obj["vlanId"]) if obj.get("vlanId") is not None else None
        })
