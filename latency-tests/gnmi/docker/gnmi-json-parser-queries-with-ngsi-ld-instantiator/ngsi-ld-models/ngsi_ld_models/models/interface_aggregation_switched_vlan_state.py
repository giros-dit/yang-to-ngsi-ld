...
class InterfaceAggregationSwitchedVlanState(BaseModel):
    """
    State variables for VLANs  YANG module: openconfig-vlan.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceAggregationSwitchedVlanState.")
    ...
    interface_mode: Optional[InterfaceAggregationSwitchedVlanStateInterfaceMode] = Field(default=None, alias="interfaceMode")
    native_vlan: Optional[InterfaceAggregationSwitchedVlanStateNativeVlan] = Field(default=None, alias="nativeVlan")
    access_vlan: Optional[InterfaceAggregationSwitchedVlanStateAccessVlan] = Field(default=None, alias="accessVlan")
    trunk_vlans: Optional[InterfaceAggregationSwitchedVlanStateTrunkVlans] = Field(default=None, alias="trunkVlans")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceAggregationSwitchedVlanState'):
            raise ValueError("must be one of enum values ('InterfaceAggregationSwitchedVlanState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceAggregationSwitchedVlanState',
            ...
            "interfaceMode": InterfaceAggregationSwitchedVlanStateInterfaceMode.from_dict(obj["interfaceMode"]) if obj.get("interfaceMode") is not None else None,
            "nativeVlan": InterfaceAggregationSwitchedVlanStateNativeVlan.from_dict(obj["nativeVlan"]) if obj.get("nativeVlan") is not None else None,
            "accessVlan": InterfaceAggregationSwitchedVlanStateAccessVlan.from_dict(obj["accessVlan"]) if obj.get("accessVlan") is not None else None,
            "trunkVlans": InterfaceAggregationSwitchedVlanStateTrunkVlans.from_dict(obj["trunkVlans"]) if obj.get("trunkVlans") is not None else None,
