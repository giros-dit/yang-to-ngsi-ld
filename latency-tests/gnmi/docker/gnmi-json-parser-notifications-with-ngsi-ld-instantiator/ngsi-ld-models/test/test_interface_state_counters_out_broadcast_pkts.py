...
class TestInterfaceStateCountersOutBroadcastPkts(unittest.TestCase):
    """InterfaceStateCountersOutBroadcastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersOutBroadcastPkts:
        """Test InterfaceStateCountersOutBroadcastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersOutBroadcastPkts`
        """
        model = InterfaceStateCountersOutBroadcastPkts()
        if include_optional:
            return InterfaceStateCountersOutBroadcastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersOutBroadcastPkts(self):
        """Test InterfaceStateCountersOutBroadcastPkts"""
