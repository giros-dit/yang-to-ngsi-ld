...
class TestInterfaceEthernetStatePortSpeed(unittest.TestCase):
    """InterfaceEthernetStatePortSpeed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStatePortSpeed:
        """Test InterfaceEthernetStatePortSpeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStatePortSpeed`
        """
        model = InterfaceEthernetStatePortSpeed()
        if include_optional:
            return InterfaceEthernetStatePortSpeed(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceEthernetStatePortSpeed(self):
        """Test InterfaceEthernetStatePortSpeed"""
