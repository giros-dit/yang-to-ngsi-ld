...
class TestInterfaceSubinterfacesSubinterfaceIpv4UnnumberedState(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState:
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4UnnumberedState(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState"""
