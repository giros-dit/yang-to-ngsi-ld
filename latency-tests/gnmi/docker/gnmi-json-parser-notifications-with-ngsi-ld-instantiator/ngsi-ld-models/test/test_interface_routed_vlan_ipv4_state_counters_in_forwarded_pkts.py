...
class TestInterfaceRoutedVlanIpv4StateCountersInForwardedPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersInForwardedPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersInForwardedPkts:
        """Test InterfaceRoutedVlanIpv4StateCountersInForwardedPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersInForwardedPkts`
        """
        model = InterfaceRoutedVlanIpv4StateCountersInForwardedPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersInForwardedPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersInForwardedPkts(self):
        """Test InterfaceRoutedVlanIpv4StateCountersInForwardedPkts"""
