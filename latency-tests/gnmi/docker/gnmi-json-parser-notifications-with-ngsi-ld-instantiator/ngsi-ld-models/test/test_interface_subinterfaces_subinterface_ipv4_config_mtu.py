...
class TestInterfaceSubinterfacesSubinterfaceIpv4ConfigMtu(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu:
        """Test InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu(
                type = 'Property',
                value = 68,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4ConfigMtu(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu"""
