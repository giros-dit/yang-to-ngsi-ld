...
class TestInterfaceAggregationSwitchedVlanState(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanState:
        """Test InterfaceAggregationSwitchedVlanState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanState`
        """
        model = InterfaceAggregationSwitchedVlanState()
        if include_optional:
            return InterfaceAggregationSwitchedVlanState(
                id = '',
                type = 'InterfaceAggregationSwitchedVlanState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceAggregationSwitchedVlanState(self):
        """Test InterfaceAggregationSwitchedVlanState"""
