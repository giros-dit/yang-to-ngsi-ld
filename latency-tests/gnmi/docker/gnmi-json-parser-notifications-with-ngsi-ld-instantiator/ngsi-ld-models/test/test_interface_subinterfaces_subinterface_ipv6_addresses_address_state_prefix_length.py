...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength"""
