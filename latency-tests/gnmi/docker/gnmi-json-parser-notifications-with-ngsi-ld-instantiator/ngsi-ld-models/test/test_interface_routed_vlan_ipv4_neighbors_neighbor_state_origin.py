...
class TestInterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin(unittest.TestCase):
    """InterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin:
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin`
        """
        model = InterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin()
        if include_optional:
            return InterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin(
                type = 'Property',
                value = 'OTHER',
    ...
    def testInterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin(self):
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborStateOrigin"""
