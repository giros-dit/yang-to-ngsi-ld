...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigIp"""
