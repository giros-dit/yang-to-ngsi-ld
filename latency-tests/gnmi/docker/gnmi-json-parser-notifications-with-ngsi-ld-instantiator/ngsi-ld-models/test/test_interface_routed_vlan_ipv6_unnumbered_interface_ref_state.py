...
class TestInterfaceRoutedVlanIpv6UnnumberedInterfaceRefState(unittest.TestCase):
    """InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState:
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState`
        """
        model = InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState()
        if include_optional:
            return InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState(
                id = '',
                type = 'InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6UnnumberedInterfaceRefState(self):
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState"""
