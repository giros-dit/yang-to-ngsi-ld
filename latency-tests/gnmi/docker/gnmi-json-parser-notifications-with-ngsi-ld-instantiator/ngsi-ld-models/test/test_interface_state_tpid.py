...
class TestInterfaceStateTpid(unittest.TestCase):
    """InterfaceStateTpid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateTpid:
        """Test InterfaceStateTpid
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateTpid`
        """
        model = InterfaceStateTpid()
        if include_optional:
            return InterfaceStateTpid(
                type = 'Relationship',
    ...
    def testInterfaceStateTpid(self):
        """Test InterfaceStateTpid"""
