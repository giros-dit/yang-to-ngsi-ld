...
class TestInterfaceSubinterfacesSubinterfaceIpv6ConfigMtu(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu:
        """Test InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu(
                type = 'Property',
                value = 1280,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6ConfigMtu(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu"""
