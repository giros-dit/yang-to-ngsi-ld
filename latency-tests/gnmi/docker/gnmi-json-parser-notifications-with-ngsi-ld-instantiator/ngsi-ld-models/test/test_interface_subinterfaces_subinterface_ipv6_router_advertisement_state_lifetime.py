...
class TestInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime:
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime"""
