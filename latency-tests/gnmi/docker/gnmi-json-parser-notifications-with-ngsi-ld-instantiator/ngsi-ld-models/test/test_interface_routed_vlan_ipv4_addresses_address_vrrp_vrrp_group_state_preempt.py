...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt"""
