...
class TestInterfaceRoutedVlanIpv6AddressesAddressStateIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressStateIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressStateIp:
        """Test InterfaceRoutedVlanIpv6AddressesAddressStateIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressStateIp`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressStateIp()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressStateIp(
                type = 'Property',
                value = 'C:02:84::3',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressStateIp(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressStateIp"""
