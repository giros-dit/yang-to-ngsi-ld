...
class TestInterfaceEthernetConfigAutoNegotiate(unittest.TestCase):
    """InterfaceEthernetConfigAutoNegotiate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetConfigAutoNegotiate:
        """Test InterfaceEthernetConfigAutoNegotiate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetConfigAutoNegotiate`
        """
        model = InterfaceEthernetConfigAutoNegotiate()
        if include_optional:
            return InterfaceEthernetConfigAutoNegotiate(
                type = 'Property',
                value = True,
    ...
    def testInterfaceEthernetConfigAutoNegotiate(self):
        """Test InterfaceEthernetConfigAutoNegotiate"""
