...
class TestInterfaceSubinterfacesSubinterfaceStateLastChange(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateLastChange:
        """Test InterfaceSubinterfacesSubinterfaceStateLastChange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateLastChange`
        """
        model = InterfaceSubinterfacesSubinterfaceStateLastChange()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateLastChange(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateLastChange(self):
        """Test InterfaceSubinterfacesSubinterfaceStateLastChange"""
