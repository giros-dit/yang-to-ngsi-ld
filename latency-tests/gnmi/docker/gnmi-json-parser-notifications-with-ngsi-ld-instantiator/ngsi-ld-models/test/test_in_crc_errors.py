...
class TestInCrcErrors(unittest.TestCase):
    """InCrcErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InCrcErrors:
        """Test InCrcErrors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InCrcErrors`
        """
        model = InCrcErrors()
        if include_optional:
            return InCrcErrors(
