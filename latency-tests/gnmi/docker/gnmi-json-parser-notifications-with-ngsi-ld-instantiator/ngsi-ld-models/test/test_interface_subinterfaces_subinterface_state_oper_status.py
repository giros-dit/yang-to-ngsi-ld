...
class TestInterfaceSubinterfacesSubinterfaceStateOperStatus(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateOperStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateOperStatus:
        """Test InterfaceSubinterfacesSubinterfaceStateOperStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateOperStatus`
        """
        model = InterfaceSubinterfacesSubinterfaceStateOperStatus()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateOperStatus(
                type = 'Property',
                value = 'UP',
    ...
    def testInterfaceSubinterfacesSubinterfaceStateOperStatus(self):
        """Test InterfaceSubinterfacesSubinterfaceStateOperStatus"""
