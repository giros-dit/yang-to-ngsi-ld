...
class TestNegotiatedPortSpeed(unittest.TestCase):
    """NegotiatedPortSpeed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NegotiatedPortSpeed:
        """Test NegotiatedPortSpeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NegotiatedPortSpeed`
        """
        model = NegotiatedPortSpeed()
        if include_optional:
            return NegotiatedPortSpeed(
                type = 'Relationship',
                object = '',
    ...
    def testNegotiatedPortSpeed(self):
        """Test NegotiatedPortSpeed"""
