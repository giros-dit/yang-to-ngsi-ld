...
class TestInterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled:
        """Test InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled"""
