...
class TestInterfaceRoutedVlanIpv6AddressesAddressStateOrigin(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressStateOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressStateOrigin:
        """Test InterfaceRoutedVlanIpv6AddressesAddressStateOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressStateOrigin`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressStateOrigin()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressStateOrigin(
                type = 'Property',
                value = 'OTHER',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressStateOrigin(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressStateOrigin"""
