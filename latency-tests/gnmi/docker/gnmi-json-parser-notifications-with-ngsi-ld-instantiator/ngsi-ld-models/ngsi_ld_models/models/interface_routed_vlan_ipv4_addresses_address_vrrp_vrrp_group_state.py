...
class InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState.")
    ...
    virtual_router_id: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId] = Field(default=None, alias="virtualRouterId")
    virtual_address: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress] = Field(default=None, alias="virtualAddress")
    priority: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority] = None
    preempt: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt] = None
    preempt_delay: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay] = Field(default=None, alias="preemptDelay")
    accept_mode: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAcceptMode] = Field(default=None, alias="acceptMode")
    advertisement_interval: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval] = Field(default=None, alias="advertisementInterval")
    current_priority: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority] = Field(default=None, alias="currentPriority")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState',
            ...
            "virtualRouterId": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
            "virtualAddress": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress.from_dict(obj["virtualAddress"]) if obj.get("virtualAddress") is not None else None,
            "priority": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "preempt": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreempt.from_dict(obj["preempt"]) if obj.get("preempt") is not None else None,
            "preemptDelay": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay.from_dict(obj["preemptDelay"]) if obj.get("preemptDelay") is not None else None,
            "acceptMode": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAcceptMode.from_dict(obj["acceptMode"]) if obj.get("acceptMode") is not None else None,
            "advertisementInterval": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval.from_dict(obj["advertisementInterval"]) if obj.get("advertisementInterval") is not None else None,
            "currentPriority": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority.from_dict(obj["currentPriority"]) if obj.get("currentPriority") is not None else None,
