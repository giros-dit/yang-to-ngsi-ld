...
class InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfig.")
    ...
    virtual_router_id: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigVirtualRouterId] = Field(default=None, alias="virtualRouterId")
    virtual_address: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress] = Field(default=None, alias="virtualAddress")
    priority: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority] = None
    preempt: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt] = None
    preempt_delay: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreemptDelay] = Field(default=None, alias="preemptDelay")
    accept_mode: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode] = Field(default=None, alias="acceptMode")
    advertisement_interval: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigAdvertisementInterval] = Field(default=None, alias="advertisementInterval")
    virtual_link_local: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal] = Field(default=None, alias="virtualLinkLocal")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "virtualRouterId", "virtualAddress", "priority", "preempt", "preemptDelay", "acceptMode", "advertisementInterval", "virtualLinkLocal", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfig',
            ...
            "virtualRouterId": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigVirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
            "virtualAddress": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress.from_dict(obj["virtualAddress"]) if obj.get("virtualAddress") is not None else None,
            "priority": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "preempt": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt.from_dict(obj["preempt"]) if obj.get("preempt") is not None else None,
            "preemptDelay": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreemptDelay.from_dict(obj["preemptDelay"]) if obj.get("preemptDelay") is not None else None,
            "acceptMode": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode.from_dict(obj["acceptMode"]) if obj.get("acceptMode") is not None else None,
            "advertisementInterval": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigAdvertisementInterval.from_dict(obj["advertisementInterval"]) if obj.get("advertisementInterval") is not None else None,
            "virtualLinkLocal": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal.from_dict(obj["virtualLinkLocal"]) if obj.get("virtualLinkLocal") is not None else None,
