...
class InterfaceSubinterfacesSubinterfaceStateCounters(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceStateCounters.")
    ...
    in_octets: Optional[InterfaceSubinterfacesSubinterfaceStateCountersInOctets] = Field(default=None, alias="inOctets")
    in_unicast_pkts: Optional[InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts] = Field(default=None, alias="inUnicastPkts")
    in_broadcast_pkts: Optional[InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts] = Field(default=None, alias="inBroadcastPkts")
    in_multicast_pkts: Optional[InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts] = Field(default=None, alias="inMulticastPkts")
    in_discards: Optional[InterfaceSubinterfacesSubinterfaceStateCountersInDiscards] = Field(default=None, alias="inDiscards")
    in_errors: Optional[InterfaceSubinterfacesSubinterfaceStateCountersInErrors] = Field(default=None, alias="inErrors")
    in_unknown_protos: Optional[InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos] = Field(default=None, alias="inUnknownProtos")
    in_fcs_errors: Optional[InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors] = Field(default=None, alias="inFcsErrors")
    out_octets: Optional[InterfaceSubinterfacesSubinterfaceStateCountersOutOctets] = Field(default=None, alias="outOctets")
    out_unicast_pkts: Optional[InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts] = Field(default=None, alias="outUnicastPkts")
    out_broadcast_pkts: Optional[InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts] = Field(default=None, alias="outBroadcastPkts")
    out_multicast_pkts: Optional[InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts] = Field(default=None, alias="outMulticastPkts")
    out_discards: Optional[InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards] = Field(default=None, alias="outDiscards")
    out_errors: Optional[InterfaceSubinterfacesSubinterfaceStateCountersOutErrors] = Field(default=None, alias="outErrors")
    carrier_transitions: Optional[InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions] = Field(default=None, alias="carrierTransitions")
    last_clear: Optional[InterfaceSubinterfacesSubinterfaceStateCountersLastClear] = Field(default=None, alias="lastClear")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceStateCounters'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceStateCounters')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceStateCounters',
            ...
            "inOctets": InterfaceSubinterfacesSubinterfaceStateCountersInOctets.from_dict(obj["inOctets"]) if obj.get("inOctets") is not None else None,
            "inUnicastPkts": InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts.from_dict(obj["inUnicastPkts"]) if obj.get("inUnicastPkts") is not None else None,
            "inBroadcastPkts": InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts.from_dict(obj["inBroadcastPkts"]) if obj.get("inBroadcastPkts") is not None else None,
            "inMulticastPkts": InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts.from_dict(obj["inMulticastPkts"]) if obj.get("inMulticastPkts") is not None else None,
            "inDiscards": InterfaceSubinterfacesSubinterfaceStateCountersInDiscards.from_dict(obj["inDiscards"]) if obj.get("inDiscards") is not None else None,
            "inErrors": InterfaceSubinterfacesSubinterfaceStateCountersInErrors.from_dict(obj["inErrors"]) if obj.get("inErrors") is not None else None,
            "inUnknownProtos": InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos.from_dict(obj["inUnknownProtos"]) if obj.get("inUnknownProtos") is not None else None,
            "inFcsErrors": InterfaceSubinterfacesSubinterfaceStateCountersInFcsErrors.from_dict(obj["inFcsErrors"]) if obj.get("inFcsErrors") is not None else None,
            "outOctets": InterfaceSubinterfacesSubinterfaceStateCountersOutOctets.from_dict(obj["outOctets"]) if obj.get("outOctets") is not None else None,
            "outUnicastPkts": InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts.from_dict(obj["outUnicastPkts"]) if obj.get("outUnicastPkts") is not None else None,
            "outBroadcastPkts": InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts.from_dict(obj["outBroadcastPkts"]) if obj.get("outBroadcastPkts") is not None else None,
            "outMulticastPkts": InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts.from_dict(obj["outMulticastPkts"]) if obj.get("outMulticastPkts") is not None else None,
            "outDiscards": InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards.from_dict(obj["outDiscards"]) if obj.get("outDiscards") is not None else None,
            "outErrors": InterfaceSubinterfacesSubinterfaceStateCountersOutErrors.from_dict(obj["outErrors"]) if obj.get("outErrors") is not None else None,
            "carrierTransitions": InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions.from_dict(obj["carrierTransitions"]) if obj.get("carrierTransitions") is not None else None,
            "lastClear": InterfaceSubinterfacesSubinterfaceStateCountersLastClear.from_dict(obj["lastClear"]) if obj.get("lastClear") is not None else None,
