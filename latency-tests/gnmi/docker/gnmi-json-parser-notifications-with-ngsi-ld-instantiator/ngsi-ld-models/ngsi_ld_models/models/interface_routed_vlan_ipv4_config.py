...
class InterfaceRoutedVlanIpv4Config(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4Config.")
    ...
    enabled: Optional[InterfaceRoutedVlanIpv4ConfigEnabled] = None
    mtu: Optional[InterfaceRoutedVlanIpv4ConfigMtu] = None
    dhcp_client: Optional[InterfaceRoutedVlanIpv4ConfigDhcpClient] = Field(default=None, alias="dhcpClient")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4Config'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4Config')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4Config',
            ...
            "enabled": InterfaceRoutedVlanIpv4ConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "mtu": InterfaceRoutedVlanIpv4ConfigMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dhcpClient": InterfaceRoutedVlanIpv4ConfigDhcpClient.from_dict(obj["dhcpClient"]) if obj.get("dhcpClient") is not None else None,
