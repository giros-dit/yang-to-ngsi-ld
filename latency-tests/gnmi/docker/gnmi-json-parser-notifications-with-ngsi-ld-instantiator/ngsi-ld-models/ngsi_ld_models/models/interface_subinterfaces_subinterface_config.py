...
class InterfaceSubinterfacesSubinterfaceConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceConfig.")
    ...
    index: Optional[InterfaceSubinterfacesSubinterfaceConfigIndex] = None
    description: Optional[InterfaceSubinterfacesSubinterfaceConfigDescription] = None
    enabled: Optional[InterfaceSubinterfacesSubinterfaceConfigEnabled] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "index", "description", "enabled", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceConfig',
            ...
            "index": InterfaceSubinterfacesSubinterfaceConfigIndex.from_dict(obj["index"]) if obj.get("index") is not None else None,
            "description": InterfaceSubinterfacesSubinterfaceConfigDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "enabled": InterfaceSubinterfacesSubinterfaceConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
