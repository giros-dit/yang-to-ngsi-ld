...
async def startup_event():
    ...
    for entity in LIST_ENTITIES:
        ...
        subs_request = CreateSubscriptionRequest (
            ...
            description="Periodic subscription to InterfaceState entities.",
            timeInterval= 10,
        ...
        subs_request = CreateSubscriptionRequest (
            ...
            description="On-change subscription to InterfaceStateCounters entities for changes within inOctets property.",
