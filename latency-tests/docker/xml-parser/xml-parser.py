...
print("I will process every single notification and parse them to NGSI-LD structures (in JSON format)")

while True:
    for message in consumer:
        print("I have consumed a new notification! I will try to parse it...")
        ...
        eventTime = {}
        eventTime["eventTime"] = root[0].text
        dict_buffers.append(eventTime)
