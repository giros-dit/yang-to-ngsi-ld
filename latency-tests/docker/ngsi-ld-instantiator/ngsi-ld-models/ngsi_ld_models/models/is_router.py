...
class IsRouter(BaseModel):
    """
    NGSI-LD Property Type. Indicates that the neighbor node acts as a router.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in IsRouter) in the input: " + _key)
