...
class InterfaceIpv4Address(BaseModel):
    """
    NGSI-LD Entity Type that represents the IPv4 address on interfaces of a YANG model-based network device.   # noqa: E501
    """
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: Optional[StrictStr] = Field(default='InterfaceIpv4Address', description="NGSI-LD Entity identifier. It has to be InterfaceIpv4Address.")
    ...
    ip: Optional[Ipv4Ip] = None
    prefix_length: Optional[Ipv4PrefixLength] = Field(default=None, alias="prefixLength")
    netmask: Optional[Ipv4Netmask] = None
    origin: Optional[IpOrigin] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ip", "prefixLength", "netmask", "origin", "isPartOf"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('InterfaceIpv4Address'):
            raise ValueError("must be one of enum values ('InterfaceIpv4Address')")
        return value
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of netmask
        if self.netmask:
            _dict['netmask'] = self.netmask.to_dict()
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceIpv4Address',
            ...
            "prefixLength": Ipv4PrefixLength.from_dict(obj.get("prefixLength")) if obj.get("prefixLength") is not None else None,
            "netmask": Ipv4Netmask.from_dict(obj.get("netmask")) if obj.get("netmask") is not None else None,
            "origin": IpOrigin.from_dict(obj.get("origin")) if obj.get("origin") is not None else None,
