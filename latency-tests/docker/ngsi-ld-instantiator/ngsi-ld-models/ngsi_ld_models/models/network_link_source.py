...
class NetworkLinkSource(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='NetworkLinkSource', description="NGSI-LD Entity identifier. It has to be NetworkLinkSource.")
    ...
    source_node: SourceNode = Field(alias="sourceNode")
    source_tp: SourceTp = Field(alias="sourceTp")
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "sourceNode": SourceNode.from_dict(obj.get("sourceNode")) if obj.get("sourceNode") is not None else None,
            "sourceTp": SourceTp.from_dict(obj.get("sourceTp")) if obj.get("sourceTp") is not None else None,
