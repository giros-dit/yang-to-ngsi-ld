...
class PhysAddress(BaseModel):
    """
    NGSI-LD Property Type. The interface's address at its protocol sub-layer.  # noqa: E501
    """
    ...
    def from_dict(cls, obj: dict) -> Self:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in PhysAddress) in the input: " + _key)
