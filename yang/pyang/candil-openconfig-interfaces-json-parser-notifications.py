...
for element_text, child_node, parent_path, iteration_key in zip(values, child_nodes, parent_paths, iteration_keys):
    if parent_path[0] == "openconfig-interfaces:interfaces" or parent_path[0] == "interfaces":
        ...
        if parent_path[2] == "state":
            ...
            interface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceState:" + iteration_key
        ...
        if parent_path[2] == "hold-time":
            if parent_path[3] == "config":
                interface_config_dict_buffer = {}
                interface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceHoldTimeConfig:" + iteration_key
                ...
                if parent_path[4] == "state":
                    interface_state_dict_buffer = {}
                    interface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceHoldTimeState:" + iteration_key
            ...
            if parent_path[3] == "subinterface":
                ...
                if len(parent_path) - 1 == 3 or len(parent_path) - 1 == 4:
                    ...
                    if parent_path[4] == "state":
                        ...
                        interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceState:" + iteration_key
                    ...
                    if parent_path[4] == "openconfig-if-ip:ipv4" or parent_path[4] == "ipv4":
                        if parent_path[5] == "addresses":
                            if parent_path[6] == "address":
                                ...
                                if len(parent_path) - 1 == 6 or len(parent_path) - 1 == 7:
                                    ...
                                    if parent_path[7] == "state":
                                        ...
                                        interface_subinterface_address_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressState:" + iteration_key
                                        ...
                                        if parent_path[8] == "vrrp-group":
                                            ...
                                            if len(parent_path) - 1 == 8 or len(parent_path) - 1 == 9:
                                                ...
                                                if parent_path[9] == "state":
                                                    ...
                                                    interface_subinterface_address_vrrp_group_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupState:" + iteration_key
                                                ...
                                                if parent_path[9] == "interface-tracking":
                                                    if parent_path[10] == "config":
                                                        interface_subinterface_address_vrrp_group_config_dict_buffer = {}
                                                        interface_subinterface_address_vrrp_group_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingConfig:" + iteration_key
                                                        ...
                                                        if parent_path[11] == "state":
                                                            interface_subinterface_address_vrrp_group_state_dict_buffer = {}
                                                            interface_subinterface_address_vrrp_group_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingState:" + iteration_key
                            ...
                            if parent_path[6] == "proxy-arp":
                                if parent_path[7] == "config":
                                    interface_subinterface_config_dict_buffer = {}
                                    interface_subinterface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig:" + iteration_key
                                    ...
                                    if parent_path[8] == "state":
                                        interface_subinterface_state_dict_buffer = {}
                                        interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4ProxyArpState:" + iteration_key
                                ...
                                if parent_path[7] == "neighbors":
                                    if parent_path[8] == "neighbor":
                                        ...
                                        if len(parent_path) - 1 == 8 or len(parent_path) - 1 == 9:
                                            ...
                                            if parent_path[9] == "state":
                                                ...
                                                interface_subinterface_neighbor_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState:" + iteration_key
                                    ...
                                    if parent_path[8] == "unnumbered":
                                        if parent_path[9] == "config":
                                            interface_subinterface_config_dict_buffer = {}
                                            interface_subinterface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig:" + iteration_key
                                            ...
                                            if parent_path[10] == "state":
                                                interface_subinterface_state_dict_buffer = {}
                                                interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState:" + iteration_key
                                                ...
                                                if parent_path[11] == "interface-ref":
                                                    if parent_path[12] == "config":
                                                        interface_subinterface_config_dict_buffer = {}
                                                        interface_subinterface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfig:" + iteration_key
                                                        ...
                                                        if parent_path[13] == "state":
                                                            interface_subinterface_state_dict_buffer = {}
                                                            interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefState:" + iteration_key
                                        ...
                                        if parent_path[9] == "config":
                                            interface_subinterface_config_dict_buffer = {}
                                            interface_subinterface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4Config:" + iteration_key
                                            ...
                                            if parent_path[10] == "state":
                                                interface_subinterface_state_dict_buffer = {}
                                                interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv4State:" + iteration_key
                        ...
                        if parent_path[5] == "addresses":
                            if parent_path[6] == "address":
                                ...
                                if len(parent_path) - 1 == 6 or len(parent_path) - 1 == 7:
                                    ...
                                    if parent_path[7] == "state":
                                        interface_subinterface_address_state_dict_buffer = {}
                                        interface_subinterface_address_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState:" + iteration_key
                                    ...
                                    if parent_path[7] == "vrrp":
                                        if parent_path[8] == "vrrp-group":
                                            ...
                                            if len(parent_path) - 1 == 8 or len(parent_path) - 1 == 9:
                                                ...
                                                if parent_path[9] == "state":
                                                    interface_subinterface_address_vrrp_group_state_dict_buffer = {}
                                                    interface_subinterface_address_vrrp_group_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupState:" + iteration_key
                                                ...
                                                if parent_path[9] == "interface-tracking":
                                                    if parent_path[10] == "config":
                                                        interface_subinterface_address_vrrp_group_config_dict_buffer = {}
                                                        interface_subinterface_address_vrrp_group_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingConfig:" + iteration_key
                                                        ...
                                                        if parent_path[11] == "state":
                                                            interface_subinterface_address_vrrp_group_state_dict_buffer = {}
                                                            interface_subinterface_address_vrrp_group_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingState:" + iteration_key
                            ...
                            if parent_path[6] == "router-advertisement":
                                if parent_path[7] == "config":
                                    interface_subinterface_config_dict_buffer = {}
                                    interface_subinterface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfig:" + iteration_key
                                    ...
                                    if parent_path[8] == "state":
                                        interface_subinterface_state_dict_buffer = {}
                                        interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementState:" + iteration_key
                                ...
                                if parent_path[7] == "neighbors":
                                    if parent_path[8] == "neighbor":
                                        ...
                                        if len(parent_path) - 1 == 8 or len(parent_path) - 1 == 9:
                                            ...
                                            if parent_path[9] == "state":
                                                interface_subinterface_neighbor_state_dict_buffer = {}
                                                interface_subinterface_neighbor_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState:" + iteration_key
                                    ...
                                    if parent_path[8] == "unnumbered":
                                        if parent_path[9] == "config":
                                            interface_subinterface_config_dict_buffer = {}
                                            interface_subinterface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig:" + iteration_key
                                            ...
                                            if parent_path[10] == "state":
                                                interface_subinterface_state_dict_buffer = {}
                                                interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6UnnumberedState:" + iteration_key
                                                ...
                                                if parent_path[11] == "interface-ref":
                                                    if parent_path[12] == "config":
                                                        interface_subinterface_config_dict_buffer = {}
                                                        interface_subinterface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfig:" + iteration_key
                                                        ...
                                                        if parent_path[13] == "state":
                                                            interface_subinterface_state_dict_buffer = {}
                                                            interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefState:" + iteration_key
                                        ...
                                        if parent_path[9] == "config":
                                            interface_subinterface_config_dict_buffer = {}
                                            interface_subinterface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6Config:" + iteration_key
                                            ...
                                            if parent_path[10] == "state":
                                                interface_subinterface_state_dict_buffer = {}
                                                interface_subinterface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceSubinterfacesSubinterfaceIpv6State:" + iteration_key
        ...
        if parent_path[2] == "openconfig-if-ethernet:ethernet" or parent_path[2] == "ethernet":
            if parent_path[3] == "config":
                interface_config_dict_buffer = {}
                interface_config_dict_buffer["id"] = "urn:ngsi-ld:InterfaceEthernetConfig:" + iteration_key
                ...
                if parent_path[4] == "state":
                    interface_state_dict_buffer = {}
                    interface_state_dict_buffer["id"] = "urn:ngsi-ld:InterfaceEthernetState:" + iteration_key
