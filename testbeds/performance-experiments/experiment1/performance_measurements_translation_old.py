...
gnmi_df1 = pd.read_csv('gnmi_performance_measurements_translation_12ifaces.csv')
gnmi_df2 = pd.read_csv('gnmi_performance_measurements_translation_24ifaces.csv')
gnmi_df3 = pd.read_csv('gnmi_performance_measurements_translation_36ifaces.csv')
gnmi_df4 = pd.read_csv('gnmi_performance_measurements_translation_48ifaces.csv')
...
ax_gnmi.set_title('YANG to NGSI-LD translation \n performance for gNMI')
...
ax_netconf.set_title('YANG to NGSI-LD translation \n performance for NETCONF')
ax_netconf.set_xticks([1, 2, 3, 4], ['12', '24', '36', '48'])

plt.tight_layout()

plt.savefig("performance_measurements_translation_old.png", format="png", dpi=1500)
plt.show()