...
raw_gnmi_df1 = pd.read_csv('gnmi_performance_measurements_translation_12ifaces-orion.csv')
...
raw_gnmi_df2 = pd.read_csv('gnmi_performance_measurements_translation_24ifaces-orion.csv')
...
raw_gnmi_df3 = pd.read_csv('gnmi_performance_measurements_translation_36ifaces-orion.csv')
...
raw_gnmi_df4 = pd.read_csv('gnmi_performance_measurements_translation_48ifaces-orion.csv')
...
print("gNMI latency performance measurements for YANG to NGSI-LD translation: \n")
...
netconf_df1 = pd.read_csv('netconf_performance_measurements_translation_12ifaces-orion.csv')
netconf_df2 = pd.read_csv('netconf_performance_measurements_translation_24ifaces-orion.csv')
netconf_df3 = pd.read_csv('netconf_performance_measurements_translation_36ifaces-orion.csv')
netconf_df4 = pd.read_csv('netconf_performance_measurements_translation_48ifaces-orion.csv')

print("NETCONF latency performance measurements for YANG to NGSI-LD translation: \n")
...
plt.title('YANG to NGSI-LD translation latency \n performance for NETCONF and gNMI')
plt.xticks([1, 2, 3, 4], ['12', '24', '36', '48'])
plt.suptitle('')
plt.savefig("performance_measurements_translation-combined-orion.png", format="png", dpi=1500)
plt.show()