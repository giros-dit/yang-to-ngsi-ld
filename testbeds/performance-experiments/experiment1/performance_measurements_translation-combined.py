...
gnmi_plot1 = gnmi_df1.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "orange", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[1])

gnmi_plot2 = gnmi_df2.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "orange", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[2])

gnmi_plot3 = gnmi_df3.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "orange", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[3])

gnmi_plot4 = gnmi_df4.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "orange", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[4])
...
netconf_plot1 = netconf_df1.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "cyan", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[1])

netconf_plot2 = netconf_df2.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "cyan", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[2])

netconf_plot3 = netconf_df3.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "cyan", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[3])

netconf_plot4 = netconf_df4.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "cyan", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[4])
