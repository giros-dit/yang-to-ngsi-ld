...
plt.savefig("netflow_notifications_throughput_measurements_events_join-scorpio.png", format="png", dpi=1500)
...
plt.savefig("netflow_notifications_throughput_measurements_bytes_join-scorpio.png", format="png", dpi=1500)
