...
raw_netflow_df1 = pd.read_csv('netflow_performance_measurements_translation_and_materialization_10flows.csv')
...
raw_netflow_df2 = pd.read_csv('netflow_performance_measurements_translation_and_materialization_20flows.csv')
...
raw_netflow_df3 = pd.read_csv('netflow_performance_measurements_translation_and_materialization_50flows.csv')
...
plt.suptitle('')
plt.savefig("netflow_performance_measurements_translation_and_materialization.png", format="png", dpi=1500)
plt.show()