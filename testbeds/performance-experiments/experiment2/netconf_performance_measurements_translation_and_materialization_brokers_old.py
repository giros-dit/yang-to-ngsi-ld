...
scorpio_df1 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_12ifaces.csv')
scorpio_df2 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_24ifaces.csv')
scorpio_df3 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_36ifaces.csv')
scorpio_df4 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_48ifaces.csv')
...
plt.suptitle('')
plt.savefig("netconf_performance_measurements_translation_and_materialization_brokers_old.png", format="png", dpi=1500)
plt.show()