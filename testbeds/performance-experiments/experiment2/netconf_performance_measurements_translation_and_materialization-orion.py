...
df1 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_12ifaces-orion.csv')
df2 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_24ifaces-orion.csv')
df3 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_36ifaces-orion.csv')
df4 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_48ifaces-orion.csv')
...
plt.suptitle('')
plt.savefig("netconf_performance_measurements_translation_and_materialization-orion.png", format="png", dpi=1500)
plt.show()