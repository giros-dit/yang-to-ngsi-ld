...
df1 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_12ifaces.csv')
df2 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_24ifaces.csv')
df3 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_36ifaces.csv')
df4 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_48ifaces.csv')
...
plt.suptitle('')
plt.savefig("netconf_performance_measurements_translation_and_materialization.png", format="png", dpi=1500)
plt.show()