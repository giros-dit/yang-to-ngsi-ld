...
df1 = pd.read_csv('gnmi_performance_measurements_translation_and_materialization_12ifaces.csv')
df2 = pd.read_csv('gnmi_performance_measurements_translation_and_materialization_24ifaces.csv')
df3 = pd.read_csv('gnmi_performance_measurements_translation_and_materialization_36ifaces.csv')
df4 = pd.read_csv('gnmi_performance_measurements_translation_and_materialization_48ifaces.csv')
...
plot1 = df1.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "red", linewidth = 1.5), ax=ax, positions=[1])

plot2 = df2.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "red", linewidth = 1.5), ax=ax, positions=[2])

plot3 = df3.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "red", linewidth = 1.5), ax=ax, positions=[3])

plot4 = df4.boxplot(column = ['iteration_execution_time'], vert=True, patch_artist=True, showfliers = False, medianprops = dict(color = "red", linewidth = 1.5), ax=ax, positions=[4])
...
plt.suptitle('')
plt.savefig("gnmi_performance_measurements_translation_and_materialization_old.png", format="png", dpi=1500)
plt.show()