...
raw_gnmi_df1 = pd.read_csv('gnmi_performance_measurements_translation_and_materialization_12ifaces-orion.csv')
...
raw_gnmi_df2 = pd.read_csv('gnmi_performance_measurements_translation_and_materialization_24ifaces-orion.csv')
...
raw_gnmi_df3 = pd.read_csv('gnmi_performance_measurements_translation_and_materialization_36ifaces-orion.csv')
...
raw_gnmi_df4 = pd.read_csv('gnmi_performance_measurements_translation_and_materialization_48ifaces-orion.csv')
...
netconf_df1 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_12ifaces-orion.csv')
netconf_df2 = pd.read_csv('netconf_performance_measurements_translation_and_materialization_24ifaces-orion.csv')
