...
df_materialization = pd.read_csv('performance_measurements-netconf-materialization-1.csv')
...
df_virtualization_context_broker = pd.read_csv('performance_measurements-netconf-virtualization-1-cb.csv')
...
df_virtualization_context_source = pd.read_csv('performance_measurements-netconf-virtualization-1-cs.csv')
...
df_virtualization_context_broker = pd.read_csv('performance_measurements-netconf-virtualization-2-cb.csv')
...
df_virtualization_context_source = pd.read_csv('performance_measurements-netconf-virtualization-2-cs.csv')
...
df_virtualization_context_broker = pd.read_csv('performance_measurements-netconf-virtualization-3-cb.csv')
...
df_virtualization_context_source = pd.read_csv('performance_measurements-netconf-virtualization-3-cs.csv')
...
materialization_files = [
    'performance_measurements-netconf-materialization-1.csv',
    'performance_measurements-netconf-materialization-2.csv',
    'performance_measurements-netconf-materialization-3.csv'
]
...
virtualization_cb_files = [
    'performance_measurements-netconf-virtualization-1-cb.csv',
    'performance_measurements-netconf-virtualization-2-cb.csv',
    'performance_measurements-netconf-virtualization-3-cb.csv'
]
...
virtualization_cs_files = [
    'performance_measurements-netconf-virtualization-1-cs.csv',
    'performance_measurements-netconf-virtualization-2-cs.csv',
    'performance_measurements-netconf-virtualization-3-cs.csv'
]
