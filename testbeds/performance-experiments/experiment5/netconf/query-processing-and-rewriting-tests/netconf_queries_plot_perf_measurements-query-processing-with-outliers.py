...
ax.text(0.05, 0.95, text_outliers_operation_materialization , transform=ax.transAxes,
...
ax.text(0.95, 0.95, text_outliers_cb_translation_virtualization, transform=ax.transAxes,
