...
INPUT_CSV = "performance_measurements_operation-netconf-virtualization-3-cb.csv"
OUTPUT_CSV = "performance_measurements_operation-netconf-virtualization-3-cb-output.csv"
...
def isoformat_z(ts):
    """Returns datetime in ISO8601 format with Z instead of +00:00, with full available precision."""
