...
class InterfaceIpv6(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceIpv6.")
    ...
    enabled: Optional[InterfaceIpv6Enabled] = None
    forwarding: Optional[InterfaceIpv6Forwarding] = None
    mtu: Optional[InterfaceIpv6Mtu] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceIpv6'):
            raise ValueError("must be one of enum values ('InterfaceIpv6')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceIpv6',
            ...
            "enabled": InterfaceIpv6Enabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "forwarding": InterfaceIpv6Forwarding.from_dict(obj["forwarding"]) if obj.get("forwarding") is not None else None,
            "mtu": InterfaceIpv6Mtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
