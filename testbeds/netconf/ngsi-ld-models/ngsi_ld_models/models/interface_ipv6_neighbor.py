...
class InterfaceIpv6Neighbor(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceIpv6Neighbor.")
    ...
    ip: Optional[InterfaceIpv6NeighborIp] = None
    link_layer_address: InterfaceIpv6NeighborLinkLayerAddress = Field(alias="linkLayerAddress")
    origin: Optional[InterfaceIpv6NeighborOrigin] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ip": InterfaceIpv6NeighborIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceIpv6NeighborLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
            "origin": InterfaceIpv6NeighborOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "isRouter": IsRouter.from_dict(obj["isRouter"]) if obj.get("isRouter") is not None else None,
