...
class TestInterfaceIpv6Mtu(unittest.TestCase):
    """InterfaceIpv6Mtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceIpv6Mtu:
        """Test InterfaceIpv6Mtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceIpv6Mtu`
        """
        model = InterfaceIpv6Mtu()
        if include_optional:
            return InterfaceIpv6Mtu(
                type = 'Property',
                value = 1280,
