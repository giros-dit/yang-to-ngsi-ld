...
class Operation(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["type", "value", "observedAt", "unitCode", "datasetId", "createdAt", "modifiedAt", "deletedAt", "instanceId", "previousValue", "entityType", "entityId", "getOption", "subscriptionMode", "subscriptionState"]
