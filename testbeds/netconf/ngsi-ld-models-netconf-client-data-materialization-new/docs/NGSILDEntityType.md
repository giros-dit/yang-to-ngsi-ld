...
NGSI-LD Property Type. NGSI-LD Entity Type. Short hand string (type name) is allowed. 
...
```python
from ngsi_ld_models_netconf_client_data_materialization_new.models.ngsild_entity_type import NGSILDEntityType
