...
class Operation(BaseModel):
    ...
    xpath: Optional[Xpath] = None
    __properties: ClassVar[List[str]] = ["type", "value", "observedAt", "unitCode", "datasetId", "createdAt", "modifiedAt", "deletedAt", "instanceId", "previousValue", "getOption", "subscriptionMode", "subscriptionState", "xpath"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of xpath
        if self.xpath:
            _dict['xpath'] = self.xpath.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "xpath": Xpath.from_dict(obj["xpath"]) if obj.get("xpath") is not None else None
        })
        return _obj
