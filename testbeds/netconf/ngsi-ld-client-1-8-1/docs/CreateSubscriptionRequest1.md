...
create_subscription_request1_instance = CreateSubscriptionRequest1.from_json(json)
# print the JSON string representation of the object
print(CreateSubscriptionRequest1.to_json())

# convert the object into a dict
create_subscription_request1_dict = create_subscription_request1_instance.to_dict()
# create an instance of CreateSubscriptionRequest1 from a dict
create_subscription_request1_from_dict = CreateSubscriptionRequest1.from_dict(create_subscription_request1_dict)
```
