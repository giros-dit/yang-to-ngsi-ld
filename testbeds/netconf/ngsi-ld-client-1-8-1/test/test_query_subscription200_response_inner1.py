...
class TestQuerySubscription200ResponseInner1(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QuerySubscription200ResponseInner1:
        ...
        """
        model = QuerySubscription200ResponseInner1()
        if include_optional:
            return QuerySubscription200ResponseInner1(
                ...
                csf = '',
                is_active = True,
                notification = ngsi_ld_client_1_8_1.models.notification_params.NotificationParams(
                    attributes = [
                        ''
                        ], 
                    sys_attrs = True, 
