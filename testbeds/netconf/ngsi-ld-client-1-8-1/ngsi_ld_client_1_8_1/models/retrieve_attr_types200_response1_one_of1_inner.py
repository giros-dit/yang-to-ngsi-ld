...
class RetrieveAttrTypes200Response1OneOf1Inner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "attributeName", "attributeCount", "attributeTypes", "typeNames", "@context"]
