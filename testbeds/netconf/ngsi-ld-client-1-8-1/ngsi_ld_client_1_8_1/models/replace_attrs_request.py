...
REPLACEATTRSREQUEST_ONE_OF_SCHEMAS = ["GeoProperty", "JsonProperty", "LanguageProperty", "ListProperty", "ListRelationship", "ModelProperty", "Relationship", "VocabProperty"]
...
class ReplaceAttrsRequest(BaseModel):
    ...
    oneof_schema_5_validator: Optional[VocabProperty] = None
    # data type: JsonProperty
    oneof_schema_6_validator: Optional[JsonProperty] = None
    # data type: ListProperty
    oneof_schema_7_validator: Optional[ListProperty] = None
    # data type: ListRelationship
    oneof_schema_8_validator: Optional[ListRelationship] = None
    actual_instance: Optional[Union[GeoProperty, JsonProperty, LanguageProperty, ListProperty, ListRelationship, ModelProperty, Relationship, VocabProperty]] = None
    one_of_schemas: Set[str] = { "GeoProperty", "JsonProperty", "LanguageProperty", "ListProperty", "ListRelationship", "ModelProperty", "Relationship", "VocabProperty" }
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when setting `actual_instance` in ReplaceAttrsRequest with oneOf schemas: GeoProperty, JsonProperty, LanguageProperty, ListProperty, ListRelationship, ModelProperty, Relationship, VocabProperty. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when setting `actual_instance` in ReplaceAttrsRequest with oneOf schemas: GeoProperty, JsonProperty, LanguageProperty, ListProperty, ListRelationship, ModelProperty, Relationship, VocabProperty. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if match > 1:
            # more than 1 match
            raise ValueError("Multiple matches found when deserializing the JSON string into ReplaceAttrsRequest with oneOf schemas: GeoProperty, JsonProperty, LanguageProperty, ListProperty, ListRelationship, ModelProperty, Relationship, VocabProperty. Details: " + ", ".join(error_messages))
        elif match == 0:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ReplaceAttrsRequest with oneOf schemas: GeoProperty, JsonProperty, LanguageProperty, ListProperty, ListRelationship, ModelProperty, Relationship, VocabProperty. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], GeoProperty, JsonProperty, LanguageProperty, ListProperty, ListRelationship, ModelProperty, Relationship, VocabProperty]]:
