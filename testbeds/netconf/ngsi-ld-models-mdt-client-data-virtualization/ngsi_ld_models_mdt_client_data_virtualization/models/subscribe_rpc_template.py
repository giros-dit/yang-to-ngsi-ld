...
class SubscribeRpcTemplate(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SubscribeRpcTemplate.")
    ...
    subscription_mode: SubscriptionMode = Field(alias="subscriptionMode")
    uses_protocol: UsesProtocol = Field(alias="usesProtocol")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "subscriptionMode", "usesProtocol"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SubscribeRpcTemplate']):
            raise ValueError("must be one of enum values ('SubscribeRpcTemplate')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of uses_protocol
        if self.uses_protocol:
            _dict['usesProtocol'] = self.uses_protocol.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SubscribeRpcTemplate',
            ...
            "usesProtocol": UsesProtocol.from_dict(obj["usesProtocol"]) if obj.get("usesProtocol") is not None else None
        })
