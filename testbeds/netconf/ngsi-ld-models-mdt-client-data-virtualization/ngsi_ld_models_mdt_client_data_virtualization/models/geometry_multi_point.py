...
class GeometryMultiPoint(BaseModel):
    ...
    coordinates: Optional[List[Annotated[List[Union[StrictFloat, StrictInt]], Field(min_length=2, max_length=3)]]] = Field(default=None, description="An array of positions. ")
