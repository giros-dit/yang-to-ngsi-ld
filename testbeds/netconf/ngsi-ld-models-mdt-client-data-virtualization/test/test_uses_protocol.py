...
class TestUsesProtocol(unittest.TestCase):
    """UsesProtocol unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsesProtocol:
        """Test UsesProtocol
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsesProtocol`
        """
        model = UsesProtocol()
        if include_optional:
            return UsesProtocol(
