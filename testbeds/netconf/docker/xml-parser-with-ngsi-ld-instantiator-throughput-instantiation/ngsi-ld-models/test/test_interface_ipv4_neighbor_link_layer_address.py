...
class TestInterfaceIpv4NeighborLinkLayerAddress(unittest.TestCase):
    """InterfaceIpv4NeighborLinkLayerAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceIpv4NeighborLinkLayerAddress:
        """Test InterfaceIpv4NeighborLinkLayerAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceIpv4NeighborLinkLayerAddress`
        """
        model = InterfaceIpv4NeighborLinkLayerAddress()
        if include_optional:
            return InterfaceIpv4NeighborLinkLayerAddress(
                type = 'Property',
    ...
    def testInterfaceIpv4NeighborLinkLayerAddress(self):
        """Test InterfaceIpv4NeighborLinkLayerAddress"""
