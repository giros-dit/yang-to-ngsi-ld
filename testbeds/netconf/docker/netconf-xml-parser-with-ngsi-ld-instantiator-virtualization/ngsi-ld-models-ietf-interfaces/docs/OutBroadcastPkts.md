...
```python
from ngsi_ld_models_ietf_interfaces.models.out_broadcast_pkts import OutBroadcastPkts
...
out_broadcast_pkts_from_dict = OutBroadcastPkts.from_dict(out_broadcast_pkts_dict)
```
