...
```python
from ngsi_ld_models_ietf_interfaces.models.create_temporary_addresses import CreateTemporaryAddresses
...
create_temporary_addresses_from_dict = CreateTemporaryAddresses.from_dict(create_temporary_addresses_dict)
```
