...
Indicates whether IPv6 packet forwarding is enabled or disabled on this interface.  Reference: RFC 4861: Neighbor Discovery for IP version 6 (IPv6)      Section 6.2.1, IsRouter  YANG module: ietf-ip.yang 
...
```python
from ngsi_ld_models_ietf_interfaces.models.interface_ipv6_forwarding import InterfaceIpv6Forwarding
...
interface_ipv6_forwarding_from_dict = InterfaceIpv6Forwarding.from_dict(interface_ipv6_forwarding_dict)
```
