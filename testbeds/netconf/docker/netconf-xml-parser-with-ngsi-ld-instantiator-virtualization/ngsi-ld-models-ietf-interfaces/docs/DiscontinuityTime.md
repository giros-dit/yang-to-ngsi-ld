...
```python
from ngsi_ld_models_ietf_interfaces.models.discontinuity_time import DiscontinuityTime
...
discontinuity_time_from_dict = DiscontinuityTime.from_dict(discontinuity_time_dict)
```
