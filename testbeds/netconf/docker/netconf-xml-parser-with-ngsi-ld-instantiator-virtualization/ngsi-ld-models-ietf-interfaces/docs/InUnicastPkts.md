...
```python
from ngsi_ld_models_ietf_interfaces.models.in_unicast_pkts import InUnicastPkts
...
in_unicast_pkts_from_dict = InUnicastPkts.from_dict(in_unicast_pkts_dict)
```
