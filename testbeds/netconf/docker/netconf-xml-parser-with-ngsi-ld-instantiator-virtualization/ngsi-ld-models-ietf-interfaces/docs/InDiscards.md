...
```python
from ngsi_ld_models_ietf_interfaces.models.in_discards import InDiscards
...
in_discards_from_dict = InDiscards.from_dict(in_discards_dict)
```
