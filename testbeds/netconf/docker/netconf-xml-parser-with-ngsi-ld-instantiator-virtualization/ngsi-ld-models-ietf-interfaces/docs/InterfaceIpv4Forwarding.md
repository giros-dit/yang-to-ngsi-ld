# InterfaceIpv4Forwarding

Indicates whether IPv4 packet forwarding is enabled or disabled on this interface.  YANG module: ietf-ip.yang 
...
```python
from ngsi_ld_models_ietf_interfaces.models.interface_ipv4_forwarding import InterfaceIpv4Forwarding
...
interface_ipv4_forwarding_from_dict = InterfaceIpv4Forwarding.from_dict(interface_ipv4_forwarding_dict)
```
