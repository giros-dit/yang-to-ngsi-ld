...
class TestInterfaceConfigIpv4AddressSubnetNetmask(unittest.TestCase):
    """InterfaceConfigIpv4AddressSubnetNetmask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigIpv4AddressSubnetNetmask:
        """Test InterfaceConfigIpv4AddressSubnetNetmask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigIpv4AddressSubnetNetmask`
        """
        model = InterfaceConfigIpv4AddressSubnetNetmask()
        if include_optional:
            return InterfaceConfigIpv4AddressSubnetNetmask(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testInterfaceConfigIpv4AddressSubnetNetmask(self):
        """Test InterfaceConfigIpv4AddressSubnetNetmask"""
