...
class TestInterfaceConfigIpv4(unittest.TestCase):
    """InterfaceConfigIpv4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigIpv4:
        """Test InterfaceConfigIpv4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigIpv4`
        """
        model = InterfaceConfigIpv4()
        if include_optional:
            return InterfaceConfigIpv4(
                id = '',
                type = 'InterfaceConfigIpv4',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceConfigIpv4(self):
        """Test InterfaceConfigIpv4"""
