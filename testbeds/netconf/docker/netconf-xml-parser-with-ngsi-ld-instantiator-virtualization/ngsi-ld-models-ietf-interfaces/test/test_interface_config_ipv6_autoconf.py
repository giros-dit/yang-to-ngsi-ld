...
class TestInterfaceConfigIpv6Autoconf(unittest.TestCase):
    """InterfaceConfigIpv6Autoconf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigIpv6Autoconf:
        """Test InterfaceConfigIpv6Autoconf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigIpv6Autoconf`
        """
        model = InterfaceConfigIpv6Autoconf()
        if include_optional:
            return InterfaceConfigIpv6Autoconf(
                id = '',
                type = 'InterfaceConfigIpv6Autoconf',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceConfigIpv6Autoconf(self):
        """Test InterfaceConfigIpv6Autoconf"""
