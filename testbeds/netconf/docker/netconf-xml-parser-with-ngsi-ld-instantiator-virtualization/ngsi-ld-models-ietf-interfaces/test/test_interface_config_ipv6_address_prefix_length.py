...
class TestInterfaceConfigIpv6AddressPrefixLength(unittest.TestCase):
    """InterfaceConfigIpv6AddressPrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigIpv6AddressPrefixLength:
        """Test InterfaceConfigIpv6AddressPrefixLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigIpv6AddressPrefixLength`
        """
        model = InterfaceConfigIpv6AddressPrefixLength()
        if include_optional:
            return InterfaceConfigIpv6AddressPrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceConfigIpv6AddressPrefixLength(self):
        """Test InterfaceConfigIpv6AddressPrefixLength"""
