...
class InterfaceIpv6AddressOrigin(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['other', 'static', 'dhcp', 'link-layer', 'random']):
            raise ValueError("must be one of enum values ('other', 'static', 'dhcp', 'link-layer', 'random')")
        return value
