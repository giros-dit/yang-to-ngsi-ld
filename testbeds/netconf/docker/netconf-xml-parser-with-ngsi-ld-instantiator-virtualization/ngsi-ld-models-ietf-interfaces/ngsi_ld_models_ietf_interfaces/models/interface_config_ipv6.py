...
class InterfaceConfigIpv6(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceConfigIpv6.")
    ...
    enabled: Optional[InterfaceConfigIpv6Enabled] = None
    forwarding: Optional[InterfaceConfigIpv6Forwarding] = None
    mtu: Optional[InterfaceConfigIpv6Mtu] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceConfigIpv6']):
            raise ValueError("must be one of enum values ('InterfaceConfigIpv6')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceConfigIpv6',
            ...
            "enabled": InterfaceConfigIpv6Enabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "forwarding": InterfaceConfigIpv6Forwarding.from_dict(obj["forwarding"]) if obj.get("forwarding") is not None else None,
            "mtu": InterfaceConfigIpv6Mtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dupAddrDetectTransmits": DupAddrDetectTransmits.from_dict(obj["dupAddrDetectTransmits"]) if obj.get("dupAddrDetectTransmits") is not None else None,
