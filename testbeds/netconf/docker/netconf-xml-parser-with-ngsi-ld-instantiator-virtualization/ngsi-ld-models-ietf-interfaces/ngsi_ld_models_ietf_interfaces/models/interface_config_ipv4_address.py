...
class InterfaceConfigIpv4Address(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceConfigIpv4Address.")
    ...
    ip: Optional[InterfaceConfigIpv4AddressIp] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ip", "prefixLength", "netmask", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceConfigIpv4Address']):
            raise ValueError("must be one of enum values ('InterfaceConfigIpv4Address')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceConfigIpv4Address',
            ...
            "ip": InterfaceConfigIpv4AddressIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
