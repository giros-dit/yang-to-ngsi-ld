...
class InterfaceIpv6Address(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceIpv6Address.")
    ...
    ip: Optional[InterfaceIpv6AddressIp] = None
    prefix_length: InterfaceIpv6AddressPrefixLength = Field(alias="prefixLength")
    origin: Optional[InterfaceIpv6AddressOrigin] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceIpv6Address']):
            raise ValueError("must be one of enum values ('InterfaceIpv6Address')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceIpv6Address',
            ...
            "ip": InterfaceIpv6AddressIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceIpv6AddressPrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
            "origin": InterfaceIpv6AddressOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
