...
import ngsi_ld_models_netconf_client_data_virtualization
...
from network_controller_virtualization.ncclient_collector import get_operation, set_operation
...
async def subscribe_operation(host: str, port: str, username: str, password: str, family: str, xpath: str, subscriptionMode: str, period: str, subscription_id: str, hostKeyVerify: Optional[bool] = False, sysAttrs: Optional[bool] = False):
    ...
    subscription_template = Template(open('./network_controller_virtualization/jinja2-templates/yang-push-subscriptions.xml').read())
...
async def post_entities(entity: dict):
    try:
        ...
        set_operation(host=host, port=port, username=username, password=password, family=family, xpath=xpath, instance=entity_match, all_context_data=all_context_data)
