...
from netconf_notifier_tester_virtualization_on_change_context_source.check_client import NGSILDHealthInfoClient
...
CONTEXT_SOURCE_URI = os.getenv("CONTEXT_SOURCE_URI", "http://netconf-network-controller-virtualization:8089/ngsi-ld/v1")
...
# Notifier
NOTIFIER_URI = os.getenv("NOTIFIER_URI", "http://netconf-notifier-tester-virtualization-on-change:8082/notify")
...
performance_measurements_file = open("/opt/netconf-notifier-tester-virtualization-on-change-context-source/netconf_notifier_tester_virtualization_on_change_context_source/performance_measurements.csv", "w", newline='')
...
notification_performance_measurements_file = open("/opt/netconf-notifier-tester-virtualization-on-change-context-source/netconf_notifier_tester_virtualization_on_change_context_source/notification_performance_measurements.csv", "w", newline='')
