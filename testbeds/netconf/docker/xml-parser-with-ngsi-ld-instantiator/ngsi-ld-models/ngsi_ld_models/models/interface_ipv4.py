...
class InterfaceIpv4(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceIpv4.")
    ...
    enabled: Optional[InterfaceIpv4Enabled] = None
    forwarding: Optional[InterfaceIpv4Forwarding] = None
    mtu: Optional[InterfaceIpv4Mtu] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceIpv4'):
            raise ValueError("must be one of enum values ('InterfaceIpv4')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceIpv4',
            ...
            "enabled": InterfaceIpv4Enabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "forwarding": InterfaceIpv4Forwarding.from_dict(obj["forwarding"]) if obj.get("forwarding") is not None else None,
            "mtu": InterfaceIpv4Mtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
