...
class Subnet(BaseModel):
    ...
    def actual_instance_must_validate_oneof(cls, v):
        instance = Subnet.model_construct()
        error_messages = []
        match = 0
        # validate data type: SubnetPrefixLength
        if not isinstance(v, SubnetPrefixLength):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # deserialize data into SubnetPrefixLength
        try:
            instance.actual_instance = SubnetPrefixLength.from_json(json_str)
            match += 1
