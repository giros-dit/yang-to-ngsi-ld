...
```python
from ngsi_ld_models.models.interface_ipv6_neighbor_origin import InterfaceIpv6NeighborOrigin
...
interface_ipv6_neighbor_origin_form_dict = interface_ipv6_neighbor_origin.from_dict(interface_ipv6_neighbor_origin_dict)
```
