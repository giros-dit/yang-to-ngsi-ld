...
class TestSubnetPrefixLength(unittest.TestCase):
    """SubnetPrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubnetPrefixLength:
        """Test SubnetPrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubnetPrefixLength`
        """
        model = SubnetPrefixLength()
        if include_optional:
    ...
    def testSubnetPrefixLength(self):
        """Test SubnetPrefixLength"""
