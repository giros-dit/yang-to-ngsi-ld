...
class TestInterfaceIpv6NeighborLinkLayerAddress(unittest.TestCase):
    """InterfaceIpv6NeighborLinkLayerAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceIpv6NeighborLinkLayerAddress:
        """Test InterfaceIpv6NeighborLinkLayerAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceIpv6NeighborLinkLayerAddress`
        """
        model = InterfaceIpv6NeighborLinkLayerAddress()
        if include_optional:
            return InterfaceIpv6NeighborLinkLayerAddress(
                type = 'Property',
    ...
    def testInterfaceIpv6NeighborLinkLayerAddress(self):
        """Test InterfaceIpv6NeighborLinkLayerAddress"""
