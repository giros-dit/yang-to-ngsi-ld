...
from netconf_query_tester_virtualization_context_broker.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/netconf-query-tester-virtualization-context-broker/netconf_query_tester_virtualization_context_broker/performance_measurements.csv", "w", newline='')
