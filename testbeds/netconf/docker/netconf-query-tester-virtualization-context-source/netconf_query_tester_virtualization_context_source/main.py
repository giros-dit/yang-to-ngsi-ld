...
from netconf_query_tester_virtualization_context_source.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/netconf-query-tester-virtualization-context-source/netconf_query_tester_virtualization_context_source/performance_measurements.csv", "w", newline='')
