...
from notifier_tester_virtualization_on_change_context_source_new.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/notifier-tester-virtualization-on-change-context-source-new/notifier_tester_virtualization_on_change_context_source_new/performance_measurements.csv", "w", newline='')
...
notification_performance_measurements_file = open("/opt/notifier-tester-virtualization-on-change-context-source-new/notifier_tester_virtualization_on_change_context_source_new/notification_performance_measurements.csv", "w", newline='')
