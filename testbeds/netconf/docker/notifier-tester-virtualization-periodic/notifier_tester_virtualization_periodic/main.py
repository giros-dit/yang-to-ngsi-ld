...
from notifier_tester_virtualization_periodic.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/notifier-tester-virtualization-periodic/notifier_tester_virtualization_periodic/performance_measurements.csv", "w", newline='')
...
notification_performance_measurements_file = open("/opt/notifier-tester-virtualization-periodic/notifier_tester_virtualization_periodic/notification_performance_measurements.csv", "w", newline='')
