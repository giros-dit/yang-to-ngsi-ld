...
from network_controller_virtualization_new.check_client import NGSILDHealthInfoClient
from network_controller_virtualization_new.context_client import ContextCatalogClient
from network_controller_virtualization_new.ncclient_collector import get_operation, set_operation, get_xpath_in_context_catalog, get_xpath_with_keys
...
async def subscribe_operation(host: str, port: str, username: str, password: str, family: str, entity_type: str, entity_id: str, subscriptionMode: str, period: str, subscription_id: str, all_context_data: Optional[dict] = None, hostKeyVerify: Optional[bool] = False, sysAttrs: Optional[bool] = False, all_context_registries: Optional[list] = None):
    ...
    subscription_template = Template(open('./network_controller_virtualization_new/jinja2-templates/yang-push-subscriptions.xml').read())
...
async def listen_to_kafka_subscriptions(notification_endpoint, subscription_id, entity_type, entity_id = None):
    ...
    exec_times = []
    performance_measurements_file = open("/opt/network-controller-virtualization-new/network_controller_virtualization_new/performance_measurements.csv", "w", newline='')
