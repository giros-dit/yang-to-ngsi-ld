...
from notifier_tester_virtualization_on_change_context_source_new_alternative.check_client import NGSILDHealthInfoClient
...
from ngsi_ld_models_netconf_client_data_virtualization_new.models.subscription_mode import SubscriptionMode
from ngsi_ld_models_netconf_client_data_virtualization_new.models.period import Period
...
performance_measurements_file = open("/opt/notifier-tester-virtualization-on-change-context-source-new-alternative/notifier_tester_virtualization_on_change_context_source_new_alternative/performance_measurements.csv", "w", newline='')
...
notification_performance_measurements_file = open("/opt/notifier-tester-virtualization-on-change-context-source-new-alternative/notifier_tester_virtualization_on_change_context_source_new_alternative/notification_performance_measurements.csv", "w", newline='')
...
async def startup_event():
    ...
    csources = api_instance_csource.query_csr(type="ietf-interfaces:interfaces-state/interface/statistics")
    print(csources)
    if csources != []:
