...
from netconf_query_tester_materialization.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/netconf-query-tester-materialization/netconf_query_tester_materialization/performance_measurements.csv", "w", newline='')
...
async def startup_event():
    ...
    operation_instance = Operation(
        type="Property",
        value="GET",
        entityType={"type": "Property", "value": "ietf-interfaces:interfaces-state/interface"},
        #entityId={"type": "Property", "value": "urn:ngsi-ld:Interface:clab-telemetry-ixiac-lab:r1:GigabitEthernet2"},
    ...
    while True:
        ...
        while True:
            ...
            try:                
                ...
                api_response = api_instance_consumption.query_entity(type='ietf-interfaces:interfaces-state/interface')
                # api_response = api_instance_consumption.query_entity(type='Interface')
        
                if api_response and len(api_response) == 3:
        ...
        try:
            ...
            api_instance_provision.delete_entity(entity_id='urn:ngsi-ld:Interface:clab-telemetry-ixiac-lab:r1:GigabitEthernet1')
        except Exception as e:
        ...
        try:
            # Delete NGSI-LD Entity by id: DELETE /entities/{entityId}
            api_instance_provision.delete_entity(entity_id='urn:ngsi-ld:Interface:clab-telemetry-ixiac-lab:r1:GigabitEthernet3')
        except Exception as e:
            logger.exception("Exception when calling ContextInformationProvisionApi->delete_entity: %s\n" % e)
        sleep(5)