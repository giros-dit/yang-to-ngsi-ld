...
class TestInterfaceConfigIpv6Neighbor(unittest.TestCase):
    """InterfaceConfigIpv6Neighbor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigIpv6Neighbor:
        """Test InterfaceConfigIpv6Neighbor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigIpv6Neighbor`
        """
        model = InterfaceConfigIpv6Neighbor()
        if include_optional:
            return InterfaceConfigIpv6Neighbor(
                id = '',
                type = 'InterfaceConfigIpv6Neighbor',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceConfigIpv6Neighbor(self):
        """Test InterfaceConfigIpv6Neighbor"""
