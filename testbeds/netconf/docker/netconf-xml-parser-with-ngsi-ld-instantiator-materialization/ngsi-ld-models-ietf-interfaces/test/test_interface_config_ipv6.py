...
class TestInterfaceConfigIpv6(unittest.TestCase):
    """InterfaceConfigIpv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigIpv6:
        """Test InterfaceConfigIpv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigIpv6`
        """
        model = InterfaceConfigIpv6()
        if include_optional:
            return InterfaceConfigIpv6(
                id = '',
                type = 'InterfaceConfigIpv6',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceConfigIpv6(self):
        """Test InterfaceConfigIpv6"""
