...
class TestInterfaceConfigEnabled(unittest.TestCase):
    """InterfaceConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigEnabled:
        """Test InterfaceConfigEnabled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigEnabled`
        """
        model = InterfaceConfigEnabled()
        if include_optional:
            return InterfaceConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceConfigEnabled(self):
        """Test InterfaceConfigEnabled"""
