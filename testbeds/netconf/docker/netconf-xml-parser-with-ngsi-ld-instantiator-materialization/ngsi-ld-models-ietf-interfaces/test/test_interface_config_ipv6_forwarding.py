...
class TestInterfaceConfigIpv6Forwarding(unittest.TestCase):
    """InterfaceConfigIpv6Forwarding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigIpv6Forwarding:
        """Test InterfaceConfigIpv6Forwarding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigIpv6Forwarding`
        """
        model = InterfaceConfigIpv6Forwarding()
        if include_optional:
            return InterfaceConfigIpv6Forwarding(
                type = 'Property',
                value = True,
    ...
    def testInterfaceConfigIpv6Forwarding(self):
        """Test InterfaceConfigIpv6Forwarding"""
