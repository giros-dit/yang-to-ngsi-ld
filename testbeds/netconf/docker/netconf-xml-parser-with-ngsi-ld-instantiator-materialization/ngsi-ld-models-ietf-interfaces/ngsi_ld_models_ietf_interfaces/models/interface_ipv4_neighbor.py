...
class InterfaceIpv4Neighbor(BaseModel):
    ...
    ip: Optional[InterfaceIpv4NeighborIp] = None
    link_layer_address: Optional[InterfaceIpv4NeighborLinkLayerAddress] = Field(default=None, alias="linkLayerAddress")
    origin: Optional[InterfaceIpv4NeighborOrigin] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceIpv4Neighbor']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ip": InterfaceIpv4NeighborIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceIpv4NeighborLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
            "origin": InterfaceIpv4NeighborOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
