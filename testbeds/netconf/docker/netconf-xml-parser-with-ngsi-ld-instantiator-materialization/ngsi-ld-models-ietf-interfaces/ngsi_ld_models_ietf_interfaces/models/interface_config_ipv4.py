...
class InterfaceConfigIpv4(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceConfigIpv4.")
    ...
    enabled: Optional[InterfaceConfigIpv4Enabled] = None
    forwarding: Optional[InterfaceConfigIpv4Forwarding] = None
    mtu: Optional[InterfaceConfigIpv4Mtu] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "enabled", "forwarding", "mtu", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceConfigIpv4']):
            raise ValueError("must be one of enum values ('InterfaceConfigIpv4')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceConfigIpv4',
            ...
            "enabled": InterfaceConfigIpv4Enabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "forwarding": InterfaceConfigIpv4Forwarding.from_dict(obj["forwarding"]) if obj.get("forwarding") is not None else None,
            "mtu": InterfaceConfigIpv4Mtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
