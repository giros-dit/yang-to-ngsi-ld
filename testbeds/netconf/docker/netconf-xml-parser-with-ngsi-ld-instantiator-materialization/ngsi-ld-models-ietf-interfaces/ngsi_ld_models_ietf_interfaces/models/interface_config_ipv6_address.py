...
class InterfaceConfigIpv6Address(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceConfigIpv6Address.")
    ...
    ip: Optional[InterfaceConfigIpv6AddressIp] = None
    prefix_length: InterfaceConfigIpv6AddressPrefixLength = Field(alias="prefixLength")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceConfigIpv6Address']):
            raise ValueError("must be one of enum values ('InterfaceConfigIpv6Address')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceConfigIpv6Address',
            ...
            "ip": InterfaceConfigIpv6AddressIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceConfigIpv6AddressPrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
