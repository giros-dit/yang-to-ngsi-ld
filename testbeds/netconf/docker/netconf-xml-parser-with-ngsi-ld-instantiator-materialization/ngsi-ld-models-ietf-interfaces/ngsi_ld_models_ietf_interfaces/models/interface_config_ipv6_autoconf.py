...
class InterfaceConfigIpv6Autoconf(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceConfigIpv6Autoconf.")
    ...
    temporary_valid_lifetime: Optional[TemporaryValidLifetime] = Field(default=None, alias="temporaryValidLifetime")
    temporary_preferred_lifetime: Optional[TemporaryPreferredLifetime] = Field(default=None, alias="temporaryPreferredLifetime")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceConfigIpv6Autoconf']):
            raise ValueError("must be one of enum values ('InterfaceConfigIpv6Autoconf')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of temporary_valid_lifetime
        if self.temporary_valid_lifetime:
            _dict['temporaryValidLifetime'] = self.temporary_valid_lifetime.to_dict()
        # override the default output from pydantic by calling `to_dict()` of temporary_preferred_lifetime
        if self.temporary_preferred_lifetime:
            _dict['temporaryPreferredLifetime'] = self.temporary_preferred_lifetime.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceConfigIpv6Autoconf',
            ...
            "createGlobalAddresses": CreateGlobalAddresses.from_dict(obj["createGlobalAddresses"]) if obj.get("createGlobalAddresses") is not None else None,
            "createTemporaryAddresses": CreateTemporaryAddresses.from_dict(obj["createTemporaryAddresses"]) if obj.get("createTemporaryAddresses") is not None else None,
            "temporaryValidLifetime": TemporaryValidLifetime.from_dict(obj["temporaryValidLifetime"]) if obj.get("temporaryValidLifetime") is not None else None,
            "temporaryPreferredLifetime": TemporaryPreferredLifetime.from_dict(obj["temporaryPreferredLifetime"]) if obj.get("temporaryPreferredLifetime") is not None else None,
