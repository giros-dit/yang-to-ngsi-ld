...
```python
from ngsi_ld_models_ietf_interfaces.models.dup_addr_detect_transmits import DupAddrDetectTransmits
...
dup_addr_detect_transmits_from_dict = DupAddrDetectTransmits.from_dict(dup_addr_detect_transmits_dict)
```
