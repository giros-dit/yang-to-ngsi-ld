...
```python
from ngsi_ld_models_ietf_interfaces.models.interface_ipv4_neighbor_ip import InterfaceIpv4NeighborIp
...
interface_ipv4_neighbor_ip_from_dict = InterfaceIpv4NeighborIp.from_dict(interface_ipv4_neighbor_ip_dict)
```
