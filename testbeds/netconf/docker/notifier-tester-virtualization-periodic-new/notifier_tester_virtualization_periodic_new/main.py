...
from notifier_tester_virtualization_periodic_new.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/notifier-tester-virtualization-periodic-new/notifier_tester_virtualization_periodic_new/performance_measurements.csv", "w", newline='')
...
notification_performance_measurements_file = open("/opt/notifier-tester-virtualization-periodic-new/notifier_tester_virtualization_periodic_new/notification_performance_measurements.csv", "w", newline='')
