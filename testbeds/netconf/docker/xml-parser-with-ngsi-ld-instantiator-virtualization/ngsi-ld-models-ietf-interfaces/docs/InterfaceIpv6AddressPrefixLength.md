# InterfaceIpv6AddressPrefixLength
...
```python
from ngsi_ld_models_ietf_interfaces.models.interface_ipv6_address_prefix_length import InterfaceIpv6AddressPrefixLength
...
interface_ipv6_address_prefix_length_from_dict = InterfaceIpv6AddressPrefixLength.from_dict(interface_ipv6_address_prefix_length_dict)
```
