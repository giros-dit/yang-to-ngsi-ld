...
from notifier_tester_virtualization_periodic_new_alternative.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/notifier-tester-virtualization-periodic-new-alternative/notifier_tester_virtualization_periodic_new_alternative/performance_measurements.csv", "w", newline='')
...
notification_performance_measurements_file = open("/opt/notifier-tester-virtualization-periodic-new-alternative/notifier_tester_virtualization_periodic_new_alternative/notification_performance_measurements.csv", "w", newline='')
...
async def startup_event():
    ...
    subs_mode_instance = SubscriptionMode(
        type="Property",
        value="periodic",
        period=Period.from_dict({"type": "Property", "value": 10})
    )
