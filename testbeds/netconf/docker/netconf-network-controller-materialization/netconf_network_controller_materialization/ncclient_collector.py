...
performance_measurements_file = open("/opt/netconf-network-controller-materialization/netconf_network_controller_materialization/performance_measurements_operation.csv", "w", newline='')
...
'''
def get_operation(host: str, port: str, username: str, password: str, family: str, entity_type: str, entity_id: str, option: str, notified_at: str, all_context_data: Optional[dict] = None, hostKeyVerify: Optional[bool] = False, all_context_registries: Optional[list] = None):
