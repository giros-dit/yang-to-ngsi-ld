...
'''
def get_operation(host: str, port: str, username: str, password: str, family: str,  entity_type: str, entity_id: str, option: str, all_context_data: Optional[dict] = None, hostKeyVerify: Optional[bool] = False, all_context_registries: Optional[list] = None):
