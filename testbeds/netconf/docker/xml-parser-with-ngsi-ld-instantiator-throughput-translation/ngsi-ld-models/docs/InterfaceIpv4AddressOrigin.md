...
```python
from ngsi_ld_models.models.interface_ipv4_address_origin import InterfaceIpv4AddressOrigin
...
interface_ipv4_address_origin_form_dict = interface_ipv4_address_origin.from_dict(interface_ipv4_address_origin_dict)
```
