...
```python
from ngsi_ld_models.models.temporary_preferred_lifetime import TemporaryPreferredLifetime
...
temporary_preferred_lifetime_form_dict = temporary_preferred_lifetime.from_dict(temporary_preferred_lifetime_dict)
```
