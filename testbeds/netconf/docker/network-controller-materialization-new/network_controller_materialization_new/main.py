...
from network_controller_materialization_new.check_client import NGSILDHealthInfoClient
from network_controller_materialization_new.context_client import ContextCatalogClient
from network_controller_materialization_new.ncclient_collector import get_operation, set_operation, get_xpath_in_context_catalog, get_xpath_with_keys
...
async def subscribe_operation(host: str, port: str, username: str, password: str, family: str, entityType: str, entityId: str, subscriptionMode: str, period: str, entity_id: str, all_context_data: Optional[dict] = None, hostKeyVerify: Optional[bool] = False, all_context_registries: Optional[list] = None):
    ...
    xpath = get_xpath_in_context_catalog(entity_type=entityType, all_context_data=all_context_data)
    ...
    subscription_template = Template(open('./network_controller_materialization_new/jinja2-templates/yang-push-subscriptions.xml').read())
