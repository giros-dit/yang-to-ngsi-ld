...
df = pd.read_csv('performance_measurements_virtualization_periodic.csv')
...
plt.savefig("notifier_tester_virtualization_periodic_perf_graph_entity_created.png")
plt.show()
...
plt.xlabel('notification index')
plt.ylabel('time (in ms)')
plt.savefig("notifier_tester_virtualization_periodic_perf_graph_notification_received.png")
plt.show()