...
plt.title('notification_performance_measurements_materialization_on-change \n Distribution evaluation time per notification until notification received')
plt.savefig("notification_performance_measurements_materialization_on-change_distribution.png", format="png", dpi=1500)
plt.show()