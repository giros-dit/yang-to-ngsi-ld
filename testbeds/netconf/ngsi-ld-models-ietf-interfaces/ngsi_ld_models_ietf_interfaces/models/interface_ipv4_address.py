...
class InterfaceIpv4Address(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceIpv4Address.")
    ...
    ip: Optional[InterfaceIpv4AddressIp] = None
    prefix_length: Optional[InterfaceIpv4AddressSubnetPrefixLength] = Field(default=None, alias="prefixLength")
    netmask: Optional[InterfaceIpv4AddressSubnetNetmask] = None
    origin: Optional[InterfaceIpv4AddressOrigin] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceIpv4Address']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ip": InterfaceIpv4AddressIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceIpv4AddressSubnetPrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
            "netmask": InterfaceIpv4AddressSubnetNetmask.from_dict(obj["netmask"]) if obj.get("netmask") is not None else None,
            "origin": InterfaceIpv4AddressOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
