...
class InterfaceConfigIpv4Neighbor(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceConfigIpv4Neighbor.")
    ...
    ip: Optional[InterfaceConfigIpv4NeighborIp] = None
    link_layer_address: InterfaceConfigIpv4NeighborLinkLayerAddress = Field(alias="linkLayerAddress")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceConfigIpv4Neighbor']):
            raise ValueError("must be one of enum values ('InterfaceConfigIpv4Neighbor')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceConfigIpv4Neighbor',
            ...
            "ip": InterfaceConfigIpv4NeighborIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceConfigIpv4NeighborLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
