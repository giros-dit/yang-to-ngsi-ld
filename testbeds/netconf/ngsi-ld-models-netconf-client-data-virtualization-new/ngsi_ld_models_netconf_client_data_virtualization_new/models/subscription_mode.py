...
class SubscriptionMode(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "value", "observedAt", "unitCode", "datasetId", "createdAt", "modifiedAt", "deletedAt", "instanceId", "previousValue", "period"]
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['on-change', 'periodic']):
            raise ValueError("must be one of enum values ('on-change', 'periodic')")
        return value
