...
class HostFamily(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['junos', 'csr', 'nexus', 'iosxr', 'iosxe', 'huawei', 'huaweiyang', 'alu', 'h3c', 'hpconware', 'default']):
            raise ValueError("must be one of enum values ('junos', 'csr', 'nexus', 'iosxr', 'iosxe', 'huawei', 'huaweiyang', 'alu', 'h3c', 'hpconware', 'default')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value") if obj.get("value") is not None else 'default',
