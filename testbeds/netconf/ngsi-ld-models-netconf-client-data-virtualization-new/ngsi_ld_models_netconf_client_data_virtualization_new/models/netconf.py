...
class NETCONF(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "host", "port", "username", "password", "hostFamily", "hostKeyVerify", "subscriptionMode"]
