...
class RpcOperation(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default='RpcOperation', description="NGSI-LD Entity identifier. It has to be RpcOperation.")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "operation", "usesProtocol"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['RpcOperation']):
            raise ValueError("must be one of enum values ('RpcOperation')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'RpcOperation',
