...
class Protocol(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be Protocol.")
    ...
    address: Address
    port: Port
    has_credentials: HasCredentials = Field(alias="hasCredentials")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "address", "port", "hasCredentials"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Protocol']):
            raise ValueError("must be one of enum values ('Protocol')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of has_credentials
        if self.has_credentials:
            _dict['hasCredentials'] = self.has_credentials.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Protocol',
            ...
            "hasCredentials": HasCredentials.from_dict(obj["hasCredentials"]) if obj.get("hasCredentials") is not None else None
        })
