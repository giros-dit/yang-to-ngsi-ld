...
df_netflow_extraction = pd.read_csv('netflow_collector_throughput_measurements_translation-scorpio.csv')
df_netflow_translation = pd.read_csv('json_parser_throughput_measurements_translation-scorpio.csv')
df_netflow_instantiation = pd.read_csv('json_parser_throughput_measurements_instantiation-scorpio.csv')
...
plt.savefig("netflow_notifications_throughput_measurements_events-scorpio.png", format="png", dpi=1500)
...
plt.ylabel('Throughput (events/second)')
plt.title('Throughput for integrating \n NetFlow monitoring data')
plt.savefig("netflow_notifications_throughput_measurements_events_instantiation-scorpio.png", format="png", dpi=1500)
...
plt.title('Throughput for integrating \n NetFlow monitoring data')
plt.savefig("netflow_notifications_throughput_measurements_bytes-scorpio.png", format="png", dpi=1500)
...
plt.ylabel('Throughput (bytes/second)')
plt.title('Throughput for integrating \n NetFlow monitoring data')
plt.savefig("netflow_notifications_throughput_measurements_bytes_instantiation-scorpio.png", format="png", dpi=1500)
