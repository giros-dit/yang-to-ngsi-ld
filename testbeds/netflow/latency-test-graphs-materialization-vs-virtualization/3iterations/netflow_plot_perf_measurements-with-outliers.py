...
df_materialization_notification = pd.read_csv('notification_performance_measurements_materialization-iteration-1.csv')
all_materialization_data.append(df_materialization_notification['evaluation_time'])

print("NetFlow v9 performance measurements for YANG to NGSI-LD translation using data materialization - Iteration 1: \n")
...
df_virtualization_notification = pd.read_csv('notification_performance_measurements_virtualization-iteration-1.csv')
all_virtualization_data.append(df_virtualization_notification['evaluation_time'])

print("NetFlow v9 performance measurements for YANG to NGSI-LD translation using data virtualization - Iteration 1: \n")
...
plt.title('Mean evaluation time per notification in \n NetFlow v9 monitoring data')
plt.savefig("notification_performance_measurements_data_integration-iteration-1.png", format="png", dpi=1500)

df_materialization_notification = pd.read_csv('notification_performance_measurements_materialization-iteration-2.csv')
all_materialization_data.append(df_materialization_notification['evaluation_time'])

print("NetFlow v9 performance measurements for YANG to NGSI-LD translation using data materialization - Iteration 2: \n")
...
df_virtualization_notification = pd.read_csv('notification_performance_measurements_virtualization-iteration-2.csv')
all_virtualization_data.append(df_virtualization_notification['evaluation_time'])

print("NetFlow v9 performance measurements for YANG to NGSI-LD translation using data virtualization - Iteration 2: \n")
...
df_materialization_notification = pd.read_csv('notification_performance_measurements_materialization-iteration-3.csv')
all_materialization_data.append(df_materialization_notification['evaluation_time'])

print("NetFlow v9 performance measurements for YANG to NGSI-LD translation using data materialization - Iteration 3: \n")
...
df_virtualization_notification = pd.read_csv('notification_performance_measurements_virtualization-iteration-3.csv')
all_virtualization_data.append(df_virtualization_notification['evaluation_time'])

print("NetFlow v9 performance measurements for YANG to NGSI-LD translation using data virtualization - Iteration 3: \n")
...
materialization_files = [
    'notification_performance_measurements_materialization-iteration-1.csv',
    'notification_performance_measurements_materialization-iteration-1.csv',
    'notification_performance_measurements_materialization-iteration-1.csv'
]
...
virtualization_files = [
    'notification_performance_measurements_virtualization-iteration-1.csv',
    'notification_performance_measurements_virtualization-iteration-1.csv',
    'notification_performance_measurements_virtualization-iteration-1.csv'
]
