...
column_data = df_materialization_integration['iteration_execution_time']
...
print("Outliers in data materialization: ")
print(outliers)
print("Outliers ocurrences in data materialization:" + str(len(outliers)))
...
# Calculate Q1, Q3, and IQR
column_data = df_virtualization_integration['iteration_execution_time']
q1 = column_data.quantile(0.25)
q3 = column_data.quantile(0.75)
iqr = q3 - q1
...
print("Outliers in data virtualization: ")
print(outliers)
print("Outliers ocurrences in data virtualization:" + str(len(outliers)))
