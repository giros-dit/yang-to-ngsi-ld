...
df = pd.read_csv('netflow_complex_performance_measurements.csv')
...
plt.title('netflow-json-parser-with-ngsi-ld-instantiator (complex) - Execution times per processed notification')
plt.xlabel('netflow-json-parser-with-ngsi-ld-instantiator index')
plt.ylabel('time (in ms)')
plt.savefig('netflow_complex_performance_measurements.png')
plt.show()