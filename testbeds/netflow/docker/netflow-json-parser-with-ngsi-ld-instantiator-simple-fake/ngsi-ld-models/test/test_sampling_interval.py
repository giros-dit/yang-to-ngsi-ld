...
class TestSamplingInterval(unittest.TestCase):
    """SamplingInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplingInterval:
        """Test SamplingInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplingInterval`
        """
        model = SamplingInterval()
        if include_optional:
