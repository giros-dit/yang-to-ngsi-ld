...
class TestTopLabelType(unittest.TestCase):
    """TopLabelType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopLabelType:
        """Test TopLabelType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopLabelType`
        """
        model = TopLabelType()
        if include_optional:
            return TopLabelType(
