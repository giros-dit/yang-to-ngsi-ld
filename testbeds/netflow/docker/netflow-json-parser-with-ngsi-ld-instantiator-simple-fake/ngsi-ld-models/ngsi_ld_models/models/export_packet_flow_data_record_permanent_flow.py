...
class ExportPacketFlowDataRecordPermanentFlow(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be ExportPacketFlowDataRecordPermanentFlow.")
    ...
    bytes_in: Optional[ExportPacketFlowDataRecordPermanentFlowBytesIn] = Field(default=None, alias="bytesIn")
    pkts_in: Optional[ExportPacketFlowDataRecordPermanentFlowPktsIn] = Field(default=None, alias="pktsIn")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "bytesIn", "pktsIn", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ExportPacketFlowDataRecordPermanentFlow'):
            raise ValueError("must be one of enum values ('ExportPacketFlowDataRecordPermanentFlow')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'ExportPacketFlowDataRecordPermanentFlow',
            ...
            "bytesIn": ExportPacketFlowDataRecordPermanentFlowBytesIn.from_dict(obj["bytesIn"]) if obj.get("bytesIn") is not None else None,
            "pktsIn": ExportPacketFlowDataRecordPermanentFlowPktsIn.from_dict(obj["pktsIn"]) if obj.get("pktsIn") is not None else None,
