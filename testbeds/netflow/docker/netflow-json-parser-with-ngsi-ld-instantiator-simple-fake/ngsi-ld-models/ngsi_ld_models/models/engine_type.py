...
class EngineType(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('rp', 'vip-linecard', 'pdc/dfc'):
            raise ValueError("must be one of enum values ('rp', 'vip-linecard', 'pdc/dfc')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in EngineType) in the input: " + _key)
