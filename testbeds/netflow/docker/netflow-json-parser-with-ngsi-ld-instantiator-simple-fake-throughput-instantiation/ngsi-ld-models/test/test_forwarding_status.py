...
class TestForwardingStatus(unittest.TestCase):
    """ForwardingStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForwardingStatus:
        """Test ForwardingStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForwardingStatus`
        """
        model = ForwardingStatus()
        if include_optional:
