...
class TestBytesInPerSecond(unittest.TestCase):
    """BytesInPerSecond unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BytesInPerSecond:
        """Test BytesInPerSecond
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BytesInPerSecond`
        """
        model = BytesInPerSecond()
        if include_optional:
