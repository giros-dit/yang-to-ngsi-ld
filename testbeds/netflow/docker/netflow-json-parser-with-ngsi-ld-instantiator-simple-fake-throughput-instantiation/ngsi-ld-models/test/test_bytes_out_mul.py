...
class TestBytesOutMul(unittest.TestCase):
    """BytesOutMul unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BytesOutMul:
        """Test BytesOutMul
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BytesOutMul`
        """
        model = BytesOutMul()
        if include_optional:
            return BytesOutMul(
