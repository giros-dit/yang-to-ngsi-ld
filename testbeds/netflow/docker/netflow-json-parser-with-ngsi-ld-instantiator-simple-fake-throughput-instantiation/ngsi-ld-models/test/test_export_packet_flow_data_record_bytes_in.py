...
class TestExportPacketFlowDataRecordBytesIn(unittest.TestCase):
    """ExportPacketFlowDataRecordBytesIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportPacketFlowDataRecordBytesIn:
        """Test ExportPacketFlowDataRecordBytesIn
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportPacketFlowDataRecordBytesIn`
        """
        model = ExportPacketFlowDataRecordBytesIn()
        if include_optional:
            return ExportPacketFlowDataRecordBytesIn(
                type = 'Property',
                value = 56,
    ...
    def testExportPacketFlowDataRecordBytesIn(self):
        """Test ExportPacketFlowDataRecordBytesIn"""
