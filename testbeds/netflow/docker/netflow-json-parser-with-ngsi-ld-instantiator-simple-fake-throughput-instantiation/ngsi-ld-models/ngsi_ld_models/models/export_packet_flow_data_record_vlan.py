...
class ExportPacketFlowDataRecordVlan(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be ExportPacketFlowDataRecordVlan.")
    ...
    src_id: Optional[SrcId] = Field(default=None, alias="srcId")
    dst_id: Optional[DstId] = Field(default=None, alias="dstId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "srcId", "dstId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ExportPacketFlowDataRecordVlan'):
            raise ValueError("must be one of enum values ('ExportPacketFlowDataRecordVlan')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of src_id
        if self.src_id:
            _dict['srcId'] = self.src_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of dst_id
        if self.dst_id:
            _dict['dstId'] = self.dst_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'ExportPacketFlowDataRecordVlan',
            ...
            "srcId": SrcId.from_dict(obj["srcId"]) if obj.get("srcId") is not None else None,
            "dstId": DstId.from_dict(obj["dstId"]) if obj.get("dstId") is not None else None,
