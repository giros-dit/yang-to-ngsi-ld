...
class IgmpType(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('membership-query', 'membership-report-v1', 'dvmrp', 'pim-v1', 'trace-messages', 'membership-report-v2', 'leave-group-v2', 'mul-traceroute-resp', 'mul-traceroute', 'membership-report-v3', 'mul-router-advert', 'mul-router-sol', 'mul-router-term'):
            raise ValueError("must be one of enum values ('membership-query', 'membership-report-v1', 'dvmrp', 'pim-v1', 'trace-messages', 'membership-report-v2', 'leave-group-v2', 'mul-traceroute-resp', 'mul-traceroute', 'membership-report-v3', 'mul-router-advert', 'mul-router-sol', 'mul-router-term')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in IgmpType) in the input: " + _key)
