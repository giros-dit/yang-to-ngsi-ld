...
class TestNextHopIpv6(unittest.TestCase):
    """NextHopIpv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NextHopIpv6:
        """Test NextHopIpv6
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NextHopIpv6`
        """
        model = NextHopIpv6()
        if include_optional:
            return NextHopIpv6(
