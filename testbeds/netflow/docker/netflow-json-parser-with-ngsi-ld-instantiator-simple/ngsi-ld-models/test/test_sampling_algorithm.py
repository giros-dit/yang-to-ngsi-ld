...
class TestSamplingAlgorithm(unittest.TestCase):
    """SamplingAlgorithm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplingAlgorithm:
        """Test SamplingAlgorithm
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplingAlgorithm`
        """
    ...
    def testSamplingAlgorithm(self):
        """Test SamplingAlgorithm"""
