...
class TestLastSwitched(unittest.TestCase):
    """LastSwitched unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastSwitched:
        """Test LastSwitched
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastSwitched`
        """
        model = LastSwitched()
        if include_optional:
            return LastSwitched(
