...
class TestExportPacketFlowDataRecordPktsIn(unittest.TestCase):
    """ExportPacketFlowDataRecordPktsIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportPacketFlowDataRecordPktsIn:
        """Test ExportPacketFlowDataRecordPktsIn
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportPacketFlowDataRecordPktsIn`
        """
        model = ExportPacketFlowDataRecordPktsIn()
        if include_optional:
            return ExportPacketFlowDataRecordPktsIn(
                type = 'Property',
                value = 56,
    ...
    def testExportPacketFlowDataRecordPktsIn(self):
        """Test ExportPacketFlowDataRecordPktsIn"""
