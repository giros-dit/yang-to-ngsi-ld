...
class TestExportPacketFlowDataRecordIpv6NextHop(unittest.TestCase):
    """ExportPacketFlowDataRecordIpv6NextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportPacketFlowDataRecordIpv6NextHop:
        """Test ExportPacketFlowDataRecordIpv6NextHop
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportPacketFlowDataRecordIpv6NextHop`
        """
        model = ExportPacketFlowDataRecordIpv6NextHop()
        if include_optional:
            return ExportPacketFlowDataRecordIpv6NextHop(
                type = 'Property',
    ...
    def testExportPacketFlowDataRecordIpv6NextHop(self):
        """Test ExportPacketFlowDataRecordIpv6NextHop"""
