...
class TestExportPacketFlowDataRecordIpv6DstAddress(unittest.TestCase):
    """ExportPacketFlowDataRecordIpv6DstAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportPacketFlowDataRecordIpv6DstAddress:
        """Test ExportPacketFlowDataRecordIpv6DstAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportPacketFlowDataRecordIpv6DstAddress`
        """
        model = ExportPacketFlowDataRecordIpv6DstAddress()
        if include_optional:
            return ExportPacketFlowDataRecordIpv6DstAddress(
                type = 'Property',
    ...
    def testExportPacketFlowDataRecordIpv6DstAddress(self):
        """Test ExportPacketFlowDataRecordIpv6DstAddress"""
