...
class TestRatioPktsInPerOut(unittest.TestCase):
    """RatioPktsInPerOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatioPktsInPerOut:
        """Test RatioPktsInPerOut
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatioPktsInPerOut`
        """
        model = RatioPktsInPerOut()
        if include_optional:
            return RatioPktsInPerOut(
                type = 'Property',
                value = 1.337,
    ...
    def testRatioPktsInPerOut(self):
        """Test RatioPktsInPerOut"""
