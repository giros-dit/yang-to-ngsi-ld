...
class TestSnmpOut(unittest.TestCase):
    """SnmpOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SnmpOut:
        """Test SnmpOut
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SnmpOut`
        """
        model = SnmpOut()
        if include_optional:
            return SnmpOut(
