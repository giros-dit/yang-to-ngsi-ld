...
class TestPktsOut(unittest.TestCase):
    """PktsOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PktsOut:
        """Test PktsOut
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PktsOut`
        """
        model = PktsOut()
        if include_optional:
            return PktsOut(
