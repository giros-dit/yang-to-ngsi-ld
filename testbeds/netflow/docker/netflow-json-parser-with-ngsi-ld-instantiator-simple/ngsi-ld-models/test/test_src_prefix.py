...
class TestSrcPrefix(unittest.TestCase):
    """SrcPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SrcPrefix:
        """Test SrcPrefix
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SrcPrefix`
        """
        model = SrcPrefix()
        if include_optional:
            return SrcPrefix(
