...
class TestRatioBytesInPerOut(unittest.TestCase):
    """RatioBytesInPerOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RatioBytesInPerOut:
        """Test RatioBytesInPerOut
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RatioBytesInPerOut`
        """
        model = RatioBytesInPerOut()
        if include_optional:
            return RatioBytesInPerOut(
                type = 'Property',
                value = 1.337,
    ...
    def testRatioBytesInPerOut(self):
        """Test RatioBytesInPerOut"""
