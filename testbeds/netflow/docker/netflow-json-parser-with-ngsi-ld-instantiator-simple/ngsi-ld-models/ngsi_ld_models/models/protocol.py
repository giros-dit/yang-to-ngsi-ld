...
class Protocol(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('icmp', 'igmp', 'tcp', 'egp', 'igp', 'udp', 'icmp-ipv6', 'pim', 'l2tp', 'sctp', 'eth'):
            raise ValueError("must be one of enum values ('icmp', 'igmp', 'tcp', 'egp', 'igp', 'udp', 'icmp-ipv6', 'pim', 'l2tp', 'sctp', 'eth')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in Protocol) in the input: " + _key)
