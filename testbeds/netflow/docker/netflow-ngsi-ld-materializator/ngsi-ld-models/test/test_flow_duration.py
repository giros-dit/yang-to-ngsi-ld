...
class TestFlowDuration(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FlowDuration:
        """Test FlowDuration
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowDuration`
        """
        model = FlowDuration()
        if include_optional:
            return FlowDuration(
