...
```python
from ngsi_ld_models.models.yang_identity_broader import YANGIdentityBroader
...
yang_identity_broader_form_dict = yang_identity_broader.from_dict(yang_identity_broader_dict)
```
