...
class TestSrcTrafficId(unittest.TestCase):
    """SrcTrafficId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SrcTrafficId:
        """Test SrcTrafficId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SrcTrafficId`
        """
        model = SrcTrafficId()
        if include_optional:
            return SrcTrafficId(
