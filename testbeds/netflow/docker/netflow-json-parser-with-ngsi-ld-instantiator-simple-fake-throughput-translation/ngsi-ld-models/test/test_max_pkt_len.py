...
class TestMaxPktLen(unittest.TestCase):
    """MaxPktLen unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxPktLen:
        """Test MaxPktLen
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxPktLen`
        """
        model = MaxPktLen()
        if include_optional:
            return MaxPktLen(
