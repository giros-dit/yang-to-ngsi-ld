...
class TestPktsOutPerSecond(unittest.TestCase):
    """PktsOutPerSecond unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PktsOutPerSecond:
        """Test PktsOutPerSecond
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PktsOutPerSecond`
        """
        model = PktsOutPerSecond()
        if include_optional:
            return PktsOutPerSecond(
                type = 'Property',
                value = 1.337,
