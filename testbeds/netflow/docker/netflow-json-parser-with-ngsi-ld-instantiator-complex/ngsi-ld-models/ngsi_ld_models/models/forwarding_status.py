...
class ForwardingStatus(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('unknown', 'unknown-forwarded', 'forwarded-frag', 'forwarded-not-frag', 'unknown-dropped', 'acl-deny', 'acl-drop', 'unroutable', 'adjacency', 'fragment-df', 'bad-header-check', 'bad-tot-len', 'bad-header-len', 'bad-ttl', 'policer', 'wred', 'rpf', 'for-us', 'bad-out-interf', 'hardware', 'unknown-consumed', 'term-punt-adjacency', 'term-incomp-adjacency', 'term-for-us'):
            raise ValueError("must be one of enum values ('unknown', 'unknown-forwarded', 'forwarded-frag', 'forwarded-not-frag', 'unknown-dropped', 'acl-deny', 'acl-drop', 'unroutable', 'adjacency', 'fragment-df', 'bad-header-check', 'bad-tot-len', 'bad-header-len', 'bad-ttl', 'policer', 'wred', 'rpf', 'for-us', 'bad-out-interf', 'hardware', 'unknown-consumed', 'term-punt-adjacency', 'term-incomp-adjacency', 'term-for-us')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in ForwardingStatus) in the input: " + _key)
