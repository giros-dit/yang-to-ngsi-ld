...
class ExportPacketFlowDataRecordBgp(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be ExportPacketFlowDataRecordBgp.")
    ...
    src_as: Optional[SrcAs] = Field(default=None, alias="srcAs")
    dst_as: Optional[DstAs] = Field(default=None, alias="dstAs")
    next_hop: Optional[ExportPacketFlowDataRecordBgpNextHop] = Field(default=None, alias="nextHop")
    next_hop_ipv6: Optional[NextHopIpv6] = Field(default=None, alias="nextHopIpv6")
    src_traffic_id: Optional[SrcTrafficId] = Field(default=None, alias="srcTrafficId")
    dst_traffic_id: Optional[DstTrafficId] = Field(default=None, alias="dstTrafficId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "srcAs", "dstAs", "nextHop", "nextHopIpv6", "srcTrafficId", "dstTrafficId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('ExportPacketFlowDataRecordBgp'):
            raise ValueError("must be one of enum values ('ExportPacketFlowDataRecordBgp')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of src_as
        if self.src_as:
            _dict['srcAs'] = self.src_as.to_dict()
        # override the default output from pydantic by calling `to_dict()` of dst_as
        if self.dst_as:
            _dict['dstAs'] = self.dst_as.to_dict()
        # override the default output from pydantic by calling `to_dict()` of next_hop
        if self.next_hop:
            _dict['nextHop'] = self.next_hop.to_dict()
        # override the default output from pydantic by calling `to_dict()` of next_hop_ipv6
        if self.next_hop_ipv6:
            _dict['nextHopIpv6'] = self.next_hop_ipv6.to_dict()
        # override the default output from pydantic by calling `to_dict()` of src_traffic_id
        if self.src_traffic_id:
            _dict['srcTrafficId'] = self.src_traffic_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of dst_traffic_id
        if self.dst_traffic_id:
            _dict['dstTrafficId'] = self.dst_traffic_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'ExportPacketFlowDataRecordBgp',
            ...
            "srcAs": SrcAs.from_dict(obj["srcAs"]) if obj.get("srcAs") is not None else None,
            "dstAs": DstAs.from_dict(obj["dstAs"]) if obj.get("dstAs") is not None else None,
            "nextHop": ExportPacketFlowDataRecordBgpNextHop.from_dict(obj["nextHop"]) if obj.get("nextHop") is not None else None,
            "nextHopIpv6": NextHopIpv6.from_dict(obj["nextHopIpv6"]) if obj.get("nextHopIpv6") is not None else None,
            "srcTrafficId": SrcTrafficId.from_dict(obj["srcTrafficId"]) if obj.get("srcTrafficId") is not None else None,
            "dstTrafficId": DstTrafficId.from_dict(obj["dstTrafficId"]) if obj.get("dstTrafficId") is not None else None,
