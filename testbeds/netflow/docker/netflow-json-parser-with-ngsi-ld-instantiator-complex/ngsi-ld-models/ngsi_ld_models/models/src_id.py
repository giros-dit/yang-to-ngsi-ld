...
class SrcId(BaseModel):
    ...
    value: Annotated[int, Field(le=4095, strict=True, ge=0)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in SrcId) in the input: " + _key)
