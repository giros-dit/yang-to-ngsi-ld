...
class TestPktsInPerSecond(unittest.TestCase):
    """PktsInPerSecond unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PktsInPerSecond:
        """Test PktsInPerSecond
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PktsInPerSecond`
        """
        model = PktsInPerSecond()
        if include_optional:
            return PktsInPerSecond(
                type = 'Property',
                value = 1.337,
