...
class TestTotPktsExp(unittest.TestCase):
    """TotPktsExp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotPktsExp:
        """Test TotPktsExp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotPktsExp`
        """
        model = TotPktsExp()
        if include_optional:
            return TotPktsExp(
