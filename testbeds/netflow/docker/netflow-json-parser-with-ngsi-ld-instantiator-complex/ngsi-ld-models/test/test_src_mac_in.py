...
class TestSrcMacIn(unittest.TestCase):
    """SrcMacIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SrcMacIn:
        """Test SrcMacIn
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SrcMacIn`
        """
        model = SrcMacIn()
        if include_optional:
            return SrcMacIn(
