...
class TestSamplerName(unittest.TestCase):
    """SamplerName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplerName:
        """Test SamplerName
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplerName`
        """
        model = SamplerName()
        if include_optional:
            return SamplerName(
