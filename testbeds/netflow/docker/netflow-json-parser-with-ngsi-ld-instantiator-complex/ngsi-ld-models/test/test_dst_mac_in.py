...
class TestDstMacIn(unittest.TestCase):
    """DstMacIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DstMacIn:
        """Test DstMacIn
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DstMacIn`
        """
        model = DstMacIn()
        if include_optional:
            return DstMacIn(
