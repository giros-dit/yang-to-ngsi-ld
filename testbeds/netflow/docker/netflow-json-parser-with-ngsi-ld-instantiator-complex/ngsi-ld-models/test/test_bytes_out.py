...
class TestBytesOut(unittest.TestCase):
    """BytesOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BytesOut:
        """Test BytesOut
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BytesOut`
        """
        model = BytesOut()
        if include_optional:
            return BytesOut(
