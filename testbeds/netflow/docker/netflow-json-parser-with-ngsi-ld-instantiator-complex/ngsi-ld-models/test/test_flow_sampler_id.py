...
class TestFlowSamplerId(unittest.TestCase):
    """FlowSamplerId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowSamplerId:
        """Test FlowSamplerId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowSamplerId`
        """
        model = FlowSamplerId()
        if include_optional:
