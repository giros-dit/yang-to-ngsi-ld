...
class TestFirstSwitched(unittest.TestCase):
    """FirstSwitched unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FirstSwitched:
        """Test FirstSwitched
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FirstSwitched`
        """
        model = FirstSwitched()
        if include_optional:
