...
class TestDstTrafficId(unittest.TestCase):
    """DstTrafficId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DstTrafficId:
        """Test DstTrafficId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DstTrafficId`
        """
        model = DstTrafficId()
        if include_optional:
            return DstTrafficId(
