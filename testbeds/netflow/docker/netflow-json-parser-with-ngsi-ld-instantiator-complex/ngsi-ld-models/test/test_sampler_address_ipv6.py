...
class TestSamplerAddressIpv6(unittest.TestCase):
    """SamplerAddressIpv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SamplerAddressIpv6:
        """Test SamplerAddressIpv6
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SamplerAddressIpv6`
        """
        model = SamplerAddressIpv6()
        if include_optional:
            return SamplerAddressIpv6(
                type = 'Property',
    ...
    def testSamplerAddressIpv6(self):
        """Test SamplerAddressIpv6"""
