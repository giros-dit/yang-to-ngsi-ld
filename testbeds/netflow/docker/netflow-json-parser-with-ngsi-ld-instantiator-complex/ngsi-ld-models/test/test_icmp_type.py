...
class TestIcmpType(unittest.TestCase):
    """IcmpType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IcmpType:
        """Test IcmpType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IcmpType`
        """
        model = IcmpType()
        if include_optional:
            return IcmpType(
