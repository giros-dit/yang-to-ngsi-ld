...
class TestPktsOutMul(unittest.TestCase):
    """PktsOutMul unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PktsOutMul:
        """Test PktsOutMul
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PktsOutMul`
        """
        model = PktsOutMul()
        if include_optional:
            return PktsOutMul(
