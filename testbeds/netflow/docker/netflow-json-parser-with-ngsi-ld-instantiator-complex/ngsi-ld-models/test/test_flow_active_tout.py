...
class TestFlowActiveTout(unittest.TestCase):
    """FlowActiveTout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowActiveTout:
        """Test FlowActiveTout
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowActiveTout`
        """
        model = FlowActiveTout()
        if include_optional:
            return FlowActiveTout(
                type = 'Property',
                value = 56,
