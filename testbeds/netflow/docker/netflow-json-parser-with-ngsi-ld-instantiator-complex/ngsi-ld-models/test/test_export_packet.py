...
class TestExportPacket(unittest.TestCase):
    """ExportPacket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportPacket:
        """Test ExportPacket
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportPacket`
        """
        model = ExportPacket()
        if include_optional:
            return ExportPacket(
