...
class TestEngineId(unittest.TestCase):
    """EngineId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EngineId:
        """Test EngineId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EngineId`
        """
        model = EngineId()
        if include_optional:
            return EngineId(
