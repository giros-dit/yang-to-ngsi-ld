...
class TestSrcMacOut(unittest.TestCase):
    """SrcMacOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SrcMacOut:
        """Test SrcMacOut
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SrcMacOut`
        """
        model = SrcMacOut()
        if include_optional:
            return SrcMacOut(
