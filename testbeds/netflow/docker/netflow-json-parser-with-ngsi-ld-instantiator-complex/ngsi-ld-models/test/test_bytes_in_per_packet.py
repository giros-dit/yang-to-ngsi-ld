...
class TestBytesInPerPacket(unittest.TestCase):
    """BytesInPerPacket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BytesInPerPacket:
        """Test BytesInPerPacket
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BytesInPerPacket`
        """
        model = BytesInPerPacket()
        if include_optional:
            return BytesInPerPacket(
                type = 'Property',
                value = 1.337,
