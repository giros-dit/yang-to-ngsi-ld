...
class TestIgmpType(unittest.TestCase):
    """IgmpType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IgmpType:
        """Test IgmpType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IgmpType`
        """
        model = IgmpType()
        if include_optional:
            return IgmpType(
