...
class TestBytesOutPerSecond(unittest.TestCase):
    """BytesOutPerSecond unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BytesOutPerSecond:
        """Test BytesOutPerSecond
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BytesOutPerSecond`
        """
        model = BytesOutPerSecond()
        if include_optional:
    ...
    def testBytesOutPerSecond(self):
        """Test BytesOutPerSecond"""
