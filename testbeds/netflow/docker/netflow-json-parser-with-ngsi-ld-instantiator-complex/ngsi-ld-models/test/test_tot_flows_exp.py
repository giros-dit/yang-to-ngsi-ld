...
class TestTotFlowsExp(unittest.TestCase):
    """TotFlowsExp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotFlowsExp:
        """Test TotFlowsExp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotFlowsExp`
        """
        model = TotFlowsExp()
        if include_optional:
            return TotFlowsExp(
