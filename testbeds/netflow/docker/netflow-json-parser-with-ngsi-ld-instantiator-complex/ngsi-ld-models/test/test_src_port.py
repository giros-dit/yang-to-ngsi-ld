...
class TestSrcPort(unittest.TestCase):
    """SrcPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SrcPort:
        """Test SrcPort
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SrcPort`
        """
        model = SrcPort()
        if include_optional:
            return SrcPort(
