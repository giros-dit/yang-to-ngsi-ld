...
class TestUnixSeconds(unittest.TestCase):
    """UnixSeconds unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnixSeconds:
        """Test UnixSeconds
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnixSeconds`
        """
        model = UnixSeconds()
        if include_optional:
            return UnixSeconds(
