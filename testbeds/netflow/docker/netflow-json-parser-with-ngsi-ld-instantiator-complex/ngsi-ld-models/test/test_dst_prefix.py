...
class TestDstPrefix(unittest.TestCase):
    """DstPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DstPrefix:
        """Test DstPrefix
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DstPrefix`
        """
        model = DstPrefix()
        if include_optional:
            return DstPrefix(
