...
class TestMinPktLen(unittest.TestCase):
    """MinPktLen unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MinPktLen:
        """Test MinPktLen
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MinPktLen`
        """
        model = MinPktLen()
        if include_optional:
            return MinPktLen(
