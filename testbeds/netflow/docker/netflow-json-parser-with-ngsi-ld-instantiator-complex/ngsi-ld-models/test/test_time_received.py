...
class TestTimeReceived(unittest.TestCase):
    """TimeReceived unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeReceived:
        """Test TimeReceived
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeReceived`
        """
        model = TimeReceived()
        if include_optional:
            return TimeReceived(
