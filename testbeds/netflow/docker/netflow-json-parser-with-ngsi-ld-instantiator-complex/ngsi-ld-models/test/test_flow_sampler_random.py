...
class TestFlowSamplerRandom(unittest.TestCase):
    """FlowSamplerRandom unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowSamplerRandom:
        """Test FlowSamplerRandom
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowSamplerRandom`
        """
        model = FlowSamplerRandom()
        if include_optional:
            return FlowSamplerRandom(
                type = 'Property',
                value = 56,
    ...
    def testFlowSamplerRandom(self):
        """Test FlowSamplerRandom"""
