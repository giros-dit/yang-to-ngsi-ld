...
class TestPostipDscp(unittest.TestCase):
    """PostipDscp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PostipDscp:
        """Test PostipDscp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PostipDscp`
        """
        model = PostipDscp()
        if include_optional:
            return PostipDscp(
