...
class TestBytesOutPerPacket(unittest.TestCase):
    """BytesOutPerPacket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BytesOutPerPacket:
        """Test BytesOutPerPacket
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BytesOutPerPacket`
        """
        model = BytesOutPerPacket()
        if include_optional:
            return BytesOutPerPacket(
                type = 'Property',
                value = 1.337,
    ...
    def testBytesOutPerPacket(self):
        """Test BytesOutPerPacket"""
