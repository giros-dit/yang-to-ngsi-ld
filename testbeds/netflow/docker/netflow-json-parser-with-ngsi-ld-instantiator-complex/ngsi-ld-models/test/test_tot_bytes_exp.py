...
class TestTotBytesExp(unittest.TestCase):
    """TotBytesExp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotBytesExp:
        """Test TotBytesExp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotBytesExp`
        """
        model = TotBytesExp()
        if include_optional:
            return TotBytesExp(
