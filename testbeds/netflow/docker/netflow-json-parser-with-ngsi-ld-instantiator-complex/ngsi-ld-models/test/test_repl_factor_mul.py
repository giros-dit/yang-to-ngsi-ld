...
class TestReplFactorMul(unittest.TestCase):
    """ReplFactorMul unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplFactorMul:
        """Test ReplFactorMul
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplFactorMul`
        """
        model = ReplFactorMul()
        if include_optional:
            return ReplFactorMul(
                type = 'Property',
                value = 56,
