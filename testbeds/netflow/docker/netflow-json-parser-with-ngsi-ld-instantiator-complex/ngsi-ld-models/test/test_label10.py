...
class TestLabel10(unittest.TestCase):
    """Label10 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Label10:
        """Test Label10
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Label10`
        """
        model = Label10()
        if include_optional:
            return Label10(
