...
class TestSystemUptime(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SystemUptime:
        """Test SystemUptime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemUptime`
        """
        model = SystemUptime()
        if include_optional:
            return SystemUptime(
