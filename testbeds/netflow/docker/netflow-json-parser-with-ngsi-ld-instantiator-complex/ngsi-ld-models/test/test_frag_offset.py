...
class TestFragOffset(unittest.TestCase):
    """FragOffset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FragOffset:
        """Test FragOffset
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FragOffset`
        """
        model = FragOffset()
        if include_optional:
            return FragOffset(
