...
class TestFlowSamplerMode(unittest.TestCase):
    """FlowSamplerMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowSamplerMode:
        """Test FlowSamplerMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowSamplerMode`
        """
        model = FlowSamplerMode()
        if include_optional:
            return FlowSamplerMode(
                type = 'Property',
                value = 'deterministic',
