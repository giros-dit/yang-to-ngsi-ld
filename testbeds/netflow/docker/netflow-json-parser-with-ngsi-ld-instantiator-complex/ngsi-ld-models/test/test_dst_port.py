...
class TestDstPort(unittest.TestCase):
    """DstPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DstPort:
        """Test DstPort
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DstPort`
        """
        model = DstPort()
        if include_optional:
            return DstPort(
