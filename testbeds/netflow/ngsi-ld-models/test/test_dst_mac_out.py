...
class TestDstMacOut(unittest.TestCase):
    """DstMacOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DstMacOut:
        """Test DstMacOut
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DstMacOut`
        """
        model = DstMacOut()
        if include_optional:
            return DstMacOut(
