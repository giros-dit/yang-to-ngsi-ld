...
class TestOptHeaders(unittest.TestCase):
    """OptHeaders unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptHeaders:
        """Test OptHeaders
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptHeaders`
        """
        model = OptHeaders()
        if include_optional:
            return OptHeaders(
