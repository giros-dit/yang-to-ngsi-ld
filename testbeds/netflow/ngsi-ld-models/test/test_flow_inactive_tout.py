...
class TestFlowInactiveTout(unittest.TestCase):
    """FlowInactiveTout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowInactiveTout:
        """Test FlowInactiveTout
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowInactiveTout`
        """
        model = FlowInactiveTout()
        if include_optional:
            return FlowInactiveTout(
                type = 'Property',
                value = 56,
