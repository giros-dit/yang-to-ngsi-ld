...
query_plot_materialization = df_materialization.boxplot(column = ['query_execution_time'], vert=True, patch_artist=True, showfliers = True, medianprops = dict(color = "red", linewidth = 1.5), boxprops = dict(facecolor = "blue"), ax=ax, positions=[1])
query_plot_virtualization_context_source = df_virtualization_context_source.boxplot(column = ['query_execution_time'], vert=True, patch_artist=True, showfliers = True, medianprops = dict(color = "yellow", linewidth = 1.5), boxprops = dict(facecolor = "grey"), ax=ax, positions=[2])
query_plot_virtualization_context_broker = df_virtualization_context_broker.boxplot(column = ['query_execution_time'], vert=True, patch_artist=True, showfliers = True, medianprops = dict(color = "green", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[3])
...
query_reply_plot_materialization = df_materialization.boxplot(column = ['processing_time_since_observed_at'], vert=True, patch_artist=True, showfliers = True, medianprops = dict(color = "red", linewidth = 1.5), boxprops = dict(facecolor = "blue"), ax=ax, positions=[1])
query_reply_plot_virtualization_context_source = df_virtualization_context_source.boxplot(column = ['processing_time_since_observed_at'], vert=True, patch_artist=True, showfliers = True, medianprops = dict(color = "yellow", linewidth = 1.5), boxprops = dict(facecolor = "grey"), ax=ax, positions=[2])
query_reply_plot_virtualization_context_broker = df_virtualization_context_broker.boxplot(column = ['processing_time_since_observed_at'], vert=True, patch_artist=True, showfliers = True, medianprops = dict(color = "green", linewidth = 1.5), boxprops = dict(facecolor = "white"), ax=ax, positions=[3])
