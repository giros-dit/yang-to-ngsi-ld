...
```python
from ngsi_ld_models_1_8_1.models.subscription_periodic import SubscriptionPeriodic

# TODO update the JSON string below
json = "{}"
# create an instance of SubscriptionPeriodic from a JSON string
subscription_periodic_instance = SubscriptionPeriodic.from_json(json)
# print the JSON string representation of the object
print(SubscriptionPeriodic.to_json())

# convert the object into a dict
subscription_periodic_dict = subscription_periodic_instance.to_dict()
# create an instance of SubscriptionPeriodic from a dict
subscription_periodic_from_dict = SubscriptionPeriodic.from_dict(subscription_periodic_dict)
```
