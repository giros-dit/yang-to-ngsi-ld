...
class RetrieveEntityTypes200Response1OneOf1Inner(BaseModel):
    """
    ...
    attribute_names: List[StrictStr] = Field(description="List containing the names of attributes that instances of the entity type can have. ", alias="attributeNames")
    context: LdContext = Field(alias="@context")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "typeName", "attributeNames", "@context"]
