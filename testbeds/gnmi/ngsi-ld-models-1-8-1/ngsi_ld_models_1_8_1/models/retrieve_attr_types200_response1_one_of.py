...
class RetrieveAttrTypes200Response1OneOf(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "attributeList", "@context"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AttributeList']):
            raise ValueError("must be one of enum values ('AttributeList')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributeList": obj.get("attributeList"),
