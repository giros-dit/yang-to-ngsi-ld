...
class CsourceRegistration(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "registrationName", "contextSourceAlias", "description", "information", "datasetId", "tenant", "observationInterval", "managementInterval", "location", "observationSpace", "operationSpace", "expiresAt", "endpoint", "contextSourceInfo", "scope", "mode", "operations", "refreshRate", "management", "createdAt", "modifiedAt", "deletedAt", "status", "timesSent", "timesFailed", "lastSuccess", "lastFailure"]
