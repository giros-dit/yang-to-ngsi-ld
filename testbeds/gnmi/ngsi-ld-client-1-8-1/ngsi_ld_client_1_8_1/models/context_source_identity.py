...
class ContextSourceIdentity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "contextSourceExtras", "contextSourceUpTime", "contextSourceTimeAt", "contextSourceAlias"]
