...
class SubscriptionPeriodic(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "subscriptionName", "description", "entities", "localOnly", "notificationTrigger", "q", "geoQ", "csf", "isActive", "notification", "expiresAt", "temporalQ", "scopeQ", "lang", "createdAt", "modifiedAt", "deletedAt", "status", "jsonldContext", "datasetId", "timeInterval"]
