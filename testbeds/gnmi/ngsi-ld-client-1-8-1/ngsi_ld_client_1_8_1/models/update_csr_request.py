...
class UpdateCSRRequest(BaseModel):
    ...
    type: Optional[StrictStr] = Field(default=None, description="JSON-LD @type Use reserved type for identifying Context Source Registration. ")
    ...
    information: Optional[Annotated[List[RegistrationInfo], Field(min_length=1)]] = Field(default=None, description="Describes the Entities, Properties and Relationships for which the Context Source may be able to provide information. ")
