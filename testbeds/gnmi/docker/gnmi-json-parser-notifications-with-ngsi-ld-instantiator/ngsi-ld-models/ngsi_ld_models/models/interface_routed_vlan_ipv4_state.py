...
class InterfaceRoutedVlanIpv4State(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4State.")
    ...
    enabled: Optional[InterfaceRoutedVlanIpv4StateEnabled] = None
    mtu: Optional[InterfaceRoutedVlanIpv4StateMtu] = None
    dhcp_client: Optional[InterfaceRoutedVlanIpv4StateDhcpClient] = Field(default=None, alias="dhcpClient")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4State'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4State')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4State',
            ...
            "enabled": InterfaceRoutedVlanIpv4StateEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "mtu": InterfaceRoutedVlanIpv4StateMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dhcpClient": InterfaceRoutedVlanIpv4StateDhcpClient.from_dict(obj["dhcpClient"]) if obj.get("dhcpClient") is not None else None,
