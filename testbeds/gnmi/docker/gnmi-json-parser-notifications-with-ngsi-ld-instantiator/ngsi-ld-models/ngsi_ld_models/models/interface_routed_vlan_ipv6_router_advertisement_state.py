...
class InterfaceRoutedVlanIpv6RouterAdvertisementState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6RouterAdvertisementState.")
    ...
    interval: Optional[InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval] = None
    lifetime: Optional[InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime] = None
    suppress: Optional[InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6RouterAdvertisementState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6RouterAdvertisementState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6RouterAdvertisementState',
            ...
            "interval": InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval.from_dict(obj["interval"]) if obj.get("interval") is not None else None,
            "lifetime": InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime.from_dict(obj["lifetime"]) if obj.get("lifetime") is not None else None,
            "suppress": InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress.from_dict(obj["suppress"]) if obj.get("suppress") is not None else None,
