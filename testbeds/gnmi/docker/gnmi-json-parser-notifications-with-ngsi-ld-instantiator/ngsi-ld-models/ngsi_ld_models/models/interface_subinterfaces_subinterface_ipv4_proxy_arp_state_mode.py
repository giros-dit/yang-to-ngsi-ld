...
class InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('DISABLE', 'REMOTE_ONLY', 'ALL'):
            raise ValueError("must be one of enum values ('DISABLE', 'REMOTE_ONLY', 'ALL')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode) in the input: " + _key)
