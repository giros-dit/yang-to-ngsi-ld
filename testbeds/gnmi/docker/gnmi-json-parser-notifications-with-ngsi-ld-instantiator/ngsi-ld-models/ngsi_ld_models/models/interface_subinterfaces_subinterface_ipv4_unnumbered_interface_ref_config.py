...
class InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfig.")
    ...
    interface: Optional[InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface] = None
    subinterface: Optional[InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfig',
            ...
            "interface": InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "subinterface": InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
