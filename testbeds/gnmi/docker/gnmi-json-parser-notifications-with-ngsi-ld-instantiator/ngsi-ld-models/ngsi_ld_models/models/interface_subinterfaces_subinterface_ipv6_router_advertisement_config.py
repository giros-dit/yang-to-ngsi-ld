...
class InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfig.")
    ...
    interval: Optional[InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigInterval] = None
    lifetime: Optional[InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime] = None
    suppress: Optional[InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "interval", "lifetime", "suppress", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfig')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of suppress
        if self.suppress:
            _dict['suppress'] = self.suppress.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfig',
            ...
            "interval": InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigInterval.from_dict(obj["interval"]) if obj.get("interval") is not None else None,
            "lifetime": InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime.from_dict(obj["lifetime"]) if obj.get("lifetime") is not None else None,
            "suppress": InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigSuppress.from_dict(obj["suppress"]) if obj.get("suppress") is not None else None,
