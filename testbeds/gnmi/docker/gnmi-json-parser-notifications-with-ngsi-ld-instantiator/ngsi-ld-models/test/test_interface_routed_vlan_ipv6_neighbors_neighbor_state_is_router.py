...
class TestInterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter(unittest.TestCase):
    """InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter:
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter`
        """
        model = InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter()
        if include_optional:
            return InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter(
                type = 'Property',
                value = '',
    ...
    def testInterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter(self):
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter"""
