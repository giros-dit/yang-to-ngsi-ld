...
class TestInterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled:
        """Test InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled"""
