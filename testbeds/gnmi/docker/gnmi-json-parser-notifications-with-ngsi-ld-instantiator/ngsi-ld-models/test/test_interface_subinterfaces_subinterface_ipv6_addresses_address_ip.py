...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp"""
