...
class TestInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin:
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin(
                type = 'Property',
                value = 'OTHER',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin"""
