...
class TestInterfaceRoutedVlanIpv4AddressesAddressStateOrigin(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressStateOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressStateOrigin:
        """Test InterfaceRoutedVlanIpv4AddressesAddressStateOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressStateOrigin`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressStateOrigin()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressStateOrigin(
                type = 'Property',
                value = 'OTHER',
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressStateOrigin(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressStateOrigin"""
