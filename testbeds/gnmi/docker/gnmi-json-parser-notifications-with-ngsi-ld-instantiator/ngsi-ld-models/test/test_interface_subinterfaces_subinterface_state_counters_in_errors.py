...
class TestInterfaceSubinterfacesSubinterfaceStateCountersInErrors(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersInErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersInErrors:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInErrors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersInErrors`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersInErrors()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersInErrors(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersInErrors(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInErrors"""
