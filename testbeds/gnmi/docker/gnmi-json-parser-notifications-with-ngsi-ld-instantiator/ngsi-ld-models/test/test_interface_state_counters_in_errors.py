...
class TestInterfaceStateCountersInErrors(unittest.TestCase):
    """InterfaceStateCountersInErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersInErrors:
        """Test InterfaceStateCountersInErrors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersInErrors`
        """
        model = InterfaceStateCountersInErrors()
        if include_optional:
            return InterfaceStateCountersInErrors(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersInErrors(self):
        """Test InterfaceStateCountersInErrors"""
