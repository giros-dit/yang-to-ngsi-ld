...
class TestInterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets:
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutForwardedOctets"""
