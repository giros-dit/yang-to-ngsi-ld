...
class TestInterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress(unittest.TestCase):
    """InterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress:
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress`
        """
        model = InterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress()
        if include_optional:
            return InterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress(
                type = 'Property',
    ...
    def testInterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress(self):
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborConfigLinkLayerAddress"""
