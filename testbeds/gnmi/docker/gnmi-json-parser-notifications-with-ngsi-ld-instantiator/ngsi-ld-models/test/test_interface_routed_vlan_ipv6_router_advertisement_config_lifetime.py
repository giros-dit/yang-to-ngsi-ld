...
class TestInterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime(unittest.TestCase):
    """InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime:
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime`
        """
        model = InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime()
        if include_optional:
            return InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime(self):
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime"""
