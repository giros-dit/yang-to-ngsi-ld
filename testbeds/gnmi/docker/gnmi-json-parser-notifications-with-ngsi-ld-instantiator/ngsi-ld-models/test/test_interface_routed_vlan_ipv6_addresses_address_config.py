...
class TestInterfaceRoutedVlanIpv6AddressesAddressConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressConfig:
        """Test InterfaceRoutedVlanIpv6AddressesAddressConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressConfig`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv6AddressesAddressConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressConfig(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressConfig"""
