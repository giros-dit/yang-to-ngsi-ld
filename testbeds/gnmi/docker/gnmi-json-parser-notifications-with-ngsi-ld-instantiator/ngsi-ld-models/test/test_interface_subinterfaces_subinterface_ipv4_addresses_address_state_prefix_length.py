...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength"""
