...
class TestInterfaceSubinterfacesSubinterfaceConfigIndex(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceConfigIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceConfigIndex:
        """Test InterfaceSubinterfacesSubinterfaceConfigIndex
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceConfigIndex`
        """
        model = InterfaceSubinterfacesSubinterfaceConfigIndex()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceConfigIndex(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceConfigIndex(self):
        """Test InterfaceSubinterfacesSubinterfaceConfigIndex"""
