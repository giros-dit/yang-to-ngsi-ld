...
class TestInterfaceStateName(unittest.TestCase):
    """InterfaceStateName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateName:
        """Test InterfaceStateName
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateName`
        """
        model = InterfaceStateName()
        if include_optional:
            return InterfaceStateName(
                type = 'Property',
                value = '',
    ...
    def testInterfaceStateName(self):
        """Test InterfaceStateName"""
