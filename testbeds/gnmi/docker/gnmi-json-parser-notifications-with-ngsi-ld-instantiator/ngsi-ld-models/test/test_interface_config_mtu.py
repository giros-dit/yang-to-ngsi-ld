...
class TestInterfaceConfigMtu(unittest.TestCase):
    """InterfaceConfigMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigMtu:
        """Test InterfaceConfigMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigMtu`
        """
        model = InterfaceConfigMtu()
        if include_optional:
            return InterfaceConfigMtu(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceConfigMtu(self):
        """Test InterfaceConfigMtu"""
