...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp"""
