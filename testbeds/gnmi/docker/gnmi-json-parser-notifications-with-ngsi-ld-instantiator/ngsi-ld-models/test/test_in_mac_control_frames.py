...
class TestInMacControlFrames(unittest.TestCase):
    """InMacControlFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InMacControlFrames:
        """Test InMacControlFrames
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InMacControlFrames`
        """
        model = InMacControlFrames()
        if include_optional:
    ...
    def testInMacControlFrames(self):
        """Test InMacControlFrames"""
