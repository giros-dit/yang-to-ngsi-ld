...
class TestInterfaceRoutedVlanConfig(unittest.TestCase):
    """InterfaceRoutedVlanConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanConfig:
        """Test InterfaceRoutedVlanConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanConfig`
        """
        model = InterfaceRoutedVlanConfig()
        if include_optional:
            return InterfaceRoutedVlanConfig(
                id = '',
                type = 'InterfaceRoutedVlanConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanConfig(self):
        """Test InterfaceRoutedVlanConfig"""
