...
class TestInterfaceRoutedVlanIpv4ConfigMtu(unittest.TestCase):
    """InterfaceRoutedVlanIpv4ConfigMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4ConfigMtu:
        """Test InterfaceRoutedVlanIpv4ConfigMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4ConfigMtu`
        """
        model = InterfaceRoutedVlanIpv4ConfigMtu()
        if include_optional:
            return InterfaceRoutedVlanIpv4ConfigMtu(
                type = 'Property',
                value = 68,
    ...
    def testInterfaceRoutedVlanIpv4ConfigMtu(self):
        """Test InterfaceRoutedVlanIpv4ConfigMtu"""
