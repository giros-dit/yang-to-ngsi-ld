...
class TestInterfaceStateMtu(unittest.TestCase):
    """InterfaceStateMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateMtu:
        """Test InterfaceStateMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateMtu`
        """
        model = InterfaceStateMtu()
        if include_optional:
            return InterfaceStateMtu(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateMtu(self):
        """Test InterfaceStateMtu"""
