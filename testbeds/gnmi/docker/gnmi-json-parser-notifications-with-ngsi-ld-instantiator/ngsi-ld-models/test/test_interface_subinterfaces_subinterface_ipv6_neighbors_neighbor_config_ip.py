...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp(
                type = 'Property',
                value = 'C:02:84::3',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp"""
