...
class TestInterfaceRoutedVlanIpv4StateCountersInDiscardedPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersInDiscardedPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersInDiscardedPkts:
        """Test InterfaceRoutedVlanIpv4StateCountersInDiscardedPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersInDiscardedPkts`
        """
        model = InterfaceRoutedVlanIpv4StateCountersInDiscardedPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersInDiscardedPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersInDiscardedPkts(self):
        """Test InterfaceRoutedVlanIpv4StateCountersInDiscardedPkts"""
