...
class TestInterfaceEthernetSwitchedVlanConfigNativeVlan(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanConfigNativeVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanConfigNativeVlan:
        """Test InterfaceEthernetSwitchedVlanConfigNativeVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanConfigNativeVlan`
        """
        model = InterfaceEthernetSwitchedVlanConfigNativeVlan()
        if include_optional:
            return InterfaceEthernetSwitchedVlanConfigNativeVlan(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetSwitchedVlanConfigNativeVlan(self):
        """Test InterfaceEthernetSwitchedVlanConfigNativeVlan"""
