...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay"""
