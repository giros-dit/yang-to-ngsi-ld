...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval"""
