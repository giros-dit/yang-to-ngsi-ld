...
class TestInterfaceSubinterfacesSubinterfaceStateCounters(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCounters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCounters:
        """Test InterfaceSubinterfacesSubinterfaceStateCounters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCounters`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCounters()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCounters(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceStateCounters',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCounters(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCounters"""
