...
class TestInterfaceRoutedVlanIpv4StateCountersOutForwardedPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersOutForwardedPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersOutForwardedPkts:
        """Test InterfaceRoutedVlanIpv4StateCountersOutForwardedPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersOutForwardedPkts`
        """
        model = InterfaceRoutedVlanIpv4StateCountersOutForwardedPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersOutForwardedPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersOutForwardedPkts(self):
        """Test InterfaceRoutedVlanIpv4StateCountersOutForwardedPkts"""
