...
class TestInterfaceRoutedVlanIpv6ConfigEnabled(unittest.TestCase):
    """InterfaceRoutedVlanIpv6ConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6ConfigEnabled:
        """Test InterfaceRoutedVlanIpv6ConfigEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6ConfigEnabled`
        """
        model = InterfaceRoutedVlanIpv6ConfigEnabled()
        if include_optional:
            return InterfaceRoutedVlanIpv6ConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6ConfigEnabled(self):
        """Test InterfaceRoutedVlanIpv6ConfigEnabled"""
