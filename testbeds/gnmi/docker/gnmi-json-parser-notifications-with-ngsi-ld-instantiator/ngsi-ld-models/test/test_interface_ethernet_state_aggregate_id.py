...
class TestInterfaceEthernetStateAggregateId(unittest.TestCase):
    """InterfaceEthernetStateAggregateId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStateAggregateId:
        """Test InterfaceEthernetStateAggregateId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStateAggregateId`
        """
        model = InterfaceEthernetStateAggregateId()
        if include_optional:
            return InterfaceEthernetStateAggregateId(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceEthernetStateAggregateId(self):
        """Test InterfaceEthernetStateAggregateId"""
