...
class TestInterfaceRoutedVlanIpv6StateCountersOutErrorPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersOutErrorPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersOutErrorPkts:
        """Test InterfaceRoutedVlanIpv6StateCountersOutErrorPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersOutErrorPkts`
        """
        model = InterfaceRoutedVlanIpv6StateCountersOutErrorPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersOutErrorPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersOutErrorPkts(self):
        """Test InterfaceRoutedVlanIpv6StateCountersOutErrorPkts"""
