...
class TestInterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface:
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface"""
