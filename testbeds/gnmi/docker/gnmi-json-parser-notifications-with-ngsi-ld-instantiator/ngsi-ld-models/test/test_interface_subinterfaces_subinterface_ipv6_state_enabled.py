...
class TestInterfaceSubinterfacesSubinterfaceIpv6StateEnabled(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6StateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6StateEnabled:
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6StateEnabled`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6StateEnabled()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6StateEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6StateEnabled(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateEnabled"""
