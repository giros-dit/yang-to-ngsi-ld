...
class TestInterfaceRoutedVlanIpv4UnnumberedConfigEnabled(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedConfigEnabled:
        """Test InterfaceRoutedVlanIpv4UnnumberedConfigEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedConfigEnabled`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedConfigEnabled()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedConfigEnabled(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedConfigEnabled"""
