...
class TestOut8021qFrames(unittest.TestCase):
    """Out8021qFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Out8021qFrames:
        """Test Out8021qFrames
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Out8021qFrames`
        """
        model = Out8021qFrames()
        if include_optional:
            return Out8021qFrames(
                type = 'Property',
                value = 56,
