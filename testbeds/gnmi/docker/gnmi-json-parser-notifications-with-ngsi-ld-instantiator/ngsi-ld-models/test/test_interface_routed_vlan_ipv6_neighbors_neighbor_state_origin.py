...
class TestInterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin(unittest.TestCase):
    """InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin:
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin`
        """
        model = InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin()
        if include_optional:
            return InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin(
                type = 'Property',
                value = 'OTHER',
    ...
    def testInterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin(self):
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin"""
