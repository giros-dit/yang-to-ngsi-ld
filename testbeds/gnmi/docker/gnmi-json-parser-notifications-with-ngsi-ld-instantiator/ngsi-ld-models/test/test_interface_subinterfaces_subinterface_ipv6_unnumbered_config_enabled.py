...
class TestInterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled:
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled"""
