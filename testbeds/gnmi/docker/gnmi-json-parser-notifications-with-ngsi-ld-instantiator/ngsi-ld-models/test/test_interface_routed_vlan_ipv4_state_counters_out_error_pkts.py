...
class TestInterfaceRoutedVlanIpv4StateCountersOutErrorPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersOutErrorPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersOutErrorPkts:
        """Test InterfaceRoutedVlanIpv4StateCountersOutErrorPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersOutErrorPkts`
        """
        model = InterfaceRoutedVlanIpv4StateCountersOutErrorPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersOutErrorPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersOutErrorPkts(self):
        """Test InterfaceRoutedVlanIpv4StateCountersOutErrorPkts"""
