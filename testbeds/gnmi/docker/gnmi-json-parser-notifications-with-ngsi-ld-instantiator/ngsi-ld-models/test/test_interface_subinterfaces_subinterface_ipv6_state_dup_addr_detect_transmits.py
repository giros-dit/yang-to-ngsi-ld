...
class TestInterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits:
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateDupAddrDetectTransmits"""
