...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority"""
