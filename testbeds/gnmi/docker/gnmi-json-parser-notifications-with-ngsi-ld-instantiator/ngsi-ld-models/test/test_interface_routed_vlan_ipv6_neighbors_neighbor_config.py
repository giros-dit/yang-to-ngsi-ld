...
class TestInterfaceRoutedVlanIpv6NeighborsNeighborConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv6NeighborsNeighborConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6NeighborsNeighborConfig:
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6NeighborsNeighborConfig`
        """
        model = InterfaceRoutedVlanIpv6NeighborsNeighborConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv6NeighborsNeighborConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv6NeighborsNeighborConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6NeighborsNeighborConfig(self):
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborConfig"""
