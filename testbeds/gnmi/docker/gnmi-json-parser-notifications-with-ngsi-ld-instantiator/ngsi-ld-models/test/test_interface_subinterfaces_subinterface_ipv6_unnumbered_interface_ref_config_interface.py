...
class TestInterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface:
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefConfigInterface"""
