...
class TestVlanConfigName(unittest.TestCase):
    """VlanConfigName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanConfigName:
        """Test VlanConfigName
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanConfigName`
        """
        model = VlanConfigName()
        if include_optional:
            return VlanConfigName(
                type = 'Property',
                value = '',
