...
class TestInterfaceRoutedVlanIpv6StateEnabled(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateEnabled:
        """Test InterfaceRoutedVlanIpv6StateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateEnabled`
        """
        model = InterfaceRoutedVlanIpv6StateEnabled()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6StateEnabled(self):
        """Test InterfaceRoutedVlanIpv6StateEnabled"""
