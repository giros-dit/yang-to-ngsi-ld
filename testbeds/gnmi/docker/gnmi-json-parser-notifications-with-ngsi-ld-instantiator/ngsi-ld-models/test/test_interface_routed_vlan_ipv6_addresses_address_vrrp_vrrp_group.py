...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup(
                id = '',
                type = 'InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroup"""
