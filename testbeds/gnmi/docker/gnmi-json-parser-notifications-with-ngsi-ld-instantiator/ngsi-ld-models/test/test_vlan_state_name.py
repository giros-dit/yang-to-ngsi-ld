...
class TestVlanStateName(unittest.TestCase):
    """VlanStateName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanStateName:
        """Test VlanStateName
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanStateName`
        """
        model = VlanStateName()
        if include_optional:
            return VlanStateName(
                type = 'Property',
                value = '',
