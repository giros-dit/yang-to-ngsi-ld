...
class TestInterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface(unittest.TestCase):
    """InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface:
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface`
        """
        model = InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface()
        if include_optional:
            return InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface(self):
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface"""
