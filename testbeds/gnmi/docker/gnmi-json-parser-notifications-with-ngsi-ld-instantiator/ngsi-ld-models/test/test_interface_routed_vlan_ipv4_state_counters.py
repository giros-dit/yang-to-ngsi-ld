...
class TestInterfaceRoutedVlanIpv4StateCounters(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCounters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCounters:
        """Test InterfaceRoutedVlanIpv4StateCounters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCounters`
        """
        model = InterfaceRoutedVlanIpv4StateCounters()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCounters(
                id = '',
                type = 'InterfaceRoutedVlanIpv4StateCounters',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4StateCounters(self):
        """Test InterfaceRoutedVlanIpv4StateCounters"""
