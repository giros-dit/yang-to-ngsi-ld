...
class TestInterfaceAggregationSwitchedVlanConfigAccessVlan(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanConfigAccessVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanConfigAccessVlan:
        """Test InterfaceAggregationSwitchedVlanConfigAccessVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanConfigAccessVlan`
        """
        model = InterfaceAggregationSwitchedVlanConfigAccessVlan()
        if include_optional:
            return InterfaceAggregationSwitchedVlanConfigAccessVlan(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceAggregationSwitchedVlanConfigAccessVlan(self):
        """Test InterfaceAggregationSwitchedVlanConfigAccessVlan"""
