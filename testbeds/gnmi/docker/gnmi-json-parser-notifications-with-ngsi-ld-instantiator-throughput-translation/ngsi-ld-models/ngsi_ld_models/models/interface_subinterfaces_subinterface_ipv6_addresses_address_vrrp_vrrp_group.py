...
class InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroup(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroup.")
    ...
    virtual_router_id: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId] = Field(default=None, alias="virtualRouterId")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroup'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroup')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroup',
            ...
            "virtualRouterId": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
