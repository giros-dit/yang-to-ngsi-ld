...
class InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp] = None
    link_layer_address: InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress = Field(alias="linkLayerAddress")
    origin: Optional[InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin] = None
    is_router: Optional[InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter] = Field(default=None, alias="isRouter")
    neighbor_state: Optional[InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState] = Field(default=None, alias="neighborState")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ip", "linkLayerAddress", "origin", "isRouter", "neighborState", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of is_router
        if self.is_router:
            _dict['isRouter'] = self.is_router.to_dict()
        # override the default output from pydantic by calling `to_dict()` of neighbor_state
        if self.neighbor_state:
            _dict['neighborState'] = self.neighbor_state.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
            "origin": InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "isRouter": InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter.from_dict(obj["isRouter"]) if obj.get("isRouter") is not None else None,
            "neighborState": InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState.from_dict(obj["neighborState"]) if obj.get("neighborState") is not None else None,
