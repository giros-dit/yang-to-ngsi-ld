...
class InterfaceSubinterfacesSubinterfaceIpv6Config(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6Config.")
    ...
    enabled: Optional[InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled] = None
    mtu: Optional[InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu] = None
    dup_addr_detect_transmits: Optional[InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits] = Field(default=None, alias="dupAddrDetectTransmits")
    dhcp_client: Optional[InterfaceSubinterfacesSubinterfaceIpv6ConfigDhcpClient] = Field(default=None, alias="dhcpClient")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "enabled", "mtu", "dupAddrDetectTransmits", "dhcpClient", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6Config'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6Config')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.dhcp_client:
            _dict['dhcpClient'] = self.dhcp_client.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6Config',
            ...
            "enabled": InterfaceSubinterfacesSubinterfaceIpv6ConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "mtu": InterfaceSubinterfacesSubinterfaceIpv6ConfigMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dupAddrDetectTransmits": InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits.from_dict(obj["dupAddrDetectTransmits"]) if obj.get("dupAddrDetectTransmits") is not None else None,
            "dhcpClient": InterfaceSubinterfacesSubinterfaceIpv6ConfigDhcpClient.from_dict(obj["dhcpClient"]) if obj.get("dhcpClient") is not None else None,
