...
class InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
