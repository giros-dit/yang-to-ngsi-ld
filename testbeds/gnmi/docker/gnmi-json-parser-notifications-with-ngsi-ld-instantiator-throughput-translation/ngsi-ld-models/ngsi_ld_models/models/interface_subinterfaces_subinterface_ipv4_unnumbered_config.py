...
class InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig.")
    ...
    enabled: Optional[InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "enabled", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig',
            ...
            "enabled": InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
