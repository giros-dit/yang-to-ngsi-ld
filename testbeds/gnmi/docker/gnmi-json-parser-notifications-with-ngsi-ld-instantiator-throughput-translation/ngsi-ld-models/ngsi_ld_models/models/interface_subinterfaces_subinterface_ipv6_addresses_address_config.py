...
class InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfig.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp] = None
    prefix_length: InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength = Field(alias="prefixLength")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfig',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
