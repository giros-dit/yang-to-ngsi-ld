...
class InterfaceAggregationSwitchedVlanConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceAggregationSwitchedVlanConfig.")
    ...
    interface_mode: Optional[InterfaceAggregationSwitchedVlanConfigInterfaceMode] = Field(default=None, alias="interfaceMode")
    native_vlan: Optional[InterfaceAggregationSwitchedVlanConfigNativeVlan] = Field(default=None, alias="nativeVlan")
    access_vlan: Optional[InterfaceAggregationSwitchedVlanConfigAccessVlan] = Field(default=None, alias="accessVlan")
    trunk_vlans: Optional[InterfaceAggregationSwitchedVlanConfigTrunkVlans] = Field(default=None, alias="trunkVlans")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "interfaceMode", "nativeVlan", "accessVlan", "trunkVlans", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceAggregationSwitchedVlanConfig'):
            raise ValueError("must be one of enum values ('InterfaceAggregationSwitchedVlanConfig')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of interface_mode
        if self.interface_mode:
            _dict['interfaceMode'] = self.interface_mode.to_dict()
        # override the default output from pydantic by calling `to_dict()` of native_vlan
        if self.native_vlan:
            _dict['nativeVlan'] = self.native_vlan.to_dict()
        # override the default output from pydantic by calling `to_dict()` of access_vlan
        if self.access_vlan:
            _dict['accessVlan'] = self.access_vlan.to_dict()
        # override the default output from pydantic by calling `to_dict()` of trunk_vlans
        if self.trunk_vlans:
            _dict['trunkVlans'] = self.trunk_vlans.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceAggregationSwitchedVlanConfig',
            ...
            "interfaceMode": InterfaceAggregationSwitchedVlanConfigInterfaceMode.from_dict(obj["interfaceMode"]) if obj.get("interfaceMode") is not None else None,
            "nativeVlan": InterfaceAggregationSwitchedVlanConfigNativeVlan.from_dict(obj["nativeVlan"]) if obj.get("nativeVlan") is not None else None,
            "accessVlan": InterfaceAggregationSwitchedVlanConfigAccessVlan.from_dict(obj["accessVlan"]) if obj.get("accessVlan") is not None else None,
            "trunkVlans": InterfaceAggregationSwitchedVlanConfigTrunkVlans.from_dict(obj["trunkVlans"]) if obj.get("trunkVlans") is not None else None,
