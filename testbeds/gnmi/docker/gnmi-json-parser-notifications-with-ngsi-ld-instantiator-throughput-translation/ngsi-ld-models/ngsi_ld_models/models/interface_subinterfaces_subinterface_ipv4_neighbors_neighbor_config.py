...
class InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp] = None
    link_layer_address: InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigLinkLayerAddress = Field(alias="linkLayerAddress")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ip", "linkLayerAddress", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
