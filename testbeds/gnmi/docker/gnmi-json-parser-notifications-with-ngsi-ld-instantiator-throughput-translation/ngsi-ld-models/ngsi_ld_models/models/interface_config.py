...
class InterfaceConfig(BaseModel):
    ...
    name: Optional[InterfaceConfigName] = None
    config_type: InterfaceConfigType = Field(alias="configType")
    mtu: Optional[InterfaceConfigMtu] = None
    loopback_mode: Optional[InterfaceConfigLoopbackMode] = Field(default=None, alias="loopbackMode")
    description: Optional[InterfaceConfigDescription] = None
    enabled: Optional[InterfaceConfigEnabled] = None
    tpid: Optional[InterfaceConfigTpid] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "configType", "mtu", "loopbackMode", "description", "enabled", "tpid", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceConfig'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "configType": InterfaceConfigType.from_dict(obj["configType"]) if obj.get("configType") is not None else None,
            "mtu": InterfaceConfigMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "loopbackMode": InterfaceConfigLoopbackMode.from_dict(obj["loopbackMode"]) if obj.get("loopbackMode") is not None else None,
            "description": InterfaceConfigDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "enabled": InterfaceConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "tpid": InterfaceConfigTpid.from_dict(obj["tpid"]) if obj.get("tpid") is not None else None,
