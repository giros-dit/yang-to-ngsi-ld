...
class InterfaceHoldTimeConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceHoldTimeConfig.")
    ...
    up: Optional[InterfaceHoldTimeConfigUp] = None
    down: Optional[InterfaceHoldTimeConfigDown] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "up", "down", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceHoldTimeConfig'):
            raise ValueError("must be one of enum values ('InterfaceHoldTimeConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceHoldTimeConfig',
            ...
            "up": InterfaceHoldTimeConfigUp.from_dict(obj["up"]) if obj.get("up") is not None else None,
            "down": InterfaceHoldTimeConfigDown.from_dict(obj["down"]) if obj.get("down") is not None else None,
