...
class TestInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState:
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState"""
