...
class TestInterfaceRoutedVlanIpv6StateCountersOutForwardedOctets(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersOutForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersOutForwardedOctets:
        """Test InterfaceRoutedVlanIpv6StateCountersOutForwardedOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersOutForwardedOctets`
        """
        model = InterfaceRoutedVlanIpv6StateCountersOutForwardedOctets()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersOutForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersOutForwardedOctets(self):
        """Test InterfaceRoutedVlanIpv6StateCountersOutForwardedOctets"""
