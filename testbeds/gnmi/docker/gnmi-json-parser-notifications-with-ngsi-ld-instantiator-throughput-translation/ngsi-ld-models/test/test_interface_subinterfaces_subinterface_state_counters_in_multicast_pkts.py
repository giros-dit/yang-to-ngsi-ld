...
class TestInterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInMulticastPkts"""
