...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePriority"""
