...
class TestInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp"""
