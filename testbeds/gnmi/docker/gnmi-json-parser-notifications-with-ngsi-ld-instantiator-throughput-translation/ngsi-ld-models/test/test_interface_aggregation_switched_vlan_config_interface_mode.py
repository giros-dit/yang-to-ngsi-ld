...
class TestInterfaceAggregationSwitchedVlanConfigInterfaceMode(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanConfigInterfaceMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanConfigInterfaceMode:
        """Test InterfaceAggregationSwitchedVlanConfigInterfaceMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanConfigInterfaceMode`
        """
        model = InterfaceAggregationSwitchedVlanConfigInterfaceMode()
        if include_optional:
            return InterfaceAggregationSwitchedVlanConfigInterfaceMode(
                type = 'Property',
                value = 'ACCESS',
    ...
    def testInterfaceAggregationSwitchedVlanConfigInterfaceMode(self):
        """Test InterfaceAggregationSwitchedVlanConfigInterfaceMode"""
