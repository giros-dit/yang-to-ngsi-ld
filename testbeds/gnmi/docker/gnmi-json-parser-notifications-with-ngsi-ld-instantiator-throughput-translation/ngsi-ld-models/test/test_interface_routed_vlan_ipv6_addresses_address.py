...
class TestInterfaceRoutedVlanIpv6AddressesAddress(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddress:
        """Test InterfaceRoutedVlanIpv6AddressesAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddress`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddress()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddress(
                id = '',
                type = 'InterfaceRoutedVlanIpv6AddressesAddress',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddress(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddress"""
