...
class TestInterfaceAggregationStateMinLinks(unittest.TestCase):
    """InterfaceAggregationStateMinLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationStateMinLinks:
        """Test InterfaceAggregationStateMinLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationStateMinLinks`
        """
        model = InterfaceAggregationStateMinLinks()
        if include_optional:
            return InterfaceAggregationStateMinLinks(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceAggregationStateMinLinks(self):
        """Test InterfaceAggregationStateMinLinks"""
