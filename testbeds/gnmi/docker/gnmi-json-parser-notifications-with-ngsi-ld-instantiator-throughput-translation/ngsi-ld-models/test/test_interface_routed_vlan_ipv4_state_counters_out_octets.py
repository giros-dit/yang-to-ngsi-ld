...
class TestInterfaceRoutedVlanIpv4StateCountersOutOctets(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersOutOctets:
        """Test InterfaceRoutedVlanIpv4StateCountersOutOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersOutOctets`
        """
        model = InterfaceRoutedVlanIpv4StateCountersOutOctets()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersOutOctets(self):
        """Test InterfaceRoutedVlanIpv4StateCountersOutOctets"""
