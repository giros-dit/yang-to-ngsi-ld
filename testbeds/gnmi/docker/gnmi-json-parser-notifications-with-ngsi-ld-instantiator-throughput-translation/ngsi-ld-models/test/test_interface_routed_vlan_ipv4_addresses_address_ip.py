...
class TestInterfaceRoutedVlanIpv4AddressesAddressIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressIp:
        """Test InterfaceRoutedVlanIpv4AddressesAddressIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressIp`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressIp()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressIp(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressIp(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressIp"""
