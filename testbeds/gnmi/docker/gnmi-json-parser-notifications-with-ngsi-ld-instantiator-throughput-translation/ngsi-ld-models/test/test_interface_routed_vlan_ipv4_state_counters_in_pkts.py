...
class TestInterfaceRoutedVlanIpv4StateCountersInPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersInPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersInPkts:
        """Test InterfaceRoutedVlanIpv4StateCountersInPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersInPkts`
        """
        model = InterfaceRoutedVlanIpv4StateCountersInPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersInPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersInPkts(self):
        """Test InterfaceRoutedVlanIpv4StateCountersInPkts"""
