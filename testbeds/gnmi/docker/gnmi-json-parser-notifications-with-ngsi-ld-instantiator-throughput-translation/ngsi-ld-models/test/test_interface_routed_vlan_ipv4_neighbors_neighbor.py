...
class TestInterfaceRoutedVlanIpv4NeighborsNeighbor(unittest.TestCase):
    """InterfaceRoutedVlanIpv4NeighborsNeighbor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4NeighborsNeighbor:
        """Test InterfaceRoutedVlanIpv4NeighborsNeighbor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4NeighborsNeighbor`
        """
        model = InterfaceRoutedVlanIpv4NeighborsNeighbor()
        if include_optional:
            return InterfaceRoutedVlanIpv4NeighborsNeighbor(
                id = '',
                type = 'InterfaceRoutedVlanIpv4NeighborsNeighbor',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4NeighborsNeighbor(self):
        """Test InterfaceRoutedVlanIpv4NeighborsNeighbor"""
