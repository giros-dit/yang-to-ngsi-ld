...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority"""
