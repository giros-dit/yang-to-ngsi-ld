...
class TestInterfaceRoutedVlanIpv6StateCountersInOctets(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersInOctets:
        """Test InterfaceRoutedVlanIpv6StateCountersInOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersInOctets`
        """
        model = InterfaceRoutedVlanIpv6StateCountersInOctets()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersInOctets(self):
        """Test InterfaceRoutedVlanIpv6StateCountersInOctets"""
