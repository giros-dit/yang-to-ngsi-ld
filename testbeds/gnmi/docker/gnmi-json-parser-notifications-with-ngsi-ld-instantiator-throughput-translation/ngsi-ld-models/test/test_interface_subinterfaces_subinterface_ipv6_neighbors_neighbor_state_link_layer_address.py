...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress(
                type = 'Property',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateLinkLayerAddress"""
