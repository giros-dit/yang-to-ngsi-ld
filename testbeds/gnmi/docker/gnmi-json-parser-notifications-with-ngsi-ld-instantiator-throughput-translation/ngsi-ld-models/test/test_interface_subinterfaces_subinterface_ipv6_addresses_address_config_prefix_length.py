...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigPrefixLength"""
