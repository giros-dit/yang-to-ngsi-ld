...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId"""
