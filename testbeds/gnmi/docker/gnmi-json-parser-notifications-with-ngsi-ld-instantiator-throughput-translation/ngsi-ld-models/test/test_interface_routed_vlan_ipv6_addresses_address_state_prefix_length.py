...
class TestInterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength:
        """Test InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength"""
