...
class TestOutMacControlFrames(unittest.TestCase):
    """OutMacControlFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutMacControlFrames:
        """Test OutMacControlFrames
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutMacControlFrames`
        """
        model = OutMacControlFrames()
        if include_optional:
            return OutMacControlFrames(
                type = 'Property',
                value = 56,
    ...
    def testOutMacControlFrames(self):
        """Test OutMacControlFrames"""
