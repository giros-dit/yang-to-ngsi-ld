...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId"""
