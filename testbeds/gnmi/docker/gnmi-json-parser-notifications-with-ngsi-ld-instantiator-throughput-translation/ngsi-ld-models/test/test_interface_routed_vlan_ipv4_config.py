...
class TestInterfaceRoutedVlanIpv4Config(unittest.TestCase):
    """InterfaceRoutedVlanIpv4Config unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4Config:
        """Test InterfaceRoutedVlanIpv4Config
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4Config`
        """
        model = InterfaceRoutedVlanIpv4Config()
        if include_optional:
            return InterfaceRoutedVlanIpv4Config(
                id = '',
                type = 'InterfaceRoutedVlanIpv4Config',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4Config(self):
        """Test InterfaceRoutedVlanIpv4Config"""
