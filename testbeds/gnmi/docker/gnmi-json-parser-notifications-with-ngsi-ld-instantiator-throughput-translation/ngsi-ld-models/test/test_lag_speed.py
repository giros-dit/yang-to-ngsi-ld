...
class TestLagSpeed(unittest.TestCase):
    """LagSpeed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LagSpeed:
        """Test LagSpeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LagSpeed`
        """
        model = LagSpeed()
        if include_optional:
            return LagSpeed(
