...
class TestInterfaceStateCountersInMulticastPkts(unittest.TestCase):
    """InterfaceStateCountersInMulticastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersInMulticastPkts:
        """Test InterfaceStateCountersInMulticastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersInMulticastPkts`
        """
        model = InterfaceStateCountersInMulticastPkts()
        if include_optional:
            return InterfaceStateCountersInMulticastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersInMulticastPkts(self):
        """Test InterfaceStateCountersInMulticastPkts"""
