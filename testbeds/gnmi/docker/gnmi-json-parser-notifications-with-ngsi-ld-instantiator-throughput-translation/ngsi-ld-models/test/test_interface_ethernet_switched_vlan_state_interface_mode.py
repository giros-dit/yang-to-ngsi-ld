...
class TestInterfaceEthernetSwitchedVlanStateInterfaceMode(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanStateInterfaceMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanStateInterfaceMode:
        """Test InterfaceEthernetSwitchedVlanStateInterfaceMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanStateInterfaceMode`
        """
        model = InterfaceEthernetSwitchedVlanStateInterfaceMode()
        if include_optional:
            return InterfaceEthernetSwitchedVlanStateInterfaceMode(
                type = 'Property',
                value = 'ACCESS',
    ...
    def testInterfaceEthernetSwitchedVlanStateInterfaceMode(self):
        """Test InterfaceEthernetSwitchedVlanStateInterfaceMode"""
