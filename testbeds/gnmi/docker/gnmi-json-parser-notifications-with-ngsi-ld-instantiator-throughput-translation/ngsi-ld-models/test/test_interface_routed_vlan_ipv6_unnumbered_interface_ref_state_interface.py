...
class TestInterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface(unittest.TestCase):
    """InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface:
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface`
        """
        model = InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface()
        if include_optional:
            return InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface(self):
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface"""
