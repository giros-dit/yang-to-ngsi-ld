...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal(
                type = 'Property',
                value = '',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal"""
