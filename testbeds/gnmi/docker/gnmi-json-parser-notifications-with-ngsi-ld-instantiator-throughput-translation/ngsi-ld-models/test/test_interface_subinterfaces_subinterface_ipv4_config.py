...
class TestInterfaceSubinterfacesSubinterfaceIpv4Config(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4Config unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4Config:
        """Test InterfaceSubinterfacesSubinterfaceIpv4Config
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4Config`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4Config()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4Config(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4Config',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4Config(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4Config"""
