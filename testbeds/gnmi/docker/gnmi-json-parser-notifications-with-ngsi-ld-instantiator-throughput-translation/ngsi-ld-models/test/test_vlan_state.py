...
class TestVlanState(unittest.TestCase):
    """VlanState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanState:
        """Test VlanState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanState`
        """
        model = VlanState()
        if include_optional:
            return VlanState(
