...
class TestInterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig:
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfig"""
