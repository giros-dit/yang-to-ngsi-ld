...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddress(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddress(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddress"""
