...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin(
                type = 'Property',
                value = 'OTHER',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateOrigin"""
