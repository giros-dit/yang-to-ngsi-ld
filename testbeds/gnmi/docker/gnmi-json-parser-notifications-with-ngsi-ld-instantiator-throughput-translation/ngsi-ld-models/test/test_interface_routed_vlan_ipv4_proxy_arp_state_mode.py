...
class TestInterfaceRoutedVlanIpv4ProxyArpStateMode(unittest.TestCase):
    """InterfaceRoutedVlanIpv4ProxyArpStateMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4ProxyArpStateMode:
        """Test InterfaceRoutedVlanIpv4ProxyArpStateMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4ProxyArpStateMode`
        """
        model = InterfaceRoutedVlanIpv4ProxyArpStateMode()
        if include_optional:
            return InterfaceRoutedVlanIpv4ProxyArpStateMode(
                type = 'Property',
                value = 'DISABLE',
    ...
    def testInterfaceRoutedVlanIpv4ProxyArpStateMode(self):
        """Test InterfaceRoutedVlanIpv4ProxyArpStateMode"""
