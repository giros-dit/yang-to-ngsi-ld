...
class TestInterfaceSubinterfacesSubinterfaceIpv4StateMtu(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4StateMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4StateMtu:
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4StateMtu`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4StateMtu()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4StateMtu(
                type = 'Property',
                value = 68,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4StateMtu(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateMtu"""
