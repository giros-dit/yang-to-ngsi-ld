...
class TestInterfaceRoutedVlanIpv4NeighborsNeighborState(unittest.TestCase):
    """InterfaceRoutedVlanIpv4NeighborsNeighborState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4NeighborsNeighborState:
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4NeighborsNeighborState`
        """
        model = InterfaceRoutedVlanIpv4NeighborsNeighborState()
        if include_optional:
            return InterfaceRoutedVlanIpv4NeighborsNeighborState(
                id = '',
                type = 'InterfaceRoutedVlanIpv4NeighborsNeighborState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4NeighborsNeighborState(self):
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborState"""
