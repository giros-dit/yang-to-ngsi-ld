...
class TestInterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface(unittest.TestCase):
    """InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface:
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface`
        """
        model = InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface()
        if include_optional:
            return InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface(self):
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfigInterface"""
