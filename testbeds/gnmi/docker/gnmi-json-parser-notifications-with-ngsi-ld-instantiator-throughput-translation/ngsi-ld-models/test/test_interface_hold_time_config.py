...
class TestInterfaceHoldTimeConfig(unittest.TestCase):
    """InterfaceHoldTimeConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceHoldTimeConfig:
        """Test InterfaceHoldTimeConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceHoldTimeConfig`
        """
        model = InterfaceHoldTimeConfig()
        if include_optional:
            return InterfaceHoldTimeConfig(
                id = '',
                type = 'InterfaceHoldTimeConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceHoldTimeConfig(self):
        """Test InterfaceHoldTimeConfig"""
