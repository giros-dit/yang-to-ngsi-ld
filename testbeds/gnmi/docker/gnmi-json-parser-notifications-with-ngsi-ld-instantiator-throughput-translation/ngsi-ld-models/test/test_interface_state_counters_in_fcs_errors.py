...
class TestInterfaceStateCountersInFcsErrors(unittest.TestCase):
    """InterfaceStateCountersInFcsErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersInFcsErrors:
        """Test InterfaceStateCountersInFcsErrors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersInFcsErrors`
        """
        model = InterfaceStateCountersInFcsErrors()
        if include_optional:
            return InterfaceStateCountersInFcsErrors(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersInFcsErrors(self):
        """Test InterfaceStateCountersInFcsErrors"""
