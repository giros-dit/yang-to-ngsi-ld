...
class TestInterfaceStateCountersInUnknownProtos(unittest.TestCase):
    """InterfaceStateCountersInUnknownProtos unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersInUnknownProtos:
        """Test InterfaceStateCountersInUnknownProtos
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersInUnknownProtos`
        """
        model = InterfaceStateCountersInUnknownProtos()
        if include_optional:
            return InterfaceStateCountersInUnknownProtos(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersInUnknownProtos(self):
        """Test InterfaceStateCountersInUnknownProtos"""
