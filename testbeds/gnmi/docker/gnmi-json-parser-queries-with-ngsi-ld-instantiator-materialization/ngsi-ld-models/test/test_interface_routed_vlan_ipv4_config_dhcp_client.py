...
class TestInterfaceRoutedVlanIpv4ConfigDhcpClient(unittest.TestCase):
    """InterfaceRoutedVlanIpv4ConfigDhcpClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4ConfigDhcpClient:
        """Test InterfaceRoutedVlanIpv4ConfigDhcpClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4ConfigDhcpClient`
        """
        model = InterfaceRoutedVlanIpv4ConfigDhcpClient()
        if include_optional:
            return InterfaceRoutedVlanIpv4ConfigDhcpClient(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv4ConfigDhcpClient(self):
        """Test InterfaceRoutedVlanIpv4ConfigDhcpClient"""
