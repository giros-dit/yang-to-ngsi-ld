...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighbor"""
