...
class TestInterfaceRoutedVlanIpv6StateDhcpClient(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateDhcpClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateDhcpClient:
        """Test InterfaceRoutedVlanIpv6StateDhcpClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateDhcpClient`
        """
        model = InterfaceRoutedVlanIpv6StateDhcpClient()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateDhcpClient(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6StateDhcpClient(self):
        """Test InterfaceRoutedVlanIpv6StateDhcpClient"""
