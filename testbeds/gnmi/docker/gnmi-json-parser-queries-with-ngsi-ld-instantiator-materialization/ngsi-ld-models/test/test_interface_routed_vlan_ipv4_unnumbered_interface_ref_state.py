...
class TestInterfaceRoutedVlanIpv4UnnumberedInterfaceRefState(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedInterfaceRefState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedInterfaceRefState:
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedInterfaceRefState`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedInterfaceRefState()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedInterfaceRefState(
                id = '',
                type = 'InterfaceRoutedVlanIpv4UnnumberedInterfaceRefState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedInterfaceRefState(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefState"""
