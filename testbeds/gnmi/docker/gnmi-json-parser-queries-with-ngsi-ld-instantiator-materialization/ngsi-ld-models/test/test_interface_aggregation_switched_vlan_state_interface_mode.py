...
class TestInterfaceAggregationSwitchedVlanStateInterfaceMode(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanStateInterfaceMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanStateInterfaceMode:
        """Test InterfaceAggregationSwitchedVlanStateInterfaceMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanStateInterfaceMode`
        """
        model = InterfaceAggregationSwitchedVlanStateInterfaceMode()
        if include_optional:
            return InterfaceAggregationSwitchedVlanStateInterfaceMode(
                type = 'Property',
                value = 'ACCESS',
    ...
    def testInterfaceAggregationSwitchedVlanStateInterfaceMode(self):
        """Test InterfaceAggregationSwitchedVlanStateInterfaceMode"""
