...
class TestInterfaceSubinterfacesSubinterfaceStateCountersInOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersInOctets:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersInOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersInOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersInOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInOctets"""
