...
class TestInterfaceStateCountersInOctets(unittest.TestCase):
    """InterfaceStateCountersInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersInOctets:
        """Test InterfaceStateCountersInOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersInOctets`
        """
        model = InterfaceStateCountersInOctets()
        if include_optional:
            return InterfaceStateCountersInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersInOctets(self):
        """Test InterfaceStateCountersInOctets"""
