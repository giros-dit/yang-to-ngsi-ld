...
class TestInterfaceRoutedVlanIpv6ConfigDhcpClient(unittest.TestCase):
    """InterfaceRoutedVlanIpv6ConfigDhcpClient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6ConfigDhcpClient:
        """Test InterfaceRoutedVlanIpv6ConfigDhcpClient
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6ConfigDhcpClient`
        """
        model = InterfaceRoutedVlanIpv6ConfigDhcpClient()
        if include_optional:
            return InterfaceRoutedVlanIpv6ConfigDhcpClient(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6ConfigDhcpClient(self):
        """Test InterfaceRoutedVlanIpv6ConfigDhcpClient"""
