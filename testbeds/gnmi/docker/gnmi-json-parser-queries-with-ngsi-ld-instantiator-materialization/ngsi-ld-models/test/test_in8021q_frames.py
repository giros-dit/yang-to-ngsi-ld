...
class TestIn8021qFrames(unittest.TestCase):
    """In8021qFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> In8021qFrames:
        """Test In8021qFrames
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `In8021qFrames`
        """
        model = In8021qFrames()
        if include_optional:
            return In8021qFrames(
                type = 'Property',
                value = 56,
