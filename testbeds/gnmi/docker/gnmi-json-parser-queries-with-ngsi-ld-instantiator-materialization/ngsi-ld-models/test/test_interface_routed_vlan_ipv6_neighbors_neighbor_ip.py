...
class TestInterfaceRoutedVlanIpv6NeighborsNeighborIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv6NeighborsNeighborIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6NeighborsNeighborIp:
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6NeighborsNeighborIp`
        """
        model = InterfaceRoutedVlanIpv6NeighborsNeighborIp()
        if include_optional:
            return InterfaceRoutedVlanIpv6NeighborsNeighborIp(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv6NeighborsNeighborIp(self):
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborIp"""
