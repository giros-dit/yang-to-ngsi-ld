...
class TestInterfaceStateLoopbackMode(unittest.TestCase):
    """InterfaceStateLoopbackMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateLoopbackMode:
        """Test InterfaceStateLoopbackMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateLoopbackMode`
        """
        model = InterfaceStateLoopbackMode()
        if include_optional:
            return InterfaceStateLoopbackMode(
                type = 'Property',
                value = True,
    ...
    def testInterfaceStateLoopbackMode(self):
        """Test InterfaceStateLoopbackMode"""
