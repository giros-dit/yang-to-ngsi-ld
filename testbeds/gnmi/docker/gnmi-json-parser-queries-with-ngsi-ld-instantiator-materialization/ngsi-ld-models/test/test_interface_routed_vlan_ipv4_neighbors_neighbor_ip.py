...
class TestInterfaceRoutedVlanIpv4NeighborsNeighborIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv4NeighborsNeighborIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4NeighborsNeighborIp:
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4NeighborsNeighborIp`
        """
        model = InterfaceRoutedVlanIpv4NeighborsNeighborIp()
        if include_optional:
            return InterfaceRoutedVlanIpv4NeighborsNeighborIp(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv4NeighborsNeighborIp(self):
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborIp"""
