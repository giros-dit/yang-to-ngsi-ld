...
class TestInterfaceRoutedVlanIpv4StateCountersInErrorPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersInErrorPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersInErrorPkts:
        """Test InterfaceRoutedVlanIpv4StateCountersInErrorPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersInErrorPkts`
        """
        model = InterfaceRoutedVlanIpv4StateCountersInErrorPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersInErrorPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersInErrorPkts(self):
        """Test InterfaceRoutedVlanIpv4StateCountersInErrorPkts"""
