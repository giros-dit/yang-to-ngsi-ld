...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp(
                type = 'Property',
                value = 'C:02:84::3',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressConfigIp"""
