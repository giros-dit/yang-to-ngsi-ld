...
class TestInterfaceAggregationSwitchedVlanConfig(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanConfig:
        """Test InterfaceAggregationSwitchedVlanConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanConfig`
        """
        model = InterfaceAggregationSwitchedVlanConfig()
        if include_optional:
            return InterfaceAggregationSwitchedVlanConfig(
                id = '',
                type = 'InterfaceAggregationSwitchedVlanConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceAggregationSwitchedVlanConfig(self):
        """Test InterfaceAggregationSwitchedVlanConfig"""
