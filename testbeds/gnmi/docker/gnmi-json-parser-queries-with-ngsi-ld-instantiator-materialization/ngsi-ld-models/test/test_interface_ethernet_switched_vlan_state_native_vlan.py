...
class TestInterfaceEthernetSwitchedVlanStateNativeVlan(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanStateNativeVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanStateNativeVlan:
        """Test InterfaceEthernetSwitchedVlanStateNativeVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanStateNativeVlan`
        """
        model = InterfaceEthernetSwitchedVlanStateNativeVlan()
        if include_optional:
            return InterfaceEthernetSwitchedVlanStateNativeVlan(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetSwitchedVlanStateNativeVlan(self):
        """Test InterfaceEthernetSwitchedVlanStateNativeVlan"""
