...
class TestInterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength:
        """Test InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength"""
