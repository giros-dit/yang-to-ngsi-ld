...
class TestInterfaceHoldTimeStateDown(unittest.TestCase):
    """InterfaceHoldTimeStateDown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceHoldTimeStateDown:
        """Test InterfaceHoldTimeStateDown
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceHoldTimeStateDown`
        """
        model = InterfaceHoldTimeStateDown()
        if include_optional:
            return InterfaceHoldTimeStateDown(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceHoldTimeStateDown(self):
        """Test InterfaceHoldTimeStateDown"""
