...
class TestInterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress(unittest.TestCase):
    """InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress:
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress`
        """
        model = InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress()
        if include_optional:
            return InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress(self):
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementStateSuppress"""
