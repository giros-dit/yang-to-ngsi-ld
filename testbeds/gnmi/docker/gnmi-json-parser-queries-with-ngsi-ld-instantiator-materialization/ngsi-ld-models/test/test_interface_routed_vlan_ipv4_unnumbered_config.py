...
class TestInterfaceRoutedVlanIpv4UnnumberedConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedConfig:
        """Test InterfaceRoutedVlanIpv4UnnumberedConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedConfig`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv4UnnumberedConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedConfig(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedConfig"""
