...
class TestInterfaceRoutedVlanIpv4UnnumberedState(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedState:
        """Test InterfaceRoutedVlanIpv4UnnumberedState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedState`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedState()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedState(
                id = '',
                type = 'InterfaceRoutedVlanIpv4UnnumberedState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedState(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedState"""
