...
class TestInterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets:
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets"""
