...
class TestInterfaceStateCountersInUnicastPkts(unittest.TestCase):
    """InterfaceStateCountersInUnicastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersInUnicastPkts:
        """Test InterfaceStateCountersInUnicastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersInUnicastPkts`
        """
        model = InterfaceStateCountersInUnicastPkts()
        if include_optional:
            return InterfaceStateCountersInUnicastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersInUnicastPkts(self):
        """Test InterfaceStateCountersInUnicastPkts"""
