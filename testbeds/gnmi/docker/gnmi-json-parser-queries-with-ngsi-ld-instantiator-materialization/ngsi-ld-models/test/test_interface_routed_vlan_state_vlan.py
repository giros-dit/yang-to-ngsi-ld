...
class TestInterfaceRoutedVlanStateVlan(unittest.TestCase):
    """InterfaceRoutedVlanStateVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanStateVlan:
        """Test InterfaceRoutedVlanStateVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanStateVlan`
        """
        model = InterfaceRoutedVlanStateVlan()
        if include_optional:
            return InterfaceRoutedVlanStateVlan(
                type = 'Property',
                value = '',
    ...
    def testInterfaceRoutedVlanStateVlan(self):
        """Test InterfaceRoutedVlanStateVlan"""
