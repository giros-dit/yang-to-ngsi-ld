...
class TestInterfaceEthernetSwitchedVlanState(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanState:
        """Test InterfaceEthernetSwitchedVlanState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanState`
        """
        model = InterfaceEthernetSwitchedVlanState()
        if include_optional:
            return InterfaceEthernetSwitchedVlanState(
                id = '',
                type = 'InterfaceEthernetSwitchedVlanState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetSwitchedVlanState(self):
        """Test InterfaceEthernetSwitchedVlanState"""
