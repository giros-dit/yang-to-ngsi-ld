...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfig"""
