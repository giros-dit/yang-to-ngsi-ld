...
class TestInterfaceSubinterfacesSubinterfaceStateCountersOutErrors(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersOutErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersOutErrors:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutErrors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersOutErrors`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersOutErrors()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersOutErrors(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersOutErrors(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutErrors"""
