...
class TestInterfaceHoldTimeConfigDown(unittest.TestCase):
    """InterfaceHoldTimeConfigDown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceHoldTimeConfigDown:
        """Test InterfaceHoldTimeConfigDown
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceHoldTimeConfigDown`
        """
        model = InterfaceHoldTimeConfigDown()
        if include_optional:
            return InterfaceHoldTimeConfigDown(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceHoldTimeConfigDown(self):
        """Test InterfaceHoldTimeConfigDown"""
