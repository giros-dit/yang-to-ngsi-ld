...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig"""
