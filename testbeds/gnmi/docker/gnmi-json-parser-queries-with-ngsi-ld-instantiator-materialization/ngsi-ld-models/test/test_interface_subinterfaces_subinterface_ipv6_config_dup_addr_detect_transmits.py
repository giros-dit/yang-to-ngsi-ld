...
class TestInterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits:
        """Test InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6ConfigDupAddrDetectTransmits"""
