...
class InterfaceSubinterfacesSubinterfaceIpv6StateCounters(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6StateCounters.")
    ...
    in_pkts: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersInPkts] = Field(default=None, alias="inPkts")
    in_octets: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets] = Field(default=None, alias="inOctets")
    in_error_pkts: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersInErrorPkts] = Field(default=None, alias="inErrorPkts")
    in_forwarded_pkts: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedPkts] = Field(default=None, alias="inForwardedPkts")
    in_forwarded_octets: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets] = Field(default=None, alias="inForwardedOctets")
    in_discarded_pkts: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersInDiscardedPkts] = Field(default=None, alias="inDiscardedPkts")
    out_pkts: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutPkts] = Field(default=None, alias="outPkts")
    out_octets: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets] = Field(default=None, alias="outOctets")
    out_error_pkts: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutErrorPkts] = Field(default=None, alias="outErrorPkts")
    out_forwarded_pkts: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedPkts] = Field(default=None, alias="outForwardedPkts")
    out_forwarded_octets: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets] = Field(default=None, alias="outForwardedOctets")
    out_discarded_pkts: Optional[InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutDiscardedPkts] = Field(default=None, alias="outDiscardedPkts")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6StateCounters'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6StateCounters')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6StateCounters',
            ...
            "inPkts": InterfaceSubinterfacesSubinterfaceIpv6StateCountersInPkts.from_dict(obj["inPkts"]) if obj.get("inPkts") is not None else None,
            "inOctets": InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets.from_dict(obj["inOctets"]) if obj.get("inOctets") is not None else None,
            "inErrorPkts": InterfaceSubinterfacesSubinterfaceIpv6StateCountersInErrorPkts.from_dict(obj["inErrorPkts"]) if obj.get("inErrorPkts") is not None else None,
            "inForwardedPkts": InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedPkts.from_dict(obj["inForwardedPkts"]) if obj.get("inForwardedPkts") is not None else None,
            "inForwardedOctets": InterfaceSubinterfacesSubinterfaceIpv6StateCountersInForwardedOctets.from_dict(obj["inForwardedOctets"]) if obj.get("inForwardedOctets") is not None else None,
            "inDiscardedPkts": InterfaceSubinterfacesSubinterfaceIpv6StateCountersInDiscardedPkts.from_dict(obj["inDiscardedPkts"]) if obj.get("inDiscardedPkts") is not None else None,
            "outPkts": InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutPkts.from_dict(obj["outPkts"]) if obj.get("outPkts") is not None else None,
            "outOctets": InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets.from_dict(obj["outOctets"]) if obj.get("outOctets") is not None else None,
            "outErrorPkts": InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutErrorPkts.from_dict(obj["outErrorPkts"]) if obj.get("outErrorPkts") is not None else None,
            "outForwardedPkts": InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedPkts.from_dict(obj["outForwardedPkts"]) if obj.get("outForwardedPkts") is not None else None,
            "outForwardedOctets": InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets.from_dict(obj["outForwardedOctets"]) if obj.get("outForwardedOctets") is not None else None,
            "outDiscardedPkts": InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutDiscardedPkts.from_dict(obj["outDiscardedPkts"]) if obj.get("outDiscardedPkts") is not None else None,
