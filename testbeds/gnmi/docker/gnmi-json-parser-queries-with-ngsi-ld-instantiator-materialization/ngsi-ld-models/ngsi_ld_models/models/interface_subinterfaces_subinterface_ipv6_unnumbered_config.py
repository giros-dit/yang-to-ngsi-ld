...
class InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig.")
    ...
    enabled: Optional[InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig',
            ...
            "enabled": InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
