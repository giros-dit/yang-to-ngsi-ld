...
class InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementState.")
    ...
    interval: Optional[InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval] = None
    lifetime: Optional[InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime] = None
    suppress: Optional[InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementState',
            ...
            "interval": InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval.from_dict(obj["interval"]) if obj.get("interval") is not None else None,
            "lifetime": InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateLifetime.from_dict(obj["lifetime"]) if obj.get("lifetime") is not None else None,
            "suppress": InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress.from_dict(obj["suppress"]) if obj.get("suppress") is not None else None,
