...
class InterfaceRoutedVlanIpv6NeighborsNeighborConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6NeighborsNeighborConfig.")
    ...
    ip: Optional[InterfaceRoutedVlanIpv6NeighborsNeighborConfigIp] = None
    link_layer_address: InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress = Field(alias="linkLayerAddress")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6NeighborsNeighborConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6NeighborsNeighborConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6NeighborsNeighborConfig',
            ...
            "ip": InterfaceRoutedVlanIpv6NeighborsNeighborConfigIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
