...
class InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingState.")
    ...
    track_interface: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingStateTrackInterface] = Field(default=None, alias="trackInterface")
    priority_decrement: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingStatePriorityDecrement] = Field(default=None, alias="priorityDecrement")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingState',
            ...
            "trackInterface": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingStateTrackInterface.from_dict(obj["trackInterface"]) if obj.get("trackInterface") is not None else None,
            "priorityDecrement": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupInterfaceTrackingStatePriorityDecrement.from_dict(obj["priorityDecrement"]) if obj.get("priorityDecrement") is not None else None,
