...
class InterfaceSubinterfacesSubinterface(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterface.")
    ...
    index: Optional[InterfaceSubinterfacesSubinterfaceIndex] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterface'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterface')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterface',
            ...
            "index": InterfaceSubinterfacesSubinterfaceIndex.from_dict(obj["index"]) if obj.get("index") is not None else None,
