...
class NetworkNodeTerminationPointSupportingTerminationPoint(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkNodeTerminationPointSupportingTerminationPoint.")
    ...
    network_ref: Optional[NetworkNodeTerminationPointSupportingTerminationPointNetworkRef] = Field(default=None, alias="networkRef")
    node_ref: Optional[NetworkNodeTerminationPointSupportingTerminationPointNodeRef] = Field(default=None, alias="nodeRef")
    tp_ref: Optional[TpRef] = Field(default=None, alias="tpRef")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NetworkNodeTerminationPointSupportingTerminationPoint'):
            raise ValueError("must be one of enum values ('NetworkNodeTerminationPointSupportingTerminationPoint')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkNodeTerminationPointSupportingTerminationPoint',
            ...
            "networkRef": NetworkNodeTerminationPointSupportingTerminationPointNetworkRef.from_dict(obj["networkRef"]) if obj.get("networkRef") is not None else None,
            "nodeRef": NetworkNodeTerminationPointSupportingTerminationPointNodeRef.from_dict(obj["nodeRef"]) if obj.get("nodeRef") is not None else None,
            "tpRef": TpRef.from_dict(obj["tpRef"]) if obj.get("tpRef") is not None else None,
