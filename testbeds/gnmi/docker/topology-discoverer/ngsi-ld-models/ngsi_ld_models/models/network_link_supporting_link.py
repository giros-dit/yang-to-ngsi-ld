...
class NetworkLinkSupportingLink(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkLinkSupportingLink.")
    ...
    network_ref: Optional[NetworkLinkSupportingLinkNetworkRef] = Field(default=None, alias="networkRef")
    link_ref: Optional[LinkRef] = Field(default=None, alias="linkRef")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "networkRef", "linkRef", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NetworkLinkSupportingLink'):
            raise ValueError("must be one of enum values ('NetworkLinkSupportingLink')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of link_ref
        if self.link_ref:
            _dict['linkRef'] = self.link_ref.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkLinkSupportingLink',
            ...
            "networkRef": NetworkLinkSupportingLinkNetworkRef.from_dict(obj["networkRef"]) if obj.get("networkRef") is not None else None,
            "linkRef": LinkRef.from_dict(obj["linkRef"]) if obj.get("linkRef") is not None else None,
