...
class NetworkLinkDestination(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkLinkDestination.")
    ...
    dest_node: Optional[DestNode] = Field(default=None, alias="destNode")
    dest_tp: Optional[DestTp] = Field(default=None, alias="destTp")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "destNode", "destTp", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NetworkLinkDestination'):
            raise ValueError("must be one of enum values ('NetworkLinkDestination')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of dest_node
        if self.dest_node:
            _dict['destNode'] = self.dest_node.to_dict()
        # override the default output from pydantic by calling `to_dict()` of dest_tp
        if self.dest_tp:
            _dict['destTp'] = self.dest_tp.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkLinkDestination',
            ...
            "destNode": DestNode.from_dict(obj["destNode"]) if obj.get("destNode") is not None else None,
            "destTp": DestTp.from_dict(obj["destTp"]) if obj.get("destTp") is not None else None,
