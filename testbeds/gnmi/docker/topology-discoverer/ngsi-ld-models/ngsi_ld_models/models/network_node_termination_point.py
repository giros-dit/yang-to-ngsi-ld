...
class NetworkNodeTerminationPoint(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkNodeTerminationPoint.")
    ...
    tp_id: Optional[TpId] = Field(default=None, alias="tpId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "tpId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NetworkNodeTerminationPoint'):
            raise ValueError("must be one of enum values ('NetworkNodeTerminationPoint')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of tp_id
        if self.tp_id:
            _dict['tpId'] = self.tp_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkNodeTerminationPoint',
            ...
            "tpId": TpId.from_dict(obj["tpId"]) if obj.get("tpId") is not None else None,
