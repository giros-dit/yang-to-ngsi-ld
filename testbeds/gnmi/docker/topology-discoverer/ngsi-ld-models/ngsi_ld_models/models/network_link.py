...
class NetworkLink(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkLink.")
    ...
    link_id: Optional[LinkId] = Field(default=None, alias="linkId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "linkId": LinkId.from_dict(obj["linkId"]) if obj.get("linkId") is not None else None,
