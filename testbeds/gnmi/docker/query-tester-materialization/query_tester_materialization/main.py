...
from query_tester_materialization.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/query-tester-materialization/query_tester_materialization/performance_measurements.csv", "w", newline='')
...
async def startup_event():
    ...
    operation_instance = Operation(
        type="Property",
        value="GET",
        entityType={"type": "Property", "value": "openconfig-interfaces:interfaces"},
    ...
    while True:
        ...
        try:
            ...
            api_instance_provision.delete_entity(entity_id='urn:ngsi-ld:InterfaceState:clab-telemetry-testbed-xrv9k-ceos-4hosts:r1:GigabitEthernet0/0/0/0')
        except Exception as e:
            logger.exception("Exception when calling ContextInformationProvisionApi->delete_entity: %s\n" % e)
        try:
            # Delete NGSI-LD Entity by id: DELETE /entities/{entityId}
            api_instance_provision.delete_entity(entity_id='urn:ngsi-ld:InterfaceState:clab-telemetry-testbed-xrv9k-ceos-4hosts:r1:GigabitEthernet0/0/0/1')
        except Exception as e:
            logger.exception("Exception when calling ContextInformationProvisionApi->delete_entity: %s\n" % e)
        try:
            # Delete NGSI-LD Entity by id: DELETE /entities/{entityId}
            api_instance_provision.delete_entity(entity_id='urn:ngsi-ld:InterfaceState:clab-telemetry-testbed-xrv9k-ceos-4hosts:r1:Null0')
        except Exception as e:
            logger.exception("Exception when calling ContextInformationProvisionApi->delete_entity: %s\n" % e)
        try:
            # Delete NGSI-LD Entity by id: DELETE /entities/{entityId}
            api_instance_provision.delete_entity(entity_id='urn:ngsi-ld:InterfaceState:clab-telemetry-testbed-xrv9k-ceos-4hosts:r1:MgmtEth0/RP0/CPU0/0')
        except Exception as e:
            logger.exception("Exception when calling ContextInformationProvisionApi->delete_entity: %s\n" % e)
        sleep(5)