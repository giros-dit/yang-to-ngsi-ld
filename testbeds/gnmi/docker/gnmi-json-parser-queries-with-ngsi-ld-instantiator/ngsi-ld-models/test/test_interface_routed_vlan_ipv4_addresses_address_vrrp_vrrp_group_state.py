...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState(
                id = '',
                type = 'InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupState"""
