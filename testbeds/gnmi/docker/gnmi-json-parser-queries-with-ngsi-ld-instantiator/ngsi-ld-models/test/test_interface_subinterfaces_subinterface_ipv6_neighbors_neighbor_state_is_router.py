...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIsRouter"""
