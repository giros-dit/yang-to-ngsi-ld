...
class TestInterfaceRoutedVlanIpv6StateCountersInForwardedOctets(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersInForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersInForwardedOctets:
        """Test InterfaceRoutedVlanIpv6StateCountersInForwardedOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersInForwardedOctets`
        """
        model = InterfaceRoutedVlanIpv6StateCountersInForwardedOctets()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersInForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersInForwardedOctets(self):
        """Test InterfaceRoutedVlanIpv6StateCountersInForwardedOctets"""
