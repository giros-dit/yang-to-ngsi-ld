...
class TestNegotiatedDuplexMode(unittest.TestCase):
    """NegotiatedDuplexMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NegotiatedDuplexMode:
        """Test NegotiatedDuplexMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NegotiatedDuplexMode`
        """
        model = NegotiatedDuplexMode()
        if include_optional:
            return NegotiatedDuplexMode(
                type = 'Property',
                value = 'FULL',
    ...
    def testNegotiatedDuplexMode(self):
        """Test NegotiatedDuplexMode"""
