...
class TestInterfaceSubinterfacesSubinterfaceStateCountersInDiscards(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersInDiscards unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersInDiscards:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInDiscards
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersInDiscards`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersInDiscards()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersInDiscards(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersInDiscards(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInDiscards"""
