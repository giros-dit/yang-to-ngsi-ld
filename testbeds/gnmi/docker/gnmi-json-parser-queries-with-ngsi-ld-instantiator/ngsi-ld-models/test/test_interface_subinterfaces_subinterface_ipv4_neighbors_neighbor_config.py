...
class TestInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig:
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfig"""
