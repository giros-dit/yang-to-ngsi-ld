...
class TestInterfaceAggregationState(unittest.TestCase):
    """InterfaceAggregationState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationState:
        """Test InterfaceAggregationState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationState`
        """
        model = InterfaceAggregationState()
        if include_optional:
            return InterfaceAggregationState(
                id = '',
                type = 'InterfaceAggregationState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceAggregationState(self):
        """Test InterfaceAggregationState"""
