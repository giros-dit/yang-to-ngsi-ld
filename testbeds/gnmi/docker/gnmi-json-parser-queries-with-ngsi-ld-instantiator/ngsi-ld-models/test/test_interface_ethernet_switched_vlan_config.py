...
class TestInterfaceEthernetSwitchedVlanConfig(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanConfig:
        """Test InterfaceEthernetSwitchedVlanConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanConfig`
        """
        model = InterfaceEthernetSwitchedVlanConfig()
        if include_optional:
            return InterfaceEthernetSwitchedVlanConfig(
                id = '',
                type = 'InterfaceEthernetSwitchedVlanConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetSwitchedVlanConfig(self):
        """Test InterfaceEthernetSwitchedVlanConfig"""
