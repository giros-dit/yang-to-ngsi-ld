...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode"""
