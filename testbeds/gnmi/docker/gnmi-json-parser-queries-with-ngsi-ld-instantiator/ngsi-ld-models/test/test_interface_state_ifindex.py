...
class TestInterfaceStateIfindex(unittest.TestCase):
    """InterfaceStateIfindex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateIfindex:
        """Test InterfaceStateIfindex
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateIfindex`
        """
        model = InterfaceStateIfindex()
        if include_optional:
            return InterfaceStateIfindex(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateIfindex(self):
        """Test InterfaceStateIfindex"""
