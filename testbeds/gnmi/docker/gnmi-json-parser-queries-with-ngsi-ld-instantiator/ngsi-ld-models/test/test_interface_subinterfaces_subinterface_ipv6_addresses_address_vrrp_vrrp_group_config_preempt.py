...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPreempt"""
