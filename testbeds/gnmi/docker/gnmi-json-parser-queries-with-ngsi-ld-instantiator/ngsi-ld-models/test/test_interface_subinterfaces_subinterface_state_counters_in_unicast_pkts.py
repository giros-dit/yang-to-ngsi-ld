...
class TestInterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInUnicastPkts"""
