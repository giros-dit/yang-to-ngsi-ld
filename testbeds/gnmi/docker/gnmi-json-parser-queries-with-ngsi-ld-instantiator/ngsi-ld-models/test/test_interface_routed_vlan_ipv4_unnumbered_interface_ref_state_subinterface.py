...
class TestInterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface:
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateSubinterface"""
