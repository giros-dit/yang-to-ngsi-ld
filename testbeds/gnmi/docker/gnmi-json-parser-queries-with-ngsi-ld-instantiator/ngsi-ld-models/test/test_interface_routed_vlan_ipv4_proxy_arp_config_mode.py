...
class TestInterfaceRoutedVlanIpv4ProxyArpConfigMode(unittest.TestCase):
    """InterfaceRoutedVlanIpv4ProxyArpConfigMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4ProxyArpConfigMode:
        """Test InterfaceRoutedVlanIpv4ProxyArpConfigMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4ProxyArpConfigMode`
        """
        model = InterfaceRoutedVlanIpv4ProxyArpConfigMode()
        if include_optional:
            return InterfaceRoutedVlanIpv4ProxyArpConfigMode(
                type = 'Property',
                value = 'DISABLE',
    ...
    def testInterfaceRoutedVlanIpv4ProxyArpConfigMode(self):
        """Test InterfaceRoutedVlanIpv4ProxyArpConfigMode"""
