...
class TestInterfaceStateCountersOutErrors(unittest.TestCase):
    """InterfaceStateCountersOutErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersOutErrors:
        """Test InterfaceStateCountersOutErrors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersOutErrors`
        """
        model = InterfaceStateCountersOutErrors()
        if include_optional:
            return InterfaceStateCountersOutErrors(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersOutErrors(self):
        """Test InterfaceStateCountersOutErrors"""
