...
class TestInterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts:
        """Test InterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts`
        """
        model = InterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts(self):
        """Test InterfaceRoutedVlanIpv4StateCountersOutDiscardedPkts"""
