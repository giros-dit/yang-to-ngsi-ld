...
class TestInterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode:
        """Test InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode(
                type = 'Property',
                value = 'DISABLE',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfigMode"""
