...
class TestInterfaceHoldTimeConfigUp(unittest.TestCase):
    """InterfaceHoldTimeConfigUp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceHoldTimeConfigUp:
        """Test InterfaceHoldTimeConfigUp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceHoldTimeConfigUp`
        """
        model = InterfaceHoldTimeConfigUp()
        if include_optional:
            return InterfaceHoldTimeConfigUp(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceHoldTimeConfigUp(self):
        """Test InterfaceHoldTimeConfigUp"""
