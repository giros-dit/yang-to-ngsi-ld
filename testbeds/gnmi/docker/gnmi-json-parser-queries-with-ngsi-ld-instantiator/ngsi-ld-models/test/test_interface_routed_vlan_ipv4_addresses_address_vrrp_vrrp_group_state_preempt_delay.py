...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay"""
