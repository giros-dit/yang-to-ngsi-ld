...
class TestInterfaceSubinterfacesSubinterfaceIpv4StateCounters(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4StateCounters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4StateCounters:
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCounters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4StateCounters`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4StateCounters()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4StateCounters(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4StateCounters',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4StateCounters(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCounters"""
