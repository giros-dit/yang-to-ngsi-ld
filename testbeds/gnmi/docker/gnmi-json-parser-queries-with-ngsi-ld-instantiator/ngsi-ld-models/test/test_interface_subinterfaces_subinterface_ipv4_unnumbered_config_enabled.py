...
class TestInterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled:
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedConfigEnabled"""
