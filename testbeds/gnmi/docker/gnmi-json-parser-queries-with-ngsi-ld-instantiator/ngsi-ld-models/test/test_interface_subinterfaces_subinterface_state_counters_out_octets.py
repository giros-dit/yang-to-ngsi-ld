...
class TestInterfaceSubinterfacesSubinterfaceStateCountersOutOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersOutOctets:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersOutOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersOutOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersOutOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutOctets"""
