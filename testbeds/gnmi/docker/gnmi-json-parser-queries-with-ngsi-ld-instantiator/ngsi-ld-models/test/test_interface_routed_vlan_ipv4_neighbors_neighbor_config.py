...
class TestInterfaceRoutedVlanIpv4NeighborsNeighborConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv4NeighborsNeighborConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4NeighborsNeighborConfig:
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4NeighborsNeighborConfig`
        """
        model = InterfaceRoutedVlanIpv4NeighborsNeighborConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv4NeighborsNeighborConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv4NeighborsNeighborConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4NeighborsNeighborConfig(self):
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborConfig"""
