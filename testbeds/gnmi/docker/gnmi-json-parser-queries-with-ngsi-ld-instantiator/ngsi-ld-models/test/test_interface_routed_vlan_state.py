...
class TestInterfaceRoutedVlanState(unittest.TestCase):
    """InterfaceRoutedVlanState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanState:
        """Test InterfaceRoutedVlanState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanState`
        """
        model = InterfaceRoutedVlanState()
        if include_optional:
            return InterfaceRoutedVlanState(
                id = '',
                type = 'InterfaceRoutedVlanState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanState(self):
        """Test InterfaceRoutedVlanState"""
