...
class TestInterfaceRoutedVlanIpv6StateCountersInPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersInPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersInPkts:
        """Test InterfaceRoutedVlanIpv6StateCountersInPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersInPkts`
        """
        model = InterfaceRoutedVlanIpv6StateCountersInPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersInPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersInPkts(self):
        """Test InterfaceRoutedVlanIpv6StateCountersInPkts"""
