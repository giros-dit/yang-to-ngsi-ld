...
class TestInterfaceEthernetConfig(unittest.TestCase):
    """InterfaceEthernetConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetConfig:
        """Test InterfaceEthernetConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetConfig`
        """
        model = InterfaceEthernetConfig()
        if include_optional:
    ...
    def testInterfaceEthernetConfig(self):
        """Test InterfaceEthernetConfig"""
