...
class TestInterfaceRoutedVlanIpv6StateCountersInErrorPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersInErrorPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersInErrorPkts:
        """Test InterfaceRoutedVlanIpv6StateCountersInErrorPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersInErrorPkts`
        """
        model = InterfaceRoutedVlanIpv6StateCountersInErrorPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersInErrorPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersInErrorPkts(self):
        """Test InterfaceRoutedVlanIpv6StateCountersInErrorPkts"""
