...
class TestInterfaceEthernetConfigEnableFlowControl(unittest.TestCase):
    """InterfaceEthernetConfigEnableFlowControl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetConfigEnableFlowControl:
        """Test InterfaceEthernetConfigEnableFlowControl
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetConfigEnableFlowControl`
        """
        model = InterfaceEthernetConfigEnableFlowControl()
        if include_optional:
            return InterfaceEthernetConfigEnableFlowControl(
                type = 'Property',
                value = True,
    ...
    def testInterfaceEthernetConfigEnableFlowControl(self):
        """Test InterfaceEthernetConfigEnableFlowControl"""
