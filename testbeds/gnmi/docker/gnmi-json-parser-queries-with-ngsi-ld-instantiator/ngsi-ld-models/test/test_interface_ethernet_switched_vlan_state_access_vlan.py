...
class TestInterfaceEthernetSwitchedVlanStateAccessVlan(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanStateAccessVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanStateAccessVlan:
        """Test InterfaceEthernetSwitchedVlanStateAccessVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanStateAccessVlan`
        """
        model = InterfaceEthernetSwitchedVlanStateAccessVlan()
        if include_optional:
            return InterfaceEthernetSwitchedVlanStateAccessVlan(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetSwitchedVlanStateAccessVlan(self):
        """Test InterfaceEthernetSwitchedVlanStateAccessVlan"""
