...
class TestInterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig:
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig`
        """
        model = InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig(self):
        """Test InterfaceRoutedVlanIpv6UnnumberedInterfaceRefConfig"""
