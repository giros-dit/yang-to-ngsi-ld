...
class TestInterfaceEthernetConfigDuplexMode(unittest.TestCase):
    """InterfaceEthernetConfigDuplexMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetConfigDuplexMode:
        """Test InterfaceEthernetConfigDuplexMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetConfigDuplexMode`
        """
        model = InterfaceEthernetConfigDuplexMode()
        if include_optional:
            return InterfaceEthernetConfigDuplexMode(
                type = 'Property',
                value = 'FULL',
    ...
    def testInterfaceEthernetConfigDuplexMode(self):
        """Test InterfaceEthernetConfigDuplexMode"""
