...
class TestInterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets:
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutForwardedOctets"""
