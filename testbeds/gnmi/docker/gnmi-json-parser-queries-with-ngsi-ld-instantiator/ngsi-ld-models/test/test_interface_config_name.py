...
class TestInterfaceConfigName(unittest.TestCase):
    """InterfaceConfigName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigName:
        """Test InterfaceConfigName
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigName`
        """
        model = InterfaceConfigName()
        if include_optional:
            return InterfaceConfigName(
                type = 'Property',
                value = '',
    ...
    def testInterfaceConfigName(self):
        """Test InterfaceConfigName"""
