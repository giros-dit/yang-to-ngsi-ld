...
class TestInterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutUnicastPkts"""
