...
class TestInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval:
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateInterval"""
