...
class TestInterfaceSubinterfacesSubinterfaceConfigDescription(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceConfigDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceConfigDescription:
        """Test InterfaceSubinterfacesSubinterfaceConfigDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceConfigDescription`
        """
        model = InterfaceSubinterfacesSubinterfaceConfigDescription()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceConfigDescription(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceConfigDescription(self):
        """Test InterfaceSubinterfacesSubinterfaceConfigDescription"""
