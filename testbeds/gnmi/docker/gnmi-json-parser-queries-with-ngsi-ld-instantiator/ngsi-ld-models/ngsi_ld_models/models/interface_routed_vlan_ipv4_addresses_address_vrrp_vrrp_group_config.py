...
class InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfig.")
    ...
    virtual_router_id: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId] = Field(default=None, alias="virtualRouterId")
    virtual_address: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress] = Field(default=None, alias="virtualAddress")
    priority: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority] = None
    preempt: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt] = None
    preempt_delay: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay] = Field(default=None, alias="preemptDelay")
    accept_mode: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigAcceptMode] = Field(default=None, alias="acceptMode")
    advertisement_interval: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigAdvertisementInterval] = Field(default=None, alias="advertisementInterval")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfig',
            ...
            "virtualRouterId": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
            "virtualAddress": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress.from_dict(obj["virtualAddress"]) if obj.get("virtualAddress") is not None else None,
            "priority": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "preempt": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt.from_dict(obj["preempt"]) if obj.get("preempt") is not None else None,
            "preemptDelay": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreemptDelay.from_dict(obj["preemptDelay"]) if obj.get("preemptDelay") is not None else None,
            "acceptMode": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigAcceptMode.from_dict(obj["acceptMode"]) if obj.get("acceptMode") is not None else None,
            "advertisementInterval": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigAdvertisementInterval.from_dict(obj["advertisementInterval"]) if obj.get("advertisementInterval") is not None else None,
