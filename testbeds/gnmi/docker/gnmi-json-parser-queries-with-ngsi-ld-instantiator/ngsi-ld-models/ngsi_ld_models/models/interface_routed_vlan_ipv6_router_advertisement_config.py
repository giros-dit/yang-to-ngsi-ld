...
class InterfaceRoutedVlanIpv6RouterAdvertisementConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6RouterAdvertisementConfig.")
    ...
    interval: Optional[InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval] = None
    lifetime: Optional[InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime] = None
    suppress: Optional[InterfaceRoutedVlanIpv6RouterAdvertisementConfigSuppress] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6RouterAdvertisementConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6RouterAdvertisementConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6RouterAdvertisementConfig',
            ...
            "interval": InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval.from_dict(obj["interval"]) if obj.get("interval") is not None else None,
            "lifetime": InterfaceRoutedVlanIpv6RouterAdvertisementConfigLifetime.from_dict(obj["lifetime"]) if obj.get("lifetime") is not None else None,
            "suppress": InterfaceRoutedVlanIpv6RouterAdvertisementConfigSuppress.from_dict(obj["suppress"]) if obj.get("suppress") is not None else None,
