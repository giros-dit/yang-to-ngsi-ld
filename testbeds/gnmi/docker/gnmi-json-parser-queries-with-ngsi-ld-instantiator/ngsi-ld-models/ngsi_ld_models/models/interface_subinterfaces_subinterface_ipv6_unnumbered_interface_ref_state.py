...
class InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefState.")
    ...
    interface: Optional[InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface] = None
    subinterface: Optional[InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefState',
            ...
            "interface": InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "subinterface": InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
