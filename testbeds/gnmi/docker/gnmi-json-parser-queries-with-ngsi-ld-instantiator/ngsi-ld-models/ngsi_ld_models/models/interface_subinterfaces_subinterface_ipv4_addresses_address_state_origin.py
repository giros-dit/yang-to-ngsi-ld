...
class InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('OTHER', 'STATIC', 'DHCP', 'LINK_LAYER', 'RANDOM'):
            raise ValueError("must be one of enum values ('OTHER', 'STATIC', 'DHCP', 'LINK_LAYER', 'RANDOM')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin) in the input: " + _key)
