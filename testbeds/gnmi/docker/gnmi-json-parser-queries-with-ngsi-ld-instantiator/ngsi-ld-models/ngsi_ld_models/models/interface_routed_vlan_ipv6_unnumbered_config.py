...
class InterfaceRoutedVlanIpv6UnnumberedConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6UnnumberedConfig.")
    ...
    enabled: Optional[InterfaceRoutedVlanIpv6UnnumberedConfigEnabled] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6UnnumberedConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6UnnumberedConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6UnnumberedConfig',
            ...
            "enabled": InterfaceRoutedVlanIpv6UnnumberedConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
