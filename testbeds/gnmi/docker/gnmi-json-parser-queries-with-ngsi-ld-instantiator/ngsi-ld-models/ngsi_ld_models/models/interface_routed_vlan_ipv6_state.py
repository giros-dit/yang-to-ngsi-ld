...
class InterfaceRoutedVlanIpv6State(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6State.")
    ...
    enabled: Optional[InterfaceRoutedVlanIpv6StateEnabled] = None
    mtu: Optional[InterfaceRoutedVlanIpv6StateMtu] = None
    dup_addr_detect_transmits: Optional[InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits] = Field(default=None, alias="dupAddrDetectTransmits")
    dhcp_client: Optional[InterfaceRoutedVlanIpv6StateDhcpClient] = Field(default=None, alias="dhcpClient")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6State'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6State')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6State',
            ...
            "enabled": InterfaceRoutedVlanIpv6StateEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "mtu": InterfaceRoutedVlanIpv6StateMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dupAddrDetectTransmits": InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits.from_dict(obj["dupAddrDetectTransmits"]) if obj.get("dupAddrDetectTransmits") is not None else None,
            "dhcpClient": InterfaceRoutedVlanIpv6StateDhcpClient.from_dict(obj["dhcpClient"]) if obj.get("dhcpClient") is not None else None,
