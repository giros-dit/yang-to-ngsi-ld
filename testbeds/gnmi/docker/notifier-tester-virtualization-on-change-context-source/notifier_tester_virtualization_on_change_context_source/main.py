...
# Notifier
NOTIFIER_URI = os.getenv("NOTIFIER_URI", "http://notifier-tester-virtualization-on-change:8082/notify")
...
async def startup_event():
    ...
    sleep(5)
    csources = api_instance_csource.query_csr(type="openconfig-interfaces:interfaces/interface/state/counters")
    print(csources)
    if csources != []:
                ...
                entities=[
                    {
                        ...
                        "id": "urn:ngsi-ld:InterfaceStateCounters:clab-telemetry-testbed-xrv9k-ceos-4hosts:r1:GigabitEthernet0/0/0/0"
                    }
                ],
