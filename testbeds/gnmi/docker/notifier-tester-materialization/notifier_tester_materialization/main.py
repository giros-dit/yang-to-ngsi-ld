...
from notifier_tester_materialization.check_client import NGSILDHealthInfoClient
...
# Notifier
NOTIFIER_URI = os.getenv("NOTIFIER_URI", "http://notifier-tester-materialization:8082/notify")
...
performance_measurements_file = open("/opt/notifier-tester-materialization/notifier_tester_materialization/performance_measurements.csv", "w", newline='')
...
notification_performance_measurements_file = open("/opt/notifier-tester-materialization/notifier_tester_materialization/notification_performance_measurements.csv", "w", newline='')
...
async def startup_event():
    ...
    operation_instance = Operation(
        type="Property",
        value="SUBSCRIBE",
        entityType={"type": "Property", "value": "openconfig-interfaces:interfaces/interface/state/counters"},
        entityId={"type": "Property", "value": "urn:ngsi-ld:InterfaceStateCounters:clab-telemetry-testbed-xrv9k-ceos-4hosts-r1:GigabitEthernet0/0/0/0"},
...
async def receiveNotification(request: Request):
    ...
    for entity in notification["data"]:
        if entity["type"] == "InterfaceStateCounters":
