...
INPUT_CSV = "performance_measurements_operation-gnmi-virtualization-3-cb.csv"
OUTPUT_CSV = "performance_measurements_operation-gnmi-virtualization-3-cb-output.csv"
