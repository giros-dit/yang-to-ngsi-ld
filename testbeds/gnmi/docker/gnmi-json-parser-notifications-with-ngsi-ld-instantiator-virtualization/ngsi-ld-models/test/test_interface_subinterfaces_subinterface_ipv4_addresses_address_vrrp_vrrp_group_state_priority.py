...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority"""
