...
class TestInterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets:
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCountersOutOctets"""
