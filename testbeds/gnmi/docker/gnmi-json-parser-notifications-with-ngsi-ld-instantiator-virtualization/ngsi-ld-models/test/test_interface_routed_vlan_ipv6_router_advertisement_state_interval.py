...
class TestInterfaceRoutedVlanIpv6RouterAdvertisementStateInterval(unittest.TestCase):
    """InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval:
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval`
        """
        model = InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval()
        if include_optional:
            return InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6RouterAdvertisementStateInterval(self):
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementStateInterval"""
