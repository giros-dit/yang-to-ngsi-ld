...
class TestInterfaceConfigType(unittest.TestCase):
    """InterfaceConfigType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigType:
        """Test InterfaceConfigType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigType`
        """
        model = InterfaceConfigType()
        if include_optional:
            return InterfaceConfigType(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceConfigType(self):
        """Test InterfaceConfigType"""
