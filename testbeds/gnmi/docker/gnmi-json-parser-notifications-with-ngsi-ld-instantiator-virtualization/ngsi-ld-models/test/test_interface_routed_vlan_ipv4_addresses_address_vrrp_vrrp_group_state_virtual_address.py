...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress(
                type = 'Property',
                value = '',
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress"""
