...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt"""
