...
class TestInterfaceRoutedVlanIpv6StateCountersOutForwardedPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersOutForwardedPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersOutForwardedPkts:
        """Test InterfaceRoutedVlanIpv6StateCountersOutForwardedPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersOutForwardedPkts`
        """
        model = InterfaceRoutedVlanIpv6StateCountersOutForwardedPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersOutForwardedPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersOutForwardedPkts(self):
        """Test InterfaceRoutedVlanIpv6StateCountersOutForwardedPkts"""
