...
class TestInterfaceRoutedVlanIpv6AddressesAddressStateStatus(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressStateStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressStateStatus:
        """Test InterfaceRoutedVlanIpv6AddressesAddressStateStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressStateStatus`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressStateStatus()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressStateStatus(
                type = 'Property',
                value = 'PREFERRED',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressStateStatus(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressStateStatus"""
