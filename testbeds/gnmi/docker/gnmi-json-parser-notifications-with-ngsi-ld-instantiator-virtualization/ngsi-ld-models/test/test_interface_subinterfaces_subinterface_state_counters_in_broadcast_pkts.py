...
class TestInterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInBroadcastPkts"""
