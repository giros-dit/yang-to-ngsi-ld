...
class TestInterfaceRoutedVlanIpv6UnnumberedState(unittest.TestCase):
    """InterfaceRoutedVlanIpv6UnnumberedState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6UnnumberedState:
        """Test InterfaceRoutedVlanIpv6UnnumberedState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6UnnumberedState`
        """
        model = InterfaceRoutedVlanIpv6UnnumberedState()
        if include_optional:
            return InterfaceRoutedVlanIpv6UnnumberedState(
                id = '',
                type = 'InterfaceRoutedVlanIpv6UnnumberedState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6UnnumberedState(self):
        """Test InterfaceRoutedVlanIpv6UnnumberedState"""
