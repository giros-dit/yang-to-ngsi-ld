...
class TestInterfaceSubinterfacesSubinterfaceStateIndex(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateIndex:
        """Test InterfaceSubinterfacesSubinterfaceStateIndex
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateIndex`
        """
        model = InterfaceSubinterfacesSubinterfaceStateIndex()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateIndex(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateIndex(self):
        """Test InterfaceSubinterfacesSubinterfaceStateIndex"""
