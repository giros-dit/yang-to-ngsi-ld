...
class TestInterfaceRoutedVlanIpv4StateCountersInOctets(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersInOctets:
        """Test InterfaceRoutedVlanIpv4StateCountersInOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersInOctets`
        """
        model = InterfaceRoutedVlanIpv4StateCountersInOctets()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersInOctets(self):
        """Test InterfaceRoutedVlanIpv4StateCountersInOctets"""
