...
class TestInterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength:
        """Test InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressConfigPrefixLength"""
