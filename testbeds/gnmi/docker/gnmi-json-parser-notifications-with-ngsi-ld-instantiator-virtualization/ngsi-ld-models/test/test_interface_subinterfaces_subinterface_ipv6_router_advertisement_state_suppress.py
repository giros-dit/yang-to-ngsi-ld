...
class TestInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress:
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementStateSuppress"""
