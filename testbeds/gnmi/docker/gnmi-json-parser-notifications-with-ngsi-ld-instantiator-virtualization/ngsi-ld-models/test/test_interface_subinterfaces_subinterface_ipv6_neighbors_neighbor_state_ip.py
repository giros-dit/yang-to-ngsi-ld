...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp(
                type = 'Property',
                value = 'C:02:84::3',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateIp"""
