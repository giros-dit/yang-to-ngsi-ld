...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress(
                type = 'Property',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress"""
