...
class TestInterfaceHoldTimeState(unittest.TestCase):
    """InterfaceHoldTimeState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceHoldTimeState:
        """Test InterfaceHoldTimeState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceHoldTimeState`
        """
        model = InterfaceHoldTimeState()
        if include_optional:
            return InterfaceHoldTimeState(
                id = '',
                type = 'InterfaceHoldTimeState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceHoldTimeState(self):
        """Test InterfaceHoldTimeState"""
