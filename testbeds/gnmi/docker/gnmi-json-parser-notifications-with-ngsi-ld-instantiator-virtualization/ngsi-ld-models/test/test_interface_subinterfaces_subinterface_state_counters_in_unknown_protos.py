...
class TestInterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersInUnknownProtos"""
