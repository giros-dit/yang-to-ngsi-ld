...
class TestInterfaceStateLastChange(unittest.TestCase):
    """InterfaceStateLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateLastChange:
        """Test InterfaceStateLastChange
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateLastChange`
        """
        model = InterfaceStateLastChange()
        if include_optional:
            return InterfaceStateLastChange(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateLastChange(self):
        """Test InterfaceStateLastChange"""
