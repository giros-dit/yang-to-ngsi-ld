...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigPreempt"""
