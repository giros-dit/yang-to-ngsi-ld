...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborState"""
