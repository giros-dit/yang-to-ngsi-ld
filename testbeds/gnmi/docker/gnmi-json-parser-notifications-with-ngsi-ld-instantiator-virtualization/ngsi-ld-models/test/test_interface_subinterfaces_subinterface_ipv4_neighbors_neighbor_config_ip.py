...
class TestInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborConfigIp"""
