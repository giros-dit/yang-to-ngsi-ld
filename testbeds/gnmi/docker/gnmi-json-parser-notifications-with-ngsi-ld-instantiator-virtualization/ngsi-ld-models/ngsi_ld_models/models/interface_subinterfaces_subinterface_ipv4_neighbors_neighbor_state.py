...
class InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateIp] = None
    link_layer_address: InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress = Field(alias="linkLayerAddress")
    origin: Optional[InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborState',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
            "origin": InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
