...
class InterfaceEthernetSwitchedVlanConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetSwitchedVlanConfig.")
    ...
    interface_mode: Optional[InterfaceEthernetSwitchedVlanConfigInterfaceMode] = Field(default=None, alias="interfaceMode")
    native_vlan: Optional[InterfaceEthernetSwitchedVlanConfigNativeVlan] = Field(default=None, alias="nativeVlan")
    access_vlan: Optional[InterfaceEthernetSwitchedVlanConfigAccessVlan] = Field(default=None, alias="accessVlan")
    trunk_vlans: Optional[InterfaceEthernetSwitchedVlanConfigTrunkVlans] = Field(default=None, alias="trunkVlans")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceEthernetSwitchedVlanConfig'):
            raise ValueError("must be one of enum values ('InterfaceEthernetSwitchedVlanConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetSwitchedVlanConfig',
            ...
            "interfaceMode": InterfaceEthernetSwitchedVlanConfigInterfaceMode.from_dict(obj["interfaceMode"]) if obj.get("interfaceMode") is not None else None,
            "nativeVlan": InterfaceEthernetSwitchedVlanConfigNativeVlan.from_dict(obj["nativeVlan"]) if obj.get("nativeVlan") is not None else None,
            "accessVlan": InterfaceEthernetSwitchedVlanConfigAccessVlan.from_dict(obj["accessVlan"]) if obj.get("accessVlan") is not None else None,
            "trunkVlans": InterfaceEthernetSwitchedVlanConfigTrunkVlans.from_dict(obj["trunkVlans"]) if obj.get("trunkVlans") is not None else None,
