...
class InterfaceSubinterfacesSubinterfaceVlanConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceVlanConfig.")
    ...
    vlan_id: Optional[InterfaceSubinterfacesSubinterfaceVlanConfigVlanId] = Field(default=None, alias="vlanId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "vlanId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceVlanConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceVlanConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceVlanConfig',
            ...
            "vlanId": InterfaceSubinterfacesSubinterfaceVlanConfigVlanId.from_dict(obj["vlanId"]) if obj.get("vlanId") is not None else None,
