...
class InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type InterfaceSubinterfacesSubinterface.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface) in the input: " + _key)
