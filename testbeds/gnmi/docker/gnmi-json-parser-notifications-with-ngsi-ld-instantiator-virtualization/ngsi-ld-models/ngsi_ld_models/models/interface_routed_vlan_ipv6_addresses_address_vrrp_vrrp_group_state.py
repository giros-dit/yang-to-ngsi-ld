...
class InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState.")
    ...
    virtual_router_id: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId] = Field(default=None, alias="virtualRouterId")
    virtual_address: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress] = Field(default=None, alias="virtualAddress")
    priority: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority] = None
    preempt: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt] = None
    preempt_delay: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreemptDelay] = Field(default=None, alias="preemptDelay")
    accept_mode: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode] = Field(default=None, alias="acceptMode")
    advertisement_interval: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval] = Field(default=None, alias="advertisementInterval")
    current_priority: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority] = Field(default=None, alias="currentPriority")
    virtual_link_local: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualLinkLocal] = Field(default=None, alias="virtualLinkLocal")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState',
            ...
            "virtualRouterId": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
            "virtualAddress": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualAddress.from_dict(obj["virtualAddress"]) if obj.get("virtualAddress") is not None else None,
            "priority": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "preempt": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt.from_dict(obj["preempt"]) if obj.get("preempt") is not None else None,
            "preemptDelay": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreemptDelay.from_dict(obj["preemptDelay"]) if obj.get("preemptDelay") is not None else None,
            "acceptMode": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAcceptMode.from_dict(obj["acceptMode"]) if obj.get("acceptMode") is not None else None,
            "advertisementInterval": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateAdvertisementInterval.from_dict(obj["advertisementInterval"]) if obj.get("advertisementInterval") is not None else None,
            "currentPriority": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority.from_dict(obj["currentPriority"]) if obj.get("currentPriority") is not None else None,
            "virtualLinkLocal": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateVirtualLinkLocal.from_dict(obj["virtualLinkLocal"]) if obj.get("virtualLinkLocal") is not None else None,
