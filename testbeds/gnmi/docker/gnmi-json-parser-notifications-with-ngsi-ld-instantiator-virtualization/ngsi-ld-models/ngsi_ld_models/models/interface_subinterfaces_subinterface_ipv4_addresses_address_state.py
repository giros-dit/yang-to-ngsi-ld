...
class InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressState.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateIp] = None
    prefix_length: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength] = Field(default=None, alias="prefixLength")
    origin: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ip", "prefixLength", "origin", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressState',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStatePrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
            "origin": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
