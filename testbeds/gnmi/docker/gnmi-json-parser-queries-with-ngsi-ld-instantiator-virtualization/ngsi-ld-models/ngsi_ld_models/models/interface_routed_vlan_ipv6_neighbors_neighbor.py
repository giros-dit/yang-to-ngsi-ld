...
class InterfaceRoutedVlanIpv6NeighborsNeighbor(BaseModel):
    """
    List of IPv6 neighbors  YANG module: openconfig-if-ip.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6NeighborsNeighbor.")
    ...
    ip: Optional[InterfaceRoutedVlanIpv6NeighborsNeighborIp] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6NeighborsNeighbor'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6NeighborsNeighbor')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6NeighborsNeighbor',
            ...
            "ip": InterfaceRoutedVlanIpv6NeighborsNeighborIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
