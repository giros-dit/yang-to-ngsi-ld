...
class InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingState.")
    ...
    track_interface: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingStateTrackInterface] = Field(default=None, alias="trackInterface")
    priority_decrement: Optional[InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingStatePriorityDecrement] = Field(default=None, alias="priorityDecrement")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingState',
            ...
            "trackInterface": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingStateTrackInterface.from_dict(obj["trackInterface"]) if obj.get("trackInterface") is not None else None,
            "priorityDecrement": InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupInterfaceTrackingStatePriorityDecrement.from_dict(obj["priorityDecrement"]) if obj.get("priorityDecrement") is not None else None,
