...
class InterfaceRoutedVlanIpv6AddressesAddress(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6AddressesAddress.")
    ...
    ip: Optional[InterfaceRoutedVlanIpv6AddressesAddressIp] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6AddressesAddress'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6AddressesAddress')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6AddressesAddress',
            ...
            "ip": InterfaceRoutedVlanIpv6AddressesAddressIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
