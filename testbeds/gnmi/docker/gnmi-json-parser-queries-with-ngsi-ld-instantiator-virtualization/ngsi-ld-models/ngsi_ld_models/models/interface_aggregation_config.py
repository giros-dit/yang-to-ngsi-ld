...
class InterfaceAggregationConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceAggregationConfig.")
    ...
    lag_type: Optional[InterfaceAggregationConfigLagType] = Field(default=None, alias="lagType")
    min_links: Optional[InterfaceAggregationConfigMinLinks] = Field(default=None, alias="minLinks")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "lagType", "minLinks", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceAggregationConfig'):
            raise ValueError("must be one of enum values ('InterfaceAggregationConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceAggregationConfig',
            ...
            "lagType": InterfaceAggregationConfigLagType.from_dict(obj["lagType"]) if obj.get("lagType") is not None else None,
            "minLinks": InterfaceAggregationConfigMinLinks.from_dict(obj["minLinks"]) if obj.get("minLinks") is not None else None,
