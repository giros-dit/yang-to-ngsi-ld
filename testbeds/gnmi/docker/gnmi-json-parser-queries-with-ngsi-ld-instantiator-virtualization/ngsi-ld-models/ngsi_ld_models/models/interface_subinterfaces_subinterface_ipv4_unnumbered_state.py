...
class InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState.")
    ...
    enabled: Optional[InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4UnnumberedState',
            ...
            "enabled": InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
