...
class InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp] = None
    link_layer_address: InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress = Field(alias="linkLayerAddress")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfig',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborConfigLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
