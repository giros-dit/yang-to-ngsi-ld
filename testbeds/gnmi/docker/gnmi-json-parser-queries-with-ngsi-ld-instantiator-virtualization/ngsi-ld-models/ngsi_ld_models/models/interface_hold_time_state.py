...
class InterfaceHoldTimeState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceHoldTimeState.")
    ...
    up: Optional[InterfaceHoldTimeStateUp] = None
    down: Optional[InterfaceHoldTimeStateDown] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceHoldTimeState'):
            raise ValueError("must be one of enum values ('InterfaceHoldTimeState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceHoldTimeState',
            ...
            "up": InterfaceHoldTimeStateUp.from_dict(obj["up"]) if obj.get("up") is not None else None,
            "down": InterfaceHoldTimeStateDown.from_dict(obj["down"]) if obj.get("down") is not None else None,
