...
class TestInterfaceRoutedVlanIpv6StateCountersOutPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersOutPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersOutPkts:
        """Test InterfaceRoutedVlanIpv6StateCountersOutPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersOutPkts`
        """
        model = InterfaceRoutedVlanIpv6StateCountersOutPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersOutPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersOutPkts(self):
        """Test InterfaceRoutedVlanIpv6StateCountersOutPkts"""
