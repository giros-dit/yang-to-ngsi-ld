...
class TestVlanMembersMemberStateInterface(unittest.TestCase):
    """VlanMembersMemberStateInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanMembersMemberStateInterface:
        """Test VlanMembersMemberStateInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanMembersMemberStateInterface`
        """
        model = VlanMembersMemberStateInterface()
        if include_optional:
            return VlanMembersMemberStateInterface(
                type = 'Relationship',
                object = '',
    ...
    def testVlanMembersMemberStateInterface(self):
        """Test VlanMembersMemberStateInterface"""
