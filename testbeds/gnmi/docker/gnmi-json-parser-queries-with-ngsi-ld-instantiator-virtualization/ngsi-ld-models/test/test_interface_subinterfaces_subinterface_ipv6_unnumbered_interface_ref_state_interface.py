...
class TestInterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface:
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedInterfaceRefStateInterface"""
