...
class TestInterfaceRoutedVlanIpv4StateCountersOutForwardedOctets(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersOutForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersOutForwardedOctets:
        """Test InterfaceRoutedVlanIpv4StateCountersOutForwardedOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersOutForwardedOctets`
        """
        model = InterfaceRoutedVlanIpv4StateCountersOutForwardedOctets()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersOutForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersOutForwardedOctets(self):
        """Test InterfaceRoutedVlanIpv4StateCountersOutForwardedOctets"""
