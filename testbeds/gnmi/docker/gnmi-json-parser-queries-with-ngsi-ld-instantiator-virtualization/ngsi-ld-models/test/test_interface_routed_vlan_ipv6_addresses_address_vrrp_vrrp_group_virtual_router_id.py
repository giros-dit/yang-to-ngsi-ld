...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupVirtualRouterId"""
