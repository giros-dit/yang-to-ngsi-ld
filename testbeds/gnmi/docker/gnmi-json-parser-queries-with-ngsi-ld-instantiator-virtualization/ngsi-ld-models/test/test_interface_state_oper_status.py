...
class TestInterfaceStateOperStatus(unittest.TestCase):
    """InterfaceStateOperStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateOperStatus:
        """Test InterfaceStateOperStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateOperStatus`
        """
        model = InterfaceStateOperStatus()
        if include_optional:
            return InterfaceStateOperStatus(
                type = 'Property',
                value = 'UP',
    ...
    def testInterfaceStateOperStatus(self):
        """Test InterfaceStateOperStatus"""
