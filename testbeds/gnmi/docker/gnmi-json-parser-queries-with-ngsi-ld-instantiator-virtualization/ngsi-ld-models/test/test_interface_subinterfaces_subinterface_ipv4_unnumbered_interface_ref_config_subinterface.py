...
class TestInterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface:
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigSubinterface"""
