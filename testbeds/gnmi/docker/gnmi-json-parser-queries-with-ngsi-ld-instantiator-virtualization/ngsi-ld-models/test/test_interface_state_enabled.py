...
class TestInterfaceStateEnabled(unittest.TestCase):
    """InterfaceStateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateEnabled:
        """Test InterfaceStateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateEnabled`
        """
        model = InterfaceStateEnabled()
        if include_optional:
    ...
    def testInterfaceStateEnabled(self):
        """Test InterfaceStateEnabled"""
