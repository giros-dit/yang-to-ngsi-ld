...
class TestInterfaceSubinterfacesSubinterfaceStateAdminStatus(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateAdminStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateAdminStatus:
        """Test InterfaceSubinterfacesSubinterfaceStateAdminStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateAdminStatus`
        """
        model = InterfaceSubinterfacesSubinterfaceStateAdminStatus()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateAdminStatus(
                type = 'Property',
                value = 'UP',
    ...
    def testInterfaceSubinterfacesSubinterfaceStateAdminStatus(self):
        """Test InterfaceSubinterfacesSubinterfaceStateAdminStatus"""
