...
class TestInterfaceSubinterfacesSubinterfaceStateCountersLastClear(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersLastClear:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersLastClear
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersLastClear`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersLastClear()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersLastClear(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersLastClear(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersLastClear"""
