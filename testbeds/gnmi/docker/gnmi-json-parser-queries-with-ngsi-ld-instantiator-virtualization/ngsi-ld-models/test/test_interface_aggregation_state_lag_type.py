...
class TestInterfaceAggregationStateLagType(unittest.TestCase):
    """InterfaceAggregationStateLagType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationStateLagType:
        """Test InterfaceAggregationStateLagType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationStateLagType`
        """
        model = InterfaceAggregationStateLagType()
        if include_optional:
            return InterfaceAggregationStateLagType(
                type = 'Property',
                value = 'LACP',
    ...
    def testInterfaceAggregationStateLagType(self):
        """Test InterfaceAggregationStateLagType"""
