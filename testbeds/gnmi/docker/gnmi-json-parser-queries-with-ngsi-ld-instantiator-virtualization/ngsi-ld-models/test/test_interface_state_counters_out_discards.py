...
class TestInterfaceStateCountersOutDiscards(unittest.TestCase):
    """InterfaceStateCountersOutDiscards unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersOutDiscards:
        """Test InterfaceStateCountersOutDiscards
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersOutDiscards`
        """
        model = InterfaceStateCountersOutDiscards()
        if include_optional:
            return InterfaceStateCountersOutDiscards(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersOutDiscards(self):
        """Test InterfaceStateCountersOutDiscards"""
