...
class TestInterfaceRoutedVlanIpv6NeighborsNeighborStateIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv6NeighborsNeighborStateIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6NeighborsNeighborStateIp:
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborStateIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6NeighborsNeighborStateIp`
        """
        model = InterfaceRoutedVlanIpv6NeighborsNeighborStateIp()
        if include_optional:
            return InterfaceRoutedVlanIpv6NeighborsNeighborStateIp(
                type = 'Property',
                value = 'C:02:84::3',
    ...
    def testInterfaceRoutedVlanIpv6NeighborsNeighborStateIp(self):
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborStateIp"""
