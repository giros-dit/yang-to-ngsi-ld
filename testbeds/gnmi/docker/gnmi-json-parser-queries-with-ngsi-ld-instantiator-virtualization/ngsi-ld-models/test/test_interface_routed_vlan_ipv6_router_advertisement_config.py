...
class TestInterfaceRoutedVlanIpv6RouterAdvertisementConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv6RouterAdvertisementConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6RouterAdvertisementConfig:
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6RouterAdvertisementConfig`
        """
        model = InterfaceRoutedVlanIpv6RouterAdvertisementConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv6RouterAdvertisementConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv6RouterAdvertisementConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6RouterAdvertisementConfig(self):
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementConfig"""
