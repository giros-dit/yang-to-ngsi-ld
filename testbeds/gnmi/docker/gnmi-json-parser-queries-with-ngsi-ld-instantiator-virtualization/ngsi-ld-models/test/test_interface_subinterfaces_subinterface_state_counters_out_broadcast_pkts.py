...
class TestInterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutBroadcastPkts"""
