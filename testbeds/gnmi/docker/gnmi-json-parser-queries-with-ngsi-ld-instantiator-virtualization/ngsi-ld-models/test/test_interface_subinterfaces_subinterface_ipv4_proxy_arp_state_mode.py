...
class TestInterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode:
        """Test InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode(
                type = 'Property',
                value = 'DISABLE',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode"""
