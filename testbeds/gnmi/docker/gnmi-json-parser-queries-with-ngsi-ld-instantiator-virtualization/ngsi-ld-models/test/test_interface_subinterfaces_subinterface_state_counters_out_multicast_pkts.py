...
class TestInterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutMulticastPkts"""
