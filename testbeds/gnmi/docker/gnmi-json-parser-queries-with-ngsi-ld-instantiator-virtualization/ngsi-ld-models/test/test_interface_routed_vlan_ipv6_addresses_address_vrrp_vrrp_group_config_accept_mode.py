...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode"""
