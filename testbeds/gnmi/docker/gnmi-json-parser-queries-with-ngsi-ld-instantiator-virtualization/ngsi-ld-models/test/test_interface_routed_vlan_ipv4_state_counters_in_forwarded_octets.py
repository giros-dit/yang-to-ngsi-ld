...
class TestInterfaceRoutedVlanIpv4StateCountersInForwardedOctets(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersInForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersInForwardedOctets:
        """Test InterfaceRoutedVlanIpv4StateCountersInForwardedOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersInForwardedOctets`
        """
        model = InterfaceRoutedVlanIpv4StateCountersInForwardedOctets()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersInForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersInForwardedOctets(self):
        """Test InterfaceRoutedVlanIpv4StateCountersInForwardedOctets"""
