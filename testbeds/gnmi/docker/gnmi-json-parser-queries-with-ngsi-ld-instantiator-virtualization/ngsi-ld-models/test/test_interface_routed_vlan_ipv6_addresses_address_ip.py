...
class TestInterfaceRoutedVlanIpv6AddressesAddressIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressIp:
        """Test InterfaceRoutedVlanIpv6AddressesAddressIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressIp`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressIp()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressIp(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressIp(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressIp"""
