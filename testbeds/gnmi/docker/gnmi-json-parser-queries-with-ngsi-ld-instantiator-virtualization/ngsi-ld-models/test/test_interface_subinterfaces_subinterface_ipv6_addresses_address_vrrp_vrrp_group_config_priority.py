...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupConfigPriority"""
