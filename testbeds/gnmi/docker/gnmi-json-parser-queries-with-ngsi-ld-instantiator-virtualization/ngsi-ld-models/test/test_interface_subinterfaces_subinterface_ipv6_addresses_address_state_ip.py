...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp(
                type = 'Property',
                value = 'C:02:84::3',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp"""
