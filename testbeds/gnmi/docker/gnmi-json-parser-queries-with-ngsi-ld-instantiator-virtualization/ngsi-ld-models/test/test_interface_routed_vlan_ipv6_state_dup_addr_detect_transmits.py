...
class TestInterfaceRoutedVlanIpv6StateDupAddrDetectTransmits(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits:
        """Test InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits`
        """
        model = InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateDupAddrDetectTransmits(self):
        """Test InterfaceRoutedVlanIpv6StateDupAddrDetectTransmits"""
