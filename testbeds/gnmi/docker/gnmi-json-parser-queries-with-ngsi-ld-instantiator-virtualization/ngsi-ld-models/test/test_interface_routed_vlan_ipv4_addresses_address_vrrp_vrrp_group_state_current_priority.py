...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority"""
