...
class TestInterfaceRoutedVlanIpv4ConfigEnabled(unittest.TestCase):
    """InterfaceRoutedVlanIpv4ConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4ConfigEnabled:
        """Test InterfaceRoutedVlanIpv4ConfigEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4ConfigEnabled`
        """
        model = InterfaceRoutedVlanIpv4ConfigEnabled()
        if include_optional:
            return InterfaceRoutedVlanIpv4ConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv4ConfigEnabled(self):
        """Test InterfaceRoutedVlanIpv4ConfigEnabled"""
