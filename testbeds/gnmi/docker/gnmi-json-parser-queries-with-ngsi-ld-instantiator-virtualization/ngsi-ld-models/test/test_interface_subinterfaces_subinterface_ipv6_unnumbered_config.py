...
class TestInterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig:
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6UnnumberedConfig"""
