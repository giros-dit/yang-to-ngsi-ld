...
class TestInterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets:
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCountersInOctets"""
