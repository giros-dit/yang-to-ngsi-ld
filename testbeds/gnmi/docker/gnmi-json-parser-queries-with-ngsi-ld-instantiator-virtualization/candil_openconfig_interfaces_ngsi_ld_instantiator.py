...
from candil_openconfig_interfaces_json_parser_queries import parse_gnmi_query, update_nested_keys
...
while True:
    for message in consumer:
        ...
        sysAttrs, event_time, dict_buffers = parse_gnmi_query(message)
        ...
        for dict_buffer in dict_buffers:
            ...
            try:
                ...
                '''
                if entity != None and dict_buffer['type'] == 'InterfaceState':
        ...
        producer.send('interface-dictionary-buffers', value=json.dumps(filtered_dict_buffers).encode('utf-8'))
        producer.flush()
