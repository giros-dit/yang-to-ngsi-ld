...
from query_tester_virtualization_context_broker.check_client import NGSILDHealthInfoClient
...
performance_measurements_file = open("/opt/query-tester-virtualization-context-broker/query_tester_virtualization_context_broker/performance_measurements.csv", "w", newline='')
