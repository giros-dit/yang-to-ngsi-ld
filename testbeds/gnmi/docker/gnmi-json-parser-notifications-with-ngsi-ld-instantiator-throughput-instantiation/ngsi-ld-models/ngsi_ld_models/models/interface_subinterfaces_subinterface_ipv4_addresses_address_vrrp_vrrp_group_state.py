...
class InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupState.")
    ...
    virtual_router_id: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId] = Field(default=None, alias="virtualRouterId")
    virtual_address: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress] = Field(default=None, alias="virtualAddress")
    priority: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority] = None
    preempt: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt] = None
    preempt_delay: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay] = Field(default=None, alias="preemptDelay")
    accept_mode: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateAcceptMode] = Field(default=None, alias="acceptMode")
    advertisement_interval: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval] = Field(default=None, alias="advertisementInterval")
    current_priority: Optional[InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority] = Field(default=None, alias="currentPriority")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "virtualRouterId", "virtualAddress", "priority", "preempt", "preemptDelay", "acceptMode", "advertisementInterval", "currentPriority", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupState',
            ...
            "virtualRouterId": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateVirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
            "virtualAddress": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateVirtualAddress.from_dict(obj["virtualAddress"]) if obj.get("virtualAddress") is not None else None,
            "priority": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "preempt": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreempt.from_dict(obj["preempt"]) if obj.get("preempt") is not None else None,
            "preemptDelay": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStatePreemptDelay.from_dict(obj["preemptDelay"]) if obj.get("preemptDelay") is not None else None,
            "acceptMode": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateAcceptMode.from_dict(obj["acceptMode"]) if obj.get("acceptMode") is not None else None,
            "advertisementInterval": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateAdvertisementInterval.from_dict(obj["advertisementInterval"]) if obj.get("advertisementInterval") is not None else None,
            "currentPriority": InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupStateCurrentPriority.from_dict(obj["currentPriority"]) if obj.get("currentPriority") is not None else None,
