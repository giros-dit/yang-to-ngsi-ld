...
class InterfaceSubinterfacesSubinterfaceVlanState(BaseModel):
    """
    State variables for VLANs  YANG module: openconfig-vlan.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceVlanState.")
    ...
    vlan_id: Optional[InterfaceSubinterfacesSubinterfaceVlanStateVlanId] = Field(default=None, alias="vlanId")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceVlanState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceVlanState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceVlanState',
            ...
            "vlanId": InterfaceSubinterfacesSubinterfaceVlanStateVlanId.from_dict(obj["vlanId"]) if obj.get("vlanId") is not None else None,
