...
class InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig.")
    ...
    interface: Optional[InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface] = None
    subinterface: Optional[InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig',
            ...
            "interface": InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "subinterface": InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
