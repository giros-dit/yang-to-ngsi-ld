...
class InterfaceRoutedVlanIpv6NeighborsNeighborIp(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type InterfaceRoutedVlanIpv6NeighborsNeighborConfig.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceRoutedVlanIpv6NeighborsNeighborIp) in the input: " + _key)
