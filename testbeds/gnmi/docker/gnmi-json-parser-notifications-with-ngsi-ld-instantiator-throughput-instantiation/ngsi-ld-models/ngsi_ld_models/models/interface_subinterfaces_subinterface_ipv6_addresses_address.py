...
class InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
