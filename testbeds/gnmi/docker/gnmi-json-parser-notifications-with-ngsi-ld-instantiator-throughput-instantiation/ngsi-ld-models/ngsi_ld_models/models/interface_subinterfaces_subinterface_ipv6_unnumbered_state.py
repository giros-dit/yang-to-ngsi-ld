...
class InterfaceSubinterfacesSubinterfaceIpv6UnnumberedState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6UnnumberedState.")
    ...
    enabled: Optional[InterfaceSubinterfacesSubinterfaceIpv6UnnumberedStateEnabled] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6UnnumberedState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6UnnumberedState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6UnnumberedState',
            ...
            "enabled": InterfaceSubinterfacesSubinterfaceIpv6UnnumberedStateEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
