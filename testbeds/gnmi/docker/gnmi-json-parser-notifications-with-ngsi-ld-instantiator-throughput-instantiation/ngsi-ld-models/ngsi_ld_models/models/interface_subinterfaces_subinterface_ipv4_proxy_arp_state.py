...
class InterfaceSubinterfacesSubinterfaceIpv4ProxyArpState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4ProxyArpState.")
    ...
    mode: Optional[InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4ProxyArpState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4ProxyArpState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4ProxyArpState',
            ...
            "mode": InterfaceSubinterfacesSubinterfaceIpv4ProxyArpStateMode.from_dict(obj["mode"]) if obj.get("mode") is not None else None,
