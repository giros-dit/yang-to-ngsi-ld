...
class InterfaceRoutedVlanIpv6NeighborsNeighborState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6NeighborsNeighborState.")
    ...
    ip: Optional[InterfaceRoutedVlanIpv6NeighborsNeighborStateIp] = None
    link_layer_address: InterfaceRoutedVlanIpv6NeighborsNeighborStateLinkLayerAddress = Field(alias="linkLayerAddress")
    origin: Optional[InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin] = None
    is_router: Optional[InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter] = Field(default=None, alias="isRouter")
    neighbor_state: Optional[InterfaceRoutedVlanIpv6NeighborsNeighborStateNeighborState] = Field(default=None, alias="neighborState")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6NeighborsNeighborState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6NeighborsNeighborState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6NeighborsNeighborState',
            ...
            "ip": InterfaceRoutedVlanIpv6NeighborsNeighborStateIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "linkLayerAddress": InterfaceRoutedVlanIpv6NeighborsNeighborStateLinkLayerAddress.from_dict(obj["linkLayerAddress"]) if obj.get("linkLayerAddress") is not None else None,
            "origin": InterfaceRoutedVlanIpv6NeighborsNeighborStateOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "isRouter": InterfaceRoutedVlanIpv6NeighborsNeighborStateIsRouter.from_dict(obj["isRouter"]) if obj.get("isRouter") is not None else None,
            "neighborState": InterfaceRoutedVlanIpv6NeighborsNeighborStateNeighborState.from_dict(obj["neighborState"]) if obj.get("neighborState") is not None else None,
