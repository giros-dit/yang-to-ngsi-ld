...
class TestInterfaceEthernetStateDuplexMode(unittest.TestCase):
    """InterfaceEthernetStateDuplexMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStateDuplexMode:
        """Test InterfaceEthernetStateDuplexMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStateDuplexMode`
        """
        model = InterfaceEthernetStateDuplexMode()
        if include_optional:
            return InterfaceEthernetStateDuplexMode(
                type = 'Property',
                value = 'FULL',
    ...
    def testInterfaceEthernetStateDuplexMode(self):
        """Test InterfaceEthernetStateDuplexMode"""
