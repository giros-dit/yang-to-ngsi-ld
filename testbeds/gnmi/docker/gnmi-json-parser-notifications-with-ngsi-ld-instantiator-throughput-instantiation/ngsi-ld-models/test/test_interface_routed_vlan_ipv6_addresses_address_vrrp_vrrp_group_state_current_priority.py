...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStateCurrentPriority"""
