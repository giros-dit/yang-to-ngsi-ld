...
class TestInterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig:
        """Test InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4ProxyArpConfig"""
