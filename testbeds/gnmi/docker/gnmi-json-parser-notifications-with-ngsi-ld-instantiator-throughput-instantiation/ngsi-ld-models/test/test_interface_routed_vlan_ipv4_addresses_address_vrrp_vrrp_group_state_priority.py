...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupStatePriority"""
