...
class TestInterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface:
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefConfigInterface"""
