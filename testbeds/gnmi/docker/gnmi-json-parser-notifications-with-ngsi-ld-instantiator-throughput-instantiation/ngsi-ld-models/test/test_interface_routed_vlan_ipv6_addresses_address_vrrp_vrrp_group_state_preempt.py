...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePreempt"""
