...
class TestInterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets:
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateCountersInForwardedOctets"""
