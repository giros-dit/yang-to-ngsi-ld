...
class TestInterfaceEthernetConfigPortSpeed(unittest.TestCase):
    """InterfaceEthernetConfigPortSpeed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetConfigPortSpeed:
        """Test InterfaceEthernetConfigPortSpeed
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetConfigPortSpeed`
        """
        model = InterfaceEthernetConfigPortSpeed()
        if include_optional:
            return InterfaceEthernetConfigPortSpeed(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceEthernetConfigPortSpeed(self):
        """Test InterfaceEthernetConfigPortSpeed"""
