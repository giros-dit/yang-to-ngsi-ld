...
class TestInterfaceSubinterfacesSubinterfaceStateName(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateName:
        """Test InterfaceSubinterfacesSubinterfaceStateName
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateName`
        """
        model = InterfaceSubinterfacesSubinterfaceStateName()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateName(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceStateName(self):
        """Test InterfaceSubinterfacesSubinterfaceStateName"""
