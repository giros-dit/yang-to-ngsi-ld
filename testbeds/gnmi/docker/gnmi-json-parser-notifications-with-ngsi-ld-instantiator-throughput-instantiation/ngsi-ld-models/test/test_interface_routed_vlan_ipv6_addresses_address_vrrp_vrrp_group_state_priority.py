...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupStatePriority"""
