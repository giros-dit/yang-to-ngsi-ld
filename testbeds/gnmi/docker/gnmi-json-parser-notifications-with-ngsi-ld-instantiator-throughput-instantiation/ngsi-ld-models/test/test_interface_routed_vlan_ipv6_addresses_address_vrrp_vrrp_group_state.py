...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState(
                id = '',
                type = 'InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupState"""
