...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressConfigPrefixLength"""
