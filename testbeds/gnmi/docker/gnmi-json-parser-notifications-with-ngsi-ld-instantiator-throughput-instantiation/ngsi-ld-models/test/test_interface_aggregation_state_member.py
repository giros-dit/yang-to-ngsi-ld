...
class TestInterfaceAggregationStateMember(unittest.TestCase):
    """InterfaceAggregationStateMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationStateMember:
        """Test InterfaceAggregationStateMember
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationStateMember`
        """
        model = InterfaceAggregationStateMember()
        if include_optional:
            return InterfaceAggregationStateMember(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceAggregationStateMember(self):
        """Test InterfaceAggregationStateMember"""
