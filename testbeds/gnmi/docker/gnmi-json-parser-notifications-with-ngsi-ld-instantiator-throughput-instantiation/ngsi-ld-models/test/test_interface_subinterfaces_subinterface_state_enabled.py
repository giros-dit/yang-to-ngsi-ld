...
class TestInterfaceSubinterfacesSubinterfaceStateEnabled(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateEnabled:
        """Test InterfaceSubinterfacesSubinterfaceStateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateEnabled`
        """
        model = InterfaceSubinterfacesSubinterfaceStateEnabled()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateEnabled(self):
        """Test InterfaceSubinterfacesSubinterfaceStateEnabled"""
