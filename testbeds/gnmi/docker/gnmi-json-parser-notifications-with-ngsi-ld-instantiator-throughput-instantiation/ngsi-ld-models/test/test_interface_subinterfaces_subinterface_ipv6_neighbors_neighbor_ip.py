...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborIp"""
