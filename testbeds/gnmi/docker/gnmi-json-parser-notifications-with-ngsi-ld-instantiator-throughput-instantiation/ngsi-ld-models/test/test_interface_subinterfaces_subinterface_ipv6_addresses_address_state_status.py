...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus(
                type = 'Property',
                value = 'PREFERRED',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus"""
