...
class TestInterfaceStateAdminStatus(unittest.TestCase):
    """InterfaceStateAdminStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateAdminStatus:
        """Test InterfaceStateAdminStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateAdminStatus`
        """
        model = InterfaceStateAdminStatus()
        if include_optional:
            return InterfaceStateAdminStatus(
                type = 'Property',
                value = 'UP',
    ...
    def testInterfaceStateAdminStatus(self):
        """Test InterfaceStateAdminStatus"""
