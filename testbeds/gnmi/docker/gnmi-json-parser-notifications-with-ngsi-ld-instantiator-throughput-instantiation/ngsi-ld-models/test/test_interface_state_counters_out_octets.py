...
class TestInterfaceStateCountersOutOctets(unittest.TestCase):
    """InterfaceStateCountersOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersOutOctets:
        """Test InterfaceStateCountersOutOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersOutOctets`
        """
        model = InterfaceStateCountersOutOctets()
        if include_optional:
            return InterfaceStateCountersOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersOutOctets(self):
        """Test InterfaceStateCountersOutOctets"""
