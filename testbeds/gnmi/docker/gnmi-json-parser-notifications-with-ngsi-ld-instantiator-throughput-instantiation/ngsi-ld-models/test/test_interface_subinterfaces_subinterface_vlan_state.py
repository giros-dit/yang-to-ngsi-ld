...
class TestInterfaceSubinterfacesSubinterfaceVlanState(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceVlanState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceVlanState:
        """Test InterfaceSubinterfacesSubinterfaceVlanState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceVlanState`
        """
        model = InterfaceSubinterfacesSubinterfaceVlanState()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceVlanState(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceVlanState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceVlanState(self):
        """Test InterfaceSubinterfacesSubinterfaceVlanState"""
