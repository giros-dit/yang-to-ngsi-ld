...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin(
                type = 'Property',
                value = 'OTHER',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressStateOrigin"""
