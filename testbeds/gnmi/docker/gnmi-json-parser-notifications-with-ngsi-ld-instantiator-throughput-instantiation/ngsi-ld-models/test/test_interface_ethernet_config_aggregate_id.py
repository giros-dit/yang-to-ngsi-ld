...
class TestInterfaceEthernetConfigAggregateId(unittest.TestCase):
    """InterfaceEthernetConfigAggregateId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetConfigAggregateId:
        """Test InterfaceEthernetConfigAggregateId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetConfigAggregateId`
        """
        model = InterfaceEthernetConfigAggregateId()
        if include_optional:
            return InterfaceEthernetConfigAggregateId(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceEthernetConfigAggregateId(self):
        """Test InterfaceEthernetConfigAggregateId"""
