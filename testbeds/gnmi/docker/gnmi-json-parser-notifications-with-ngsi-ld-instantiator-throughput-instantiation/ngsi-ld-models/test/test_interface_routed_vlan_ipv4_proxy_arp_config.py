...
class TestInterfaceRoutedVlanIpv4ProxyArpConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv4ProxyArpConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4ProxyArpConfig:
        """Test InterfaceRoutedVlanIpv4ProxyArpConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4ProxyArpConfig`
        """
        model = InterfaceRoutedVlanIpv4ProxyArpConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv4ProxyArpConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv4ProxyArpConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4ProxyArpConfig(self):
        """Test InterfaceRoutedVlanIpv4ProxyArpConfig"""
