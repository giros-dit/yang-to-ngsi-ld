...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt"""
