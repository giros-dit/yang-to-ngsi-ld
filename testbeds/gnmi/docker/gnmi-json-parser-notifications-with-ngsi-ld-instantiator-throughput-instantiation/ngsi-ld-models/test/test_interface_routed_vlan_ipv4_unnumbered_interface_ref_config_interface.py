...
class TestInterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface:
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigInterface"""
