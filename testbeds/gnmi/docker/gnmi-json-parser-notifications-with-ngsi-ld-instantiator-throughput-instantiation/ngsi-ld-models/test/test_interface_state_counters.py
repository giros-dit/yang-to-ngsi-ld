...
class TestInterfaceStateCounters(unittest.TestCase):
    """InterfaceStateCounters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCounters:
        """Test InterfaceStateCounters
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCounters`
        """
        model = InterfaceStateCounters()
        if include_optional:
            return InterfaceStateCounters(
                id = '',
                type = 'InterfaceStateCounters',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceStateCounters(self):
        """Test InterfaceStateCounters"""
