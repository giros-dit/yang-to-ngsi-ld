...
class TestInterfaceRoutedVlanIpv4NeighborsNeighborStateIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv4NeighborsNeighborStateIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4NeighborsNeighborStateIp:
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborStateIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4NeighborsNeighborStateIp`
        """
        model = InterfaceRoutedVlanIpv4NeighborsNeighborStateIp()
        if include_optional:
            return InterfaceRoutedVlanIpv4NeighborsNeighborStateIp(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testInterfaceRoutedVlanIpv4NeighborsNeighborStateIp(self):
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborStateIp"""
