...
class TestInterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime(unittest.TestCase):
    """InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime:
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime`
        """
        model = InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime()
        if include_optional:
            return InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime(self):
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementStateLifetime"""
