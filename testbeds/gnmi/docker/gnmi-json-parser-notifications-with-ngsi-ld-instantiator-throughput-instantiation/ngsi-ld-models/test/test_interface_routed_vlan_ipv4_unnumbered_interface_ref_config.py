...
class TestInterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig:
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig(
                id = '',
                type = 'InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfig"""
