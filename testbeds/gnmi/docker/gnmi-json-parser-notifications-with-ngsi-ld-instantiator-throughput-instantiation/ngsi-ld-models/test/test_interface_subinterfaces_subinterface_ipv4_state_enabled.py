...
class TestInterfaceSubinterfacesSubinterfaceIpv4StateEnabled(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4StateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4StateEnabled:
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4StateEnabled`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4StateEnabled()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4StateEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4StateEnabled(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4StateEnabled"""
