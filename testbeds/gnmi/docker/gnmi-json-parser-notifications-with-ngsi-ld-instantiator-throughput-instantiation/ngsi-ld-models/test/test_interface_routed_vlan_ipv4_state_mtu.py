...
class TestInterfaceRoutedVlanIpv4StateMtu(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateMtu:
        """Test InterfaceRoutedVlanIpv4StateMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateMtu`
        """
        model = InterfaceRoutedVlanIpv4StateMtu()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateMtu(
                type = 'Property',
                value = 68,
    ...
    def testInterfaceRoutedVlanIpv4StateMtu(self):
        """Test InterfaceRoutedVlanIpv4StateMtu"""
