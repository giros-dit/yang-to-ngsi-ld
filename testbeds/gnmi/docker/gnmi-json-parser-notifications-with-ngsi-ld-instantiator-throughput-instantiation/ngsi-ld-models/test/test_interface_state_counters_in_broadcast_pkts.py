...
class TestInterfaceStateCountersInBroadcastPkts(unittest.TestCase):
    """InterfaceStateCountersInBroadcastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersInBroadcastPkts:
        """Test InterfaceStateCountersInBroadcastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersInBroadcastPkts`
        """
        model = InterfaceStateCountersInBroadcastPkts()
        if include_optional:
            return InterfaceStateCountersInBroadcastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersInBroadcastPkts(self):
        """Test InterfaceStateCountersInBroadcastPkts"""
