...
class TestInterfaceStateCountersInDiscards(unittest.TestCase):
    """InterfaceStateCountersInDiscards unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersInDiscards:
        """Test InterfaceStateCountersInDiscards
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersInDiscards`
        """
        model = InterfaceStateCountersInDiscards()
        if include_optional:
            return InterfaceStateCountersInDiscards(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersInDiscards(self):
        """Test InterfaceStateCountersInDiscards"""
