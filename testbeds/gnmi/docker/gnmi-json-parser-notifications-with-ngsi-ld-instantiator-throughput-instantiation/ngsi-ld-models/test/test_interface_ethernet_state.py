...
class TestInterfaceEthernetState(unittest.TestCase):
    """InterfaceEthernetState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetState:
        """Test InterfaceEthernetState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetState`
        """
        model = InterfaceEthernetState()
        if include_optional:
            return InterfaceEthernetState(
                id = '',
                type = 'InterfaceEthernetState',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                hw_mac_address = None,
                negotiated_duplex_mode = None,
                negotiated_port_speed = None,
                aggregate_id = None,
                is_part_of = None
            )
        else:
    ...
    def testInterfaceEthernetState(self):
        """Test InterfaceEthernetState"""
