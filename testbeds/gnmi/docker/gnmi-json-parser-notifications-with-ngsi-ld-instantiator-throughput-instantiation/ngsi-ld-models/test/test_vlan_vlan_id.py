...
class TestVlanVlanId(unittest.TestCase):
    """VlanVlanId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanVlanId:
        """Test VlanVlanId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanVlanId`
        """
        model = VlanVlanId()
        if include_optional:
            return VlanVlanId(
