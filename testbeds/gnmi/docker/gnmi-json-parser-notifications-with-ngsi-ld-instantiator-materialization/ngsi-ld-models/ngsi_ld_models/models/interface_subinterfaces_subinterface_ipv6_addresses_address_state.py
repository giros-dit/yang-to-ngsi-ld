...
class InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp] = None
    prefix_length: InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength = Field(alias="prefixLength")
    origin: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin] = None
    status: Optional[InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ip", "prefixLength", "origin", "status", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStatePrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
            "origin": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "status": InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
