...
class InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState.")
    ...
    interface: Optional[InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface] = None
    subinterface: Optional[InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6UnnumberedInterfaceRefState',
            ...
            "interface": InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "subinterface": InterfaceRoutedVlanIpv6UnnumberedInterfaceRefStateSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
