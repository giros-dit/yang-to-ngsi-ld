...
class InterfaceSubinterfacesSubinterfaceState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceState.")
    ...
    index: Optional[InterfaceSubinterfacesSubinterfaceStateIndex] = None
    description: Optional[InterfaceSubinterfacesSubinterfaceStateDescription] = None
    enabled: Optional[InterfaceSubinterfacesSubinterfaceStateEnabled] = None
    name: Optional[InterfaceSubinterfacesSubinterfaceStateName] = None
    ifindex: Optional[InterfaceSubinterfacesSubinterfaceStateIfindex] = None
    admin_status: InterfaceSubinterfacesSubinterfaceStateAdminStatus = Field(alias="adminStatus")
    oper_status: InterfaceSubinterfacesSubinterfaceStateOperStatus = Field(alias="operStatus")
    last_change: Optional[InterfaceSubinterfacesSubinterfaceStateLastChange] = Field(default=None, alias="lastChange")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "index", "description", "enabled", "name", "ifindex", "adminStatus", "operStatus", "lastChange", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceState'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceState',
            ...
            "index": InterfaceSubinterfacesSubinterfaceStateIndex.from_dict(obj["index"]) if obj.get("index") is not None else None,
            "description": InterfaceSubinterfacesSubinterfaceStateDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "enabled": InterfaceSubinterfacesSubinterfaceStateEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "name": InterfaceSubinterfacesSubinterfaceStateName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "ifindex": InterfaceSubinterfacesSubinterfaceStateIfindex.from_dict(obj["ifindex"]) if obj.get("ifindex") is not None else None,
            "adminStatus": InterfaceSubinterfacesSubinterfaceStateAdminStatus.from_dict(obj["adminStatus"]) if obj.get("adminStatus") is not None else None,
            "operStatus": InterfaceSubinterfacesSubinterfaceStateOperStatus.from_dict(obj["operStatus"]) if obj.get("operStatus") is not None else None,
            "lastChange": InterfaceSubinterfacesSubinterfaceStateLastChange.from_dict(obj["lastChange"]) if obj.get("lastChange") is not None else None,
