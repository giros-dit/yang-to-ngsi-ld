...
class InterfaceRoutedVlanIpv4AddressesAddressConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4AddressesAddressConfig.")
    ...
    ip: Optional[InterfaceRoutedVlanIpv4AddressesAddressConfigIp] = None
    prefix_length: Optional[InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength] = Field(default=None, alias="prefixLength")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4AddressesAddressConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4AddressesAddressConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4AddressesAddressConfig',
            ...
            "ip": InterfaceRoutedVlanIpv4AddressesAddressConfigIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceRoutedVlanIpv4AddressesAddressConfigPrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
