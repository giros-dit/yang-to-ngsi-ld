...
class TestInterfaceSubinterfacesSubinterfaceIpv4State(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4State unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4State:
        """Test InterfaceSubinterfacesSubinterfaceIpv4State
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4State`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4State()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4State(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv4State',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4State(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4State"""
