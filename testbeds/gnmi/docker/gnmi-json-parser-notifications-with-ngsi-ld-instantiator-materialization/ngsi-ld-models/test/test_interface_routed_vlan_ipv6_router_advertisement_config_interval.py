...
class TestInterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval(unittest.TestCase):
    """InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval:
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval`
        """
        model = InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval()
        if include_optional:
            return InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval(self):
        """Test InterfaceRoutedVlanIpv6RouterAdvertisementConfigInterval"""
