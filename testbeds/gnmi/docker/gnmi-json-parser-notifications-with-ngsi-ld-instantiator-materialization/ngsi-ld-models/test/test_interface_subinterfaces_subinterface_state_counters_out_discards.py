...
class TestInterfaceSubinterfacesSubinterfaceStateCountersOutDiscards(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersOutDiscards(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersOutDiscards"""
