...
class TestInterfaceRoutedVlanIpv6AddressesAddressState(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressState:
        """Test InterfaceRoutedVlanIpv6AddressesAddressState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressState`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressState()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressState(
                id = '',
                type = 'InterfaceRoutedVlanIpv6AddressesAddressState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressState(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressState"""
