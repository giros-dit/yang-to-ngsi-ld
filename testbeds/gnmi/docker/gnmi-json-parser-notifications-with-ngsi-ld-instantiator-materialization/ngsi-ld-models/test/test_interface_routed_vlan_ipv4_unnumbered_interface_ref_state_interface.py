...
class TestInterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface:
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefStateInterface"""
