...
class TestInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress:
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress(
                type = 'Property',
                value = '',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress"""
