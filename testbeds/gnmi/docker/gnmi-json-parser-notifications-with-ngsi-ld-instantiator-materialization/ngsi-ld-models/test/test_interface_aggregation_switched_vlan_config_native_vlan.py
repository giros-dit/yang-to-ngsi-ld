...
class TestInterfaceAggregationSwitchedVlanConfigNativeVlan(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanConfigNativeVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanConfigNativeVlan:
        """Test InterfaceAggregationSwitchedVlanConfigNativeVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanConfigNativeVlan`
        """
        model = InterfaceAggregationSwitchedVlanConfigNativeVlan()
        if include_optional:
            return InterfaceAggregationSwitchedVlanConfigNativeVlan(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceAggregationSwitchedVlanConfigNativeVlan(self):
        """Test InterfaceAggregationSwitchedVlanConfigNativeVlan"""
