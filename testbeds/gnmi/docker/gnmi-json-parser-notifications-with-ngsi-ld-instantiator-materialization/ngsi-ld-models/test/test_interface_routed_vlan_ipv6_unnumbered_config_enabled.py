...
class TestInterfaceRoutedVlanIpv6UnnumberedConfigEnabled(unittest.TestCase):
    """InterfaceRoutedVlanIpv6UnnumberedConfigEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6UnnumberedConfigEnabled:
        """Test InterfaceRoutedVlanIpv6UnnumberedConfigEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6UnnumberedConfigEnabled`
        """
        model = InterfaceRoutedVlanIpv6UnnumberedConfigEnabled()
        if include_optional:
            return InterfaceRoutedVlanIpv6UnnumberedConfigEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv6UnnumberedConfigEnabled(self):
        """Test InterfaceRoutedVlanIpv6UnnumberedConfigEnabled"""
