...
class TestInterfaceRoutedVlanIpv4AddressesAddressConfigIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressConfigIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressConfigIp:
        """Test InterfaceRoutedVlanIpv4AddressesAddressConfigIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressConfigIp`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressConfigIp()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressConfigIp(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressConfigIp(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressConfigIp"""
