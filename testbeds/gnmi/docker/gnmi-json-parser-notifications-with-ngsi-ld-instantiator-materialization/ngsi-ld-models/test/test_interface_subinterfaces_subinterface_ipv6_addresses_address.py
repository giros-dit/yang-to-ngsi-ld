...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddress(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddress(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddress"""
