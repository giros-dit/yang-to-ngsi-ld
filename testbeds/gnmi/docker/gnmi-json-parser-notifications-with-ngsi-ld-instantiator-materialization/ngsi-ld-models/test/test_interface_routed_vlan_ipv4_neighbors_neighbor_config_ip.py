...
class TestInterfaceRoutedVlanIpv4NeighborsNeighborConfigIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv4NeighborsNeighborConfigIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4NeighborsNeighborConfigIp:
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborConfigIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4NeighborsNeighborConfigIp`
        """
        model = InterfaceRoutedVlanIpv4NeighborsNeighborConfigIp()
        if include_optional:
            return InterfaceRoutedVlanIpv4NeighborsNeighborConfigIp(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testInterfaceRoutedVlanIpv4NeighborsNeighborConfigIp(self):
        """Test InterfaceRoutedVlanIpv4NeighborsNeighborConfigIp"""
