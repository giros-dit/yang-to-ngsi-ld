...
class TestInterfaceAggregationSwitchedVlanConfigTrunkVlans(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanConfigTrunkVlans unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanConfigTrunkVlans:
        """Test InterfaceAggregationSwitchedVlanConfigTrunkVlans
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanConfigTrunkVlans`
        """
        model = InterfaceAggregationSwitchedVlanConfigTrunkVlans()
        if include_optional:
            return InterfaceAggregationSwitchedVlanConfigTrunkVlans(
                type = 'Property',
                value = '',
    ...
    def testInterfaceAggregationSwitchedVlanConfigTrunkVlans(self):
        """Test InterfaceAggregationSwitchedVlanConfigTrunkVlans"""
