...
class TestVlanConfigVlanId(unittest.TestCase):
    """VlanConfigVlanId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanConfigVlanId:
        """Test VlanConfigVlanId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanConfigVlanId`
        """
        model = VlanConfigVlanId()
        if include_optional:
            return VlanConfigVlanId(
                type = 'Property',
                value = 56,
