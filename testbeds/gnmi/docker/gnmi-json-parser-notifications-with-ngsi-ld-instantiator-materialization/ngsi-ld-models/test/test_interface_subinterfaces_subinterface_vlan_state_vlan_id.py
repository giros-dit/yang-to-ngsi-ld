...
class TestInterfaceSubinterfacesSubinterfaceVlanStateVlanId(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceVlanStateVlanId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceVlanStateVlanId:
        """Test InterfaceSubinterfacesSubinterfaceVlanStateVlanId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceVlanStateVlanId`
        """
        model = InterfaceSubinterfacesSubinterfaceVlanStateVlanId()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceVlanStateVlanId(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceVlanStateVlanId(self):
        """Test InterfaceSubinterfacesSubinterfaceVlanStateVlanId"""
