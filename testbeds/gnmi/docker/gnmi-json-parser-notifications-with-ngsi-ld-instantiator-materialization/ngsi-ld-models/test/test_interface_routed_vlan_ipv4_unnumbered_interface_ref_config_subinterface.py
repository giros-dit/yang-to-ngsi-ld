...
class TestInterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface:
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedInterfaceRefConfigSubinterface"""
