...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin(
                type = 'Property',
                value = 'OTHER',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressStateOrigin"""
