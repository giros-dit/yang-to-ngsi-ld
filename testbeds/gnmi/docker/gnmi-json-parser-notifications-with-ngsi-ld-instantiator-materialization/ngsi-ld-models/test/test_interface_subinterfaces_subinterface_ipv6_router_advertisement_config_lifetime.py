...
class TestInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime:
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6RouterAdvertisementConfigLifetime"""
