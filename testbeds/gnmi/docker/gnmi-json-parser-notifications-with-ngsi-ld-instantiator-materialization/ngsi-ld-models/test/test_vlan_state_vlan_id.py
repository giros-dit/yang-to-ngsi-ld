...
class TestVlanStateVlanId(unittest.TestCase):
    """VlanStateVlanId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanStateVlanId:
        """Test VlanStateVlanId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanStateVlanId`
        """
        model = VlanStateVlanId()
        if include_optional:
            return VlanStateVlanId(
                type = 'Property',
                value = 56,
