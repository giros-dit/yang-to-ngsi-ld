...
class TestInterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled:
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedStateEnabled"""
