...
class TestInterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions:
        """Test InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions`
        """
        model = InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions(self):
        """Test InterfaceSubinterfacesSubinterfaceStateCountersCarrierTransitions"""
