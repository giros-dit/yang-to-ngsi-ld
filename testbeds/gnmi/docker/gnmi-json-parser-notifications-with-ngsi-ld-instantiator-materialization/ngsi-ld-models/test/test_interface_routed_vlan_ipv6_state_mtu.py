...
class TestInterfaceRoutedVlanIpv6StateMtu(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateMtu:
        """Test InterfaceRoutedVlanIpv6StateMtu
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateMtu`
        """
        model = InterfaceRoutedVlanIpv6StateMtu()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateMtu(
                type = 'Property',
                value = 1280,
    ...
    def testInterfaceRoutedVlanIpv6StateMtu(self):
        """Test InterfaceRoutedVlanIpv6StateMtu"""
