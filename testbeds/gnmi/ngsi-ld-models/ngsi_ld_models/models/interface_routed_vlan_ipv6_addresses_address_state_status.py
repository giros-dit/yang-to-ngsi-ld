...
class InterfaceRoutedVlanIpv6AddressesAddressStateStatus(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('PREFERRED', 'DEPRECATED', 'INVALID', 'INACCESSIBLE', 'UNKNOWN', 'TENTATIVE', 'DUPLICATE', 'OPTIMISTIC'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceRoutedVlanIpv6AddressesAddressStateStatus) in the input: " + _key)
