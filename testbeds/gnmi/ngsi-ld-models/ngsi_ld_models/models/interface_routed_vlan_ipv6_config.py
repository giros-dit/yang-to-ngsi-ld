...
class InterfaceRoutedVlanIpv6Config(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6Config.")
    ...
    enabled: Optional[InterfaceRoutedVlanIpv6ConfigEnabled] = None
    mtu: Optional[InterfaceRoutedVlanIpv6ConfigMtu] = None
    dup_addr_detect_transmits: Optional[InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits] = Field(default=None, alias="dupAddrDetectTransmits")
    dhcp_client: Optional[InterfaceRoutedVlanIpv6ConfigDhcpClient] = Field(default=None, alias="dhcpClient")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6Config'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6Config')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6Config',
            ...
            "enabled": InterfaceRoutedVlanIpv6ConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "mtu": InterfaceRoutedVlanIpv6ConfigMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dupAddrDetectTransmits": InterfaceRoutedVlanIpv6ConfigDupAddrDetectTransmits.from_dict(obj["dupAddrDetectTransmits"]) if obj.get("dupAddrDetectTransmits") is not None else None,
            "dhcpClient": InterfaceRoutedVlanIpv6ConfigDhcpClient.from_dict(obj["dhcpClient"]) if obj.get("dhcpClient") is not None else None,
