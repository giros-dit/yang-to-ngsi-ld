...
class InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig.")
    ...
    virtual_router_id: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualRouterId] = Field(default=None, alias="virtualRouterId")
    virtual_address: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress] = Field(default=None, alias="virtualAddress")
    priority: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority] = None
    preempt: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt] = None
    preempt_delay: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreemptDelay] = Field(default=None, alias="preemptDelay")
    accept_mode: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode] = Field(default=None, alias="acceptMode")
    advertisement_interval: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAdvertisementInterval] = Field(default=None, alias="advertisementInterval")
    virtual_link_local: Optional[InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal] = Field(default=None, alias="virtualLinkLocal")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfig',
            ...
            "virtualRouterId": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
            "virtualAddress": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualAddress.from_dict(obj["virtualAddress"]) if obj.get("virtualAddress") is not None else None,
            "priority": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPriority.from_dict(obj["priority"]) if obj.get("priority") is not None else None,
            "preempt": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreempt.from_dict(obj["preempt"]) if obj.get("preempt") is not None else None,
            "preemptDelay": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigPreemptDelay.from_dict(obj["preemptDelay"]) if obj.get("preemptDelay") is not None else None,
            "acceptMode": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAcceptMode.from_dict(obj["acceptMode"]) if obj.get("acceptMode") is not None else None,
            "advertisementInterval": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigAdvertisementInterval.from_dict(obj["advertisementInterval"]) if obj.get("advertisementInterval") is not None else None,
            "virtualLinkLocal": InterfaceRoutedVlanIpv6AddressesAddressVrrpVrrpGroupConfigVirtualLinkLocal.from_dict(obj["virtualLinkLocal"]) if obj.get("virtualLinkLocal") is not None else None,
