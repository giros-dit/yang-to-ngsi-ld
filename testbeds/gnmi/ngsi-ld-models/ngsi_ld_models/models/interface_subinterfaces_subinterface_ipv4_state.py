...
class InterfaceSubinterfacesSubinterfaceIpv4State(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4State.")
    ...
    enabled: Optional[InterfaceSubinterfacesSubinterfaceIpv4StateEnabled] = None
    mtu: Optional[InterfaceSubinterfacesSubinterfaceIpv4StateMtu] = None
    dhcp_client: Optional[InterfaceSubinterfacesSubinterfaceIpv4StateDhcpClient] = Field(default=None, alias="dhcpClient")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4State'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4State')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4State',
            ...
            "enabled": InterfaceSubinterfacesSubinterfaceIpv4StateEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "mtu": InterfaceSubinterfacesSubinterfaceIpv4StateMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dhcpClient": InterfaceSubinterfacesSubinterfaceIpv4StateDhcpClient.from_dict(obj["dhcpClient"]) if obj.get("dhcpClient") is not None else None,
