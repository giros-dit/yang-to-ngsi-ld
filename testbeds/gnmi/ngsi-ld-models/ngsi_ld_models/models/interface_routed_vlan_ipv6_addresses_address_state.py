...
class InterfaceRoutedVlanIpv6AddressesAddressState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv6AddressesAddressState.")
    ...
    ip: Optional[InterfaceRoutedVlanIpv6AddressesAddressStateIp] = None
    prefix_length: InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength = Field(alias="prefixLength")
    origin: Optional[InterfaceRoutedVlanIpv6AddressesAddressStateOrigin] = None
    status: Optional[InterfaceRoutedVlanIpv6AddressesAddressStateStatus] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv6AddressesAddressState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv6AddressesAddressState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv6AddressesAddressState',
            ...
            "ip": InterfaceRoutedVlanIpv6AddressesAddressStateIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceRoutedVlanIpv6AddressesAddressStatePrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
            "origin": InterfaceRoutedVlanIpv6AddressesAddressStateOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "status": InterfaceRoutedVlanIpv6AddressesAddressStateStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
