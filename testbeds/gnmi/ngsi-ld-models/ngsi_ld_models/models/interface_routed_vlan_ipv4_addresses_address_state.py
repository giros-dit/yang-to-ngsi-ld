...
class InterfaceRoutedVlanIpv4AddressesAddressState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4AddressesAddressState.")
    ...
    ip: Optional[InterfaceRoutedVlanIpv4AddressesAddressStateIp] = None
    prefix_length: Optional[InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength] = Field(default=None, alias="prefixLength")
    origin: Optional[InterfaceRoutedVlanIpv4AddressesAddressStateOrigin] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4AddressesAddressState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4AddressesAddressState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4AddressesAddressState',
            ...
            "ip": InterfaceRoutedVlanIpv4AddressesAddressStateIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "prefixLength": InterfaceRoutedVlanIpv4AddressesAddressStatePrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
            "origin": InterfaceRoutedVlanIpv4AddressesAddressStateOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
