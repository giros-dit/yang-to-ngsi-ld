...
class InterfaceRoutedVlanIpv4NeighborsNeighbor(BaseModel):
    ...
    ip: Optional[InterfaceRoutedVlanIpv4NeighborsNeighborIp] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4NeighborsNeighbor'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4NeighborsNeighbor')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4NeighborsNeighbor',
            ...
            "ip": InterfaceRoutedVlanIpv4NeighborsNeighborIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
