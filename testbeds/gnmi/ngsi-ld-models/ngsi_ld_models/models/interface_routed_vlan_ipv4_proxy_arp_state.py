...
class InterfaceRoutedVlanIpv4ProxyArpState(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanIpv4ProxyArpState.")
    ...
    mode: Optional[InterfaceRoutedVlanIpv4ProxyArpStateMode] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanIpv4ProxyArpState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanIpv4ProxyArpState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanIpv4ProxyArpState',
            ...
            "mode": InterfaceRoutedVlanIpv4ProxyArpStateMode.from_dict(obj["mode"]) if obj.get("mode") is not None else None,
