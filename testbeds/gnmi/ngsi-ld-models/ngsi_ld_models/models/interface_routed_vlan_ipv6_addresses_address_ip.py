...
class InterfaceRoutedVlanIpv6AddressesAddressIp(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type InterfaceRoutedVlanIpv6AddressesAddressConfig.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceRoutedVlanIpv6AddressesAddressIp) in the input: " + _key)
