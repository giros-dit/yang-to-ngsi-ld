...
class InterfaceRoutedVlanState(BaseModel):
    """
    Operational state data   YANG module: openconfig-vlan.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceRoutedVlanState.")
    ...
    vlan: Optional[InterfaceRoutedVlanStateVlan] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceRoutedVlanState'):
            raise ValueError("must be one of enum values ('InterfaceRoutedVlanState')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceRoutedVlanState',
            ...
            "vlan": InterfaceRoutedVlanStateVlan.from_dict(obj["vlan"]) if obj.get("vlan") is not None else None,
