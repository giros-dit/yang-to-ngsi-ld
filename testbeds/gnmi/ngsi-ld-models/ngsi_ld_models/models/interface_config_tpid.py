...
class InterfaceConfigTpid(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceConfigTpid) in the input: " + _key)

        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'Relationship',
            "object": obj.get("object") if obj.get("object") is not None else 'urn:ngsi-ld:YANGIdentity:oc-vlan-types:TPID_0X8100',
