...
class InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighbor(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighbor.")
    ...
    ip: Optional[InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ip", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighbor'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighbor')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighbor',
            ...
            "ip": InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborIp.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
