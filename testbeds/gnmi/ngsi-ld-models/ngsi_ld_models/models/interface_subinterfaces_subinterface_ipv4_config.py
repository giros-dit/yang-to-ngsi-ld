...
class InterfaceSubinterfacesSubinterfaceIpv4Config(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfacesSubinterfaceIpv4Config.")
    ...
    enabled: Optional[InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled] = None
    mtu: Optional[InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu] = None
    dhcp_client: Optional[InterfaceSubinterfacesSubinterfaceIpv4ConfigDhcpClient] = Field(default=None, alias="dhcpClient")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "enabled", "mtu", "dhcpClient", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfacesSubinterfaceIpv4Config'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfacesSubinterfaceIpv4Config')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfacesSubinterfaceIpv4Config',
            ...
            "enabled": InterfaceSubinterfacesSubinterfaceIpv4ConfigEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
            "mtu": InterfaceSubinterfacesSubinterfaceIpv4ConfigMtu.from_dict(obj["mtu"]) if obj.get("mtu") is not None else None,
            "dhcpClient": InterfaceSubinterfacesSubinterfaceIpv4ConfigDhcpClient.from_dict(obj["dhcpClient"]) if obj.get("dhcpClient") is not None else None,
