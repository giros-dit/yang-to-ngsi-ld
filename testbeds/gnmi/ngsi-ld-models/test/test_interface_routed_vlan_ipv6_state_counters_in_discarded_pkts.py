...
class TestInterfaceRoutedVlanIpv6StateCountersInDiscardedPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersInDiscardedPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersInDiscardedPkts:
        """Test InterfaceRoutedVlanIpv6StateCountersInDiscardedPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersInDiscardedPkts`
        """
        model = InterfaceRoutedVlanIpv6StateCountersInDiscardedPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersInDiscardedPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersInDiscardedPkts(self):
        """Test InterfaceRoutedVlanIpv6StateCountersInDiscardedPkts"""
