...
class TestInterfaceAggregationSwitchedVlanStateTrunkVlans(unittest.TestCase):
    """InterfaceAggregationSwitchedVlanStateTrunkVlans unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationSwitchedVlanStateTrunkVlans:
        """Test InterfaceAggregationSwitchedVlanStateTrunkVlans
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationSwitchedVlanStateTrunkVlans`
        """
        model = InterfaceAggregationSwitchedVlanStateTrunkVlans()
        if include_optional:
            return InterfaceAggregationSwitchedVlanStateTrunkVlans(
                type = 'Property',
                value = '',
    ...
    def testInterfaceAggregationSwitchedVlanStateTrunkVlans(self):
        """Test InterfaceAggregationSwitchedVlanStateTrunkVlans"""
