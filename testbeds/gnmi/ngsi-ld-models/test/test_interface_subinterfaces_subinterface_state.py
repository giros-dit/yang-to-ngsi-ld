...
class TestInterfaceSubinterfacesSubinterfaceState(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceState:
        """Test InterfaceSubinterfacesSubinterfaceState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceState`
        """
        model = InterfaceSubinterfacesSubinterfaceState()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceState(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceState(self):
        """Test InterfaceSubinterfacesSubinterfaceState"""
