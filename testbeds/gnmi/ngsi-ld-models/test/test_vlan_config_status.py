...
class TestVlanConfigStatus(unittest.TestCase):
    """VlanConfigStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanConfigStatus:
        """Test VlanConfigStatus
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanConfigStatus`
        """
        model = VlanConfigStatus()
        if include_optional:
            return VlanConfigStatus(
                type = 'Property',
                value = 'ACTIVE',
