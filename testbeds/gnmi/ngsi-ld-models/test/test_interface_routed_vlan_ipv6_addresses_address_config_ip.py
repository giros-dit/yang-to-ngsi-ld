...
class TestInterfaceRoutedVlanIpv6AddressesAddressConfigIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv6AddressesAddressConfigIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6AddressesAddressConfigIp:
        """Test InterfaceRoutedVlanIpv6AddressesAddressConfigIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6AddressesAddressConfigIp`
        """
        model = InterfaceRoutedVlanIpv6AddressesAddressConfigIp()
        if include_optional:
            return InterfaceRoutedVlanIpv6AddressesAddressConfigIp(
                type = 'Property',
                value = 'C:02:84::3',
    ...
    def testInterfaceRoutedVlanIpv6AddressesAddressConfigIp(self):
        """Test InterfaceRoutedVlanIpv6AddressesAddressConfigIp"""
