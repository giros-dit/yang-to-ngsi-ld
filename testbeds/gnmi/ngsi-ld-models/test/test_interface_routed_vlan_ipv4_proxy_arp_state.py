...
class TestInterfaceRoutedVlanIpv4ProxyArpState(unittest.TestCase):
    """InterfaceRoutedVlanIpv4ProxyArpState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4ProxyArpState:
        """Test InterfaceRoutedVlanIpv4ProxyArpState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4ProxyArpState`
        """
        model = InterfaceRoutedVlanIpv4ProxyArpState()
        if include_optional:
            return InterfaceRoutedVlanIpv4ProxyArpState(
                id = '',
                type = 'InterfaceRoutedVlanIpv4ProxyArpState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv4ProxyArpState(self):
        """Test InterfaceRoutedVlanIpv4ProxyArpState"""
