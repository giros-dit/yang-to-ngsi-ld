...
class TestInterfaceRoutedVlanIpv4StateEnabled(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateEnabled:
        """Test InterfaceRoutedVlanIpv4StateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateEnabled`
        """
        model = InterfaceRoutedVlanIpv4StateEnabled()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv4StateEnabled(self):
        """Test InterfaceRoutedVlanIpv4StateEnabled"""
