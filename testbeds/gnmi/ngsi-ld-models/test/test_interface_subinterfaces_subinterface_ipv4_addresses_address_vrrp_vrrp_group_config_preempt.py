...
class TestInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt:
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4AddressesAddressVrrpVrrpGroupConfigPreempt"""
