...
class TestInterfaceStateCountersLastClear(unittest.TestCase):
    """InterfaceStateCountersLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersLastClear:
        """Test InterfaceStateCountersLastClear
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersLastClear`
        """
        model = InterfaceStateCountersLastClear()
        if include_optional:
            return InterfaceStateCountersLastClear(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersLastClear(self):
        """Test InterfaceStateCountersLastClear"""
