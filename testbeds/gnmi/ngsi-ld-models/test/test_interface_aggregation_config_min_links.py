...
class TestInterfaceAggregationConfigMinLinks(unittest.TestCase):
    """InterfaceAggregationConfigMinLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationConfigMinLinks:
        """Test InterfaceAggregationConfigMinLinks
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationConfigMinLinks`
        """
        model = InterfaceAggregationConfigMinLinks()
        if include_optional:
            return InterfaceAggregationConfigMinLinks(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceAggregationConfigMinLinks(self):
        """Test InterfaceAggregationConfigMinLinks"""
