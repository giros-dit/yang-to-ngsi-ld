...
class TestInterfaceStateType(unittest.TestCase):
    """InterfaceStateType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateType:
        """Test InterfaceStateType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateType`
        """
        model = InterfaceStateType()
        if include_optional:
    ...
    def testInterfaceStateType(self):
        """Test InterfaceStateType"""
