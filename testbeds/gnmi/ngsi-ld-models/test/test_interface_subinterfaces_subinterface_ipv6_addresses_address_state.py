...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressState"""
