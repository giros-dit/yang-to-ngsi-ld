...
class TestInterfaceSubinterfacesSubinterfaceIndex(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIndex:
        """Test InterfaceSubinterfacesSubinterfaceIndex
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIndex`
        """
        model = InterfaceSubinterfacesSubinterfaceIndex()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIndex(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIndex(self):
        """Test InterfaceSubinterfacesSubinterfaceIndex"""
