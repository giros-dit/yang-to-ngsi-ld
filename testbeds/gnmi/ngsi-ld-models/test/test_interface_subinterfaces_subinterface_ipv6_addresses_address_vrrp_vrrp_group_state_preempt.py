...
class TestInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt:
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6AddressesAddressVrrpVrrpGroupStatePreempt"""
