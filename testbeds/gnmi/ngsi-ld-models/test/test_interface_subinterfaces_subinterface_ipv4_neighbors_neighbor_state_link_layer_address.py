...
class TestInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress:
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress(
                type = 'Property',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4NeighborsNeighborStateLinkLayerAddress"""
