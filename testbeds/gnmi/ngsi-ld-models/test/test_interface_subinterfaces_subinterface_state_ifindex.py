...
class TestInterfaceSubinterfacesSubinterfaceStateIfindex(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceStateIfindex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceStateIfindex:
        """Test InterfaceSubinterfacesSubinterfaceStateIfindex
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceStateIfindex`
        """
        model = InterfaceSubinterfacesSubinterfaceStateIfindex()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceStateIfindex(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceStateIfindex(self):
        """Test InterfaceSubinterfacesSubinterfaceStateIfindex"""
