...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress(
                type = 'Property',
                value = '',
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualAddress"""
