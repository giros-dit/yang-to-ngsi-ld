...
class TestInterfaceRoutedVlanIpv6StateCountersInForwardedPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv6StateCountersInForwardedPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6StateCountersInForwardedPkts:
        """Test InterfaceRoutedVlanIpv6StateCountersInForwardedPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6StateCountersInForwardedPkts`
        """
        model = InterfaceRoutedVlanIpv6StateCountersInForwardedPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv6StateCountersInForwardedPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv6StateCountersInForwardedPkts(self):
        """Test InterfaceRoutedVlanIpv6StateCountersInForwardedPkts"""
