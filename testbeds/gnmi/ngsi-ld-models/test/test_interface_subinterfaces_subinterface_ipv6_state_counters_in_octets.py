...
class TestInterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets:
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateCountersInOctets"""
