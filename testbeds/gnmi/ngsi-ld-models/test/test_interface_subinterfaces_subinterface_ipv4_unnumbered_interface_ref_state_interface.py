...
class TestInterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface:
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv4UnnumberedInterfaceRefStateInterface"""
