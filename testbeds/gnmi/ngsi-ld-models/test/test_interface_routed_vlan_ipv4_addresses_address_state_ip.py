...
class TestInterfaceRoutedVlanIpv4AddressesAddressStateIp(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressStateIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressStateIp:
        """Test InterfaceRoutedVlanIpv4AddressesAddressStateIp
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressStateIp`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressStateIp()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressStateIp(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressStateIp(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressStateIp"""
