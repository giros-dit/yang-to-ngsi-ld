...
class TestInterfaceRoutedVlanIpv6NeighborsNeighborState(unittest.TestCase):
    """InterfaceRoutedVlanIpv6NeighborsNeighborState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6NeighborsNeighborState:
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6NeighborsNeighborState`
        """
        model = InterfaceRoutedVlanIpv6NeighborsNeighborState()
        if include_optional:
            return InterfaceRoutedVlanIpv6NeighborsNeighborState(
                id = '',
                type = 'InterfaceRoutedVlanIpv6NeighborsNeighborState',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceRoutedVlanIpv6NeighborsNeighborState(self):
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborState"""
