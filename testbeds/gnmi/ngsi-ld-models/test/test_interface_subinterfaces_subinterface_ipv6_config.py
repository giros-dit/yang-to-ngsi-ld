...
class TestInterfaceSubinterfacesSubinterfaceIpv6Config(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6Config unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6Config:
        """Test InterfaceSubinterfacesSubinterfaceIpv6Config
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6Config`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6Config()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6Config(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv6Config',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6Config(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6Config"""
