...
class TestInterfaceAggregationConfig(unittest.TestCase):
    """InterfaceAggregationConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAggregationConfig:
        """Test InterfaceAggregationConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAggregationConfig`
        """
        model = InterfaceAggregationConfig()
        if include_optional:
            return InterfaceAggregationConfig(
                id = '',
    ...
    def testInterfaceAggregationConfig(self):
        """Test InterfaceAggregationConfig"""
