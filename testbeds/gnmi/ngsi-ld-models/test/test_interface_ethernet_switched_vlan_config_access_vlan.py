...
class TestInterfaceEthernetSwitchedVlanConfigAccessVlan(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanConfigAccessVlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanConfigAccessVlan:
        """Test InterfaceEthernetSwitchedVlanConfigAccessVlan
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanConfigAccessVlan`
        """
        model = InterfaceEthernetSwitchedVlanConfigAccessVlan()
        if include_optional:
            return InterfaceEthernetSwitchedVlanConfigAccessVlan(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetSwitchedVlanConfigAccessVlan(self):
        """Test InterfaceEthernetSwitchedVlanConfigAccessVlan"""
