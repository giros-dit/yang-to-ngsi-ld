...
class TestInterfaceStateCountersOutUnicastPkts(unittest.TestCase):
    """InterfaceStateCountersOutUnicastPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateCountersOutUnicastPkts:
        """Test InterfaceStateCountersOutUnicastPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateCountersOutUnicastPkts`
        """
        model = InterfaceStateCountersOutUnicastPkts()
        if include_optional:
            return InterfaceStateCountersOutUnicastPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStateCountersOutUnicastPkts(self):
        """Test InterfaceStateCountersOutUnicastPkts"""
