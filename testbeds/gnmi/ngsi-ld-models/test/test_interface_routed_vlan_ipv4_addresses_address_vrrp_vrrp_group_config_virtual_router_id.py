...
class TestInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId(unittest.TestCase):
    """InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId:
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId`
        """
        model = InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId()
        if include_optional:
            return InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId(self):
        """Test InterfaceRoutedVlanIpv4AddressesAddressVrrpVrrpGroupConfigVirtualRouterId"""
