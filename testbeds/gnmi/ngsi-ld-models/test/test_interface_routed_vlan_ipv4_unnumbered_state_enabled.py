...
class TestInterfaceRoutedVlanIpv4UnnumberedStateEnabled(unittest.TestCase):
    """InterfaceRoutedVlanIpv4UnnumberedStateEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4UnnumberedStateEnabled:
        """Test InterfaceRoutedVlanIpv4UnnumberedStateEnabled
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4UnnumberedStateEnabled`
        """
        model = InterfaceRoutedVlanIpv4UnnumberedStateEnabled()
        if include_optional:
            return InterfaceRoutedVlanIpv4UnnumberedStateEnabled(
                type = 'Property',
                value = True,
    ...
    def testInterfaceRoutedVlanIpv4UnnumberedStateEnabled(self):
        """Test InterfaceRoutedVlanIpv4UnnumberedStateEnabled"""
