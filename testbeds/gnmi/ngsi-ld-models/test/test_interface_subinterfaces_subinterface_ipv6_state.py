...
class TestInterfaceSubinterfacesSubinterfaceIpv6State(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6State unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6State:
        """Test InterfaceSubinterfacesSubinterfaceIpv6State
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6State`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6State()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6State(
                id = '',
                type = 'InterfaceSubinterfacesSubinterfaceIpv6State',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6State(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6State"""
