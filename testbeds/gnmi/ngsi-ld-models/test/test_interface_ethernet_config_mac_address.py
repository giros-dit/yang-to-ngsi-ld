...
class TestInterfaceEthernetConfigMacAddress(unittest.TestCase):
    """InterfaceEthernetConfigMacAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetConfigMacAddress:
        """Test InterfaceEthernetConfigMacAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetConfigMacAddress`
        """
        model = InterfaceEthernetConfigMacAddress()
        if include_optional:
            return InterfaceEthernetConfigMacAddress(
                type = 'Property',
    ...
    def testInterfaceEthernetConfigMacAddress(self):
        """Test InterfaceEthernetConfigMacAddress"""
