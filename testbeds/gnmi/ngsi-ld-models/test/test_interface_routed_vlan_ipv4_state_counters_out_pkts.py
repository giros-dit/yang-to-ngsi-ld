...
class TestInterfaceRoutedVlanIpv4StateCountersOutPkts(unittest.TestCase):
    """InterfaceRoutedVlanIpv4StateCountersOutPkts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv4StateCountersOutPkts:
        """Test InterfaceRoutedVlanIpv4StateCountersOutPkts
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv4StateCountersOutPkts`
        """
        model = InterfaceRoutedVlanIpv4StateCountersOutPkts()
        if include_optional:
            return InterfaceRoutedVlanIpv4StateCountersOutPkts(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceRoutedVlanIpv4StateCountersOutPkts(self):
        """Test InterfaceRoutedVlanIpv4StateCountersOutPkts"""
