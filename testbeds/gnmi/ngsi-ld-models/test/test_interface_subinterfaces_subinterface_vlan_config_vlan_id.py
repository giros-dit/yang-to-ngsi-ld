...
class TestInterfaceSubinterfacesSubinterfaceVlanConfigVlanId(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceVlanConfigVlanId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceVlanConfigVlanId:
        """Test InterfaceSubinterfacesSubinterfaceVlanConfigVlanId
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceVlanConfigVlanId`
        """
        model = InterfaceSubinterfacesSubinterfaceVlanConfigVlanId()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceVlanConfigVlanId(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfacesSubinterfaceVlanConfigVlanId(self):
        """Test InterfaceSubinterfacesSubinterfaceVlanConfigVlanId"""
