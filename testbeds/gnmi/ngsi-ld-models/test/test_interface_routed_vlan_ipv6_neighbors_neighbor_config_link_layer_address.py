...
class TestInterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress(unittest.TestCase):
    """InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress:
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress`
        """
        model = InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress()
        if include_optional:
            return InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress(
                type = 'Property',
    ...
    def testInterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress(self):
        """Test InterfaceRoutedVlanIpv6NeighborsNeighborConfigLinkLayerAddress"""
