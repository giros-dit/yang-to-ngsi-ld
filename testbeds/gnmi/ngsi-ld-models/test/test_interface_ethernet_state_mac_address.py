...
class TestInterfaceEthernetStateMacAddress(unittest.TestCase):
    """InterfaceEthernetStateMacAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStateMacAddress:
        """Test InterfaceEthernetStateMacAddress
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStateMacAddress`
        """
        model = InterfaceEthernetStateMacAddress()
        if include_optional:
            return InterfaceEthernetStateMacAddress(
                type = 'Property',
    ...
    def testInterfaceEthernetStateMacAddress(self):
        """Test InterfaceEthernetStateMacAddress"""
