...
class TestInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState:
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState(
                type = 'Property',
                value = 'INCOMPLETE',
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6NeighborsNeighborStateNeighborState"""
