...
class TestInterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets(unittest.TestCase):
    """InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets:
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets`
        """
        model = InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets()
        if include_optional:
            return InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets(self):
        """Test InterfaceSubinterfacesSubinterfaceIpv6StateCountersOutOctets"""
