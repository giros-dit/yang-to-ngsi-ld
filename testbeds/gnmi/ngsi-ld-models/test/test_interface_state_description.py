...
class TestInterfaceStateDescription(unittest.TestCase):
    """InterfaceStateDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStateDescription:
        """Test InterfaceStateDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStateDescription`
        """
        model = InterfaceStateDescription()
        if include_optional:
            return InterfaceStateDescription(
                type = 'Property',
                value = '',
    ...
    def testInterfaceStateDescription(self):
        """Test InterfaceStateDescription"""
