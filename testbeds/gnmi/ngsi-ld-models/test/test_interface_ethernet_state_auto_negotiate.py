...
class TestInterfaceEthernetStateAutoNegotiate(unittest.TestCase):
    """InterfaceEthernetStateAutoNegotiate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStateAutoNegotiate:
        """Test InterfaceEthernetStateAutoNegotiate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStateAutoNegotiate`
        """
        model = InterfaceEthernetStateAutoNegotiate()
        if include_optional:
            return InterfaceEthernetStateAutoNegotiate(
                type = 'Property',
                value = True,
    ...
    def testInterfaceEthernetStateAutoNegotiate(self):
        """Test InterfaceEthernetStateAutoNegotiate"""
