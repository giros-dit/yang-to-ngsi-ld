...
class TestInterfaceEthernetSwitchedVlanConfigInterfaceMode(unittest.TestCase):
    """InterfaceEthernetSwitchedVlanConfigInterfaceMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSwitchedVlanConfigInterfaceMode:
        """Test InterfaceEthernetSwitchedVlanConfigInterfaceMode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSwitchedVlanConfigInterfaceMode`
        """
        model = InterfaceEthernetSwitchedVlanConfigInterfaceMode()
        if include_optional:
            return InterfaceEthernetSwitchedVlanConfigInterfaceMode(
                type = 'Property',
                value = 'ACCESS',
    ...
    def testInterfaceEthernetSwitchedVlanConfigInterfaceMode(self):
        """Test InterfaceEthernetSwitchedVlanConfigInterfaceMode"""
