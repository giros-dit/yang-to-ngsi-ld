...
class TestInterfaceConfigDescription(unittest.TestCase):
    """InterfaceConfigDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceConfigDescription:
        """Test InterfaceConfigDescription
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceConfigDescription`
        """
        model = InterfaceConfigDescription()
        if include_optional:
            return InterfaceConfigDescription(
                type = 'Property',
                value = '',
    ...
    def testInterfaceConfigDescription(self):
        """Test InterfaceConfigDescription"""
