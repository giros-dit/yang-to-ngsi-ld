...
class TestLinkLsa(unittest.TestCase):
    """LinkLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkLsa:
        """Test LinkLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkLsa`
        """
        model = LinkLsa()
        if include_optional:
            return LinkLsa(
