...
class TestNetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface:
        """Test NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface`
        """
        model = NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface()
        if include_optional:
            return NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface(self):
        """Test NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface"""
