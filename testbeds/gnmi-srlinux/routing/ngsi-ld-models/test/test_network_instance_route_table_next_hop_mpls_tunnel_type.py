...
class TestNetworkInstanceRouteTableNextHopMplsTunnelType(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopMplsTunnelType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopMplsTunnelType:
        """Test NetworkInstanceRouteTableNextHopMplsTunnelType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopMplsTunnelType`
        """
        model = NetworkInstanceRouteTableNextHopMplsTunnelType()
        if include_optional:
            return NetworkInstanceRouteTableNextHopMplsTunnelType(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopMplsTunnelType(self):
        """Test NetworkInstanceRouteTableNextHopMplsTunnelType"""
