...
class TestLinecardMdaTemperatureInstant(unittest.TestCase):
    """LinecardMdaTemperatureInstant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaTemperatureInstant:
        """Test LinecardMdaTemperatureInstant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaTemperatureInstant`
        """
        model = LinecardMdaTemperatureInstant()
        if include_optional:
            return LinecardMdaTemperatureInstant(
                type = 'Property',
                value = 56,
    ...
    def testLinecardMdaTemperatureInstant(self):
        """Test LinecardMdaTemperatureInstant"""
