...
class TestInterfaceSubinterfaceStatisticsOutPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsOutPackets:
        """Test InterfaceSubinterfaceStatisticsOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsOutPackets`
        """
        model = InterfaceSubinterfaceStatisticsOutPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsOutPackets(self):
        """Test InterfaceSubinterfaceStatisticsOutPackets"""
