...
class TestInterfaceStatisticsOutDiscardedPackets(unittest.TestCase):
    """InterfaceStatisticsOutDiscardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsOutDiscardedPackets:
        """Test InterfaceStatisticsOutDiscardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsOutDiscardedPackets`
        """
        model = InterfaceStatisticsOutDiscardedPackets()
        if include_optional:
            return InterfaceStatisticsOutDiscardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStatisticsOutDiscardedPackets(self):
        """Test InterfaceStatisticsOutDiscardedPackets"""
