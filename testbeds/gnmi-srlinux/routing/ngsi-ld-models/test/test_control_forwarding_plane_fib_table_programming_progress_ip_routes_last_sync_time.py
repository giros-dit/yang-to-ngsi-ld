...
class TestControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime:
        """Test ControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime(
                type = 'Property',
                value = '',
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressIpRoutesLastSyncTime"""
