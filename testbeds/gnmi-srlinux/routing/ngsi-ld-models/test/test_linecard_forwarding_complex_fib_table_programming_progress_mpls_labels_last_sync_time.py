...
class TestLinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime:
        """Test LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsLastSyncTime"""
