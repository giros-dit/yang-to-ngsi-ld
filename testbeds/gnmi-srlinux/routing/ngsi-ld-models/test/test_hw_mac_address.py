...
class TestHwMacAddress(unittest.TestCase):
    """HwMacAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HwMacAddress:
        """Test HwMacAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HwMacAddress`
        """
        model = HwMacAddress()
        if include_optional:
            return HwMacAddress(
