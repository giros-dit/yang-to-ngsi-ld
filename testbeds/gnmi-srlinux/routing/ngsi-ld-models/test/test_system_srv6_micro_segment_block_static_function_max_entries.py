...
class TestSystemSrv6MicroSegmentBlockStaticFunctionMaxEntries(unittest.TestCase):
    """SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries:
        """Test SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries`
        """
        model = SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries()
        if include_optional:
            return SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries(
                type = 'Property',
                value = 1,
    ...
    def testSystemSrv6MicroSegmentBlockStaticFunctionMaxEntries(self):
        """Test SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries"""
