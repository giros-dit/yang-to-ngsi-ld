...
class TestSystemLldpStatisticsLastClear(unittest.TestCase):
    """SystemLldpStatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpStatisticsLastClear:
        """Test SystemLldpStatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpStatisticsLastClear`
        """
        model = SystemLldpStatisticsLastClear()
        if include_optional:
            return SystemLldpStatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpStatisticsLastClear(self):
        """Test SystemLldpStatisticsLastClear"""
