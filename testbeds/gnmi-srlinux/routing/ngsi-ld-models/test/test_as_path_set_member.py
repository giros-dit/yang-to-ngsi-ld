...
class TestAsPathSetMember(unittest.TestCase):
    """AsPathSetMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsPathSetMember:
        """Test AsPathSetMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsPathSetMember`
        """
        model = AsPathSetMember()
        if include_optional:
            return AsPathSetMember(
                type = 'Property',
                value = '. 8[9',
