...
class TestNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement:
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement`
        """
        model = NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement(self):
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAdvertisement"""
