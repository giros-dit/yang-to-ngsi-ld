...
class TestSystemLldpLldpMedNetworkPolicyName(unittest.TestCase):
    """SystemLldpLldpMedNetworkPolicyName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpLldpMedNetworkPolicyName:
        """Test SystemLldpLldpMedNetworkPolicyName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpLldpMedNetworkPolicyName`
        """
        model = SystemLldpLldpMedNetworkPolicyName()
        if include_optional:
            return SystemLldpLldpMedNetworkPolicyName(
                type = 'Property',
                value = ';s_~N0FL=Jb3 Z%6lbjFq7ecV`Cwc',
    ...
    def testSystemLldpLldpMedNetworkPolicyName(self):
        """Test SystemLldpLldpMedNetworkPolicyName"""
