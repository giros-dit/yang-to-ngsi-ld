...
class TestInterfaceAdapterVendorPartNumber(unittest.TestCase):
    """InterfaceAdapterVendorPartNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAdapterVendorPartNumber:
        """Test InterfaceAdapterVendorPartNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAdapterVendorPartNumber`
        """
        model = InterfaceAdapterVendorPartNumber()
        if include_optional:
            return InterfaceAdapterVendorPartNumber(
                type = 'Property',
                value = '',
    ...
    def testInterfaceAdapterVendorPartNumber(self):
        """Test InterfaceAdapterVendorPartNumber"""
