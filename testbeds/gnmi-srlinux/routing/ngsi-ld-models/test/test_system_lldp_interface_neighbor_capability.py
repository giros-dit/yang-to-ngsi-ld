...
class TestSystemLldpInterfaceNeighborCapability(unittest.TestCase):
    """SystemLldpInterfaceNeighborCapability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborCapability:
        """Test SystemLldpInterfaceNeighborCapability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborCapability`
        """
        model = SystemLldpInterfaceNeighborCapability()
        if include_optional:
            return SystemLldpInterfaceNeighborCapability(
                id = '',
                type = 'SystemLldpInterfaceNeighborCapability',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceNeighborCapability(self):
        """Test SystemLldpInterfaceNeighborCapability"""
