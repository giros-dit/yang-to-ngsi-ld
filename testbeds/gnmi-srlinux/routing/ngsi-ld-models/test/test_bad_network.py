...
class TestBadNetwork(unittest.TestCase):
    """BadNetwork unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadNetwork:
        """Test BadNetwork
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadNetwork`
        """
        model = BadNetwork()
        if include_optional:
            return BadNetwork(
