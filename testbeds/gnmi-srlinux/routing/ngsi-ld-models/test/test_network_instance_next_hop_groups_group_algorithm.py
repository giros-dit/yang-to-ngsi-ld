...
class TestNetworkInstanceNextHopGroupsGroupAlgorithm(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupAlgorithm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupAlgorithm:
        """Test NetworkInstanceNextHopGroupsGroupAlgorithm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupAlgorithm`
        """
        model = NetworkInstanceNextHopGroupsGroupAlgorithm()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupAlgorithm(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupAlgorithm(self):
        """Test NetworkInstanceNextHopGroupsGroupAlgorithm"""
