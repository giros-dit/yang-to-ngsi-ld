...
class TestSystemLldpInterfaceNeighbor(unittest.TestCase):
    """SystemLldpInterfaceNeighbor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighbor:
        """Test SystemLldpInterfaceNeighbor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighbor`
        """
        model = SystemLldpInterfaceNeighbor()
        if include_optional:
            return SystemLldpInterfaceNeighbor(
                id = None,
                type = 'SystemLldpInterfaceNeighbor',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceNeighbor(self):
        """Test SystemLldpInterfaceNeighbor"""
