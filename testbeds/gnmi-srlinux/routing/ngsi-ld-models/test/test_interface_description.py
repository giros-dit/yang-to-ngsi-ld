...
class TestInterfaceDescription(unittest.TestCase):
    """InterfaceDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceDescription:
        """Test InterfaceDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceDescription`
        """
    ...
    def testInterfaceDescription(self):
        """Test InterfaceDescription"""
