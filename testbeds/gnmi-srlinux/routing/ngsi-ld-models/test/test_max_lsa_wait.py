...
class TestMaxLsaWait(unittest.TestCase):
    """MaxLsaWait unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxLsaWait:
        """Test MaxLsaWait
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxLsaWait`
        """
        model = MaxLsaWait()
        if include_optional:
            return MaxLsaWait(
