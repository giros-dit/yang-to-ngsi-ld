...
class TestMedFastTransmitInterval(unittest.TestCase):
    """MedFastTransmitInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedFastTransmitInterval:
        """Test MedFastTransmitInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedFastTransmitInterval`
        """
        model = MedFastTransmitInterval()
        if include_optional:
            return MedFastTransmitInterval(
                type = 'Property',
                value = 1,
    ...
    def testMedFastTransmitInterval(self):
        """Test MedFastTransmitInterval"""
