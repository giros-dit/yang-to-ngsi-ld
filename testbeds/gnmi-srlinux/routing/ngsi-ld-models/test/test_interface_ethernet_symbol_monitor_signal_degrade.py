...
class TestInterfaceEthernetSymbolMonitorSignalDegrade(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorSignalDegrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorSignalDegrade:
        """Test InterfaceEthernetSymbolMonitorSignalDegrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorSignalDegrade`
        """
        model = InterfaceEthernetSymbolMonitorSignalDegrade()
        if include_optional:
            return InterfaceEthernetSymbolMonitorSignalDegrade(
                id = '',
                type = 'InterfaceEthernetSymbolMonitorSignalDegrade',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetSymbolMonitorSignalDegrade(self):
        """Test InterfaceEthernetSymbolMonitorSignalDegrade"""
