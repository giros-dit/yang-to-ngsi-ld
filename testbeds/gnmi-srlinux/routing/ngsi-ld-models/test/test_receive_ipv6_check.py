...
class TestReceiveIpv6Check(unittest.TestCase):
    """ReceiveIpv6Check unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReceiveIpv6Check:
        """Test ReceiveIpv6Check
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReceiveIpv6Check`
        """
        model = ReceiveIpv6Check()
        if include_optional:
            return ReceiveIpv6Check(
                type = 'Property',
                value = True,
