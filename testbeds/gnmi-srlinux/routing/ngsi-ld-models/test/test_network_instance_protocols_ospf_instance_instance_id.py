...
class TestNetworkInstanceProtocolsOspfInstanceInstanceId(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceInstanceId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceInstanceId:
        """Test NetworkInstanceProtocolsOspfInstanceInstanceId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceInstanceId`
        """
        model = NetworkInstanceProtocolsOspfInstanceInstanceId()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceInstanceId(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceProtocolsOspfInstanceInstanceId(self):
        """Test NetworkInstanceProtocolsOspfInstanceInstanceId"""
