...
class TestGroupNameAlias(unittest.TestCase):
    """GroupNameAlias unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupNameAlias:
        """Test GroupNameAlias
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupNameAlias`
        """
        model = GroupNameAlias()
        if include_optional:
