...
class TestYANGIdentity(unittest.TestCase):
    """YANGIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YANGIdentity:
        """Test YANGIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YANGIdentity`
        """
        model = YANGIdentity()
        if include_optional:
            return YANGIdentity(
