...
class TestInterfaceSubinterfaceIpv4StatisticsInPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInPackets"""
