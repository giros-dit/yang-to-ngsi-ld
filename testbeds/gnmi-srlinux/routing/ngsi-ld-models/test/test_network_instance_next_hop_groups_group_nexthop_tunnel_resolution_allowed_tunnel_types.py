...
class TestNetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes:
        """Test NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes"""
