...
class TestNetworkInstanceTrafficEngineeringAdminGroupsGroup(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringAdminGroupsGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringAdminGroupsGroup:
        """Test NetworkInstanceTrafficEngineeringAdminGroupsGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringAdminGroupsGroup`
        """
        model = NetworkInstanceTrafficEngineeringAdminGroupsGroup()
        if include_optional:
            return NetworkInstanceTrafficEngineeringAdminGroupsGroup(
                id = '',
    ...
    def testNetworkInstanceTrafficEngineeringAdminGroupsGroup(self):
        """Test NetworkInstanceTrafficEngineeringAdminGroupsGroup"""
