...
class TestPolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp(unittest.TestCase):
    """PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp:
        """Test PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp`
        """
        model = PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp()
        if include_optional:
            return PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp(
                type = 'Property',
                value = True,
    ...
    def testPolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp(self):
        """Test PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp"""
