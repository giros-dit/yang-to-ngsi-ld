...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType(
                type = 'Property',
                value = 'all',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType"""
