...
class TestFlowLabelOperState(unittest.TestCase):
    """FlowLabelOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowLabelOperState:
        """Test FlowLabelOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowLabelOperState`
        """
        model = FlowLabelOperState()
        if include_optional:
            return FlowLabelOperState(
                type = 'Property',
                value = 'up',
    ...
    def testFlowLabelOperState(self):
        """Test FlowLabelOperState"""
