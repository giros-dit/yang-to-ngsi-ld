...
class TestNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedOperationType"""
