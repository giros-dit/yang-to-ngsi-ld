...
class TestInterfaceSubinterfaceIpv4StatisticsLastClear(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsLastClear:
        """Test InterfaceSubinterfaceIpv4StatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsLastClear`
        """
        model = InterfaceSubinterfaceIpv4StatisticsLastClear()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceIpv4StatisticsLastClear(self):
        """Test InterfaceSubinterfaceIpv4StatisticsLastClear"""
