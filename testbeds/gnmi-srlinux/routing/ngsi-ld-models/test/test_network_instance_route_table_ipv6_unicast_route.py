...
class TestNetworkInstanceRouteTableIpv6UnicastRoute(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRoute:
        """Test NetworkInstanceRouteTableIpv6UnicastRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRoute`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRoute()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRoute(
                id = None,
                type = 'NetworkInstanceRouteTableIpv6UnicastRoute',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                route_type = None,
                route_owner = None,
                origin_network_instance = None,
                leakable = None,
                target_network_instances = None,
                metric = None,
                preference = None,
                active = None,
                last_app_update = None,
                next_hop_group = None,
                next_hop_group_network_instance = None,
                gribi_metadata = None,
                resilient_hash = None,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRoute(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRoute"""
