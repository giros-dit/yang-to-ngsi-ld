...
class TestPolicyDefaultActionIsisLevel(unittest.TestCase):
    """PolicyDefaultActionIsisLevel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionIsisLevel:
        """Test PolicyDefaultActionIsisLevel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionIsisLevel`
        """
        model = PolicyDefaultActionIsisLevel()
        if include_optional:
            return PolicyDefaultActionIsisLevel(
                type = 'Property',
                value = 56,
    ...
    def testPolicyDefaultActionIsisLevel(self):
        """Test PolicyDefaultActionIsisLevel"""
