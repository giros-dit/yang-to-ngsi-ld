...
class TestPolicyStatementActionIsisMetricSetStyle(unittest.TestCase):
    """PolicyStatementActionIsisMetricSetStyle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionIsisMetricSetStyle:
        """Test PolicyStatementActionIsisMetricSetStyle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionIsisMetricSetStyle`
        """
        model = PolicyStatementActionIsisMetricSetStyle()
        if include_optional:
            return PolicyStatementActionIsisMetricSetStyle(
                type = 'Property',
                value = 'wide',
    ...
    def testPolicyStatementActionIsisMetricSetStyle(self):
        """Test PolicyStatementActionIsisMetricSetStyle"""
