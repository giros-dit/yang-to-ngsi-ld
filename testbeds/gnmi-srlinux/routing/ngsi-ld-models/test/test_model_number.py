...
class TestModelNumber(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ModelNumber:
        """Test ModelNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelNumber`
        """
        model = ModelNumber()
        if include_optional:
            return ModelNumber(
