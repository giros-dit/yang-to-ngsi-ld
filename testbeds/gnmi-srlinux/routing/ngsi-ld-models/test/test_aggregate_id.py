...
class TestAggregateId(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AggregateId:
        """Test AggregateId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AggregateId`
        """
        model = AggregateId()
        if include_optional:
            return AggregateId(
