...
class TestInterfaceMtu(unittest.TestCase):
    """InterfaceMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceMtu:
        """Test InterfaceMtu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceMtu`
        """
        model = InterfaceMtu()
        if include_optional:
            return InterfaceMtu(
