...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix"""
