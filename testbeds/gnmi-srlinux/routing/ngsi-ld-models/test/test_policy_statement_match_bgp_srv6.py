...
class TestPolicyStatementMatchBgpSrv6(unittest.TestCase):
    """PolicyStatementMatchBgpSrv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpSrv6:
        """Test PolicyStatementMatchBgpSrv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpSrv6`
        """
        model = PolicyStatementMatchBgpSrv6()
        if include_optional:
            return PolicyStatementMatchBgpSrv6(
                id = '',
                type = 'PolicyStatementMatchBgpSrv6',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchBgpSrv6(self):
        """Test PolicyStatementMatchBgpSrv6"""
