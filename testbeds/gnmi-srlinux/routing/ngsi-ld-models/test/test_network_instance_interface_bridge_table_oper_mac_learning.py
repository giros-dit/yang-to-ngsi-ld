...
class TestNetworkInstanceInterfaceBridgeTableOperMacLearning(unittest.TestCase):
    """NetworkInstanceInterfaceBridgeTableOperMacLearning unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceBridgeTableOperMacLearning:
        """Test NetworkInstanceInterfaceBridgeTableOperMacLearning
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceBridgeTableOperMacLearning`
        """
        model = NetworkInstanceInterfaceBridgeTableOperMacLearning()
        if include_optional:
            return NetworkInstanceInterfaceBridgeTableOperMacLearning(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceInterfaceBridgeTableOperMacLearning(self):
        """Test NetworkInstanceInterfaceBridgeTableOperMacLearning"""
