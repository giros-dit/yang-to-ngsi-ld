...
class TestControlLastSwitchoverReason(unittest.TestCase):
    """ControlLastSwitchoverReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlLastSwitchoverReason:
        """Test ControlLastSwitchoverReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlLastSwitchoverReason`
        """
        model = ControlLastSwitchoverReason()
        if include_optional:
            return ControlLastSwitchoverReason(
                id = '',
                type = 'ControlLastSwitchoverReason',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testControlLastSwitchoverReason(self):
        """Test ControlLastSwitchoverReason"""
