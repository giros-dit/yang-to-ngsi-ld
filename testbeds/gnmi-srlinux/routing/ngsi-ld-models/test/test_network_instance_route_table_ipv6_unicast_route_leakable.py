...
class TestNetworkInstanceRouteTableIpv6UnicastRouteLeakable(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteLeakable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteLeakable:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteLeakable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteLeakable`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteLeakable()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteLeakable(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteLeakable(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteLeakable"""
