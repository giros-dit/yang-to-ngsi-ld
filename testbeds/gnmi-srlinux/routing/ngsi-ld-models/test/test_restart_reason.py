...
class TestRestartReason(unittest.TestCase):
    """RestartReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestartReason:
        """Test RestartReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestartReason`
        """
        model = RestartReason()
        if include_optional:
