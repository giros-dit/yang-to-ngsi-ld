...
class TestPolicyStatementMatchOspf(unittest.TestCase):
    """PolicyStatementMatchOspf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchOspf:
        """Test PolicyStatementMatchOspf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchOspf`
        """
        model = PolicyStatementMatchOspf()
        if include_optional:
            return PolicyStatementMatchOspf(
                id = '',
                type = 'PolicyStatementMatchOspf',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchOspf(self):
        """Test PolicyStatementMatchOspf"""
