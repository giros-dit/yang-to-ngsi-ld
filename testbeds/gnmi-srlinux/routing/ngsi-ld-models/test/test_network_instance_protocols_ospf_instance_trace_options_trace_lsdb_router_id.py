...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId"""
