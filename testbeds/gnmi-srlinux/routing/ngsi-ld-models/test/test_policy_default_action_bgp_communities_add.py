...
class TestPolicyDefaultActionBgpCommunitiesAdd(unittest.TestCase):
    """PolicyDefaultActionBgpCommunitiesAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpCommunitiesAdd:
        """Test PolicyDefaultActionBgpCommunitiesAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpCommunitiesAdd`
        """
        model = PolicyDefaultActionBgpCommunitiesAdd()
        if include_optional:
            return PolicyDefaultActionBgpCommunitiesAdd(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyDefaultActionBgpCommunitiesAdd(self):
        """Test PolicyDefaultActionBgpCommunitiesAdd"""
