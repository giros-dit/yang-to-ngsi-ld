...
class TestNeighborCount(unittest.TestCase):
    """NeighborCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NeighborCount:
        """Test NeighborCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NeighborCount`
        """
        model = NeighborCount()
        if include_optional:
