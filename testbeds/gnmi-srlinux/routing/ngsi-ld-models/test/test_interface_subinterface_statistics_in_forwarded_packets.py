...
class TestInterfaceSubinterfaceStatisticsInForwardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInForwardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInForwardedPackets:
        """Test InterfaceSubinterfaceStatisticsInForwardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInForwardedPackets`
        """
        model = InterfaceSubinterfaceStatisticsInForwardedPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInForwardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInForwardedPackets(self):
        """Test InterfaceSubinterfaceStatisticsInForwardedPackets"""
