...
class TestInMacPauseFrames(unittest.TestCase):
    """InMacPauseFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InMacPauseFrames:
        """Test InMacPauseFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InMacPauseFrames`
        """
        model = InMacPauseFrames()
        if include_optional:
            return InMacPauseFrames(
                type = 'Property',
                value = 56,
