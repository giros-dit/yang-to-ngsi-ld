...
class TestNetworkInstanceProtocolsOspfInstanceAreaExportPolicy(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaExportPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaExportPolicy:
        """Test NetworkInstanceProtocolsOspfInstanceAreaExportPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaExportPolicy`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaExportPolicy()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaExportPolicy(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaExportPolicy(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaExportPolicy"""
