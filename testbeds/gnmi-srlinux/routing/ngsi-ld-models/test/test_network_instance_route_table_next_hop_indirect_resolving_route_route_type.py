...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType"""
