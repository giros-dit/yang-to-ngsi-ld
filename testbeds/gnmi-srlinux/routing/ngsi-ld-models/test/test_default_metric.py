...
class TestDefaultMetric(unittest.TestCase):
    """DefaultMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultMetric:
        """Test DefaultMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultMetric`
        """
        model = DefaultMetric()
        if include_optional:
