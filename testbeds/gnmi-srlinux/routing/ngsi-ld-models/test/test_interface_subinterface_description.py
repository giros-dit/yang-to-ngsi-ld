...
class TestInterfaceSubinterfaceDescription(unittest.TestCase):
    """InterfaceSubinterfaceDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceDescription:
        """Test InterfaceSubinterfaceDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceDescription`
        """
        model = InterfaceSubinterfaceDescription()
        if include_optional:
            return InterfaceSubinterfaceDescription(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceDescription(self):
        """Test InterfaceSubinterfaceDescription"""
