...
class TestNetworkInstanceConnectionPointBridgeTableMacLearningAdminState(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacLearningAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacLearningAdminState:
        """Test NetworkInstanceConnectionPointBridgeTableMacLearningAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacLearningAdminState`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacLearningAdminState()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacLearningAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacLearningAdminState(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacLearningAdminState"""
