...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthentication"""
