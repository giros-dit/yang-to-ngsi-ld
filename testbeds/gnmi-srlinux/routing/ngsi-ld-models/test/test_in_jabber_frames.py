...
class TestInJabberFrames(unittest.TestCase):
    """InJabberFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InJabberFrames:
        """Test InJabberFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InJabberFrames`
        """
        model = InJabberFrames()
        if include_optional:
