...
class TestSystemLldpInterfaceOperState(unittest.TestCase):
    """SystemLldpInterfaceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceOperState:
        """Test SystemLldpInterfaceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceOperState`
        """
        model = SystemLldpInterfaceOperState()
        if include_optional:
            return SystemLldpInterfaceOperState(
                type = 'Property',
                value = 'up',
    ...
    def testSystemLldpInterfaceOperState(self):
        """Test SystemLldpInterfaceOperState"""
