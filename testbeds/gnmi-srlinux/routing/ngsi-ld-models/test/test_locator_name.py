...
class TestLocatorName(unittest.TestCase):
    """LocatorName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocatorName:
        """Test LocatorName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocatorName`
        """
        model = LocatorName()
        if include_optional:
            return LocatorName(
