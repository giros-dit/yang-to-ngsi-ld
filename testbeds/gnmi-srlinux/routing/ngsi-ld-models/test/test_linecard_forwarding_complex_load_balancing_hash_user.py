...
class TestLinecardForwardingComplexLoadBalancingHashUser(unittest.TestCase):
    """LinecardForwardingComplexLoadBalancingHashUser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexLoadBalancingHashUser:
        """Test LinecardForwardingComplexLoadBalancingHashUser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexLoadBalancingHashUser`
        """
        model = LinecardForwardingComplexLoadBalancingHashUser()
        if include_optional:
            return LinecardForwardingComplexLoadBalancingHashUser(
                id = '',
                type = 'LinecardForwardingComplexLoadBalancingHashUser',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexLoadBalancingHashUser(self):
        """Test LinecardForwardingComplexLoadBalancingHashUser"""
