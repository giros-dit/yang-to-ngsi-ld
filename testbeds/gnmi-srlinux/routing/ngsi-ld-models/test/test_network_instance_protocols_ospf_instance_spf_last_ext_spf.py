...
class TestNetworkInstanceProtocolsOspfInstanceSpfLastExtSpf(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf:
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf`
        """
        model = NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceProtocolsOspfInstanceSpfLastExtSpf(self):
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf"""
