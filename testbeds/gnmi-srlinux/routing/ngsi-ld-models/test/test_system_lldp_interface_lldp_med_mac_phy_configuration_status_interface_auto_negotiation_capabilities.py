...
class TestSystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities(unittest.TestCase):
    """SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities:
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities`
        """
        model = SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities()
        if include_optional:
            return SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities(
                type = 'Property',
                value = 'other',
    ...
    def testSystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities(self):
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities"""
