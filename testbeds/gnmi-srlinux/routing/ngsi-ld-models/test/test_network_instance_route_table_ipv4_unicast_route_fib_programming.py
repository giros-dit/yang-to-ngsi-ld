...
class TestNetworkInstanceRouteTableIpv4UnicastRouteFibProgramming(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteFibProgramming unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteFibProgramming:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgramming
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteFibProgramming`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteFibProgramming()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteFibProgramming(
                id = '',
                type = 'NetworkInstanceRouteTableIpv4UnicastRouteFibProgramming',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteFibProgramming(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgramming"""
