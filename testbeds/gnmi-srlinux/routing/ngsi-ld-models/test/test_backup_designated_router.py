...
class TestBackupDesignatedRouter(unittest.TestCase):
    """BackupDesignatedRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackupDesignatedRouter:
        """Test BackupDesignatedRouter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackupDesignatedRouter`
        """
        model = BackupDesignatedRouter()
        if include_optional:
    ...
    def testBackupDesignatedRouter(self):
        """Test BackupDesignatedRouter"""
