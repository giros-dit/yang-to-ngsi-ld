...
class TestInterfaceEthernetSymbolMonitorWindowSize(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorWindowSize unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorWindowSize:
        """Test InterfaceEthernetSymbolMonitorWindowSize
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorWindowSize`
        """
        model = InterfaceEthernetSymbolMonitorWindowSize()
        if include_optional:
            return InterfaceEthernetSymbolMonitorWindowSize(
                type = 'Property',
                value = 5,
    ...
    def testInterfaceEthernetSymbolMonitorWindowSize(self):
        """Test InterfaceEthernetSymbolMonitorWindowSize"""
