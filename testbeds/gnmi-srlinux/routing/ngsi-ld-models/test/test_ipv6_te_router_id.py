...
class TestIpv6TeRouterId(unittest.TestCase):
    """Ipv6TeRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ipv6TeRouterId:
        """Test Ipv6TeRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ipv6TeRouterId`
        """
        model = Ipv6TeRouterId()
        if include_optional:
            return Ipv6TeRouterId(
                type = 'Property',
                value = None,
