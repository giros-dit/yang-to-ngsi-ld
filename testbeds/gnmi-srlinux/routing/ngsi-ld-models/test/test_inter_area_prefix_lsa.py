...
class TestInterAreaPrefixLsa(unittest.TestCase):
    """InterAreaPrefixLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterAreaPrefixLsa:
        """Test InterAreaPrefixLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterAreaPrefixLsa`
        """
        model = InterAreaPrefixLsa()
        if include_optional:
    ...
    def testInterAreaPrefixLsa(self):
        """Test InterAreaPrefixLsa"""
