...
class TestSystemAuthenticationKeychainAdminState(unittest.TestCase):
    """SystemAuthenticationKeychainAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainAdminState:
        """Test SystemAuthenticationKeychainAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainAdminState`
        """
        model = SystemAuthenticationKeychainAdminState()
        if include_optional:
            return SystemAuthenticationKeychainAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testSystemAuthenticationKeychainAdminState(self):
        """Test SystemAuthenticationKeychainAdminState"""
