...
class TestNetworkInstanceProtocolsOspfInstanceOverload(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceOverload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceOverload:
        """Test NetworkInstanceProtocolsOspfInstanceOverload
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceOverload`
        """
        model = NetworkInstanceProtocolsOspfInstanceOverload()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceOverload(
                id = '',
                ...
                active = None,
                overload_include_ext1 = None,
                overload_include_ext2 = None,
                overload_include_stub = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceOverload(
    ...
    def testNetworkInstanceProtocolsOspfInstanceOverload(self):
        """Test NetworkInstanceProtocolsOspfInstanceOverload"""
