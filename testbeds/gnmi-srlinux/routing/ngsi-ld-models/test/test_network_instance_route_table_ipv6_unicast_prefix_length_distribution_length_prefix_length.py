...
class TestNetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength:
        """Test NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength`
        """
        model = NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength(self):
        """Test NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength"""
