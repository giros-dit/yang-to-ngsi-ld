...
class TestPolicyStatementActionBgpSrv6(unittest.TestCase):
    """PolicyStatementActionBgpSrv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpSrv6:
        """Test PolicyStatementActionBgpSrv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpSrv6`
        """
        model = PolicyStatementActionBgpSrv6()
        if include_optional:
            return PolicyStatementActionBgpSrv6(
                id = '',
                type = 'PolicyStatementActionBgpSrv6',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpSrv6(self):
        """Test PolicyStatementActionBgpSrv6"""
