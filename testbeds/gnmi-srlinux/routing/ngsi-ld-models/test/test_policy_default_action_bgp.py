...
class TestPolicyDefaultActionBgp(unittest.TestCase):
    """PolicyDefaultActionBgp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgp:
        """Test PolicyDefaultActionBgp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgp`
        """
        model = PolicyDefaultActionBgp()
        if include_optional:
            return PolicyDefaultActionBgp(
                id = '',
                type = 'PolicyDefaultActionBgp',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgp(self):
        """Test PolicyDefaultActionBgp"""
