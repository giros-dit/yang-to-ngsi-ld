...
class TestBadAuthType(unittest.TestCase):
    """BadAuthType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadAuthType:
        """Test BadAuthType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadAuthType`
        """
        model = BadAuthType()
        if include_optional:
            return BadAuthType(
