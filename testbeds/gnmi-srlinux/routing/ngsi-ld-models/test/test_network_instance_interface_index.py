...
class TestNetworkInstanceInterfaceIndex(unittest.TestCase):
    """NetworkInstanceInterfaceIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceIndex:
        """Test NetworkInstanceInterfaceIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceIndex`
        """
        model = NetworkInstanceInterfaceIndex()
        if include_optional:
            return NetworkInstanceInterfaceIndex(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceInterfaceIndex(self):
        """Test NetworkInstanceInterfaceIndex"""
