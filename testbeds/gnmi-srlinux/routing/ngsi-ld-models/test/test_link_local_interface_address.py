...
class TestLinkLocalInterfaceAddress(unittest.TestCase):
    """LinkLocalInterfaceAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkLocalInterfaceAddress:
        """Test LinkLocalInterfaceAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkLocalInterfaceAddress`
        """
        model = LinkLocalInterfaceAddress()
        if include_optional:
            return LinkLocalInterfaceAddress(
                type = 'Property',
                value = '',
    ...
    def testLinkLocalInterfaceAddress(self):
        """Test LinkLocalInterfaceAddress"""
