...
class TestSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp:
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp`
        """
        model = SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp(
                type = 'Property',
                value = 'CS0',
    ...
    def testSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp(self):
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp"""
