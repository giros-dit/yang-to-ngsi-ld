...
class TestSpfMaxWait(unittest.TestCase):
    """SpfMaxWait unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpfMaxWait:
        """Test SpfMaxWait
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpfMaxWait`
        """
        model = SpfMaxWait()
        if include_optional:
            return SpfMaxWait(
