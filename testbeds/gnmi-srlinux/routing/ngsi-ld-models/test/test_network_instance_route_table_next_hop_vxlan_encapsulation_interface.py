...
class TestNetworkInstanceRouteTableNextHopVxlanEncapsulationInterface(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopVxlanEncapsulationInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopVxlanEncapsulationInterface:
        """Test NetworkInstanceRouteTableNextHopVxlanEncapsulationInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopVxlanEncapsulationInterface`
        """
        model = NetworkInstanceRouteTableNextHopVxlanEncapsulationInterface()
        if include_optional:
            return NetworkInstanceRouteTableNextHopVxlanEncapsulationInterface(
                type = 'Property',
                value = 'vxlan0.9728880',
    ...
    def testNetworkInstanceRouteTableNextHopVxlanEncapsulationInterface(self):
        """Test NetworkInstanceRouteTableNextHopVxlanEncapsulationInterface"""
