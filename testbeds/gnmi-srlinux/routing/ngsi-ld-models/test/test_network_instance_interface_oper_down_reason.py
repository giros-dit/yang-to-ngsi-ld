...
class TestNetworkInstanceInterfaceOperDownReason(unittest.TestCase):
    """NetworkInstanceInterfaceOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceOperDownReason:
        """Test NetworkInstanceInterfaceOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceOperDownReason`
        """
        model = NetworkInstanceInterfaceOperDownReason()
        if include_optional:
            return NetworkInstanceInterfaceOperDownReason(
                type = 'Property',
                value = 'ip-addr-missing',
    ...
    def testNetworkInstanceInterfaceOperDownReason(self):
        """Test NetworkInstanceInterfaceOperDownReason"""
