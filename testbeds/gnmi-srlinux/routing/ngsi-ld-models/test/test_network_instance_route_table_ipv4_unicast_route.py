...
class TestNetworkInstanceRouteTableIpv4UnicastRoute(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRoute:
        """Test NetworkInstanceRouteTableIpv4UnicastRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRoute`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRoute()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRoute(
                id = None,
                type = 'NetworkInstanceRouteTableIpv4UnicastRoute',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRoute(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRoute"""
