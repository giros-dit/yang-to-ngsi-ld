...
class TestNetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength:
        """Test NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength`
        """
        model = NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength(self):
        """Test NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength"""
