...
class TestPolicyStatementActionBgpStatisticsLabeledUnicast(unittest.TestCase):
    """PolicyStatementActionBgpStatisticsLabeledUnicast unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpStatisticsLabeledUnicast:
        """Test PolicyStatementActionBgpStatisticsLabeledUnicast
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpStatisticsLabeledUnicast`
        """
        model = PolicyStatementActionBgpStatisticsLabeledUnicast()
        if include_optional:
            return PolicyStatementActionBgpStatisticsLabeledUnicast(
                id = '',
                type = 'PolicyStatementActionBgpStatisticsLabeledUnicast',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpStatisticsLabeledUnicast(self):
        """Test PolicyStatementActionBgpStatisticsLabeledUnicast"""
