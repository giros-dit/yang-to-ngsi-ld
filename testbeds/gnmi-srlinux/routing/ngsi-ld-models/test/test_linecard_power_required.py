...
class TestLinecardPowerRequired(unittest.TestCase):
    """LinecardPowerRequired unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardPowerRequired:
        """Test LinecardPowerRequired
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardPowerRequired`
        """
        model = LinecardPowerRequired()
        if include_optional:
            return LinecardPowerRequired(
                type = 'Property',
                value = 56,
    ...
    def testLinecardPowerRequired(self):
        """Test LinecardPowerRequired"""
