...
class TestInterfaceTransceiverSerialNumber(unittest.TestCase):
    """InterfaceTransceiverSerialNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverSerialNumber:
        """Test InterfaceTransceiverSerialNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverSerialNumber`
        """
        model = InterfaceTransceiverSerialNumber()
        if include_optional:
            return InterfaceTransceiverSerialNumber(
                type = 'Property',
                value = '',
    ...
    def testInterfaceTransceiverSerialNumber(self):
        """Test InterfaceTransceiverSerialNumber"""
