...
class TestNetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier:
        """Test NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier`
        """
        model = NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier(self):
        """Test NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier"""
