...
class TestStrictLsaChecking(unittest.TestCase):
    """StrictLsaChecking unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StrictLsaChecking:
        """Test StrictLsaChecking
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StrictLsaChecking`
        """
        model = StrictLsaChecking()
        if include_optional:
            return StrictLsaChecking(
                type = 'Property',
                value = True,
    ...
    def testStrictLsaChecking(self):
        """Test StrictLsaChecking"""
