...
class TestRxDbDescription(unittest.TestCase):
    """RxDbDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RxDbDescription:
        """Test RxDbDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RxDbDescription`
        """
        model = RxDbDescription()
        if include_optional:
            return RxDbDescription(
                type = 'Property',
                value = 56,
