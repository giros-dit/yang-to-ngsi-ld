...
class TestPolicyStatementActionIsis(unittest.TestCase):
    """PolicyStatementActionIsis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionIsis:
        """Test PolicyStatementActionIsis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionIsis`
        """
        model = PolicyStatementActionIsis()
        if include_optional:
            return PolicyStatementActionIsis(
                id = '',
                type = 'PolicyStatementActionIsis',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionIsis(self):
        """Test PolicyStatementActionIsis"""
