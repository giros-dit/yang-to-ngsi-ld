...
class TestNetworkInstanceRouteTableNextHopMplsTunnel(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopMplsTunnel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopMplsTunnel:
        """Test NetworkInstanceRouteTableNextHopMplsTunnel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopMplsTunnel`
        """
        model = NetworkInstanceRouteTableNextHopMplsTunnel()
        if include_optional:
            return NetworkInstanceRouteTableNextHopMplsTunnel(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopMplsTunnel',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopMplsTunnel(self):
        """Test NetworkInstanceRouteTableNextHopMplsTunnel"""
