...
class TestSystemLldpSystemDescription(unittest.TestCase):
    """SystemLldpSystemDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpSystemDescription:
        """Test SystemLldpSystemDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpSystemDescription`
        """
        model = SystemLldpSystemDescription()
        if include_optional:
            return SystemLldpSystemDescription(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpSystemDescription(self):
        """Test SystemLldpSystemDescription"""
