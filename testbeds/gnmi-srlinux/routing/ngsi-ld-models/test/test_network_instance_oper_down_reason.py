...
class TestNetworkInstanceOperDownReason(unittest.TestCase):
    """NetworkInstanceOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceOperDownReason:
        """Test NetworkInstanceOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceOperDownReason`
        """
        model = NetworkInstanceOperDownReason()
        if include_optional:
            return NetworkInstanceOperDownReason(
                type = 'Property',
                value = 'admin-down',
    ...
    def testNetworkInstanceOperDownReason(self):
        """Test NetworkInstanceOperDownReason"""
