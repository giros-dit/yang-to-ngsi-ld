...
class TestControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify:
        """Test ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify(
                type = 'Property',
                value = 56,
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify"""
