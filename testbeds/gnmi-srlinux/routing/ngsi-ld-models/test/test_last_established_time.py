...
class TestLastEstablishedTime(unittest.TestCase):
    """LastEstablishedTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastEstablishedTime:
        """Test LastEstablishedTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastEstablishedTime`
        """
        model = LastEstablishedTime()
        if include_optional:
            return LastEstablishedTime(
                type = 'Property',
                value = '',
    ...
    def testLastEstablishedTime(self):
        """Test LastEstablishedTime"""
