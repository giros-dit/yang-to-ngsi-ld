...
class TestSwapSrcDstMac(unittest.TestCase):
    """SwapSrcDstMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SwapSrcDstMac:
        """Test SwapSrcDstMac
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SwapSrcDstMac`
        """
        model = SwapSrcDstMac()
        if include_optional:
            return SwapSrcDstMac(
                type = 'Property',
                value = True,
