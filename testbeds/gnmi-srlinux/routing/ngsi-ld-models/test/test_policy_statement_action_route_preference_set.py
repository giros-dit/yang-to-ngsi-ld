...
class TestPolicyStatementActionRoutePreferenceSet(unittest.TestCase):
    """PolicyStatementActionRoutePreferenceSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionRoutePreferenceSet:
        """Test PolicyStatementActionRoutePreferenceSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionRoutePreferenceSet`
        """
        model = PolicyStatementActionRoutePreferenceSet()
        if include_optional:
            return PolicyStatementActionRoutePreferenceSet(
                type = 'Property',
                value = 56,
    ...
    def testPolicyStatementActionRoutePreferenceSet(self):
        """Test PolicyStatementActionRoutePreferenceSet"""
