...
class TestInterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets"""
