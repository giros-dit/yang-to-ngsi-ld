...
class TestPolicyStatementActionBgpLocalPreference(unittest.TestCase):
    """PolicyStatementActionBgpLocalPreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpLocalPreference:
        """Test PolicyStatementActionBgpLocalPreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpLocalPreference`
        """
        model = PolicyStatementActionBgpLocalPreference()
        if include_optional:
            return PolicyStatementActionBgpLocalPreference(
                id = '',
                type = 'PolicyStatementActionBgpLocalPreference',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpLocalPreference(self):
        """Test PolicyStatementActionBgpLocalPreference"""
