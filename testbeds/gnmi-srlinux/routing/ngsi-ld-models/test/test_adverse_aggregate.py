...
class TestAdverseAggregate(unittest.TestCase):
    """AdverseAggregate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdverseAggregate:
        """Test AdverseAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdverseAggregate`
        """
        model = AdverseAggregate()
        if include_optional:
            return AdverseAggregate(
                type = 'Property',
                value = 56,
