...
class TestNetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType:
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType`
        """
        model = NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType(self):
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationType"""
