...
class TestLinecardForwardingComplexFibTableNextHopGroup(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroup:
        """Test LinecardForwardingComplexFibTableNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroup`
        """
        model = LinecardForwardingComplexFibTableNextHopGroup()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroup(
                id = '',
                type = 'LinecardForwardingComplexFibTableNextHopGroup',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexFibTableNextHopGroup(self):
        """Test LinecardForwardingComplexFibTableNextHopGroup"""
