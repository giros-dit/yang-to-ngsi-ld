...
class TestUnavailableAddressReason(unittest.TestCase):
    """UnavailableAddressReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnavailableAddressReason:
        """Test UnavailableAddressReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnavailableAddressReason`
        """
        model = UnavailableAddressReason()
        if include_optional:
            return UnavailableAddressReason(
                type = 'Property',
                value = 'not-same-network-instance',
    ...
    def testUnavailableAddressReason(self):
        """Test UnavailableAddressReason"""
