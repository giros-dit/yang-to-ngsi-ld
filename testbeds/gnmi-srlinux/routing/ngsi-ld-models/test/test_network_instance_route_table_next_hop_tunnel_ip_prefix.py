...
class TestNetworkInstanceRouteTableNextHopTunnelIpPrefix(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopTunnelIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopTunnelIpPrefix:
        """Test NetworkInstanceRouteTableNextHopTunnelIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopTunnelIpPrefix`
        """
        model = NetworkInstanceRouteTableNextHopTunnelIpPrefix()
        if include_optional:
            return NetworkInstanceRouteTableNextHopTunnelIpPrefix(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopTunnelIpPrefix(self):
        """Test NetworkInstanceRouteTableNextHopTunnelIpPrefix"""
