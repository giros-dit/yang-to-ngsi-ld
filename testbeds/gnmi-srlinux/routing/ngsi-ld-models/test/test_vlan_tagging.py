...
class TestVlanTagging(unittest.TestCase):
    """VlanTagging unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VlanTagging:
        """Test VlanTagging
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VlanTagging`
        """
        model = VlanTagging()
        if include_optional:
            return VlanTagging(
