...
class TestPolicyStatementActionBgpNextHopSet(unittest.TestCase):
    """PolicyStatementActionBgpNextHopSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpNextHopSet:
        """Test PolicyStatementActionBgpNextHopSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpNextHopSet`
        """
        model = PolicyStatementActionBgpNextHopSet()
        if include_optional:
            return PolicyStatementActionBgpNextHopSet(
                type = 'Property',
                value = '',
    ...
    def testPolicyStatementActionBgpNextHopSet(self):
        """Test PolicyStatementActionBgpNextHopSet"""
