...
class TestExtendedCommunitySetMember(unittest.TestCase):
    """ExtendedCommunitySetMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedCommunitySetMember:
        """Test ExtendedCommunitySetMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedCommunitySetMember`
        """
        model = ExtendedCommunitySetMember()
        if include_optional:
            return ExtendedCommunitySetMember(
                type = 'Property',
                value = '',
    ...
    def testExtendedCommunitySetMember(self):
        """Test ExtendedCommunitySetMember"""
