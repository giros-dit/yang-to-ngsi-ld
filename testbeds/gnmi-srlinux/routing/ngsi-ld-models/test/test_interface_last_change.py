...
class TestInterfaceLastChange(unittest.TestCase):
    """InterfaceLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceLastChange:
        """Test InterfaceLastChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceLastChange`
        """
        model = InterfaceLastChange()
        if include_optional:
            return InterfaceLastChange(
                type = 'Property',
                value = '',
    ...
    def testInterfaceLastChange(self):
        """Test InterfaceLastChange"""
