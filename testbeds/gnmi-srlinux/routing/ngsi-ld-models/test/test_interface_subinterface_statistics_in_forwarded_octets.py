...
class TestInterfaceSubinterfaceStatisticsInForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInForwardedOctets:
        """Test InterfaceSubinterfaceStatisticsInForwardedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInForwardedOctets`
        """
        model = InterfaceSubinterfaceStatisticsInForwardedOctets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInForwardedOctets(self):
        """Test InterfaceSubinterfaceStatisticsInForwardedOctets"""
