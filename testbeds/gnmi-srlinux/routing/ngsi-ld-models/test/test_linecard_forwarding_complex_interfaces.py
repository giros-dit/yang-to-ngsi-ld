...
class TestLinecardForwardingComplexInterfaces(unittest.TestCase):
    """LinecardForwardingComplexInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexInterfaces:
        """Test LinecardForwardingComplexInterfaces
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexInterfaces`
        """
        model = LinecardForwardingComplexInterfaces()
        if include_optional:
            return LinecardForwardingComplexInterfaces(
                type = 'Property',
                value = 'mgmt0',
    ...
    def testLinecardForwardingComplexInterfaces(self):
        """Test LinecardForwardingComplexInterfaces"""
