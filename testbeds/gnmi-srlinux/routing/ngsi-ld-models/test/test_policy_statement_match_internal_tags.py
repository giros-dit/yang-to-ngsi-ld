...
class TestPolicyStatementMatchInternalTags(unittest.TestCase):
    """PolicyStatementMatchInternalTags unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchInternalTags:
        """Test PolicyStatementMatchInternalTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchInternalTags`
        """
        model = PolicyStatementMatchInternalTags()
        if include_optional:
            return PolicyStatementMatchInternalTags(
                id = '',
                type = 'PolicyStatementMatchInternalTags',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchInternalTags(self):
        """Test PolicyStatementMatchInternalTags"""
