...
class TestDroppedBytesAggregate(unittest.TestCase):
    """DroppedBytesAggregate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DroppedBytesAggregate:
        """Test DroppedBytesAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DroppedBytesAggregate`
        """
        model = DroppedBytesAggregate()
        if include_optional:
            return DroppedBytesAggregate(
                type = 'Property',
                value = 56,
    ...
    def testDroppedBytesAggregate(self):
        """Test DroppedBytesAggregate"""
