...
class TestUnknownLsa(unittest.TestCase):
    """UnknownLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnknownLsa:
        """Test UnknownLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnknownLsa`
        """
        model = UnknownLsa()
        if include_optional:
            return UnknownLsa(
