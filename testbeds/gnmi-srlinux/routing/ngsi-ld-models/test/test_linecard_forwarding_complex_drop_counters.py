...
class TestLinecardForwardingComplexDropCounters(unittest.TestCase):
    """LinecardForwardingComplexDropCounters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexDropCounters:
        """Test LinecardForwardingComplexDropCounters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexDropCounters`
        """
        model = LinecardForwardingComplexDropCounters()
        if include_optional:
            return LinecardForwardingComplexDropCounters(
                id = '',
                type = 'LinecardForwardingComplexDropCounters',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                adverse_aggregate = None,
                congestion_aggregate = None,
                packet_processing_aggregate = None,
                no_route = None,
                is_part_of = None
            )
        else:
    ...
    def testLinecardForwardingComplexDropCounters(self):
        """Test LinecardForwardingComplexDropCounters"""
