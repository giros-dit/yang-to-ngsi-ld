...
class TestIncrementalInterSpfRuns(unittest.TestCase):
    """IncrementalInterSpfRuns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncrementalInterSpfRuns:
        """Test IncrementalInterSpfRuns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncrementalInterSpfRuns`
        """
        model = IncrementalInterSpfRuns()
        if include_optional:
            return IncrementalInterSpfRuns(
                type = 'Property',
                value = 56,
    ...
    def testIncrementalInterSpfRuns(self):
        """Test IncrementalInterSpfRuns"""
