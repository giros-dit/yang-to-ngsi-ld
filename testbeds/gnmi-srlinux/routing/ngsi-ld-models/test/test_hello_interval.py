...
class TestHelloInterval(unittest.TestCase):
    """HelloInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelloInterval:
        """Test HelloInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelloInterval`
        """
        model = HelloInterval()
        if include_optional:
