...
class TestPolicyStatementMatchBgpStandardCommunity(unittest.TestCase):
    """PolicyStatementMatchBgpStandardCommunity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpStandardCommunity:
        """Test PolicyStatementMatchBgpStandardCommunity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpStandardCommunity`
        """
        model = PolicyStatementMatchBgpStandardCommunity()
        if include_optional:
            return PolicyStatementMatchBgpStandardCommunity(
                id = '',
                type = 'PolicyStatementMatchBgpStandardCommunity',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchBgpStandardCommunity(self):
        """Test PolicyStatementMatchBgpStandardCommunity"""
