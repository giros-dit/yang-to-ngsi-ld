...
class TestInterfaceStatisticsInErrorPackets(unittest.TestCase):
    """InterfaceStatisticsInErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsInErrorPackets:
        """Test InterfaceStatisticsInErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsInErrorPackets`
        """
        model = InterfaceStatisticsInErrorPackets()
        if include_optional:
            return InterfaceStatisticsInErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStatisticsInErrorPackets(self):
        """Test InterfaceStatisticsInErrorPackets"""
