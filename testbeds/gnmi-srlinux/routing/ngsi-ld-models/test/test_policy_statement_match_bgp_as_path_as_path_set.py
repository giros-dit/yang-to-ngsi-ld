...
class TestPolicyStatementMatchBgpAsPathAsPathSet(unittest.TestCase):
    """PolicyStatementMatchBgpAsPathAsPathSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpAsPathAsPathSet:
        """Test PolicyStatementMatchBgpAsPathAsPathSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpAsPathAsPathSet`
        """
        model = PolicyStatementMatchBgpAsPathAsPathSet()
        if include_optional:
            return PolicyStatementMatchBgpAsPathAsPathSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementMatchBgpAsPathAsPathSet(self):
        """Test PolicyStatementMatchBgpAsPathAsPathSet"""
