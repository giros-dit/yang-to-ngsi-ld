...
class TestNetworkInstanceTrafficEngineeringInterfaceInterfaceName(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringInterfaceInterfaceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringInterfaceInterfaceName:
        """Test NetworkInstanceTrafficEngineeringInterfaceInterfaceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringInterfaceInterfaceName`
        """
        model = NetworkInstanceTrafficEngineeringInterfaceInterfaceName()
        if include_optional:
            return NetworkInstanceTrafficEngineeringInterfaceInterfaceName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceTrafficEngineeringInterfaceInterfaceName(self):
        """Test NetworkInstanceTrafficEngineeringInterfaceInterfaceName"""
