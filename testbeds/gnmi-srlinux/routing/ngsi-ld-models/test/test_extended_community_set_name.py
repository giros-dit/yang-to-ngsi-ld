...
class TestExtendedCommunitySetName(unittest.TestCase):
    """ExtendedCommunitySetName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedCommunitySetName:
        """Test ExtendedCommunitySetName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedCommunitySetName`
        """
        model = ExtendedCommunitySetName()
        if include_optional:
            return ExtendedCommunitySetName(
                type = 'Property',
                value = '',
    ...
    def testExtendedCommunitySetName(self):
        """Test ExtendedCommunitySetName"""
