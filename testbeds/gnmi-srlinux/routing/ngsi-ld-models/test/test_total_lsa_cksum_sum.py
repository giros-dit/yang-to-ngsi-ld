...
class TestTotalLsaCksumSum(unittest.TestCase):
    """TotalLsaCksumSum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotalLsaCksumSum:
        """Test TotalLsaCksumSum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotalLsaCksumSum`
        """
        model = TotalLsaCksumSum()
        if include_optional:
            return TotalLsaCksumSum(
                type = 'Property',
                value = '0x2',
