...
class TestInterfaceOperState(unittest.TestCase):
    """InterfaceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceOperState:
        """Test InterfaceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceOperState`
        """
        model = InterfaceOperState()
        if include_optional:
            return InterfaceOperState(
                type = 'Property',
                value = 'up',
    ...
    def testInterfaceOperState(self):
        """Test InterfaceOperState"""
