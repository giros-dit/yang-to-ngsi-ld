...
class TestNetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval:
        """Test NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval`
        """
        model = NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval(self):
        """Test NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval"""
