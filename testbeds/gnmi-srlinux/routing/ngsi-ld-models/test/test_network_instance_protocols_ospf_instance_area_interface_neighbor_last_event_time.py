...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborLastEventTime"""
