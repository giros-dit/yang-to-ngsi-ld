...
class TestPolicyStatementMatchInternalTagsTagSet(unittest.TestCase):
    """PolicyStatementMatchInternalTagsTagSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchInternalTagsTagSet:
        """Test PolicyStatementMatchInternalTagsTagSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchInternalTagsTagSet`
        """
        model = PolicyStatementMatchInternalTagsTagSet()
        if include_optional:
            return PolicyStatementMatchInternalTagsTagSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementMatchInternalTagsTagSet(self):
        """Test PolicyStatementMatchInternalTagsTagSet"""
