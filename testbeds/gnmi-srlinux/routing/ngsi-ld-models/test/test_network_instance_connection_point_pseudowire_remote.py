...
class TestNetworkInstanceConnectionPointPseudowireRemote(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireRemote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireRemote:
        """Test NetworkInstanceConnectionPointPseudowireRemote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireRemote`
        """
        model = NetworkInstanceConnectionPointPseudowireRemote()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireRemote(
                id = '',
                type = 'NetworkInstanceConnectionPointPseudowireRemote',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                operational_egress_vc_label = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceConnectionPointPseudowireRemote(
    ...
    def testNetworkInstanceConnectionPointPseudowireRemote(self):
        """Test NetworkInstanceConnectionPointPseudowireRemote"""
