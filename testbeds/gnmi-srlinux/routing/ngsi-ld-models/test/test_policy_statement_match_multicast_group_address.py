...
class TestPolicyStatementMatchMulticastGroupAddress(unittest.TestCase):
    """PolicyStatementMatchMulticastGroupAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchMulticastGroupAddress:
        """Test PolicyStatementMatchMulticastGroupAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchMulticastGroupAddress`
        """
        model = PolicyStatementMatchMulticastGroupAddress()
        if include_optional:
            return PolicyStatementMatchMulticastGroupAddress(
                id = '',
                type = 'PolicyStatementMatchMulticastGroupAddress',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchMulticastGroupAddress(self):
        """Test PolicyStatementMatchMulticastGroupAddress"""
