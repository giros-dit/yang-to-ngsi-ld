...
class TestNumberLinks(unittest.TestCase):
    """NumberLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumberLinks:
        """Test NumberLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumberLinks`
        """
        model = NumberLinks()
        if include_optional:
            return NumberLinks(
