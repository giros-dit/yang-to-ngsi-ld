...
class TestExportFiltered(unittest.TestCase):
    """ExportFiltered unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportFiltered:
        """Test ExportFiltered
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportFiltered`
        """
        model = ExportFiltered()
        if include_optional:
