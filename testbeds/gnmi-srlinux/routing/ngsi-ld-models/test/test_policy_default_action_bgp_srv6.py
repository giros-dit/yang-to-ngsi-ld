...
class TestPolicyDefaultActionBgpSrv6(unittest.TestCase):
    """PolicyDefaultActionBgpSrv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpSrv6:
        """Test PolicyDefaultActionBgpSrv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpSrv6`
        """
        model = PolicyDefaultActionBgpSrv6()
        if include_optional:
            return PolicyDefaultActionBgpSrv6(
                id = '',
                type = 'PolicyDefaultActionBgpSrv6',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpSrv6(self):
        """Test PolicyDefaultActionBgpSrv6"""
