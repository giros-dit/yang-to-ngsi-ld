...
class TestInterfaceTransceiverTemperatureLatestValue(unittest.TestCase):
    """InterfaceTransceiverTemperatureLatestValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureLatestValue:
        """Test InterfaceTransceiverTemperatureLatestValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureLatestValue`
        """
        model = InterfaceTransceiverTemperatureLatestValue()
        if include_optional:
            return InterfaceTransceiverTemperatureLatestValue(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceTransceiverTemperatureLatestValue(self):
        """Test InterfaceTransceiverTemperatureLatestValue"""
