...
class TestNetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance:
        """Test NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance`
        """
        model = NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance()
        if include_optional:
            return NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance(self):
        """Test NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance"""
