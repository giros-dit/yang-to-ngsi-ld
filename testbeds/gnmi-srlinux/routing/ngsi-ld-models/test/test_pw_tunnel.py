...
class TestPwTunnel(unittest.TestCase):
    """PwTunnel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PwTunnel:
        """Test PwTunnel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PwTunnel`
        """
        model = PwTunnel()
        if include_optional:
            return PwTunnel(
