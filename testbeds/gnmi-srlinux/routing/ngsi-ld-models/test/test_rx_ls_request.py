...
class TestRxLsRequest(unittest.TestCase):
    """RxLsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RxLsRequest:
        """Test RxLsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RxLsRequest`
        """
        model = RxLsRequest()
        if include_optional:
            return RxLsRequest(
