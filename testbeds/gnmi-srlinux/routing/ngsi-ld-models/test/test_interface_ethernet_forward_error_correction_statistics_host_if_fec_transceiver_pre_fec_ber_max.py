...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax"""
