...
class TestInterfaceTransceiverTemperatureMaximumTime(unittest.TestCase):
    """InterfaceTransceiverTemperatureMaximumTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureMaximumTime:
        """Test InterfaceTransceiverTemperatureMaximumTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureMaximumTime`
        """
        model = InterfaceTransceiverTemperatureMaximumTime()
        if include_optional:
            return InterfaceTransceiverTemperatureMaximumTime(
                type = 'Property',
                value = '',
    ...
    def testInterfaceTransceiverTemperatureMaximumTime(self):
        """Test InterfaceTransceiverTemperatureMaximumTime"""
