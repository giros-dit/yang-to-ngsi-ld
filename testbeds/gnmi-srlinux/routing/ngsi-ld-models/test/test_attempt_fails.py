...
class TestAttemptFails(unittest.TestCase):
    """AttemptFails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AttemptFails:
        """Test AttemptFails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AttemptFails`
        """
        model = AttemptFails()
        if include_optional:
            return AttemptFails(
