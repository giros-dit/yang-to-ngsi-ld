...
class TestLinecardForwardingComplexFibTableNextHopGroupIndex(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroupIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroupIndex:
        """Test LinecardForwardingComplexFibTableNextHopGroupIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroupIndex`
        """
        model = LinecardForwardingComplexFibTableNextHopGroupIndex()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroupIndex(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexFibTableNextHopGroupIndex(self):
        """Test LinecardForwardingComplexFibTableNextHopGroupIndex"""
