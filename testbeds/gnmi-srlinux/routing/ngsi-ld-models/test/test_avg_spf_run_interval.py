...
class TestAvgSpfRunInterval(unittest.TestCase):
    """AvgSpfRunInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AvgSpfRunInterval:
        """Test AvgSpfRunInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AvgSpfRunInterval`
        """
        model = AvgSpfRunInterval()
        if include_optional:
            return AvgSpfRunInterval(
                type = 'Property',
                value = 0,
    ...
    def testAvgSpfRunInterval(self):
        """Test AvgSpfRunInterval"""
