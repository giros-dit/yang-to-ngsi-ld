...
class TestLinecardMdaRebootingAt(unittest.TestCase):
    """LinecardMdaRebootingAt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaRebootingAt:
        """Test LinecardMdaRebootingAt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaRebootingAt`
        """
        model = LinecardMdaRebootingAt()
        if include_optional:
            return LinecardMdaRebootingAt(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaRebootingAt(self):
        """Test LinecardMdaRebootingAt"""
