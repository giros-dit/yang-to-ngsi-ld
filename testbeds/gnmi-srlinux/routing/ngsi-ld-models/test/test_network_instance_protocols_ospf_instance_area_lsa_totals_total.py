...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsTotal"""
