...
class TestSystemLldpInterfaceLldpMedAdminState(unittest.TestCase):
    """SystemLldpInterfaceLldpMedAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedAdminState:
        """Test SystemLldpInterfaceLldpMedAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedAdminState`
        """
        model = SystemLldpInterfaceLldpMedAdminState()
        if include_optional:
            return SystemLldpInterfaceLldpMedAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testSystemLldpInterfaceLldpMedAdminState(self):
        """Test SystemLldpInterfaceLldpMedAdminState"""
