...
class TestOutMacPauseFrames(unittest.TestCase):
    """OutMacPauseFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutMacPauseFrames:
        """Test OutMacPauseFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutMacPauseFrames`
        """
        model = OutMacPauseFrames()
        if include_optional:
            return OutMacPauseFrames(
                type = 'Property',
                value = 56,
    ...
    def testOutMacPauseFrames(self):
        """Test OutMacPauseFrames"""
