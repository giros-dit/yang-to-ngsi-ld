...
class TestNetworkInstanceRouteTableNextHopIndex(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndex:
        """Test NetworkInstanceRouteTableNextHopIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndex`
        """
        model = NetworkInstanceRouteTableNextHopIndex()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndex(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopIndex(self):
        """Test NetworkInstanceRouteTableNextHopIndex"""
