...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId"""
