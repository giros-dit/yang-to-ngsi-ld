...
class TestNetworkInstanceInterfaceOperState(unittest.TestCase):
    """NetworkInstanceInterfaceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceOperState:
        """Test NetworkInstanceInterfaceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceOperState`
        """
        model = NetworkInstanceInterfaceOperState()
        if include_optional:
            return NetworkInstanceInterfaceOperState(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceInterfaceOperState(self):
        """Test NetworkInstanceInterfaceOperState"""
