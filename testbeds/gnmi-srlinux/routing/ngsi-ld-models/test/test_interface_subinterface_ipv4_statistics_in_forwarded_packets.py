...
class TestInterfaceSubinterfaceIpv4StatisticsInForwardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInForwardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInForwardedPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsInForwardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInForwardedPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInForwardedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInForwardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInForwardedPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInForwardedPackets"""
