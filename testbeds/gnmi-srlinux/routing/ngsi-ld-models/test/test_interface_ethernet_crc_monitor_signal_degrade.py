...
class TestInterfaceEthernetCrcMonitorSignalDegrade(unittest.TestCase):
    """InterfaceEthernetCrcMonitorSignalDegrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitorSignalDegrade:
        """Test InterfaceEthernetCrcMonitorSignalDegrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitorSignalDegrade`
        """
        model = InterfaceEthernetCrcMonitorSignalDegrade()
        if include_optional:
            return InterfaceEthernetCrcMonitorSignalDegrade(
                id = '',
                type = 'InterfaceEthernetCrcMonitorSignalDegrade',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetCrcMonitorSignalDegrade(self):
        """Test InterfaceEthernetCrcMonitorSignalDegrade"""
