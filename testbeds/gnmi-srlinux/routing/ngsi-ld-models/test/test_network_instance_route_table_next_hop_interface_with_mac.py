...
class TestNetworkInstanceRouteTableNextHopInterfaceWithMac(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopInterfaceWithMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopInterfaceWithMac:
        """Test NetworkInstanceRouteTableNextHopInterfaceWithMac
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopInterfaceWithMac`
        """
        model = NetworkInstanceRouteTableNextHopInterfaceWithMac()
        if include_optional:
            return NetworkInstanceRouteTableNextHopInterfaceWithMac(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopInterfaceWithMac',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopInterfaceWithMac(self):
        """Test NetworkInstanceRouteTableNextHopInterfaceWithMac"""
