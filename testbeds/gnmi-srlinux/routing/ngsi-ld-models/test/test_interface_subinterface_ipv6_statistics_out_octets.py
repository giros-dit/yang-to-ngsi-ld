...
class TestInterfaceSubinterfaceIpv6StatisticsOutOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsOutOctets:
        """Test InterfaceSubinterfaceIpv6StatisticsOutOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsOutOctets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsOutOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsOutOctets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsOutOctets"""
