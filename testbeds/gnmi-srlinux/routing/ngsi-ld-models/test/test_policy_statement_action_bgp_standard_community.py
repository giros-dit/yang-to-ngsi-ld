...
class TestPolicyStatementActionBgpStandardCommunity(unittest.TestCase):
    """PolicyStatementActionBgpStandardCommunity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpStandardCommunity:
        """Test PolicyStatementActionBgpStandardCommunity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpStandardCommunity`
        """
        model = PolicyStatementActionBgpStandardCommunity()
        if include_optional:
            return PolicyStatementActionBgpStandardCommunity(
                id = '',
                type = 'PolicyStatementActionBgpStandardCommunity',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpStandardCommunity(self):
        """Test PolicyStatementActionBgpStandardCommunity"""
