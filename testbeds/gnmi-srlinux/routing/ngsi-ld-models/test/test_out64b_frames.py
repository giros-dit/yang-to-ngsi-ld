...
class TestOut64bFrames(unittest.TestCase):
    """Out64bFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Out64bFrames:
        """Test Out64bFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Out64bFrames`
        """
        model = Out64bFrames()
        if include_optional:
            return Out64bFrames(
