...
class TestInterfaceEthernetSymbolMonitor(unittest.TestCase):
    """InterfaceEthernetSymbolMonitor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitor:
        """Test InterfaceEthernetSymbolMonitor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitor`
        """
        model = InterfaceEthernetSymbolMonitor()
        if include_optional:
            return InterfaceEthernetSymbolMonitor(
                id = '',
                type = 'InterfaceEthernetSymbolMonitor',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetSymbolMonitor(self):
        """Test InterfaceEthernetSymbolMonitor"""
