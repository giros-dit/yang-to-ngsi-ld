...
class TestSystemLldpInterfaceStatisticsTlvDiscard(unittest.TestCase):
    """SystemLldpInterfaceStatisticsTlvDiscard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceStatisticsTlvDiscard:
        """Test SystemLldpInterfaceStatisticsTlvDiscard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceStatisticsTlvDiscard`
        """
        model = SystemLldpInterfaceStatisticsTlvDiscard()
        if include_optional:
            return SystemLldpInterfaceStatisticsTlvDiscard(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceStatisticsTlvDiscard(self):
        """Test SystemLldpInterfaceStatisticsTlvDiscard"""
