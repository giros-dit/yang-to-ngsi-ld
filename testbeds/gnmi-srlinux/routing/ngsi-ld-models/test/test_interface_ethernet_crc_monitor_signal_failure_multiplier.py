...
class TestInterfaceEthernetCrcMonitorSignalFailureMultiplier(unittest.TestCase):
    """InterfaceEthernetCrcMonitorSignalFailureMultiplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitorSignalFailureMultiplier:
        """Test InterfaceEthernetCrcMonitorSignalFailureMultiplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitorSignalFailureMultiplier`
        """
        model = InterfaceEthernetCrcMonitorSignalFailureMultiplier()
        if include_optional:
            return InterfaceEthernetCrcMonitorSignalFailureMultiplier(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceEthernetCrcMonitorSignalFailureMultiplier(self):
        """Test InterfaceEthernetCrcMonitorSignalFailureMultiplier"""
