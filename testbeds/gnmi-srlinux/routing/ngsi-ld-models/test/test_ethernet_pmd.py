...
class TestEthernetPmd(unittest.TestCase):
    """EthernetPmd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EthernetPmd:
        """Test EthernetPmd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EthernetPmd`
        """
        model = EthernetPmd()
        if include_optional:
            return EthernetPmd(
