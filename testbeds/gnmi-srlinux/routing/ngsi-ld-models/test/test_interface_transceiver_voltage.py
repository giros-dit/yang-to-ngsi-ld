...
class TestInterfaceTransceiverVoltage(unittest.TestCase):
    """InterfaceTransceiverVoltage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltage:
        """Test InterfaceTransceiverVoltage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltage`
        """
        model = InterfaceTransceiverVoltage()
        if include_optional:
            return InterfaceTransceiverVoltage(
                id = '',
                type = 'InterfaceTransceiverVoltage',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceTransceiverVoltage(self):
        """Test InterfaceTransceiverVoltage"""
