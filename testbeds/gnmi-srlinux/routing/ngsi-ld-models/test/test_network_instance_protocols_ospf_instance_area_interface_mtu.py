...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu(
                type = 'Property',
                value = 512,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceMtu"""
