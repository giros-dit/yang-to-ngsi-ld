...
class TestNetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa:
        """Test NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa`
        """
        model = NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa(self):
        """Test NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa"""
