...
class TestSystemLldpInterfaceLldpMed(unittest.TestCase):
    """SystemLldpInterfaceLldpMed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMed:
        """Test SystemLldpInterfaceLldpMed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMed`
        """
        model = SystemLldpInterfaceLldpMed()
        if include_optional:
            return SystemLldpInterfaceLldpMed(
                id = '',
                type = 'SystemLldpInterfaceLldpMed',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceLldpMed(self):
        """Test SystemLldpInterfaceLldpMed"""
