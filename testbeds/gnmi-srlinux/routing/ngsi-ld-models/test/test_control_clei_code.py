...
class TestControlCleiCode(unittest.TestCase):
    """ControlCleiCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlCleiCode:
        """Test ControlCleiCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlCleiCode`
        """
        model = ControlCleiCode()
        if include_optional:
            return ControlCleiCode(
                type = 'Property',
                value = '',
