...
class TestInterfaceTransceiverChannel(unittest.TestCase):
    """InterfaceTransceiverChannel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverChannel:
        """Test InterfaceTransceiverChannel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverChannel`
        """
        model = InterfaceTransceiverChannel()
        if include_optional:
            return InterfaceTransceiverChannel(
                id = '',
                type = 'InterfaceTransceiverChannel',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceTransceiverChannel(self):
        """Test InterfaceTransceiverChannel"""
