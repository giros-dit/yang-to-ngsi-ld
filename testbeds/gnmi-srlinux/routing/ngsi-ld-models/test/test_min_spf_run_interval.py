...
class TestMinSpfRunInterval(unittest.TestCase):
    """MinSpfRunInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MinSpfRunInterval:
        """Test MinSpfRunInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MinSpfRunInterval`
        """
        model = MinSpfRunInterval()
        if include_optional:
            return MinSpfRunInterval(
                type = 'Property',
                value = 0,
    ...
    def testMinSpfRunInterval(self):
        """Test MinSpfRunInterval"""
