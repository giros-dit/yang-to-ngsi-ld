...
class TestDesignatedRouter(unittest.TestCase):
    """DesignatedRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignatedRouter:
        """Test DesignatedRouter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DesignatedRouter`
        """
        model = DesignatedRouter()
        if include_optional:
