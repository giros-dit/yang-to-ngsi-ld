...
class TestControlLastBooted(unittest.TestCase):
    """ControlLastBooted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlLastBooted:
        """Test ControlLastBooted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlLastBooted`
        """
        model = ControlLastBooted()
        if include_optional:
            return ControlLastBooted(
                type = 'Property',
                value = '',
    ...
    def testControlLastBooted(self):
        """Test ControlLastBooted"""
