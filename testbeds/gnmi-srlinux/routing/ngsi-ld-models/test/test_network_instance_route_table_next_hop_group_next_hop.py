...
class TestNetworkInstanceRouteTableNextHopGroupNextHop(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupNextHop:
        """Test NetworkInstanceRouteTableNextHopGroupNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupNextHop`
        """
        model = NetworkInstanceRouteTableNextHopGroupNextHop()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupNextHop(
                id = None,
                type = 'NetworkInstanceRouteTableNextHopGroupNextHop',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                weight = None,
                resolved = None,
                resource_allocation_failed = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceRouteTableNextHopGroupNextHop(
    ...
    def testNetworkInstanceRouteTableNextHopGroupNextHop(self):
        """Test NetworkInstanceRouteTableNextHopGroupNextHop"""
