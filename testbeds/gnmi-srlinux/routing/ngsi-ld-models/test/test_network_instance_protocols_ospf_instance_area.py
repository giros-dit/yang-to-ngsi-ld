...
class TestNetworkInstanceProtocolsOspfInstanceArea(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceArea unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceArea:
        """Test NetworkInstanceProtocolsOspfInstanceArea
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceArea`
        """
        model = NetworkInstanceProtocolsOspfInstanceArea()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceArea(
                id = '',
                ...
                blackhole_aggregate = None,
                export_policy = None,
                bgp_ls_exclude = None,
                full_spf_runs = None,
                last_spf_run_time = None,
                area_bdr_rtr_count = None,
                as_bdr_rtr_count = None,
    ...
    def testNetworkInstanceProtocolsOspfInstanceArea(self):
        """Test NetworkInstanceProtocolsOspfInstanceArea"""
