...
class TestRedistributeDelay(unittest.TestCase):
    """RedistributeDelay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RedistributeDelay:
        """Test RedistributeDelay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RedistributeDelay`
        """
        model = RedistributeDelay()
        if include_optional:
            return RedistributeDelay(
                type = 'Property',
                value = 0,
    ...
    def testRedistributeDelay(self):
        """Test RedistributeDelay"""
