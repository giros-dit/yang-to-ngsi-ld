...
class TestVendorLotNumber(unittest.TestCase):
    """VendorLotNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VendorLotNumber:
        """Test VendorLotNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VendorLotNumber`
        """
        model = VendorLotNumber()
        if include_optional:
