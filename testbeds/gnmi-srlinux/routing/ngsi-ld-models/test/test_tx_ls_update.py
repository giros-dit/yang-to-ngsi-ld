...
class TestTxLsUpdate(unittest.TestCase):
    """TxLsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TxLsUpdate:
        """Test TxLsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TxLsUpdate`
        """
        model = TxLsUpdate()
        if include_optional:
            return TxLsUpdate(
