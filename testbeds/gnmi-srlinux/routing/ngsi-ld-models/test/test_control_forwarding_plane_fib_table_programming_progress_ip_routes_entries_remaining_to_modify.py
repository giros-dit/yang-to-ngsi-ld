...
class TestControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify:
        """Test ControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify(
                type = 'Property',
                value = 56,
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressIpRoutesEntriesRemainingToModify"""
