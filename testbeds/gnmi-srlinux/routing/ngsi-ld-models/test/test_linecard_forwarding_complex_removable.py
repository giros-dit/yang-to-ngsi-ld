...
class TestLinecardForwardingComplexRemovable(unittest.TestCase):
    """LinecardForwardingComplexRemovable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexRemovable:
        """Test LinecardForwardingComplexRemovable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexRemovable`
        """
        model = LinecardForwardingComplexRemovable()
        if include_optional:
            return LinecardForwardingComplexRemovable(
                type = 'Property',
                value = True,
    ...
    def testLinecardForwardingComplexRemovable(self):
        """Test LinecardForwardingComplexRemovable"""
