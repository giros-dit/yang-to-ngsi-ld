...
class TestPolicyStatementMatchOspfRouteType(unittest.TestCase):
    """PolicyStatementMatchOspfRouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchOspfRouteType:
        """Test PolicyStatementMatchOspfRouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchOspfRouteType`
        """
        model = PolicyStatementMatchOspfRouteType()
        if include_optional:
            return PolicyStatementMatchOspfRouteType(
                type = 'Property',
                value = 'internal',
    ...
    def testPolicyStatementMatchOspfRouteType(self):
        """Test PolicyStatementMatchOspfRouteType"""
