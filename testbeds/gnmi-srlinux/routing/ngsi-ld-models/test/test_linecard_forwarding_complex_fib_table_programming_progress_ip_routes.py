...
class TestLinecardForwardingComplexFibTableProgrammingProgressIpRoutes(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressIpRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressIpRoutes:
        """Test LinecardForwardingComplexFibTableProgrammingProgressIpRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressIpRoutes`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressIpRoutes()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressIpRoutes(
                id = '',
                type = 'LinecardForwardingComplexFibTableProgrammingProgressIpRoutes',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressIpRoutes(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressIpRoutes"""
