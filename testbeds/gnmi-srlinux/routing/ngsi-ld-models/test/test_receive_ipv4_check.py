...
class TestReceiveIpv4Check(unittest.TestCase):
    """ReceiveIpv4Check unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReceiveIpv4Check:
        """Test ReceiveIpv4Check
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReceiveIpv4Check`
        """
        model = ReceiveIpv4Check()
        if include_optional:
            return ReceiveIpv4Check(
                type = 'Property',
                value = True,
