...
class TestOutMirrorOctets(unittest.TestCase):
    """OutMirrorOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutMirrorOctets:
        """Test OutMirrorOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutMirrorOctets`
        """
        model = OutMirrorOctets()
        if include_optional:
            return OutMirrorOctets(
                type = 'Property',
                value = 56,
