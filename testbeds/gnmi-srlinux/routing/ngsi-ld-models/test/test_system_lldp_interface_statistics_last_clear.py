...
class TestSystemLldpInterfaceStatisticsLastClear(unittest.TestCase):
    """SystemLldpInterfaceStatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceStatisticsLastClear:
        """Test SystemLldpInterfaceStatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceStatisticsLastClear`
        """
        model = SystemLldpInterfaceStatisticsLastClear()
        if include_optional:
            return SystemLldpInterfaceStatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceStatisticsLastClear(self):
        """Test SystemLldpInterfaceStatisticsLastClear"""
