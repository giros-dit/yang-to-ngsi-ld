...
class TestNetworkInstanceTcpListeningApplicationLocalAddress(unittest.TestCase):
    """NetworkInstanceTcpListeningApplicationLocalAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpListeningApplicationLocalAddress:
        """Test NetworkInstanceTcpListeningApplicationLocalAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpListeningApplicationLocalAddress`
        """
        model = NetworkInstanceTcpListeningApplicationLocalAddress()
        if include_optional:
            return NetworkInstanceTcpListeningApplicationLocalAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceTcpListeningApplicationLocalAddress(self):
        """Test NetworkInstanceTcpListeningApplicationLocalAddress"""
