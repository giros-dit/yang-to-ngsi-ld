...
class TestCollectIrbStats(unittest.TestCase):
    """CollectIrbStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectIrbStats:
        """Test CollectIrbStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectIrbStats`
        """
        model = CollectIrbStats()
        if include_optional:
            return CollectIrbStats(
                type = 'Property',
                value = True,
