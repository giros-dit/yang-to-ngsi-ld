...
class TestNetworkInstanceStaticRoutesRoute(unittest.TestCase):
    """NetworkInstanceStaticRoutesRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesRoute:
        """Test NetworkInstanceStaticRoutesRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesRoute`
        """
        model = NetworkInstanceStaticRoutesRoute()
        if include_optional:
            return NetworkInstanceStaticRoutesRoute(
                id = '',
    ...
    def testNetworkInstanceStaticRoutesRoute(self):
        """Test NetworkInstanceStaticRoutesRoute"""
