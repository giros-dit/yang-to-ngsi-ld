...
class TestLinecardFailureReason(unittest.TestCase):
    """LinecardFailureReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardFailureReason:
        """Test LinecardFailureReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardFailureReason`
        """
        model = LinecardFailureReason()
        if include_optional:
            return LinecardFailureReason(
                type = 'Property',
                value = '',
    ...
    def testLinecardFailureReason(self):
        """Test LinecardFailureReason"""
