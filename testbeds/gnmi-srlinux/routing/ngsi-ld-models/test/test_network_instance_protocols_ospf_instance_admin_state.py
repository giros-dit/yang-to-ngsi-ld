...
class TestNetworkInstanceProtocolsOspfInstanceAdminState(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAdminState:
        """Test NetworkInstanceProtocolsOspfInstanceAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAdminState`
        """
        model = NetworkInstanceProtocolsOspfInstanceAdminState()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAdminState(self):
        """Test NetworkInstanceProtocolsOspfInstanceAdminState"""
