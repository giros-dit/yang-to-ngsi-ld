...
class TestLinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd:
        """Test LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd"""
