...
class TestSystemLldpInterfaceNeighborManagementAddressType(unittest.TestCase):
    """SystemLldpInterfaceNeighborManagementAddressType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborManagementAddressType:
        """Test SystemLldpInterfaceNeighborManagementAddressType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborManagementAddressType`
        """
        model = SystemLldpInterfaceNeighborManagementAddressType()
        if include_optional:
            return SystemLldpInterfaceNeighborManagementAddressType(
                type = 'Property',
                value = 'IPv4',
    ...
    def testSystemLldpInterfaceNeighborManagementAddressType(self):
        """Test SystemLldpInterfaceNeighborManagementAddressType"""
