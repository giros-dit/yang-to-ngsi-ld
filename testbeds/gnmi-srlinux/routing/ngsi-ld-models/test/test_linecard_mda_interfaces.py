...
class TestLinecardMdaInterfaces(unittest.TestCase):
    """LinecardMdaInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaInterfaces:
        """Test LinecardMdaInterfaces
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaInterfaces`
        """
        model = LinecardMdaInterfaces()
        if include_optional:
            return LinecardMdaInterfaces(
                type = 'Property',
                value = 'mgmt0',
    ...
    def testLinecardMdaInterfaces(self):
        """Test LinecardMdaInterfaces"""
