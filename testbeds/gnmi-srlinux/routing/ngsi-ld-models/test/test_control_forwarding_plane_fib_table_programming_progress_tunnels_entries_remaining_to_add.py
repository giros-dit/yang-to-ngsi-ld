...
class TestControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd:
        """Test ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd(
                type = 'Property',
                value = 56,
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToAdd"""
