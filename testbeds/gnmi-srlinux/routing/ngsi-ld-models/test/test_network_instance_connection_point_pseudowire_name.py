...
class TestNetworkInstanceConnectionPointPseudowireName(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireName:
        """Test NetworkInstanceConnectionPointPseudowireName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireName`
        """
        model = NetworkInstanceConnectionPointPseudowireName()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceConnectionPointPseudowireName(self):
        """Test NetworkInstanceConnectionPointPseudowireName"""
