...
class TestControlOperState(unittest.TestCase):
    """ControlOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlOperState:
        """Test ControlOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlOperState`
        """
        model = ControlOperState()
        if include_optional:
            return ControlOperState(
                type = 'Property',
                value = 'up',
