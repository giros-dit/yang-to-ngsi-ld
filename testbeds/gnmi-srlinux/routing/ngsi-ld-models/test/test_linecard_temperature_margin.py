...
class TestLinecardTemperatureMargin(unittest.TestCase):
    """LinecardTemperatureMargin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardTemperatureMargin:
        """Test LinecardTemperatureMargin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardTemperatureMargin`
        """
        model = LinecardTemperatureMargin()
        if include_optional:
            return LinecardTemperatureMargin(
                type = 'Property',
                value = 56,
    ...
    def testLinecardTemperatureMargin(self):
        """Test LinecardTemperatureMargin"""
