...
class TestPolicyStatementMatchBgpExtendedCommunityMatchSetOptions(unittest.TestCase):
    """PolicyStatementMatchBgpExtendedCommunityMatchSetOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpExtendedCommunityMatchSetOptions:
        """Test PolicyStatementMatchBgpExtendedCommunityMatchSetOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpExtendedCommunityMatchSetOptions`
        """
        model = PolicyStatementMatchBgpExtendedCommunityMatchSetOptions()
        if include_optional:
            return PolicyStatementMatchBgpExtendedCommunityMatchSetOptions(
                type = 'Property',
                value = 'any',
    ...
    def testPolicyStatementMatchBgpExtendedCommunityMatchSetOptions(self):
        """Test PolicyStatementMatchBgpExtendedCommunityMatchSetOptions"""
