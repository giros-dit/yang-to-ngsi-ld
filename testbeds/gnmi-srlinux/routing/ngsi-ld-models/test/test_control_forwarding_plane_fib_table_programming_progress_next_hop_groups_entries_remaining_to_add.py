...
class TestControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd:
        """Test ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd(
                type = 'Property',
                value = 56,
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd"""
