...
class TestEgressVcLabel(unittest.TestCase):
    """EgressVcLabel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EgressVcLabel:
        """Test EgressVcLabel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EgressVcLabel`
        """
        model = EgressVcLabel()
        if include_optional:
            return EgressVcLabel(
                type = 'Property',
                value = 56,
