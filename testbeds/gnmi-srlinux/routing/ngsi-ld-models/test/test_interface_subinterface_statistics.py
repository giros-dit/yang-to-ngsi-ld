...
class TestInterfaceSubinterfaceStatistics(unittest.TestCase):
    """InterfaceSubinterfaceStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatistics:
        """Test InterfaceSubinterfaceStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatistics`
        """
        model = InterfaceSubinterfaceStatistics()
        if include_optional:
            return InterfaceSubinterfaceStatistics(
                id = '',
                type = 'InterfaceSubinterfaceStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfaceStatistics(self):
        """Test InterfaceSubinterfaceStatistics"""
