...
class TestSystemAuthenticationKeychainKeyReceiveLifetime(unittest.TestCase):
    """SystemAuthenticationKeychainKeyReceiveLifetime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKeyReceiveLifetime:
        """Test SystemAuthenticationKeychainKeyReceiveLifetime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKeyReceiveLifetime`
        """
        model = SystemAuthenticationKeychainKeyReceiveLifetime()
        if include_optional:
            return SystemAuthenticationKeychainKeyReceiveLifetime(
                id = '',
                type = 'SystemAuthenticationKeychainKeyReceiveLifetime',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemAuthenticationKeychainKeyReceiveLifetime(self):
        """Test SystemAuthenticationKeychainKeyReceiveLifetime"""
