...
class TestOpaqueLsaSupport(unittest.TestCase):
    """OpaqueLsaSupport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpaqueLsaSupport:
        """Test OpaqueLsaSupport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpaqueLsaSupport`
        """
        model = OpaqueLsaSupport()
        if include_optional:
            return OpaqueLsaSupport(
                type = 'Property',
                value = True,
