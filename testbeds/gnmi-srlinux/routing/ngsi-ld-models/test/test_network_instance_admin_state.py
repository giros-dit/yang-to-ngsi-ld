...
class TestNetworkInstanceAdminState(unittest.TestCase):
    """NetworkInstanceAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceAdminState:
        """Test NetworkInstanceAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceAdminState`
        """
        model = NetworkInstanceAdminState()
        if include_optional:
            return NetworkInstanceAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceAdminState(self):
        """Test NetworkInstanceAdminState"""
