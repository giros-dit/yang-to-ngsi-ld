...
class TestStandardCommunitySetName(unittest.TestCase):
    """StandardCommunitySetName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardCommunitySetName:
        """Test StandardCommunitySetName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardCommunitySetName`
        """
        model = StandardCommunitySetName()
        if include_optional:
            return StandardCommunitySetName(
                type = 'Property',
                value = '',
    ...
    def testStandardCommunitySetName(self):
        """Test StandardCommunitySetName"""
