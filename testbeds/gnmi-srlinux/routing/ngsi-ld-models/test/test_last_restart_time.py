...
class TestLastRestartTime(unittest.TestCase):
    """LastRestartTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastRestartTime:
        """Test LastRestartTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastRestartTime`
        """
        model = LastRestartTime()
        if include_optional:
