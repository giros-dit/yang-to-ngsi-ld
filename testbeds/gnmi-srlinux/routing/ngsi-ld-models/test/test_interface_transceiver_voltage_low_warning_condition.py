...
class TestInterfaceTransceiverVoltageLowWarningCondition(unittest.TestCase):
    """InterfaceTransceiverVoltageLowWarningCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageLowWarningCondition:
        """Test InterfaceTransceiverVoltageLowWarningCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageLowWarningCondition`
        """
        model = InterfaceTransceiverVoltageLowWarningCondition()
        if include_optional:
            return InterfaceTransceiverVoltageLowWarningCondition(
                type = 'Property',
                value = True,
    ...
    def testInterfaceTransceiverVoltageLowWarningCondition(self):
        """Test InterfaceTransceiverVoltageLowWarningCondition"""
