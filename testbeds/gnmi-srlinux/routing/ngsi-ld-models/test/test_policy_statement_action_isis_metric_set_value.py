...
class TestPolicyStatementActionIsisMetricSetValue(unittest.TestCase):
    """PolicyStatementActionIsisMetricSetValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionIsisMetricSetValue:
        """Test PolicyStatementActionIsisMetricSetValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionIsisMetricSetValue`
        """
        model = PolicyStatementActionIsisMetricSetValue()
        if include_optional:
            return PolicyStatementActionIsisMetricSetValue(
                type = 'Property',
                value = 56,
    ...
    def testPolicyStatementActionIsisMetricSetValue(self):
        """Test PolicyStatementActionIsisMetricSetValue"""
