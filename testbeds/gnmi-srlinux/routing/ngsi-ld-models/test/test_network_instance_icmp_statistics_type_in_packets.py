...
class TestNetworkInstanceIcmpStatisticsTypeInPackets(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTypeInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTypeInPackets:
        """Test NetworkInstanceIcmpStatisticsTypeInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTypeInPackets`
        """
        model = NetworkInstanceIcmpStatisticsTypeInPackets()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTypeInPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmpStatisticsTypeInPackets(self):
        """Test NetworkInstanceIcmpStatisticsTypeInPackets"""
