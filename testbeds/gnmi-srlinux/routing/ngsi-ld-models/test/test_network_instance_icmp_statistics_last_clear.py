...
class TestNetworkInstanceIcmpStatisticsLastClear(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsLastClear:
        """Test NetworkInstanceIcmpStatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsLastClear`
        """
        model = NetworkInstanceIcmpStatisticsLastClear()
        if include_optional:
            return NetworkInstanceIcmpStatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceIcmpStatisticsLastClear(self):
        """Test NetworkInstanceIcmpStatisticsLastClear"""
