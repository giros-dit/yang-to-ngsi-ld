...
class TestSystemLldpBgpAutoDiscoveryGroupId(unittest.TestCase):
    """SystemLldpBgpAutoDiscoveryGroupId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpBgpAutoDiscoveryGroupId:
        """Test SystemLldpBgpAutoDiscoveryGroupId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpBgpAutoDiscoveryGroupId`
        """
        model = SystemLldpBgpAutoDiscoveryGroupId()
        if include_optional:
            return SystemLldpBgpAutoDiscoveryGroupId(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpBgpAutoDiscoveryGroupId(self):
        """Test SystemLldpBgpAutoDiscoveryGroupId"""
