...
class TestNetworkInstanceRouteTableIpv4UnicastRouteId(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteId:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteId`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteId()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteId(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteId(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteId"""
