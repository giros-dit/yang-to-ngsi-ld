...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsRoutesWithPerPrefixStatistics"""
