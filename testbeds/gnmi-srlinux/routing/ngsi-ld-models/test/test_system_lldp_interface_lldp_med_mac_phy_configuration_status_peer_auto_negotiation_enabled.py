...
class TestSystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled(unittest.TestCase):
    """SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled:
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled`
        """
        model = SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled()
        if include_optional:
            return SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled(
                type = 'Property',
                value = 'unknown',
    ...
    def testSystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled(self):
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationEnabled"""
