...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain"""
