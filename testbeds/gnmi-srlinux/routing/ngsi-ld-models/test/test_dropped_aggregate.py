...
class TestDroppedAggregate(unittest.TestCase):
    """DroppedAggregate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DroppedAggregate:
        """Test DroppedAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DroppedAggregate`
        """
        model = DroppedAggregate()
        if include_optional:
            return DroppedAggregate(
                type = 'Property',
                value = 56,
