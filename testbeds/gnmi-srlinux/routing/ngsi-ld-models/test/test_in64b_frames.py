...
class TestIn64bFrames(unittest.TestCase):
    """In64bFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> In64bFrames:
        """Test In64bFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `In64bFrames`
        """
        model = In64bFrames()
        if include_optional:
            return In64bFrames(
