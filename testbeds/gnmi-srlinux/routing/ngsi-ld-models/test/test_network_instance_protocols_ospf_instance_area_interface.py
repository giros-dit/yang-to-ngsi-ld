...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterface(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterface:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterface`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterface()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterface(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterface(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterface"""
