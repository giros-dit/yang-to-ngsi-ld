...
class TestSystemLldpManagementAddressType(unittest.TestCase):
    """SystemLldpManagementAddressType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpManagementAddressType:
        """Test SystemLldpManagementAddressType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpManagementAddressType`
        """
        model = SystemLldpManagementAddressType()
        if include_optional:
            return SystemLldpManagementAddressType(
                type = 'Property',
                value = 'IPv4',
    ...
    def testSystemLldpManagementAddressType(self):
        """Test SystemLldpManagementAddressType"""
