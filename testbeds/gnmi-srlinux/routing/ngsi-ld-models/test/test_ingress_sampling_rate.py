...
class TestIngressSamplingRate(unittest.TestCase):
    """IngressSamplingRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IngressSamplingRate:
        """Test IngressSamplingRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IngressSamplingRate`
        """
        model = IngressSamplingRate()
        if include_optional:
            return IngressSamplingRate(
                type = 'Property',
                value = 0,
    ...
    def testIngressSamplingRate(self):
        """Test IngressSamplingRate"""
