...
class TestNetworkInstanceRouteTableNextHopIndirectUsable(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectUsable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectUsable:
        """Test NetworkInstanceRouteTableNextHopIndirectUsable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectUsable`
        """
        model = NetworkInstanceRouteTableNextHopIndirectUsable()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectUsable(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopIndirectUsable(self):
        """Test NetworkInstanceRouteTableNextHopIndirectUsable"""
