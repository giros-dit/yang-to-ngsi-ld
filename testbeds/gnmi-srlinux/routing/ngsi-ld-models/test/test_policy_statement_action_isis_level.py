...
class TestPolicyStatementActionIsisLevel(unittest.TestCase):
    """PolicyStatementActionIsisLevel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionIsisLevel:
        """Test PolicyStatementActionIsisLevel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionIsisLevel`
        """
        model = PolicyStatementActionIsisLevel()
        if include_optional:
            return PolicyStatementActionIsisLevel(
                type = 'Property',
                value = 56,
    ...
    def testPolicyStatementActionIsisLevel(self):
        """Test PolicyStatementActionIsisLevel"""
