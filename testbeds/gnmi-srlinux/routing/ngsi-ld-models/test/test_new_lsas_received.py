...
class TestNewLsasReceived(unittest.TestCase):
    """NewLsasReceived unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewLsasReceived:
        """Test NewLsasReceived
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewLsasReceived`
        """
        model = NewLsasReceived()
        if include_optional:
            return NewLsasReceived(
                type = 'Property',
                value = 56,
