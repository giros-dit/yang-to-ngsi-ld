...
class TestLinkLengthInformation(unittest.TestCase):
    """LinkLengthInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkLengthInformation:
        """Test LinkLengthInformation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkLengthInformation`
        """
        model = LinkLengthInformation()
        if include_optional:
            return LinkLengthInformation(
                type = 'Property',
                value = '',
    ...
    def testLinkLengthInformation(self):
        """Test LinkLengthInformation"""
