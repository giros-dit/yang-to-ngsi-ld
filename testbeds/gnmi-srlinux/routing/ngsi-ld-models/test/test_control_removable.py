...
class TestControlRemovable(unittest.TestCase):
    """ControlRemovable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlRemovable:
        """Test ControlRemovable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlRemovable`
        """
        model = ControlRemovable()
        if include_optional:
            return ControlRemovable(
                type = 'Property',
                value = True,
