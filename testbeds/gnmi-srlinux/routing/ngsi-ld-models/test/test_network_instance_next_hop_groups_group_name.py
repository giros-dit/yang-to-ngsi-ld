...
class TestNetworkInstanceNextHopGroupsGroupName(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupName:
        """Test NetworkInstanceNextHopGroupsGroupName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupName`
        """
        model = NetworkInstanceNextHopGroupsGroupName()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupName(self):
        """Test NetworkInstanceNextHopGroupsGroupName"""
