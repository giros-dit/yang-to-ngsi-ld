...
class TestLsaArrival(unittest.TestCase):
    """LsaArrival unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LsaArrival:
        """Test LsaArrival
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LsaArrival`
        """
        model = LsaArrival()
        if include_optional:
            return LsaArrival(
