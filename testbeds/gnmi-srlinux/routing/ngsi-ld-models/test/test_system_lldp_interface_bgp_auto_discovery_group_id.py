...
class TestSystemLldpInterfaceBgpAutoDiscoveryGroupId(unittest.TestCase):
    """SystemLldpInterfaceBgpAutoDiscoveryGroupId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceBgpAutoDiscoveryGroupId:
        """Test SystemLldpInterfaceBgpAutoDiscoveryGroupId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceBgpAutoDiscoveryGroupId`
        """
        model = SystemLldpInterfaceBgpAutoDiscoveryGroupId()
        if include_optional:
            return SystemLldpInterfaceBgpAutoDiscoveryGroupId(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceBgpAutoDiscoveryGroupId(self):
        """Test SystemLldpInterfaceBgpAutoDiscoveryGroupId"""
