...
class TestNetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader:
        """Test NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader(
                type = 'Property',
                value = 'gre',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader"""
