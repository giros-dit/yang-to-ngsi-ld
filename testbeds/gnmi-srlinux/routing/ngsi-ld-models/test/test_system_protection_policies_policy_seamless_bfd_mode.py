...
class TestSystemProtectionPoliciesPolicySeamlessBfdMode(unittest.TestCase):
    """SystemProtectionPoliciesPolicySeamlessBfdMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemProtectionPoliciesPolicySeamlessBfdMode:
        """Test SystemProtectionPoliciesPolicySeamlessBfdMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemProtectionPoliciesPolicySeamlessBfdMode`
        """
        model = SystemProtectionPoliciesPolicySeamlessBfdMode()
        if include_optional:
            return SystemProtectionPoliciesPolicySeamlessBfdMode(
                type = 'Property',
                value = 'monitored',
    ...
    def testSystemProtectionPoliciesPolicySeamlessBfdMode(self):
        """Test SystemProtectionPoliciesPolicySeamlessBfdMode"""
