...
class TestNetworkInstanceInterface(unittest.TestCase):
    """NetworkInstanceInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterface:
        """Test NetworkInstanceInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterface`
        """
        model = NetworkInstanceInterface()
        if include_optional:
    ...
    def testNetworkInstanceInterface(self):
        """Test NetworkInstanceInterface"""
