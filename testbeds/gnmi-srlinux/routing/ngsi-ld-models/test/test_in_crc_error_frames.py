...
class TestInCrcErrorFrames(unittest.TestCase):
    """InCrcErrorFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InCrcErrorFrames:
        """Test InCrcErrorFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InCrcErrorFrames`
        """
        model = InCrcErrorFrames()
        if include_optional:
            return InCrcErrorFrames(
                type = 'Property',
                value = 56,
