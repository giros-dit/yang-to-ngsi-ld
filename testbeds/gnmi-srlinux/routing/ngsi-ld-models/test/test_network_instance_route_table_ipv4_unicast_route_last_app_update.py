...
class TestNetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteLastAppUpdate"""
