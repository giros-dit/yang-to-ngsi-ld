...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId"""
