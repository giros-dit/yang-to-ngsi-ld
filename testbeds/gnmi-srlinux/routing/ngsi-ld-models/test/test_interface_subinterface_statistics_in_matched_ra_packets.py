...
class TestInterfaceSubinterfaceStatisticsInMatchedRaPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInMatchedRaPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInMatchedRaPackets:
        """Test InterfaceSubinterfaceStatisticsInMatchedRaPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInMatchedRaPackets`
        """
        model = InterfaceSubinterfaceStatisticsInMatchedRaPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInMatchedRaPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInMatchedRaPackets(self):
        """Test InterfaceSubinterfaceStatisticsInMatchedRaPackets"""
