...
class TestLinecardMdaLastBootedReason(unittest.TestCase):
    """LinecardMdaLastBootedReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaLastBootedReason:
        """Test LinecardMdaLastBootedReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaLastBootedReason`
        """
        model = LinecardMdaLastBootedReason()
        if include_optional:
            return LinecardMdaLastBootedReason(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaLastBootedReason(self):
        """Test LinecardMdaLastBootedReason"""
