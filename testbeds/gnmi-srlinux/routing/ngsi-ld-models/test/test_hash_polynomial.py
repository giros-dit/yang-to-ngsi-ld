...
class TestHashPolynomial(unittest.TestCase):
    """HashPolynomial unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HashPolynomial:
        """Test HashPolynomial
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HashPolynomial`
        """
        model = HashPolynomial()
        if include_optional:
            return HashPolynomial(
                type = 'Property',
                value = 1,
