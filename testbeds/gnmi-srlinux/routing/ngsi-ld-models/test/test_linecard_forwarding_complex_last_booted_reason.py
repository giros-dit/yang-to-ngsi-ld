...
class TestLinecardForwardingComplexLastBootedReason(unittest.TestCase):
    """LinecardForwardingComplexLastBootedReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexLastBootedReason:
        """Test LinecardForwardingComplexLastBootedReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexLastBootedReason`
        """
        model = LinecardForwardingComplexLastBootedReason()
        if include_optional:
            return LinecardForwardingComplexLastBootedReason(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexLastBootedReason(self):
        """Test LinecardForwardingComplexLastBootedReason"""
