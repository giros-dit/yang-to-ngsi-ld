...
class TestSystemLldpInterfaceStatisticsFrameDiscard(unittest.TestCase):
    """SystemLldpInterfaceStatisticsFrameDiscard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceStatisticsFrameDiscard:
        """Test SystemLldpInterfaceStatisticsFrameDiscard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceStatisticsFrameDiscard`
        """
        model = SystemLldpInterfaceStatisticsFrameDiscard()
        if include_optional:
            return SystemLldpInterfaceStatisticsFrameDiscard(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceStatisticsFrameDiscard(self):
        """Test SystemLldpInterfaceStatisticsFrameDiscard"""
