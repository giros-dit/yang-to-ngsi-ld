...
class TestSystemLldpInterfaceNeighborLldpMedInventory(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedInventory unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedInventory:
        """Test SystemLldpInterfaceNeighborLldpMedInventory
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedInventory`
        """
        model = SystemLldpInterfaceNeighborLldpMedInventory()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedInventory(
                id = '',
                type = 'SystemLldpInterfaceNeighborLldpMedInventory',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceNeighborLldpMedInventory(self):
        """Test SystemLldpInterfaceNeighborLldpMedInventory"""
