...
class TestNetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange:
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange"""
