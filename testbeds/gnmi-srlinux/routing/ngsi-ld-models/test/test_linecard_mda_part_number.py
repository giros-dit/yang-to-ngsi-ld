...
class TestLinecardMdaPartNumber(unittest.TestCase):
    """LinecardMdaPartNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaPartNumber:
        """Test LinecardMdaPartNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaPartNumber`
        """
        model = LinecardMdaPartNumber()
        if include_optional:
            return LinecardMdaPartNumber(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaPartNumber(self):
        """Test LinecardMdaPartNumber"""
