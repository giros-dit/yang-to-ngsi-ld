...
class TestManufacturerNumber(unittest.TestCase):
    """ManufacturerNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManufacturerNumber:
        """Test ManufacturerNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManufacturerNumber`
        """
        model = ManufacturerNumber()
        if include_optional:
    ...
    def testManufacturerNumber(self):
        """Test ManufacturerNumber"""
