...
class TestLinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify:
        """Test LinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressIpRoutesEntriesRemainingToModify"""
