...
class TestPolicyStatementActionBgpStandardCommunityMethod(unittest.TestCase):
    """PolicyStatementActionBgpStandardCommunityMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpStandardCommunityMethod:
        """Test PolicyStatementActionBgpStandardCommunityMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpStandardCommunityMethod`
        """
        model = PolicyStatementActionBgpStandardCommunityMethod()
        if include_optional:
            return PolicyStatementActionBgpStandardCommunityMethod(
                type = 'Property',
                value = 'reference',
    ...
    def testPolicyStatementActionBgpStandardCommunityMethod(self):
        """Test PolicyStatementActionBgpStandardCommunityMethod"""
