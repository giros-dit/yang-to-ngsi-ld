...
class TestLinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify:
        """Test LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify"""
