...
class TestNetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa:
        """Test NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa`
        """
        model = NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa(self):
        """Test NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa"""
