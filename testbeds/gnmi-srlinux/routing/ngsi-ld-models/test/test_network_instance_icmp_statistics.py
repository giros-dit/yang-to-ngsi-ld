...
class TestNetworkInstanceIcmpStatistics(unittest.TestCase):
    """NetworkInstanceIcmpStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatistics:
        """Test NetworkInstanceIcmpStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatistics`
        """
        model = NetworkInstanceIcmpStatistics()
        if include_optional:
            return NetworkInstanceIcmpStatistics(
                id = '',
                type = 'NetworkInstanceIcmpStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceIcmpStatistics(self):
        """Test NetworkInstanceIcmpStatistics"""
