...
class TestENssaLsa(unittest.TestCase):
    """ENssaLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ENssaLsa:
        """Test ENssaLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ENssaLsa`
        """
        model = ENssaLsa()
        if include_optional:
            return ENssaLsa(
