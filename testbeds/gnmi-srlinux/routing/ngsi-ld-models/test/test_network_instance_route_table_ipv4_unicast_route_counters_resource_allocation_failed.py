...
class TestNetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed"""
