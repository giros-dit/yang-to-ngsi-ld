...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfacePackets(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfacePackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfacePackets:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfacePackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfacePackets`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfacePackets()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfacePackets(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceAreaInterfacePackets',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                tx_total = None,
                tx_hello = None,
                tx_db_description = None,
                tx_ls_request = None,
                tx_ls_update = None,
                tx_ls_ack = None,
                rx_total = None,
                rx_hello = None,
                rx_db_description = None,
                rx_ls_request = None,
                rx_ls_update = None,
                rx_ls_ack = None,
                discarded = None,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfacePackets(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfacePackets"""
