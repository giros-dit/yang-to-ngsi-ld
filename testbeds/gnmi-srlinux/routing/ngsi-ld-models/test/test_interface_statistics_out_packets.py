...
class TestInterfaceStatisticsOutPackets(unittest.TestCase):
    """InterfaceStatisticsOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsOutPackets:
        """Test InterfaceStatisticsOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsOutPackets`
        """
        model = InterfaceStatisticsOutPackets()
        if include_optional:
            return InterfaceStatisticsOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStatisticsOutPackets(self):
        """Test InterfaceStatisticsOutPackets"""
