...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeType"""
