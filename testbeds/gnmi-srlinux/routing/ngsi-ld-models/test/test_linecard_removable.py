...
class TestLinecardRemovable(unittest.TestCase):
    """LinecardRemovable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardRemovable:
        """Test LinecardRemovable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardRemovable`
        """
        model = LinecardRemovable()
        if include_optional:
            return LinecardRemovable(
                type = 'Property',
                value = True,
    ...
    def testLinecardRemovable(self):
        """Test LinecardRemovable"""
