...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer(
                id = '',
                type = 'InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBer"""
