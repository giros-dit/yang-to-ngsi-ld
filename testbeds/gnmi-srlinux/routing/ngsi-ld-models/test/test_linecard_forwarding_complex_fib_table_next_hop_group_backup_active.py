...
class TestLinecardForwardingComplexFibTableNextHopGroupBackupActive(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroupBackupActive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroupBackupActive:
        """Test LinecardForwardingComplexFibTableNextHopGroupBackupActive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroupBackupActive`
        """
        model = LinecardForwardingComplexFibTableNextHopGroupBackupActive()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroupBackupActive(
                type = 'Property',
                value = True,
    ...
    def testLinecardForwardingComplexFibTableNextHopGroupBackupActive(self):
        """Test LinecardForwardingComplexFibTableNextHopGroupBackupActive"""
