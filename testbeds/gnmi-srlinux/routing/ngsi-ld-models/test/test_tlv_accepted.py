...
class TestTlvAccepted(unittest.TestCase):
    """TlvAccepted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TlvAccepted:
        """Test TlvAccepted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TlvAccepted`
        """
        model = TlvAccepted()
        if include_optional:
            return TlvAccepted(
