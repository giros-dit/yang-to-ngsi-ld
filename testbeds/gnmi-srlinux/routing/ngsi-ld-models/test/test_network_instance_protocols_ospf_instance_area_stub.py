...
class TestNetworkInstanceProtocolsOspfInstanceAreaStub(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaStub unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaStub:
        """Test NetworkInstanceProtocolsOspfInstanceAreaStub
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaStub`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaStub()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaStub(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaStub(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaStub"""
