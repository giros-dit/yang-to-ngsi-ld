...
class TestNetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType:
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType`
        """
        model = NetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType(self):
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingPendingOperationType"""
