...
class TestInterfaceEthernetFlowControl(unittest.TestCase):
    """InterfaceEthernetFlowControl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetFlowControl:
        """Test InterfaceEthernetFlowControl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetFlowControl`
        """
        model = InterfaceEthernetFlowControl()
        if include_optional:
            return InterfaceEthernetFlowControl(
                id = '',
    ...
    def testInterfaceEthernetFlowControl(self):
        """Test InterfaceEthernetFlowControl"""
