...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotals"""
