...
class TestSystemLldpAdminState(unittest.TestCase):
    """SystemLldpAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpAdminState:
        """Test SystemLldpAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpAdminState`
        """
        model = SystemLldpAdminState()
        if include_optional:
            return SystemLldpAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testSystemLldpAdminState(self):
        """Test SystemLldpAdminState"""
