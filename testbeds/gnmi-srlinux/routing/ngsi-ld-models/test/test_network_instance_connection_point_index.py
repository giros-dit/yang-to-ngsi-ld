...
class TestNetworkInstanceConnectionPointIndex(unittest.TestCase):
    """NetworkInstanceConnectionPointIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointIndex:
        """Test NetworkInstanceConnectionPointIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointIndex`
        """
        model = NetworkInstanceConnectionPointIndex()
        if include_optional:
            return NetworkInstanceConnectionPointIndex(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceConnectionPointIndex(self):
        """Test NetworkInstanceConnectionPointIndex"""
