...
class TestBadHelloInterval(unittest.TestCase):
    """BadHelloInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadHelloInterval:
        """Test BadHelloInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadHelloInterval`
        """
        model = BadHelloInterval()
        if include_optional:
            return BadHelloInterval(
                type = 'Property',
                value = 56,
