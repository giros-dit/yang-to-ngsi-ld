...
class TestInterfaceEthernetMacAddress(unittest.TestCase):
    """InterfaceEthernetMacAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetMacAddress:
        """Test InterfaceEthernetMacAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetMacAddress`
        """
        model = InterfaceEthernetMacAddress()
        if include_optional:
            return InterfaceEthernetMacAddress(
                type = 'Property',
    ...
    def testInterfaceEthernetMacAddress(self):
        """Test InterfaceEthernetMacAddress"""
