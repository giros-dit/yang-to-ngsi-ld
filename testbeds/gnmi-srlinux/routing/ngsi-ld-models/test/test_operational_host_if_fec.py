...
class TestOperationalHostIfFec(unittest.TestCase):
    """OperationalHostIfFec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalHostIfFec:
        """Test OperationalHostIfFec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalHostIfFec`
        """
        model = OperationalHostIfFec()
        if include_optional:
            return OperationalHostIfFec(
                type = 'Property',
                value = 'disabled',
    ...
    def testOperationalHostIfFec(self):
        """Test OperationalHostIfFec"""
