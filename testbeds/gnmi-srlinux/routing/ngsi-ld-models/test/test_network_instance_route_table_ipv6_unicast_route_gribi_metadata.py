...
class TestNetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata(
                type = 'Property',
                value = bytes(b'blah'),
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteGribiMetadata"""
