...
class TestNetworkInstanceConnectionPointPseudowireSignaling(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireSignaling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireSignaling:
        """Test NetworkInstanceConnectionPointPseudowireSignaling
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireSignaling`
        """
        model = NetworkInstanceConnectionPointPseudowireSignaling()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireSignaling(
                id = '',
                type = 'NetworkInstanceConnectionPointPseudowireSignaling',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                virtual_circuit_identifier = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceConnectionPointPseudowireSignaling(
    ...
    def testNetworkInstanceConnectionPointPseudowireSignaling(self):
        """Test NetworkInstanceConnectionPointPseudowireSignaling"""
