...
class TestLinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime:
        """Test LinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressIpRoutesLastSyncTime"""
