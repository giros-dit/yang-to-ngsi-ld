...
class TestSystemSrv6MicroSegment(unittest.TestCase):
    """SystemSrv6MicroSegment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6MicroSegment:
        """Test SystemSrv6MicroSegment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6MicroSegment`
        """
        model = SystemSrv6MicroSegment()
        if include_optional:
            return SystemSrv6MicroSegment(
                id = '',
                type = 'SystemSrv6MicroSegment',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6MicroSegment(self):
        """Test SystemSrv6MicroSegment"""
