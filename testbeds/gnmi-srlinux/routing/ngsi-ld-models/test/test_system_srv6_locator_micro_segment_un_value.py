...
class TestSystemSrv6LocatorMicroSegmentUnValue(unittest.TestCase):
    """SystemSrv6LocatorMicroSegmentUnValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorMicroSegmentUnValue:
        """Test SystemSrv6LocatorMicroSegmentUnValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorMicroSegmentUnValue`
        """
        model = SystemSrv6LocatorMicroSegmentUnValue()
        if include_optional:
            return SystemSrv6LocatorMicroSegmentUnValue(
                type = 'Property',
                value = 1,
    ...
    def testSystemSrv6LocatorMicroSegmentUnValue(self):
        """Test SystemSrv6LocatorMicroSegmentUnValue"""
