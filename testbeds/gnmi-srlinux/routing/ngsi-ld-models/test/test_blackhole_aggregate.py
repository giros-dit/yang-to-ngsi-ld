...
class TestBlackholeAggregate(unittest.TestCase):
    """BlackholeAggregate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlackholeAggregate:
        """Test BlackholeAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlackholeAggregate`
        """
        model = BlackholeAggregate()
        if include_optional:
            return BlackholeAggregate(
                type = 'Property',
                value = True,
    ...
    def testBlackholeAggregate(self):
        """Test BlackholeAggregate"""
