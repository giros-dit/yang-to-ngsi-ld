...
class TestSystemLldpStatisticsTlvDiscard(unittest.TestCase):
    """SystemLldpStatisticsTlvDiscard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpStatisticsTlvDiscard:
        """Test SystemLldpStatisticsTlvDiscard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpStatisticsTlvDiscard`
        """
        model = SystemLldpStatisticsTlvDiscard()
        if include_optional:
            return SystemLldpStatisticsTlvDiscard(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpStatisticsTlvDiscard(self):
        """Test SystemLldpStatisticsTlvDiscard"""
