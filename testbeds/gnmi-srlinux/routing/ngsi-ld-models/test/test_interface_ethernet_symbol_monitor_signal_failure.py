...
class TestInterfaceEthernetSymbolMonitorSignalFailure(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorSignalFailure unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorSignalFailure:
        """Test InterfaceEthernetSymbolMonitorSignalFailure
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorSignalFailure`
        """
        model = InterfaceEthernetSymbolMonitorSignalFailure()
        if include_optional:
            return InterfaceEthernetSymbolMonitorSignalFailure(
                id = '',
                type = 'InterfaceEthernetSymbolMonitorSignalFailure',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetSymbolMonitorSignalFailure(self):
        """Test InterfaceEthernetSymbolMonitorSignalFailure"""
