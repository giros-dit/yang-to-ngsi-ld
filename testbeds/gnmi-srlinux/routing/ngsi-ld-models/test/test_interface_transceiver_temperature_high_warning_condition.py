...
class TestInterfaceTransceiverTemperatureHighWarningCondition(unittest.TestCase):
    """InterfaceTransceiverTemperatureHighWarningCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureHighWarningCondition:
        """Test InterfaceTransceiverTemperatureHighWarningCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureHighWarningCondition`
        """
        model = InterfaceTransceiverTemperatureHighWarningCondition()
        if include_optional:
            return InterfaceTransceiverTemperatureHighWarningCondition(
                type = 'Property',
                value = True,
    ...
    def testInterfaceTransceiverTemperatureHighWarningCondition(self):
        """Test InterfaceTransceiverTemperatureHighWarningCondition"""
