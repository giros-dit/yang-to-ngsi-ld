...
class TestYANGIdentityIdentifier(unittest.TestCase):
    """YANGIdentityIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YANGIdentityIdentifier:
        """Test YANGIdentityIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YANGIdentityIdentifier`
        """
        model = YANGIdentityIdentifier()
        if include_optional:
            return YANGIdentityIdentifier(
                type = 'Property',
                value = '',
    ...
    def testYANGIdentityIdentifier(self):
        """Test YANGIdentityIdentifier"""
