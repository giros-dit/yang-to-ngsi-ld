...
class TestInterfaceEthernetCrcMonitor(unittest.TestCase):
    """InterfaceEthernetCrcMonitor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitor:
        """Test InterfaceEthernetCrcMonitor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitor`
        """
        model = InterfaceEthernetCrcMonitor()
        if include_optional:
            return InterfaceEthernetCrcMonitor(
                id = '',
                type = 'InterfaceEthernetCrcMonitor',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetCrcMonitor(self):
        """Test InterfaceEthernetCrcMonitor"""
