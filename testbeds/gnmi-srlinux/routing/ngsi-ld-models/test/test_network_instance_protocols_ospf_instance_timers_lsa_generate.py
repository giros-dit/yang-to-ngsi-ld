...
class TestNetworkInstanceProtocolsOspfInstanceTimersLsaGenerate(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate:
        """Test NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate`
        """
        model = NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate(
                id = '',
                ...
                max_lsa_wait = None,
                lsa_initial_wait = None,
                lsa_second_wait = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate(
    ...
    def testNetworkInstanceProtocolsOspfInstanceTimersLsaGenerate(self):
        """Test NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate"""
