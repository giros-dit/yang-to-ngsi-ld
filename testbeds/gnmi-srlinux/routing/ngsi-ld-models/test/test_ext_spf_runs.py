...
class TestExtSpfRuns(unittest.TestCase):
    """ExtSpfRuns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtSpfRuns:
        """Test ExtSpfRuns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtSpfRuns`
        """
        model = ExtSpfRuns()
        if include_optional:
            return ExtSpfRuns(
