...
class TestControlPowerRequired(unittest.TestCase):
    """ControlPowerRequired unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlPowerRequired:
        """Test ControlPowerRequired
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlPowerRequired`
        """
        model = ControlPowerRequired()
        if include_optional:
            return ControlPowerRequired(
                type = 'Property',
                value = 56,
    ...
    def testControlPowerRequired(self):
        """Test ControlPowerRequired"""
