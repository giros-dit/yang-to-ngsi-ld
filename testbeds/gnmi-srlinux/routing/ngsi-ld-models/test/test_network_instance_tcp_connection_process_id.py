...
class TestNetworkInstanceTcpConnectionProcessId(unittest.TestCase):
    """NetworkInstanceTcpConnectionProcessId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpConnectionProcessId:
        """Test NetworkInstanceTcpConnectionProcessId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpConnectionProcessId`
        """
        model = NetworkInstanceTcpConnectionProcessId()
        if include_optional:
            return NetworkInstanceTcpConnectionProcessId(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceTcpConnectionProcessId(self):
        """Test NetworkInstanceTcpConnectionProcessId"""
