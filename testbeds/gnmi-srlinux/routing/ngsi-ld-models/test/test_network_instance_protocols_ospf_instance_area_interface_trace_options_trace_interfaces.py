...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces"""
