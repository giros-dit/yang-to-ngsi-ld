...
class TestNetworkInstanceProtocolsOspfInstanceGracefulRestart(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceGracefulRestart unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceGracefulRestart:
        """Test NetworkInstanceProtocolsOspfInstanceGracefulRestart
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceGracefulRestart`
        """
        model = NetworkInstanceProtocolsOspfInstanceGracefulRestart()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceGracefulRestart(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceGracefulRestart(self):
        """Test NetworkInstanceProtocolsOspfInstanceGracefulRestart"""
