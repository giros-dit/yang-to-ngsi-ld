...
class TestAutoNegotiate(unittest.TestCase):
    """AutoNegotiate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AutoNegotiate:
        """Test AutoNegotiate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AutoNegotiate`
        """
        model = AutoNegotiate()
        if include_optional:
