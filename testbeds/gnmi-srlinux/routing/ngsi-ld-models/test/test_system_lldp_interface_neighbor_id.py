...
class TestSystemLldpInterfaceNeighborId(unittest.TestCase):
    """SystemLldpInterfaceNeighborId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborId:
        """Test SystemLldpInterfaceNeighborId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborId`
        """
        model = SystemLldpInterfaceNeighborId()
        if include_optional:
            return SystemLldpInterfaceNeighborId(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborId(self):
        """Test SystemLldpInterfaceNeighborId"""
