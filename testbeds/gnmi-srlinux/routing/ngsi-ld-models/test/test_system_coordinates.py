...
class TestSystemCoordinates(unittest.TestCase):
    """SystemCoordinates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemCoordinates:
        """Test SystemCoordinates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemCoordinates`
        """
        model = SystemCoordinates()
        if include_optional:
    ...
    def testSystemCoordinates(self):
        """Test SystemCoordinates"""
