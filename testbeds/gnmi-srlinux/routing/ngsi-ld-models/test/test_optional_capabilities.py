...
class TestOptionalCapabilities(unittest.TestCase):
    """OptionalCapabilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptionalCapabilities:
        """Test OptionalCapabilities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptionalCapabilities`
        """
        model = OptionalCapabilities()
        if include_optional:
    ...
    def testOptionalCapabilities(self):
        """Test OptionalCapabilities"""
