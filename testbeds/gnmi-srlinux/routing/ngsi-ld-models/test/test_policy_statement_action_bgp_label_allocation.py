...
class TestPolicyStatementActionBgpLabelAllocation(unittest.TestCase):
    """PolicyStatementActionBgpLabelAllocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpLabelAllocation:
        """Test PolicyStatementActionBgpLabelAllocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpLabelAllocation`
        """
        model = PolicyStatementActionBgpLabelAllocation()
        if include_optional:
            return PolicyStatementActionBgpLabelAllocation(
                id = '',
                type = 'PolicyStatementActionBgpLabelAllocation',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpLabelAllocation(self):
        """Test PolicyStatementActionBgpLabelAllocation"""
