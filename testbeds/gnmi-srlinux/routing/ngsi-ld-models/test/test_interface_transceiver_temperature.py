...
class TestInterfaceTransceiverTemperature(unittest.TestCase):
    """InterfaceTransceiverTemperature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperature:
        """Test InterfaceTransceiverTemperature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperature`
        """
        model = InterfaceTransceiverTemperature()
        if include_optional:
            return InterfaceTransceiverTemperature(
                id = '',
                type = 'InterfaceTransceiverTemperature',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                maximum = None,
                maximum_time = None,
                high_alarm_condition = None,
                high_alarm_threshold = None,
                low_alarm_condition = None,
                low_alarm_threshold = None,
                high_warning_condition = None,
                high_warning_threshold = None,
                low_warning_condition = None,
                low_warning_threshold = None,
                is_part_of = None
            )
        else:
            return InterfaceTransceiverTemperature(
    ...
    def testInterfaceTransceiverTemperature(self):
        """Test InterfaceTransceiverTemperature"""
