...
class TestNetworkInstanceSystemIpv6AddressOperState(unittest.TestCase):
    """NetworkInstanceSystemIpv6AddressOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceSystemIpv6AddressOperState:
        """Test NetworkInstanceSystemIpv6AddressOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceSystemIpv6AddressOperState`
        """
        model = NetworkInstanceSystemIpv6AddressOperState()
        if include_optional:
            return NetworkInstanceSystemIpv6AddressOperState(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceSystemIpv6AddressOperState(self):
        """Test NetworkInstanceSystemIpv6AddressOperState"""
