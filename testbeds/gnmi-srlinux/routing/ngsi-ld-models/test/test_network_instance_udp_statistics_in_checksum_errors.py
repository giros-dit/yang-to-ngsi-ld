...
class TestNetworkInstanceUdpStatisticsInChecksumErrors(unittest.TestCase):
    """NetworkInstanceUdpStatisticsInChecksumErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpStatisticsInChecksumErrors:
        """Test NetworkInstanceUdpStatisticsInChecksumErrors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpStatisticsInChecksumErrors`
        """
        model = NetworkInstanceUdpStatisticsInChecksumErrors()
        if include_optional:
            return NetworkInstanceUdpStatisticsInChecksumErrors(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceUdpStatisticsInChecksumErrors(self):
        """Test NetworkInstanceUdpStatisticsInChecksumErrors"""
