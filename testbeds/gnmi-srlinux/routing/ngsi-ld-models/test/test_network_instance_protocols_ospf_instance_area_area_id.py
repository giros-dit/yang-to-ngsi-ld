...
class TestNetworkInstanceProtocolsOspfInstanceAreaAreaId(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaAreaId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaAreaId:
        """Test NetworkInstanceProtocolsOspfInstanceAreaAreaId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaAreaId`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaAreaId()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaAreaId(
                type = 'Property',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaAreaId(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaAreaId"""
