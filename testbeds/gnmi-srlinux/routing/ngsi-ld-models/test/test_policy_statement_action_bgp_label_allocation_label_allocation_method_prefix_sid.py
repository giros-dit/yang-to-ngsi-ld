...
class TestPolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid(unittest.TestCase):
    """PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid:
        """Test PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid`
        """
        model = PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid()
        if include_optional:
            return PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid(
                id = '',
                type = 'PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid(self):
        """Test PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid"""
