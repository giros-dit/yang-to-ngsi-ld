...
class TestSystemLldpInterfaceNeighborChassisIdType(unittest.TestCase):
    """SystemLldpInterfaceNeighborChassisIdType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborChassisIdType:
        """Test SystemLldpInterfaceNeighborChassisIdType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborChassisIdType`
        """
        model = SystemLldpInterfaceNeighborChassisIdType()
        if include_optional:
            return SystemLldpInterfaceNeighborChassisIdType(
                type = 'Property',
                value = 'MAC_ADDRESS',
    ...
    def testSystemLldpInterfaceNeighborChassisIdType(self):
        """Test SystemLldpInterfaceNeighborChassisIdType"""
