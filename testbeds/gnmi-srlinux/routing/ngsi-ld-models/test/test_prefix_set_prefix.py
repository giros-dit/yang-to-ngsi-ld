...
class TestPrefixSetPrefix(unittest.TestCase):
    """PrefixSetPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrefixSetPrefix:
        """Test PrefixSetPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrefixSetPrefix`
        """
        model = PrefixSetPrefix()
        if include_optional:
            return PrefixSetPrefix(
                id = '',
