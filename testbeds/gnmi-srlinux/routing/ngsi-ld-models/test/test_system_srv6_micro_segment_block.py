...
class TestSystemSrv6MicroSegmentBlock(unittest.TestCase):
    """SystemSrv6MicroSegmentBlock unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6MicroSegmentBlock:
        """Test SystemSrv6MicroSegmentBlock
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6MicroSegmentBlock`
        """
        model = SystemSrv6MicroSegmentBlock()
        if include_optional:
            return SystemSrv6MicroSegmentBlock(
                id = '',
                type = 'SystemSrv6MicroSegmentBlock',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6MicroSegmentBlock(self):
        """Test SystemSrv6MicroSegmentBlock"""
