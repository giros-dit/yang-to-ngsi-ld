...
class TestOverloadRemInterval(unittest.TestCase):
    """OverloadRemInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverloadRemInterval:
        """Test OverloadRemInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverloadRemInterval`
        """
        model = OverloadRemInterval()
        if include_optional:
            return OverloadRemInterval(
                type = 'Property',
                value = 0,
    ...
    def testOverloadRemInterval(self):
        """Test OverloadRemInterval"""
