...
class TestNetworkInstance(unittest.TestCase):
    """NetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstance:
        """Test NetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstance`
        """
        ...
        if include_optional:
            return NetworkInstance(
                ...
                name = None,
                networkinstance_type = None,
                admin_state = None,
                oper_state = None,
                oper_down_reason = None,
                oper_mac_vrf_mtu = None,
                oper_vpws_mtu = None,
                description = None,
                router_id = None
            )
