...
class TestNetworkInstanceNextHopGroupsGroupNexthopInterfaceRef(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef:
        """Test NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef(
                id = '',
                type = 'NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopInterfaceRef(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef"""
