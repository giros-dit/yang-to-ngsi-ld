...
class TestNetworkInstanceSystemIpv6AddressOperDownReason(unittest.TestCase):
    """NetworkInstanceSystemIpv6AddressOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceSystemIpv6AddressOperDownReason:
        """Test NetworkInstanceSystemIpv6AddressOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceSystemIpv6AddressOperDownReason`
        """
        model = NetworkInstanceSystemIpv6AddressOperDownReason()
        if include_optional:
            return NetworkInstanceSystemIpv6AddressOperDownReason(
                type = 'Property',
                value = 'system-interface-not-bound',
    ...
    def testNetworkInstanceSystemIpv6AddressOperDownReason(self):
        """Test NetworkInstanceSystemIpv6AddressOperDownReason"""
