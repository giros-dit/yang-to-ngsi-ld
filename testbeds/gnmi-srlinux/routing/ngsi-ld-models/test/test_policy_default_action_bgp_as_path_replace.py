...
class TestPolicyDefaultActionBgpAsPathReplace(unittest.TestCase):
    """PolicyDefaultActionBgpAsPathReplace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpAsPathReplace:
        """Test PolicyDefaultActionBgpAsPathReplace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpAsPathReplace`
        """
        model = PolicyDefaultActionBgpAsPathReplace()
        if include_optional:
            return PolicyDefaultActionBgpAsPathReplace(
                type = 'Property',
                value = 56,
    ...
    def testPolicyDefaultActionBgpAsPathReplace(self):
        """Test PolicyDefaultActionBgpAsPathReplace"""
