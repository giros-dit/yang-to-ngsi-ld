...
class TestNetworkInstanceRouteTableNextHopGroupFibProgramming(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupFibProgramming unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupFibProgramming:
        """Test NetworkInstanceRouteTableNextHopGroupFibProgramming
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupFibProgramming`
        """
        model = NetworkInstanceRouteTableNextHopGroupFibProgramming()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupFibProgramming(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopGroupFibProgramming',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopGroupFibProgramming(self):
        """Test NetworkInstanceRouteTableNextHopGroupFibProgramming"""
