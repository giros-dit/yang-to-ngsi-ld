...
class TestLinecardSerialNumber(unittest.TestCase):
    """LinecardSerialNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardSerialNumber:
        """Test LinecardSerialNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardSerialNumber`
        """
        model = LinecardSerialNumber()
        if include_optional:
            return LinecardSerialNumber(
                type = 'Property',
                value = '',
    ...
    def testLinecardSerialNumber(self):
        """Test LinecardSerialNumber"""
