...
class TestLastOverflowExitTime(unittest.TestCase):
    """LastOverflowExitTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastOverflowExitTime:
        """Test LastOverflowExitTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastOverflowExitTime`
        """
        model = LastOverflowExitTime()
        if include_optional:
            return LastOverflowExitTime(
                type = 'Property',
                value = '',
    ...
    def testLastOverflowExitTime(self):
        """Test LastOverflowExitTime"""
