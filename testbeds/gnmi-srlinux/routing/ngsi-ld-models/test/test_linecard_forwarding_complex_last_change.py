...
class TestLinecardForwardingComplexLastChange(unittest.TestCase):
    """LinecardForwardingComplexLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexLastChange:
        """Test LinecardForwardingComplexLastChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexLastChange`
        """
        model = LinecardForwardingComplexLastChange()
        if include_optional:
            return LinecardForwardingComplexLastChange(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexLastChange(self):
        """Test LinecardForwardingComplexLastChange"""
