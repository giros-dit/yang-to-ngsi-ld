...
class TestNetworkInstanceProtocolsOspfInstanceLastEnabledTime(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLastEnabledTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLastEnabledTime:
        """Test NetworkInstanceProtocolsOspfInstanceLastEnabledTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLastEnabledTime`
        """
        model = NetworkInstanceProtocolsOspfInstanceLastEnabledTime()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLastEnabledTime(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceLastEnabledTime(self):
        """Test NetworkInstanceProtocolsOspfInstanceLastEnabledTime"""
