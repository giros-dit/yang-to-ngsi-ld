...
class TestInterfaceEthernetCrcMonitorAdminState(unittest.TestCase):
    """InterfaceEthernetCrcMonitorAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitorAdminState:
        """Test InterfaceEthernetCrcMonitorAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitorAdminState`
        """
        model = InterfaceEthernetCrcMonitorAdminState()
        if include_optional:
            return InterfaceEthernetCrcMonitorAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testInterfaceEthernetCrcMonitorAdminState(self):
        """Test InterfaceEthernetCrcMonitorAdminState"""
