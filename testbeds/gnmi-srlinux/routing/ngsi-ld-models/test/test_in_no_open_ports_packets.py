...
class TestInNoOpenPortsPackets(unittest.TestCase):
    """InNoOpenPortsPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InNoOpenPortsPackets:
        """Test InNoOpenPortsPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InNoOpenPortsPackets`
        """
        model = InNoOpenPortsPackets()
        if include_optional:
            return InNoOpenPortsPackets(
                type = 'Property',
                value = 56,
    ...
    def testInNoOpenPortsPackets(self):
        """Test InNoOpenPortsPackets"""
