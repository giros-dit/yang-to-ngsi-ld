...
class TestInterfaceSflowAdminState(unittest.TestCase):
    """InterfaceSflowAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSflowAdminState:
        """Test InterfaceSflowAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSflowAdminState`
        """
        model = InterfaceSflowAdminState()
        if include_optional:
            return InterfaceSflowAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testInterfaceSflowAdminState(self):
        """Test InterfaceSflowAdminState"""
