...
class TestLinecardForwardingComplexFibTableNextHopGroupNextHopId(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroupNextHopId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroupNextHopId:
        """Test LinecardForwardingComplexFibTableNextHopGroupNextHopId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroupNextHopId`
        """
        model = LinecardForwardingComplexFibTableNextHopGroupNextHopId()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroupNextHopId(
                type = 'Property',
                value = 0,
    ...
    def testLinecardForwardingComplexFibTableNextHopGroupNextHopId(self):
        """Test LinecardForwardingComplexFibTableNextHopGroupNextHopId"""
