...
class TestControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify:
        """Test ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify(
                type = 'Property',
                value = 56,
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify"""
