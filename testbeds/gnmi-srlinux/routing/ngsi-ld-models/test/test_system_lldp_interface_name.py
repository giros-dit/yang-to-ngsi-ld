...
class TestSystemLldpInterfaceName(unittest.TestCase):
    """SystemLldpInterfaceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceName:
        """Test SystemLldpInterfaceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceName`
        """
        model = SystemLldpInterfaceName()
        if include_optional:
            return SystemLldpInterfaceName(
                type = 'Relationship',
                object = '',
    ...
    def testSystemLldpInterfaceName(self):
        """Test SystemLldpInterfaceName"""
