...
class TestNetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType(
                id = '',
                type = 'NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType"""
