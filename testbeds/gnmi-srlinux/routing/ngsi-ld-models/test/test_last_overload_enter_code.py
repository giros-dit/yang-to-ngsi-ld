...
class TestLastOverloadEnterCode(unittest.TestCase):
    """LastOverloadEnterCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastOverloadEnterCode:
        """Test LastOverloadEnterCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastOverloadEnterCode`
        """
        model = LastOverloadEnterCode()
        if include_optional:
            return LastOverloadEnterCode(
                type = 'Property',
                value = 'none',
    ...
    def testLastOverloadEnterCode(self):
        """Test LastOverloadEnterCode"""
