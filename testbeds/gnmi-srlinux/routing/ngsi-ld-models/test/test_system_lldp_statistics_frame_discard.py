...
class TestSystemLldpStatisticsFrameDiscard(unittest.TestCase):
    """SystemLldpStatisticsFrameDiscard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpStatisticsFrameDiscard:
        """Test SystemLldpStatisticsFrameDiscard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpStatisticsFrameDiscard`
        """
        model = SystemLldpStatisticsFrameDiscard()
        if include_optional:
            return SystemLldpStatisticsFrameDiscard(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpStatisticsFrameDiscard(self):
        """Test SystemLldpStatisticsFrameDiscard"""
