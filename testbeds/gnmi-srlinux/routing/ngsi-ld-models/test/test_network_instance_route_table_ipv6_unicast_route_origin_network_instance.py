...
class TestNetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteOriginNetworkInstance"""
