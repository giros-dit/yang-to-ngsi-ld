...
class TestReachableLsOnly(unittest.TestCase):
    """ReachableLsOnly unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReachableLsOnly:
        """Test ReachableLsOnly
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReachableLsOnly`
        """
        model = ReachableLsOnly()
        if include_optional:
            return ReachableLsOnly(
                type = 'Property',
                value = True,
