...
class TestInterfaceTransceiverVoltageLowAlarmCondition(unittest.TestCase):
    """InterfaceTransceiverVoltageLowAlarmCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageLowAlarmCondition:
        """Test InterfaceTransceiverVoltageLowAlarmCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageLowAlarmCondition`
        """
        model = InterfaceTransceiverVoltageLowAlarmCondition()
        if include_optional:
            return InterfaceTransceiverVoltageLowAlarmCondition(
                type = 'Property',
                value = True,
    ...
    def testInterfaceTransceiverVoltageLowAlarmCondition(self):
        """Test InterfaceTransceiverVoltageLowAlarmCondition"""
