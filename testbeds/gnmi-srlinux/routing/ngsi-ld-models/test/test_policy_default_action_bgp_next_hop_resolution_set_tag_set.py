...
class TestPolicyDefaultActionBgpNextHopResolutionSetTagSet(unittest.TestCase):
    """PolicyDefaultActionBgpNextHopResolutionSetTagSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpNextHopResolutionSetTagSet:
        """Test PolicyDefaultActionBgpNextHopResolutionSetTagSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpNextHopResolutionSetTagSet`
        """
        model = PolicyDefaultActionBgpNextHopResolutionSetTagSet()
        if include_optional:
            return PolicyDefaultActionBgpNextHopResolutionSetTagSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyDefaultActionBgpNextHopResolutionSetTagSet(self):
        """Test PolicyDefaultActionBgpNextHopResolutionSetTagSet"""
