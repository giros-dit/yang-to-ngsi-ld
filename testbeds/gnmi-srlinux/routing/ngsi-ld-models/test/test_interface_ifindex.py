...
class TestInterfaceIfindex(unittest.TestCase):
    """InterfaceIfindex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceIfindex:
        """Test InterfaceIfindex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceIfindex`
        """
        model = InterfaceIfindex()
        if include_optional:
            return InterfaceIfindex(
                type = 'Property',
                value = 56,
