...
class TestNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationType"""
