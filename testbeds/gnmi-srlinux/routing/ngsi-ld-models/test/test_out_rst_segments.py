...
class TestOutRstSegments(unittest.TestCase):
    """OutRstSegments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutRstSegments:
        """Test OutRstSegments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutRstSegments`
        """
        model = OutRstSegments()
        if include_optional:
            return OutRstSegments(
                type = 'Property',
                value = 56,
