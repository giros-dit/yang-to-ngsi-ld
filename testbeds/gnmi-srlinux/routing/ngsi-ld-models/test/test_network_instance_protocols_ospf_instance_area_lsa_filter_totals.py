...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                export_filtered = None,
                import_filtered = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals(
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals"""
