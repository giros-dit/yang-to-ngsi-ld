...
class TestLinecardCleiCode(unittest.TestCase):
    """LinecardCleiCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardCleiCode:
        """Test LinecardCleiCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardCleiCode`
        """
        model = LinecardCleiCode()
        if include_optional:
            return LinecardCleiCode(
                type = 'Property',
                value = '',
