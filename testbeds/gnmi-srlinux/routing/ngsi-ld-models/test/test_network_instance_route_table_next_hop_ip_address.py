...
class TestNetworkInstanceRouteTableNextHopIpAddress(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIpAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIpAddress:
        """Test NetworkInstanceRouteTableNextHopIpAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIpAddress`
        """
        model = NetworkInstanceRouteTableNextHopIpAddress()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIpAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopIpAddress(self):
        """Test NetworkInstanceRouteTableNextHopIpAddress"""
