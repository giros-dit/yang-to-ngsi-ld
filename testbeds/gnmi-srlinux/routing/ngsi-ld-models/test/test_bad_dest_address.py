...
class TestBadDestAddress(unittest.TestCase):
    """BadDestAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadDestAddress:
        """Test BadDestAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadDestAddress`
        """
        model = BadDestAddress()
        if include_optional:
            return BadDestAddress(
                type = 'Property',
                value = 56,
