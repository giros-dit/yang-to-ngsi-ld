...
class TestNetworkInstanceTrafficEngineering(unittest.TestCase):
    """NetworkInstanceTrafficEngineering unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineering:
        """Test NetworkInstanceTrafficEngineering
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineering`
        """
        model = NetworkInstanceTrafficEngineering()
        if include_optional:
            return NetworkInstanceTrafficEngineering(
                id = '',
    ...
    def testNetworkInstanceTrafficEngineering(self):
        """Test NetworkInstanceTrafficEngineering"""
