...
class TestLinecardForwardingComplexFibTableNextHopGroupNextHopNextHop(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop:
        """Test LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop`
        """
        model = LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexFibTableNextHopGroupNextHopNextHop(self):
        """Test LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop"""
