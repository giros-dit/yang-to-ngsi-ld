...
class TestNetworkInstanceConnectionPointPseudowireLastChange(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireLastChange:
        """Test NetworkInstanceConnectionPointPseudowireLastChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireLastChange`
        """
        model = NetworkInstanceConnectionPointPseudowireLastChange()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireLastChange(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceConnectionPointPseudowireLastChange(self):
        """Test NetworkInstanceConnectionPointPseudowireLastChange"""
