...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType(
                type = 'Property',
                value = 'all',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType"""
