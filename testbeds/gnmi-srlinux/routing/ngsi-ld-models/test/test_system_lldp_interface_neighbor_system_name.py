...
class TestSystemLldpInterfaceNeighborSystemName(unittest.TestCase):
    """SystemLldpInterfaceNeighborSystemName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborSystemName:
        """Test SystemLldpInterfaceNeighborSystemName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborSystemName`
        """
        model = SystemLldpInterfaceNeighborSystemName()
        if include_optional:
            return SystemLldpInterfaceNeighborSystemName(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborSystemName(self):
        """Test SystemLldpInterfaceNeighborSystemName"""
