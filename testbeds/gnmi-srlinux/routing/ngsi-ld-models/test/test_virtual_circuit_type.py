...
class TestVirtualCircuitType(unittest.TestCase):
    """VirtualCircuitType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualCircuitType:
        """Test VirtualCircuitType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualCircuitType`
        """
    ...
    def testVirtualCircuitType(self):
        """Test VirtualCircuitType"""
