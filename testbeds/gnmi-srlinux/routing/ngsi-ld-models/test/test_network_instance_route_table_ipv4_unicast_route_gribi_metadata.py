...
class TestNetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata(
                type = 'Property',
                value = bytes(b'blah'),
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteGribiMetadata"""
