...
class TestNetworkInstanceNextHopGroupsGroupNexthopIndex(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopIndex:
        """Test NetworkInstanceNextHopGroupsGroupNexthopIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopIndex`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopIndex()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopIndex(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopIndex(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopIndex"""
