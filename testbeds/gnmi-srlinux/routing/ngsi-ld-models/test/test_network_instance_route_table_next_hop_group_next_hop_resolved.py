...
class TestNetworkInstanceRouteTableNextHopGroupNextHopResolved(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupNextHopResolved unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupNextHopResolved:
        """Test NetworkInstanceRouteTableNextHopGroupNextHopResolved
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupNextHopResolved`
        """
        model = NetworkInstanceRouteTableNextHopGroupNextHopResolved()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupNextHopResolved(
                type = 'Property',
                value = 'true',
    ...
    def testNetworkInstanceRouteTableNextHopGroupNextHopResolved(self):
        """Test NetworkInstanceRouteTableNextHopGroupNextHopResolved"""
