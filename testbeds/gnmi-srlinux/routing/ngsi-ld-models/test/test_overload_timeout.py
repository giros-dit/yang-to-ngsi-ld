...
class TestOverloadTimeout(unittest.TestCase):
    """OverloadTimeout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverloadTimeout:
        """Test OverloadTimeout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverloadTimeout`
        """
        model = OverloadTimeout()
        if include_optional:
            return OverloadTimeout(
                type = 'Property',
                value = 1,
