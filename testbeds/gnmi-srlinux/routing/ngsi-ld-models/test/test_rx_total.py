...
class TestRxTotal(unittest.TestCase):
    """RxTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RxTotal:
        """Test RxTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RxTotal`
        """
        model = RxTotal()
        if include_optional:
            return RxTotal(
