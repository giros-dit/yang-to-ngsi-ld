...
class TestNetworkInstanceIcmp6StatisticsTotalOutErrorPackets(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTotalOutErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTotalOutErrorPackets:
        """Test NetworkInstanceIcmp6StatisticsTotalOutErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTotalOutErrorPackets`
        """
        model = NetworkInstanceIcmp6StatisticsTotalOutErrorPackets()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTotalOutErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmp6StatisticsTotalOutErrorPackets(self):
        """Test NetworkInstanceIcmp6StatisticsTotalOutErrorPackets"""
