...
class TestNetworkInstanceBridgeTableMacLimitWarningThresholdPct(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLimitWarningThresholdPct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLimitWarningThresholdPct:
        """Test NetworkInstanceBridgeTableMacLimitWarningThresholdPct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLimitWarningThresholdPct`
        """
        model = NetworkInstanceBridgeTableMacLimitWarningThresholdPct()
        if include_optional:
            return NetworkInstanceBridgeTableMacLimitWarningThresholdPct(
                type = 'Property',
                value = 6,
    ...
    def testNetworkInstanceBridgeTableMacLimitWarningThresholdPct(self):
        """Test NetworkInstanceBridgeTableMacLimitWarningThresholdPct"""
