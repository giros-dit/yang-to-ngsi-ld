...
class TestInterfaceEthernetHoldTime(unittest.TestCase):
    """InterfaceEthernetHoldTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetHoldTime:
        """Test InterfaceEthernetHoldTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetHoldTime`
        """
        model = InterfaceEthernetHoldTime()
        if include_optional:
            return InterfaceEthernetHoldTime(
                id = '',
                type = 'InterfaceEthernetHoldTime',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetHoldTime(self):
        """Test InterfaceEthernetHoldTime"""
