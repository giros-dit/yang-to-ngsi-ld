...
class TestInterfaceSubinterfaceIpv6StatisticsInErrorPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInErrorPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsInErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInErrorPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInErrorPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInErrorPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInErrorPackets"""
