...
class TestPolicyDefaultActionBgpNextHop(unittest.TestCase):
    """PolicyDefaultActionBgpNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpNextHop:
        """Test PolicyDefaultActionBgpNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpNextHop`
        """
        model = PolicyDefaultActionBgpNextHop()
        if include_optional:
            return PolicyDefaultActionBgpNextHop(
                id = '',
                type = 'PolicyDefaultActionBgpNextHop',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpNextHop(self):
        """Test PolicyDefaultActionBgpNextHop"""
