...
class TestSystemLldpChassisId(unittest.TestCase):
    """SystemLldpChassisId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpChassisId:
        """Test SystemLldpChassisId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpChassisId`
        """
        model = SystemLldpChassisId()
        if include_optional:
            return SystemLldpChassisId(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpChassisId(self):
        """Test SystemLldpChassisId"""
