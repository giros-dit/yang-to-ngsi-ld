...
class TestExtendedCommunitySet(unittest.TestCase):
    """ExtendedCommunitySet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExtendedCommunitySet:
        """Test ExtendedCommunitySet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExtendedCommunitySet`
        """
        model = ExtendedCommunitySet()
        if include_optional:
            return ExtendedCommunitySet(
                id = '',
                type = 'ExtendedCommunitySet',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testExtendedCommunitySet(self):
        """Test ExtendedCommunitySet"""
