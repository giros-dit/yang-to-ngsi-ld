...
class TestNetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime:
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime`
        """
        model = NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime(self):
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime"""
