...
class TestTagSetTagValue(unittest.TestCase):
    """TagSetTagValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagSetTagValue:
        """Test TagSetTagValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagSetTagValue`
        """
        model = TagSetTagValue()
        if include_optional:
            return TagSetTagValue(
                type = 'Property',
                value = '',
