...
class TestNetworkInstanceInterfaceConnectionPoint(unittest.TestCase):
    """NetworkInstanceInterfaceConnectionPoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceConnectionPoint:
        """Test NetworkInstanceInterfaceConnectionPoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceConnectionPoint`
        """
        model = NetworkInstanceInterfaceConnectionPoint()
        if include_optional:
            return NetworkInstanceInterfaceConnectionPoint(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceInterfaceConnectionPoint(self):
        """Test NetworkInstanceInterfaceConnectionPoint"""
