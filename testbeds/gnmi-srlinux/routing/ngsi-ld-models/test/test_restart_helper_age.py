...
class TestRestartHelperAge(unittest.TestCase):
    """RestartHelperAge unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestartHelperAge:
        """Test RestartHelperAge
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestartHelperAge`
        """
        model = RestartHelperAge()
        if include_optional:
            return RestartHelperAge(
                type = 'Property',
                value = 0,
