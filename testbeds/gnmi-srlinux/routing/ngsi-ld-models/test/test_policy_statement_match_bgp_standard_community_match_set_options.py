...
class TestPolicyStatementMatchBgpStandardCommunityMatchSetOptions(unittest.TestCase):
    """PolicyStatementMatchBgpStandardCommunityMatchSetOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpStandardCommunityMatchSetOptions:
        """Test PolicyStatementMatchBgpStandardCommunityMatchSetOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpStandardCommunityMatchSetOptions`
        """
        model = PolicyStatementMatchBgpStandardCommunityMatchSetOptions()
        if include_optional:
            return PolicyStatementMatchBgpStandardCommunityMatchSetOptions(
                type = 'Property',
                value = 'any',
    ...
    def testPolicyStatementMatchBgpStandardCommunityMatchSetOptions(self):
        """Test PolicyStatementMatchBgpStandardCommunityMatchSetOptions"""
