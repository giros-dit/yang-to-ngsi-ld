...
class TestPolicyDefaultActionBgpAsPathPrependAsNumber(unittest.TestCase):
    """PolicyDefaultActionBgpAsPathPrependAsNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpAsPathPrependAsNumber:
        """Test PolicyDefaultActionBgpAsPathPrependAsNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpAsPathPrependAsNumber`
        """
        model = PolicyDefaultActionBgpAsPathPrependAsNumber()
        if include_optional:
            return PolicyDefaultActionBgpAsPathPrependAsNumber(
                type = 'Property',
                value = '',
    ...
    def testPolicyDefaultActionBgpAsPathPrependAsNumber(self):
        """Test PolicyDefaultActionBgpAsPathPrependAsNumber"""
