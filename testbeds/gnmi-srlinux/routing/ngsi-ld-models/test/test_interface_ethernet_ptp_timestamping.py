...
class TestInterfaceEthernetPtpTimestamping(unittest.TestCase):
    """InterfaceEthernetPtpTimestamping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetPtpTimestamping:
        """Test InterfaceEthernetPtpTimestamping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetPtpTimestamping`
        """
        model = InterfaceEthernetPtpTimestamping()
        if include_optional:
            return InterfaceEthernetPtpTimestamping(
                id = '',
                type = 'InterfaceEthernetPtpTimestamping',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetPtpTimestamping(self):
        """Test InterfaceEthernetPtpTimestamping"""
