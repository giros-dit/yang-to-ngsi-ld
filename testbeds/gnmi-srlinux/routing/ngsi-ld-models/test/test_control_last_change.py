...
class TestControlLastChange(unittest.TestCase):
    """ControlLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlLastChange:
        """Test ControlLastChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlLastChange`
        """
        model = ControlLastChange()
        if include_optional:
            return ControlLastChange(
                type = 'Property',
                value = '',
    ...
    def testControlLastChange(self):
        """Test ControlLastChange"""
