...
class TestTotalCapacity(unittest.TestCase):
    """TotalCapacity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotalCapacity:
        """Test TotalCapacity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotalCapacity`
        """
        model = TotalCapacity()
        if include_optional:
