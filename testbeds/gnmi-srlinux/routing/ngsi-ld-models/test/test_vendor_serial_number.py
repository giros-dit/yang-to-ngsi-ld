...
class TestVendorSerialNumber(unittest.TestCase):
    """VendorSerialNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VendorSerialNumber:
        """Test VendorSerialNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VendorSerialNumber`
        """
        model = VendorSerialNumber()
        if include_optional:
    ...
    def testVendorSerialNumber(self):
        """Test VendorSerialNumber"""
