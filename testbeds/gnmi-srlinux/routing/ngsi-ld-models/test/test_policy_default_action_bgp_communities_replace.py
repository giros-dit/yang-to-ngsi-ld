...
class TestPolicyDefaultActionBgpCommunitiesReplace(unittest.TestCase):
    """PolicyDefaultActionBgpCommunitiesReplace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpCommunitiesReplace:
        """Test PolicyDefaultActionBgpCommunitiesReplace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpCommunitiesReplace`
        """
        model = PolicyDefaultActionBgpCommunitiesReplace()
        if include_optional:
            return PolicyDefaultActionBgpCommunitiesReplace(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyDefaultActionBgpCommunitiesReplace(self):
        """Test PolicyDefaultActionBgpCommunitiesReplace"""
