...
class TestNetworkInstanceUdpListeningApplicationProcessId(unittest.TestCase):
    """NetworkInstanceUdpListeningApplicationProcessId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpListeningApplicationProcessId:
        """Test NetworkInstanceUdpListeningApplicationProcessId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpListeningApplicationProcessId`
        """
        model = NetworkInstanceUdpListeningApplicationProcessId()
        if include_optional:
            return NetworkInstanceUdpListeningApplicationProcessId(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceUdpListeningApplicationProcessId(self):
        """Test NetworkInstanceUdpListeningApplicationProcessId"""
