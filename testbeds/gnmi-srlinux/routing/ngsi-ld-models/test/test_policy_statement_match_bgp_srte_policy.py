...
class TestPolicyStatementMatchBgpSrtePolicy(unittest.TestCase):
    """PolicyStatementMatchBgpSrtePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpSrtePolicy:
        """Test PolicyStatementMatchBgpSrtePolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpSrtePolicy`
        """
        model = PolicyStatementMatchBgpSrtePolicy()
        if include_optional:
            return PolicyStatementMatchBgpSrtePolicy(
                id = '',
                type = 'PolicyStatementMatchBgpSrtePolicy',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchBgpSrtePolicy(self):
        """Test PolicyStatementMatchBgpSrtePolicy"""
