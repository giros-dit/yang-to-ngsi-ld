...
class TestOperationalCapacity(unittest.TestCase):
    """OperationalCapacity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalCapacity:
        """Test OperationalCapacity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalCapacity`
        """
        model = OperationalCapacity()
        if include_optional:
    ...
    def testOperationalCapacity(self):
        """Test OperationalCapacity"""
