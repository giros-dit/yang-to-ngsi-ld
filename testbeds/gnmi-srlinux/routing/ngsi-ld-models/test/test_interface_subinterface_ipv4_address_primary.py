...
class TestInterfaceSubinterfaceIpv4AddressPrimary(unittest.TestCase):
    """InterfaceSubinterfaceIpv4AddressPrimary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4AddressPrimary:
        """Test InterfaceSubinterfaceIpv4AddressPrimary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4AddressPrimary`
        """
        model = InterfaceSubinterfaceIpv4AddressPrimary()
        if include_optional:
            return InterfaceSubinterfaceIpv4AddressPrimary(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceIpv4AddressPrimary(self):
        """Test InterfaceSubinterfaceIpv4AddressPrimary"""
