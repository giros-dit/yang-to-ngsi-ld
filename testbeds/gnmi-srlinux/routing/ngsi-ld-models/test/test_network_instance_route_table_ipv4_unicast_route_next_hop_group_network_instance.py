...
class TestNetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance"""
