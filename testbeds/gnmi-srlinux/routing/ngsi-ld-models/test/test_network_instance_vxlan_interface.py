...
class TestNetworkInstanceVxlanInterface(unittest.TestCase):
    """NetworkInstanceVxlanInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceVxlanInterface:
        """Test NetworkInstanceVxlanInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceVxlanInterface`
        """
        model = NetworkInstanceVxlanInterface()
        if include_optional:
            return NetworkInstanceVxlanInterface(
                id = '',
    ...
    def testNetworkInstanceVxlanInterface(self):
        """Test NetworkInstanceVxlanInterface"""
