...
class TestPacketProcessingAggregate(unittest.TestCase):
    """PacketProcessingAggregate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PacketProcessingAggregate:
        """Test PacketProcessingAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PacketProcessingAggregate`
        """
        model = PacketProcessingAggregate()
        if include_optional:
            return PacketProcessingAggregate(
                type = 'Property',
                value = 56,
    ...
    def testPacketProcessingAggregate(self):
        """Test PacketProcessingAggregate"""
