...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsFibSuppressedRoutes"""
