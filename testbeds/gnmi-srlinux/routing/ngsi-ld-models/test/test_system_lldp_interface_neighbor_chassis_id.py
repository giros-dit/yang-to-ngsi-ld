...
class TestSystemLldpInterfaceNeighborChassisId(unittest.TestCase):
    """SystemLldpInterfaceNeighborChassisId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborChassisId:
        """Test SystemLldpInterfaceNeighborChassisId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborChassisId`
        """
        model = SystemLldpInterfaceNeighborChassisId()
        if include_optional:
            return SystemLldpInterfaceNeighborChassisId(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborChassisId(self):
        """Test SystemLldpInterfaceNeighborChassisId"""
