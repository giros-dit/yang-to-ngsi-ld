...
class TestInterfaceSubinterfaceIpv6StatisticsInPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInPackets"""
