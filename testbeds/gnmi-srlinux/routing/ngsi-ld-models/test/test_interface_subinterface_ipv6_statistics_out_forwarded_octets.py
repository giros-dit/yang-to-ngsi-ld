...
class TestInterfaceSubinterfaceIpv6StatisticsOutForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets:
        """Test InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsOutForwardedOctets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets"""
