...
class TestSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType:
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType`
        """
        model = SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType(
                id = '',
                type = 'SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType(self):
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType"""
