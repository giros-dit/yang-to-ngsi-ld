...
class TestNetworkInstanceBridgeTableMacLearningOperMacLearning(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLearningOperMacLearning unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLearningOperMacLearning:
        """Test NetworkInstanceBridgeTableMacLearningOperMacLearning
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLearningOperMacLearning`
        """
        model = NetworkInstanceBridgeTableMacLearningOperMacLearning()
        if include_optional:
            return NetworkInstanceBridgeTableMacLearningOperMacLearning(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceBridgeTableMacLearningOperMacLearning(self):
        """Test NetworkInstanceBridgeTableMacLearningOperMacLearning"""
