...
class TestNetworkInstanceRouteTableNextHop(unittest.TestCase):
    """NetworkInstanceRouteTableNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHop:
        """Test NetworkInstanceRouteTableNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHop`
        """
        model = NetworkInstanceRouteTableNextHop()
        if include_optional:
            return NetworkInstanceRouteTableNextHop(
                id = '',
                type = 'NetworkInstanceRouteTableNextHop',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                programmed_index = None,
                nexthop_type = None,
                ip_address = None,
                subinterface = None,
                decapsulate_header = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceRouteTableNextHop(
    ...
    def testNetworkInstanceRouteTableNextHop(self):
        """Test NetworkInstanceRouteTableNextHop"""
