...
class TestLogPercent(unittest.TestCase):
    """LogPercent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogPercent:
        """Test LogPercent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogPercent`
        """
        model = LogPercent()
        if include_optional:
            return LogPercent(
