...
class TestControlPowerUsed(unittest.TestCase):
    """ControlPowerUsed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlPowerUsed:
        """Test ControlPowerUsed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlPowerUsed`
        """
        model = ControlPowerUsed()
        if include_optional:
            return ControlPowerUsed(
                type = 'Property',
                value = 56,
