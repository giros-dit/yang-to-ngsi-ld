...
class TestOuiSubtype(unittest.TestCase):
    """OuiSubtype unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OuiSubtype:
        """Test OuiSubtype
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OuiSubtype`
        """
        model = OuiSubtype()
        if include_optional:
            return OuiSubtype(
