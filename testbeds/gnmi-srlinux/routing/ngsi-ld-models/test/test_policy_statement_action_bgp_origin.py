...
class TestPolicyStatementActionBgpOrigin(unittest.TestCase):
    """PolicyStatementActionBgpOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpOrigin:
        """Test PolicyStatementActionBgpOrigin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpOrigin`
        """
        model = PolicyStatementActionBgpOrigin()
        if include_optional:
            return PolicyStatementActionBgpOrigin(
                id = '',
                type = 'PolicyStatementActionBgpOrigin',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpOrigin(self):
        """Test PolicyStatementActionBgpOrigin"""
