...
class TestRevertTimer(unittest.TestCase):
    """RevertTimer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevertTimer:
        """Test RevertTimer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevertTimer`
        """
        model = RevertTimer()
        if include_optional:
            return RevertTimer(
