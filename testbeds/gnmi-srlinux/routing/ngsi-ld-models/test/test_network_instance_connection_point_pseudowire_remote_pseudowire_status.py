...
class TestNetworkInstanceConnectionPointPseudowireRemotePseudowireStatus(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus:
        """Test NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus`
        """
        model = NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus(
                type = 'Property',
                value = 'pseudowire-forwarding',
    ...
    def testNetworkInstanceConnectionPointPseudowireRemotePseudowireStatus(self):
        """Test NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus"""
