...
class TestInterfaceSubinterfaceIpv6StatisticsInTerminatedOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInTerminatedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInTerminatedOctets:
        """Test InterfaceSubinterfaceIpv6StatisticsInTerminatedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInTerminatedOctets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInTerminatedOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInTerminatedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInTerminatedOctets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInTerminatedOctets"""
