...
class TestPolicyStatementActionBgpCommunitiesReplace(unittest.TestCase):
    """PolicyStatementActionBgpCommunitiesReplace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpCommunitiesReplace:
        """Test PolicyStatementActionBgpCommunitiesReplace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpCommunitiesReplace`
        """
        model = PolicyStatementActionBgpCommunitiesReplace()
        if include_optional:
            return PolicyStatementActionBgpCommunitiesReplace(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementActionBgpCommunitiesReplace(self):
        """Test PolicyStatementActionBgpCommunitiesReplace"""
