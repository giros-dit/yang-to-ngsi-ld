...
class TestNetworkInstanceProtocolsOspfInstanceExternalDbOverflow(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceExternalDbOverflow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceExternalDbOverflow:
        """Test NetworkInstanceProtocolsOspfInstanceExternalDbOverflow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceExternalDbOverflow`
        """
        model = NetworkInstanceProtocolsOspfInstanceExternalDbOverflow()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceExternalDbOverflow(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceExternalDbOverflow(self):
        """Test NetworkInstanceProtocolsOspfInstanceExternalDbOverflow"""
