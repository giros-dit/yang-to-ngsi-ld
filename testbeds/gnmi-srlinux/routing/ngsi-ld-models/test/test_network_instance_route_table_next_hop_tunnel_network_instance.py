...
class TestNetworkInstanceRouteTableNextHopTunnelNetworkInstance(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopTunnelNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopTunnelNetworkInstance:
        """Test NetworkInstanceRouteTableNextHopTunnelNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopTunnelNetworkInstance`
        """
        model = NetworkInstanceRouteTableNextHopTunnelNetworkInstance()
        if include_optional:
            return NetworkInstanceRouteTableNextHopTunnelNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopTunnelNetworkInstance(self):
        """Test NetworkInstanceRouteTableNextHopTunnelNetworkInstance"""
