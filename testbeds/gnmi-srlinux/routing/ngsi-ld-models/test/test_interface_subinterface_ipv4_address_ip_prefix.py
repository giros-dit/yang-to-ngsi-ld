...
class TestInterfaceSubinterfaceIpv4AddressIpPrefix(unittest.TestCase):
    """InterfaceSubinterfaceIpv4AddressIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4AddressIpPrefix:
        """Test InterfaceSubinterfaceIpv4AddressIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4AddressIpPrefix`
        """
        model = InterfaceSubinterfaceIpv4AddressIpPrefix()
        if include_optional:
            return InterfaceSubinterfaceIpv4AddressIpPrefix(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceIpv4AddressIpPrefix(self):
        """Test InterfaceSubinterfaceIpv4AddressIpPrefix"""
