...
class TestSystemLldpInterfaceStatisticsFrameIn(unittest.TestCase):
    """SystemLldpInterfaceStatisticsFrameIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceStatisticsFrameIn:
        """Test SystemLldpInterfaceStatisticsFrameIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceStatisticsFrameIn`
        """
        model = SystemLldpInterfaceStatisticsFrameIn()
        if include_optional:
            return SystemLldpInterfaceStatisticsFrameIn(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceStatisticsFrameIn(self):
        """Test SystemLldpInterfaceStatisticsFrameIn"""
