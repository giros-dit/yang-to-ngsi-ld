...
class TestSystemSrv6LocatorFullSegmentPrefixIpPrefix(unittest.TestCase):
    """SystemSrv6LocatorFullSegmentPrefixIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorFullSegmentPrefixIpPrefix:
        """Test SystemSrv6LocatorFullSegmentPrefixIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorFullSegmentPrefixIpPrefix`
        """
        model = SystemSrv6LocatorFullSegmentPrefixIpPrefix()
        if include_optional:
            return SystemSrv6LocatorFullSegmentPrefixIpPrefix(
                type = 'Property',
                value = 'fFCBZ#UM/?R,Fp^l6$ARjbhJk C>i H\'qT\\{<?\'es#)#iK.YM{Rag2/!KB!k@5oXh.:Ts\";mGL,i&z5[/9',
    ...
    def testSystemSrv6LocatorFullSegmentPrefixIpPrefix(self):
        """Test SystemSrv6LocatorFullSegmentPrefixIpPrefix"""
