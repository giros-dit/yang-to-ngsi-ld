...
class TestPolicyStatementMatchPrefixMatchSetOptions(unittest.TestCase):
    """PolicyStatementMatchPrefixMatchSetOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchPrefixMatchSetOptions:
        """Test PolicyStatementMatchPrefixMatchSetOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchPrefixMatchSetOptions`
        """
        model = PolicyStatementMatchPrefixMatchSetOptions()
        if include_optional:
            return PolicyStatementMatchPrefixMatchSetOptions(
                type = 'Property',
                value = 'any',
    ...
    def testPolicyStatementMatchPrefixMatchSetOptions(self):
        """Test PolicyStatementMatchPrefixMatchSetOptions"""
