...
class TestInterfaceTransceiverVoltageLowAlarmThreshold(unittest.TestCase):
    """InterfaceTransceiverVoltageLowAlarmThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageLowAlarmThreshold:
        """Test InterfaceTransceiverVoltageLowAlarmThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageLowAlarmThreshold`
        """
        model = InterfaceTransceiverVoltageLowAlarmThreshold()
        if include_optional:
            return InterfaceTransceiverVoltageLowAlarmThreshold(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceTransceiverVoltageLowAlarmThreshold(self):
        """Test InterfaceTransceiverVoltageLowAlarmThreshold"""
