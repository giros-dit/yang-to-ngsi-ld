...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                restart_helper_status = None,
                restart_helper_age = None,
                restart_helper_exit_rc = None,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighbor"""
