...
class TestControlPowerAllocated(unittest.TestCase):
    """ControlPowerAllocated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlPowerAllocated:
        """Test ControlPowerAllocated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlPowerAllocated`
        """
        model = ControlPowerAllocated()
        if include_optional:
            return ControlPowerAllocated(
                type = 'Property',
                value = 56,
    ...
    def testControlPowerAllocated(self):
        """Test ControlPowerAllocated"""
