...
class TestPolicyStatementAction(unittest.TestCase):
    """PolicyStatementAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementAction:
        """Test PolicyStatementAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementAction`
        """
        model = PolicyStatementAction()
        if include_optional:
            return PolicyStatementAction(
                id = '',
                type = 'PolicyStatementAction',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementAction(self):
        """Test PolicyStatementAction"""
