...
class TestNetworkInstanceProtocolsOspfInstanceName(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceName:
        """Test NetworkInstanceProtocolsOspfInstanceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceName`
        """
        model = NetworkInstanceProtocolsOspfInstanceName()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceName(self):
        """Test NetworkInstanceProtocolsOspfInstanceName"""
