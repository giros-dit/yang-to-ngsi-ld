...
class TestLinecardPartNumber(unittest.TestCase):
    """LinecardPartNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardPartNumber:
        """Test LinecardPartNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardPartNumber`
        """
        model = LinecardPartNumber()
        if include_optional:
            return LinecardPartNumber(
                type = 'Property',
                value = '',
    ...
    def testLinecardPartNumber(self):
        """Test LinecardPartNumber"""
