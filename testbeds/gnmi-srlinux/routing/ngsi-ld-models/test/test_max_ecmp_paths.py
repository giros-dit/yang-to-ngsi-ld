...
class TestMaxEcmpPaths(unittest.TestCase):
    """MaxEcmpPaths unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxEcmpPaths:
        """Test MaxEcmpPaths
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxEcmpPaths`
        """
        model = MaxEcmpPaths()
        if include_optional:
            return MaxEcmpPaths(
