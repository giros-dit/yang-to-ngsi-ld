...
class TestTypeNssa(unittest.TestCase):
    """TypeNssa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TypeNssa:
        """Test TypeNssa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TypeNssa`
        """
        model = TypeNssa()
        if include_optional:
            return TypeNssa(
