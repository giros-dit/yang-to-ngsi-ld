...
class TestSendBufferErrors(unittest.TestCase):
    """SendBufferErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendBufferErrors:
        """Test SendBufferErrors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendBufferErrors`
        """
        model = SendBufferErrors()
        if include_optional:
            return SendBufferErrors(
                type = 'Property',
                value = 56,
