...
class TestNetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement:
        """Test NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement`
        """
        model = NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement(self):
        """Test NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement"""
