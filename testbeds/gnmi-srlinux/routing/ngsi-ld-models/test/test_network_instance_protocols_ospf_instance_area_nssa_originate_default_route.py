...
class TestNetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute:
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute"""
