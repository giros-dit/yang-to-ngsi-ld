...
class TestNetworkSummaryLsa(unittest.TestCase):
    """NetworkSummaryLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkSummaryLsa:
        """Test NetworkSummaryLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkSummaryLsa`
        """
        model = NetworkSummaryLsa()
        if include_optional:
            return NetworkSummaryLsa(
                type = 'Property',
                value = 56,
    ...
    def testNetworkSummaryLsa(self):
        """Test NetworkSummaryLsa"""
