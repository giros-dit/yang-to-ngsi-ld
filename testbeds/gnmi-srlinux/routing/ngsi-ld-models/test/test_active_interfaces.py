...
class TestActiveInterfaces(unittest.TestCase):
    """ActiveInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveInterfaces:
        """Test ActiveInterfaces
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveInterfaces`
        """
        model = ActiveInterfaces()
        if include_optional:
