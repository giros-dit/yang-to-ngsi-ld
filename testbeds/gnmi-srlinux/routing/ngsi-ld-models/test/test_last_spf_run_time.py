...
class TestLastSpfRunTime(unittest.TestCase):
    """LastSpfRunTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastSpfRunTime:
        """Test LastSpfRunTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastSpfRunTime`
        """
        model = LastSpfRunTime()
        if include_optional:
            return LastSpfRunTime(
                type = 'Property',
                value = '',
