...
class TestNetworkInstanceRouteTableIpv4UnicastRouteLeakable(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteLeakable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteLeakable:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteLeakable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteLeakable`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteLeakable()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteLeakable(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteLeakable(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteLeakable"""
