...
class TestNetworkInstanceNextHopGroupsGroupBlackhole(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupBlackhole unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupBlackhole:
        """Test NetworkInstanceNextHopGroupsGroupBlackhole
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupBlackhole`
        """
        model = NetworkInstanceNextHopGroupsGroupBlackhole()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupBlackhole(
                id = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupBlackhole(self):
        """Test NetworkInstanceNextHopGroupsGroupBlackhole"""
