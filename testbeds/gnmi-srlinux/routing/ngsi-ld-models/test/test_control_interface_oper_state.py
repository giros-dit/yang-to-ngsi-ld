...
class TestControlInterfaceOperState(unittest.TestCase):
    """ControlInterfaceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlInterfaceOperState:
        """Test ControlInterfaceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlInterfaceOperState`
        """
        model = ControlInterfaceOperState()
        if include_optional:
            return ControlInterfaceOperState(
                type = 'Property',
                value = 'up',
    ...
    def testControlInterfaceOperState(self):
        """Test ControlInterfaceOperState"""
