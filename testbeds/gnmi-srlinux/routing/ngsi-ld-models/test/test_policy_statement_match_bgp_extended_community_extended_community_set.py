...
class TestPolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet(unittest.TestCase):
    """PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet:
        """Test PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet`
        """
        model = PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet()
        if include_optional:
            return PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet(self):
        """Test PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet"""
