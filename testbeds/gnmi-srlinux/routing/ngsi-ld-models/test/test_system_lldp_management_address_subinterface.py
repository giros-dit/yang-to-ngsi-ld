...
class TestSystemLldpManagementAddressSubinterface(unittest.TestCase):
    """SystemLldpManagementAddressSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpManagementAddressSubinterface:
        """Test SystemLldpManagementAddressSubinterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpManagementAddressSubinterface`
        """
        model = SystemLldpManagementAddressSubinterface()
        if include_optional:
            return SystemLldpManagementAddressSubinterface(
                type = 'Property',
                value = 'mgmt0.0',
    ...
    def testSystemLldpManagementAddressSubinterface(self):
        """Test SystemLldpManagementAddressSubinterface"""
