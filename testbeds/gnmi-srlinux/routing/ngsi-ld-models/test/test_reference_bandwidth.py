...
class TestReferenceBandwidth(unittest.TestCase):
    """ReferenceBandwidth unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReferenceBandwidth:
        """Test ReferenceBandwidth
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReferenceBandwidth`
        """
        model = ReferenceBandwidth()
        if include_optional:
    ...
    def testReferenceBandwidth(self):
        """Test ReferenceBandwidth"""
