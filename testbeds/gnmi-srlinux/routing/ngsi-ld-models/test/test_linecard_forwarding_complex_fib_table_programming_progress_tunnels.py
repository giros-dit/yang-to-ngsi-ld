...
class TestLinecardForwardingComplexFibTableProgrammingProgressTunnels(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressTunnels unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressTunnels:
        """Test LinecardForwardingComplexFibTableProgrammingProgressTunnels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressTunnels`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressTunnels()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressTunnels(
                id = '',
                type = 'LinecardForwardingComplexFibTableProgrammingProgressTunnels',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressTunnels(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressTunnels"""
