...
class TestPolicyDefaultActionInternalTagsSetTagSet(unittest.TestCase):
    """PolicyDefaultActionInternalTagsSetTagSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionInternalTagsSetTagSet:
        """Test PolicyDefaultActionInternalTagsSetTagSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionInternalTagsSetTagSet`
        """
        model = PolicyDefaultActionInternalTagsSetTagSet()
        if include_optional:
            return PolicyDefaultActionInternalTagsSetTagSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyDefaultActionInternalTagsSetTagSet(self):
        """Test PolicyDefaultActionInternalTagsSetTagSet"""
