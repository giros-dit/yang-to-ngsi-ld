...
class TestSrhMode(unittest.TestCase):
    """SrhMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SrhMode:
        """Test SrhMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SrhMode`
        """
        model = SrhMode()
        if include_optional:
            return SrhMode(
