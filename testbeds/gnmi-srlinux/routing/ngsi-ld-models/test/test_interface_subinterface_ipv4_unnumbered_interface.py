...
class TestInterfaceSubinterfaceIpv4UnnumberedInterface(unittest.TestCase):
    """InterfaceSubinterfaceIpv4UnnumberedInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4UnnumberedInterface:
        """Test InterfaceSubinterfaceIpv4UnnumberedInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4UnnumberedInterface`
        """
        model = InterfaceSubinterfaceIpv4UnnumberedInterface()
        if include_optional:
            return InterfaceSubinterfaceIpv4UnnumberedInterface(
                type = 'Property',
                value = 'mgmt0.0',
    ...
    def testInterfaceSubinterfaceIpv4UnnumberedInterface(self):
        """Test InterfaceSubinterfaceIpv4UnnumberedInterface"""
