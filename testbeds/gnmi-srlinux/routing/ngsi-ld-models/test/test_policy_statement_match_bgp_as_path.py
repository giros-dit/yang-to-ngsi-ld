...
class TestPolicyStatementMatchBgpAsPath(unittest.TestCase):
    """PolicyStatementMatchBgpAsPath unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpAsPath:
        """Test PolicyStatementMatchBgpAsPath
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpAsPath`
        """
        model = PolicyStatementMatchBgpAsPath()
        if include_optional:
            return PolicyStatementMatchBgpAsPath(
                id = '',
                type = 'PolicyStatementMatchBgpAsPath',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchBgpAsPath(self):
        """Test PolicyStatementMatchBgpAsPath"""
