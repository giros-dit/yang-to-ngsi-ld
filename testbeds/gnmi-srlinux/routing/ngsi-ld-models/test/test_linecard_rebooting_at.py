...
class TestLinecardRebootingAt(unittest.TestCase):
    """LinecardRebootingAt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardRebootingAt:
        """Test LinecardRebootingAt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardRebootingAt`
        """
        model = LinecardRebootingAt()
        if include_optional:
            return LinecardRebootingAt(
                type = 'Property',
                value = '',
    ...
    def testLinecardRebootingAt(self):
        """Test LinecardRebootingAt"""
