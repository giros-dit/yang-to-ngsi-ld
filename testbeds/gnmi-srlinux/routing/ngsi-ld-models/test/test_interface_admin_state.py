...
class TestInterfaceAdminState(unittest.TestCase):
    """InterfaceAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAdminState:
        """Test InterfaceAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAdminState`
        """
        model = InterfaceAdminState()
        if include_optional:
            return InterfaceAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testInterfaceAdminState(self):
        """Test InterfaceAdminState"""
