...
class TestLinecardMdaTemperatureMaximum(unittest.TestCase):
    """LinecardMdaTemperatureMaximum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaTemperatureMaximum:
        """Test LinecardMdaTemperatureMaximum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaTemperatureMaximum`
        """
        model = LinecardMdaTemperatureMaximum()
        if include_optional:
            return LinecardMdaTemperatureMaximum(
                type = 'Property',
                value = 56,
    ...
    def testLinecardMdaTemperatureMaximum(self):
        """Test LinecardMdaTemperatureMaximum"""
