...
class TestPolicyDefaultActionBgpCommunities(unittest.TestCase):
    """PolicyDefaultActionBgpCommunities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpCommunities:
        """Test PolicyDefaultActionBgpCommunities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpCommunities`
        """
        model = PolicyDefaultActionBgpCommunities()
        if include_optional:
            return PolicyDefaultActionBgpCommunities(
                id = '',
                type = 'PolicyDefaultActionBgpCommunities',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpCommunities(self):
        """Test PolicyDefaultActionBgpCommunities"""
