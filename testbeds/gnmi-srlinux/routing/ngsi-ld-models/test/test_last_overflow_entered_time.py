...
class TestLastOverflowEnteredTime(unittest.TestCase):
    """LastOverflowEnteredTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastOverflowEnteredTime:
        """Test LastOverflowEnteredTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastOverflowEnteredTime`
        """
        model = LastOverflowEnteredTime()
        if include_optional:
            return LastOverflowEnteredTime(
                type = 'Property',
                value = '',
    ...
    def testLastOverflowEnteredTime(self):
        """Test LastOverflowEnteredTime"""
