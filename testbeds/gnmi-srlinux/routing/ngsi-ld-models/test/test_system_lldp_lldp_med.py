...
class TestSystemLldpLldpMed(unittest.TestCase):
    """SystemLldpLldpMed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpLldpMed:
        """Test SystemLldpLldpMed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpLldpMed`
        """
        model = SystemLldpLldpMed()
        if include_optional:
            return SystemLldpLldpMed(
                id = '',
                type = 'SystemLldpLldpMed',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                med_fast_transmit_interval = None,
                med_fast_transmit_repeat_count = None,
                topology_change_notification = None,
                is_part_of = None
            )
        else:
            return SystemLldpLldpMed(
    ...
    def testSystemLldpLldpMed(self):
        """Test SystemLldpLldpMed"""
