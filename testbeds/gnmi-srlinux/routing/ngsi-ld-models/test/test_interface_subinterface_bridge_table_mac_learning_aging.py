...
class TestInterfaceSubinterfaceBridgeTableMacLearningAging(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableMacLearningAging unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableMacLearningAging:
        """Test InterfaceSubinterfaceBridgeTableMacLearningAging
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableMacLearningAging`
        """
        model = InterfaceSubinterfaceBridgeTableMacLearningAging()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableMacLearningAging(
                id = '',
    ...
    def testInterfaceSubinterfaceBridgeTableMacLearningAging(self):
        """Test InterfaceSubinterfaceBridgeTableMacLearningAging"""
