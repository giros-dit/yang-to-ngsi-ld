...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail"""
