...
class TestPolicyStatementActionBgpAsPathRemove(unittest.TestCase):
    """PolicyStatementActionBgpAsPathRemove unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpAsPathRemove:
        """Test PolicyStatementActionBgpAsPathRemove
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpAsPathRemove`
        """
        model = PolicyStatementActionBgpAsPathRemove()
        if include_optional:
            return PolicyStatementActionBgpAsPathRemove(
                type = 'Property',
                value = True,
    ...
    def testPolicyStatementActionBgpAsPathRemove(self):
        """Test PolicyStatementActionBgpAsPathRemove"""
