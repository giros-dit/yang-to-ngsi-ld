...
class TestDestinationMac(unittest.TestCase):
    """DestinationMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestinationMac:
        """Test DestinationMac
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationMac`
        """
        model = DestinationMac()
        if include_optional:
