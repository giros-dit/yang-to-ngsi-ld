...
class TestSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p:
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p`
        """
        model = SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p(
                type = 'Property',
                value = 0,
    ...
    def testSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p(self):
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p"""
