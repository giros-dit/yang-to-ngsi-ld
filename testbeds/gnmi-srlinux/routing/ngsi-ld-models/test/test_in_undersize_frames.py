...
class TestInUndersizeFrames(unittest.TestCase):
    """InUndersizeFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InUndersizeFrames:
        """Test InUndersizeFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InUndersizeFrames`
        """
        model = InUndersizeFrames()
        if include_optional:
            return InUndersizeFrames(
                type = 'Property',
                value = 56,
    ...
    def testInUndersizeFrames(self):
        """Test InUndersizeFrames"""
