...
class TestNetworkInstanceInterfaceInterfaceRefSubinterface(unittest.TestCase):
    """NetworkInstanceInterfaceInterfaceRefSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceInterfaceRefSubinterface:
        """Test NetworkInstanceInterfaceInterfaceRefSubinterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceInterfaceRefSubinterface`
        """
        model = NetworkInstanceInterfaceInterfaceRefSubinterface()
        if include_optional:
            return NetworkInstanceInterfaceInterfaceRefSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceInterfaceInterfaceRefSubinterface(self):
        """Test NetworkInstanceInterfaceInterfaceRefSubinterface"""
