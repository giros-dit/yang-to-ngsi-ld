...
class TestNetworkInstanceRouteTableNextHopGroupNextHopId(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupNextHopId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupNextHopId:
        """Test NetworkInstanceRouteTableNextHopGroupNextHopId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupNextHopId`
        """
        model = NetworkInstanceRouteTableNextHopGroupNextHopId()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupNextHopId(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceRouteTableNextHopGroupNextHopId(self):
        """Test NetworkInstanceRouteTableNextHopGroupNextHopId"""
