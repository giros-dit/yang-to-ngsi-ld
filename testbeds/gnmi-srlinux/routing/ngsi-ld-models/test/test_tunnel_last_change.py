...
class TestTunnelLastChange(unittest.TestCase):
    """TunnelLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TunnelLastChange:
        """Test TunnelLastChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TunnelLastChange`
        """
        model = TunnelLastChange()
        if include_optional:
            return TunnelLastChange(
                type = 'Property',
                value = '',
