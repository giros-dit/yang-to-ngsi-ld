...
class TestInterfaceSubinterfaceIpv4StatisticsOutOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsOutOctets:
        """Test InterfaceSubinterfaceIpv4StatisticsOutOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsOutOctets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsOutOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsOutOctets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsOutOctets"""
