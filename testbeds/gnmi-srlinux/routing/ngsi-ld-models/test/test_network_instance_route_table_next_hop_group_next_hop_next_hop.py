...
class TestNetworkInstanceRouteTableNextHopGroupNextHopNextHop(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupNextHopNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupNextHopNextHop:
        """Test NetworkInstanceRouteTableNextHopGroupNextHopNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupNextHopNextHop`
        """
        model = NetworkInstanceRouteTableNextHopGroupNextHopNextHop()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupNextHopNextHop(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopGroupNextHopNextHop(self):
        """Test NetworkInstanceRouteTableNextHopGroupNextHopNextHop"""
