...
class TestIgnoredMulticastPackets(unittest.TestCase):
    """IgnoredMulticastPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IgnoredMulticastPackets:
        """Test IgnoredMulticastPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IgnoredMulticastPackets`
        """
        model = IgnoredMulticastPackets()
        if include_optional:
            return IgnoredMulticastPackets(
                type = 'Property',
                value = 56,
    ...
    def testIgnoredMulticastPackets(self):
        """Test IgnoredMulticastPackets"""
