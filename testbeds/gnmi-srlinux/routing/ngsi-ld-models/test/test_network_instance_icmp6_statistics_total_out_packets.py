...
class TestNetworkInstanceIcmp6StatisticsTotalOutPackets(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTotalOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTotalOutPackets:
        """Test NetworkInstanceIcmp6StatisticsTotalOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTotalOutPackets`
        """
        model = NetworkInstanceIcmp6StatisticsTotalOutPackets()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTotalOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmp6StatisticsTotalOutPackets(self):
        """Test NetworkInstanceIcmp6StatisticsTotalOutPackets"""
