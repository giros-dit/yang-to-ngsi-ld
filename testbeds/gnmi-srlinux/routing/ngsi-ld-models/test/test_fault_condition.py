...
class TestFaultCondition(unittest.TestCase):
    """FaultCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FaultCondition:
        """Test FaultCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FaultCondition`
        """
        model = FaultCondition()
        if include_optional:
