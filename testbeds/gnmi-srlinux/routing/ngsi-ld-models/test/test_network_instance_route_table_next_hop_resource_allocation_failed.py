...
class TestNetworkInstanceRouteTableNextHopResourceAllocationFailed(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopResourceAllocationFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopResourceAllocationFailed:
        """Test NetworkInstanceRouteTableNextHopResourceAllocationFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopResourceAllocationFailed`
        """
        model = NetworkInstanceRouteTableNextHopResourceAllocationFailed()
        if include_optional:
            return NetworkInstanceRouteTableNextHopResourceAllocationFailed(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopResourceAllocationFailed(self):
        """Test NetworkInstanceRouteTableNextHopResourceAllocationFailed"""
