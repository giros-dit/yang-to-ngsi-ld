...
class TestInterfaceTransceiverVoltageHighWarningCondition(unittest.TestCase):
    """InterfaceTransceiverVoltageHighWarningCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageHighWarningCondition:
        """Test InterfaceTransceiverVoltageHighWarningCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageHighWarningCondition`
        """
        model = InterfaceTransceiverVoltageHighWarningCondition()
        if include_optional:
            return InterfaceTransceiverVoltageHighWarningCondition(
                type = 'Property',
                value = True,
    ...
    def testInterfaceTransceiverVoltageHighWarningCondition(self):
        """Test InterfaceTransceiverVoltageHighWarningCondition"""
