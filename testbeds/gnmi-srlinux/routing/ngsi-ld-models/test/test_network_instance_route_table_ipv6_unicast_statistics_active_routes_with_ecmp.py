...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutesWithEcmp"""
