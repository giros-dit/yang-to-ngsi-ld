...
class TestFlowsRebalanced(unittest.TestCase):
    """FlowsRebalanced unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FlowsRebalanced:
        """Test FlowsRebalanced
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FlowsRebalanced`
        """
        model = FlowsRebalanced()
        if include_optional:
            return FlowsRebalanced(
                type = 'Property',
                value = 56,
