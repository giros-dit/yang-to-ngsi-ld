...
class TestDdmEvents(unittest.TestCase):
    """DdmEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DdmEvents:
        """Test DdmEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DdmEvents`
        """
        model = DdmEvents()
        if include_optional:
            return DdmEvents(
