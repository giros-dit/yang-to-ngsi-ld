...
class TestNetworkInstanceVxlanInterfaceName(unittest.TestCase):
    """NetworkInstanceVxlanInterfaceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceVxlanInterfaceName:
        """Test NetworkInstanceVxlanInterfaceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceVxlanInterfaceName`
        """
        model = NetworkInstanceVxlanInterfaceName()
        if include_optional:
            return NetworkInstanceVxlanInterfaceName(
                type = 'Property',
    ...
    def testNetworkInstanceVxlanInterfaceName(self):
        """Test NetworkInstanceVxlanInterfaceName"""
