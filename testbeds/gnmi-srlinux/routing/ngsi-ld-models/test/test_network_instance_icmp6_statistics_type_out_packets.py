...
class TestNetworkInstanceIcmp6StatisticsTypeOutPackets(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTypeOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTypeOutPackets:
        """Test NetworkInstanceIcmp6StatisticsTypeOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTypeOutPackets`
        """
        model = NetworkInstanceIcmp6StatisticsTypeOutPackets()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTypeOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmp6StatisticsTypeOutPackets(self):
        """Test NetworkInstanceIcmp6StatisticsTypeOutPackets"""
