...
class TestPhysicalChannel(unittest.TestCase):
    """PhysicalChannel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhysicalChannel:
        """Test PhysicalChannel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhysicalChannel`
        """
