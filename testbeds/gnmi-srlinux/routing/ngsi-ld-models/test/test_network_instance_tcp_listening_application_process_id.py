...
class TestNetworkInstanceTcpListeningApplicationProcessId(unittest.TestCase):
    """NetworkInstanceTcpListeningApplicationProcessId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpListeningApplicationProcessId:
        """Test NetworkInstanceTcpListeningApplicationProcessId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpListeningApplicationProcessId`
        """
        model = NetworkInstanceTcpListeningApplicationProcessId()
        if include_optional:
            return NetworkInstanceTcpListeningApplicationProcessId(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceTcpListeningApplicationProcessId(self):
        """Test NetworkInstanceTcpListeningApplicationProcessId"""
