...
class TestLinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify:
        """Test LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify"""
