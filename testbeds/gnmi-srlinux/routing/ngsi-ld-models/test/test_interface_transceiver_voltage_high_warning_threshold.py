...
class TestInterfaceTransceiverVoltageHighWarningThreshold(unittest.TestCase):
    """InterfaceTransceiverVoltageHighWarningThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageHighWarningThreshold:
        """Test InterfaceTransceiverVoltageHighWarningThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageHighWarningThreshold`
        """
        model = InterfaceTransceiverVoltageHighWarningThreshold()
        if include_optional:
            return InterfaceTransceiverVoltageHighWarningThreshold(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceTransceiverVoltageHighWarningThreshold(self):
        """Test InterfaceTransceiverVoltageHighWarningThreshold"""
