...
class TestRetransmissionQueueLength(unittest.TestCase):
    """RetransmissionQueueLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetransmissionQueueLength:
        """Test RetransmissionQueueLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetransmissionQueueLength`
        """
        model = RetransmissionQueueLength()
        if include_optional:
            return RetransmissionQueueLength(
                type = 'Property',
                value = 56,
    ...
    def testRetransmissionQueueLength(self):
        """Test RetransmissionQueueLength"""
