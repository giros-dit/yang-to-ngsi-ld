...
class TestPolicyDefaultActionBgpNextHopResolutionSetFlexAlgo(unittest.TestCase):
    """PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo:
        """Test PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo`
        """
        model = PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo()
        if include_optional:
            return PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo(
                type = 'Property',
                value = 56,
    ...
    def testPolicyDefaultActionBgpNextHopResolutionSetFlexAlgo(self):
        """Test PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo"""
