...
class TestNetworkInstanceVxlanInterfaceOperDownReason(unittest.TestCase):
    """NetworkInstanceVxlanInterfaceOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceVxlanInterfaceOperDownReason:
        """Test NetworkInstanceVxlanInterfaceOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceVxlanInterfaceOperDownReason`
        """
        model = NetworkInstanceVxlanInterfaceOperDownReason()
        if include_optional:
            return NetworkInstanceVxlanInterfaceOperDownReason(
                type = 'Property',
                value = 'vxlan-tunnel-down',
    ...
    def testNetworkInstanceVxlanInterfaceOperDownReason(self):
        """Test NetworkInstanceVxlanInterfaceOperDownReason"""
