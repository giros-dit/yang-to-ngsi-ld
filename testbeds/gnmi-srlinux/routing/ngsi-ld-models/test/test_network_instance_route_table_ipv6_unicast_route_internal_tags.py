...
class TestNetworkInstanceRouteTableIpv6UnicastRouteInternalTags(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteInternalTags unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteInternalTags:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteInternalTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteInternalTags`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteInternalTags()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteInternalTags(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteInternalTags(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteInternalTags"""
