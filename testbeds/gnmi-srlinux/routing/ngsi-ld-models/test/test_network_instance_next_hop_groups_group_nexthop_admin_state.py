...
class TestNetworkInstanceNextHopGroupsGroupNexthopAdminState(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopAdminState:
        """Test NetworkInstanceNextHopGroupsGroupNexthopAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopAdminState`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopAdminState()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopAdminState(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopAdminState"""
