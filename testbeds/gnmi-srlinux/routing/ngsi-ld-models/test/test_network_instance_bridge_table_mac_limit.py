...
class TestNetworkInstanceBridgeTableMacLimit(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLimit:
        """Test NetworkInstanceBridgeTableMacLimit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLimit`
        """
        model = NetworkInstanceBridgeTableMacLimit()
        if include_optional:
            return NetworkInstanceBridgeTableMacLimit(
                id = '',
    ...
    def testNetworkInstanceBridgeTableMacLimit(self):
        """Test NetworkInstanceBridgeTableMacLimit"""
