...
class TestPolicyStatementActionBgpMed(unittest.TestCase):
    """PolicyStatementActionBgpMed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpMed:
        """Test PolicyStatementActionBgpMed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpMed`
        """
        model = PolicyStatementActionBgpMed()
        if include_optional:
            return PolicyStatementActionBgpMed(
                id = '',
                type = 'PolicyStatementActionBgpMed',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpMed(self):
        """Test PolicyStatementActionBgpMed"""
