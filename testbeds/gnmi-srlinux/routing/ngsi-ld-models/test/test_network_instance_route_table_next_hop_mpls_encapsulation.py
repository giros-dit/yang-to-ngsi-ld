...
class TestNetworkInstanceRouteTableNextHopMplsEncapsulation(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopMplsEncapsulation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopMplsEncapsulation:
        """Test NetworkInstanceRouteTableNextHopMplsEncapsulation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopMplsEncapsulation`
        """
        model = NetworkInstanceRouteTableNextHopMplsEncapsulation()
        if include_optional:
            return NetworkInstanceRouteTableNextHopMplsEncapsulation(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopMplsEncapsulation',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                pushed_mpls_label_stack = None,
                entropy_label_transmit = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceRouteTableNextHopMplsEncapsulation(
    ...
    def testNetworkInstanceRouteTableNextHopMplsEncapsulation(self):
        """Test NetworkInstanceRouteTableNextHopMplsEncapsulation"""
