...
class TestPassiveOpens(unittest.TestCase):
    """PassiveOpens unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PassiveOpens:
        """Test PassiveOpens
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PassiveOpens`
        """
        model = PassiveOpens()
        if include_optional:
            return PassiveOpens(
