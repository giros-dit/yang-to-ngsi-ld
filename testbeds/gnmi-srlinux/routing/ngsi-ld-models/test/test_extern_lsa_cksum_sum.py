...
class TestExternLsaCksumSum(unittest.TestCase):
    """ExternLsaCksumSum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternLsaCksumSum:
        """Test ExternLsaCksumSum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternLsaCksumSum`
        """
        model = ExternLsaCksumSum()
        if include_optional:
            return ExternLsaCksumSum(
                type = 'Property',
                value = '0x2',
    ...
    def testExternLsaCksumSum(self):
        """Test ExternLsaCksumSum"""
