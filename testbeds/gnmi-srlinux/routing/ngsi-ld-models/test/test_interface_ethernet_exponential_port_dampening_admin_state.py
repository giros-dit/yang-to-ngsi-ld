...
class TestInterfaceEthernetExponentialPortDampeningAdminState(unittest.TestCase):
    """InterfaceEthernetExponentialPortDampeningAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetExponentialPortDampeningAdminState:
        """Test InterfaceEthernetExponentialPortDampeningAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetExponentialPortDampeningAdminState`
        """
        model = InterfaceEthernetExponentialPortDampeningAdminState()
        if include_optional:
            return InterfaceEthernetExponentialPortDampeningAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testInterfaceEthernetExponentialPortDampeningAdminState(self):
        """Test InterfaceEthernetExponentialPortDampeningAdminState"""
