...
class TestBackboneRouter(unittest.TestCase):
    """BackboneRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BackboneRouter:
        """Test BackboneRouter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BackboneRouter`
        """
        model = BackboneRouter()
        if include_optional:
