...
class TestSystemAuthenticationKeychainKeyMacsec(unittest.TestCase):
    """SystemAuthenticationKeychainKeyMacsec unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKeyMacsec:
        """Test SystemAuthenticationKeychainKeyMacsec
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKeyMacsec`
        """
        model = SystemAuthenticationKeychainKeyMacsec()
        if include_optional:
            return SystemAuthenticationKeychainKeyMacsec(
                id = '',
                type = 'SystemAuthenticationKeychainKeyMacsec',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemAuthenticationKeychainKeyMacsec(self):
        """Test SystemAuthenticationKeychainKeyMacsec"""
