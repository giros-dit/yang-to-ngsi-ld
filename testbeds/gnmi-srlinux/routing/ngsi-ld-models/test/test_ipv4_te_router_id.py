...
class TestIpv4TeRouterId(unittest.TestCase):
    """Ipv4TeRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ipv4TeRouterId:
        """Test Ipv4TeRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ipv4TeRouterId`
        """
        model = Ipv4TeRouterId()
        if include_optional:
