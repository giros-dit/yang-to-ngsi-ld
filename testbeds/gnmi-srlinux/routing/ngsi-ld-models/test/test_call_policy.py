...
class TestCallPolicy(unittest.TestCase):
    """CallPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CallPolicy:
        """Test CallPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CallPolicy`
        """
        model = CallPolicy()
        if include_optional:
            return CallPolicy(
