...
class TestSystemProtectionPoliciesPolicySeamlessBfd(unittest.TestCase):
    """SystemProtectionPoliciesPolicySeamlessBfd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemProtectionPoliciesPolicySeamlessBfd:
        """Test SystemProtectionPoliciesPolicySeamlessBfd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemProtectionPoliciesPolicySeamlessBfd`
        """
        model = SystemProtectionPoliciesPolicySeamlessBfd()
        if include_optional:
            return SystemProtectionPoliciesPolicySeamlessBfd(
                id = '',
                type = 'SystemProtectionPoliciesPolicySeamlessBfd',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                desired_minimum_transmit_interval = None,
                hold_down_timer = None,
                wait_for_up_timer = None,
                mode = None,
                threshold = None,
                is_part_of = None
            )
    ...
    def testSystemProtectionPoliciesPolicySeamlessBfd(self):
        """Test SystemProtectionPoliciesPolicySeamlessBfd"""
