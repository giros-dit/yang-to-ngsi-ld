...
class TestRetransmits(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Retransmits:
        """Test Retransmits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Retransmits`
        """
        model = Retransmits()
        if include_optional:
            return Retransmits(
