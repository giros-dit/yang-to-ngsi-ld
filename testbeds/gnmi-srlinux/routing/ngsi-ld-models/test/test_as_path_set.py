...
class TestAsPathSet(unittest.TestCase):
    """AsPathSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsPathSet:
        """Test AsPathSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsPathSet`
        """
        model = AsPathSet()
        if include_optional:
            return AsPathSet(
