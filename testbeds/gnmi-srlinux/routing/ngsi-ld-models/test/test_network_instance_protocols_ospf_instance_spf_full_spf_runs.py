...
class TestNetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns:
        """Test NetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns`
        """
        model = NetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns(self):
        """Test NetworkInstanceProtocolsOspfInstanceSpfFullSpfRuns"""
