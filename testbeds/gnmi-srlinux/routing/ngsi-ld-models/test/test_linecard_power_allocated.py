...
class TestLinecardPowerAllocated(unittest.TestCase):
    """LinecardPowerAllocated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardPowerAllocated:
        """Test LinecardPowerAllocated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardPowerAllocated`
        """
        model = LinecardPowerAllocated()
        if include_optional:
            return LinecardPowerAllocated(
                type = 'Property',
                value = 56,
    ...
    def testLinecardPowerAllocated(self):
        """Test LinecardPowerAllocated"""
