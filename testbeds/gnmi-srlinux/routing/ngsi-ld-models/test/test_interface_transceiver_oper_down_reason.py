...
class TestInterfaceTransceiverOperDownReason(unittest.TestCase):
    """InterfaceTransceiverOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverOperDownReason:
        """Test InterfaceTransceiverOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverOperDownReason`
        """
        model = InterfaceTransceiverOperDownReason()
        if include_optional:
            return InterfaceTransceiverOperDownReason(
                type = 'Property',
                value = 'not-present',
    ...
    def testInterfaceTransceiverOperDownReason(self):
        """Test InterfaceTransceiverOperDownReason"""
