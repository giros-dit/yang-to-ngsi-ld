...
class TestNetworkInstanceStaticRoutesRouteMetric(unittest.TestCase):
    """NetworkInstanceStaticRoutesRouteMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesRouteMetric:
        """Test NetworkInstanceStaticRoutesRouteMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesRouteMetric`
        """
        model = NetworkInstanceStaticRoutesRouteMetric()
        if include_optional:
            return NetworkInstanceStaticRoutesRouteMetric(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceStaticRoutesRouteMetric(self):
        """Test NetworkInstanceStaticRoutesRouteMetric"""
