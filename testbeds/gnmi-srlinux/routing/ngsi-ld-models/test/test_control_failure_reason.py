...
class TestControlFailureReason(unittest.TestCase):
    """ControlFailureReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlFailureReason:
        """Test ControlFailureReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlFailureReason`
        """
        model = ControlFailureReason()
        if include_optional:
            return ControlFailureReason(
                type = 'Property',
                value = '',
    ...
    def testControlFailureReason(self):
        """Test ControlFailureReason"""
