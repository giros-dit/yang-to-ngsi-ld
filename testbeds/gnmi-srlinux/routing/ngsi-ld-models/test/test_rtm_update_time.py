...
class TestRtmUpdateTime(unittest.TestCase):
    """RtmUpdateTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RtmUpdateTime:
        """Test RtmUpdateTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RtmUpdateTime`
        """
        model = RtmUpdateTime()
        if include_optional:
            return RtmUpdateTime(
                type = 'Property',
                value = 0,
