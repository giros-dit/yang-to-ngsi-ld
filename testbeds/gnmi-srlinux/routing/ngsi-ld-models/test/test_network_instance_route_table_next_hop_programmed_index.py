...
class TestNetworkInstanceRouteTableNextHopProgrammedIndex(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopProgrammedIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopProgrammedIndex:
        """Test NetworkInstanceRouteTableNextHopProgrammedIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopProgrammedIndex`
        """
        model = NetworkInstanceRouteTableNextHopProgrammedIndex()
        if include_optional:
            return NetworkInstanceRouteTableNextHopProgrammedIndex(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopProgrammedIndex(self):
        """Test NetworkInstanceRouteTableNextHopProgrammedIndex"""
