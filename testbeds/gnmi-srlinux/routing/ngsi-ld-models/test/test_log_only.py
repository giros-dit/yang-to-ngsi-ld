...
class TestLogOnly(unittest.TestCase):
    """LogOnly unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LogOnly:
        """Test LogOnly
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LogOnly`
        """
        model = LogOnly()
        if include_optional:
            return LogOnly(
