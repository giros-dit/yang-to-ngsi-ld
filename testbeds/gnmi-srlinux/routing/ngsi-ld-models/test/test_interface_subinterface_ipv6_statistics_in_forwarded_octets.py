...
class TestInterfaceSubinterfaceIpv6StatisticsInForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInForwardedOctets:
        """Test InterfaceSubinterfaceIpv6StatisticsInForwardedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInForwardedOctets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInForwardedOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInForwardedOctets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInForwardedOctets"""
