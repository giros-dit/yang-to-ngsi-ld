...
class TestNetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise:
        """Test NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise"""
