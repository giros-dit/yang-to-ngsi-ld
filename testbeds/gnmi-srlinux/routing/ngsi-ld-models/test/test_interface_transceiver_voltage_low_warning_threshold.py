...
class TestInterfaceTransceiverVoltageLowWarningThreshold(unittest.TestCase):
    """InterfaceTransceiverVoltageLowWarningThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageLowWarningThreshold:
        """Test InterfaceTransceiverVoltageLowWarningThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageLowWarningThreshold`
        """
        model = InterfaceTransceiverVoltageLowWarningThreshold()
        if include_optional:
            return InterfaceTransceiverVoltageLowWarningThreshold(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceTransceiverVoltageLowWarningThreshold(self):
        """Test InterfaceTransceiverVoltageLowWarningThreshold"""
