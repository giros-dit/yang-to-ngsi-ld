...
class TestSystemAuthenticationKeychainName(unittest.TestCase):
    """SystemAuthenticationKeychainName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainName:
        """Test SystemAuthenticationKeychainName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainName`
        """
        model = SystemAuthenticationKeychainName()
        if include_optional:
            return SystemAuthenticationKeychainName(
                type = 'Property',
                value = '',
    ...
    def testSystemAuthenticationKeychainName(self):
        """Test SystemAuthenticationKeychainName"""
