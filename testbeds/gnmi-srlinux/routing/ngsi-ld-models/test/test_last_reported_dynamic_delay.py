...
class TestLastReportedDynamicDelay(unittest.TestCase):
    """LastReportedDynamicDelay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastReportedDynamicDelay:
        """Test LastReportedDynamicDelay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastReportedDynamicDelay`
        """
        model = LastReportedDynamicDelay()
        if include_optional:
            return LastReportedDynamicDelay(
                type = 'Property',
                value = '',
    ...
    def testLastReportedDynamicDelay(self):
        """Test LastReportedDynamicDelay"""
