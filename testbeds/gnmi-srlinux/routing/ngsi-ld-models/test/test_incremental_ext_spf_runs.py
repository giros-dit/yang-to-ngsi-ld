...
class TestIncrementalExtSpfRuns(unittest.TestCase):
    """IncrementalExtSpfRuns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncrementalExtSpfRuns:
        """Test IncrementalExtSpfRuns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncrementalExtSpfRuns`
        """
        model = IncrementalExtSpfRuns()
        if include_optional:
            return IncrementalExtSpfRuns(
                type = 'Property',
                value = 56,
    ...
    def testIncrementalExtSpfRuns(self):
        """Test IncrementalExtSpfRuns"""
