...
class TestNetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded"""
