...
class TestEInterAreaPrefixLsa(unittest.TestCase):
    """EInterAreaPrefixLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EInterAreaPrefixLsa:
        """Test EInterAreaPrefixLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EInterAreaPrefixLsa`
        """
        model = EInterAreaPrefixLsa()
        if include_optional:
            return EInterAreaPrefixLsa(
                type = 'Property',
                value = 56,
    ...
    def testEInterAreaPrefixLsa(self):
        """Test EInterAreaPrefixLsa"""
