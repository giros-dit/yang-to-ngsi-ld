...
class TestCongestionAggregate(unittest.TestCase):
    """CongestionAggregate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CongestionAggregate:
        """Test CongestionAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CongestionAggregate`
        """
        model = CongestionAggregate()
        if include_optional:
            return CongestionAggregate(
                type = 'Property',
                value = 56,
    ...
    def testCongestionAggregate(self):
        """Test CongestionAggregate"""
