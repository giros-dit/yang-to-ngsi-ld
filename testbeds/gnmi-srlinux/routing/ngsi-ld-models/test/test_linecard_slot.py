...
class TestLinecardSlot(unittest.TestCase):
    """LinecardSlot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardSlot:
        """Test LinecardSlot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardSlot`
        """
        model = LinecardSlot()
        if include_optional:
            return LinecardSlot(
