...
class TestPolicyStatementMatchMulticastSourceAddressPrefixSet(unittest.TestCase):
    """PolicyStatementMatchMulticastSourceAddressPrefixSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchMulticastSourceAddressPrefixSet:
        """Test PolicyStatementMatchMulticastSourceAddressPrefixSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchMulticastSourceAddressPrefixSet`
        """
        model = PolicyStatementMatchMulticastSourceAddressPrefixSet()
        if include_optional:
            return PolicyStatementMatchMulticastSourceAddressPrefixSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementMatchMulticastSourceAddressPrefixSet(self):
        """Test PolicyStatementMatchMulticastSourceAddressPrefixSet"""
