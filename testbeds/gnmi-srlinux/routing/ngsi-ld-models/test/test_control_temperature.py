...
class TestControlTemperature(unittest.TestCase):
    """ControlTemperature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlTemperature:
        """Test ControlTemperature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlTemperature`
        """
        model = ControlTemperature()
        if include_optional:
            return ControlTemperature(
                id = '',
                type = 'ControlTemperature',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testControlTemperature(self):
        """Test ControlTemperature"""
