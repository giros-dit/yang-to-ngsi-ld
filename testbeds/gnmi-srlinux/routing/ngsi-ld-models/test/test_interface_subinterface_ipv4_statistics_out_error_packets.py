...
class TestInterfaceSubinterfaceIpv4StatisticsOutErrorPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsOutErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsOutErrorPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsOutErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsOutErrorPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsOutErrorPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsOutErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsOutErrorPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsOutErrorPackets"""
