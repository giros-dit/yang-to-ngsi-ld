...
class TestLacpPortPriority(unittest.TestCase):
    """LacpPortPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LacpPortPriority:
        """Test LacpPortPriority
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LacpPortPriority`
        """
        model = LacpPortPriority()
        if include_optional:
            return LacpPortPriority(
                type = 'Property',
                value = 56,
