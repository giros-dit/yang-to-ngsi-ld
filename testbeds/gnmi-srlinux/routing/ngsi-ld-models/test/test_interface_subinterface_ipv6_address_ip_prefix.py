...
class TestInterfaceSubinterfaceIpv6AddressIpPrefix(unittest.TestCase):
    """InterfaceSubinterfaceIpv6AddressIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6AddressIpPrefix:
        """Test InterfaceSubinterfaceIpv6AddressIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6AddressIpPrefix`
        """
        model = InterfaceSubinterfaceIpv6AddressIpPrefix()
        if include_optional:
            return InterfaceSubinterfaceIpv6AddressIpPrefix(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceIpv6AddressIpPrefix(self):
        """Test InterfaceSubinterfaceIpv6AddressIpPrefix"""
