...
class TestPolicyStatementActionBgpStandardCommunityReferencedSets(unittest.TestCase):
    """PolicyStatementActionBgpStandardCommunityReferencedSets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpStandardCommunityReferencedSets:
        """Test PolicyStatementActionBgpStandardCommunityReferencedSets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpStandardCommunityReferencedSets`
        """
        model = PolicyStatementActionBgpStandardCommunityReferencedSets()
        if include_optional:
            return PolicyStatementActionBgpStandardCommunityReferencedSets(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementActionBgpStandardCommunityReferencedSets(self):
        """Test PolicyStatementActionBgpStandardCommunityReferencedSets"""
