...
class TestPolicyStatementMatchOspfAreaId(unittest.TestCase):
    """PolicyStatementMatchOspfAreaId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchOspfAreaId:
        """Test PolicyStatementMatchOspfAreaId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchOspfAreaId`
        """
        model = PolicyStatementMatchOspfAreaId()
        if include_optional:
            return PolicyStatementMatchOspfAreaId(
                type = 'Property',
    ...
    def testPolicyStatementMatchOspfAreaId(self):
        """Test PolicyStatementMatchOspfAreaId"""
