...
class TestSystemSrv6LocatorFullSegmentStaticFunction(unittest.TestCase):
    """SystemSrv6LocatorFullSegmentStaticFunction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorFullSegmentStaticFunction:
        """Test SystemSrv6LocatorFullSegmentStaticFunction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorFullSegmentStaticFunction`
        """
        model = SystemSrv6LocatorFullSegmentStaticFunction()
        if include_optional:
            return SystemSrv6LocatorFullSegmentStaticFunction(
                id = '',
                type = 'SystemSrv6LocatorFullSegmentStaticFunction',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6LocatorFullSegmentStaticFunction(self):
        """Test SystemSrv6LocatorFullSegmentStaticFunction"""
