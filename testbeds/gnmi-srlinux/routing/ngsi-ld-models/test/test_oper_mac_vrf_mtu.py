...
class TestOperMacVrfMtu(unittest.TestCase):
    """OperMacVrfMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperMacVrfMtu:
        """Test OperMacVrfMtu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperMacVrfMtu`
        """
        model = OperMacVrfMtu()
        if include_optional:
            return OperMacVrfMtu(
                type = 'Property',
                value = 1492,
