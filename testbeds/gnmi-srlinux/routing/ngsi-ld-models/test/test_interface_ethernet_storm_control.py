...
class TestInterfaceEthernetStormControl(unittest.TestCase):
    """InterfaceEthernetStormControl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStormControl:
        """Test InterfaceEthernetStormControl
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStormControl`
        """
        model = InterfaceEthernetStormControl()
        if include_optional:
            return InterfaceEthernetStormControl(
                id = '',
                type = 'InterfaceEthernetStormControl',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                broadcast_rate = None,
                multicast_rate = None,
                unknown_unicast_rate = None,
                operational_broadcast_rate = None,
                operational_multicast_rate = None,
                operational_unknown_unicast_rate = None,
                rising_threshold_action = None,
                is_part_of = None
            )
        else:
            return InterfaceEthernetStormControl(
    ...
    def testInterfaceEthernetStormControl(self):
        """Test InterfaceEthernetStormControl"""
