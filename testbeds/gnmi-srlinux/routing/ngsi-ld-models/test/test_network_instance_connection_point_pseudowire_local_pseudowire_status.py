...
class TestNetworkInstanceConnectionPointPseudowireLocalPseudowireStatus(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus:
        """Test NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus`
        """
        model = NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus(
                type = 'Property',
    ...
    def testNetworkInstanceConnectionPointPseudowireLocalPseudowireStatus(self):
        """Test NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus"""
