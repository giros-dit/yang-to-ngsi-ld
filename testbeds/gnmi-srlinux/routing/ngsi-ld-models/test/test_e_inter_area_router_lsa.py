...
class TestEInterAreaRouterLsa(unittest.TestCase):
    """EInterAreaRouterLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EInterAreaRouterLsa:
        """Test EInterAreaRouterLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EInterAreaRouterLsa`
        """
        model = EInterAreaRouterLsa()
        if include_optional:
            return EInterAreaRouterLsa(
                type = 'Property',
                value = 56,
    ...
    def testEInterAreaRouterLsa(self):
        """Test EInterAreaRouterLsa"""
