...
class TestPolicyStatementMatchPrefixPrefixSet(unittest.TestCase):
    """PolicyStatementMatchPrefixPrefixSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchPrefixPrefixSet:
        """Test PolicyStatementMatchPrefixPrefixSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchPrefixPrefixSet`
        """
        model = PolicyStatementMatchPrefixPrefixSet()
        if include_optional:
            return PolicyStatementMatchPrefixPrefixSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementMatchPrefixPrefixSet(self):
        """Test PolicyStatementMatchPrefixPrefixSet"""
