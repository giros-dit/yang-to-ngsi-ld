...
class TestLocalDiscriminator(unittest.TestCase):
    """LocalDiscriminator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocalDiscriminator:
        """Test LocalDiscriminator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocalDiscriminator`
        """
    ...
    def testLocalDiscriminator(self):
        """Test LocalDiscriminator"""
