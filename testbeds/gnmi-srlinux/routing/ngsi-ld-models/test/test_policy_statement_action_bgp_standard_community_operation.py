...
class TestPolicyStatementActionBgpStandardCommunityOperation(unittest.TestCase):
    """PolicyStatementActionBgpStandardCommunityOperation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpStandardCommunityOperation:
        """Test PolicyStatementActionBgpStandardCommunityOperation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpStandardCommunityOperation`
        """
        model = PolicyStatementActionBgpStandardCommunityOperation()
        if include_optional:
            return PolicyStatementActionBgpStandardCommunityOperation(
                type = 'Property',
                value = 'add',
    ...
    def testPolicyStatementActionBgpStandardCommunityOperation(self):
        """Test PolicyStatementActionBgpStandardCommunityOperation"""
