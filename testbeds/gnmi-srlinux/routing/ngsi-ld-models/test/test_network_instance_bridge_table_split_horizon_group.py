...
class TestNetworkInstanceBridgeTableSplitHorizonGroup(unittest.TestCase):
    """NetworkInstanceBridgeTableSplitHorizonGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableSplitHorizonGroup:
        """Test NetworkInstanceBridgeTableSplitHorizonGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableSplitHorizonGroup`
        """
        model = NetworkInstanceBridgeTableSplitHorizonGroup()
        if include_optional:
            return NetworkInstanceBridgeTableSplitHorizonGroup(
                id = '',
                type = 'NetworkInstanceBridgeTableSplitHorizonGroup',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceBridgeTableSplitHorizonGroup(self):
        """Test NetworkInstanceBridgeTableSplitHorizonGroup"""
