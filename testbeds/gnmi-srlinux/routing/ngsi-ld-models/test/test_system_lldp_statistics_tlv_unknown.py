...
class TestSystemLldpStatisticsTlvUnknown(unittest.TestCase):
    """SystemLldpStatisticsTlvUnknown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpStatisticsTlvUnknown:
        """Test SystemLldpStatisticsTlvUnknown
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpStatisticsTlvUnknown`
        """
        model = SystemLldpStatisticsTlvUnknown()
        if include_optional:
            return SystemLldpStatisticsTlvUnknown(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpStatisticsTlvUnknown(self):
        """Test SystemLldpStatisticsTlvUnknown"""
