...
class TestSystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer(unittest.TestCase):
    """SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer:
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer`
        """
        model = SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer()
        if include_optional:
            return SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer(
                id = '',
                type = 'SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer(self):
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeer"""
