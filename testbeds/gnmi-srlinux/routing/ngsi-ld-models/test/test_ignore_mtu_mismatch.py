...
class TestIgnoreMtuMismatch(unittest.TestCase):
    """IgnoreMtuMismatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IgnoreMtuMismatch:
        """Test IgnoreMtuMismatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IgnoreMtuMismatch`
        """
        model = IgnoreMtuMismatch()
        if include_optional:
            return IgnoreMtuMismatch(
                type = 'Property',
                value = True,
    ...
    def testIgnoreMtuMismatch(self):
        """Test IgnoreMtuMismatch"""
