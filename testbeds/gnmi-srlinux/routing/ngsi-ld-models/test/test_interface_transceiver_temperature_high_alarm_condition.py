...
class TestInterfaceTransceiverTemperatureHighAlarmCondition(unittest.TestCase):
    """InterfaceTransceiverTemperatureHighAlarmCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureHighAlarmCondition:
        """Test InterfaceTransceiverTemperatureHighAlarmCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureHighAlarmCondition`
        """
        model = InterfaceTransceiverTemperatureHighAlarmCondition()
        if include_optional:
            return InterfaceTransceiverTemperatureHighAlarmCondition(
                type = 'Property',
                value = True,
    ...
    def testInterfaceTransceiverTemperatureHighAlarmCondition(self):
        """Test InterfaceTransceiverTemperatureHighAlarmCondition"""
