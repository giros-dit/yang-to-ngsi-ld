...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin"""
