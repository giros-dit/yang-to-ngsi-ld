...
class TestNetworkInstanceRouteTableNextHopCounters(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopCounters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopCounters:
        """Test NetworkInstanceRouteTableNextHopCounters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopCounters`
        """
        model = NetworkInstanceRouteTableNextHopCounters()
        if include_optional:
            return NetworkInstanceRouteTableNextHopCounters(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopCounters',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopCounters(self):
        """Test NetworkInstanceRouteTableNextHopCounters"""
