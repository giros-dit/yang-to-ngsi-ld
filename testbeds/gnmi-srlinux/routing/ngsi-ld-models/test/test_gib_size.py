...
class TestGibSize(unittest.TestCase):
    """GibSize unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GibSize:
        """Test GibSize
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GibSize`
        """
        model = GibSize()
        if include_optional:
            return GibSize(
