...
class TestExportRoutes(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExportRoutes:
        """Test ExportRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportRoutes`
        """
        model = ExportRoutes()
        if include_optional:
            return ExportRoutes(
