...
class TestNetworkInstanceStaticRoutesRouteTagValue(unittest.TestCase):
    """NetworkInstanceStaticRoutesRouteTagValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesRouteTagValue:
        """Test NetworkInstanceStaticRoutesRouteTagValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesRouteTagValue`
        """
        model = NetworkInstanceStaticRoutesRouteTagValue()
        if include_optional:
            return NetworkInstanceStaticRoutesRouteTagValue(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceStaticRoutesRouteTagValue(self):
        """Test NetworkInstanceStaticRoutesRouteTagValue"""
