...
class TestTxTotal(unittest.TestCase):
    """TxTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TxTotal:
        """Test TxTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TxTotal`
        """
        model = TxTotal()
        if include_optional:
            return TxTotal(
