...
class TestNetworkInstanceBridgeTableMacLimitMaximumEntries(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLimitMaximumEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLimitMaximumEntries:
        """Test NetworkInstanceBridgeTableMacLimitMaximumEntries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLimitMaximumEntries`
        """
        model = NetworkInstanceBridgeTableMacLimitMaximumEntries()
        if include_optional:
            return NetworkInstanceBridgeTableMacLimitMaximumEntries(
                type = 'Property',
                value = 1,
    ...
    def testNetworkInstanceBridgeTableMacLimitMaximumEntries(self):
        """Test NetworkInstanceBridgeTableMacLimitMaximumEntries"""
