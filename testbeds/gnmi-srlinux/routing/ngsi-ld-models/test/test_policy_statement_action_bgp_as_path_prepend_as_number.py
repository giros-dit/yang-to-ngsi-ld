...
class TestPolicyStatementActionBgpAsPathPrependAsNumber(unittest.TestCase):
    """PolicyStatementActionBgpAsPathPrependAsNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpAsPathPrependAsNumber:
        """Test PolicyStatementActionBgpAsPathPrependAsNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpAsPathPrependAsNumber`
        """
        model = PolicyStatementActionBgpAsPathPrependAsNumber()
        if include_optional:
            return PolicyStatementActionBgpAsPathPrependAsNumber(
                type = 'Property',
                value = '',
    ...
    def testPolicyStatementActionBgpAsPathPrependAsNumber(self):
        """Test PolicyStatementActionBgpAsPathPrependAsNumber"""
