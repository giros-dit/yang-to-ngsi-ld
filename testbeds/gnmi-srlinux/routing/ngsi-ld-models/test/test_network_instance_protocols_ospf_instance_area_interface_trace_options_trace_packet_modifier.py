...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier(
                type = 'Property',
                value = 'ingress',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier"""
