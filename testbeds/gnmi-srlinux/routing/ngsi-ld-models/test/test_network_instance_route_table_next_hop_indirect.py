...
class TestNetworkInstanceRouteTableNextHopIndirect(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirect:
        """Test NetworkInstanceRouteTableNextHopIndirect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirect`
        """
        model = NetworkInstanceRouteTableNextHopIndirect()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirect(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopIndirect',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopIndirect(self):
        """Test NetworkInstanceRouteTableNextHopIndirect"""
