...
class TestMaxSpfRunInterval(unittest.TestCase):
    """MaxSpfRunInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxSpfRunInterval:
        """Test MaxSpfRunInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxSpfRunInterval`
        """
        model = MaxSpfRunInterval()
        if include_optional:
            return MaxSpfRunInterval(
                type = 'Property',
                value = 0,
    ...
    def testMaxSpfRunInterval(self):
        """Test MaxSpfRunInterval"""
