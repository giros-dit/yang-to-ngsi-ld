...
class TestNetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier(unittest.TestCase):
    """NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier:
        """Test NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier`
        """
        model = NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier()
        if include_optional:
            return NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier(self):
        """Test NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier"""
