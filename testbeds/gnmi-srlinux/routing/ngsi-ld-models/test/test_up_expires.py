...
class TestUpExpires(unittest.TestCase):
    """UpExpires unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpExpires:
        """Test UpExpires
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpExpires`
        """
        model = UpExpires()
        if include_optional:
            return UpExpires(
