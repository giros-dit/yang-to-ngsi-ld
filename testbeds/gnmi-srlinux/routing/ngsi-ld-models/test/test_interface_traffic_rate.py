...
class TestInterfaceTrafficRate(unittest.TestCase):
    """InterfaceTrafficRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTrafficRate:
        """Test InterfaceTrafficRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTrafficRate`
        """
        model = InterfaceTrafficRate()
        if include_optional:
            return InterfaceTrafficRate(
                id = '',
                type = 'InterfaceTrafficRate',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceTrafficRate(self):
        """Test InterfaceTrafficRate"""
