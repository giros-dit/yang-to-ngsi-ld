...
class TestRxLsUpdate(unittest.TestCase):
    """RxLsUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RxLsUpdate:
        """Test RxLsUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RxLsUpdate`
        """
        model = RxLsUpdate()
        if include_optional:
            return RxLsUpdate(
