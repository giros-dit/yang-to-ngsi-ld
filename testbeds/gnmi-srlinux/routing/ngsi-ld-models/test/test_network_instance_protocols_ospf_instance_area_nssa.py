...
class TestNetworkInstanceProtocolsOspfInstanceAreaNssa(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaNssa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaNssa:
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaNssa`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaNssa()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaNssa(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaNssa(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssa"""
