...
class TestNetworkInstanceBridgeTableMacDuplicationAction(unittest.TestCase):
    """NetworkInstanceBridgeTableMacDuplicationAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacDuplicationAction:
        """Test NetworkInstanceBridgeTableMacDuplicationAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacDuplicationAction`
        """
        model = NetworkInstanceBridgeTableMacDuplicationAction()
        if include_optional:
            return NetworkInstanceBridgeTableMacDuplicationAction(
                type = 'Property',
                value = 'stop-learning',
    ...
    def testNetworkInstanceBridgeTableMacDuplicationAction(self):
        """Test NetworkInstanceBridgeTableMacDuplicationAction"""
