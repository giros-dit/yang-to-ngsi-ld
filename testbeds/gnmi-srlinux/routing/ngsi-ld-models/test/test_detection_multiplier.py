...
class TestDetectionMultiplier(unittest.TestCase):
    """DetectionMultiplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetectionMultiplier:
        """Test DetectionMultiplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetectionMultiplier`
        """
        model = DetectionMultiplier()
        if include_optional:
    ...
    def testDetectionMultiplier(self):
        """Test DetectionMultiplier"""
