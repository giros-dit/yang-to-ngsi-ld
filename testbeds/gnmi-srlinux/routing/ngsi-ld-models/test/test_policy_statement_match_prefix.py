...
class TestPolicyStatementMatchPrefix(unittest.TestCase):
    """PolicyStatementMatchPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchPrefix:
        """Test PolicyStatementMatchPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchPrefix`
        """
        model = PolicyStatementMatchPrefix()
        if include_optional:
            return PolicyStatementMatchPrefix(
                id = '',
                type = 'PolicyStatementMatchPrefix',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchPrefix(self):
        """Test PolicyStatementMatchPrefix"""
