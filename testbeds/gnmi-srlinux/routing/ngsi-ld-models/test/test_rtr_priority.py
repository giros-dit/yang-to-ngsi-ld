...
class TestRtrPriority(unittest.TestCase):
    """RtrPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RtrPriority:
        """Test RtrPriority
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RtrPriority`
        """
        model = RtrPriority()
        if include_optional:
            return RtrPriority(
