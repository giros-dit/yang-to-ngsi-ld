...
class TestNetworkInstanceRouteTableIpv4UnicastRouteResilientHash(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteResilientHash unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteResilientHash:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteResilientHash
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteResilientHash`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteResilientHash()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteResilientHash(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteResilientHash(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteResilientHash"""
