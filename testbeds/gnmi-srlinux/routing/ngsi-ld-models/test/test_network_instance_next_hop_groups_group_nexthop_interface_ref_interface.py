...
class TestNetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface:
        """Test NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface"""
