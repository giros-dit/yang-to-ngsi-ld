...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsFibFailedRoutes"""
