...
class TestSystemAuthenticationKeychainKeyMacsecAdminState(unittest.TestCase):
    """SystemAuthenticationKeychainKeyMacsecAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKeyMacsecAdminState:
        """Test SystemAuthenticationKeychainKeyMacsecAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKeyMacsecAdminState`
        """
        model = SystemAuthenticationKeychainKeyMacsecAdminState()
        if include_optional:
            return SystemAuthenticationKeychainKeyMacsecAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testSystemAuthenticationKeychainKeyMacsecAdminState(self):
        """Test SystemAuthenticationKeychainKeyMacsecAdminState"""
