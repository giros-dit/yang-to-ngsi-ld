...
class TestInterfaceSubinterfaceIpv4StatisticsInDiscardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInDiscardedPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets"""
