...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetric"""
