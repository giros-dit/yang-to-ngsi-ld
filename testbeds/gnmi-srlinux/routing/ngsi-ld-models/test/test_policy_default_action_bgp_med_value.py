...
class TestPolicyDefaultActionBgpMedValue(unittest.TestCase):
    """PolicyDefaultActionBgpMedValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpMedValue:
        """Test PolicyDefaultActionBgpMedValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpMedValue`
        """
        model = PolicyDefaultActionBgpMedValue()
        if include_optional:
            return PolicyDefaultActionBgpMedValue(
                type = 'Property',
                value = '',
    ...
    def testPolicyDefaultActionBgpMedValue(self):
        """Test PolicyDefaultActionBgpMedValue"""
