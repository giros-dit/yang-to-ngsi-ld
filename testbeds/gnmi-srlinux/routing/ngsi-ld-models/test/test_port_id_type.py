...
class TestPortIdType(unittest.TestCase):
    """PortIdType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortIdType:
        """Test PortIdType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortIdType`
        """
        model = PortIdType()
        if include_optional:
            return PortIdType(
                type = 'Property',
                value = 'INTERFACE_ALIAS',
