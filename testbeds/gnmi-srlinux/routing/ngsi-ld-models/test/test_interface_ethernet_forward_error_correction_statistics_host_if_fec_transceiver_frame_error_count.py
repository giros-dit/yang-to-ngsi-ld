...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount(
                id = '',
                type = 'InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount"""
