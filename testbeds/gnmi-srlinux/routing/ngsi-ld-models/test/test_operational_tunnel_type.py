...
class TestOperationalTunnelType(unittest.TestCase):
    """OperationalTunnelType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalTunnelType:
        """Test OperationalTunnelType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalTunnelType`
        """
        model = OperationalTunnelType()
        if include_optional:
            return OperationalTunnelType(
                type = 'Property',
                value = '',
    ...
    def testOperationalTunnelType(self):
        """Test OperationalTunnelType"""
