...
class TestNetworkInstanceConnectionPointBridgeTableMacLimit(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacLimit:
        """Test NetworkInstanceConnectionPointBridgeTableMacLimit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacLimit`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacLimit()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacLimit(
                id = '',
                type = 'NetworkInstanceConnectionPointBridgeTableMacLimit',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacLimit(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacLimit"""
