...
class TestCarrierTransitions(unittest.TestCase):
    """CarrierTransitions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CarrierTransitions:
        """Test CarrierTransitions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CarrierTransitions`
        """
        model = CarrierTransitions()
        if include_optional:
            return CarrierTransitions(
                type = 'Property',
                value = 56,
    ...
    def testCarrierTransitions(self):
        """Test CarrierTransitions"""
