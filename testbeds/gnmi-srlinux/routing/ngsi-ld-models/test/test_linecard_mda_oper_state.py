...
class TestLinecardMdaOperState(unittest.TestCase):
    """LinecardMdaOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaOperState:
        """Test LinecardMdaOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaOperState`
        """
        model = LinecardMdaOperState()
        if include_optional:
            return LinecardMdaOperState(
                type = 'Property',
                value = 'up',
    ...
    def testLinecardMdaOperState(self):
        """Test LinecardMdaOperState"""
