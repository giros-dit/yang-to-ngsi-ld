...
class TestNetworkInstanceConnectionPointBridgeTable(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTable:
        """Test NetworkInstanceConnectionPointBridgeTable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTable`
        """
        model = NetworkInstanceConnectionPointBridgeTable()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTable(
                id = '',
                type = 'NetworkInstanceConnectionPointBridgeTable',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceConnectionPointBridgeTable(self):
        """Test NetworkInstanceConnectionPointBridgeTable"""
