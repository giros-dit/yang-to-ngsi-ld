...
class TestSystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled(unittest.TestCase):
    """SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled:
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled`
        """
        model = SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled()
        if include_optional:
            return SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled(
                type = 'Property',
                value = 'unknown',
    ...
    def testSystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled(self):
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled"""
