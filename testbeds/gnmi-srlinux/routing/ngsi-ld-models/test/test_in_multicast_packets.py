...
class TestInMulticastPackets(unittest.TestCase):
    """InMulticastPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InMulticastPackets:
        """Test InMulticastPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InMulticastPackets`
        """
        model = InMulticastPackets()
        if include_optional:
    ...
    def testInMulticastPackets(self):
        """Test InMulticastPackets"""
