...
class TestInterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets"""
