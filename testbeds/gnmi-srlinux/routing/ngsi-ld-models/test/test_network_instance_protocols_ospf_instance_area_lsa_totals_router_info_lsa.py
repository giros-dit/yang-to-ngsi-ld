...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsRouterInfoLsa"""
