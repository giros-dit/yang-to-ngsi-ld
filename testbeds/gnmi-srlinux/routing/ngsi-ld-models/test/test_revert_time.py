...
class TestRevertTime(unittest.TestCase):
    """RevertTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RevertTime:
        """Test RevertTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RevertTime`
        """
        model = RevertTime()
        if include_optional:
            return RevertTime(
