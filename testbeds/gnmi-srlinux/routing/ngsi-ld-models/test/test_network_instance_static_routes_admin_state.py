...
class TestNetworkInstanceStaticRoutesAdminState(unittest.TestCase):
    """NetworkInstanceStaticRoutesAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesAdminState:
        """Test NetworkInstanceStaticRoutesAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesAdminState`
        """
        model = NetworkInstanceStaticRoutesAdminState()
        if include_optional:
            return NetworkInstanceStaticRoutesAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceStaticRoutesAdminState(self):
        """Test NetworkInstanceStaticRoutesAdminState"""
