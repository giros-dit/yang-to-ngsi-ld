...
class TestInterfaceTransceiverVoltageHighAlarmCondition(unittest.TestCase):
    """InterfaceTransceiverVoltageHighAlarmCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageHighAlarmCondition:
        """Test InterfaceTransceiverVoltageHighAlarmCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageHighAlarmCondition`
        """
        model = InterfaceTransceiverVoltageHighAlarmCondition()
        if include_optional:
            return InterfaceTransceiverVoltageHighAlarmCondition(
                type = 'Property',
                value = True,
    ...
    def testInterfaceTransceiverVoltageHighAlarmCondition(self):
        """Test InterfaceTransceiverVoltageHighAlarmCondition"""
