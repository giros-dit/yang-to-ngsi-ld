...
class TestRetransmitInterval(unittest.TestCase):
    """RetransmitInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetransmitInterval:
        """Test RetransmitInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetransmitInterval`
        """
        model = RetransmitInterval()
        if include_optional:
    ...
    def testRetransmitInterval(self):
        """Test RetransmitInterval"""
