...
class TestNetworkInstanceRouteTableNextHopGroupIndex(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupIndex:
        """Test NetworkInstanceRouteTableNextHopGroupIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupIndex`
        """
        model = NetworkInstanceRouteTableNextHopGroupIndex()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupIndex(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopGroupIndex(self):
        """Test NetworkInstanceRouteTableNextHopGroupIndex"""
