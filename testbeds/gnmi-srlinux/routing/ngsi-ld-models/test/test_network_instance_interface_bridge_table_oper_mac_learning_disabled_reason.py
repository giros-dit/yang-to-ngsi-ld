...
class TestNetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason(unittest.TestCase):
    """NetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason:
        """Test NetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason`
        """
        model = NetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason()
        if include_optional:
            return NetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason(
                type = 'Property',
    ...
    def testNetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason(self):
        """Test NetworkInstanceInterfaceBridgeTableOperMacLearningDisabledReason"""
