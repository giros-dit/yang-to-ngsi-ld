...
class TestActiveKeyForSend(unittest.TestCase):
    """ActiveKeyForSend unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveKeyForSend:
        """Test ActiveKeyForSend
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveKeyForSend`
        """
        model = ActiveKeyForSend()
        if include_optional:
            return ActiveKeyForSend(
                type = 'Property',
                value = '',
