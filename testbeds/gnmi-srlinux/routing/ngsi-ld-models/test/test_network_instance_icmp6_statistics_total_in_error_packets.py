...
class TestNetworkInstanceIcmp6StatisticsTotalInErrorPackets(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTotalInErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTotalInErrorPackets:
        """Test NetworkInstanceIcmp6StatisticsTotalInErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTotalInErrorPackets`
        """
        model = NetworkInstanceIcmp6StatisticsTotalInErrorPackets()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTotalInErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmp6StatisticsTotalInErrorPackets(self):
        """Test NetworkInstanceIcmp6StatisticsTotalInErrorPackets"""
