...
class TestLinecardMdaSlot(unittest.TestCase):
    """LinecardMdaSlot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaSlot:
        """Test LinecardMdaSlot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaSlot`
        """
        model = LinecardMdaSlot()
        if include_optional:
            return LinecardMdaSlot(
                type = 'Property',
                value = 1,
