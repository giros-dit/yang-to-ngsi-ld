...
class TestExternSpfTime(unittest.TestCase):
    """ExternSpfTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternSpfTime:
        """Test ExternSpfTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternSpfTime`
        """
        model = ExternSpfTime()
        if include_optional:
            return ExternSpfTime(
                type = 'Property',
                value = 0,
