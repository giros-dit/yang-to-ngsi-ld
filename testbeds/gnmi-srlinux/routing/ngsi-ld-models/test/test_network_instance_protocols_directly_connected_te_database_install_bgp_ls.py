...
class TestNetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs(unittest.TestCase):
    """NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs:
        """Test NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs`
        """
        model = NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs()
        if include_optional:
            return NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs(
                id = '',
                type = 'NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs(self):
        """Test NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs"""
