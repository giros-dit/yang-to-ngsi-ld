...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType(
                type = 'Property',
                value = 'all',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType"""
