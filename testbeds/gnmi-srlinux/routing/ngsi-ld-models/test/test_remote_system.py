...
class TestRemoteSystem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RemoteSystem:
        """Test RemoteSystem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteSystem`
        """
        model = RemoteSystem()
        if include_optional:
            return RemoteSystem(
