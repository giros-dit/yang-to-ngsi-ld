...
class TestInterfaceTransceiverVoltageHighAlarmThreshold(unittest.TestCase):
    """InterfaceTransceiverVoltageHighAlarmThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageHighAlarmThreshold:
        """Test InterfaceTransceiverVoltageHighAlarmThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageHighAlarmThreshold`
        """
        model = InterfaceTransceiverVoltageHighAlarmThreshold()
        if include_optional:
            return InterfaceTransceiverVoltageHighAlarmThreshold(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceTransceiverVoltageHighAlarmThreshold(self):
        """Test InterfaceTransceiverVoltageHighAlarmThreshold"""
