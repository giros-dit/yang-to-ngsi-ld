...
class TestEIntraAreaPrefixLsa(unittest.TestCase):
    """EIntraAreaPrefixLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EIntraAreaPrefixLsa:
        """Test EIntraAreaPrefixLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EIntraAreaPrefixLsa`
        """
        model = EIntraAreaPrefixLsa()
        if include_optional:
            return EIntraAreaPrefixLsa(
                type = 'Property',
                value = 56,
    ...
    def testEIntraAreaPrefixLsa(self):
        """Test EIntraAreaPrefixLsa"""
