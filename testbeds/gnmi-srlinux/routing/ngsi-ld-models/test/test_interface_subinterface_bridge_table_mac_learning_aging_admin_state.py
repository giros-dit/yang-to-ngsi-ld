...
class TestInterfaceSubinterfaceBridgeTableMacLearningAgingAdminState(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState:
        """Test InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState`
        """
        model = InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testInterfaceSubinterfaceBridgeTableMacLearningAgingAdminState(self):
        """Test InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState"""
