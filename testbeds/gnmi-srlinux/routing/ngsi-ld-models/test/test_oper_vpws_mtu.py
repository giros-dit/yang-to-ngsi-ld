...
class TestOperVpwsMtu(unittest.TestCase):
    """OperVpwsMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperVpwsMtu:
        """Test OperVpwsMtu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperVpwsMtu`
        """
        model = OperVpwsMtu()
        if include_optional:
            return OperVpwsMtu(
