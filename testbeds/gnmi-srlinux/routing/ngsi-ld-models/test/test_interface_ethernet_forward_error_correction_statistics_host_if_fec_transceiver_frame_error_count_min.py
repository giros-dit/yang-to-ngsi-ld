...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin"""
