...
class TestRetransmittedSegments(unittest.TestCase):
    """RetransmittedSegments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetransmittedSegments:
        """Test RetransmittedSegments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetransmittedSegments`
        """
        model = RetransmittedSegments()
        if include_optional:
    ...
    def testRetransmittedSegments(self):
        """Test RetransmittedSegments"""
