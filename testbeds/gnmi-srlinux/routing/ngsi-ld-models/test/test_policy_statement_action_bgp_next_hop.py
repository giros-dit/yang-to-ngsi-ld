...
class TestPolicyStatementActionBgpNextHop(unittest.TestCase):
    """PolicyStatementActionBgpNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpNextHop:
        """Test PolicyStatementActionBgpNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpNextHop`
        """
        model = PolicyStatementActionBgpNextHop()
        if include_optional:
            return PolicyStatementActionBgpNextHop(
                id = '',
                type = 'PolicyStatementActionBgpNextHop',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpNextHop(self):
        """Test PolicyStatementActionBgpNextHop"""
