...
class TestNetworkInstanceConnectionPointBridgeTableMacLearning(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacLearning unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacLearning:
        """Test NetworkInstanceConnectionPointBridgeTableMacLearning
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacLearning`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacLearning()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacLearning(
                id = '',
                type = 'NetworkInstanceConnectionPointBridgeTableMacLearning',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacLearning(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacLearning"""
