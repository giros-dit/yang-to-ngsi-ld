...
class TestPolicyStatementMatchIsisLevel(unittest.TestCase):
    """PolicyStatementMatchIsisLevel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchIsisLevel:
        """Test PolicyStatementMatchIsisLevel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchIsisLevel`
        """
        model = PolicyStatementMatchIsisLevel()
        if include_optional:
            return PolicyStatementMatchIsisLevel(
                type = 'Property',
                value = 1,
    ...
    def testPolicyStatementMatchIsisLevel(self):
        """Test PolicyStatementMatchIsisLevel"""
