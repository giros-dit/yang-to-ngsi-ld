...
class TestSystemLldpLldpMedNetworkPolicy(unittest.TestCase):
    """SystemLldpLldpMedNetworkPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpLldpMedNetworkPolicy:
        """Test SystemLldpLldpMedNetworkPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpLldpMedNetworkPolicy`
        """
        model = SystemLldpLldpMedNetworkPolicy()
        if include_optional:
            return SystemLldpLldpMedNetworkPolicy(
                id = '',
                type = 'SystemLldpLldpMedNetworkPolicy',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpLldpMedNetworkPolicy(self):
        """Test SystemLldpLldpMedNetworkPolicy"""
