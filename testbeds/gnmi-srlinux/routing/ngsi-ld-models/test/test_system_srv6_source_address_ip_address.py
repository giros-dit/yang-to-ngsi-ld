...
class TestSystemSrv6SourceAddressIpAddress(unittest.TestCase):
    """SystemSrv6SourceAddressIpAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6SourceAddressIpAddress:
        """Test SystemSrv6SourceAddressIpAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6SourceAddressIpAddress`
        """
        model = SystemSrv6SourceAddressIpAddress()
        if include_optional:
            return SystemSrv6SourceAddressIpAddress(
                type = 'Property',
                value = None,
    ...
    def testSystemSrv6SourceAddressIpAddress(self):
        """Test SystemSrv6SourceAddressIpAddress"""
