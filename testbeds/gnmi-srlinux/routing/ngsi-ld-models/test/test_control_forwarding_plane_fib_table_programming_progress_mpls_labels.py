...
class TestControlForwardingPlaneFibTableProgrammingProgressMplsLabels(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressMplsLabels unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressMplsLabels:
        """Test ControlForwardingPlaneFibTableProgrammingProgressMplsLabels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressMplsLabels`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressMplsLabels()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressMplsLabels(
                id = '',
                type = 'ControlForwardingPlaneFibTableProgrammingProgressMplsLabels',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressMplsLabels(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressMplsLabels"""
