...
class TestNetworkInstanceRouteTableNextHopMplsTunnelIpPrefix(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix:
        """Test NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix`
        """
        model = NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix()
        if include_optional:
            return NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopMplsTunnelIpPrefix(self):
        """Test NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix"""
