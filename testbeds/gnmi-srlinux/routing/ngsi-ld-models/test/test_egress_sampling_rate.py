...
class TestEgressSamplingRate(unittest.TestCase):
    """EgressSamplingRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EgressSamplingRate:
        """Test EgressSamplingRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EgressSamplingRate`
        """
        model = EgressSamplingRate()
        if include_optional:
            return EgressSamplingRate(
                type = 'Property',
                value = 0,
    ...
    def testEgressSamplingRate(self):
        """Test EgressSamplingRate"""
