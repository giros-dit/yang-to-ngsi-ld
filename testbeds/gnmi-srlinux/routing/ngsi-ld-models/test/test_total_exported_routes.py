...
class TestTotalExportedRoutes(unittest.TestCase):
    """TotalExportedRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotalExportedRoutes:
        """Test TotalExportedRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotalExportedRoutes`
        """
        model = TotalExportedRoutes()
        if include_optional:
            return TotalExportedRoutes(
                type = 'Property',
                value = 56,
    ...
    def testTotalExportedRoutes(self):
        """Test TotalExportedRoutes"""
