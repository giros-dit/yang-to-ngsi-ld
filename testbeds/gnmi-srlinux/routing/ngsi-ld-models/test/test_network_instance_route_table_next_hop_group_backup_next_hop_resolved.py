...
class TestNetworkInstanceRouteTableNextHopGroupBackupNextHopResolved(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupBackupNextHopResolved unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupBackupNextHopResolved:
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopResolved
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupBackupNextHopResolved`
        """
        model = NetworkInstanceRouteTableNextHopGroupBackupNextHopResolved()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupBackupNextHopResolved(
                type = 'Property',
                value = 'true',
    ...
    def testNetworkInstanceRouteTableNextHopGroupBackupNextHopResolved(self):
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopResolved"""
