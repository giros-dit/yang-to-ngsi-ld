...
class TestNetworkInstanceSystemIpv4Address(unittest.TestCase):
    """NetworkInstanceSystemIpv4Address unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceSystemIpv4Address:
        """Test NetworkInstanceSystemIpv4Address
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceSystemIpv4Address`
        """
        model = NetworkInstanceSystemIpv4Address()
        if include_optional:
            return NetworkInstanceSystemIpv4Address(
                id = '',
                type = 'NetworkInstanceSystemIpv4Address',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceSystemIpv4Address(self):
        """Test NetworkInstanceSystemIpv4Address"""
