...
class TestInterfaceSubinterfaceUnidirectionalLinkDelay(unittest.TestCase):
    """InterfaceSubinterfaceUnidirectionalLinkDelay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceUnidirectionalLinkDelay:
        """Test InterfaceSubinterfaceUnidirectionalLinkDelay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceUnidirectionalLinkDelay`
        """
        model = InterfaceSubinterfaceUnidirectionalLinkDelay()
        if include_optional:
            return InterfaceSubinterfaceUnidirectionalLinkDelay(
                id = '',
                type = 'InterfaceSubinterfaceUnidirectionalLinkDelay',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                static_delay = None,
                last_reported_dynamic_delay = None,
                is_part_of = None
            )
        else:
            return InterfaceSubinterfaceUnidirectionalLinkDelay(
    ...
    def testInterfaceSubinterfaceUnidirectionalLinkDelay(self):
        """Test InterfaceSubinterfaceUnidirectionalLinkDelay"""
