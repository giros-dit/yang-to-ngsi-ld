...
class TestNetworkInstanceRouteTableNextHopGroupBackupActive(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupBackupActive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupBackupActive:
        """Test NetworkInstanceRouteTableNextHopGroupBackupActive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupBackupActive`
        """
        model = NetworkInstanceRouteTableNextHopGroupBackupActive()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupBackupActive(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopGroupBackupActive(self):
        """Test NetworkInstanceRouteTableNextHopGroupBackupActive"""
