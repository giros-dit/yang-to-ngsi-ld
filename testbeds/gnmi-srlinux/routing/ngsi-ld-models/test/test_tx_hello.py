...
class TestTxHello(unittest.TestCase):
    """TxHello unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TxHello:
        """Test TxHello
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TxHello`
        """
        model = TxHello()
        if include_optional:
            return TxHello(
