...
class TestDateCode(unittest.TestCase):
    """DateCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DateCode:
        """Test DateCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DateCode`
        """
        model = DateCode()
        if include_optional:
            return DateCode(
