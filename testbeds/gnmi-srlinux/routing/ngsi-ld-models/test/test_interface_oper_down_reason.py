...
class TestInterfaceOperDownReason(unittest.TestCase):
    """InterfaceOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceOperDownReason:
        """Test InterfaceOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceOperDownReason`
        """
        model = InterfaceOperDownReason()
        if include_optional:
            return InterfaceOperDownReason(
                type = 'Property',
                value = 'port-admin-disabled',
    ...
    def testInterfaceOperDownReason(self):
        """Test InterfaceOperDownReason"""
