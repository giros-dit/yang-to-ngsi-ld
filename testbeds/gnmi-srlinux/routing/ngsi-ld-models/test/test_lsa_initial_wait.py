...
class TestLsaInitialWait(unittest.TestCase):
    """LsaInitialWait unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LsaInitialWait:
        """Test LsaInitialWait
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LsaInitialWait`
        """
        model = LsaInitialWait()
        if include_optional:
            return LsaInitialWait(
                type = 'Property',
                value = 10,
