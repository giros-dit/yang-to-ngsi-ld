...
class TestInterfaceEthernetSymbolMonitorSignalDegradeExponent(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorSignalDegradeExponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorSignalDegradeExponent:
        """Test InterfaceEthernetSymbolMonitorSignalDegradeExponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorSignalDegradeExponent`
        """
        model = InterfaceEthernetSymbolMonitorSignalDegradeExponent()
        if include_optional:
            return InterfaceEthernetSymbolMonitorSignalDegradeExponent(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceEthernetSymbolMonitorSignalDegradeExponent(self):
        """Test InterfaceEthernetSymbolMonitorSignalDegradeExponent"""
