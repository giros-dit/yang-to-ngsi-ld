...
class TestEntriesAgedOut(unittest.TestCase):
    """EntriesAgedOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntriesAgedOut:
        """Test EntriesAgedOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntriesAgedOut`
        """
        model = EntriesAgedOut()
        if include_optional:
            return EntriesAgedOut(
                type = 'Property',
                value = 56,
