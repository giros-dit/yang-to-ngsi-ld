...
class TestSystemSrv6LocatorMicroSegmentArgumentLength(unittest.TestCase):
    """SystemSrv6LocatorMicroSegmentArgumentLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorMicroSegmentArgumentLength:
        """Test SystemSrv6LocatorMicroSegmentArgumentLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorMicroSegmentArgumentLength`
        """
        model = SystemSrv6LocatorMicroSegmentArgumentLength()
        if include_optional:
            return SystemSrv6LocatorMicroSegmentArgumentLength(
                type = 'Property',
                value = 56,
    ...
    def testSystemSrv6LocatorMicroSegmentArgumentLength(self):
        """Test SystemSrv6LocatorMicroSegmentArgumentLength"""
