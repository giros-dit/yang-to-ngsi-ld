...
class TestNetworkInstanceBridgeTableMacLearning(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLearning unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLearning:
        """Test NetworkInstanceBridgeTableMacLearning
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLearning`
        """
        model = NetworkInstanceBridgeTableMacLearning()
        if include_optional:
            return NetworkInstanceBridgeTableMacLearning(
                id = '',
    ...
    def testNetworkInstanceBridgeTableMacLearning(self):
        """Test NetworkInstanceBridgeTableMacLearning"""
