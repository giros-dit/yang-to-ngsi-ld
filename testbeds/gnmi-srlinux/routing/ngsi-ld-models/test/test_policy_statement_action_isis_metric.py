...
class TestPolicyStatementActionIsisMetric(unittest.TestCase):
    """PolicyStatementActionIsisMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionIsisMetric:
        """Test PolicyStatementActionIsisMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionIsisMetric`
        """
        model = PolicyStatementActionIsisMetric()
        if include_optional:
            return PolicyStatementActionIsisMetric(
                id = '',
                type = 'PolicyStatementActionIsisMetric',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionIsisMetric(self):
        """Test PolicyStatementActionIsisMetric"""
