...
class TestNetworkInstanceConnectionPointPseudowire(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowire unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowire:
        """Test NetworkInstanceConnectionPointPseudowire
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowire`
        """
        model = NetworkInstanceConnectionPointPseudowire()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowire(
                id = '',
                type = 'NetworkInstanceConnectionPointPseudowire',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceConnectionPointPseudowire(self):
        """Test NetworkInstanceConnectionPointPseudowire"""
