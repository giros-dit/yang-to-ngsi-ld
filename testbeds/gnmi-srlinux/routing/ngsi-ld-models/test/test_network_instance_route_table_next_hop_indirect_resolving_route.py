...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingRoute(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingRoute:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingRoute`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingRoute()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingRoute(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopIndirectResolvingRoute',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingRoute(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRoute"""
