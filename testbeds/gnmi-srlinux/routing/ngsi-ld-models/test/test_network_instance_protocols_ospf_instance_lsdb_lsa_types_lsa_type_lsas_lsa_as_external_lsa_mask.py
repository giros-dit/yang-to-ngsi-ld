...
class TestNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask:
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask`
        """
        model = NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask(self):
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaMask"""
