...
class TestInterfaceSubinterfaceIpv6AddressOrigin(unittest.TestCase):
    """InterfaceSubinterfaceIpv6AddressOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6AddressOrigin:
        """Test InterfaceSubinterfaceIpv6AddressOrigin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6AddressOrigin`
        """
        model = InterfaceSubinterfaceIpv6AddressOrigin()
        if include_optional:
            return InterfaceSubinterfaceIpv6AddressOrigin(
                type = 'Property',
                value = 'other',
    ...
    def testInterfaceSubinterfaceIpv6AddressOrigin(self):
        """Test InterfaceSubinterfaceIpv6AddressOrigin"""
