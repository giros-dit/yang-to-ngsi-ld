...
class TestNetworkInstanceTcpConnectionLocalAddress(unittest.TestCase):
    """NetworkInstanceTcpConnectionLocalAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpConnectionLocalAddress:
        """Test NetworkInstanceTcpConnectionLocalAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpConnectionLocalAddress`
        """
        model = NetworkInstanceTcpConnectionLocalAddress()
        if include_optional:
            return NetworkInstanceTcpConnectionLocalAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceTcpConnectionLocalAddress(self):
        """Test NetworkInstanceTcpConnectionLocalAddress"""
