...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter(
                id = '',
                type = 'InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter"""
