...
class TestPolicyStatementMatchOspfInstanceId(unittest.TestCase):
    """PolicyStatementMatchOspfInstanceId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchOspfInstanceId:
        """Test PolicyStatementMatchOspfInstanceId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchOspfInstanceId`
        """
        model = PolicyStatementMatchOspfInstanceId()
        if include_optional:
            return PolicyStatementMatchOspfInstanceId(
                type = 'Property',
                value = 0,
    ...
    def testPolicyStatementMatchOspfInstanceId(self):
        """Test PolicyStatementMatchOspfInstanceId"""
