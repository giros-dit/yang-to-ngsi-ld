...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsBadPackets"""
