...
class TestAdjacencyCheck(unittest.TestCase):
    """AdjacencyCheck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdjacencyCheck:
        """Test AdjacencyCheck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdjacencyCheck`
        """
        model = AdjacencyCheck()
        if include_optional:
