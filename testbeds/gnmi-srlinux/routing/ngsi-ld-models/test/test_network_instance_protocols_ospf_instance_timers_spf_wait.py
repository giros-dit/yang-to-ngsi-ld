...
class TestNetworkInstanceProtocolsOspfInstanceTimersSpfWait(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTimersSpfWait unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTimersSpfWait:
        """Test NetworkInstanceProtocolsOspfInstanceTimersSpfWait
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTimersSpfWait`
        """
        model = NetworkInstanceProtocolsOspfInstanceTimersSpfWait()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTimersSpfWait(
                id = '',
                ...
                spf_max_wait = None,
                spf_initial_wait = None,
                spf_second_wait = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceTimersSpfWait(
    ...
    def testNetworkInstanceProtocolsOspfInstanceTimersSpfWait(self):
        """Test NetworkInstanceProtocolsOspfInstanceTimersSpfWait"""
