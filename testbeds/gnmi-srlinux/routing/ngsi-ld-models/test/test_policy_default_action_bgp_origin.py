...
class TestPolicyDefaultActionBgpOrigin(unittest.TestCase):
    """PolicyDefaultActionBgpOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpOrigin:
        """Test PolicyDefaultActionBgpOrigin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpOrigin`
        """
        model = PolicyDefaultActionBgpOrigin()
        if include_optional:
            return PolicyDefaultActionBgpOrigin(
                id = '',
                type = 'PolicyDefaultActionBgpOrigin',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpOrigin(self):
        """Test PolicyDefaultActionBgpOrigin"""
