...
class TestInterfaceSubinterfaceIpv4StatisticsOutForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets:
        """Test InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsOutForwardedOctets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets"""
