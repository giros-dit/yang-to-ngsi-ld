...
class TestSystemLldpBgpAutoDiscoveryAdminState(unittest.TestCase):
    """SystemLldpBgpAutoDiscoveryAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpBgpAutoDiscoveryAdminState:
        """Test SystemLldpBgpAutoDiscoveryAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpBgpAutoDiscoveryAdminState`
        """
        model = SystemLldpBgpAutoDiscoveryAdminState()
        if include_optional:
            return SystemLldpBgpAutoDiscoveryAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testSystemLldpBgpAutoDiscoveryAdminState(self):
        """Test SystemLldpBgpAutoDiscoveryAdminState"""
