...
class TestNetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface:
        """Test NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface`
        """
        model = NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface()
        if include_optional:
            return NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface(self):
        """Test NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface"""
