...
class TestLinecardMdaRemovable(unittest.TestCase):
    """LinecardMdaRemovable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaRemovable:
        """Test LinecardMdaRemovable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaRemovable`
        """
        model = LinecardMdaRemovable()
        if include_optional:
            return LinecardMdaRemovable(
                type = 'Property',
                value = True,
    ...
    def testLinecardMdaRemovable(self):
        """Test LinecardMdaRemovable"""
