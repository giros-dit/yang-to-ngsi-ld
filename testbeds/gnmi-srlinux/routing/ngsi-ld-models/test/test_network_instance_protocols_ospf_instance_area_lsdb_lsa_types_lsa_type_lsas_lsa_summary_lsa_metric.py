...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaMetric"""
