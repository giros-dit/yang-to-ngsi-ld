...
class TestLsaAccumulate(unittest.TestCase):
    """LsaAccumulate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LsaAccumulate:
        """Test LsaAccumulate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LsaAccumulate`
        """
        model = LsaAccumulate()
        if include_optional:
            return LsaAccumulate(
                type = 'Property',
                value = 0,
