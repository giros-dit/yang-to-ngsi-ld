...
class TestSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId:
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId`
        """
        model = SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId(
                type = 'Property',
                value = 0,
    ...
    def testSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId(self):
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId"""
