...
class TestNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType:
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType`
        """
        model = NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType(self):
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaType"""
