...
class TestInterfaceSubinterfaceStatisticsOutDiscardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsOutDiscardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsOutDiscardedPackets:
        """Test InterfaceSubinterfaceStatisticsOutDiscardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsOutDiscardedPackets`
        """
        model = InterfaceSubinterfaceStatisticsOutDiscardedPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsOutDiscardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsOutDiscardedPackets(self):
        """Test InterfaceSubinterfaceStatisticsOutDiscardedPackets"""
