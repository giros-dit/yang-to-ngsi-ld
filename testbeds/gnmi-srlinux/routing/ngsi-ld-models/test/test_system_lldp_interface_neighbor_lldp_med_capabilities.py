...
class TestSystemLldpInterfaceNeighborLldpMedCapabilities(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedCapabilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedCapabilities:
        """Test SystemLldpInterfaceNeighborLldpMedCapabilities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedCapabilities`
        """
        model = SystemLldpInterfaceNeighborLldpMedCapabilities()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedCapabilities(
                id = '',
                type = 'SystemLldpInterfaceNeighborLldpMedCapabilities',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceNeighborLldpMedCapabilities(self):
        """Test SystemLldpInterfaceNeighborLldpMedCapabilities"""
