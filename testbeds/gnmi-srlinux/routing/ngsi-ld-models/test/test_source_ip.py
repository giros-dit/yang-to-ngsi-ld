...
class TestSourceIp(unittest.TestCase):
    """SourceIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SourceIp:
        """Test SourceIp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SourceIp`
        """
        model = SourceIp()
        if include_optional:
            return SourceIp(
