...
class TestLinecardForwardingComplexPartNumber(unittest.TestCase):
    """LinecardForwardingComplexPartNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexPartNumber:
        """Test LinecardForwardingComplexPartNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexPartNumber`
        """
        model = LinecardForwardingComplexPartNumber()
        if include_optional:
            return LinecardForwardingComplexPartNumber(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexPartNumber(self):
        """Test LinecardForwardingComplexPartNumber"""
