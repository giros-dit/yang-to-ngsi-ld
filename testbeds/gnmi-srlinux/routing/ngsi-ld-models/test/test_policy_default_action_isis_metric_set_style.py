...
class TestPolicyDefaultActionIsisMetricSetStyle(unittest.TestCase):
    """PolicyDefaultActionIsisMetricSetStyle unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionIsisMetricSetStyle:
        """Test PolicyDefaultActionIsisMetricSetStyle
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionIsisMetricSetStyle`
        """
        model = PolicyDefaultActionIsisMetricSetStyle()
        if include_optional:
            return PolicyDefaultActionIsisMetricSetStyle(
                type = 'Property',
                value = 'wide',
    ...
    def testPolicyDefaultActionIsisMetricSetStyle(self):
        """Test PolicyDefaultActionIsisMetricSetStyle"""
