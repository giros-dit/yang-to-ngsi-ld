...
class TestInterfaceTransceiverTemperatureLowWarningCondition(unittest.TestCase):
    """InterfaceTransceiverTemperatureLowWarningCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureLowWarningCondition:
        """Test InterfaceTransceiverTemperatureLowWarningCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureLowWarningCondition`
        """
        model = InterfaceTransceiverTemperatureLowWarningCondition()
        if include_optional:
            return InterfaceTransceiverTemperatureLowWarningCondition(
                type = 'Property',
                value = True,
    ...
    def testInterfaceTransceiverTemperatureLowWarningCondition(self):
        """Test InterfaceTransceiverTemperatureLowWarningCondition"""
