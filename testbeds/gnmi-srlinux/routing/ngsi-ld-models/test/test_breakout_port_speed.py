...
class TestBreakoutPortSpeed(unittest.TestCase):
    """BreakoutPortSpeed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BreakoutPortSpeed:
        """Test BreakoutPortSpeed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BreakoutPortSpeed`
        """
        model = BreakoutPortSpeed()
        if include_optional:
            return BreakoutPortSpeed(
                type = 'Property',
                value = '1G',
    ...
    def testBreakoutPortSpeed(self):
        """Test BreakoutPortSpeed"""
