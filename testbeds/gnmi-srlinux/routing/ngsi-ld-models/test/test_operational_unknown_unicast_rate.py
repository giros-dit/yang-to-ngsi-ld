...
class TestOperationalUnknownUnicastRate(unittest.TestCase):
    """OperationalUnknownUnicastRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalUnknownUnicastRate:
        """Test OperationalUnknownUnicastRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalUnknownUnicastRate`
        """
        model = OperationalUnknownUnicastRate()
        if include_optional:
            return OperationalUnknownUnicastRate(
                type = 'Property',
                value = 56,
    ...
    def testOperationalUnknownUnicastRate(self):
        """Test OperationalUnknownUnicastRate"""
