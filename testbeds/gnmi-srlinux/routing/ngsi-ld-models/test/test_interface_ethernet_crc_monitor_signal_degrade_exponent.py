...
class TestInterfaceEthernetCrcMonitorSignalDegradeExponent(unittest.TestCase):
    """InterfaceEthernetCrcMonitorSignalDegradeExponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitorSignalDegradeExponent:
        """Test InterfaceEthernetCrcMonitorSignalDegradeExponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitorSignalDegradeExponent`
        """
        model = InterfaceEthernetCrcMonitorSignalDegradeExponent()
        if include_optional:
            return InterfaceEthernetCrcMonitorSignalDegradeExponent(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceEthernetCrcMonitorSignalDegradeExponent(self):
        """Test InterfaceEthernetCrcMonitorSignalDegradeExponent"""
