...
class TestNetworkInstanceProtocolsOspfInstanceSpf(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceSpf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceSpf:
        """Test NetworkInstanceProtocolsOspfInstanceSpf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceSpf`
        """
        model = NetworkInstanceProtocolsOspfInstanceSpf()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceSpf(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceSpf',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                full_spf_runs = None,
                ext_spf_runs = None,
                incremental_inter_spf_runs = None,
                incremental_ext_spf_runs = None,
                spf_attempts_failed = None,
                max_spf_run_interval = None,
                min_spf_run_interval = None,
                avg_spf_run_interval = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceSpf(
    ...
    def testNetworkInstanceProtocolsOspfInstanceSpf(self):
        """Test NetworkInstanceProtocolsOspfInstanceSpf"""
