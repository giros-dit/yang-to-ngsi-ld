...
class TestExportNeighbors(unittest.TestCase):
    """ExportNeighbors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExportNeighbors:
        """Test ExportNeighbors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExportNeighbors`
        """
        model = ExportNeighbors()
        if include_optional:
            return ExportNeighbors(
                type = 'Property',
                value = True,
