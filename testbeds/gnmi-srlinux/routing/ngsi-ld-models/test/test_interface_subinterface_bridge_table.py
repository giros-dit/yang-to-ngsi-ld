...
class TestInterfaceSubinterfaceBridgeTable(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTable:
        """Test InterfaceSubinterfaceBridgeTable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTable`
        """
        model = InterfaceSubinterfaceBridgeTable()
        if include_optional:
            return InterfaceSubinterfaceBridgeTable(
                id = '',
    ...
    def testInterfaceSubinterfaceBridgeTable(self):
        """Test InterfaceSubinterfaceBridgeTable"""
