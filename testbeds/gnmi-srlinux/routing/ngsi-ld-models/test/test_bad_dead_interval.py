...
class TestBadDeadInterval(unittest.TestCase):
    """BadDeadInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadDeadInterval:
        """Test BadDeadInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadDeadInterval`
        """
        model = BadDeadInterval()
        if include_optional:
            return BadDeadInterval(
                type = 'Property',
                value = 56,
