...
class TestNetworkInstanceIcmpStatisticsTotalOutErrorPackets(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTotalOutErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTotalOutErrorPackets:
        """Test NetworkInstanceIcmpStatisticsTotalOutErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTotalOutErrorPackets`
        """
        model = NetworkInstanceIcmpStatisticsTotalOutErrorPackets()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTotalOutErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmpStatisticsTotalOutErrorPackets(self):
        """Test NetworkInstanceIcmpStatisticsTotalOutErrorPackets"""
