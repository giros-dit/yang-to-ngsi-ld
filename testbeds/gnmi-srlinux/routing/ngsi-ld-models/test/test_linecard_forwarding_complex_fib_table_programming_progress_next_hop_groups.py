...
class TestLinecardForwardingComplexFibTableProgrammingProgressNextHopGroups(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups:
        """Test LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups(
                id = '',
                type = 'LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                entries_remaining_to_add = None,
                entries_remaining_to_modify = None,
                last_sync_time = None,
                is_part_of = None
            )
        else:
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressNextHopGroups(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups"""
