...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsdb(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsdb unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsdb:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdb
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsdb`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsdb()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsdb(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceAreaLsdb',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsdb(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdb"""
