...
class TestLinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd:
        """Test LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd"""
