...
class TestInterfaceName(unittest.TestCase):
    """InterfaceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceName:
        """Test InterfaceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceName`
        """
        model = InterfaceName()
        if include_optional:
