...
class TestInterfaceSubinterfaceLastChange(unittest.TestCase):
    """InterfaceSubinterfaceLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceLastChange:
        """Test InterfaceSubinterfaceLastChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceLastChange`
        """
        model = InterfaceSubinterfaceLastChange()
        if include_optional:
            return InterfaceSubinterfaceLastChange(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceLastChange(self):
        """Test InterfaceSubinterfaceLastChange"""
