...
class TestInterfaceAdapterType(unittest.TestCase):
    """InterfaceAdapterType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAdapterType:
        """Test InterfaceAdapterType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAdapterType`
        """
        model = InterfaceAdapterType()
        if include_optional:
            return InterfaceAdapterType(
                type = 'Property',
                value = 'unknown',
    ...
    def testInterfaceAdapterType(self):
        """Test InterfaceAdapterType"""
