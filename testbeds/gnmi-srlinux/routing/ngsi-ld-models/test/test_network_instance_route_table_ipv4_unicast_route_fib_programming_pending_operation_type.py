...
class TestNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingPendingOperationType"""
