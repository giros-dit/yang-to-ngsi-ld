...
class TestInterfaceEthernetStandbySignaling(unittest.TestCase):
    """InterfaceEthernetStandbySignaling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStandbySignaling:
        """Test InterfaceEthernetStandbySignaling
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStandbySignaling`
        """
        model = InterfaceEthernetStandbySignaling()
        if include_optional:
            return InterfaceEthernetStandbySignaling(
                type = 'Property',
                value = 'power-off',
    ...
    def testInterfaceEthernetStandbySignaling(self):
        """Test InterfaceEthernetStandbySignaling"""
