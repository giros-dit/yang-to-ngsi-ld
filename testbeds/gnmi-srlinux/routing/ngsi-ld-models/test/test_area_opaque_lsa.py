...
class TestAreaOpaqueLsa(unittest.TestCase):
    """AreaOpaqueLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaOpaqueLsa:
        """Test AreaOpaqueLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaOpaqueLsa`
        """
        model = AreaOpaqueLsa()
        if include_optional:
