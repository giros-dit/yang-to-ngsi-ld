...
class TestLinecardMdaTemperature(unittest.TestCase):
    """LinecardMdaTemperature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaTemperature:
        """Test LinecardMdaTemperature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaTemperature`
        """
        model = LinecardMdaTemperature()
        if include_optional:
            return LinecardMdaTemperature(
                id = '',
                type = 'LinecardMdaTemperature',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardMdaTemperature(self):
        """Test LinecardMdaTemperature"""
