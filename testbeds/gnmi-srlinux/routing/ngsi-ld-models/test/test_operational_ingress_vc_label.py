...
class TestOperationalIngressVcLabel(unittest.TestCase):
    """OperationalIngressVcLabel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalIngressVcLabel:
        """Test OperationalIngressVcLabel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalIngressVcLabel`
        """
        model = OperationalIngressVcLabel()
        if include_optional:
            return OperationalIngressVcLabel(
                type = 'Property',
                value = 56,
    ...
    def testOperationalIngressVcLabel(self):
        """Test OperationalIngressVcLabel"""
