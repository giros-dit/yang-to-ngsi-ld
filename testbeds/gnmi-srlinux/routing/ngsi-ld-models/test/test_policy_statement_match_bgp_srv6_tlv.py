...
class TestPolicyStatementMatchBgpSrv6Tlv(unittest.TestCase):
    """PolicyStatementMatchBgpSrv6Tlv unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpSrv6Tlv:
        """Test PolicyStatementMatchBgpSrv6Tlv
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpSrv6Tlv`
        """
        model = PolicyStatementMatchBgpSrv6Tlv()
        if include_optional:
            return PolicyStatementMatchBgpSrv6Tlv(
                type = 'Property',
                value = 'present',
    ...
    def testPolicyStatementMatchBgpSrv6Tlv(self):
        """Test PolicyStatementMatchBgpSrv6Tlv"""
