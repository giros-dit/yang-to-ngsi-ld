...
class TestInSegments(unittest.TestCase):
    """InSegments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InSegments:
        """Test InSegments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InSegments`
        """
        model = InSegments()
        if include_optional:
            return InSegments(
