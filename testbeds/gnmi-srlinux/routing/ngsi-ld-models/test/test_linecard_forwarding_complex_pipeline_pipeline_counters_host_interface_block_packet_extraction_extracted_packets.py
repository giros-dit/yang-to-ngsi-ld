...
class TestLinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets(unittest.TestCase):
    """LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets:
        """Test LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets`
        """
        model = LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets()
        if include_optional:
            return LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets(self):
        """Test LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets"""
