...
class TestPolicyStatementActionBgpAsPathPrepend(unittest.TestCase):
    """PolicyStatementActionBgpAsPathPrepend unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpAsPathPrepend:
        """Test PolicyStatementActionBgpAsPathPrepend
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpAsPathPrepend`
        """
        model = PolicyStatementActionBgpAsPathPrepend()
        if include_optional:
            return PolicyStatementActionBgpAsPathPrepend(
                id = '',
                type = 'PolicyStatementActionBgpAsPathPrepend',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpAsPathPrepend(self):
        """Test PolicyStatementActionBgpAsPathPrepend"""
