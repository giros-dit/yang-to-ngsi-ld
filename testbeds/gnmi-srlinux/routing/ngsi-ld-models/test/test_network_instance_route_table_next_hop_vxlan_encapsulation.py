...
class TestNetworkInstanceRouteTableNextHopVxlanEncapsulation(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopVxlanEncapsulation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopVxlanEncapsulation:
        """Test NetworkInstanceRouteTableNextHopVxlanEncapsulation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopVxlanEncapsulation`
        """
        model = NetworkInstanceRouteTableNextHopVxlanEncapsulation()
        if include_optional:
            return NetworkInstanceRouteTableNextHopVxlanEncapsulation(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopVxlanEncapsulation',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopVxlanEncapsulation(self):
        """Test NetworkInstanceRouteTableNextHopVxlanEncapsulation"""
