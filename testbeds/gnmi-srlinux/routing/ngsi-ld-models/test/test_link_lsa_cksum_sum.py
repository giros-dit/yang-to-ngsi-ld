...
class TestLinkLsaCksumSum(unittest.TestCase):
    """LinkLsaCksumSum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkLsaCksumSum:
        """Test LinkLsaCksumSum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkLsaCksumSum`
        """
        model = LinkLsaCksumSum()
        if include_optional:
            return LinkLsaCksumSum(
                type = 'Property',
                value = '0x2',
