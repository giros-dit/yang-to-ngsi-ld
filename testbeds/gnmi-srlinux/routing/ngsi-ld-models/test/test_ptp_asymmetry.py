...
class TestPtpAsymmetry(unittest.TestCase):
    """PtpAsymmetry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PtpAsymmetry:
        """Test PtpAsymmetry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PtpAsymmetry`
        """
        model = PtpAsymmetry()
        if include_optional:
            return PtpAsymmetry(
