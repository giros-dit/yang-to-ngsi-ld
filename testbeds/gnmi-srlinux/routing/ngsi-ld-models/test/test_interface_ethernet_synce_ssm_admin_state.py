...
class TestInterfaceEthernetSynceSsmAdminState(unittest.TestCase):
    """InterfaceEthernetSynceSsmAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSynceSsmAdminState:
        """Test InterfaceEthernetSynceSsmAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSynceSsmAdminState`
        """
        model = InterfaceEthernetSynceSsmAdminState()
        if include_optional:
            return InterfaceEthernetSynceSsmAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testInterfaceEthernetSynceSsmAdminState(self):
        """Test InterfaceEthernetSynceSsmAdminState"""
