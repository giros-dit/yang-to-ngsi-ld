...
class TestLinecardMdaSerialNumber(unittest.TestCase):
    """LinecardMdaSerialNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaSerialNumber:
        """Test LinecardMdaSerialNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaSerialNumber`
        """
        model = LinecardMdaSerialNumber()
        if include_optional:
            return LinecardMdaSerialNumber(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaSerialNumber(self):
        """Test LinecardMdaSerialNumber"""
