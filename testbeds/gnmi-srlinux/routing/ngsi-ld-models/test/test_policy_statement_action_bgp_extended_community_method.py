...
class TestPolicyStatementActionBgpExtendedCommunityMethod(unittest.TestCase):
    """PolicyStatementActionBgpExtendedCommunityMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpExtendedCommunityMethod:
        """Test PolicyStatementActionBgpExtendedCommunityMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpExtendedCommunityMethod`
        """
        model = PolicyStatementActionBgpExtendedCommunityMethod()
        if include_optional:
            return PolicyStatementActionBgpExtendedCommunityMethod(
                type = 'Property',
                value = 'reference',
    ...
    def testPolicyStatementActionBgpExtendedCommunityMethod(self):
        """Test PolicyStatementActionBgpExtendedCommunityMethod"""
