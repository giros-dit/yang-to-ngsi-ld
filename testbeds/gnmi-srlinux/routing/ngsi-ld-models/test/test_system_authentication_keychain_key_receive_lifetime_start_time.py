...
class TestSystemAuthenticationKeychainKeyReceiveLifetimeStartTime(unittest.TestCase):
    """SystemAuthenticationKeychainKeyReceiveLifetimeStartTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKeyReceiveLifetimeStartTime:
        """Test SystemAuthenticationKeychainKeyReceiveLifetimeStartTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKeyReceiveLifetimeStartTime`
        """
        model = SystemAuthenticationKeychainKeyReceiveLifetimeStartTime()
        if include_optional:
            return SystemAuthenticationKeychainKeyReceiveLifetimeStartTime(
                type = 'Property',
                value = '',
    ...
    def testSystemAuthenticationKeychainKeyReceiveLifetimeStartTime(self):
        """Test SystemAuthenticationKeychainKeyReceiveLifetimeStartTime"""
