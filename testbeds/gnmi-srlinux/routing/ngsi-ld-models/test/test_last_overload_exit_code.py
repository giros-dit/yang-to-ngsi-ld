...
class TestLastOverloadExitCode(unittest.TestCase):
    """LastOverloadExitCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastOverloadExitCode:
        """Test LastOverloadExitCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastOverloadExitCode`
        """
        model = LastOverloadExitCode()
        if include_optional:
            return LastOverloadExitCode(
                type = 'Property',
                value = 'none',
    ...
    def testLastOverloadExitCode(self):
        """Test LastOverloadExitCode"""
