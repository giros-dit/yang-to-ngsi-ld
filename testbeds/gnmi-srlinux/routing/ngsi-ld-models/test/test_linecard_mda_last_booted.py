...
class TestLinecardMdaLastBooted(unittest.TestCase):
    """LinecardMdaLastBooted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaLastBooted:
        """Test LinecardMdaLastBooted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaLastBooted`
        """
        model = LinecardMdaLastBooted()
        if include_optional:
            return LinecardMdaLastBooted(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaLastBooted(self):
        """Test LinecardMdaLastBooted"""
