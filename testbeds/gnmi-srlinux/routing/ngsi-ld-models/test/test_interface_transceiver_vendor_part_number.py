...
class TestInterfaceTransceiverVendorPartNumber(unittest.TestCase):
    """InterfaceTransceiverVendorPartNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVendorPartNumber:
        """Test InterfaceTransceiverVendorPartNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVendorPartNumber`
        """
        model = InterfaceTransceiverVendorPartNumber()
        if include_optional:
            return InterfaceTransceiverVendorPartNumber(
                type = 'Property',
                value = '',
    ...
    def testInterfaceTransceiverVendorPartNumber(self):
        """Test InterfaceTransceiverVendorPartNumber"""
