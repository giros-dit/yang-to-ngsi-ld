...
class TestInterfaceSubinterfaceType(unittest.TestCase):
    """InterfaceSubinterfaceType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceType:
        """Test InterfaceSubinterfaceType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceType`
        """
        model = InterfaceSubinterfaceType()
        if include_optional:
            return InterfaceSubinterfaceType(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceType(self):
        """Test InterfaceSubinterfaceType"""
