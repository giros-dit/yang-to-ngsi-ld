...
class TestNetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName"""
