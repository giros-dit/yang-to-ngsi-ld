...
class TestInterfaceEthernetExponentialPortDampeningOperState(unittest.TestCase):
    """InterfaceEthernetExponentialPortDampeningOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetExponentialPortDampeningOperState:
        """Test InterfaceEthernetExponentialPortDampeningOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetExponentialPortDampeningOperState`
        """
        model = InterfaceEthernetExponentialPortDampeningOperState()
        if include_optional:
            return InterfaceEthernetExponentialPortDampeningOperState(
                type = 'Property',
                value = 'active',
    ...
    def testInterfaceEthernetExponentialPortDampeningOperState(self):
        """Test InterfaceEthernetExponentialPortDampeningOperState"""
