...
class TestAdvertiseL2Mtu(unittest.TestCase):
    """AdvertiseL2Mtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvertiseL2Mtu:
        """Test AdvertiseL2Mtu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvertiseL2Mtu`
        """
        model = AdvertiseL2Mtu()
        if include_optional:
            return AdvertiseL2Mtu(
                type = 'Property',
                value = 1450,
