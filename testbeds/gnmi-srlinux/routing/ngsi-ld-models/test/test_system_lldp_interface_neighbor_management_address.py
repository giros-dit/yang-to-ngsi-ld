...
class TestSystemLldpInterfaceNeighborManagementAddress(unittest.TestCase):
    """SystemLldpInterfaceNeighborManagementAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborManagementAddress:
        """Test SystemLldpInterfaceNeighborManagementAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborManagementAddress`
        """
        model = SystemLldpInterfaceNeighborManagementAddress()
        if include_optional:
            return SystemLldpInterfaceNeighborManagementAddress(
                id = '',
                type = 'SystemLldpInterfaceNeighborManagementAddress',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceNeighborManagementAddress(self):
        """Test SystemLldpInterfaceNeighborManagementAddress"""
