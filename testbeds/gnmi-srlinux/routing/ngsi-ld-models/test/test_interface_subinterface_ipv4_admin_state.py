...
class TestInterfaceSubinterfaceIpv4AdminState(unittest.TestCase):
    """InterfaceSubinterfaceIpv4AdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4AdminState:
        """Test InterfaceSubinterfaceIpv4AdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4AdminState`
        """
        model = InterfaceSubinterfaceIpv4AdminState()
        if include_optional:
            return InterfaceSubinterfaceIpv4AdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testInterfaceSubinterfaceIpv4AdminState(self):
        """Test InterfaceSubinterfaceIpv4AdminState"""
