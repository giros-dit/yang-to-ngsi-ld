...
class TestPolicyStatementMatchBgp(unittest.TestCase):
    """PolicyStatementMatchBgp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgp:
        """Test PolicyStatementMatchBgp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgp`
        """
        model = PolicyStatementMatchBgp()
        if include_optional:
            return PolicyStatementMatchBgp(
                id = '',
                type = 'PolicyStatementMatchBgp',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchBgp(self):
        """Test PolicyStatementMatchBgp"""
