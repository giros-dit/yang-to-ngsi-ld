...
class TestInterfaceId(unittest.TestCase):
    """InterfaceId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceId:
        """Test InterfaceId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceId`
        """
        model = InterfaceId()
        if include_optional:
            return InterfaceId(
