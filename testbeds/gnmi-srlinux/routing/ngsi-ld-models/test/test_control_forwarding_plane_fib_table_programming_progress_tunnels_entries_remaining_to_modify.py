...
class TestControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify:
        """Test ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify(
                type = 'Property',
                value = 56,
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressTunnelsEntriesRemainingToModify"""
