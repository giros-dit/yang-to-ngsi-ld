...
class TestNetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress:
        """Test NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfdLocalAddress"""
