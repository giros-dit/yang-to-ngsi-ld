...
class TestSystemSrv6LocatorFullSegment(unittest.TestCase):
    """SystemSrv6LocatorFullSegment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorFullSegment:
        """Test SystemSrv6LocatorFullSegment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorFullSegment`
        """
        model = SystemSrv6LocatorFullSegment()
        if include_optional:
            return SystemSrv6LocatorFullSegment(
                id = '',
                type = 'SystemSrv6LocatorFullSegment',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6LocatorFullSegment(self):
        """Test SystemSrv6LocatorFullSegment"""
