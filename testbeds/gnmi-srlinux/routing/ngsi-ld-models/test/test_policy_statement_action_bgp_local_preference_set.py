...
class TestPolicyStatementActionBgpLocalPreferenceSet(unittest.TestCase):
    """PolicyStatementActionBgpLocalPreferenceSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpLocalPreferenceSet:
        """Test PolicyStatementActionBgpLocalPreferenceSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpLocalPreferenceSet`
        """
        model = PolicyStatementActionBgpLocalPreferenceSet()
        if include_optional:
            return PolicyStatementActionBgpLocalPreferenceSet(
                type = 'Property',
                value = 56,
    ...
    def testPolicyStatementActionBgpLocalPreferenceSet(self):
        """Test PolicyStatementActionBgpLocalPreferenceSet"""
