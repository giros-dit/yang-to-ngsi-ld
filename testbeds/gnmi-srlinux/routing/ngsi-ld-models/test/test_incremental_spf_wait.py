...
class TestIncrementalSpfWait(unittest.TestCase):
    """IncrementalSpfWait unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IncrementalSpfWait:
        """Test IncrementalSpfWait
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IncrementalSpfWait`
        """
        model = IncrementalSpfWait()
        if include_optional:
            return IncrementalSpfWait(
                type = 'Property',
                value = 0,
    ...
    def testIncrementalSpfWait(self):
        """Test IncrementalSpfWait"""
