...
class TestNetworkInstanceProtocolsOspfInstancePreference(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstancePreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstancePreference:
        """Test NetworkInstanceProtocolsOspfInstancePreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstancePreference`
        """
        model = NetworkInstanceProtocolsOspfInstancePreference()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstancePreference(
                type = 'Property',
                value = 1,
    ...
    def testNetworkInstanceProtocolsOspfInstancePreference(self):
        """Test NetworkInstanceProtocolsOspfInstancePreference"""
