...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsRoutesWithPerPrefixStatistics"""
