...
class TestInterfaceTransceiverTemperatureLowWarningThreshold(unittest.TestCase):
    """InterfaceTransceiverTemperatureLowWarningThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureLowWarningThreshold:
        """Test InterfaceTransceiverTemperatureLowWarningThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureLowWarningThreshold`
        """
        model = InterfaceTransceiverTemperatureLowWarningThreshold()
        if include_optional:
            return InterfaceTransceiverTemperatureLowWarningThreshold(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceTransceiverTemperatureLowWarningThreshold(self):
        """Test InterfaceTransceiverTemperatureLowWarningThreshold"""
