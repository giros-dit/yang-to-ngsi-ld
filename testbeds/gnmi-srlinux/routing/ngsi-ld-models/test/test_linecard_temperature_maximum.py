...
class TestLinecardTemperatureMaximum(unittest.TestCase):
    """LinecardTemperatureMaximum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardTemperatureMaximum:
        """Test LinecardTemperatureMaximum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardTemperatureMaximum`
        """
        model = LinecardTemperatureMaximum()
        if include_optional:
            return LinecardTemperatureMaximum(
                type = 'Property',
                value = 56,
    ...
    def testLinecardTemperatureMaximum(self):
        """Test LinecardTemperatureMaximum"""
