...
class TestTeMetric(unittest.TestCase):
    """TeMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TeMetric:
        """Test TeMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TeMetric`
        """
        model = TeMetric()
        if include_optional:
            return TeMetric(
