...
class TestMaskLengthRange(unittest.TestCase):
    """MaskLengthRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaskLengthRange:
        """Test MaskLengthRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaskLengthRange`
        """
        model = MaskLengthRange()
        if include_optional:
