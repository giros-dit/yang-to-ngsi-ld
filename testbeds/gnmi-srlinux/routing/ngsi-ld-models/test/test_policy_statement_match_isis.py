...
class TestPolicyStatementMatchIsis(unittest.TestCase):
    """PolicyStatementMatchIsis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchIsis:
        """Test PolicyStatementMatchIsis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchIsis`
        """
        model = PolicyStatementMatchIsis()
        if include_optional:
            return PolicyStatementMatchIsis(
                id = '',
                type = 'PolicyStatementMatchIsis',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchIsis(self):
        """Test PolicyStatementMatchIsis"""
