...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                events = None,
                bad_nbr_states = None,
                lsa_install_failed = None,
                bad_seq_nums = None,
                bad_mtu = None,
                bad_packets = None,
                lsa_not_in_lsdbs = None,
                option_mismatches = None,
                duplicates = None,
                num_restarts = None,
                is_part_of = None
            )
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatistics"""
