...
class TestNetworkInstanceIpForwardingSecondaryDefaultLookupIpv6(unittest.TestCase):
    """NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6:
        """Test NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6`
        """
        model = NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6()
        if include_optional:
            return NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6(
                type = 'Property',
                value = 'inactive',
    ...
    def testNetworkInstanceIpForwardingSecondaryDefaultLookupIpv6(self):
        """Test NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6"""
