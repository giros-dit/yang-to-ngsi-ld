...
class TestInterfaceEthernetSymbolMonitorSignalFailureMultiplier(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorSignalFailureMultiplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorSignalFailureMultiplier:
        """Test InterfaceEthernetSymbolMonitorSignalFailureMultiplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorSignalFailureMultiplier`
        """
        model = InterfaceEthernetSymbolMonitorSignalFailureMultiplier()
        if include_optional:
            return InterfaceEthernetSymbolMonitorSignalFailureMultiplier(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceEthernetSymbolMonitorSignalFailureMultiplier(self):
        """Test InterfaceEthernetSymbolMonitorSignalFailureMultiplier"""
