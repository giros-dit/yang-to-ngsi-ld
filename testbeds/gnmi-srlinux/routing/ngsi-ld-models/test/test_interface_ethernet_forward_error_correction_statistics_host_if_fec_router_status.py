...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus(
                type = 'Property',
                value = 'locked',
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus"""
