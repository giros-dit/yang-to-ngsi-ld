...
class TestInterfaceSubinterfaceBridgeTableMacLearningAdminState(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableMacLearningAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableMacLearningAdminState:
        """Test InterfaceSubinterfaceBridgeTableMacLearningAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableMacLearningAdminState`
        """
        model = InterfaceSubinterfaceBridgeTableMacLearningAdminState()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableMacLearningAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testInterfaceSubinterfaceBridgeTableMacLearningAdminState(self):
        """Test InterfaceSubinterfaceBridgeTableMacLearningAdminState"""
