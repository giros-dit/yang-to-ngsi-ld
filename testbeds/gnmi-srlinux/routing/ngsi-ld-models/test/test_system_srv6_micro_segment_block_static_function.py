...
class TestSystemSrv6MicroSegmentBlockStaticFunction(unittest.TestCase):
    """SystemSrv6MicroSegmentBlockStaticFunction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6MicroSegmentBlockStaticFunction:
        """Test SystemSrv6MicroSegmentBlockStaticFunction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6MicroSegmentBlockStaticFunction`
        """
        model = SystemSrv6MicroSegmentBlockStaticFunction()
        if include_optional:
            return SystemSrv6MicroSegmentBlockStaticFunction(
                id = '',
                type = 'SystemSrv6MicroSegmentBlockStaticFunction',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6MicroSegmentBlockStaticFunction(self):
        """Test SystemSrv6MicroSegmentBlockStaticFunction"""
