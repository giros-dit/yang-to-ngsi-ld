...
class TestInterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets"""
