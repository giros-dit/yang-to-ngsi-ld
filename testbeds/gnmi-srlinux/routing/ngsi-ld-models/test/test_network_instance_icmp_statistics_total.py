...
class TestNetworkInstanceIcmpStatisticsTotal(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTotal:
        """Test NetworkInstanceIcmpStatisticsTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTotal`
        """
        model = NetworkInstanceIcmpStatisticsTotal()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTotal(
                id = '',
                type = 'NetworkInstanceIcmpStatisticsTotal',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceIcmpStatisticsTotal(self):
        """Test NetworkInstanceIcmpStatisticsTotal"""
