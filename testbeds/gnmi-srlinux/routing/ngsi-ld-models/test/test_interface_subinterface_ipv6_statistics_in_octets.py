...
class TestInterfaceSubinterfaceIpv6StatisticsInOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInOctets:
        """Test InterfaceSubinterfaceIpv6StatisticsInOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInOctets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInOctets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInOctets"""
