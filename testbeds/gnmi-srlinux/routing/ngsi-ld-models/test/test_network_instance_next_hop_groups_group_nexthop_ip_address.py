...
class TestNetworkInstanceNextHopGroupsGroupNexthopIpAddress(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopIpAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopIpAddress:
        """Test NetworkInstanceNextHopGroupsGroupNexthopIpAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopIpAddress`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopIpAddress()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopIpAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopIpAddress(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopIpAddress"""
