...
class TestAreaBorderRouter(unittest.TestCase):
    """AreaBorderRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaBorderRouter:
        """Test AreaBorderRouter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaBorderRouter`
        """
        model = AreaBorderRouter()
        if include_optional:
