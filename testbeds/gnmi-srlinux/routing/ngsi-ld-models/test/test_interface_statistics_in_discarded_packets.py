...
class TestInterfaceStatisticsInDiscardedPackets(unittest.TestCase):
    """InterfaceStatisticsInDiscardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsInDiscardedPackets:
        """Test InterfaceStatisticsInDiscardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsInDiscardedPackets`
        """
        model = InterfaceStatisticsInDiscardedPackets()
        if include_optional:
            return InterfaceStatisticsInDiscardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStatisticsInDiscardedPackets(self):
        """Test InterfaceStatisticsInDiscardedPackets"""
