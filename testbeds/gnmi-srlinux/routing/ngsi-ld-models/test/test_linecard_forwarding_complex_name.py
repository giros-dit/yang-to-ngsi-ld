...
class TestLinecardForwardingComplexName(unittest.TestCase):
    """LinecardForwardingComplexName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexName:
        """Test LinecardForwardingComplexName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexName`
        """
        model = LinecardForwardingComplexName()
        if include_optional:
            return LinecardForwardingComplexName(
                type = 'Property',
                value = '0',
    ...
    def testLinecardForwardingComplexName(self):
        """Test LinecardForwardingComplexName"""
