...
class TestNetworkInstanceProtocolsOspfInstanceExportPolicy(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceExportPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceExportPolicy:
        """Test NetworkInstanceProtocolsOspfInstanceExportPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceExportPolicy`
        """
        model = NetworkInstanceProtocolsOspfInstanceExportPolicy()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceExportPolicy(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceExportPolicy(self):
        """Test NetworkInstanceProtocolsOspfInstanceExportPolicy"""
