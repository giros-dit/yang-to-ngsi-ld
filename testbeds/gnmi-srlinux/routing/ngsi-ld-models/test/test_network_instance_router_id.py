...
class TestNetworkInstanceRouterId(unittest.TestCase):
    """NetworkInstanceRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouterId:
        """Test NetworkInstanceRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouterId`
        """
        model = NetworkInstanceRouterId()
        if include_optional:
            return NetworkInstanceRouterId(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testNetworkInstanceRouterId(self):
        """Test NetworkInstanceRouterId"""
