...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTrace(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTrace(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace"""
