...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdvertiseRouterCapability"""
