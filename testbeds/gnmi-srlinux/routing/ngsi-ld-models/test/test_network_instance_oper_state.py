...
class TestNetworkInstanceOperState(unittest.TestCase):
    """NetworkInstanceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceOperState:
        """Test NetworkInstanceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceOperState`
        """
        model = NetworkInstanceOperState()
        if include_optional:
            return NetworkInstanceOperState(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceOperState(self):
        """Test NetworkInstanceOperState"""
