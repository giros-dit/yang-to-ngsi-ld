...
class TestNetworkInstanceIcmpStatisticsTypeOutErrorPackets(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTypeOutErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTypeOutErrorPackets:
        """Test NetworkInstanceIcmpStatisticsTypeOutErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTypeOutErrorPackets`
        """
        model = NetworkInstanceIcmpStatisticsTypeOutErrorPackets()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTypeOutErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmpStatisticsTypeOutErrorPackets(self):
        """Test NetworkInstanceIcmpStatisticsTypeOutErrorPackets"""
