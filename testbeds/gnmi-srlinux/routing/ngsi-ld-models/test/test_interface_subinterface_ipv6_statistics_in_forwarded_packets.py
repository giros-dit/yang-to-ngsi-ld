...
class TestInterfaceSubinterfaceIpv6StatisticsInForwardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInForwardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInForwardedPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsInForwardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInForwardedPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInForwardedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInForwardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInForwardedPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInForwardedPackets"""
