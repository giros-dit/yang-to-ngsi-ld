...
class TestPolicyDefaultActionBgpSrv6Locator(unittest.TestCase):
    """PolicyDefaultActionBgpSrv6Locator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpSrv6Locator:
        """Test PolicyDefaultActionBgpSrv6Locator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpSrv6Locator`
        """
        model = PolicyDefaultActionBgpSrv6Locator()
        if include_optional:
            return PolicyDefaultActionBgpSrv6Locator(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyDefaultActionBgpSrv6Locator(self):
        """Test PolicyDefaultActionBgpSrv6Locator"""
