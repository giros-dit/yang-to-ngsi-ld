...
class TestNetworkInstanceConnectionPointPseudowireIndex(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireIndex:
        """Test NetworkInstanceConnectionPointPseudowireIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireIndex`
        """
        model = NetworkInstanceConnectionPointPseudowireIndex()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireIndex(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceConnectionPointPseudowireIndex(self):
        """Test NetworkInstanceConnectionPointPseudowireIndex"""
