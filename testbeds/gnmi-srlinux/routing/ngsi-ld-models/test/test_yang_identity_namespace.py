...
class TestYANGIdentityNamespace(unittest.TestCase):
    """YANGIdentityNamespace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YANGIdentityNamespace:
        """Test YANGIdentityNamespace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YANGIdentityNamespace`
        """
        model = YANGIdentityNamespace()
        if include_optional:
            return YANGIdentityNamespace(
                type = 'Property',
                value = '',
    ...
    def testYANGIdentityNamespace(self):
        """Test YANGIdentityNamespace"""
