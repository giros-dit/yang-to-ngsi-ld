...
class TestControlPartNumber(unittest.TestCase):
    """ControlPartNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlPartNumber:
        """Test ControlPartNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlPartNumber`
        """
        model = ControlPartNumber()
        if include_optional:
            return ControlPartNumber(
                type = 'Property',
                value = '',
    ...
    def testControlPartNumber(self):
        """Test ControlPartNumber"""
