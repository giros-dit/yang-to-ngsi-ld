...
class TestNetworkInstanceRouteTableNextHopIndirectResolved(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolved unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolved:
        """Test NetworkInstanceRouteTableNextHopIndirectResolved
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolved`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolved()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolved(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolved(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolved"""
