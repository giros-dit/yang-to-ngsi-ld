...
class TestTunnelOwner(unittest.TestCase):
    """TunnelOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TunnelOwner:
        """Test TunnelOwner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TunnelOwner`
        """
        model = TunnelOwner()
        if include_optional:
            return TunnelOwner(
