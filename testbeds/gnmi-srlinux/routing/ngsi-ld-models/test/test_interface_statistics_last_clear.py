...
class TestInterfaceStatisticsLastClear(unittest.TestCase):
    """InterfaceStatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsLastClear:
        """Test InterfaceStatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsLastClear`
        """
        model = InterfaceStatisticsLastClear()
        if include_optional:
            return InterfaceStatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testInterfaceStatisticsLastClear(self):
        """Test InterfaceStatisticsLastClear"""
