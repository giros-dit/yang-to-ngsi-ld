...
class TestNetworkInstanceDescription(unittest.TestCase):
    """NetworkInstanceDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceDescription:
        """Test NetworkInstanceDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceDescription`
        """
        model = NetworkInstanceDescription()
        if include_optional:
            return NetworkInstanceDescription(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceDescription(self):
        """Test NetworkInstanceDescription"""
