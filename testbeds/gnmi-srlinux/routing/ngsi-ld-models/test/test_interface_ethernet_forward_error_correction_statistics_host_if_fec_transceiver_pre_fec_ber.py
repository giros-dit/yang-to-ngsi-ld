...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer(
                id = '',
                type = 'InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer"""
