...
class TestProtectAnycastGwMac(unittest.TestCase):
    """ProtectAnycastGwMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProtectAnycastGwMac:
        """Test ProtectAnycastGwMac
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProtectAnycastGwMac`
        """
        model = ProtectAnycastGwMac()
        if include_optional:
            return ProtectAnycastGwMac(
                type = 'Property',
                value = True,
    ...
    def testProtectAnycastGwMac(self):
        """Test ProtectAnycastGwMac"""
