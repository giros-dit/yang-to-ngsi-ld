...
class TestInterfaceSubinterfaceName(unittest.TestCase):
    """InterfaceSubinterfaceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceName:
        """Test InterfaceSubinterfaceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceName`
        """
        model = InterfaceSubinterfaceName()
        if include_optional:
            return InterfaceSubinterfaceName(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceName(self):
        """Test InterfaceSubinterfaceName"""
