...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix"""
