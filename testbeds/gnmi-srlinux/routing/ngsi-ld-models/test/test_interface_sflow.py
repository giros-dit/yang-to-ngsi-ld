...
class TestInterfaceSflow(unittest.TestCase):
    """InterfaceSflow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSflow:
        """Test InterfaceSflow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSflow`
        """
        model = InterfaceSflow()
        if include_optional:
            return InterfaceSflow(
                id = '',
                type = 'InterfaceSflow',
                scope = None,
                location = {
                ...
                admin_state = None,
                ingress_sampling_rate = None,
                egress_sampling_rate = None,
                is_part_of = None
            )
        else:
            return InterfaceSflow(
