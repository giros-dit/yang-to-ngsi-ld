...
class TestMaxLsaCount(unittest.TestCase):
    """MaxLsaCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxLsaCount:
        """Test MaxLsaCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxLsaCount`
        """
        model = MaxLsaCount()
        if include_optional:
            return MaxLsaCount(
