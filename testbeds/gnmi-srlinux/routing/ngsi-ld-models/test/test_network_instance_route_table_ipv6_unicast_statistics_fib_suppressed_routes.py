...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsFibSuppressedRoutes"""
