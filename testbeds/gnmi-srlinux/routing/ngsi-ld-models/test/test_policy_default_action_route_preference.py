...
class TestPolicyDefaultActionRoutePreference(unittest.TestCase):
    """PolicyDefaultActionRoutePreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionRoutePreference:
        """Test PolicyDefaultActionRoutePreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionRoutePreference`
        """
        model = PolicyDefaultActionRoutePreference()
        if include_optional:
            return PolicyDefaultActionRoutePreference(
                id = '',
                type = 'PolicyDefaultActionRoutePreference',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionRoutePreference(self):
        """Test PolicyDefaultActionRoutePreference"""
