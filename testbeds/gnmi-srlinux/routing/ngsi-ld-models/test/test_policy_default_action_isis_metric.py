...
class TestPolicyDefaultActionIsisMetric(unittest.TestCase):
    """PolicyDefaultActionIsisMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionIsisMetric:
        """Test PolicyDefaultActionIsisMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionIsisMetric`
        """
        model = PolicyDefaultActionIsisMetric()
        if include_optional:
            return PolicyDefaultActionIsisMetric(
                id = '',
                type = 'PolicyDefaultActionIsisMetric',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionIsisMetric(self):
        """Test PolicyDefaultActionIsisMetric"""
