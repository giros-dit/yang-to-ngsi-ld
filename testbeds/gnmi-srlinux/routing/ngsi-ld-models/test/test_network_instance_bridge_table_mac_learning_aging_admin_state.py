...
class TestNetworkInstanceBridgeTableMacLearningAgingAdminState(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLearningAgingAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLearningAgingAdminState:
        """Test NetworkInstanceBridgeTableMacLearningAgingAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLearningAgingAdminState`
        """
        model = NetworkInstanceBridgeTableMacLearningAgingAdminState()
        if include_optional:
            return NetworkInstanceBridgeTableMacLearningAgingAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceBridgeTableMacLearningAgingAdminState(self):
        """Test NetworkInstanceBridgeTableMacLearningAgingAdminState"""
