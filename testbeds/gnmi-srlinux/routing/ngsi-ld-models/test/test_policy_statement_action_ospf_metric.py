...
class TestPolicyStatementActionOspfMetric(unittest.TestCase):
    """PolicyStatementActionOspfMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionOspfMetric:
        """Test PolicyStatementActionOspfMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionOspfMetric`
        """
        model = PolicyStatementActionOspfMetric()
        if include_optional:
            return PolicyStatementActionOspfMetric(
                id = '',
                type = 'PolicyStatementActionOspfMetric',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionOspfMetric(self):
        """Test PolicyStatementActionOspfMetric"""
