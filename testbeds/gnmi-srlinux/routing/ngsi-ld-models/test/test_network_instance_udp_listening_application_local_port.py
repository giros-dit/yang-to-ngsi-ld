...
class TestNetworkInstanceUdpListeningApplicationLocalPort(unittest.TestCase):
    """NetworkInstanceUdpListeningApplicationLocalPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpListeningApplicationLocalPort:
        """Test NetworkInstanceUdpListeningApplicationLocalPort
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpListeningApplicationLocalPort`
        """
        model = NetworkInstanceUdpListeningApplicationLocalPort()
        if include_optional:
            return NetworkInstanceUdpListeningApplicationLocalPort(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceUdpListeningApplicationLocalPort(self):
        """Test NetworkInstanceUdpListeningApplicationLocalPort"""
