...
class TestLinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction(unittest.TestCase):
    """LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction:
        """Test LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction`
        """
        model = LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction()
        if include_optional:
            return LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction(
                id = '',
                type = 'LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction(self):
        """Test LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction"""
