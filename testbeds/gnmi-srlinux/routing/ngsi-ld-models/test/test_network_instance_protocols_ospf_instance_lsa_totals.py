...
class TestNetworkInstanceProtocolsOspfInstanceLsaTotals(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLsaTotals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLsaTotals:
        """Test NetworkInstanceProtocolsOspfInstanceLsaTotals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLsaTotals`
        """
        model = NetworkInstanceProtocolsOspfInstanceLsaTotals()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLsaTotals(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceLsaTotals',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                as_external_lsa = None,
                e_as_external_lsa = None,
                as_opaque_lsa = None,
    ...
    def testNetworkInstanceProtocolsOspfInstanceLsaTotals(self):
        """Test NetworkInstanceProtocolsOspfInstanceLsaTotals"""
