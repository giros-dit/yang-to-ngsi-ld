...
class TestOut1519bOrLongerFrames(unittest.TestCase):
    """Out1519bOrLongerFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Out1519bOrLongerFrames:
        """Test Out1519bOrLongerFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Out1519bOrLongerFrames`
        """
        model = Out1519bOrLongerFrames()
        if include_optional:
            return Out1519bOrLongerFrames(
                type = 'Property',
                value = 56,
    ...
    def testOut1519bOrLongerFrames(self):
        """Test Out1519bOrLongerFrames"""
