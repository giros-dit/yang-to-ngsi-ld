...
class TestPeeringAddress(unittest.TestCase):
    """PeeringAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeeringAddress:
        """Test PeeringAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeeringAddress`
        """
        model = PeeringAddress()
        if include_optional:
