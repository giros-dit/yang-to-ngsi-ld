...
class TestNumberTosMetrics(unittest.TestCase):
    """NumberTosMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumberTosMetrics:
        """Test NumberTosMetrics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumberTosMetrics`
        """
        model = NumberTosMetrics()
        if include_optional:
            return NumberTosMetrics(
                type = 'Property',
                value = 56,
