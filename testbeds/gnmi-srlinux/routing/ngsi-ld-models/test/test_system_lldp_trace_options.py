...
class TestSystemLldpTraceOptions(unittest.TestCase):
    """SystemLldpTraceOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpTraceOptions:
        """Test SystemLldpTraceOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpTraceOptions`
        """
        model = SystemLldpTraceOptions()
        if include_optional:
            return SystemLldpTraceOptions(
                type = 'Property',
                value = 'received',
    ...
    def testSystemLldpTraceOptions(self):
        """Test SystemLldpTraceOptions"""
