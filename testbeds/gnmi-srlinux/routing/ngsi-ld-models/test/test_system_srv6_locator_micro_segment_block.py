...
class TestSystemSrv6LocatorMicroSegmentBlock(unittest.TestCase):
    """SystemSrv6LocatorMicroSegmentBlock unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorMicroSegmentBlock:
        """Test SystemSrv6LocatorMicroSegmentBlock
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorMicroSegmentBlock`
        """
        model = SystemSrv6LocatorMicroSegmentBlock()
        if include_optional:
            return SystemSrv6LocatorMicroSegmentBlock(
                type = 'Relationship',
                object = '',
    ...
    def testSystemSrv6LocatorMicroSegmentBlock(self):
        """Test SystemSrv6LocatorMicroSegmentBlock"""
