...
class TestPolicyStatementActionOspfMetricSetExternalType(unittest.TestCase):
    """PolicyStatementActionOspfMetricSetExternalType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionOspfMetricSetExternalType:
        """Test PolicyStatementActionOspfMetricSetExternalType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionOspfMetricSetExternalType`
        """
        model = PolicyStatementActionOspfMetricSetExternalType()
        if include_optional:
            return PolicyStatementActionOspfMetricSetExternalType(
                type = 'Property',
                value = 'type-1',
    ...
    def testPolicyStatementActionOspfMetricSetExternalType(self):
        """Test PolicyStatementActionOspfMetricSetExternalType"""
