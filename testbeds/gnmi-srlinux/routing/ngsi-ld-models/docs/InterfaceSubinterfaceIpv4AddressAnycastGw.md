# InterfaceSubinterfaceIpv4AddressAnycastGw
...
interface_subinterface_ipv4_address_anycast_gw_from_dict = InterfaceSubinterfaceIpv4AddressAnycastGw.from_dict(interface_subinterface_ipv4_address_anycast_gw_dict)
```
