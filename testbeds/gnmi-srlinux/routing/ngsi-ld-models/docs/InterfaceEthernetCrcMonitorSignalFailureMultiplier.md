# InterfaceEthernetCrcMonitorSignalFailureMultiplier
...
interface_ethernet_crc_monitor_signal_failure_multiplier_from_dict = InterfaceEthernetCrcMonitorSignalFailureMultiplier.from_dict(interface_ethernet_crc_monitor_signal_failure_multiplier_dict)
```
