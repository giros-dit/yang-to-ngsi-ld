# InterfaceSubinterfaceAnycastGw
...
interface_subinterface_anycast_gw_from_dict = InterfaceSubinterfaceAnycastGw.from_dict(interface_subinterface_anycast_gw_dict)
```
