# InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets

The number of octets in transit packets which the router attempted to forward out this subinterface  YANG module: srl_nokia-interfaces.yang 
...
interface_subinterface_ipv6_statistics_out_forwarded_octets_from_dict = InterfaceSubinterfaceIpv6StatisticsOutForwardedOctets.from_dict(interface_subinterface_ipv6_statistics_out_forwarded_octets_dict)
```
