# InterfaceTransceiverVoltageHighAlarmCondition
...
interface_transceiver_voltage_high_alarm_condition_from_dict = InterfaceTransceiverVoltageHighAlarmCondition.from_dict(interface_transceiver_voltage_high_alarm_condition_dict)
```
