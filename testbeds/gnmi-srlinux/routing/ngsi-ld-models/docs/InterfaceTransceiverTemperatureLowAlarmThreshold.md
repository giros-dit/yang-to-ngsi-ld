...
interface_transceiver_temperature_low_alarm_threshold_from_dict = InterfaceTransceiverTemperatureLowAlarmThreshold.from_dict(interface_transceiver_temperature_low_alarm_threshold_dict)
```
