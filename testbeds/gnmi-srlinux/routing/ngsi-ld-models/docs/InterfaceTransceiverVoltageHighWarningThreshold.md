# InterfaceTransceiverVoltageHighWarningThreshold
...
interface_transceiver_voltage_high_warning_threshold_from_dict = InterfaceTransceiverVoltageHighWarningThreshold.from_dict(interface_transceiver_voltage_high_warning_threshold_dict)
```
