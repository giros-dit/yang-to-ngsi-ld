# InterfaceTransceiverVoltageLowWarningCondition
...
interface_transceiver_voltage_low_warning_condition_from_dict = InterfaceTransceiverVoltageLowWarningCondition.from_dict(interface_transceiver_voltage_low_warning_condition_dict)
```
