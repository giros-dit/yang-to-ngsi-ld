# InterfaceSubinterfaceIpv6AddressIpPrefix
...
interface_subinterface_ipv6_address_ip_prefix_from_dict = InterfaceSubinterfaceIpv6AddressIpPrefix.from_dict(interface_subinterface_ipv6_address_ip_prefix_dict)
```
