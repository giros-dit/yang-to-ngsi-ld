# InterfaceEthernetCrcMonitorAdminState
...
interface_ethernet_crc_monitor_admin_state_from_dict = InterfaceEthernetCrcMonitorAdminState.from_dict(interface_ethernet_crc_monitor_admin_state_dict)
```
