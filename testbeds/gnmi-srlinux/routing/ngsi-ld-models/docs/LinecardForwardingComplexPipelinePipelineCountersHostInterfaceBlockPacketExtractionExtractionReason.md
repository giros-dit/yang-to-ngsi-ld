...
**reason** | [**LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReasonReason**](LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReasonReason.md) |  | [optional] 
...
linecard_forwarding_complex_pipeline_pipeline_counters_host_interface_block_packet_extraction_extraction_reason_from_dict = LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason.from_dict(linecard_forwarding_complex_pipeline_pipeline_counters_host_interface_block_packet_extraction_extraction_reason_dict)
```
