# InterfaceTransceiverVoltageHighWarningCondition
...
interface_transceiver_voltage_high_warning_condition_from_dict = InterfaceTransceiverVoltageHighWarningCondition.from_dict(interface_transceiver_voltage_high_warning_condition_dict)
```
