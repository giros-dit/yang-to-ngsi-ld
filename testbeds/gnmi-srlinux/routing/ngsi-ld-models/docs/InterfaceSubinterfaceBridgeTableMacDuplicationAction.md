# InterfaceSubinterfaceBridgeTableMacDuplicationAction
...
```python
from ngsi_ld_models.models.interface_subinterface_bridge_table_mac_duplication_action import InterfaceSubinterfaceBridgeTableMacDuplicationAction

# TODO update the JSON string below
json = "{}"
# create an instance of InterfaceSubinterfaceBridgeTableMacDuplicationAction from a JSON string
interface_subinterface_bridge_table_mac_duplication_action_instance = InterfaceSubinterfaceBridgeTableMacDuplicationAction.from_json(json)
# print the JSON string representation of the object
print(InterfaceSubinterfaceBridgeTableMacDuplicationAction.to_json())

# convert the object into a dict
interface_subinterface_bridge_table_mac_duplication_action_dict = interface_subinterface_bridge_table_mac_duplication_action_instance.to_dict()
# create an instance of InterfaceSubinterfaceBridgeTableMacDuplicationAction from a dict
interface_subinterface_bridge_table_mac_duplication_action_from_dict = InterfaceSubinterfaceBridgeTableMacDuplicationAction.from_dict(interface_subinterface_bridge_table_mac_duplication_action_dict)
```
