...
interface_subinterface_ipv4_statistics_in_matched_ra_packets_from_dict = InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets.from_dict(interface_subinterface_ipv4_statistics_in_matched_ra_packets_dict)
```
