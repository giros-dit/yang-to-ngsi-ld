# InterfaceTransceiverVoltageLowWarningThreshold
...
interface_transceiver_voltage_low_warning_threshold_from_dict = InterfaceTransceiverVoltageLowWarningThreshold.from_dict(interface_transceiver_voltage_low_warning_threshold_dict)
```
