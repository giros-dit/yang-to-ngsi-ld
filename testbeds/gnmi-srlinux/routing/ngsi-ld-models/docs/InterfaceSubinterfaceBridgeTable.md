...
**discard_unknown_src_mac** | [**InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac**](InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac.md) |  | [optional] 
...
interface_subinterface_bridge_table_from_dict = InterfaceSubinterfaceBridgeTable.from_dict(interface_subinterface_bridge_table_dict)
```
