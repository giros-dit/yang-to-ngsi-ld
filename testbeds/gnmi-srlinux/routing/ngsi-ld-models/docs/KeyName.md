...
MACsec CKN, a hexadecimal name is only valid  YANG module: srl_nokia-keychains.yang 
...
```python
from ngsi_ld_models.models.key_name import KeyName
...
key_name_from_dict = KeyName.from_dict(key_name_dict)
```
