# InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets

The number of octets in packets which originated on the CPM and which the router attempted to forward out this subinterface  YANG module: srl_nokia-interfaces.yang 
...
interface_subinterface_ipv4_statistics_out_originated_octets_from_dict = InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets.from_dict(interface_subinterface_ipv4_statistics_out_originated_octets_dict)
```
