...
An identifier for the area, expressed as a dotted quad or an unsigned 32-bit integer  YANG module: srl_nokia-ospf.yang 
...
```python
from ngsi_ld_models.models.identifier import Identifier
