# InterfaceTransceiverVoltageHighAlarmThreshold
...
interface_transceiver_voltage_high_alarm_threshold_from_dict = InterfaceTransceiverVoltageHighAlarmThreshold.from_dict(interface_transceiver_voltage_high_alarm_threshold_dict)
```
