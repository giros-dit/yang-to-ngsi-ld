...
interface_subinterface_ipv6_statistics_out_packets_from_dict = InterfaceSubinterfaceIpv6StatisticsOutPackets.from_dict(interface_subinterface_ipv6_statistics_out_packets_dict)
```
