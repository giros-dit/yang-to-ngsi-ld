# InterfaceTransceiverTemperatureHighWarningCondition
...
interface_transceiver_temperature_high_warning_condition_from_dict = InterfaceTransceiverTemperatureHighWarningCondition.from_dict(interface_transceiver_temperature_high_warning_condition_dict)
```
