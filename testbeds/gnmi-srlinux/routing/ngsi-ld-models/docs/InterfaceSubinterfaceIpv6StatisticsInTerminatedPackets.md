...
interface_subinterface_ipv6_statistics_in_terminated_packets_from_dict = InterfaceSubinterfaceIpv6StatisticsInTerminatedPackets.from_dict(interface_subinterface_ipv6_statistics_in_terminated_packets_dict)
```
