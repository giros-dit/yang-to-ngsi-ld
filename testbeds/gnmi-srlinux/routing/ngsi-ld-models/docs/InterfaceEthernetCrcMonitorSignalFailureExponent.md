# InterfaceEthernetCrcMonitorSignalFailureExponent
...
interface_ethernet_crc_monitor_signal_failure_exponent_from_dict = InterfaceEthernetCrcMonitorSignalFailureExponent.from_dict(interface_ethernet_crc_monitor_signal_failure_exponent_dict)
```
