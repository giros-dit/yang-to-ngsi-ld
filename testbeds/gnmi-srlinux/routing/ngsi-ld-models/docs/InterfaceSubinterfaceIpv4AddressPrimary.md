...
interface_subinterface_ipv4_address_primary_from_dict = InterfaceSubinterfaceIpv4AddressPrimary.from_dict(interface_subinterface_ipv4_address_primary_dict)
```
