# InterfaceEthernetSymbolMonitor
...
interface_ethernet_symbol_monitor_from_dict = InterfaceEthernetSymbolMonitor.from_dict(interface_ethernet_symbol_monitor_dict)
```
