...
class LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups.")
    ...
    entries_remaining_to_add: Optional[LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd] = Field(default=None, alias="entriesRemainingToAdd")
    entries_remaining_to_modify: Optional[LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify] = Field(default=None, alias="entriesRemainingToModify")
    last_sync_time: Optional[LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime] = Field(default=None, alias="lastSyncTime")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "entriesRemainingToAdd", "entriesRemainingToModify", "lastSyncTime", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of entries_remaining_to_add
        if self.entries_remaining_to_add:
            _dict['entriesRemainingToAdd'] = self.entries_remaining_to_add.to_dict()
        # override the default output from pydantic by calling `to_dict()` of entries_remaining_to_modify
        if self.entries_remaining_to_modify:
            _dict['entriesRemainingToModify'] = self.entries_remaining_to_modify.to_dict()
        # override the default output from pydantic by calling `to_dict()` of last_sync_time
        if self.last_sync_time:
            _dict['lastSyncTime'] = self.last_sync_time.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplexFibTableProgrammingProgressNextHopGroups',
            ...
            "entriesRemainingToAdd": LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd.from_dict(obj["entriesRemainingToAdd"]) if obj.get("entriesRemainingToAdd") is not None else None,
            "entriesRemainingToModify": LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify.from_dict(obj["entriesRemainingToModify"]) if obj.get("entriesRemainingToModify") is not None else None,
            "lastSyncTime": LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime.from_dict(obj["lastSyncTime"]) if obj.get("lastSyncTime") is not None else None,
