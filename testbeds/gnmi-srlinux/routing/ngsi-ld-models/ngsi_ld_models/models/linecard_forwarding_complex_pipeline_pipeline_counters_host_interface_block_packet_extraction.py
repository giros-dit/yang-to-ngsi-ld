...
class LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction.")
    ...
    extracted_packets: Optional[LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets] = Field(default=None, alias="extractedPackets")
    extracted_octets: Optional[LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets] = Field(default=None, alias="extractedOctets")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "extractedPackets", "extractedOctets", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction',
            ...
            "extractedPackets": LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedPackets.from_dict(obj["extractedPackets"]) if obj.get("extractedPackets") is not None else None,
            "extractedOctets": LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets.from_dict(obj["extractedOctets"]) if obj.get("extractedOctets") is not None else None,
