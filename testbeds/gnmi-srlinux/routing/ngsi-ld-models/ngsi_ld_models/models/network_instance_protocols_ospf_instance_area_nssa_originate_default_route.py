...
class NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute.")
    ...
    type_nssa: Optional[TypeNssa] = Field(default=None, alias="typeNssa")
    adjacency_check: Optional[AdjacencyCheck] = Field(default=None, alias="adjacencyCheck")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "typeNssa", "adjacencyCheck", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of type_nssa
        if self.type_nssa:
            _dict['typeNssa'] = self.type_nssa.to_dict()
        # override the default output from pydantic by calling `to_dict()` of adjacency_check
        if self.adjacency_check:
            _dict['adjacencyCheck'] = self.adjacency_check.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaNssaOriginateDefaultRoute',
            ...
            "typeNssa": TypeNssa.from_dict(obj["typeNssa"]) if obj.get("typeNssa") is not None else None,
            "adjacencyCheck": AdjacencyCheck.from_dict(obj["adjacencyCheck"]) if obj.get("adjacencyCheck") is not None else None,
