...
class SystemAuthenticationKeychainKeySendLifetime(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemAuthenticationKeychainKeySendLifetime.")
    ...
    start_time: Optional[SystemAuthenticationKeychainKeySendLifetimeStartTime] = Field(default=None, alias="startTime")
    send_and_receive: Optional[SendAndReceive] = Field(default=None, alias="sendAndReceive")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "startTime", "sendAndReceive", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemAuthenticationKeychainKeySendLifetime']):
            raise ValueError("must be one of enum values ('SystemAuthenticationKeychainKeySendLifetime')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of send_and_receive
        if self.send_and_receive:
            _dict['sendAndReceive'] = self.send_and_receive.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemAuthenticationKeychainKeySendLifetime',
            ...
            "startTime": SystemAuthenticationKeychainKeySendLifetimeStartTime.from_dict(obj["startTime"]) if obj.get("startTime") is not None else None,
            "sendAndReceive": SendAndReceive.from_dict(obj["sendAndReceive"]) if obj.get("sendAndReceive") is not None else None,
