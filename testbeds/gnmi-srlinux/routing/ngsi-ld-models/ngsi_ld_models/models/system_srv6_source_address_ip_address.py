...
from ngsi_ld_models.models.string import String
from typing import Optional, Set
from typing_extensions import Self

class SystemSrv6SourceAddressIpAddress(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": String.from_dict(obj["value"]) if obj.get("value") is not None else None,
