...
class NetworkInstanceRouteTableNextHopIndirectResolvingTunnel(BaseModel):
    """
     YANG module: srl_nokia-ip-route-tables.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopIndirectResolvingTunnel.")
    ...
    next_hop_group: Optional[NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup] = Field(default=None, alias="nextHopGroup")
    ip_prefix: Optional[NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix] = Field(default=None, alias="ipPrefix")
    tunnel_type: Optional[TunnelType] = Field(default=None, alias="tunnelType")
    tunnel_owner: Optional[TunnelOwner] = Field(default=None, alias="tunnelOwner")
    tunnel_id: Optional[NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId] = Field(default=None, alias="tunnelId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "nextHopGroup", "ipPrefix", "tunnelType", "tunnelOwner", "tunnelId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopIndirectResolvingTunnel']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopIndirectResolvingTunnel')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of tunnel_owner
        if self.tunnel_owner:
            _dict['tunnelOwner'] = self.tunnel_owner.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopIndirectResolvingTunnel',
            ...
            "nextHopGroup": NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup.from_dict(obj["nextHopGroup"]) if obj.get("nextHopGroup") is not None else None,
            "ipPrefix": NetworkInstanceRouteTableNextHopIndirectResolvingTunnelIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
            "tunnelType": TunnelType.from_dict(obj["tunnelType"]) if obj.get("tunnelType") is not None else None,
            "tunnelOwner": TunnelOwner.from_dict(obj["tunnelOwner"]) if obj.get("tunnelOwner") is not None else None,
            "tunnelId": NetworkInstanceRouteTableNextHopIndirectResolvingTunnelTunnelId.from_dict(obj["tunnelId"]) if obj.get("tunnelId") is not None else None,
