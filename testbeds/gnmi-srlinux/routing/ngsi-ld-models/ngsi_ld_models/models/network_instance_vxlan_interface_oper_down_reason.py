...
class NetworkInstanceVxlanInterfaceOperDownReason(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['vxlan-tunnel-down', 'net-inst-down', 'vxlan-if-default-net-inst-source-address-missing', 'vxlan-if-default-net-inst-source-if-down', 'vrf-type-mismatch', 'no-mcid']):
            raise ValueError("must be one of enum values ('vxlan-tunnel-down', 'net-inst-down', 'vxlan-if-default-net-inst-source-address-missing', 'vxlan-if-default-net-inst-source-if-down', 'vrf-type-mismatch', 'no-mcid')")
        return value
