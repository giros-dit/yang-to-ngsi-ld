...
class NetworkInstanceRouteTableNextHopGroupNextHop(BaseModel):
    """
    List of primary next-hops associated with the NHG  YANG module: srl_nokia-ip-route-tables.yang 
    """ # noqa: E501
    id: Optional[NetworkInstanceRouteTableNextHopGroupNextHopId] = None
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopGroupNextHop.")
    ...
    next_hop: Optional[NetworkInstanceRouteTableNextHopGroupNextHopNextHop] = Field(default=None, alias="nextHop")
    weight: Optional[Weight] = None
    resolved: Optional[NetworkInstanceRouteTableNextHopGroupNextHopResolved] = None
    resource_allocation_failed: Optional[NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed] = Field(default=None, alias="resourceAllocationFailed")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "nextHop", "weight", "resolved", "resourceAllocationFailed", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopGroupNextHop']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopGroupNextHop')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": NetworkInstanceRouteTableNextHopGroupNextHopId.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopGroupNextHop',
            ...
            "nextHop": NetworkInstanceRouteTableNextHopGroupNextHopNextHop.from_dict(obj["nextHop"]) if obj.get("nextHop") is not None else None,
            "weight": Weight.from_dict(obj["weight"]) if obj.get("weight") is not None else None,
            "resolved": NetworkInstanceRouteTableNextHopGroupNextHopResolved.from_dict(obj["resolved"]) if obj.get("resolved") is not None else None,
            "resourceAllocationFailed": NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed.from_dict(obj["resourceAllocationFailed"]) if obj.get("resourceAllocationFailed") is not None else None,
