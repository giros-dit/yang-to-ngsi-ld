...
class Tunnel(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be Tunnel.")
    ...
    name: TunnelName
    remote_system: RemoteSystem = Field(alias="remoteSystem")
    index: Optional[TunnelIndex] = None
    allowed_tunnel_types: Optional[TunnelAllowedTunnelTypes] = Field(default=None, alias="allowedTunnelTypes")
    last_change: Optional[TunnelLastChange] = Field(default=None, alias="lastChange")
    operational_tunnel_type: Optional[OperationalTunnelType] = Field(default=None, alias="operationalTunnelType")
    operational_tunnel_id: Optional[OperationalTunnelId] = Field(default=None, alias="operationalTunnelId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "remoteSystem", "index", "allowedTunnelTypes", "lastChange", "operationalTunnelType", "operationalTunnelId"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Tunnel']):
            raise ValueError("must be one of enum values ('Tunnel')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of remote_system
        if self.remote_system:
            _dict['remoteSystem'] = self.remote_system.to_dict()
        # override the default output from pydantic by calling `to_dict()` of index
        if self.index:
            _dict['index'] = self.index.to_dict()
        # override the default output from pydantic by calling `to_dict()` of allowed_tunnel_types
        if self.allowed_tunnel_types:
            _dict['allowedTunnelTypes'] = self.allowed_tunnel_types.to_dict()
        # override the default output from pydantic by calling `to_dict()` of last_change
        if self.last_change:
            _dict['lastChange'] = self.last_change.to_dict()
        # override the default output from pydantic by calling `to_dict()` of operational_tunnel_type
        if self.operational_tunnel_type:
            _dict['operationalTunnelType'] = self.operational_tunnel_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of operational_tunnel_id
        if self.operational_tunnel_id:
            _dict['operationalTunnelId'] = self.operational_tunnel_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Tunnel',
            ...
            "name": TunnelName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "remoteSystem": RemoteSystem.from_dict(obj["remoteSystem"]) if obj.get("remoteSystem") is not None else None,
            "index": TunnelIndex.from_dict(obj["index"]) if obj.get("index") is not None else None,
            "allowedTunnelTypes": TunnelAllowedTunnelTypes.from_dict(obj["allowedTunnelTypes"]) if obj.get("allowedTunnelTypes") is not None else None,
            "lastChange": TunnelLastChange.from_dict(obj["lastChange"]) if obj.get("lastChange") is not None else None,
            "operationalTunnelType": OperationalTunnelType.from_dict(obj["operationalTunnelType"]) if obj.get("operationalTunnelType") is not None else None,
            "operationalTunnelId": OperationalTunnelId.from_dict(obj["operationalTunnelId"]) if obj.get("operationalTunnelId") is not None else None
        })
