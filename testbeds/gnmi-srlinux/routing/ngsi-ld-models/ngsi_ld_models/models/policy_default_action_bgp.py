...
class PolicyDefaultActionBgp(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgp.")
    ...
    disable_ip_route_install: Optional[PolicyDefaultActionBgpDisableIpRouteInstall] = Field(default=None, alias="disableIpRouteInstall")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgp']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgp')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgp',
            ...
            "disableIpRouteInstall": PolicyDefaultActionBgpDisableIpRouteInstall.from_dict(obj["disableIpRouteInstall"]) if obj.get("disableIpRouteInstall") is not None else None,
