...
class User(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['level-1-fec', 'level-2-fec', 'level-3-fec', 'lag', 'network-header']):
            raise ValueError("must be one of enum values ('level-1-fec', 'level-2-fec', 'level-3-fec', 'lag', 'network-header')")
        return value
