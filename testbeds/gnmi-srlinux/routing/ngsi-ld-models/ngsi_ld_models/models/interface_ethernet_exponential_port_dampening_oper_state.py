...
class InterfaceEthernetExponentialPortDampeningOperState(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['active', 'idle']):
            raise ValueError("must be one of enum values ('active', 'idle')")
        return value
