...
class SystemLldpInterfaceBgpAutoDiscovery(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceBgpAutoDiscovery.")
    ...
    admin_state: Optional[SystemLldpInterfaceBgpAutoDiscoveryAdminState] = Field(default=None, alias="adminState")
    peering_address: Optional[PeeringAddress] = Field(default=None, alias="peeringAddress")
    group_id: Optional[SystemLldpInterfaceBgpAutoDiscoveryGroupId] = Field(default=None, alias="groupId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adminState", "peeringAddress", "groupId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceBgpAutoDiscovery']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceBgpAutoDiscovery')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of peering_address
        if self.peering_address:
            _dict['peeringAddress'] = self.peering_address.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceBgpAutoDiscovery',
            ...
            "adminState": SystemLldpInterfaceBgpAutoDiscoveryAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "peeringAddress": PeeringAddress.from_dict(obj["peeringAddress"]) if obj.get("peeringAddress") is not None else None,
            "groupId": SystemLldpInterfaceBgpAutoDiscoveryGroupId.from_dict(obj["groupId"]) if obj.get("groupId") is not None else None,
