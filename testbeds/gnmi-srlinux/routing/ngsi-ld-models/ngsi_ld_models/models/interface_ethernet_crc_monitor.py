...
class InterfaceEthernetCrcMonitor(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetCrcMonitor.")
    ...
    admin_state: Optional[InterfaceEthernetCrcMonitorAdminState] = Field(default=None, alias="adminState")
    window_size: Optional[InterfaceEthernetCrcMonitorWindowSize] = Field(default=None, alias="windowSize")
    current_alarms: Optional[InterfaceEthernetCrcMonitorCurrentAlarms] = Field(default=None, alias="currentAlarms")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetCrcMonitor']):
            raise ValueError("must be one of enum values ('InterfaceEthernetCrcMonitor')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetCrcMonitor',
            ...
            "adminState": InterfaceEthernetCrcMonitorAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "windowSize": InterfaceEthernetCrcMonitorWindowSize.from_dict(obj["windowSize"]) if obj.get("windowSize") is not None else None,
            "currentAlarms": InterfaceEthernetCrcMonitorCurrentAlarms.from_dict(obj["currentAlarms"]) if obj.get("currentAlarms") is not None else None,
