...
class NetworkInstanceConnectionPointRedundancy(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointRedundancy.")
    ...
    revert_time: Optional[RevertTime] = Field(default=None, alias="revertTime")
    standby_signaling: Optional[NetworkInstanceConnectionPointRedundancyStandbySignaling] = Field(default=None, alias="standbySignaling")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "revertTime", "standbySignaling", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointRedundancy']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointRedundancy')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of revert_time
        if self.revert_time:
            _dict['revertTime'] = self.revert_time.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointRedundancy',
            ...
            "revertTime": RevertTime.from_dict(obj["revertTime"]) if obj.get("revertTime") is not None else None,
            "standbySignaling": NetworkInstanceConnectionPointRedundancyStandbySignaling.from_dict(obj["standbySignaling"]) if obj.get("standbySignaling") is not None else None,
