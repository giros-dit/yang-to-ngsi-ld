...
class LastOverloadEnterCode(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['none', 'spf-failed', 'boot-overload', 'manual-overload', 'sfm-overload', 'fib-add-fail', 'rtm-add-fail', 'rtr-adv-lsa-limit']):
            raise ValueError("must be one of enum values ('none', 'spf-failed', 'boot-overload', 'manual-overload', 'sfm-overload', 'fib-add-fail', 'rtm-add-fail', 'rtr-adv-lsa-limit')")
        return value
