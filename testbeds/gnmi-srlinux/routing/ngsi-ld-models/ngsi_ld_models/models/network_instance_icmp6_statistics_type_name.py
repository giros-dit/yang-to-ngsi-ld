...
class NetworkInstanceIcmp6StatisticsTypeName(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['dest-unreachable', 'packet-too-big', 'time-exceeded', 'param-problem', 'echo-request', 'echo-reply', 'rtr-solicitation', 'rtr-advertisement', 'nbr-solicitation', 'nbr-advertisement', 'redirect']):
            raise ValueError("must be one of enum values ('dest-unreachable', 'packet-too-big', 'time-exceeded', 'param-problem', 'echo-request', 'echo-reply', 'rtr-solicitation', 'rtr-advertisement', 'nbr-solicitation', 'nbr-advertisement', 'redirect')")
        return value
