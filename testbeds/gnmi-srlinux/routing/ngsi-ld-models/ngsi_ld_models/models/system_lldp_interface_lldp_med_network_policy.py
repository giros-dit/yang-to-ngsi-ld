...
class SystemLldpInterfaceLldpMedNetworkPolicy(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type SystemLldpLldpMedNetworkPolicy.")
