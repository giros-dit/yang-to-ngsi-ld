...
class NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace(BaseModel):
    """
    Tracing parameter flags  YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace.")
    ...
    adjacencies: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies] = None
    graceful_restart: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart] = Field(default=None, alias="gracefulRestart")
    interfaces: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces] = None
    misc: Optional[Misc] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adjacencies", "gracefulRestart", "interfaces", "misc", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of adjacencies
        if self.adjacencies:
            _dict['adjacencies'] = self.adjacencies.to_dict()
        # override the default output from pydantic by calling `to_dict()` of graceful_restart
        if self.graceful_restart:
            _dict['gracefulRestart'] = self.graceful_restart.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTraceOptionsTrace',
            ...
            "adjacencies": NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies.from_dict(obj["adjacencies"]) if obj.get("adjacencies") is not None else None,
            "gracefulRestart": NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart.from_dict(obj["gracefulRestart"]) if obj.get("gracefulRestart") is not None else None,
            "interfaces": NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces.from_dict(obj["interfaces"]) if obj.get("interfaces") is not None else None,
            "misc": Misc.from_dict(obj["misc"]) if obj.get("misc") is not None else None,
