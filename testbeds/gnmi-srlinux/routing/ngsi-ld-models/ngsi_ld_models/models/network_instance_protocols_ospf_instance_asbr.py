...
class NetworkInstanceProtocolsOspfInstanceAsbr(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAsbr.")
    ...
    trace_path: Optional[TracePath] = Field(default=None, alias="tracePath")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "tracePath", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAsbr']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAsbr')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of trace_path
        if self.trace_path:
            _dict['tracePath'] = self.trace_path.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAsbr',
            ...
            "tracePath": TracePath.from_dict(obj["tracePath"]) if obj.get("tracePath") is not None else None,
