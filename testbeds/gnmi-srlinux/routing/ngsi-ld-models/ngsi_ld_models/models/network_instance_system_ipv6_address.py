...
class NetworkInstanceSystemIpv6Address(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceSystemIpv6Address.")
    ...
    oper_state: Optional[NetworkInstanceSystemIpv6AddressOperState] = Field(default=None, alias="operState")
    oper_down_reason: Optional[NetworkInstanceSystemIpv6AddressOperDownReason] = Field(default=None, alias="operDownReason")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceSystemIpv6Address']):
            raise ValueError("must be one of enum values ('NetworkInstanceSystemIpv6Address')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceSystemIpv6Address',
            ...
            "operState": NetworkInstanceSystemIpv6AddressOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
            "operDownReason": NetworkInstanceSystemIpv6AddressOperDownReason.from_dict(obj["operDownReason"]) if obj.get("operDownReason") is not None else None,
