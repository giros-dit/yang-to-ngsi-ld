...
class NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate.")
    ...
    max_lsa_wait: Optional[MaxLsaWait] = Field(default=None, alias="maxLsaWait")
    lsa_initial_wait: Optional[LsaInitialWait] = Field(default=None, alias="lsaInitialWait")
    lsa_second_wait: Optional[LsaSecondWait] = Field(default=None, alias="lsaSecondWait")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "maxLsaWait", "lsaInitialWait", "lsaSecondWait", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of max_lsa_wait
        if self.max_lsa_wait:
            _dict['maxLsaWait'] = self.max_lsa_wait.to_dict()
        # override the default output from pydantic by calling `to_dict()` of lsa_initial_wait
        if self.lsa_initial_wait:
            _dict['lsaInitialWait'] = self.lsa_initial_wait.to_dict()
        # override the default output from pydantic by calling `to_dict()` of lsa_second_wait
        if self.lsa_second_wait:
            _dict['lsaSecondWait'] = self.lsa_second_wait.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTimersLsaGenerate',
            ...
            "maxLsaWait": MaxLsaWait.from_dict(obj["maxLsaWait"]) if obj.get("maxLsaWait") is not None else None,
            "lsaInitialWait": LsaInitialWait.from_dict(obj["lsaInitialWait"]) if obj.get("lsaInitialWait") is not None else None,
            "lsaSecondWait": LsaSecondWait.from_dict(obj["lsaSecondWait"]) if obj.get("lsaSecondWait") is not None else None,
