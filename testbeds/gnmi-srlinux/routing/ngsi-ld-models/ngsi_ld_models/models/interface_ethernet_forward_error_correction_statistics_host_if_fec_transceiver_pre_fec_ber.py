...
class InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer.")
    ...
    instant: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant] = None
    avg: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg] = None
    min: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin] = None
    max: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "instant", "avg", "min", "max", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer']):
            raise ValueError("must be one of enum values ('InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBer',
            ...
            "instant": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant.from_dict(obj["instant"]) if obj.get("instant") is not None else None,
            "avg": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg.from_dict(obj["avg"]) if obj.get("avg") is not None else None,
            "min": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMin.from_dict(obj["min"]) if obj.get("min") is not None else None,
            "max": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerMax.from_dict(obj["max"]) if obj.get("max") is not None else None,
