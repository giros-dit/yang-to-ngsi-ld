...
class System(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be System.")
    ...
    trace_options: Optional[SystemTraceOptions] = Field(default=None, alias="traceOptions")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "traceOptions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'System',
            ...
            "traceOptions": SystemTraceOptions.from_dict(obj["traceOptions"]) if obj.get("traceOptions") is not None else None
        })
