...
class InterfaceSubinterfaceBridgeTable(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceBridgeTable.")
    ...
    discard_unknown_src_mac: Optional[InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac] = Field(default=None, alias="discardUnknownSrcMac")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "discardUnknownSrcMac", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceBridgeTable']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceBridgeTable')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceBridgeTable',
            ...
            "discardUnknownSrcMac": InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac.from_dict(obj["discardUnknownSrcMac"]) if obj.get("discardUnknownSrcMac") is not None else None,
