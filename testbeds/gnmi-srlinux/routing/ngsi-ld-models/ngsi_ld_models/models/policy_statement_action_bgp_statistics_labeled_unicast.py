...
class PolicyStatementActionBgpStatisticsLabeledUnicast(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpStatisticsLabeledUnicast.")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ingress", "egress", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpStatisticsLabeledUnicast']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpStatisticsLabeledUnicast')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpStatisticsLabeledUnicast',
            ...
            "ingress": Ingress.from_dict(obj["ingress"]) if obj.get("ingress") is not None else None,
