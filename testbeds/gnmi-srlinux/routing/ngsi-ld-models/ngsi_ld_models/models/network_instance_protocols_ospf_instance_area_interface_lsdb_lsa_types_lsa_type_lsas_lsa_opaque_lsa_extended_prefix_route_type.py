...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaExtendedPrefixRouteType(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['UNSPECIFIED', 'INTRA_AREA', 'INTER_AREA', 'AS_EXTERNAL', 'NSSA_EXTERNAL']):
            raise ValueError("must be one of enum values ('UNSPECIFIED', 'INTRA_AREA', 'INTER_AREA', 'AS_EXTERNAL', 'NSSA_EXTERNAL')")
        return value
