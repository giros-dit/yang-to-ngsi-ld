...
class Ipv6Prefix(BaseModel):
    ...
    def value_validate_regular_expression(cls, value):
        ...
        if not re.match(r"((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(\/(([0-9])|([0-9]{2})|(1[0-1][0-9])|(12[0-8])))", value):
            raise ValueError(r"must validate the regular expression /((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(\/(([0-9])|([0-9]{2})|(1[0-1][0-9])|(12[0-8])))/")
        return value
