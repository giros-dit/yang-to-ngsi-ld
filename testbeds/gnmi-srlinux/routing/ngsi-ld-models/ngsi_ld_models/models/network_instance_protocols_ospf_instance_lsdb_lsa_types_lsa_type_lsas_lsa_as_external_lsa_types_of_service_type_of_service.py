...
class NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfService(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfService.")
    ...
    forwarding_address: Optional[NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfServiceForwardingAddress] = Field(default=None, alias="forwardingAddress")
    external_route_tag: Optional[NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfServiceExternalRouteTag] = Field(default=None, alias="externalRouteTag")
    tos: Optional[NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfServiceTos] = None
    metric: Optional[NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfServiceMetric] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfService']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfService')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfService',
            ...
            "forwardingAddress": NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfServiceForwardingAddress.from_dict(obj["forwardingAddress"]) if obj.get("forwardingAddress") is not None else None,
            "externalRouteTag": NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfServiceExternalRouteTag.from_dict(obj["externalRouteTag"]) if obj.get("externalRouteTag") is not None else None,
            "tos": NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfServiceTos.from_dict(obj["tos"]) if obj.get("tos") is not None else None,
            "metric": NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaTypesOfServiceTypeOfServiceMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
