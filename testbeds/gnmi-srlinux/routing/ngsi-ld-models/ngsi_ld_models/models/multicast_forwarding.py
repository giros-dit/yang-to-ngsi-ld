...
class MulticastForwarding(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['none', 'BUM', 'unknown-unicast', 'broadcast-mcast']):
            raise ValueError("must be one of enum values ('none', 'BUM', 'unknown-unicast', 'broadcast-mcast')")
        return value
