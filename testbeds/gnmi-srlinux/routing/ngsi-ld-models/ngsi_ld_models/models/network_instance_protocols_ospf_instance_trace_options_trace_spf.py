...
class NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpf(BaseModel):
    """
     YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpf.")
    ...
    dest_address: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress] = Field(default=None, alias="destAddress")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpf']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpf')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpf',
            ...
            "destAddress": NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress.from_dict(obj["destAddress"]) if obj.get("destAddress") is not None else None,
