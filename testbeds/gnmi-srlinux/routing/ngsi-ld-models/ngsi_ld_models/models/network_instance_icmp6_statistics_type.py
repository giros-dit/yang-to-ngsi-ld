...
class NetworkInstanceIcmp6StatisticsType(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceIcmp6StatisticsType.")
    ...
    name: Optional[NetworkInstanceIcmp6StatisticsTypeName] = None
    in_packets: Optional[NetworkInstanceIcmp6StatisticsTypeInPackets] = Field(default=None, alias="inPackets")
    out_packets: Optional[NetworkInstanceIcmp6StatisticsTypeOutPackets] = Field(default=None, alias="outPackets")
    out_error_packets: Optional[NetworkInstanceIcmp6StatisticsTypeOutErrorPackets] = Field(default=None, alias="outErrorPackets")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "inPackets", "outPackets", "outErrorPackets", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceIcmp6StatisticsType']):
            raise ValueError("must be one of enum values ('NetworkInstanceIcmp6StatisticsType')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceIcmp6StatisticsType',
            ...
            "name": NetworkInstanceIcmp6StatisticsTypeName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "inPackets": NetworkInstanceIcmp6StatisticsTypeInPackets.from_dict(obj["inPackets"]) if obj.get("inPackets") is not None else None,
            "outPackets": NetworkInstanceIcmp6StatisticsTypeOutPackets.from_dict(obj["outPackets"]) if obj.get("outPackets") is not None else None,
            "outErrorPackets": NetworkInstanceIcmp6StatisticsTypeOutErrorPackets.from_dict(obj["outErrorPackets"]) if obj.get("outErrorPackets") is not None else None,
