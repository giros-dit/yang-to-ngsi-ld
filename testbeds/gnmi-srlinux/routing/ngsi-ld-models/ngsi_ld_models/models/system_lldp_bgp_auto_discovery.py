...
class SystemLldpBgpAutoDiscovery(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpBgpAutoDiscovery.")
    ...
    admin_state: Optional[SystemLldpBgpAutoDiscoveryAdminState] = Field(default=None, alias="adminState")
    network_instance: Optional[SystemLldpBgpAutoDiscoveryNetworkInstance] = Field(default=None, alias="networkInstance")
    group_id: Optional[SystemLldpBgpAutoDiscoveryGroupId] = Field(default=None, alias="groupId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adminState", "networkInstance", "groupId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpBgpAutoDiscovery']):
            raise ValueError("must be one of enum values ('SystemLldpBgpAutoDiscovery')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpBgpAutoDiscovery',
            ...
            "adminState": SystemLldpBgpAutoDiscoveryAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "networkInstance": SystemLldpBgpAutoDiscoveryNetworkInstance.from_dict(obj["networkInstance"]) if obj.get("networkInstance") is not None else None,
            "groupId": SystemLldpBgpAutoDiscoveryGroupId.from_dict(obj["groupId"]) if obj.get("groupId") is not None else None,
