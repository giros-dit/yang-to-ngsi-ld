...
class NetworkInstanceRouteTableNextHopGroupBackupNextHopGroup(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type NetworkInstanceRouteTableNextHopGroup.")
