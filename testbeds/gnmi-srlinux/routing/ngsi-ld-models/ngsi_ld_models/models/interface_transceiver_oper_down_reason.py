...
class InterfaceTransceiverOperDownReason(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['not-present', 'read-failure', 'checksum-failure', 'unknown-transceiver', 'tx-laser-disabled', 'unsupported-breakout', 'port-disabled', 'connector-transceiver-down', 'unsupported-operational-mode', 'no-tunable-config', 'ols-link-not-established', 'functional-type-mismatch']):
            raise ValueError("must be one of enum values ('not-present', 'read-failure', 'checksum-failure', 'unknown-transceiver', 'tx-laser-disabled', 'unsupported-breakout', 'port-disabled', 'connector-transceiver-down', 'unsupported-operational-mode', 'no-tunable-config', 'ols-link-not-established', 'functional-type-mismatch')")
        return value
