...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaPrefixesPrefixOptions(BaseModel):
    """
    Prefix options.  YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaPrefixesPrefixOptions.")
    ...
    prefix_options: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaPrefixesPrefixOptionsPrefixOptions] = Field(default=None, alias="prefixOptions")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaPrefixesPrefixOptions']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaPrefixesPrefixOptions')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaPrefixesPrefixOptions',
            ...
            "prefixOptions": NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaPrefixesPrefixOptionsPrefixOptions.from_dict(obj["prefixOptions"]) if obj.get("prefixOptions") is not None else None,
