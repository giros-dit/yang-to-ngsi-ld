...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaScope(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LINK', 'AREA', 'AS']):
            raise ValueError("must be one of enum values ('LINK', 'AREA', 'AS')")
        return value
