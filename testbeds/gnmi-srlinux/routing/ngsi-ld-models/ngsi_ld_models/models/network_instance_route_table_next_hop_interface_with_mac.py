...
class NetworkInstanceRouteTableNextHopInterfaceWithMac(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopInterfaceWithMac.")
    ...
    mac_address: Optional[NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress] = Field(default=None, alias="macAddress")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "macAddress", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopInterfaceWithMac']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopInterfaceWithMac')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopInterfaceWithMac',
            ...
            "macAddress": NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress.from_dict(obj["macAddress"]) if obj.get("macAddress") is not None else None,
