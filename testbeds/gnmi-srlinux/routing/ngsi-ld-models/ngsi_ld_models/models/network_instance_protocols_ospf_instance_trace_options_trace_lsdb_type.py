...
class NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['all', 'router', 'network', 'summary', 'nssa', 'external', 'opaque', 'inter-area-prefix', 'inter-area-router', 'intra-area-prefix']):
            raise ValueError("must be one of enum values ('all', 'router', 'network', 'summary', 'nssa', 'external', 'opaque', 'inter-area-prefix', 'inter-area-router', 'intra-area-prefix')")
        return value
