...
class NetworkInstanceProtocolsOspfInstanceAreaAreaRange(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaAreaRange.")
    ...
    ip_prefix_mask: Optional[NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask] = Field(default=None, alias="ipPrefixMask")
    advertise: Optional[NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaAreaRange']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaAreaRange')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaAreaRange',
            ...
            "ipPrefixMask": NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask.from_dict(obj["ipPrefixMask"]) if obj.get("ipPrefixMask") is not None else None,
            "advertise": NetworkInstanceProtocolsOspfInstanceAreaAreaRangeAdvertise.from_dict(obj["advertise"]) if obj.get("advertise") is not None else None,
