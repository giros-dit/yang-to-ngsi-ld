...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket.")
    ...
    packet_type: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType] = Field(default=None, alias="packetType")
    modifier: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier] = None
    detail: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "packetType", "modifier", "detail", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of packet_type
        if self.packet_type:
            _dict['packetType'] = self.packet_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket',
            ...
            "packetType": NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType.from_dict(obj["packetType"]) if obj.get("packetType") is not None else None,
            "modifier": NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketModifier.from_dict(obj["modifier"]) if obj.get("modifier") is not None else None,
            "detail": NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketDetail.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
