...
class InterfaceEthernetForwardErrorCorrection(BaseModel):
    """
     YANG module: srl_nokia-interfaces.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetForwardErrorCorrection.")
    ...
    fec_option: Optional[FecOption] = Field(default=None, alias="fecOption")
    operational_host_if_fec: Optional[OperationalHostIfFec] = Field(default=None, alias="operationalHostIfFec")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "fecOption", "operationalHostIfFec", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetForwardErrorCorrection']):
            raise ValueError("must be one of enum values ('InterfaceEthernetForwardErrorCorrection')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of fec_option
        if self.fec_option:
            _dict['fecOption'] = self.fec_option.to_dict()
        # override the default output from pydantic by calling `to_dict()` of operational_host_if_fec
        if self.operational_host_if_fec:
            _dict['operationalHostIfFec'] = self.operational_host_if_fec.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetForwardErrorCorrection',
            ...
            "fecOption": FecOption.from_dict(obj["fecOption"]) if obj.get("fecOption") is not None else None,
            "operationalHostIfFec": OperationalHostIfFec.from_dict(obj["operationalHostIfFec"]) if obj.get("operationalHostIfFec") is not None else None,
