...
class SystemSrv6MicroSegmentBlock(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6MicroSegmentBlock.")
    ...
    block_name: Optional[BlockName] = Field(default=None, alias="blockName")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "blockName", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6MicroSegmentBlock']):
            raise ValueError("must be one of enum values ('SystemSrv6MicroSegmentBlock')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.block_name:
            _dict['blockName'] = self.block_name.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6MicroSegmentBlock',
            ...
            "blockName": BlockName.from_dict(obj["blockName"]) if obj.get("blockName") is not None else None,
