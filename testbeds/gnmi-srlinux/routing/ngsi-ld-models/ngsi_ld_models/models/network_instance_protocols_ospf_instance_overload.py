...
class NetworkInstanceProtocolsOspfInstanceOverload(BaseModel):
    """
     YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceOverload.")
    ...
    active: Optional[NetworkInstanceProtocolsOspfInstanceOverloadActive] = None
    overload_include_ext1: Optional[OverloadIncludeExt1] = Field(default=None, alias="overloadIncludeExt1")
    overload_include_ext2: Optional[OverloadIncludeExt2] = Field(default=None, alias="overloadIncludeExt2")
    overload_include_stub: Optional[OverloadIncludeStub] = Field(default=None, alias="overloadIncludeStub")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "active", "overloadIncludeExt1", "overloadIncludeExt2", "overloadIncludeStub", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceOverload']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceOverload')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of overload_include_ext1
        if self.overload_include_ext1:
            _dict['overloadIncludeExt1'] = self.overload_include_ext1.to_dict()
        # override the default output from pydantic by calling `to_dict()` of overload_include_ext2
        if self.overload_include_ext2:
            _dict['overloadIncludeExt2'] = self.overload_include_ext2.to_dict()
        # override the default output from pydantic by calling `to_dict()` of overload_include_stub
        if self.overload_include_stub:
            _dict['overloadIncludeStub'] = self.overload_include_stub.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceOverload',
            ...
            "active": NetworkInstanceProtocolsOspfInstanceOverloadActive.from_dict(obj["active"]) if obj.get("active") is not None else None,
            "overloadIncludeExt1": OverloadIncludeExt1.from_dict(obj["overloadIncludeExt1"]) if obj.get("overloadIncludeExt1") is not None else None,
            "overloadIncludeExt2": OverloadIncludeExt2.from_dict(obj["overloadIncludeExt2"]) if obj.get("overloadIncludeExt2") is not None else None,
            "overloadIncludeStub": OverloadIncludeStub.from_dict(obj["overloadIncludeStub"]) if obj.get("overloadIncludeStub") is not None else None,
