...
class InterfaceEthernetFlowControl(BaseModel):
    """
     YANG module: srl_nokia-interfaces.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetFlowControl.")
    ...
    transmit: Optional[Transmit] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "receive", "transmit", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetFlowControl']):
            raise ValueError("must be one of enum values ('InterfaceEthernetFlowControl')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of transmit
        if self.transmit:
            _dict['transmit'] = self.transmit.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetFlowControl',
            ...
            "receive": Receive.from_dict(obj["receive"]) if obj.get("receive") is not None else None,
            "transmit": Transmit.from_dict(obj["transmit"]) if obj.get("transmit") is not None else None,
