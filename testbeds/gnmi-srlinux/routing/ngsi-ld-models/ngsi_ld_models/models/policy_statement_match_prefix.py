...
class PolicyStatementMatchPrefix(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchPrefix.")
    ...
    prefix_set: Optional[PolicyStatementMatchPrefixPrefixSet] = Field(default=None, alias="prefixSet")
    match_set_options: Optional[PolicyStatementMatchPrefixMatchSetOptions] = Field(default=None, alias="matchSetOptions")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "prefixSet", "matchSetOptions", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchPrefix']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchPrefix')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchPrefix',
            ...
            "prefixSet": PolicyStatementMatchPrefixPrefixSet.from_dict(obj["prefixSet"]) if obj.get("prefixSet") is not None else None,
            "matchSetOptions": PolicyStatementMatchPrefixMatchSetOptions.from_dict(obj["matchSetOptions"]) if obj.get("matchSetOptions") is not None else None,
