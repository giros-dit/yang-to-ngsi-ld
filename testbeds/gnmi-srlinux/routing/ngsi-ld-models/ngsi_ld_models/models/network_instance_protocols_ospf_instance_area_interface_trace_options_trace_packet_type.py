...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacketType(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['all', 'hello', 'dbdescr', 'ls-request', 'ls-update', 'ls-ack']):
            raise ValueError("must be one of enum values ('all', 'hello', 'dbdescr', 'ls-request', 'ls-update', 'ls-ack')")
        return value
