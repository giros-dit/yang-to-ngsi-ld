...
class NetworkInstanceRouteTableNextHopCounters(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopCounters.")
    ...
    resource_allocation_failed: Optional[NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed] = Field(default=None, alias="resourceAllocationFailed")
    packets_forwarded: Optional[NetworkInstanceRouteTableNextHopCountersPacketsForwarded] = Field(default=None, alias="packetsForwarded")
    octets_forwarded: Optional[NetworkInstanceRouteTableNextHopCountersOctetsForwarded] = Field(default=None, alias="octetsForwarded")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopCounters']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopCounters')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopCounters',
            ...
            "resourceAllocationFailed": NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed.from_dict(obj["resourceAllocationFailed"]) if obj.get("resourceAllocationFailed") is not None else None,
            "packetsForwarded": NetworkInstanceRouteTableNextHopCountersPacketsForwarded.from_dict(obj["packetsForwarded"]) if obj.get("packetsForwarded") is not None else None,
            "octetsForwarded": NetworkInstanceRouteTableNextHopCountersOctetsForwarded.from_dict(obj["octetsForwarded"]) if obj.get("octetsForwarded") is not None else None,
