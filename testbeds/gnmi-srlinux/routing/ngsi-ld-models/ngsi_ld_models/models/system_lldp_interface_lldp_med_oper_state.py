...
class SystemLldpInterfaceLldpMedOperState(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['up', 'down', 'empty', 'downloading', 'booting', 'starting', 'failed', 'synchronizing', 'upgrading', 'low-power', 'degraded', 'warm-reboot', 'waiting']):
            raise ValueError("must be one of enum values ('up', 'down', 'empty', 'downloading', 'booting', 'starting', 'failed', 'synchronizing', 'upgrading', 'low-power', 'degraded', 'warm-reboot', 'waiting')")
        return value
