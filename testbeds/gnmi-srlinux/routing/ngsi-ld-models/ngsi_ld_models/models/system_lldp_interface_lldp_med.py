...
class SystemLldpInterfaceLldpMed(BaseModel):
    """
     YANG module: srl_nokia-lldp.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceLldpMed.")
    ...
    admin_state: Optional[SystemLldpInterfaceLldpMedAdminState] = Field(default=None, alias="adminState")
    network_policy: Optional[SystemLldpInterfaceLldpMedNetworkPolicy] = Field(default=None, alias="networkPolicy")
    lldp_med_tlvs: Optional[LldpMedTlvs] = Field(default=None, alias="lldpMedTlvs")
    oper_state: Optional[SystemLldpInterfaceLldpMedOperState] = Field(default=None, alias="operState")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adminState", "networkPolicy", "lldpMedTlvs", "operState", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceLldpMed']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceLldpMed')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of lldp_med_tlvs
        if self.lldp_med_tlvs:
            _dict['lldpMedTlvs'] = self.lldp_med_tlvs.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceLldpMed',
            ...
            "adminState": SystemLldpInterfaceLldpMedAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "networkPolicy": SystemLldpInterfaceLldpMedNetworkPolicy.from_dict(obj["networkPolicy"]) if obj.get("networkPolicy") is not None else None,
            "lldpMedTlvs": LldpMedTlvs.from_dict(obj["lldpMedTlvs"]) if obj.get("lldpMedTlvs") is not None else None,
            "operState": SystemLldpInterfaceLldpMedOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
