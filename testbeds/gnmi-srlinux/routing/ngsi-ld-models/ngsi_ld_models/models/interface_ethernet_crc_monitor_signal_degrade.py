...
class InterfaceEthernetCrcMonitorSignalDegrade(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetCrcMonitorSignalDegrade.")
    ...
    exponent: Optional[InterfaceEthernetCrcMonitorSignalDegradeExponent] = None
    multiplier: Optional[InterfaceEthernetCrcMonitorSignalDegradeMultiplier] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetCrcMonitorSignalDegrade']):
            raise ValueError("must be one of enum values ('InterfaceEthernetCrcMonitorSignalDegrade')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetCrcMonitorSignalDegrade',
            ...
            "exponent": InterfaceEthernetCrcMonitorSignalDegradeExponent.from_dict(obj["exponent"]) if obj.get("exponent") is not None else None,
            "multiplier": InterfaceEthernetCrcMonitorSignalDegradeMultiplier.from_dict(obj["multiplier"]) if obj.get("multiplier") is not None else None,
