...
class SystemLldp(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldp.")
    ...
    trace_options: Optional[SystemLldpTraceOptions] = Field(default=None, alias="traceOptions")
    admin_state: Optional[SystemLldpAdminState] = Field(default=None, alias="adminState")
    hello_timer: Optional[HelloTimer] = Field(default=None, alias="helloTimer")
    hold_multiplier: Optional[HoldMultiplier] = Field(default=None, alias="holdMultiplier")
    system_name: Optional[SystemLldpSystemName] = Field(default=None, alias="systemName")
    system_description: Optional[SystemLldpSystemDescription] = Field(default=None, alias="systemDescription")
    chassis_id: Optional[SystemLldpChassisId] = Field(default=None, alias="chassisId")
    chassis_id_type: Optional[SystemLldpChassisIdType] = Field(default=None, alias="chassisIdType")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "traceOptions", "adminState", "helloTimer", "holdMultiplier", "systemName", "systemDescription", "chassisId", "chassisIdType", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldp']):
            raise ValueError("must be one of enum values ('SystemLldp')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.trace_options:
            _dict['traceOptions'] = self.trace_options.to_dict()
        # override the default output from pydantic by calling `to_dict()` of admin_state
        if self.admin_state:
            _dict['adminState'] = self.admin_state.to_dict()
        # override the default output from pydantic by calling `to_dict()` of hello_timer
        if self.hello_timer:
            _dict['helloTimer'] = self.hello_timer.to_dict()
        # override the default output from pydantic by calling `to_dict()` of hold_multiplier
        if self.hold_multiplier:
            _dict['holdMultiplier'] = self.hold_multiplier.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldp',
            ...
            "traceOptions": SystemLldpTraceOptions.from_dict(obj["traceOptions"]) if obj.get("traceOptions") is not None else None,
            "adminState": SystemLldpAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "helloTimer": HelloTimer.from_dict(obj["helloTimer"]) if obj.get("helloTimer") is not None else None,
            "holdMultiplier": HoldMultiplier.from_dict(obj["holdMultiplier"]) if obj.get("holdMultiplier") is not None else None,
            "systemName": SystemLldpSystemName.from_dict(obj["systemName"]) if obj.get("systemName") is not None else None,
            "systemDescription": SystemLldpSystemDescription.from_dict(obj["systemDescription"]) if obj.get("systemDescription") is not None else None,
            "chassisId": SystemLldpChassisId.from_dict(obj["chassisId"]) if obj.get("chassisId") is not None else None,
            "chassisIdType": SystemLldpChassisIdType.from_dict(obj["chassisIdType"]) if obj.get("chassisIdType") is not None else None,
