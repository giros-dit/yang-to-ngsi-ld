...
class SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType(BaseModel):
    """
    List name  YANG module: srl_nokia-lldp.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType.")
    ...
    name: Optional[SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName] = None
    policy_flag: Optional[PolicyFlag] = Field(default=None, alias="policyFlag")
    vlan_tagging: Optional[VlanTagging] = Field(default=None, alias="vlanTagging")
    vlan_id: Optional[SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId] = Field(default=None, alias="vlanId")
    dot1p: Optional[SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p] = None
    dscp: Optional[SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "policyFlag", "vlanTagging", "vlanId", "dot1p", "dscp", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of policy_flag
        if self.policy_flag:
            _dict['policyFlag'] = self.policy_flag.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of vlan_id
        if self.vlan_id:
            _dict['vlanId'] = self.vlan_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of dot1p
        if self.dot1p:
            _dict['dot1p'] = self.dot1p.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationType',
            ...
            "name": SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "policyFlag": PolicyFlag.from_dict(obj["policyFlag"]) if obj.get("policyFlag") is not None else None,
            "vlanTagging": VlanTagging.from_dict(obj["vlanTagging"]) if obj.get("vlanTagging") is not None else None,
            "vlanId": SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeVlanId.from_dict(obj["vlanId"]) if obj.get("vlanId") is not None else None,
            "dot1p": SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDot1p.from_dict(obj["dot1p"]) if obj.get("dot1p") is not None else None,
            "dscp": SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeDscp.from_dict(obj["dscp"]) if obj.get("dscp") is not None else None,
