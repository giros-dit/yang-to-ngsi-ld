...
class OperationalHostIfFec(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['disabled', 'cl74-baser', 'cl108-rs528', 'cl91-rs528', 'cl91-rs544', 'cl119-rs544', 'cl134-rs544', 'cl172-rs544']):
            raise ValueError("must be one of enum values ('disabled', 'cl74-baser', 'cl108-rs528', 'cl91-rs528', 'cl91-rs544', 'cl119-rs544', 'cl134-rs544', 'cl172-rs544')")
        return value
