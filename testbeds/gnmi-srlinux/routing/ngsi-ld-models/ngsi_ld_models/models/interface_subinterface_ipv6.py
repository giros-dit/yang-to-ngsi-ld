...
class InterfaceSubinterfaceIpv6(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceIpv6.")
    ...
    admin_state: Optional[InterfaceSubinterfaceIpv6AdminState] = Field(default=None, alias="adminState")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceIpv6']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceIpv6')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceIpv6',
            ...
            "adminState": InterfaceSubinterfaceIpv6AdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
