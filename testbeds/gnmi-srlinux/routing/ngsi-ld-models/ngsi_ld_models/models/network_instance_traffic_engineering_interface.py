...
class NetworkInstanceTrafficEngineeringInterface(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceTrafficEngineeringInterface.")
    ...
    interface_name: Optional[NetworkInstanceTrafficEngineeringInterfaceInterfaceName] = Field(default=None, alias="interfaceName")
    admin_group: Optional[AdminGroup] = Field(default=None, alias="adminGroup")
    srlg_membership: Optional[SrlgMembership] = Field(default=None, alias="srlgMembership")
    te_metric: Optional[TeMetric] = Field(default=None, alias="teMetric")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "interfaceName", "adminGroup", "srlgMembership", "teMetric", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceTrafficEngineeringInterface']):
            raise ValueError("must be one of enum values ('NetworkInstanceTrafficEngineeringInterface')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of admin_group
        if self.admin_group:
            _dict['adminGroup'] = self.admin_group.to_dict()
        # override the default output from pydantic by calling `to_dict()` of srlg_membership
        if self.srlg_membership:
            _dict['srlgMembership'] = self.srlg_membership.to_dict()
        # override the default output from pydantic by calling `to_dict()` of te_metric
        if self.te_metric:
            _dict['teMetric'] = self.te_metric.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceTrafficEngineeringInterface',
            ...
            "interfaceName": NetworkInstanceTrafficEngineeringInterfaceInterfaceName.from_dict(obj["interfaceName"]) if obj.get("interfaceName") is not None else None,
            "adminGroup": AdminGroup.from_dict(obj["adminGroup"]) if obj.get("adminGroup") is not None else None,
            "srlgMembership": SrlgMembership.from_dict(obj["srlgMembership"]) if obj.get("srlgMembership") is not None else None,
            "teMetric": TeMetric.from_dict(obj["teMetric"]) if obj.get("teMetric") is not None else None,
