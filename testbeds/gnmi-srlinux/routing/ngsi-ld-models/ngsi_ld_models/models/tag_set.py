...
class TagSet(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be TagSet.")
    ...
    name: TagSetName
    tag_value: Optional[TagSetTagValue] = Field(default=None, alias="tagValue")
    tag_set_index: Optional[TagSetIndex] = Field(default=None, alias="tagSetIndex")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "tagValue", "tagSetIndex"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TagSet']):
            raise ValueError("must be one of enum values ('TagSet')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of tag_set_index
        if self.tag_set_index:
            _dict['tagSetIndex'] = self.tag_set_index.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'TagSet',
            ...
            "name": TagSetName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "tagValue": TagSetTagValue.from_dict(obj["tagValue"]) if obj.get("tagValue") is not None else None,
            "tagSetIndex": TagSetIndex.from_dict(obj["tagSetIndex"]) if obj.get("tagSetIndex") is not None else None
        })
