...
class SystemLldpInterfaceNeighborCustomTlv(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceNeighborCustomTlv.")
    ...
    customtlv_type: Optional[SystemLldpInterfaceNeighborCustomTlvType] = Field(default=None, alias="customtlvType")
    oui: Optional[Oui] = None
    oui_subtype: Optional[OuiSubtype] = Field(default=None, alias="ouiSubtype")
    value: Optional[SystemLldpInterfaceNeighborCustomTlvValue] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "customtlvType", "oui", "ouiSubtype", "value", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceNeighborCustomTlv']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceNeighborCustomTlv')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of customtlv_type
        if self.customtlv_type:
            _dict['customtlvType'] = self.customtlv_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of oui
        if self.oui:
            _dict['oui'] = self.oui.to_dict()
        # override the default output from pydantic by calling `to_dict()` of oui_subtype
        if self.oui_subtype:
            _dict['ouiSubtype'] = self.oui_subtype.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceNeighborCustomTlv',
            ...
            "customtlvType": SystemLldpInterfaceNeighborCustomTlvType.from_dict(obj["customtlvType"]) if obj.get("customtlvType") is not None else None,
            "oui": Oui.from_dict(obj["oui"]) if obj.get("oui") is not None else None,
            "ouiSubtype": OuiSubtype.from_dict(obj["ouiSubtype"]) if obj.get("ouiSubtype") is not None else None,
            "value": SystemLldpInterfaceNeighborCustomTlvValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
