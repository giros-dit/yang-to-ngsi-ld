...
class SystemLldpInterfaceNeighborChassisIdType(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CHASSIS_COMPONENT', 'INTERFACE_ALIAS', 'PORT_COMPONENT', 'MAC_ADDRESS', 'NETWORK_ADDRESS', 'INTERFACE_NAME', 'LOCAL']):
            raise ValueError("must be one of enum values ('CHASSIS_COMPONENT', 'INTERFACE_ALIAS', 'PORT_COMPONENT', 'MAC_ADDRESS', 'NETWORK_ADDRESS', 'INTERFACE_NAME', 'LOCAL')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value") if obj.get("value") is not None else 'MAC_ADDRESS',
