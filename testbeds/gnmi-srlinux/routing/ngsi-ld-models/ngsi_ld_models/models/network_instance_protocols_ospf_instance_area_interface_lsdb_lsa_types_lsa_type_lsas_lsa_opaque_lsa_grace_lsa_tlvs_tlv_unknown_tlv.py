...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlv(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlv.")
    ...
    unknowntlv_type: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlvType] = Field(default=None, alias="unknowntlvType")
    length: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlvLength] = None
    value: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlvValue] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlv']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlv')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlv',
            ...
            "unknowntlvType": NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlvType.from_dict(obj["unknowntlvType"]) if obj.get("unknowntlvType") is not None else None,
            "length": NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlvLength.from_dict(obj["length"]) if obj.get("length") is not None else None,
            "value": NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvUnknownTlvValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
