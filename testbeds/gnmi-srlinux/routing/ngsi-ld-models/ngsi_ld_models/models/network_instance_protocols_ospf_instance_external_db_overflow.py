...
class NetworkInstanceProtocolsOspfInstanceExternalDbOverflow(BaseModel):
    """
     YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceExternalDbOverflow.")
    ...
    interval: Optional[NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval] = None
    limit: Optional[Limit] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "interval", "limit", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceExternalDbOverflow']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceExternalDbOverflow')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceExternalDbOverflow',
            ...
            "interval": NetworkInstanceProtocolsOspfInstanceExternalDbOverflowInterval.from_dict(obj["interval"]) if obj.get("interval") is not None else None,
