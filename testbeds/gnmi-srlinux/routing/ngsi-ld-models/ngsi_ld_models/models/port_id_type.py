...
class PortIdType(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['INTERFACE_ALIAS', 'PORT_COMPONENT', 'MAC_ADDRESS', 'NETWORK_ADDRESS', 'INTERFACE_NAME', 'AGENT_CIRCUIT_ID', 'LOCAL']):
            raise ValueError("must be one of enum values ('INTERFACE_ALIAS', 'PORT_COMPONENT', 'MAC_ADDRESS', 'NETWORK_ADDRESS', 'INTERFACE_NAME', 'AGENT_CIRCUIT_ID', 'LOCAL')")
        return value
