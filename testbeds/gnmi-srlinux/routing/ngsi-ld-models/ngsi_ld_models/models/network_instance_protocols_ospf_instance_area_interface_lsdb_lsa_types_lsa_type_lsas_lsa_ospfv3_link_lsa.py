...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsa(BaseModel):
    """
    Link LSA.  YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsa.")
    ...
    rtr_priority: Optional[RtrPriority] = Field(default=None, alias="rtrPriority")
    link_local_interface_address: Optional[LinkLocalInterfaceAddress] = Field(default=None, alias="linkLocalInterfaceAddress")
    num_of_prefixes: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaNumOfPrefixes] = Field(default=None, alias="numOfPrefixes")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "rtrPriority", "linkLocalInterfaceAddress", "numOfPrefixes", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsa']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsa')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of rtr_priority
        if self.rtr_priority:
            _dict['rtrPriority'] = self.rtr_priority.to_dict()
        # override the default output from pydantic by calling `to_dict()` of link_local_interface_address
        if self.link_local_interface_address:
            _dict['linkLocalInterfaceAddress'] = self.link_local_interface_address.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsa',
            ...
            "rtrPriority": RtrPriority.from_dict(obj["rtrPriority"]) if obj.get("rtrPriority") is not None else None,
            "linkLocalInterfaceAddress": LinkLocalInterfaceAddress.from_dict(obj["linkLocalInterfaceAddress"]) if obj.get("linkLocalInterfaceAddress") is not None else None,
            "numOfPrefixes": NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOspfv3LinkLsaNumOfPrefixes.from_dict(obj["numOfPrefixes"]) if obj.get("numOfPrefixes") is not None else None,
