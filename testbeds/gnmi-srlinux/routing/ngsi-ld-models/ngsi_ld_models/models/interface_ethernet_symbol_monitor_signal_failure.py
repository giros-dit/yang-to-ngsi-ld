...
class InterfaceEthernetSymbolMonitorSignalFailure(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetSymbolMonitorSignalFailure.")
    ...
    exponent: Optional[InterfaceEthernetSymbolMonitorSignalFailureExponent] = None
    multiplier: Optional[InterfaceEthernetSymbolMonitorSignalFailureMultiplier] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "exponent", "multiplier", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetSymbolMonitorSignalFailure']):
            raise ValueError("must be one of enum values ('InterfaceEthernetSymbolMonitorSignalFailure')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of exponent
        if self.exponent:
            _dict['exponent'] = self.exponent.to_dict()
        # override the default output from pydantic by calling `to_dict()` of multiplier
        if self.multiplier:
            _dict['multiplier'] = self.multiplier.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetSymbolMonitorSignalFailure',
            ...
            "exponent": InterfaceEthernetSymbolMonitorSignalFailureExponent.from_dict(obj["exponent"]) if obj.get("exponent") is not None else None,
            "multiplier": InterfaceEthernetSymbolMonitorSignalFailureMultiplier.from_dict(obj["multiplier"]) if obj.get("multiplier") is not None else None,
