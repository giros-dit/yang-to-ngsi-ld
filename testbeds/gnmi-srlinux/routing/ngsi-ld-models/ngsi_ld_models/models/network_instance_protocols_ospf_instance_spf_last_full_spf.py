...
class NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf.")
    ...
    run_time: Optional[NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime] = Field(default=None, alias="runTime")
    total_time: Optional[TotalTime] = Field(default=None, alias="totalTime")
    intra_spf_time: Optional[IntraSpfTime] = Field(default=None, alias="intraSpfTime")
    inter_spf_time: Optional[InterSpfTime] = Field(default=None, alias="interSpfTime")
    extern_spf_time: Optional[ExternSpfTime] = Field(default=None, alias="externSpfTime")
    rtm_update_time: Optional[RtmUpdateTime] = Field(default=None, alias="rtmUpdateTime")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "runTime", "totalTime", "intraSpfTime", "interSpfTime", "externSpfTime", "rtmUpdateTime", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of intra_spf_time
        if self.intra_spf_time:
            _dict['intraSpfTime'] = self.intra_spf_time.to_dict()
        # override the default output from pydantic by calling `to_dict()` of inter_spf_time
        if self.inter_spf_time:
            _dict['interSpfTime'] = self.inter_spf_time.to_dict()
        # override the default output from pydantic by calling `to_dict()` of extern_spf_time
        if self.extern_spf_time:
            _dict['externSpfTime'] = self.extern_spf_time.to_dict()
        # override the default output from pydantic by calling `to_dict()` of rtm_update_time
        if self.rtm_update_time:
            _dict['rtmUpdateTime'] = self.rtm_update_time.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf',
            ...
            "runTime": NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime.from_dict(obj["runTime"]) if obj.get("runTime") is not None else None,
            "totalTime": TotalTime.from_dict(obj["totalTime"]) if obj.get("totalTime") is not None else None,
            "intraSpfTime": IntraSpfTime.from_dict(obj["intraSpfTime"]) if obj.get("intraSpfTime") is not None else None,
            "interSpfTime": InterSpfTime.from_dict(obj["interSpfTime"]) if obj.get("interSpfTime") is not None else None,
            "externSpfTime": ExternSpfTime.from_dict(obj["externSpfTime"]) if obj.get("externSpfTime") is not None else None,
            "rtmUpdateTime": RtmUpdateTime.from_dict(obj["rtmUpdateTime"]) if obj.get("rtmUpdateTime") is not None else None,
