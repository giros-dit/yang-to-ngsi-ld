...
class PolicyStatementActionRoutePreference(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionRoutePreference.")
    ...
    set: Optional[PolicyStatementActionRoutePreferenceSet] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionRoutePreference']):
            raise ValueError("must be one of enum values ('PolicyStatementActionRoutePreference')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionRoutePreference',
            ...
            "set": PolicyStatementActionRoutePreferenceSet.from_dict(obj["set"]) if obj.get("set") is not None else None,
