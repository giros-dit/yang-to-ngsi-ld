...
class NetworkInstanceRouteTableNextHopTunnelIpInIp(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopTunnelIpInIp.")
    ...
    src_ip: Optional[SrcIp] = Field(default=None, alias="srcIp")
    dst_ip: Optional[DstIp] = Field(default=None, alias="dstIp")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "srcIp", "dstIp", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopTunnelIpInIp']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopTunnelIpInIp')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.src_ip:
            _dict['srcIp'] = self.src_ip.to_dict()
        # override the default output from pydantic by calling `to_dict()` of dst_ip
        if self.dst_ip:
            _dict['dstIp'] = self.dst_ip.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopTunnelIpInIp',
            ...
            "srcIp": SrcIp.from_dict(obj["srcIp"]) if obj.get("srcIp") is not None else None,
            "dstIp": DstIp.from_dict(obj["dstIp"]) if obj.get("dstIp") is not None else None,
