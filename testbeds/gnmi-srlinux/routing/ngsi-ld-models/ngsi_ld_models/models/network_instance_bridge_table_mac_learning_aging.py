...
class NetworkInstanceBridgeTableMacLearningAging(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceBridgeTableMacLearningAging.")
    ...
    admin_state: Optional[NetworkInstanceBridgeTableMacLearningAgingAdminState] = Field(default=None, alias="adminState")
    age_time: Optional[AgeTime] = Field(default=None, alias="ageTime")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adminState", "ageTime", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceBridgeTableMacLearningAging']):
            raise ValueError("must be one of enum values ('NetworkInstanceBridgeTableMacLearningAging')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of age_time
        if self.age_time:
            _dict['ageTime'] = self.age_time.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceBridgeTableMacLearningAging',
            ...
            "adminState": NetworkInstanceBridgeTableMacLearningAgingAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "ageTime": AgeTime.from_dict(obj["ageTime"]) if obj.get("ageTime") is not None else None,
