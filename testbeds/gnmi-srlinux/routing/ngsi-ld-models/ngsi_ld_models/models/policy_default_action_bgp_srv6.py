...
class PolicyDefaultActionBgpSrv6(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpSrv6.")
    ...
    locator: Optional[PolicyDefaultActionBgpSrv6Locator] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpSrv6']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpSrv6')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpSrv6',
            ...
            "locator": PolicyDefaultActionBgpSrv6Locator.from_dict(obj["locator"]) if obj.get("locator") is not None else None,
