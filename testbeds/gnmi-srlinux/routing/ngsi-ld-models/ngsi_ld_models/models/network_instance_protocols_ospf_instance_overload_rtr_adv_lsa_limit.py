...
class NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit(BaseModel):
    """
     YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit.")
    ...
    log_only: Optional[LogOnly] = Field(default=None, alias="logOnly")
    max_lsa_count: Optional[MaxLsaCount] = Field(default=None, alias="maxLsaCount")
    overload_timeout: Optional[OverloadTimeout] = Field(default=None, alias="overloadTimeout")
    warning_threshold: Optional[WarningThreshold] = Field(default=None, alias="warningThreshold")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "logOnly", "maxLsaCount", "overloadTimeout", "warningThreshold", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of log_only
        if self.log_only:
            _dict['logOnly'] = self.log_only.to_dict()
        # override the default output from pydantic by calling `to_dict()` of max_lsa_count
        if self.max_lsa_count:
            _dict['maxLsaCount'] = self.max_lsa_count.to_dict()
        # override the default output from pydantic by calling `to_dict()` of overload_timeout
        if self.overload_timeout:
            _dict['overloadTimeout'] = self.overload_timeout.to_dict()
        # override the default output from pydantic by calling `to_dict()` of warning_threshold
        if self.warning_threshold:
            _dict['warningThreshold'] = self.warning_threshold.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit',
            ...
            "logOnly": LogOnly.from_dict(obj["logOnly"]) if obj.get("logOnly") is not None else None,
            "maxLsaCount": MaxLsaCount.from_dict(obj["maxLsaCount"]) if obj.get("maxLsaCount") is not None else None,
            "overloadTimeout": OverloadTimeout.from_dict(obj["overloadTimeout"]) if obj.get("overloadTimeout") is not None else None,
            "warningThreshold": WarningThreshold.from_dict(obj["warningThreshold"]) if obj.get("warningThreshold") is not None else None,
