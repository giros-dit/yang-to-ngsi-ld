...
class PolicyStatementMatchBgp(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchBgp.")
    ...
    community_set: Optional[PolicyStatementMatchBgpCommunitySet] = Field(default=None, alias="communitySet")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "communitySet", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchBgp']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchBgp')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of community_set
        if self.community_set:
            _dict['communitySet'] = self.community_set.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchBgp',
            ...
            "communitySet": PolicyStatementMatchBgpCommunitySet.from_dict(obj["communitySet"]) if obj.get("communitySet") is not None else None,
