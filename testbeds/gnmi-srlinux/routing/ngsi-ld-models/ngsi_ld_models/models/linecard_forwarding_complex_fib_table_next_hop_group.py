...
class LinecardForwardingComplexFibTableNextHopGroup(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplexFibTableNextHopGroup.")
    ...
    index: Optional[LinecardForwardingComplexFibTableNextHopGroupIndex] = None
    oper_state: Optional[LinecardForwardingComplexFibTableNextHopGroupOperState] = Field(default=None, alias="operState")
    backup_next_hop_group: Optional[LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup] = Field(default=None, alias="backupNextHopGroup")
    backup_active: Optional[LinecardForwardingComplexFibTableNextHopGroupBackupActive] = Field(default=None, alias="backupActive")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "index", "operState", "backupNextHopGroup", "backupActive", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplexFibTableNextHopGroup']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplexFibTableNextHopGroup')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplexFibTableNextHopGroup',
            ...
            "index": LinecardForwardingComplexFibTableNextHopGroupIndex.from_dict(obj["index"]) if obj.get("index") is not None else None,
            "operState": LinecardForwardingComplexFibTableNextHopGroupOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
            "backupNextHopGroup": LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup.from_dict(obj["backupNextHopGroup"]) if obj.get("backupNextHopGroup") is not None else None,
            "backupActive": LinecardForwardingComplexFibTableNextHopGroupBackupActive.from_dict(obj["backupActive"]) if obj.get("backupActive") is not None else None,
