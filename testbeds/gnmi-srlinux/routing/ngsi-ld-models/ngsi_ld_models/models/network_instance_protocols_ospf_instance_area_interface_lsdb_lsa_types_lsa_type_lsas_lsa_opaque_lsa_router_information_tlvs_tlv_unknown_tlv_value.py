...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlvValue(BaseModel):
    """
    ...
    value: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]
