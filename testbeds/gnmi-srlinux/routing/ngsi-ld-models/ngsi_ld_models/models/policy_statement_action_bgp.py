...
class PolicyStatementActionBgp(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgp.")
    ...
    disable_ip_route_install: Optional[PolicyStatementActionBgpDisableIpRouteInstall] = Field(default=None, alias="disableIpRouteInstall")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "disableIpRouteInstall", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgp']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgp')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of disable_ip_route_install
        if self.disable_ip_route_install:
            _dict['disableIpRouteInstall'] = self.disable_ip_route_install.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgp',
            ...
            "disableIpRouteInstall": PolicyStatementActionBgpDisableIpRouteInstall.from_dict(obj["disableIpRouteInstall"]) if obj.get("disableIpRouteInstall") is not None else None,
