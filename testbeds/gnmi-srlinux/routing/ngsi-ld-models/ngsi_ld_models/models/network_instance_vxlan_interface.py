...
class NetworkInstanceVxlanInterface(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceVxlanInterface.")
    ...
    name: Optional[NetworkInstanceVxlanInterfaceName] = None
    oper_state: Optional[NetworkInstanceVxlanInterfaceOperState] = Field(default=None, alias="operState")
    oper_down_reason: Optional[NetworkInstanceVxlanInterfaceOperDownReason] = Field(default=None, alias="operDownReason")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "operState", "operDownReason", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceVxlanInterface']):
            raise ValueError("must be one of enum values ('NetworkInstanceVxlanInterface')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceVxlanInterface',
            ...
            "name": NetworkInstanceVxlanInterfaceName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "operState": NetworkInstanceVxlanInterfaceOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
            "operDownReason": NetworkInstanceVxlanInterfaceOperDownReason.from_dict(obj["operDownReason"]) if obj.get("operDownReason") is not None else None,
