...
class InterfaceSubinterfaceIpv6AddressType(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['global-unicast', 'link-local-unicast']):
            raise ValueError("must be one of enum values ('global-unicast', 'link-local-unicast')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value") if obj.get("value") is not None else 'global-unicast',
