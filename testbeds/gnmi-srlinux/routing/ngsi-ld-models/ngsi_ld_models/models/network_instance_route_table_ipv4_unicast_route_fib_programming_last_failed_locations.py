...
class NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations(BaseModel):
    """
    ...
    def value_validate_regular_expression(cls, value):
        ...
        if not re.match(r"control-A|control-B|complex-([0-9]|1[0-6])\.[01]", value):
            raise ValueError(r"must validate the regular expression /control-A|control-B|complex-([0-9]|1[0-6])\.[01]/")
        return value
