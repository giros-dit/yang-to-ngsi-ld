...
class ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups.")
    ...
    entries_remaining_to_add: Optional[ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd] = Field(default=None, alias="entriesRemainingToAdd")
    entries_remaining_to_modify: Optional[ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify] = Field(default=None, alias="entriesRemainingToModify")
    last_sync_time: Optional[ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime] = Field(default=None, alias="lastSyncTime")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups']):
            raise ValueError("must be one of enum values ('ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups',
            ...
            "entriesRemainingToAdd": ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToAdd.from_dict(obj["entriesRemainingToAdd"]) if obj.get("entriesRemainingToAdd") is not None else None,
            "entriesRemainingToModify": ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify.from_dict(obj["entriesRemainingToModify"]) if obj.get("entriesRemainingToModify") is not None else None,
            "lastSyncTime": ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime.from_dict(obj["lastSyncTime"]) if obj.get("lastSyncTime") is not None else None,
