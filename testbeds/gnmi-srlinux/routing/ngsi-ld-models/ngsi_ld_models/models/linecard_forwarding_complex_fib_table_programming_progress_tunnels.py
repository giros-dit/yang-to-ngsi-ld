...
class LinecardForwardingComplexFibTableProgrammingProgressTunnels(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplexFibTableProgrammingProgressTunnels.")
    ...
    entries_remaining_to_add: Optional[LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToAdd] = Field(default=None, alias="entriesRemainingToAdd")
    entries_remaining_to_modify: Optional[LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify] = Field(default=None, alias="entriesRemainingToModify")
    last_sync_time: Optional[LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime] = Field(default=None, alias="lastSyncTime")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplexFibTableProgrammingProgressTunnels']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplexFibTableProgrammingProgressTunnels')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplexFibTableProgrammingProgressTunnels',
            ...
            "entriesRemainingToAdd": LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToAdd.from_dict(obj["entriesRemainingToAdd"]) if obj.get("entriesRemainingToAdd") is not None else None,
            "entriesRemainingToModify": LinecardForwardingComplexFibTableProgrammingProgressTunnelsEntriesRemainingToModify.from_dict(obj["entriesRemainingToModify"]) if obj.get("entriesRemainingToModify") is not None else None,
            "lastSyncTime": LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime.from_dict(obj["lastSyncTime"]) if obj.get("lastSyncTime") is not None else None,
