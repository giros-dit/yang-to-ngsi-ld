...
class NetworkInstanceTrafficEngineeringBgpLsExport(BaseModel):
    """
     YANG module: srl_nokia-traffic-engineering.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceTrafficEngineeringBgpLsExport.")
    ...
    reachable_ls_only: Optional[ReachableLsOnly] = Field(default=None, alias="reachableLsOnly")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "reachableLsOnly", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceTrafficEngineeringBgpLsExport']):
            raise ValueError("must be one of enum values ('NetworkInstanceTrafficEngineeringBgpLsExport')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of reachable_ls_only
        if self.reachable_ls_only:
            _dict['reachableLsOnly'] = self.reachable_ls_only.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceTrafficEngineeringBgpLsExport',
            ...
            "reachableLsOnly": ReachableLsOnly.from_dict(obj["reachableLsOnly"]) if obj.get("reachableLsOnly") is not None else None,
