...
class PolicyDefaultActionBgpLocalPreference(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpLocalPreference.")
    ...
    set: Optional[PolicyDefaultActionBgpLocalPreferenceSet] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpLocalPreference']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpLocalPreference')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpLocalPreference',
            ...
            "set": PolicyDefaultActionBgpLocalPreferenceSet.from_dict(obj["set"]) if obj.get("set") is not None else None,
