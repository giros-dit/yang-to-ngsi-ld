...
class ControlForwardingPlaneFibTableProgrammingProgressMplsLabels(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be ControlForwardingPlaneFibTableProgrammingProgressMplsLabels.")
    ...
    entries_remaining_to_add: Optional[ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd] = Field(default=None, alias="entriesRemainingToAdd")
    entries_remaining_to_modify: Optional[ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify] = Field(default=None, alias="entriesRemainingToModify")
    last_sync_time: Optional[ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime] = Field(default=None, alias="lastSyncTime")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ControlForwardingPlaneFibTableProgrammingProgressMplsLabels']):
            raise ValueError("must be one of enum values ('ControlForwardingPlaneFibTableProgrammingProgressMplsLabels')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'ControlForwardingPlaneFibTableProgrammingProgressMplsLabels',
            ...
            "entriesRemainingToAdd": ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd.from_dict(obj["entriesRemainingToAdd"]) if obj.get("entriesRemainingToAdd") is not None else None,
            "entriesRemainingToModify": ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToModify.from_dict(obj["entriesRemainingToModify"]) if obj.get("entriesRemainingToModify") is not None else None,
            "lastSyncTime": ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime.from_dict(obj["lastSyncTime"]) if obj.get("lastSyncTime") is not None else None,
