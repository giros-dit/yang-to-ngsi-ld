...
class PolicyDefaultActionBgpExtendedCommunity(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpExtendedCommunity.")
    ...
    operation: Optional[PolicyDefaultActionBgpExtendedCommunityOperation] = None
    referenced_sets: Optional[PolicyDefaultActionBgpExtendedCommunityReferencedSets] = Field(default=None, alias="referencedSets")
    method: Optional[PolicyDefaultActionBgpExtendedCommunityMethod] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpExtendedCommunity']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpExtendedCommunity')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpExtendedCommunity',
            ...
            "operation": PolicyDefaultActionBgpExtendedCommunityOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
            "referencedSets": PolicyDefaultActionBgpExtendedCommunityReferencedSets.from_dict(obj["referencedSets"]) if obj.get("referencedSets") is not None else None,
            "method": PolicyDefaultActionBgpExtendedCommunityMethod.from_dict(obj["method"]) if obj.get("method") is not None else None,
