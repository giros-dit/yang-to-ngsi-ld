...
class NetworkInstanceRouteTableNextHopMplsTunnel(BaseModel):
    """
     YANG module: srl_nokia-ip-route-tables.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopMplsTunnel.")
    ...
    ip_prefix: Optional[NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix] = Field(default=None, alias="ipPrefix")
    tunnel_type: Optional[NetworkInstanceRouteTableNextHopMplsTunnelType] = Field(default=None, alias="tunnelType")
    owner: Optional[NetworkInstanceRouteTableNextHopMplsTunnelOwner] = None
    tunnel_id: Optional[NetworkInstanceRouteTableNextHopMplsTunnelTunnelId] = Field(default=None, alias="tunnelId")
    network_instance: Optional[NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance] = Field(default=None, alias="networkInstance")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipPrefix", "tunnelType", "owner", "tunnelId", "networkInstance", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopMplsTunnel']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopMplsTunnel')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopMplsTunnel',
            ...
            "ipPrefix": NetworkInstanceRouteTableNextHopMplsTunnelIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
            "tunnelType": NetworkInstanceRouteTableNextHopMplsTunnelType.from_dict(obj["tunnelType"]) if obj.get("tunnelType") is not None else None,
            "owner": NetworkInstanceRouteTableNextHopMplsTunnelOwner.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "tunnelId": NetworkInstanceRouteTableNextHopMplsTunnelTunnelId.from_dict(obj["tunnelId"]) if obj.get("tunnelId") is not None else None,
            "networkInstance": NetworkInstanceRouteTableNextHopMplsTunnelNetworkInstance.from_dict(obj["networkInstance"]) if obj.get("networkInstance") is not None else None,
