...
class LinecardTemperature(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardTemperature.")
    ...
    instant: Optional[LinecardTemperatureInstant] = None
    maximum: Optional[LinecardTemperatureMaximum] = None
    maximum_time: Optional[LinecardTemperatureMaximumTime] = Field(default=None, alias="maximumTime")
    alarm_status: Optional[LinecardTemperatureAlarmStatus] = Field(default=None, alias="alarmStatus")
    margin: Optional[LinecardTemperatureMargin] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardTemperature']):
            raise ValueError("must be one of enum values ('LinecardTemperature')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardTemperature',
            ...
            "instant": LinecardTemperatureInstant.from_dict(obj["instant"]) if obj.get("instant") is not None else None,
            "maximum": LinecardTemperatureMaximum.from_dict(obj["maximum"]) if obj.get("maximum") is not None else None,
            "maximumTime": LinecardTemperatureMaximumTime.from_dict(obj["maximumTime"]) if obj.get("maximumTime") is not None else None,
            "alarmStatus": LinecardTemperatureAlarmStatus.from_dict(obj["alarmStatus"]) if obj.get("alarmStatus") is not None else None,
            "margin": LinecardTemperatureMargin.from_dict(obj["margin"]) if obj.get("margin") is not None else None,
