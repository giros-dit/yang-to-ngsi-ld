...
class InterfaceSubinterfaceBridgeTableMacDuplicationAction(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['use-net-instance-action', 'stop-learning', 'blackhole', 'oper-down']):
            raise ValueError("must be one of enum values ('use-net-instance-action', 'stop-learning', 'blackhole', 'oper-down')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value") if obj.get("value") is not None else 'use-net-instance-action',
