...
class PolicyStatementActionBgpMed(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpMed.")
    ...
    value: Optional[PolicyStatementActionBgpMedValue] = None
    operation: Optional[PolicyStatementActionBgpMedOperation] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "value", "operation", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpMed']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpMed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpMed',
            ...
            "value": PolicyStatementActionBgpMedValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
            "operation": PolicyStatementActionBgpMedOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
