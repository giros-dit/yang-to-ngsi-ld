...
class NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroupNetworkInstance(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type NetworkInstance.")
