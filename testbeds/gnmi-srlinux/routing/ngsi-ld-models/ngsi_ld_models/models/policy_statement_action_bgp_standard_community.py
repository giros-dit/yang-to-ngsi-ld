...
class PolicyStatementActionBgpStandardCommunity(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpStandardCommunity.")
    ...
    operation: Optional[PolicyStatementActionBgpStandardCommunityOperation] = None
    referenced_sets: Optional[PolicyStatementActionBgpStandardCommunityReferencedSets] = Field(default=None, alias="referencedSets")
    method: Optional[PolicyStatementActionBgpStandardCommunityMethod] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "operation", "referencedSets", "method", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpStandardCommunity']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpStandardCommunity')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of referenced_sets
        if self.referenced_sets:
            _dict['referencedSets'] = self.referenced_sets.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpStandardCommunity',
            ...
            "operation": PolicyStatementActionBgpStandardCommunityOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
            "referencedSets": PolicyStatementActionBgpStandardCommunityReferencedSets.from_dict(obj["referencedSets"]) if obj.get("referencedSets") is not None else None,
            "method": PolicyStatementActionBgpStandardCommunityMethod.from_dict(obj["method"]) if obj.get("method") is not None else None,
