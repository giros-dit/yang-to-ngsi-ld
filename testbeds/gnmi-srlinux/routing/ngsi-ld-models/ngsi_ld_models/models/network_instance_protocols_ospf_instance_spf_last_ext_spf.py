...
class NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf.")
    ...
    run_time: Optional[NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime] = Field(default=None, alias="runTime")
    interval: Optional[NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "runTime", "interval", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceSpfLastExtSpf',
            ...
            "runTime": NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfRunTime.from_dict(obj["runTime"]) if obj.get("runTime") is not None else None,
            "interval": NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval.from_dict(obj["interval"]) if obj.get("interval") is not None else None,
