...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName(BaseModel):
    """
    ...
    def value_validate_regular_expression(cls, value):
        ...
        if not re.match(r"(mgmt0\.0|system0\.0|sync0\.0|lo(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])\.(0|[1-9](\d){0,3})|lif-.*\.(0|[1-9](\d){0,3})|vhn-.*\.(0|[1-9](\d){0,3})|enp(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])s(0|[1-9]|[1-2][0-9]|3[0-1])f[0-7]\.(0|[1-9](\d){0,3})|ethernet-([1-9](\d){0,1}(\/m[1-6])?(\/[1-9](\d){0,1})?\/(([1-9](\d){0,1})|(1[0-1]\d)|(12[0-8])))\.([0]|[1-9](\d){0,3})|irb(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])\.(0|[1-9](\d){0,3})|lag(([1-9](\d){0,2})|(1000))\.(0|[1-9](\d){0,3}))", value):
            raise ValueError(r"must validate the regular expression /(mgmt0\.0|system0\.0|sync0\.0|lo(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])\.(0|[1-9](\d){0,3})|lif-.*\.(0|[1-9](\d){0,3})|vhn-.*\.(0|[1-9](\d){0,3})|enp(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])s(0|[1-9]|[1-2][0-9]|3[0-1])f[0-7]\.(0|[1-9](\d){0,3})|ethernet-([1-9](\d){0,1}(\/m[1-6])?(\/[1-9](\d){0,1})?\/(([1-9](\d){0,1})|(1[0-1]\d)|(12[0-8])))\.([0]|[1-9](\d){0,3})|irb(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])\.(0|[1-9](\d){0,3})|lag(([1-9](\d){0,2})|(1000))\.(0|[1-9](\d){0,3}))/")
        return value
