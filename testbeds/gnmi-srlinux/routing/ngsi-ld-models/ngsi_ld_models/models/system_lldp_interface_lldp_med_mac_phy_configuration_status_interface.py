...
class SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface(BaseModel):
    """
     YANG module: srl_nokia-lldp.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface.")
    ...
    auto_negotiation_support: Optional[SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport] = Field(default=None, alias="autoNegotiationSupport")
    auto_negotiation_enabled: Optional[SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled] = Field(default=None, alias="autoNegotiationEnabled")
    auto_negotiation_capabilities: Optional[SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities] = Field(default=None, alias="autoNegotiationCapabilities")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "autoNegotiationSupport", "autoNegotiationEnabled", "autoNegotiationCapabilities", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface',
            ...
            "autoNegotiationSupport": SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport.from_dict(obj["autoNegotiationSupport"]) if obj.get("autoNegotiationSupport") is not None else None,
            "autoNegotiationEnabled": SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationEnabled.from_dict(obj["autoNegotiationEnabled"]) if obj.get("autoNegotiationEnabled") is not None else None,
            "autoNegotiationCapabilities": SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities.from_dict(obj["autoNegotiationCapabilities"]) if obj.get("autoNegotiationCapabilities") is not None else None,
