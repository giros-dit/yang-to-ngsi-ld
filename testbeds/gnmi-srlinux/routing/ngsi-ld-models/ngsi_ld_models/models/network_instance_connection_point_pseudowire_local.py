...
class NetworkInstanceConnectionPointPseudowireLocal(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointPseudowireLocal.")
    ...
    pseudowire_status: Optional[NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus] = Field(default=None, alias="pseudowireStatus")
    operational_ingress_vc_label: Optional[OperationalIngressVcLabel] = Field(default=None, alias="operationalIngressVcLabel")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "pseudowireStatus", "operationalIngressVcLabel", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointPseudowireLocal']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointPseudowireLocal')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of operational_ingress_vc_label
        if self.operational_ingress_vc_label:
            _dict['operationalIngressVcLabel'] = self.operational_ingress_vc_label.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointPseudowireLocal',
            ...
            "pseudowireStatus": NetworkInstanceConnectionPointPseudowireLocalPseudowireStatus.from_dict(obj["pseudowireStatus"]) if obj.get("pseudowireStatus") is not None else None,
            "operationalIngressVcLabel": OperationalIngressVcLabel.from_dict(obj["operationalIngressVcLabel"]) if obj.get("operationalIngressVcLabel") is not None else None,
