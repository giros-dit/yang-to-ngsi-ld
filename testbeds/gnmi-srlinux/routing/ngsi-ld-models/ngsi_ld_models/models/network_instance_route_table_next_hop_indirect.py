...
class NetworkInstanceRouteTableNextHopIndirect(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopIndirect.")
    ...
    resolved: Optional[NetworkInstanceRouteTableNextHopIndirectResolved] = None
    usable: Optional[NetworkInstanceRouteTableNextHopIndirectUsable] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "resolved", "usable", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopIndirect']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopIndirect')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopIndirect',
            ...
            "resolved": NetworkInstanceRouteTableNextHopIndirectResolved.from_dict(obj["resolved"]) if obj.get("resolved") is not None else None,
            "usable": NetworkInstanceRouteTableNextHopIndirectUsable.from_dict(obj["usable"]) if obj.get("usable") is not None else None,
