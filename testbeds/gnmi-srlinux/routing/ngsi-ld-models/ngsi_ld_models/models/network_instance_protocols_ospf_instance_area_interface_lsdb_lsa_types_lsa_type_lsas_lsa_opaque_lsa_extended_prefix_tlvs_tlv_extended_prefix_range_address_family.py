...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaExtendedPrefixTlvsTlvExtendedPrefixRangeAddressFamily(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['IPV4_UNICAST']):
            raise ValueError("must be one of enum values ('IPV4_UNICAST')")
        return value
