...
class NetworkInstanceIpForwarding(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceIpForwarding.")
    ...
    receive_ipv4_check: Optional[ReceiveIpv4Check] = Field(default=None, alias="receiveIpv4Check")
    receive_ipv6_check: Optional[ReceiveIpv6Check] = Field(default=None, alias="receiveIpv6Check")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "receiveIpv4Check", "receiveIpv6Check", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceIpForwarding']):
            raise ValueError("must be one of enum values ('NetworkInstanceIpForwarding')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of receive_ipv4_check
        if self.receive_ipv4_check:
            _dict['receiveIpv4Check'] = self.receive_ipv4_check.to_dict()
        # override the default output from pydantic by calling `to_dict()` of receive_ipv6_check
        if self.receive_ipv6_check:
            _dict['receiveIpv6Check'] = self.receive_ipv6_check.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceIpForwarding',
            ...
            "receiveIpv4Check": ReceiveIpv4Check.from_dict(obj["receiveIpv4Check"]) if obj.get("receiveIpv4Check") is not None else None,
            "receiveIpv6Check": ReceiveIpv6Check.from_dict(obj["receiveIpv6Check"]) if obj.get("receiveIpv6Check") is not None else None,
