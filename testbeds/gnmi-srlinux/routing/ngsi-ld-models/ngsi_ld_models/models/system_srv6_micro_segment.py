...
class SystemSrv6MicroSegment(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6MicroSegment.")
    ...
    block_length: Optional[SystemSrv6MicroSegmentBlockLength] = Field(default=None, alias="blockLength")
    gib_size: Optional[GibSize] = Field(default=None, alias="gibSize")
    sid_length: Optional[SidLength] = Field(default=None, alias="sidLength")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "blockLength", "gibSize", "sidLength", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6MicroSegment']):
            raise ValueError("must be one of enum values ('SystemSrv6MicroSegment')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of gib_size
        if self.gib_size:
            _dict['gibSize'] = self.gib_size.to_dict()
        # override the default output from pydantic by calling `to_dict()` of sid_length
        if self.sid_length:
            _dict['sidLength'] = self.sid_length.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6MicroSegment',
            ...
            "blockLength": SystemSrv6MicroSegmentBlockLength.from_dict(obj["blockLength"]) if obj.get("blockLength") is not None else None,
            "gibSize": GibSize.from_dict(obj["gibSize"]) if obj.get("gibSize") is not None else None,
            "sidLength": SidLength.from_dict(obj["sidLength"]) if obj.get("sidLength") is not None else None,
