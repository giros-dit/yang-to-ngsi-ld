...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['down', 'loopback', 'waiting', 'point-to-point', 'designated-router', 'backup-designated-router', 'other-designated-router']):
            raise ValueError("must be one of enum values ('down', 'loopback', 'waiting', 'point-to-point', 'designated-router', 'backup-designated-router', 'other-designated-router')")
        return value
