...
class SystemSrv6(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6.")
    ...
    default_source_address: DefaultSourceAddress = Field(alias="defaultSourceAddress")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "defaultSourceAddress", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6']):
            raise ValueError("must be one of enum values ('SystemSrv6')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of default_source_address
        if self.default_source_address:
            _dict['defaultSourceAddress'] = self.default_source_address.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6',
            ...
            "defaultSourceAddress": DefaultSourceAddress.from_dict(obj["defaultSourceAddress"]) if obj.get("defaultSourceAddress") is not None else None,
