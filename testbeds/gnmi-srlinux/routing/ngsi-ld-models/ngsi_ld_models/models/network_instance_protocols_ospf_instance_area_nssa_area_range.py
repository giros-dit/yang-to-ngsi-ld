...
class NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange.")
    ...
    ip_prefix_mask: Optional[NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask] = Field(default=None, alias="ipPrefixMask")
    advertise: Optional[NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipPrefixMask", "advertise", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of ip_prefix_mask
        if self.ip_prefix_mask:
            _dict['ipPrefixMask'] = self.ip_prefix_mask.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRange',
            ...
            "ipPrefixMask": NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask.from_dict(obj["ipPrefixMask"]) if obj.get("ipPrefixMask") is not None else None,
            "advertise": NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise.from_dict(obj["advertise"]) if obj.get("advertise") is not None else None,
