...
class NetworkInstanceIcmpStatisticsTotal(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceIcmpStatisticsTotal.")
    ...
    in_packets: Optional[NetworkInstanceIcmpStatisticsTotalInPackets] = Field(default=None, alias="inPackets")
    in_error_packets: Optional[NetworkInstanceIcmpStatisticsTotalInErrorPackets] = Field(default=None, alias="inErrorPackets")
    out_packets: Optional[NetworkInstanceIcmpStatisticsTotalOutPackets] = Field(default=None, alias="outPackets")
    out_error_packets: Optional[NetworkInstanceIcmpStatisticsTotalOutErrorPackets] = Field(default=None, alias="outErrorPackets")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "inPackets", "inErrorPackets", "outPackets", "outErrorPackets", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceIcmpStatisticsTotal']):
            raise ValueError("must be one of enum values ('NetworkInstanceIcmpStatisticsTotal')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceIcmpStatisticsTotal',
            ...
            "inPackets": NetworkInstanceIcmpStatisticsTotalInPackets.from_dict(obj["inPackets"]) if obj.get("inPackets") is not None else None,
            "inErrorPackets": NetworkInstanceIcmpStatisticsTotalInErrorPackets.from_dict(obj["inErrorPackets"]) if obj.get("inErrorPackets") is not None else None,
            "outPackets": NetworkInstanceIcmpStatisticsTotalOutPackets.from_dict(obj["outPackets"]) if obj.get("outPackets") is not None else None,
            "outErrorPackets": NetworkInstanceIcmpStatisticsTotalOutErrorPackets.from_dict(obj["outErrorPackets"]) if obj.get("outErrorPackets") is not None else None,
