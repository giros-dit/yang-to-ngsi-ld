...
class PolicyStatementActionBgpNextHop(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpNextHop.")
    ...
    set: Optional[PolicyStatementActionBgpNextHopSet] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpNextHop']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpNextHop')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpNextHop',
            ...
            "set": PolicyStatementActionBgpNextHopSet.from_dict(obj["set"]) if obj.get("set") is not None else None,
