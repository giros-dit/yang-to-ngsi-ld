...
class ExtendedCommunitySet(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be ExtendedCommunitySet.")
    ...
    name: ExtendedCommunitySetName
    member: Optional[ExtendedCommunitySetMember] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ExtendedCommunitySet']):
            raise ValueError("must be one of enum values ('ExtendedCommunitySet')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'ExtendedCommunitySet',
            ...
            "name": ExtendedCommunitySetName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "member": ExtendedCommunitySetMember.from_dict(obj["member"]) if obj.get("member") is not None else None
        })
