...
class NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pseudowire-forwarding', 'pseudowire-not-forwarding', 'local-attachment-circuit-ingress-fault', 'local-attachment-circuit-egress-fault', 'provider-service-network-ingress-fault', 'provider-service-network-egress-fault', 'pseudowire-forwarding-standby', 'pseudowire-request-switchover']):
            raise ValueError("must be one of enum values ('pseudowire-forwarding', 'pseudowire-not-forwarding', 'local-attachment-circuit-ingress-fault', 'local-attachment-circuit-egress-fault', 'provider-service-network-ingress-fault', 'provider-service-network-egress-fault', 'pseudowire-forwarding-standby', 'pseudowire-request-switchover')")
        return value
