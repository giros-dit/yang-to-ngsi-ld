...
class PolicyStatementActionBgpAsPathPrepend(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpAsPathPrepend.")
    ...
    as_number: Optional[PolicyStatementActionBgpAsPathPrependAsNumber] = Field(default=None, alias="asNumber")
    repeat_n: Optional[PolicyStatementActionBgpAsPathPrependRepeatN] = Field(default=None, alias="repeatN")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpAsPathPrepend']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpAsPathPrepend')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpAsPathPrepend',
            ...
            "asNumber": PolicyStatementActionBgpAsPathPrependAsNumber.from_dict(obj["asNumber"]) if obj.get("asNumber") is not None else None,
            "repeatN": PolicyStatementActionBgpAsPathPrependRepeatN.from_dict(obj["repeatN"]) if obj.get("repeatN") is not None else None,
