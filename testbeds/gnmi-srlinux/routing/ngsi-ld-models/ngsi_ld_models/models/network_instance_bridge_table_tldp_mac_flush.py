...
class NetworkInstanceBridgeTableTldpMacFlush(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceBridgeTableTldpMacFlush.")
    ...
    send_flush_on_failure: Optional[SendFlushOnFailure] = Field(default=None, alias="sendFlushOnFailure")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "sendFlushOnFailure", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceBridgeTableTldpMacFlush']):
            raise ValueError("must be one of enum values ('NetworkInstanceBridgeTableTldpMacFlush')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of send_flush_on_failure
        if self.send_flush_on_failure:
            _dict['sendFlushOnFailure'] = self.send_flush_on_failure.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceBridgeTableTldpMacFlush',
            ...
            "sendFlushOnFailure": SendFlushOnFailure.from_dict(obj["sendFlushOnFailure"]) if obj.get("sendFlushOnFailure") is not None else None,
