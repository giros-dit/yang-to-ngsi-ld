...
class NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution.")
    ...
    mode: Optional[NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode] = None
    allowed_tunnel_types: Optional[NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes] = Field(default=None, alias="allowedTunnelTypes")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution']):
            raise ValueError("must be one of enum values ('NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution',
            ...
            "mode": NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode.from_dict(obj["mode"]) if obj.get("mode") is not None else None,
            "allowedTunnelTypes": NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionAllowedTunnelTypes.from_dict(obj["allowedTunnelTypes"]) if obj.get("allowedTunnelTypes") is not None else None,
