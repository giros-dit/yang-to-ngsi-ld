...
class InterfaceTrafficRate(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceTrafficRate.")
    ...
    in_bps: Optional[InBps] = Field(default=None, alias="inBps")
    out_bps: Optional[OutBps] = Field(default=None, alias="outBps")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "inBps", "outBps", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceTrafficRate']):
            raise ValueError("must be one of enum values ('InterfaceTrafficRate')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of in_bps
        if self.in_bps:
            _dict['inBps'] = self.in_bps.to_dict()
        # override the default output from pydantic by calling `to_dict()` of out_bps
        if self.out_bps:
            _dict['outBps'] = self.out_bps.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceTrafficRate',
            ...
            "inBps": InBps.from_dict(obj["inBps"]) if obj.get("inBps") is not None else None,
            "outBps": OutBps.from_dict(obj["outBps"]) if obj.get("outBps") is not None else None,
