...
class NetworkInstanceNextHopGroupsGroupNexthopGre(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceNextHopGroupsGroupNexthopGre.")
    ...
    source_ip: Optional[SourceIp] = Field(default=None, alias="sourceIp")
    destination_ip: Optional[DestinationIp] = Field(default=None, alias="destinationIp")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "sourceIp", "destinationIp", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceNextHopGroupsGroupNexthopGre']):
            raise ValueError("must be one of enum values ('NetworkInstanceNextHopGroupsGroupNexthopGre')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.source_ip:
            _dict['sourceIp'] = self.source_ip.to_dict()
        # override the default output from pydantic by calling `to_dict()` of destination_ip
        if self.destination_ip:
            _dict['destinationIp'] = self.destination_ip.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceNextHopGroupsGroupNexthopGre',
            ...
            "sourceIp": SourceIp.from_dict(obj["sourceIp"]) if obj.get("sourceIp") is not None else None,
            "destinationIp": DestinationIp.from_dict(obj["destinationIp"]) if obj.get("destinationIp") is not None else None,
