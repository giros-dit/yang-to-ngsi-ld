...
class NetworkInstanceProtocolsOspfInstanceAreaStub(BaseModel):
    """
     YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaStub.")
    ...
    default_metric: Optional[DefaultMetric] = Field(default=None, alias="defaultMetric")
    summaries: Optional[NetworkInstanceProtocolsOspfInstanceAreaStubSummaries] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "defaultMetric", "summaries", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaStub']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaStub')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of default_metric
        if self.default_metric:
            _dict['defaultMetric'] = self.default_metric.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaStub',
            ...
            "defaultMetric": DefaultMetric.from_dict(obj["defaultMetric"]) if obj.get("defaultMetric") is not None else None,
            "summaries": NetworkInstanceProtocolsOspfInstanceAreaStubSummaries.from_dict(obj["summaries"]) if obj.get("summaries") is not None else None,
