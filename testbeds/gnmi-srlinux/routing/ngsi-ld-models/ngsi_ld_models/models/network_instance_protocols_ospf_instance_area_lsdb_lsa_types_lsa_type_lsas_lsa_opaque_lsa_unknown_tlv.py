...
class NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlv(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlv.")
    ...
    unknowntlv_type: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlvType] = Field(default=None, alias="unknowntlvType")
    length: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlvLength] = None
    value: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlvValue] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlv']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlv')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlv',
            ...
            "unknowntlvType": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlvType.from_dict(obj["unknowntlvType"]) if obj.get("unknowntlvType") is not None else None,
            "length": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlvLength.from_dict(obj["length"]) if obj.get("length") is not None else None,
            "value": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaUnknownTlvValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
