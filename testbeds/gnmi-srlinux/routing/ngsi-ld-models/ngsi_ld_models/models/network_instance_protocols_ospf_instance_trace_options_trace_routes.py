...
class NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes(BaseModel):
    """
     YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes.")
    ...
    dest_address: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress] = Field(default=None, alias="destAddress")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "destAddress", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of dest_address
        if self.dest_address:
            _dict['destAddress'] = self.dest_address.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes',
            ...
            "destAddress": NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress.from_dict(obj["destAddress"]) if obj.get("destAddress") is not None else None,
