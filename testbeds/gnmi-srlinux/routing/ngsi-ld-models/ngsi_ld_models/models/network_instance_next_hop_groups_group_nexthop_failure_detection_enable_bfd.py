...
class NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd(BaseModel):
    """
     YANG module: srl_nokia-next-hop-groups.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd.")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "localAddress", "localDiscriminator", "remoteDiscriminator", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd']):
            raise ValueError("must be one of enum values ('NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of local_discriminator
        if self.local_discriminator:
            _dict['localDiscriminator'] = self.local_discriminator.to_dict()
        # override the default output from pydantic by calling `to_dict()` of remote_discriminator
        if self.remote_discriminator:
            _dict['remoteDiscriminator'] = self.remote_discriminator.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd',
