...
class NetworkInstanceIcmp6Statistics(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceIcmp6Statistics.")
    ...
    last_clear: Optional[NetworkInstanceIcmp6StatisticsLastClear] = Field(default=None, alias="lastClear")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceIcmp6Statistics']):
            raise ValueError("must be one of enum values ('NetworkInstanceIcmp6Statistics')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceIcmp6Statistics',
            ...
            "lastClear": NetworkInstanceIcmp6StatisticsLastClear.from_dict(obj["lastClear"]) if obj.get("lastClear") is not None else None,
