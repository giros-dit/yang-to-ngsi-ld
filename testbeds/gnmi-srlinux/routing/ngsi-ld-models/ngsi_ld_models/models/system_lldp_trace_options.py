...
class SystemLldpTraceOptions(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['received', 'transmitted', 'common']):
            raise ValueError("must be one of enum values ('received', 'transmitted', 'common')")
        return value
