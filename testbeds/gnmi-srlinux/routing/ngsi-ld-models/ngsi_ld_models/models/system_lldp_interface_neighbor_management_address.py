...
class SystemLldpInterfaceNeighborManagementAddress(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceNeighborManagementAddress.")
    ...
    address: Optional[SystemLldpInterfaceNeighborManagementAddressAddress] = None
    managementaddress_type: Optional[SystemLldpInterfaceNeighborManagementAddressType] = Field(default=None, alias="managementaddressType")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "address", "managementaddressType", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceNeighborManagementAddress']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceNeighborManagementAddress')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of managementaddress_type
        if self.managementaddress_type:
            _dict['managementaddressType'] = self.managementaddress_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceNeighborManagementAddress',
            ...
            "address": SystemLldpInterfaceNeighborManagementAddressAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "managementaddressType": SystemLldpInterfaceNeighborManagementAddressType.from_dict(obj["managementaddressType"]) if obj.get("managementaddressType") is not None else None,
