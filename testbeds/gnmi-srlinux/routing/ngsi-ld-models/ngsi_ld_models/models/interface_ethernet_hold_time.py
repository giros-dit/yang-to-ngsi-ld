...
class InterfaceEthernetHoldTime(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetHoldTime.")
    ...
    up: Optional[Up] = None
    up_expires: Optional[UpExpires] = Field(default=None, alias="upExpires")
    down: Optional[Down] = None
    down_expires: Optional[DownExpires] = Field(default=None, alias="downExpires")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "up", "upExpires", "down", "downExpires", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetHoldTime']):
            raise ValueError("must be one of enum values ('InterfaceEthernetHoldTime')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of up_expires
        if self.up_expires:
            _dict['upExpires'] = self.up_expires.to_dict()
        # override the default output from pydantic by calling `to_dict()` of down
        if self.down:
            _dict['down'] = self.down.to_dict()
        # override the default output from pydantic by calling `to_dict()` of down_expires
        if self.down_expires:
            _dict['downExpires'] = self.down_expires.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetHoldTime',
            ...
            "up": Up.from_dict(obj["up"]) if obj.get("up") is not None else None,
            "upExpires": UpExpires.from_dict(obj["upExpires"]) if obj.get("upExpires") is not None else None,
            "down": Down.from_dict(obj["down"]) if obj.get("down") is not None else None,
            "downExpires": DownExpires.from_dict(obj["downExpires"]) if obj.get("downExpires") is not None else None,
