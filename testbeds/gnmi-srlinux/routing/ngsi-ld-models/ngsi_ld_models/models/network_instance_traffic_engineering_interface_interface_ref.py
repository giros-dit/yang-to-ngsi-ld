...
class NetworkInstanceTrafficEngineeringInterfaceInterfaceRef(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceTrafficEngineeringInterfaceInterfaceRef.")
    ...
    interface: Optional[NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface] = None
    subinterface: Optional[NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "interface", "subinterface", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceTrafficEngineeringInterfaceInterfaceRef']):
            raise ValueError("must be one of enum values ('NetworkInstanceTrafficEngineeringInterfaceInterfaceRef')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceTrafficEngineeringInterfaceInterfaceRef',
            ...
            "interface": NetworkInstanceTrafficEngineeringInterfaceInterfaceRefInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "subinterface": NetworkInstanceTrafficEngineeringInterfaceInterfaceRefSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
