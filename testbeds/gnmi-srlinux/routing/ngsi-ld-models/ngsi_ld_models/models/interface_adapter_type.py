...
class InterfaceAdapterType(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['unknown', 'qsfp28-to-sfp+/sfp28', 'cfp-to-qsfp28']):
            raise ValueError("must be one of enum values ('unknown', 'qsfp28-to-sfp+/sfp28', 'cfp-to-qsfp28')")
        return value
