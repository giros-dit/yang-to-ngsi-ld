...
class NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength.")
    ...
    prefix_length: Optional[NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength] = Field(default=None, alias="prefixLength")
    active_routes: Optional[NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes] = Field(default=None, alias="activeRoutes")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "prefixLength", "activeRoutes", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength',
            ...
            "prefixLength": NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthPrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
            "activeRoutes": NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes.from_dict(obj["activeRoutes"]) if obj.get("activeRoutes") is not None else None,
