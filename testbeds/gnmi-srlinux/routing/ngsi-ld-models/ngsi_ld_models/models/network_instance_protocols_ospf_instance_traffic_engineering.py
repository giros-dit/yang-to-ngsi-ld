...
class NetworkInstanceProtocolsOspfInstanceTrafficEngineering(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTrafficEngineering.")
    ...
    advertisement: Optional[NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "advertisement", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTrafficEngineering']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTrafficEngineering')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTrafficEngineering',
            ...
            "advertisement": NetworkInstanceProtocolsOspfInstanceTrafficEngineeringAdvertisement.from_dict(obj["advertisement"]) if obj.get("advertisement") is not None else None,
