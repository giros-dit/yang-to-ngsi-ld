...
class PolicyDefaultActionIsisMetric(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionIsisMetric.")
    ...
    set_style: Optional[PolicyDefaultActionIsisMetricSetStyle] = Field(default=None, alias="setStyle")
    set_value: Optional[PolicyDefaultActionIsisMetricSetValue] = Field(default=None, alias="setValue")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionIsisMetric']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionIsisMetric')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionIsisMetric',
            ...
            "setStyle": PolicyDefaultActionIsisMetricSetStyle.from_dict(obj["setStyle"]) if obj.get("setStyle") is not None else None,
            "setValue": PolicyDefaultActionIsisMetricSetValue.from_dict(obj["setValue"]) if obj.get("setValue") is not None else None,
