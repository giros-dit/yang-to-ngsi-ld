...
class NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='Relationship', description="Node type. ")
    object: StrictStr = Field(description="Relationship with Entity type NetworkInstanceBridgeTableSplitHorizonGroup.")
