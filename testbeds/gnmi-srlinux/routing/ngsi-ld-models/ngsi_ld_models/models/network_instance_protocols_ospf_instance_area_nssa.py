...
class NetworkInstanceProtocolsOspfInstanceAreaNssa(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaNssa.")
    ...
    redistribute_external: Optional[RedistributeExternal] = Field(default=None, alias="redistributeExternal")
    summaries: Optional[NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "redistributeExternal", "summaries", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaNssa']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaNssa')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of redistribute_external
        if self.redistribute_external:
            _dict['redistributeExternal'] = self.redistribute_external.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaNssa',
            ...
            "redistributeExternal": RedistributeExternal.from_dict(obj["redistributeExternal"]) if obj.get("redistributeExternal") is not None else None,
            "summaries": NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries.from_dict(obj["summaries"]) if obj.get("summaries") is not None else None,
