...
class SystemSrv6MicroSegmentBlockStaticFunction(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6MicroSegmentBlockStaticFunction.")
    ...
    max_entries: Optional[SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries] = Field(default=None, alias="maxEntries")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6MicroSegmentBlockStaticFunction']):
            raise ValueError("must be one of enum values ('SystemSrv6MicroSegmentBlockStaticFunction')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6MicroSegmentBlockStaticFunction',
            ...
            "maxEntries": SystemSrv6MicroSegmentBlockStaticFunctionMaxEntries.from_dict(obj["maxEntries"]) if obj.get("maxEntries") is not None else None,
