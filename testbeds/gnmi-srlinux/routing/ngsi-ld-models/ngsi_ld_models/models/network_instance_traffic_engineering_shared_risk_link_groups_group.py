...
class NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup.")
    ...
    name: Optional[NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName] = None
    value: NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "value", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup']):
            raise ValueError("must be one of enum values ('NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup',
            ...
            "name": NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "value": NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
