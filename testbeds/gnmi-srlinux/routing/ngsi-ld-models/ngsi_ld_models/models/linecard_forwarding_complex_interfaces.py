...
class LinecardForwardingComplexInterfaces(BaseModel):
    """
    ...
    def value_validate_regular_expression(cls, value):
        ...
        if not re.match(r"(mgmt0|mgmt0-standby|mgmtA|mgmtB|system0|sync0|lo(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])|lif-.*|vhn-.*|enp(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])s(0|[1-9]|[1-2][0-9]|3[0-1])f[0-7]|ethernet-([1-9](\d){0,1}(\/m[1-6])?(\/[1-9](\d){0,1})?\/(([1-9](\d){0,1})|(1[0-1]\d)|(12[0-8])))|irb(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])|lag(([1-9](\d){0,2})|(1000)))", value):
            raise ValueError(r"must validate the regular expression /(mgmt0|mgmt0-standby|mgmtA|mgmtB|system0|sync0|lo(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])|lif-.*|vhn-.*|enp(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])s(0|[1-9]|[1-2][0-9]|3[0-1])f[0-7]|ethernet-([1-9](\d){0,1}(\/m[1-6])?(\/[1-9](\d){0,1})?\/(([1-9](\d){0,1})|(1[0-1]\d)|(12[0-8])))|irb(0|1[0-9][0-9]|2([0-4][0-9]|5[0-5])|[1-9][0-9]|[1-9])|lag(([1-9](\d){0,2})|(1000)))/")
        return value
