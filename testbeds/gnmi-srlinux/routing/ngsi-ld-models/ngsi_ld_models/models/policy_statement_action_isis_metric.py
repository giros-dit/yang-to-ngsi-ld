...
class PolicyStatementActionIsisMetric(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionIsisMetric.")
    ...
    set_style: Optional[PolicyStatementActionIsisMetricSetStyle] = Field(default=None, alias="setStyle")
    set_value: Optional[PolicyStatementActionIsisMetricSetValue] = Field(default=None, alias="setValue")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "setStyle", "setValue", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionIsisMetric']):
            raise ValueError("must be one of enum values ('PolicyStatementActionIsisMetric')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of set_style
        if self.set_style:
            _dict['setStyle'] = self.set_style.to_dict()
        # override the default output from pydantic by calling `to_dict()` of set_value
        if self.set_value:
            _dict['setValue'] = self.set_value.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionIsisMetric',
            ...
            "setStyle": PolicyStatementActionIsisMetricSetStyle.from_dict(obj["setStyle"]) if obj.get("setStyle") is not None else None,
            "setValue": PolicyStatementActionIsisMetricSetValue.from_dict(obj["setValue"]) if obj.get("setValue") is not None else None,
