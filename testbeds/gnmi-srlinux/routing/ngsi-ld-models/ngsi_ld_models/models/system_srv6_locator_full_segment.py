...
class SystemSrv6LocatorFullSegment(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6LocatorFullSegment.")
    ...
    block_length: Optional[SystemSrv6LocatorFullSegmentBlockLength] = Field(default=None, alias="blockLength")
    function_length: FunctionLength = Field(alias="functionLength")
    argument_length: Optional[SystemSrv6LocatorFullSegmentArgumentLength] = Field(default=None, alias="argumentLength")
    algorithm: Optional[SystemSrv6LocatorFullSegmentAlgorithm] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "blockLength", "functionLength", "argumentLength", "algorithm", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6LocatorFullSegment']):
            raise ValueError("must be one of enum values ('SystemSrv6LocatorFullSegment')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of block_length
        if self.block_length:
            _dict['blockLength'] = self.block_length.to_dict()
        # override the default output from pydantic by calling `to_dict()` of function_length
        if self.function_length:
            _dict['functionLength'] = self.function_length.to_dict()
        # override the default output from pydantic by calling `to_dict()` of argument_length
        if self.argument_length:
            _dict['argumentLength'] = self.argument_length.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6LocatorFullSegment',
            ...
            "blockLength": SystemSrv6LocatorFullSegmentBlockLength.from_dict(obj["blockLength"]) if obj.get("blockLength") is not None else None,
            "functionLength": FunctionLength.from_dict(obj["functionLength"]) if obj.get("functionLength") is not None else None,
            "argumentLength": SystemSrv6LocatorFullSegmentArgumentLength.from_dict(obj["argumentLength"]) if obj.get("argumentLength") is not None else None,
            "algorithm": SystemSrv6LocatorFullSegmentAlgorithm.from_dict(obj["algorithm"]) if obj.get("algorithm") is not None else None,
