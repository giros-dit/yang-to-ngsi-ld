...
class SystemSrv6MicroSegmentBlockPrefix(BaseModel):
    """
    Enter the prefix context  YANG module: srl_nokia-srv6.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6MicroSegmentBlockPrefix.")
    ...
    ip_prefix: SystemSrv6MicroSegmentBlockPrefixIpPrefix = Field(alias="ipPrefix")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6MicroSegmentBlockPrefix']):
            raise ValueError("must be one of enum values ('SystemSrv6MicroSegmentBlockPrefix')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6MicroSegmentBlockPrefix',
            ...
            "ipPrefix": SystemSrv6MicroSegmentBlockPrefixIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
