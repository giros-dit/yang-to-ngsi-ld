...
class SystemLldpInterfaceNeighborBgpAutoDiscovery(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceNeighborBgpAutoDiscovery.")
    ...
    bgp_peer_addresses: Optional[BgpPeerAddresses] = Field(default=None, alias="bgpPeerAddresses")
    group_id: Optional[SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId] = Field(default=None, alias="groupId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "bgpPeerAddresses", "groupId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceNeighborBgpAutoDiscovery']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceNeighborBgpAutoDiscovery')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of bgp_peer_addresses
        if self.bgp_peer_addresses:
            _dict['bgpPeerAddresses'] = self.bgp_peer_addresses.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceNeighborBgpAutoDiscovery',
            ...
            "bgpPeerAddresses": BgpPeerAddresses.from_dict(obj["bgpPeerAddresses"]) if obj.get("bgpPeerAddresses") is not None else None,
            "groupId": SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId.from_dict(obj["groupId"]) if obj.get("groupId") is not None else None,
