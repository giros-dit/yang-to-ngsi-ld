...
class PolicyDefaultActionRoutePreference(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionRoutePreference.")
    ...
    set: Optional[PolicyDefaultActionRoutePreferenceSet] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "set", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionRoutePreference']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionRoutePreference')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionRoutePreference',
            ...
            "set": PolicyDefaultActionRoutePreferenceSet.from_dict(obj["set"]) if obj.get("set") is not None else None,
