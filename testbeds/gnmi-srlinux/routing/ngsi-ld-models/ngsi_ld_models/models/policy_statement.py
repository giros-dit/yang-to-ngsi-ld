...
class PolicyStatement(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatement.")
    ...
    name: Optional[PolicyStatementName] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatement']):
            raise ValueError("must be one of enum values ('PolicyStatement')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatement',
            ...
            "name": PolicyStatementName.from_dict(obj["name"]) if obj.get("name") is not None else None,
