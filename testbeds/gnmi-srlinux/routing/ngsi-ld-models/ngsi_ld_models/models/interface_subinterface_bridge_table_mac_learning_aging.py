...
class InterfaceSubinterfaceBridgeTableMacLearningAging(BaseModel):
    """
     YANG module: srl_nokia-interfaces.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceBridgeTableMacLearningAging.")
    ...
    admin_state: Optional[InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState] = Field(default=None, alias="adminState")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceBridgeTableMacLearningAging']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceBridgeTableMacLearningAging')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceBridgeTableMacLearningAging',
            ...
            "adminState": InterfaceSubinterfaceBridgeTableMacLearningAgingAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
