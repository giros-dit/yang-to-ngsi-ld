...
class PolicyStatementMatchBgpEvpn(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchBgpEvpn.")
    ...
    route_type: Optional[PolicyStatementMatchBgpEvpnRouteType] = Field(default=None, alias="routeType")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "routeType", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchBgpEvpn']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchBgpEvpn')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchBgpEvpn',
            ...
            "routeType": PolicyStatementMatchBgpEvpnRouteType.from_dict(obj["routeType"]) if obj.get("routeType") is not None else None,
