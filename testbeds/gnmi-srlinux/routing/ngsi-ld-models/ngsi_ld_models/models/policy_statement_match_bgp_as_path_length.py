...
class PolicyStatementMatchBgpAsPathLength(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchBgpAsPathLength.")
    ...
    value: Optional[PolicyStatementMatchBgpAsPathLengthValue] = None
    operator: Optional[Operator] = None
    unique: Optional[Unique] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "value", "operator", "unique", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchBgpAsPathLength']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchBgpAsPathLength')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchBgpAsPathLength',
            ...
            "value": PolicyStatementMatchBgpAsPathLengthValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
            "operator": Operator.from_dict(obj["operator"]) if obj.get("operator") is not None else None,
            "unique": Unique.from_dict(obj["unique"]) if obj.get("unique") is not None else None,
