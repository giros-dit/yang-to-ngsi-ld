...
class InterfaceSubinterfaceIpv4AddressStatus(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['preferred', 'inaccessible', 'tentative', 'duplicate']):
            raise ValueError("must be one of enum values ('preferred', 'inaccessible', 'tentative', 'duplicate')")
        return value
