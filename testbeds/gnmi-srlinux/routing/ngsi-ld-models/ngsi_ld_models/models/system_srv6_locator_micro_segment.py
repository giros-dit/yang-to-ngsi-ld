...
class SystemSrv6LocatorMicroSegment(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6LocatorMicroSegment.")
    ...
    block: SystemSrv6LocatorMicroSegmentBlock
    argument_length: Optional[SystemSrv6LocatorMicroSegmentArgumentLength] = Field(default=None, alias="argumentLength")
    algorithm: Optional[SystemSrv6LocatorMicroSegmentAlgorithm] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "block", "argumentLength", "algorithm", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6LocatorMicroSegment']):
            raise ValueError("must be one of enum values ('SystemSrv6LocatorMicroSegment')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6LocatorMicroSegment',
            ...
            "block": SystemSrv6LocatorMicroSegmentBlock.from_dict(obj["block"]) if obj.get("block") is not None else None,
            "argumentLength": SystemSrv6LocatorMicroSegmentArgumentLength.from_dict(obj["argumentLength"]) if obj.get("argumentLength") is not None else None,
            "algorithm": SystemSrv6LocatorMicroSegmentAlgorithm.from_dict(obj["algorithm"]) if obj.get("algorithm") is not None else None,
