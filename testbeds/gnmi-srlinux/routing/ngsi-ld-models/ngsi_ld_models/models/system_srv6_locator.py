...
class SystemSrv6Locator(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6Locator.")
    ...
    locator_name: Optional[LocatorName] = Field(default=None, alias="locatorName")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "locatorName", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6Locator']):
            raise ValueError("must be one of enum values ('SystemSrv6Locator')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of locator_name
        if self.locator_name:
            _dict['locatorName'] = self.locator_name.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6Locator',
            ...
            "locatorName": LocatorName.from_dict(obj["locatorName"]) if obj.get("locatorName") is not None else None,
