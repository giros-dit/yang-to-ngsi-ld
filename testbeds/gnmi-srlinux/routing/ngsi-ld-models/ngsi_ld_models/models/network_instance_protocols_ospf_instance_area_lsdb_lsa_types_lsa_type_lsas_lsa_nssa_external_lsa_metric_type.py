...
class NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaNssaExternalLsaMetricType(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TYPE_1', 'TYPE_2']):
            raise ValueError("must be one of enum values ('TYPE_1', 'TYPE_2')")
        return value
