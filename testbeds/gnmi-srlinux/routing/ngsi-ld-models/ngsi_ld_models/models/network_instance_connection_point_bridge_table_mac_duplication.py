...
class NetworkInstanceConnectionPointBridgeTableMacDuplication(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointBridgeTableMacDuplication.")
    ...
    action: Optional[NetworkInstanceConnectionPointBridgeTableMacDuplicationAction] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointBridgeTableMacDuplication']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointBridgeTableMacDuplication')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointBridgeTableMacDuplication',
            ...
            "action": NetworkInstanceConnectionPointBridgeTableMacDuplicationAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
