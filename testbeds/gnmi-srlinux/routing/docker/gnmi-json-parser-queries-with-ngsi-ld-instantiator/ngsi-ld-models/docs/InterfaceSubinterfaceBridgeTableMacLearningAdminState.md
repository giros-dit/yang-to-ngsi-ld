...
interface_subinterface_bridge_table_mac_learning_admin_state_from_dict = InterfaceSubinterfaceBridgeTableMacLearningAdminState.from_dict(interface_subinterface_bridge_table_mac_learning_admin_state_dict)
```
