# InterfaceTransceiverTemperatureLowWarningThreshold
...
interface_transceiver_temperature_low_warning_threshold_from_dict = InterfaceTransceiverTemperatureLowWarningThreshold.from_dict(interface_transceiver_temperature_low_warning_threshold_dict)
```
