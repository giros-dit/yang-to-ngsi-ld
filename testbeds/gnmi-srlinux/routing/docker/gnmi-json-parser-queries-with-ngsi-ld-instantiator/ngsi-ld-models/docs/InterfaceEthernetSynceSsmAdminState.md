# InterfaceEthernetSynceSsmAdminState
...
interface_ethernet_synce_ssm_admin_state_from_dict = InterfaceEthernetSynceSsmAdminState.from_dict(interface_ethernet_synce_ssm_admin_state_dict)
```
