# InterfaceSubinterfaceIpv4StatisticsOutOctets

The total number of octets in packets delivered to the lower layers for transmission  YANG module: srl_nokia-interfaces.yang 
...
interface_subinterface_ipv4_statistics_out_octets_from_dict = InterfaceSubinterfaceIpv4StatisticsOutOctets.from_dict(interface_subinterface_ipv4_statistics_out_octets_dict)
```
