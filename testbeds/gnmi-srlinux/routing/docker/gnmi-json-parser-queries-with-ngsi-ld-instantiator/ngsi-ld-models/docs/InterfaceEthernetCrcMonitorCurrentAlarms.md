# InterfaceEthernetCrcMonitorCurrentAlarms
...
interface_ethernet_crc_monitor_current_alarms_from_dict = InterfaceEthernetCrcMonitorCurrentAlarms.from_dict(interface_ethernet_crc_monitor_current_alarms_dict)
```
