# InterfaceEthernetCrcMonitorWindowSize
...
interface_ethernet_crc_monitor_window_size_from_dict = InterfaceEthernetCrcMonitorWindowSize.from_dict(interface_ethernet_crc_monitor_window_size_dict)
```
