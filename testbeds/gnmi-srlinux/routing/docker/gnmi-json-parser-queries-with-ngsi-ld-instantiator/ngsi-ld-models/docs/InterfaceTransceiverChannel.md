...
List of physical channels supported by the transceiver associated with this port.  Availability of these leaves is dependent on the transceiver-functional-type; not all leaves are available for all types  YANG module: srl_nokia-interfaces.yang 
...
interface_transceiver_channel_from_dict = InterfaceTransceiverChannel.from_dict(interface_transceiver_channel_dict)
```
