# InterfaceTransceiverTemperatureMaximumTime
...
interface_transceiver_temperature_maximum_time_from_dict = InterfaceTransceiverTemperatureMaximumTime.from_dict(interface_transceiver_temperature_maximum_time_dict)
```
