# InterfaceEthernetSymbolMonitorCurrentAlarms
...
interface_ethernet_symbol_monitor_current_alarms_from_dict = InterfaceEthernetSymbolMonitorCurrentAlarms.from_dict(interface_ethernet_symbol_monitor_current_alarms_dict)
```
