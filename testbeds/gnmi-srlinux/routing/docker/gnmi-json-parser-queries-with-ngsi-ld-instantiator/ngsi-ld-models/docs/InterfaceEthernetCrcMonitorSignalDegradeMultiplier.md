...
interface_ethernet_crc_monitor_signal_degrade_multiplier_from_dict = InterfaceEthernetCrcMonitorSignalDegradeMultiplier.from_dict(interface_ethernet_crc_monitor_signal_degrade_multiplier_dict)
```
