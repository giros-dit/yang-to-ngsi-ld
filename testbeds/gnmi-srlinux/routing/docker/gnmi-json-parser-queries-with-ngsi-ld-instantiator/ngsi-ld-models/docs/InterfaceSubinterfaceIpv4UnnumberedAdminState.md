# InterfaceSubinterfaceIpv4UnnumberedAdminState
...
interface_subinterface_ipv4_unnumbered_admin_state_from_dict = InterfaceSubinterfaceIpv4UnnumberedAdminState.from_dict(interface_subinterface_ipv4_unnumbered_admin_state_dict)
```
