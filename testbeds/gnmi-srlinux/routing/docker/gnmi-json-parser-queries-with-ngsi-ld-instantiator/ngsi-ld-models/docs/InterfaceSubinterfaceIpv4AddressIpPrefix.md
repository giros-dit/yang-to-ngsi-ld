...
interface_subinterface_ipv4_address_ip_prefix_from_dict = InterfaceSubinterfaceIpv4AddressIpPrefix.from_dict(interface_subinterface_ipv4_address_ip_prefix_dict)
```
