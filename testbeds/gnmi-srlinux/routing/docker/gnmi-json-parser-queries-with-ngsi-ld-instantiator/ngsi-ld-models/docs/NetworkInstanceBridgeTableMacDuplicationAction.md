# NetworkInstanceBridgeTableMacDuplicationAction
...
**value** | **str** |  | [default to 'stop-learning']
...
```python
from ngsi_ld_models.models.network_instance_bridge_table_mac_duplication_action import NetworkInstanceBridgeTableMacDuplicationAction

# TODO update the JSON string below
json = "{}"
# create an instance of NetworkInstanceBridgeTableMacDuplicationAction from a JSON string
network_instance_bridge_table_mac_duplication_action_instance = NetworkInstanceBridgeTableMacDuplicationAction.from_json(json)
# print the JSON string representation of the object
print(NetworkInstanceBridgeTableMacDuplicationAction.to_json())

# convert the object into a dict
network_instance_bridge_table_mac_duplication_action_dict = network_instance_bridge_table_mac_duplication_action_instance.to_dict()
# create an instance of NetworkInstanceBridgeTableMacDuplicationAction from a dict
network_instance_bridge_table_mac_duplication_action_from_dict = NetworkInstanceBridgeTableMacDuplicationAction.from_dict(network_instance_bridge_table_mac_duplication_action_dict)
```
