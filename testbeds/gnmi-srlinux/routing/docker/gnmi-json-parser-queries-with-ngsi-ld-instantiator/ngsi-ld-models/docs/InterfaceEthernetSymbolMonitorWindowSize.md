# InterfaceEthernetSymbolMonitorWindowSize
...
interface_ethernet_symbol_monitor_window_size_from_dict = InterfaceEthernetSymbolMonitorWindowSize.from_dict(interface_ethernet_symbol_monitor_window_size_dict)
```
