# InterfaceEthernetCrcMonitorSignalFailure
...
interface_ethernet_crc_monitor_signal_failure_from_dict = InterfaceEthernetCrcMonitorSignalFailure.from_dict(interface_ethernet_crc_monitor_signal_failure_dict)
```
