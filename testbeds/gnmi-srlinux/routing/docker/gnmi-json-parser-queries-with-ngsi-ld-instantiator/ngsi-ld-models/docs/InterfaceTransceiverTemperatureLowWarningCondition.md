# InterfaceTransceiverTemperatureLowWarningCondition
...
interface_transceiver_temperature_low_warning_condition_from_dict = InterfaceTransceiverTemperatureLowWarningCondition.from_dict(interface_transceiver_temperature_low_warning_condition_dict)
```
