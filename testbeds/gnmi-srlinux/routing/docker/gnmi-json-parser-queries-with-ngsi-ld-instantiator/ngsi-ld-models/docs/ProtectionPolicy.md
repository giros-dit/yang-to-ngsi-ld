...
The protection policy to use with the TE policy if the matched BGP route becomes the active candidate path  YANG module: srl_nokia-routing-policy.yang 
...
```python
from ngsi_ld_models.models.protection_policy import ProtectionPolicy
