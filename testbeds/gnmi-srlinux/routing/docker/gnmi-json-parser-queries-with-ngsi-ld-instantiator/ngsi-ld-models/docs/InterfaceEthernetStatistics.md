...
**in_undersize_frames** | [**InUndersizeFrames**](InUndersizeFrames.md) |  | [optional] 
...
interface_ethernet_statistics_from_dict = InterfaceEthernetStatistics.from_dict(interface_ethernet_statistics_dict)
```
