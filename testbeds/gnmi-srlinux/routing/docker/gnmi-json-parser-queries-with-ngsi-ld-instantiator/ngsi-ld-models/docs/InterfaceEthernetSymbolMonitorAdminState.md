# InterfaceEthernetSymbolMonitorAdminState
...
interface_ethernet_symbol_monitor_admin_state_from_dict = InterfaceEthernetSymbolMonitorAdminState.from_dict(interface_ethernet_symbol_monitor_admin_state_dict)
```
