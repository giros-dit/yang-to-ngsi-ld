# LinecardForwardingComplexLastBooted
...
linecard_forwarding_complex_last_booted_from_dict = LinecardForwardingComplexLastBooted.from_dict(linecard_forwarding_complex_last_booted_dict)
```
