# LinecardForwardingComplexLastBootedReason
...
linecard_forwarding_complex_last_booted_reason_from_dict = LinecardForwardingComplexLastBootedReason.from_dict(linecard_forwarding_complex_last_booted_reason_dict)
```
