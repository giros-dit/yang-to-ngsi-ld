# InterfaceTransceiverTemperatureHighAlarmCondition
...
interface_transceiver_temperature_high_alarm_condition_from_dict = InterfaceTransceiverTemperatureHighAlarmCondition.from_dict(interface_transceiver_temperature_high_alarm_condition_dict)
```
