# InterfaceSubinterfaceUnidirectionalLinkDelay
...
interface_subinterface_unidirectional_link_delay_from_dict = InterfaceSubinterfaceUnidirectionalLinkDelay.from_dict(interface_subinterface_unidirectional_link_delay_dict)
```
