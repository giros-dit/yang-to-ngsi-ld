...
class TestPolicyStatementMatchOriginNetworkInstance(unittest.TestCase):
    """PolicyStatementMatchOriginNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchOriginNetworkInstance:
        """Test PolicyStatementMatchOriginNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchOriginNetworkInstance`
        """
        model = PolicyStatementMatchOriginNetworkInstance()
        if include_optional:
            return PolicyStatementMatchOriginNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementMatchOriginNetworkInstance(self):
        """Test PolicyStatementMatchOriginNetworkInstance"""
