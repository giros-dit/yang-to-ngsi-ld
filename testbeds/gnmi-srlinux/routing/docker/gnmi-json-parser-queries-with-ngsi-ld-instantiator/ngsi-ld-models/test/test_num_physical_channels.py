...
class TestNumPhysicalChannels(unittest.TestCase):
    """NumPhysicalChannels unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumPhysicalChannels:
        """Test NumPhysicalChannels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumPhysicalChannels`
        """
        model = NumPhysicalChannels()
        if include_optional:
            return NumPhysicalChannels(
                type = 'Property',
                value = 1,
    ...
    def testNumPhysicalChannels(self):
        """Test NumPhysicalChannels"""
