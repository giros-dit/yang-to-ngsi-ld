...
class TestInterfaceSubinterfaceIpv4AddressAnycastGw(unittest.TestCase):
    """InterfaceSubinterfaceIpv4AddressAnycastGw unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4AddressAnycastGw:
        """Test InterfaceSubinterfaceIpv4AddressAnycastGw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4AddressAnycastGw`
        """
        model = InterfaceSubinterfaceIpv4AddressAnycastGw()
        if include_optional:
            return InterfaceSubinterfaceIpv4AddressAnycastGw(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfaceIpv4AddressAnycastGw(self):
        """Test InterfaceSubinterfaceIpv4AddressAnycastGw"""
