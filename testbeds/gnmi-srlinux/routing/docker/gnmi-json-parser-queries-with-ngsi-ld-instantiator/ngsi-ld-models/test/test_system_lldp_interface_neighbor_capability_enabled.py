...
class TestSystemLldpInterfaceNeighborCapabilityEnabled(unittest.TestCase):
    """SystemLldpInterfaceNeighborCapabilityEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborCapabilityEnabled:
        """Test SystemLldpInterfaceNeighborCapabilityEnabled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborCapabilityEnabled`
        """
        model = SystemLldpInterfaceNeighborCapabilityEnabled()
        if include_optional:
            return SystemLldpInterfaceNeighborCapabilityEnabled(
                type = 'Property',
                value = True,
    ...
    def testSystemLldpInterfaceNeighborCapabilityEnabled(self):
        """Test SystemLldpInterfaceNeighborCapabilityEnabled"""
