...
class TestNetworkInstanceIcmp6StatisticsTypeInPackets(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTypeInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTypeInPackets:
        """Test NetworkInstanceIcmp6StatisticsTypeInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTypeInPackets`
        """
        model = NetworkInstanceIcmp6StatisticsTypeInPackets()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTypeInPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmp6StatisticsTypeInPackets(self):
        """Test NetworkInstanceIcmp6StatisticsTypeInPackets"""
