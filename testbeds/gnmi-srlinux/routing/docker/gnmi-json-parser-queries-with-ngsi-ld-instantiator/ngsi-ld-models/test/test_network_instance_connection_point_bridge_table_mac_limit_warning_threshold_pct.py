...
class TestNetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct:
        """Test NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct(
                type = 'Property',
                value = 6,
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct"""
