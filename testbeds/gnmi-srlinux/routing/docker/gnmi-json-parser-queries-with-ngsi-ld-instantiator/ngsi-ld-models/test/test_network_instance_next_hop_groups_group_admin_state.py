...
class TestNetworkInstanceNextHopGroupsGroupAdminState(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupAdminState:
        """Test NetworkInstanceNextHopGroupsGroupAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupAdminState`
        """
        model = NetworkInstanceNextHopGroupsGroupAdminState()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceNextHopGroupsGroupAdminState(self):
        """Test NetworkInstanceNextHopGroupsGroupAdminState"""
