...
class TestTunnelIndex(unittest.TestCase):
    """TunnelIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TunnelIndex:
        """Test TunnelIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TunnelIndex`
        """
        model = TunnelIndex()
        if include_optional:
            return TunnelIndex(
