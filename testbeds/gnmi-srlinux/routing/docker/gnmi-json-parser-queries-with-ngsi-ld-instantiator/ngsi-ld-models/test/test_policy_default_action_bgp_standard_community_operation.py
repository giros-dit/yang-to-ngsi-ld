...
class TestPolicyDefaultActionBgpStandardCommunityOperation(unittest.TestCase):
    """PolicyDefaultActionBgpStandardCommunityOperation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpStandardCommunityOperation:
        """Test PolicyDefaultActionBgpStandardCommunityOperation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpStandardCommunityOperation`
        """
        model = PolicyDefaultActionBgpStandardCommunityOperation()
        if include_optional:
            return PolicyDefaultActionBgpStandardCommunityOperation(
                type = 'Property',
                value = 'add',
    ...
    def testPolicyDefaultActionBgpStandardCommunityOperation(self):
        """Test PolicyDefaultActionBgpStandardCommunityOperation"""
