...
class TestNetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress:
        """Test NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress`
        """
        model = NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress()
        if include_optional:
            return NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress(
                type = 'Property',
                value = '62:EC:B0:20:84:29',
    ...
    def testNetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress(self):
        """Test NetworkInstanceRouteTableNextHopInterfaceWithMacMacAddress"""
