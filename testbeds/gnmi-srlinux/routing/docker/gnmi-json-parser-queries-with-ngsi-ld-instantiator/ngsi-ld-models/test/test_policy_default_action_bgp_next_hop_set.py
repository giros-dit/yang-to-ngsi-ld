...
class TestPolicyDefaultActionBgpNextHopSet(unittest.TestCase):
    """PolicyDefaultActionBgpNextHopSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpNextHopSet:
        """Test PolicyDefaultActionBgpNextHopSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpNextHopSet`
        """
        model = PolicyDefaultActionBgpNextHopSet()
        if include_optional:
            return PolicyDefaultActionBgpNextHopSet(
                type = 'Property',
                value = '',
    ...
    def testPolicyDefaultActionBgpNextHopSet(self):
        """Test PolicyDefaultActionBgpNextHopSet"""
