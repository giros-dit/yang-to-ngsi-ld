...
class TestNetworkInstanceRouteTableNextHopCountersOctetsForwarded(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopCountersOctetsForwarded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopCountersOctetsForwarded:
        """Test NetworkInstanceRouteTableNextHopCountersOctetsForwarded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopCountersOctetsForwarded`
        """
        model = NetworkInstanceRouteTableNextHopCountersOctetsForwarded()
        if include_optional:
            return NetworkInstanceRouteTableNextHopCountersOctetsForwarded(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopCountersOctetsForwarded(self):
        """Test NetworkInstanceRouteTableNextHopCountersOctetsForwarded"""
