...
class TestNetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit:
        """Test NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit`
        """
        model = NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit(self):
        """Test NetworkInstanceProtocolsOspfInstanceOverloadRtrAdvLsaLimit"""
