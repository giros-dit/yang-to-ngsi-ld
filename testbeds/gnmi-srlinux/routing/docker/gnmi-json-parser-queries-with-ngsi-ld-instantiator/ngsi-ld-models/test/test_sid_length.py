...
class TestSidLength(unittest.TestCase):
    """SidLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SidLength:
        """Test SidLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SidLength`
        """
        model = SidLength()
        if include_optional:
            return SidLength(
