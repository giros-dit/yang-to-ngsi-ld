...
class TestControlPower(unittest.TestCase):
    """ControlPower unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlPower:
        """Test ControlPower
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlPower`
        """
        model = ControlPower()
        if include_optional:
            return ControlPower(
