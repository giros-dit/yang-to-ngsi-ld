...
class TestNetworkInstanceProtocolsOspfInstanceAreaNssaSummaries(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries:
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaNssaSummaries(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaSummaries"""
