...
class TestControlSoftwareVersion(unittest.TestCase):
    """ControlSoftwareVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlSoftwareVersion:
        """Test ControlSoftwareVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlSoftwareVersion`
        """
        model = ControlSoftwareVersion()
        if include_optional:
            return ControlSoftwareVersion(
                type = 'Property',
                value = '',
    ...
    def testControlSoftwareVersion(self):
        """Test ControlSoftwareVersion"""
