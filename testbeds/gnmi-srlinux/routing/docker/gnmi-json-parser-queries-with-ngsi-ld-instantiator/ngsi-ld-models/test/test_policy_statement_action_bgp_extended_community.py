...
class TestPolicyStatementActionBgpExtendedCommunity(unittest.TestCase):
    """PolicyStatementActionBgpExtendedCommunity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpExtendedCommunity:
        """Test PolicyStatementActionBgpExtendedCommunity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpExtendedCommunity`
        """
        model = PolicyStatementActionBgpExtendedCommunity()
        if include_optional:
            return PolicyStatementActionBgpExtendedCommunity(
                id = '',
                type = 'PolicyStatementActionBgpExtendedCommunity',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpExtendedCommunity(self):
        """Test PolicyStatementActionBgpExtendedCommunity"""
