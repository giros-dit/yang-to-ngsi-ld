...
class TestSystemSrv6MicroSegmentBlockPrefix(unittest.TestCase):
    """SystemSrv6MicroSegmentBlockPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6MicroSegmentBlockPrefix:
        """Test SystemSrv6MicroSegmentBlockPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6MicroSegmentBlockPrefix`
        """
        model = SystemSrv6MicroSegmentBlockPrefix()
        if include_optional:
            return SystemSrv6MicroSegmentBlockPrefix(
                id = '',
                type = 'SystemSrv6MicroSegmentBlockPrefix',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6MicroSegmentBlockPrefix(self):
        """Test SystemSrv6MicroSegmentBlockPrefix"""
