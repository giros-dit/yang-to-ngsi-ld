...
class TestNetworkInstanceStaticRoutesRouteTagSet(unittest.TestCase):
    """NetworkInstanceStaticRoutesRouteTagSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesRouteTagSet:
        """Test NetworkInstanceStaticRoutesRouteTagSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesRouteTagSet`
        """
        model = NetworkInstanceStaticRoutesRouteTagSet()
        if include_optional:
            return NetworkInstanceStaticRoutesRouteTagSet(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceStaticRoutesRouteTagSet(self):
        """Test NetworkInstanceStaticRoutesRouteTagSet"""
