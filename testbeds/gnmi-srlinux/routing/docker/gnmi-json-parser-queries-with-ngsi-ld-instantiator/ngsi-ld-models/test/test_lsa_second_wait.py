...
class TestLsaSecondWait(unittest.TestCase):
    """LsaSecondWait unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LsaSecondWait:
        """Test LsaSecondWait
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LsaSecondWait`
        """
        model = LsaSecondWait()
        if include_optional:
            return LsaSecondWait(
                type = 'Property',
                value = 10,
