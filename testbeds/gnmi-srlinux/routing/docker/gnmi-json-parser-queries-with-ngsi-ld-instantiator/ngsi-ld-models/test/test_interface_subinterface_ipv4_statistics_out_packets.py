...
class TestInterfaceSubinterfaceIpv4StatisticsOutPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsOutPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsOutPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsOutPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsOutPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsOutPackets"""
