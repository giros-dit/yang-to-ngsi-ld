...
class TestLinecardLastBootedReason(unittest.TestCase):
    """LinecardLastBootedReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardLastBootedReason:
        """Test LinecardLastBootedReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardLastBootedReason`
        """
        model = LinecardLastBootedReason()
        if include_optional:
            return LinecardLastBootedReason(
                type = 'Property',
                value = '',
    ...
    def testLinecardLastBootedReason(self):
        """Test LinecardLastBootedReason"""
