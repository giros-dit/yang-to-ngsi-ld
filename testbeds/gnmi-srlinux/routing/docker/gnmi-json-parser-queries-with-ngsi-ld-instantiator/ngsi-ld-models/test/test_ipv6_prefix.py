...
class TestIpv6Prefix(unittest.TestCase):
    """Ipv6Prefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Ipv6Prefix:
        """Test Ipv6Prefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ipv6Prefix`
        """
        model = Ipv6Prefix()
        if include_optional:
            return Ipv6Prefix(
