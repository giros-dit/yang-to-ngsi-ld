...
class TestNetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface:
        """Test NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface"""
