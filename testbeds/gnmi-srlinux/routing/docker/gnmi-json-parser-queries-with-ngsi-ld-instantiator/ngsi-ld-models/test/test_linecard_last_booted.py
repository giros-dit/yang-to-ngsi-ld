...
class TestLinecardLastBooted(unittest.TestCase):
    """LinecardLastBooted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardLastBooted:
        """Test LinecardLastBooted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardLastBooted`
        """
        model = LinecardLastBooted()
        if include_optional:
            return LinecardLastBooted(
                type = 'Property',
                value = '',
    ...
    def testLinecardLastBooted(self):
        """Test LinecardLastBooted"""
