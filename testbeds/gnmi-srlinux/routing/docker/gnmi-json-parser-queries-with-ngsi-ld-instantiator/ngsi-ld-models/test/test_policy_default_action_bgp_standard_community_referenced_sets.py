...
class TestPolicyDefaultActionBgpStandardCommunityReferencedSets(unittest.TestCase):
    """PolicyDefaultActionBgpStandardCommunityReferencedSets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpStandardCommunityReferencedSets:
        """Test PolicyDefaultActionBgpStandardCommunityReferencedSets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpStandardCommunityReferencedSets`
        """
        model = PolicyDefaultActionBgpStandardCommunityReferencedSets()
        if include_optional:
            return PolicyDefaultActionBgpStandardCommunityReferencedSets(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyDefaultActionBgpStandardCommunityReferencedSets(self):
        """Test PolicyDefaultActionBgpStandardCommunityReferencedSets"""
