...
class TestInterfaceSubinterfaceIpv6Statistics(unittest.TestCase):
    """InterfaceSubinterfaceIpv6Statistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6Statistics:
        """Test InterfaceSubinterfaceIpv6Statistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6Statistics`
        """
        model = InterfaceSubinterfaceIpv6Statistics()
        if include_optional:
            return InterfaceSubinterfaceIpv6Statistics(
                id = '',
                type = 'InterfaceSubinterfaceIpv6Statistics',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfaceIpv6Statistics(self):
        """Test InterfaceSubinterfaceIpv6Statistics"""
