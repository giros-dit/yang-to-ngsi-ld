...
class TestPolicyDefaultActionBgpDisableIpRouteInstall(unittest.TestCase):
    """PolicyDefaultActionBgpDisableIpRouteInstall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpDisableIpRouteInstall:
        """Test PolicyDefaultActionBgpDisableIpRouteInstall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpDisableIpRouteInstall`
        """
        model = PolicyDefaultActionBgpDisableIpRouteInstall()
        if include_optional:
            return PolicyDefaultActionBgpDisableIpRouteInstall(
                type = 'Property',
                value = True,
    ...
    def testPolicyDefaultActionBgpDisableIpRouteInstall(self):
        """Test PolicyDefaultActionBgpDisableIpRouteInstall"""
