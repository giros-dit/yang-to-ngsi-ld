...
class TestInterfaceBreakoutMode(unittest.TestCase):
    """InterfaceBreakoutMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceBreakoutMode:
        """Test InterfaceBreakoutMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceBreakoutMode`
        """
        model = InterfaceBreakoutMode()
        if include_optional:
            return InterfaceBreakoutMode(
                id = '',
                type = 'InterfaceBreakoutMode',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                num_breakout_ports = None,
                breakout_port_speed = None,
                is_part_of = None
            )
        else:
            return InterfaceBreakoutMode(
    ...
    def testInterfaceBreakoutMode(self):
        """Test InterfaceBreakoutMode"""
