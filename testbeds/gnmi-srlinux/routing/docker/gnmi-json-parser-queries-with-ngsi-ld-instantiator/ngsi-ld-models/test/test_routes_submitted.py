...
class TestRoutesSubmitted(unittest.TestCase):
    """RoutesSubmitted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RoutesSubmitted:
        """Test RoutesSubmitted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RoutesSubmitted`
        """
        model = RoutesSubmitted()
        if include_optional:
