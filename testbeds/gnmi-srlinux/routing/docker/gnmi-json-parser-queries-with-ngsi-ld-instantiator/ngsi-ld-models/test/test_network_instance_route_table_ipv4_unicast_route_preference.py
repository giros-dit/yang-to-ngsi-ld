...
class TestNetworkInstanceRouteTableIpv4UnicastRoutePreference(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRoutePreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRoutePreference:
        """Test NetworkInstanceRouteTableIpv4UnicastRoutePreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRoutePreference`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRoutePreference()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRoutePreference(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRoutePreference(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRoutePreference"""
