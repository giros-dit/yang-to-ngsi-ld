...
class TestNeighborRouterId(unittest.TestCase):
    """NeighborRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NeighborRouterId:
        """Test NeighborRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NeighborRouterId`
        """
        model = NeighborRouterId()
        if include_optional:
