...
class TestForwardingViable(unittest.TestCase):
    """ForwardingViable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForwardingViable:
        """Test ForwardingViable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForwardingViable`
        """
        model = ForwardingViable()
        if include_optional:
