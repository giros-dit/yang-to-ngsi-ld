...
class TestLinecardTemperatureMaximumTime(unittest.TestCase):
    """LinecardTemperatureMaximumTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardTemperatureMaximumTime:
        """Test LinecardTemperatureMaximumTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardTemperatureMaximumTime`
        """
        model = LinecardTemperatureMaximumTime()
        if include_optional:
            return LinecardTemperatureMaximumTime(
                type = 'Property',
                value = '',
    ...
    def testLinecardTemperatureMaximumTime(self):
        """Test LinecardTemperatureMaximumTime"""
