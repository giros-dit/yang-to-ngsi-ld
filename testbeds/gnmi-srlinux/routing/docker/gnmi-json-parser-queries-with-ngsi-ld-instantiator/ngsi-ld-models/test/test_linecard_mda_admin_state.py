...
class TestLinecardMdaAdminState(unittest.TestCase):
    """LinecardMdaAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaAdminState:
        """Test LinecardMdaAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaAdminState`
        """
        model = LinecardMdaAdminState()
        if include_optional:
            return LinecardMdaAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testLinecardMdaAdminState(self):
        """Test LinecardMdaAdminState"""
