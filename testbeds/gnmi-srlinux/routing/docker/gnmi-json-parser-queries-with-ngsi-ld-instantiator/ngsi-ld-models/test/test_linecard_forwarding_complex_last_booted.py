...
class TestLinecardForwardingComplexLastBooted(unittest.TestCase):
    """LinecardForwardingComplexLastBooted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexLastBooted:
        """Test LinecardForwardingComplexLastBooted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexLastBooted`
        """
        model = LinecardForwardingComplexLastBooted()
        if include_optional:
            return LinecardForwardingComplexLastBooted(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexLastBooted(self):
        """Test LinecardForwardingComplexLastBooted"""
