...
class TestSystemLldpLldpMedNetworkPolicyVlanId(unittest.TestCase):
    """SystemLldpLldpMedNetworkPolicyVlanId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpLldpMedNetworkPolicyVlanId:
        """Test SystemLldpLldpMedNetworkPolicyVlanId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpLldpMedNetworkPolicyVlanId`
        """
        model = SystemLldpLldpMedNetworkPolicyVlanId()
        if include_optional:
            return SystemLldpLldpMedNetworkPolicyVlanId(
                type = 'Property',
                value = 'untagged',
    ...
    def testSystemLldpLldpMedNetworkPolicyVlanId(self):
        """Test SystemLldpLldpMedNetworkPolicyVlanId"""
