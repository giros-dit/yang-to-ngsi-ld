...
class TestLinecardMdaLocatorState(unittest.TestCase):
    """LinecardMdaLocatorState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaLocatorState:
        """Test LinecardMdaLocatorState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaLocatorState`
        """
        model = LinecardMdaLocatorState()
        if include_optional:
            return LinecardMdaLocatorState(
                type = 'Property',
                value = 'inactive',
    ...
    def testLinecardMdaLocatorState(self):
        """Test LinecardMdaLocatorState"""
