...
class TestSystemLldpChassisIdType(unittest.TestCase):
    """SystemLldpChassisIdType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpChassisIdType:
        """Test SystemLldpChassisIdType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpChassisIdType`
        """
        model = SystemLldpChassisIdType()
        if include_optional:
            return SystemLldpChassisIdType(
                type = 'Property',
                value = 'MAC_ADDRESS',
    ...
    def testSystemLldpChassisIdType(self):
        """Test SystemLldpChassisIdType"""
