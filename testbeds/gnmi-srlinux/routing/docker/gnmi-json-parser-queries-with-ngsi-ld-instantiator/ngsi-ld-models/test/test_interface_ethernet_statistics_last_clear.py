...
class TestInterfaceEthernetStatisticsLastClear(unittest.TestCase):
    """InterfaceEthernetStatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetStatisticsLastClear:
        """Test InterfaceEthernetStatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetStatisticsLastClear`
        """
        model = InterfaceEthernetStatisticsLastClear()
        if include_optional:
            return InterfaceEthernetStatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testInterfaceEthernetStatisticsLastClear(self):
        """Test InterfaceEthernetStatisticsLastClear"""
