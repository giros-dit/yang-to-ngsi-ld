...
class TestAsPathSetName(unittest.TestCase):
    """AsPathSetName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsPathSetName:
        """Test AsPathSetName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsPathSetName`
        """
        model = AsPathSetName()
        if include_optional:
            return AsPathSetName(
                type = 'Property',
                value = '',
