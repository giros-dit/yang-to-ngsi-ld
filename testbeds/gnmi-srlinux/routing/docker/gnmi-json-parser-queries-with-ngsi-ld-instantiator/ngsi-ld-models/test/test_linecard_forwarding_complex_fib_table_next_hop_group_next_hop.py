...
class TestLinecardForwardingComplexFibTableNextHopGroupNextHop(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroupNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroupNextHop:
        """Test LinecardForwardingComplexFibTableNextHopGroupNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroupNextHop`
        """
        model = LinecardForwardingComplexFibTableNextHopGroupNextHop()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroupNextHop(
                id = None,
                type = 'LinecardForwardingComplexFibTableNextHopGroupNextHop',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexFibTableNextHopGroupNextHop(self):
        """Test LinecardForwardingComplexFibTableNextHopGroupNextHop"""
