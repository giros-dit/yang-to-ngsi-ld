...
class TestControlInterfaceName(unittest.TestCase):
    """ControlInterfaceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlInterfaceName:
        """Test ControlInterfaceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlInterfaceName`
        """
        model = ControlInterfaceName()
        if include_optional:
            return ControlInterfaceName(
                type = 'Property',
                value = '',
    ...
    def testControlInterfaceName(self):
        """Test ControlInterfaceName"""
