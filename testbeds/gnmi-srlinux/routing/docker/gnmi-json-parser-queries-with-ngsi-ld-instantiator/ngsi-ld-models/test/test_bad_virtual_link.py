...
class TestBadVirtualLink(unittest.TestCase):
    """BadVirtualLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadVirtualLink:
        """Test BadVirtualLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadVirtualLink`
        """
        model = BadVirtualLink()
        if include_optional:
            return BadVirtualLink(
                type = 'Property',
                value = 56,
