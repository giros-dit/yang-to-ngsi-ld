...
class TestInterfaceSubinterfaceIpv4AddressStatus(unittest.TestCase):
    """InterfaceSubinterfaceIpv4AddressStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4AddressStatus:
        """Test InterfaceSubinterfaceIpv4AddressStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4AddressStatus`
        """
        model = InterfaceSubinterfaceIpv4AddressStatus()
        if include_optional:
            return InterfaceSubinterfaceIpv4AddressStatus(
                type = 'Property',
                value = 'preferred',
    ...
    def testInterfaceSubinterfaceIpv4AddressStatus(self):
        """Test InterfaceSubinterfaceIpv4AddressStatus"""
