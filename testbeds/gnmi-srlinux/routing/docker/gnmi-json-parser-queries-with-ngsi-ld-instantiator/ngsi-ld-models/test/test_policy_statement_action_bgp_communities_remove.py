...
class TestPolicyStatementActionBgpCommunitiesRemove(unittest.TestCase):
    """PolicyStatementActionBgpCommunitiesRemove unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpCommunitiesRemove:
        """Test PolicyStatementActionBgpCommunitiesRemove
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpCommunitiesRemove`
        """
        model = PolicyStatementActionBgpCommunitiesRemove()
        if include_optional:
            return PolicyStatementActionBgpCommunitiesRemove(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementActionBgpCommunitiesRemove(self):
        """Test PolicyStatementActionBgpCommunitiesRemove"""
