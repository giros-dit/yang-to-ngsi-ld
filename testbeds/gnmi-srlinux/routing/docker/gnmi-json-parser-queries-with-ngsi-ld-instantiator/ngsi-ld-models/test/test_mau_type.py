...
class TestMauType(unittest.TestCase):
    """MauType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MauType:
        """Test MauType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MauType`
        """
        model = MauType()
        if include_optional:
            return MauType(
