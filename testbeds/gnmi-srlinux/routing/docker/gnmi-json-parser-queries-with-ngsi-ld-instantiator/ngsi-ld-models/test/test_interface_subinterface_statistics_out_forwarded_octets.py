...
class TestInterfaceSubinterfaceStatisticsOutForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsOutForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsOutForwardedOctets:
        """Test InterfaceSubinterfaceStatisticsOutForwardedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsOutForwardedOctets`
        """
        model = InterfaceSubinterfaceStatisticsOutForwardedOctets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsOutForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsOutForwardedOctets(self):
        """Test InterfaceSubinterfaceStatisticsOutForwardedOctets"""
