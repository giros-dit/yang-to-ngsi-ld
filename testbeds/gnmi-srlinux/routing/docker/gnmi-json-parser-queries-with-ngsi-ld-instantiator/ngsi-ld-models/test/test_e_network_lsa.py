...
class TestENetworkLsa(unittest.TestCase):
    """ENetworkLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ENetworkLsa:
        """Test ENetworkLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ENetworkLsa`
        """
        model = ENetworkLsa()
        if include_optional:
            return ENetworkLsa(
