...
class TestControlTemperatureAlarmStatus(unittest.TestCase):
    """ControlTemperatureAlarmStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlTemperatureAlarmStatus:
        """Test ControlTemperatureAlarmStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlTemperatureAlarmStatus`
        """
        model = ControlTemperatureAlarmStatus()
        if include_optional:
            return ControlTemperatureAlarmStatus(
                type = 'Property',
                value = True,
    ...
    def testControlTemperatureAlarmStatus(self):
        """Test ControlTemperatureAlarmStatus"""
