...
class TestNetworkInstanceConnectionPointRedundancy(unittest.TestCase):
    """NetworkInstanceConnectionPointRedundancy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointRedundancy:
        """Test NetworkInstanceConnectionPointRedundancy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointRedundancy`
        """
        model = NetworkInstanceConnectionPointRedundancy()
        if include_optional:
            return NetworkInstanceConnectionPointRedundancy(
                id = '',
                type = 'NetworkInstanceConnectionPointRedundancy',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceConnectionPointRedundancy(self):
        """Test NetworkInstanceConnectionPointRedundancy"""
