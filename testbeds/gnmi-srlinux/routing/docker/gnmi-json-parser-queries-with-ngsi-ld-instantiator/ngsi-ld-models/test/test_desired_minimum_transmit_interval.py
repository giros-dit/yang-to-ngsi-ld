...
class TestDesiredMinimumTransmitInterval(unittest.TestCase):
    """DesiredMinimumTransmitInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesiredMinimumTransmitInterval:
        """Test DesiredMinimumTransmitInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DesiredMinimumTransmitInterval`
        """
        model = DesiredMinimumTransmitInterval()
        if include_optional:
            return DesiredMinimumTransmitInterval(
                type = 'Property',
                value = 10000,
    ...
    def testDesiredMinimumTransmitInterval(self):
        """Test DesiredMinimumTransmitInterval"""
