...
class TestInterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets"""
