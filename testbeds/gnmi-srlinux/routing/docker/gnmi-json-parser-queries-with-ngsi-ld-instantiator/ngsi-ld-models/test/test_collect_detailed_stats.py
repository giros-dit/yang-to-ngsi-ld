...
class TestCollectDetailedStats(unittest.TestCase):
    """CollectDetailedStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectDetailedStats:
        """Test CollectDetailedStats
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectDetailedStats`
        """
        model = CollectDetailedStats()
        if include_optional:
    ...
    def testCollectDetailedStats(self):
        """Test CollectDetailedStats"""
