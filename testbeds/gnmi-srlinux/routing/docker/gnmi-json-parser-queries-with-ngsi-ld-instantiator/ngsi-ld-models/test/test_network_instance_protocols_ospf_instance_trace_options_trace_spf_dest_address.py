...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceSpfDestAddress"""
