...
class TestSoftwareRevision(unittest.TestCase):
    """SoftwareRevision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SoftwareRevision:
        """Test SoftwareRevision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SoftwareRevision`
        """
        model = SoftwareRevision()
        if include_optional:
