...
class TestBadPacketType(unittest.TestCase):
    """BadPacketType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadPacketType:
        """Test BadPacketType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadPacketType`
        """
        model = BadPacketType()
        if include_optional:
