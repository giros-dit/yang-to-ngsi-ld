...
class TestUnknownUnicastRate(unittest.TestCase):
    """UnknownUnicastRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnknownUnicastRate:
        """Test UnknownUnicastRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnknownUnicastRate`
        """
        model = UnknownUnicastRate()
        if include_optional:
            return UnknownUnicastRate(
                type = 'Property',
                value = 0,
    ...
    def testUnknownUnicastRate(self):
        """Test UnknownUnicastRate"""
