...
class TestGenerateIcmp(unittest.TestCase):
    """GenerateIcmp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GenerateIcmp:
        """Test GenerateIcmp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GenerateIcmp`
        """
        model = GenerateIcmp()
        if include_optional:
            return GenerateIcmp(
