...
class TestInterfaceSubinterfaceIpv6(unittest.TestCase):
    """InterfaceSubinterfaceIpv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6:
        """Test InterfaceSubinterfaceIpv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6`
        """
        model = InterfaceSubinterfaceIpv6()
        if include_optional:
            return InterfaceSubinterfaceIpv6(
                id = '',
    ...
    def testInterfaceSubinterfaceIpv6(self):
        """Test InterfaceSubinterfaceIpv6"""
