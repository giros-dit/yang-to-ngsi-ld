...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutes"""
