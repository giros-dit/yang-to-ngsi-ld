...
class TestPolicyStatementActionBgpNextHopResolutionSetTagSet(unittest.TestCase):
    """PolicyStatementActionBgpNextHopResolutionSetTagSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpNextHopResolutionSetTagSet:
        """Test PolicyStatementActionBgpNextHopResolutionSetTagSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpNextHopResolutionSetTagSet`
        """
        model = PolicyStatementActionBgpNextHopResolutionSetTagSet()
        if include_optional:
            return PolicyStatementActionBgpNextHopResolutionSetTagSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementActionBgpNextHopResolutionSetTagSet(self):
        """Test PolicyStatementActionBgpNextHopResolutionSetTagSet"""
