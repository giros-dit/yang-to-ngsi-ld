...
class TestSystemLldpBgpAutoDiscoveryNetworkInstance(unittest.TestCase):
    """SystemLldpBgpAutoDiscoveryNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpBgpAutoDiscoveryNetworkInstance:
        """Test SystemLldpBgpAutoDiscoveryNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpBgpAutoDiscoveryNetworkInstance`
        """
        model = SystemLldpBgpAutoDiscoveryNetworkInstance()
        if include_optional:
            return SystemLldpBgpAutoDiscoveryNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testSystemLldpBgpAutoDiscoveryNetworkInstance(self):
        """Test SystemLldpBgpAutoDiscoveryNetworkInstance"""
