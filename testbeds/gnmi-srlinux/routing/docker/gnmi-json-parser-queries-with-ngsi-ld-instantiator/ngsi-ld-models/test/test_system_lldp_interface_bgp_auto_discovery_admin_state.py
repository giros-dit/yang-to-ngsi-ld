...
class TestSystemLldpInterfaceBgpAutoDiscoveryAdminState(unittest.TestCase):
    """SystemLldpInterfaceBgpAutoDiscoveryAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceBgpAutoDiscoveryAdminState:
        """Test SystemLldpInterfaceBgpAutoDiscoveryAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceBgpAutoDiscoveryAdminState`
        """
        model = SystemLldpInterfaceBgpAutoDiscoveryAdminState()
        if include_optional:
            return SystemLldpInterfaceBgpAutoDiscoveryAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testSystemLldpInterfaceBgpAutoDiscoveryAdminState(self):
        """Test SystemLldpInterfaceBgpAutoDiscoveryAdminState"""
