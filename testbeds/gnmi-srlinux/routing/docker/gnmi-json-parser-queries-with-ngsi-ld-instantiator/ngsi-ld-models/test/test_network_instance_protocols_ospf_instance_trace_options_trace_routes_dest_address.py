...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceRoutesDestAddress"""
