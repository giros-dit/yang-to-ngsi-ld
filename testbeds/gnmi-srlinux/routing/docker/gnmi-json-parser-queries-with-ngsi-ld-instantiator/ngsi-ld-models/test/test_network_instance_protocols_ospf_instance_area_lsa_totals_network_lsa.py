...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaTotalsNetworkLsa"""
