...
class TestNumRestarts(unittest.TestCase):
    """NumRestarts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumRestarts:
        """Test NumRestarts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumRestarts`
        """
        model = NumRestarts()
        if include_optional:
            return NumRestarts(
