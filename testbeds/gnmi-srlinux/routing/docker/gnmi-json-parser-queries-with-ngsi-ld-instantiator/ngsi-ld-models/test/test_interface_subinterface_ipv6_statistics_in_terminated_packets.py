...
class TestInterfaceSubinterfaceIpv6StatisticsInTerminatedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInTerminatedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInTerminatedPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsInTerminatedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInTerminatedPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInTerminatedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInTerminatedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInTerminatedPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInTerminatedPackets"""
