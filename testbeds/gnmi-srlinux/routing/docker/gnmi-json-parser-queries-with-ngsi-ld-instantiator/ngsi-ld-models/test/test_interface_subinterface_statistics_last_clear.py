...
class TestInterfaceSubinterfaceStatisticsLastClear(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsLastClear:
        """Test InterfaceSubinterfaceStatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsLastClear`
        """
        model = InterfaceSubinterfaceStatisticsLastClear()
        if include_optional:
            return InterfaceSubinterfaceStatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceStatisticsLastClear(self):
        """Test InterfaceSubinterfaceStatisticsLastClear"""
