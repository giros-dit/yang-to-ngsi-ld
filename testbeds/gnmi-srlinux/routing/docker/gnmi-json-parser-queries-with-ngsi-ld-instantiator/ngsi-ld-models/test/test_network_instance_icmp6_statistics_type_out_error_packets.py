...
class TestNetworkInstanceIcmp6StatisticsTypeOutErrorPackets(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTypeOutErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTypeOutErrorPackets:
        """Test NetworkInstanceIcmp6StatisticsTypeOutErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTypeOutErrorPackets`
        """
        model = NetworkInstanceIcmp6StatisticsTypeOutErrorPackets()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTypeOutErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmp6StatisticsTypeOutErrorPackets(self):
        """Test NetworkInstanceIcmp6StatisticsTypeOutErrorPackets"""
