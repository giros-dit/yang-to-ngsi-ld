...
class TestInterfaceSubinterfaceIpv6StatisticsInDiscardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInDiscardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInDiscardedPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsInDiscardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInDiscardedPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInDiscardedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInDiscardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInDiscardedPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInDiscardedPackets"""
