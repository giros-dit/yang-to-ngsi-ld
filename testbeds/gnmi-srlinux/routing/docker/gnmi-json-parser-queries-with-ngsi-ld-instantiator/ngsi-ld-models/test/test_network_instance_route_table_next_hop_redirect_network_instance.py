...
class TestNetworkInstanceRouteTableNextHopRedirectNetworkInstance(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopRedirectNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopRedirectNetworkInstance:
        """Test NetworkInstanceRouteTableNextHopRedirectNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopRedirectNetworkInstance`
        """
        model = NetworkInstanceRouteTableNextHopRedirectNetworkInstance()
        if include_optional:
            return NetworkInstanceRouteTableNextHopRedirectNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopRedirectNetworkInstance(self):
        """Test NetworkInstanceRouteTableNextHopRedirectNetworkInstance"""
