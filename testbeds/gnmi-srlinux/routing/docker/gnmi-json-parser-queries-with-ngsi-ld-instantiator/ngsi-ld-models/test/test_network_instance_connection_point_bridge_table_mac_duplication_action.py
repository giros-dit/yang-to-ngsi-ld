...
class TestNetworkInstanceConnectionPointBridgeTableMacDuplicationAction(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacDuplicationAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacDuplicationAction:
        """Test NetworkInstanceConnectionPointBridgeTableMacDuplicationAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacDuplicationAction`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacDuplicationAction()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacDuplicationAction(
                type = 'Property',
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacDuplicationAction(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacDuplicationAction"""
