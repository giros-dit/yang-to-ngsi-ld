...
class TestLsaInstallFailed(unittest.TestCase):
    """LsaInstallFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LsaInstallFailed:
        """Test LsaInstallFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LsaInstallFailed`
        """
        model = LsaInstallFailed()
        if include_optional:
            return LsaInstallFailed(
                type = 'Property',
                value = 56,
