...
class TestNetworkInstanceBridgeTableSplitHorizonGroupName(unittest.TestCase):
    """NetworkInstanceBridgeTableSplitHorizonGroupName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableSplitHorizonGroupName:
        """Test NetworkInstanceBridgeTableSplitHorizonGroupName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableSplitHorizonGroupName`
        """
        model = NetworkInstanceBridgeTableSplitHorizonGroupName()
        if include_optional:
            return NetworkInstanceBridgeTableSplitHorizonGroupName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceBridgeTableSplitHorizonGroupName(self):
        """Test NetworkInstanceBridgeTableSplitHorizonGroupName"""
