...
class TestNetworkInstanceConnectionPointPseudowireSignalingSignalingTldp(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp:
        """Test NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp`
        """
        model = NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp(
                id = '',
                type = 'NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                virtual_circuit_type = None,
                advertise_l2_mtu = None,
                ignore_mtu_mismatch = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp(
    ...
    def testNetworkInstanceConnectionPointPseudowireSignalingSignalingTldp(self):
        """Test NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp"""
