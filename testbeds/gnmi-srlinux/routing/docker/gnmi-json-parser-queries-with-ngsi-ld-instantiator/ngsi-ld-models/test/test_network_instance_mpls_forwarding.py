...
class TestNetworkInstanceMplsForwarding(unittest.TestCase):
    """NetworkInstanceMplsForwarding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceMplsForwarding:
        """Test NetworkInstanceMplsForwarding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceMplsForwarding`
        """
        model = NetworkInstanceMplsForwarding()
        if include_optional:
            return NetworkInstanceMplsForwarding(
                id = '',
                type = 'NetworkInstanceMplsForwarding',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceMplsForwarding(self):
        """Test NetworkInstanceMplsForwarding"""
