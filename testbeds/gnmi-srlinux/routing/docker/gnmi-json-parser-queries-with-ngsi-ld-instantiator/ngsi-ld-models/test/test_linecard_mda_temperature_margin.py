...
class TestLinecardMdaTemperatureMargin(unittest.TestCase):
    """LinecardMdaTemperatureMargin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaTemperatureMargin:
        """Test LinecardMdaTemperatureMargin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaTemperatureMargin`
        """
        model = LinecardMdaTemperatureMargin()
        if include_optional:
            return LinecardMdaTemperatureMargin(
                type = 'Property',
                value = 56,
    ...
    def testLinecardMdaTemperatureMargin(self):
        """Test LinecardMdaTemperatureMargin"""
