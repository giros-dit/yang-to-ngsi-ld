...
class TestUtilizationIngress(unittest.TestCase):
    """UtilizationIngress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtilizationIngress:
        """Test UtilizationIngress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtilizationIngress`
        """
        model = UtilizationIngress()
        if include_optional:
            return UtilizationIngress(
                type = 'Property',
                value = 56,
    ...
    def testUtilizationIngress(self):
        """Test UtilizationIngress"""
