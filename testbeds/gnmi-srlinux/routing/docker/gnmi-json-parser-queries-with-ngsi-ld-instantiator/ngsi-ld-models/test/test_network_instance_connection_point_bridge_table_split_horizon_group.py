...
class TestNetworkInstanceConnectionPointBridgeTableSplitHorizonGroup(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup:
        """Test NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup`
        """
        model = NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceConnectionPointBridgeTableSplitHorizonGroup(self):
        """Test NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup"""
