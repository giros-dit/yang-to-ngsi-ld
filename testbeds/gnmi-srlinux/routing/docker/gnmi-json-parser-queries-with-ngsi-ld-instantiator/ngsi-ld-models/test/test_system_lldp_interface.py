...
class TestSystemLldpInterface(unittest.TestCase):
    """SystemLldpInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterface:
        """Test SystemLldpInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterface`
        """
        model = SystemLldpInterface()
        if include_optional:
            return SystemLldpInterface(
                id = '',
                type = 'SystemLldpInterface',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterface(self):
        """Test SystemLldpInterface"""
