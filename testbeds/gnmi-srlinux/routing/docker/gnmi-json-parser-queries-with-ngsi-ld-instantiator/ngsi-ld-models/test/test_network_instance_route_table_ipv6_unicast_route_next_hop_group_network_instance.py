...
class TestNetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroupNetworkInstance"""
