...
class TestNetworkInstanceSystemIpv6Address(unittest.TestCase):
    """NetworkInstanceSystemIpv6Address unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceSystemIpv6Address:
        """Test NetworkInstanceSystemIpv6Address
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceSystemIpv6Address`
        """
        model = NetworkInstanceSystemIpv6Address()
        if include_optional:
            return NetworkInstanceSystemIpv6Address(
                id = '',
                type = 'NetworkInstanceSystemIpv6Address',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceSystemIpv6Address(self):
        """Test NetworkInstanceSystemIpv6Address"""
