...
class TestNetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded"""
