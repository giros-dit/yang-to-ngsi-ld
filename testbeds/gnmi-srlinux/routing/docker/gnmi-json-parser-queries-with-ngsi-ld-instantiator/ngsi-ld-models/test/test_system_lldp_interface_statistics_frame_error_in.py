...
class TestSystemLldpInterfaceStatisticsFrameErrorIn(unittest.TestCase):
    """SystemLldpInterfaceStatisticsFrameErrorIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceStatisticsFrameErrorIn:
        """Test SystemLldpInterfaceStatisticsFrameErrorIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceStatisticsFrameErrorIn`
        """
        model = SystemLldpInterfaceStatisticsFrameErrorIn()
        if include_optional:
            return SystemLldpInterfaceStatisticsFrameErrorIn(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceStatisticsFrameErrorIn(self):
        """Test SystemLldpInterfaceStatisticsFrameErrorIn"""
