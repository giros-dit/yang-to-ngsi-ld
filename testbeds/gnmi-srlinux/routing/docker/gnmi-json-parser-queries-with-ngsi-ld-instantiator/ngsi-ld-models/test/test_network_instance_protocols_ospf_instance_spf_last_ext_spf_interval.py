...
class TestNetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval:
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval`
        """
        model = NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval(self):
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastExtSpfInterval"""
