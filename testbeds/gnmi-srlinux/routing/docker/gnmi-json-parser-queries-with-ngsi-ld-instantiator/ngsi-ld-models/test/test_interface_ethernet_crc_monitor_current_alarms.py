...
class TestInterfaceEthernetCrcMonitorCurrentAlarms(unittest.TestCase):
    """InterfaceEthernetCrcMonitorCurrentAlarms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitorCurrentAlarms:
        """Test InterfaceEthernetCrcMonitorCurrentAlarms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitorCurrentAlarms`
        """
        model = InterfaceEthernetCrcMonitorCurrentAlarms()
        if include_optional:
            return InterfaceEthernetCrcMonitorCurrentAlarms(
                type = 'Property',
                value = 'none',
    ...
    def testInterfaceEthernetCrcMonitorCurrentAlarms(self):
        """Test InterfaceEthernetCrcMonitorCurrentAlarms"""
