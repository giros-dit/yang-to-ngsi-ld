...
class TestPolicyDefaultActionPolicyResult(unittest.TestCase):
    """PolicyDefaultActionPolicyResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionPolicyResult:
        """Test PolicyDefaultActionPolicyResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionPolicyResult`
        """
        model = PolicyDefaultActionPolicyResult()
        if include_optional:
            return PolicyDefaultActionPolicyResult(
                type = 'Property',
                value = 'accept',
    ...
    def testPolicyDefaultActionPolicyResult(self):
        """Test PolicyDefaultActionPolicyResult"""
