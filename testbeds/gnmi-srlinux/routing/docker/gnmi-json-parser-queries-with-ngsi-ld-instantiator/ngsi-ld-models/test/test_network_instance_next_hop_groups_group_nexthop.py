...
class TestNetworkInstanceNextHopGroupsGroupNexthop(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthop:
        """Test NetworkInstanceNextHopGroupsGroupNexthop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthop`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthop()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthop(
                id = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthop(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthop"""
