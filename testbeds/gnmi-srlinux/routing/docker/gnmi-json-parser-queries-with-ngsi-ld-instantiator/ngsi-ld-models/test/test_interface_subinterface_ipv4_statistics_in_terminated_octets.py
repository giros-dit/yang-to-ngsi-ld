...
class TestInterfaceSubinterfaceIpv4StatisticsInTerminatedOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets:
        """Test InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInTerminatedOctets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets"""
