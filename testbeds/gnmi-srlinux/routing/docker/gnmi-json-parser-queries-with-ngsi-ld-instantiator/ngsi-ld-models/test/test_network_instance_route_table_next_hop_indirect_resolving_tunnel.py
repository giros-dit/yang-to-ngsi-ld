...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingTunnel(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingTunnel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingTunnel:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingTunnel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingTunnel`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingTunnel()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingTunnel(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopIndirectResolvingTunnel',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingTunnel(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingTunnel"""
