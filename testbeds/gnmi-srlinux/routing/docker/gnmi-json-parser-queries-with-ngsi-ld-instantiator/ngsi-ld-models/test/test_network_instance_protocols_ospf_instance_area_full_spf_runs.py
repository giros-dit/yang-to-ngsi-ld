...
class TestNetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns:
        """Test NetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaFullSpfRuns"""
