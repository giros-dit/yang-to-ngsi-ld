...
class TestNetworkInstanceRouteTableNextHopSubinterface(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopSubinterface:
        """Test NetworkInstanceRouteTableNextHopSubinterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopSubinterface`
        """
        model = NetworkInstanceRouteTableNextHopSubinterface()
        if include_optional:
            return NetworkInstanceRouteTableNextHopSubinterface(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopSubinterface(self):
        """Test NetworkInstanceRouteTableNextHopSubinterface"""
