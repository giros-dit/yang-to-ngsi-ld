...
class TestPolicyStatementActionBgpAsPathPrependRepeatN(unittest.TestCase):
    """PolicyStatementActionBgpAsPathPrependRepeatN unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpAsPathPrependRepeatN:
        """Test PolicyStatementActionBgpAsPathPrependRepeatN
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpAsPathPrependRepeatN`
        """
        model = PolicyStatementActionBgpAsPathPrependRepeatN()
        if include_optional:
            return PolicyStatementActionBgpAsPathPrependRepeatN(
                type = 'Property',
                value = 1,
    ...
    def testPolicyStatementActionBgpAsPathPrependRepeatN(self):
        """Test PolicyStatementActionBgpAsPathPrependRepeatN"""
