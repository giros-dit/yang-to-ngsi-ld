...
class TestInterfaceEthernetCrcMonitorWindowSize(unittest.TestCase):
    """InterfaceEthernetCrcMonitorWindowSize unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitorWindowSize:
        """Test InterfaceEthernetCrcMonitorWindowSize
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitorWindowSize`
        """
        model = InterfaceEthernetCrcMonitorWindowSize()
        if include_optional:
            return InterfaceEthernetCrcMonitorWindowSize(
                type = 'Property',
                value = 5,
    ...
    def testInterfaceEthernetCrcMonitorWindowSize(self):
        """Test InterfaceEthernetCrcMonitorWindowSize"""
