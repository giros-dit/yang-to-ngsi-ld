...
class TestDisableIpTimestamping(unittest.TestCase):
    """DisableIpTimestamping unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DisableIpTimestamping:
        """Test DisableIpTimestamping
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DisableIpTimestamping`
        """
        model = DisableIpTimestamping()
        if include_optional:
            return DisableIpTimestamping(
                type = 'Property',
                value = True,
    ...
    def testDisableIpTimestamping(self):
        """Test DisableIpTimestamping"""
