...
class TestCommunitySetMember(unittest.TestCase):
    """CommunitySetMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunitySetMember:
        """Test CommunitySetMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunitySetMember`
        """
        model = CommunitySetMember()
        if include_optional:
            return CommunitySetMember(
                type = 'Property',
                value = '',
    ...
    def testCommunitySetMember(self):
        """Test CommunitySetMember"""
