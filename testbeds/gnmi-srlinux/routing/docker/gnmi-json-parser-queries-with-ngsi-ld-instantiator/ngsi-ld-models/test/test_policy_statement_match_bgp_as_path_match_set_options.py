...
class TestPolicyStatementMatchBgpAsPathMatchSetOptions(unittest.TestCase):
    """PolicyStatementMatchBgpAsPathMatchSetOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpAsPathMatchSetOptions:
        """Test PolicyStatementMatchBgpAsPathMatchSetOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpAsPathMatchSetOptions`
        """
        model = PolicyStatementMatchBgpAsPathMatchSetOptions()
        if include_optional:
            return PolicyStatementMatchBgpAsPathMatchSetOptions(
                type = 'Property',
                value = 'any',
    ...
    def testPolicyStatementMatchBgpAsPathMatchSetOptions(self):
        """Test PolicyStatementMatchBgpAsPathMatchSetOptions"""
