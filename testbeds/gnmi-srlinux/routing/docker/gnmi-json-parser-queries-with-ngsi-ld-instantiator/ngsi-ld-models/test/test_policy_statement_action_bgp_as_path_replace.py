...
class TestPolicyStatementActionBgpAsPathReplace(unittest.TestCase):
    """PolicyStatementActionBgpAsPathReplace unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpAsPathReplace:
        """Test PolicyStatementActionBgpAsPathReplace
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpAsPathReplace`
        """
        model = PolicyStatementActionBgpAsPathReplace()
        if include_optional:
            return PolicyStatementActionBgpAsPathReplace(
                type = 'Property',
                value = 56,
    ...
    def testPolicyStatementActionBgpAsPathReplace(self):
        """Test PolicyStatementActionBgpAsPathReplace"""
