...
class TestPolicyDefaultActionBgpExtendedCommunityReferencedSets(unittest.TestCase):
    """PolicyDefaultActionBgpExtendedCommunityReferencedSets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpExtendedCommunityReferencedSets:
        """Test PolicyDefaultActionBgpExtendedCommunityReferencedSets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpExtendedCommunityReferencedSets`
        """
        model = PolicyDefaultActionBgpExtendedCommunityReferencedSets()
        if include_optional:
            return PolicyDefaultActionBgpExtendedCommunityReferencedSets(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyDefaultActionBgpExtendedCommunityReferencedSets(self):
        """Test PolicyDefaultActionBgpExtendedCommunityReferencedSets"""
