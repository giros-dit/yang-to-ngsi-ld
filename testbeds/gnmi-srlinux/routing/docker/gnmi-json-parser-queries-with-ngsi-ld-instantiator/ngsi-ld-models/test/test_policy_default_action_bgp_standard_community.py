...
class TestPolicyDefaultActionBgpStandardCommunity(unittest.TestCase):
    """PolicyDefaultActionBgpStandardCommunity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpStandardCommunity:
        """Test PolicyDefaultActionBgpStandardCommunity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpStandardCommunity`
        """
        model = PolicyDefaultActionBgpStandardCommunity()
        if include_optional:
            return PolicyDefaultActionBgpStandardCommunity(
                id = '',
                type = 'PolicyDefaultActionBgpStandardCommunity',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpStandardCommunity(self):
        """Test PolicyDefaultActionBgpStandardCommunity"""
