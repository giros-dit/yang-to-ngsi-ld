...
class TestNetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded"""
