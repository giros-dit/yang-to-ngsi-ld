...
class TestMaxSuppressTime(unittest.TestCase):
    """MaxSuppressTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxSuppressTime:
        """Test MaxSuppressTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxSuppressTime`
        """
        model = MaxSuppressTime()
        if include_optional:
