...
class TestInterfaceSubinterfaceIpv6StatisticsOutErrorPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsOutErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsOutErrorPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsOutErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsOutErrorPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsOutErrorPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsOutErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsOutErrorPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsOutErrorPackets"""
