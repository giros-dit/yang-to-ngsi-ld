...
class TestControlLastBootedReason(unittest.TestCase):
    """ControlLastBootedReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlLastBootedReason:
        """Test ControlLastBootedReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlLastBootedReason`
        """
        model = ControlLastBootedReason()
        if include_optional:
            return ControlLastBootedReason(
                type = 'Property',
                value = '',
    ...
    def testControlLastBootedReason(self):
        """Test ControlLastBootedReason"""
