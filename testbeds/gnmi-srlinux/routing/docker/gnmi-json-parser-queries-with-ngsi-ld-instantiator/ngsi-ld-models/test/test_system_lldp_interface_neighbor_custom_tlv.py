...
class TestSystemLldpInterfaceNeighborCustomTlv(unittest.TestCase):
    """SystemLldpInterfaceNeighborCustomTlv unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborCustomTlv:
        """Test SystemLldpInterfaceNeighborCustomTlv
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborCustomTlv`
        """
        model = SystemLldpInterfaceNeighborCustomTlv()
        if include_optional:
            return SystemLldpInterfaceNeighborCustomTlv(
                id = '',
                type = 'SystemLldpInterfaceNeighborCustomTlv',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceNeighborCustomTlv(self):
        """Test SystemLldpInterfaceNeighborCustomTlv"""
