...
class TestPolicyStatementActionPolicyResult(unittest.TestCase):
    """PolicyStatementActionPolicyResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionPolicyResult:
        """Test PolicyStatementActionPolicyResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionPolicyResult`
        """
        model = PolicyStatementActionPolicyResult()
        if include_optional:
            return PolicyStatementActionPolicyResult(
                type = 'Property',
                value = 'accept',
    ...
    def testPolicyStatementActionPolicyResult(self):
        """Test PolicyStatementActionPolicyResult"""
