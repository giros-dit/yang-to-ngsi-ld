...
class TestLinecardForwardingComplexFibTableNextHopGroupNextHopOperState(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroupNextHopOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroupNextHopOperState:
        """Test LinecardForwardingComplexFibTableNextHopGroupNextHopOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroupNextHopOperState`
        """
        model = LinecardForwardingComplexFibTableNextHopGroupNextHopOperState()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroupNextHopOperState(
                type = 'Property',
                value = 'up',
    ...
    def testLinecardForwardingComplexFibTableNextHopGroupNextHopOperState(self):
        """Test LinecardForwardingComplexFibTableNextHopGroupNextHopOperState"""
