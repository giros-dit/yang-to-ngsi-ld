...
class TestVirtualRouterId(unittest.TestCase):
    """VirtualRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualRouterId:
        """Test VirtualRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualRouterId`
        """
