...
class TestInterfaceEthernetSymbolMonitorAdminState(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorAdminState:
        """Test InterfaceEthernetSymbolMonitorAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorAdminState`
        """
        model = InterfaceEthernetSymbolMonitorAdminState()
        if include_optional:
            return InterfaceEthernetSymbolMonitorAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testInterfaceEthernetSymbolMonitorAdminState(self):
        """Test InterfaceEthernetSymbolMonitorAdminState"""
