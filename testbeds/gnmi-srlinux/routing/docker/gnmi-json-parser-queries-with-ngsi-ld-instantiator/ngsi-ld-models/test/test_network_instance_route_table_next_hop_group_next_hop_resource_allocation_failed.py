...
class TestNetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed:
        """Test NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed`
        """
        model = NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed(self):
        """Test NetworkInstanceRouteTableNextHopGroupNextHopResourceAllocationFailed"""
