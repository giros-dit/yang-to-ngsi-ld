...
class TestInterfaceAdapter(unittest.TestCase):
    """InterfaceAdapter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceAdapter:
        """Test InterfaceAdapter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceAdapter`
        """
