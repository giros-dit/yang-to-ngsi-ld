...
class TestLinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime:
        """Test LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressTunnelsLastSyncTime"""
