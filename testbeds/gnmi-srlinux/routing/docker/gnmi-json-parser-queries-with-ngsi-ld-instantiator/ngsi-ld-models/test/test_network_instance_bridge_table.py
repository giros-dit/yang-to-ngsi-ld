...
class TestNetworkInstanceBridgeTable(unittest.TestCase):
    """NetworkInstanceBridgeTable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTable:
        """Test NetworkInstanceBridgeTable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTable`
        """
        model = NetworkInstanceBridgeTable()
        if include_optional:
            return NetworkInstanceBridgeTable(
                id = '',
                ...
                discard_unknown_dest_mac = None,
                protect_anycast_gw_mac = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceBridgeTable(
    ...
    def testNetworkInstanceBridgeTable(self):
        """Test NetworkInstanceBridgeTable"""
