...
class TestLinecardLocatorState(unittest.TestCase):
    """LinecardLocatorState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardLocatorState:
        """Test LinecardLocatorState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardLocatorState`
        """
        model = LinecardLocatorState()
        if include_optional:
            return LinecardLocatorState(
                type = 'Property',
                value = 'inactive',
    ...
    def testLinecardLocatorState(self):
        """Test LinecardLocatorState"""
