...
class TestLinecardMdaCleiCode(unittest.TestCase):
    """LinecardMdaCleiCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaCleiCode:
        """Test LinecardMdaCleiCode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaCleiCode`
        """
        model = LinecardMdaCleiCode()
        if include_optional:
            return LinecardMdaCleiCode(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaCleiCode(self):
        """Test LinecardMdaCleiCode"""
