...
class TestSystemSrv6SourceAddress(unittest.TestCase):
    """SystemSrv6SourceAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6SourceAddress:
        """Test SystemSrv6SourceAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6SourceAddress`
        """
        model = SystemSrv6SourceAddress()
        if include_optional:
            return SystemSrv6SourceAddress(
                id = '',
                type = 'SystemSrv6SourceAddress',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6SourceAddress(self):
        """Test SystemSrv6SourceAddress"""
