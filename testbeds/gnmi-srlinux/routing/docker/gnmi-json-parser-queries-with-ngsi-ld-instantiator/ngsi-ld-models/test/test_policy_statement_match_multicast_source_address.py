...
class TestPolicyStatementMatchMulticastSourceAddress(unittest.TestCase):
    """PolicyStatementMatchMulticastSourceAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchMulticastSourceAddress:
        """Test PolicyStatementMatchMulticastSourceAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchMulticastSourceAddress`
        """
        model = PolicyStatementMatchMulticastSourceAddress()
        if include_optional:
            return PolicyStatementMatchMulticastSourceAddress(
                id = '',
                type = 'PolicyStatementMatchMulticastSourceAddress',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchMulticastSourceAddress(self):
        """Test PolicyStatementMatchMulticastSourceAddress"""
