...
class TestPolicyDefaultActionBgpCommunitiesRemove(unittest.TestCase):
    """PolicyDefaultActionBgpCommunitiesRemove unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpCommunitiesRemove:
        """Test PolicyDefaultActionBgpCommunitiesRemove
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpCommunitiesRemove`
        """
        model = PolicyDefaultActionBgpCommunitiesRemove()
        if include_optional:
            return PolicyDefaultActionBgpCommunitiesRemove(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyDefaultActionBgpCommunitiesRemove(self):
        """Test PolicyDefaultActionBgpCommunitiesRemove"""
