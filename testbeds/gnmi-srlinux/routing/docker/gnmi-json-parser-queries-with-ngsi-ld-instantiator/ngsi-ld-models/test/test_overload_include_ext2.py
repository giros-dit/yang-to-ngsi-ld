...
class TestOverloadIncludeExt2(unittest.TestCase):
    """OverloadIncludeExt2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverloadIncludeExt2:
        """Test OverloadIncludeExt2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverloadIncludeExt2`
        """
        model = OverloadIncludeExt2()
        if include_optional:
            return OverloadIncludeExt2(
                type = 'Property',
                value = True,
    ...
    def testOverloadIncludeExt2(self):
        """Test OverloadIncludeExt2"""
