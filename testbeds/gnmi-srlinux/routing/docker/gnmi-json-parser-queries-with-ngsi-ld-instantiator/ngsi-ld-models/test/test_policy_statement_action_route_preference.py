...
class TestPolicyStatementActionRoutePreference(unittest.TestCase):
    """PolicyStatementActionRoutePreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionRoutePreference:
        """Test PolicyStatementActionRoutePreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionRoutePreference`
        """
        model = PolicyStatementActionRoutePreference()
        if include_optional:
            return PolicyStatementActionRoutePreference(
                id = '',
                type = 'PolicyStatementActionRoutePreference',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionRoutePreference(self):
        """Test PolicyStatementActionRoutePreference"""
