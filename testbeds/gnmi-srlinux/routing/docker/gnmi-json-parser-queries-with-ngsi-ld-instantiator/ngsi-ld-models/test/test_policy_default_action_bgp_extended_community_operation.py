...
class TestPolicyDefaultActionBgpExtendedCommunityOperation(unittest.TestCase):
    """PolicyDefaultActionBgpExtendedCommunityOperation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpExtendedCommunityOperation:
        """Test PolicyDefaultActionBgpExtendedCommunityOperation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpExtendedCommunityOperation`
        """
        model = PolicyDefaultActionBgpExtendedCommunityOperation()
        if include_optional:
            return PolicyDefaultActionBgpExtendedCommunityOperation(
                type = 'Property',
                value = 'add',
    ...
    def testPolicyDefaultActionBgpExtendedCommunityOperation(self):
        """Test PolicyDefaultActionBgpExtendedCommunityOperation"""
