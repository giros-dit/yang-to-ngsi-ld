...
class TestLinecardSoftwareVersion(unittest.TestCase):
    """LinecardSoftwareVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardSoftwareVersion:
        """Test LinecardSoftwareVersion
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardSoftwareVersion`
        """
        model = LinecardSoftwareVersion()
        if include_optional:
            return LinecardSoftwareVersion(
                type = 'Property',
                value = '',
    ...
    def testLinecardSoftwareVersion(self):
        """Test LinecardSoftwareVersion"""
