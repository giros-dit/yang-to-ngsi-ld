...
class TestControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime:
        """Test ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime(
                type = 'Property',
                value = '',
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressNextHopGroupsLastSyncTime"""
