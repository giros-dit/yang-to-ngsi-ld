...
class TestInterfaceEthernetExponentialPortDampening(unittest.TestCase):
    """InterfaceEthernetExponentialPortDampening unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetExponentialPortDampening:
        """Test InterfaceEthernetExponentialPortDampening
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetExponentialPortDampening`
        """
        model = InterfaceEthernetExponentialPortDampening()
        if include_optional:
            return InterfaceEthernetExponentialPortDampening(
                id = '',
                type = 'InterfaceEthernetExponentialPortDampening',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                admin_state = None,
                half_life = None,
                max_suppress_time = None,
                reuse_threshold = None,
                suppress_threshold = None,
                current_penalties = None,
                max_penalties = None,
                oper_state = None,
                is_part_of = None
            )
    ...
    def testInterfaceEthernetExponentialPortDampening(self):
        """Test InterfaceEthernetExponentialPortDampening"""
