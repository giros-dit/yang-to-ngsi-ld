...
class TestPrefixSetName(unittest.TestCase):
    """PrefixSetName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrefixSetName:
        """Test PrefixSetName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrefixSetName`
        """
        model = PrefixSetName()
        if include_optional:
            return PrefixSetName(
                type = 'Property',
                value = '',
