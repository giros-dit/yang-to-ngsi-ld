...
class TestInterfaceSubinterfaceIpv4StatisticsOutForwardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsOutForwardedPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets"""
