...
class TestNetworkInstanceInterfaceBridgeTableSplitHorizonGroup(unittest.TestCase):
    """NetworkInstanceInterfaceBridgeTableSplitHorizonGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceBridgeTableSplitHorizonGroup:
        """Test NetworkInstanceInterfaceBridgeTableSplitHorizonGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceBridgeTableSplitHorizonGroup`
        """
        model = NetworkInstanceInterfaceBridgeTableSplitHorizonGroup()
        if include_optional:
            return NetworkInstanceInterfaceBridgeTableSplitHorizonGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceInterfaceBridgeTableSplitHorizonGroup(self):
        """Test NetworkInstanceInterfaceBridgeTableSplitHorizonGroup"""
