...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutesWithEcmp"""
