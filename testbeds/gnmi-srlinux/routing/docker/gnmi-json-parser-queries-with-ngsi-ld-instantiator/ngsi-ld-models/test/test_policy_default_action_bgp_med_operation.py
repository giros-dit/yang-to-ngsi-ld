...
class TestPolicyDefaultActionBgpMedOperation(unittest.TestCase):
    """PolicyDefaultActionBgpMedOperation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpMedOperation:
        """Test PolicyDefaultActionBgpMedOperation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpMedOperation`
        """
        model = PolicyDefaultActionBgpMedOperation()
        if include_optional:
            return PolicyDefaultActionBgpMedOperation(
                type = 'Property',
                value = 'set',
    ...
    def testPolicyDefaultActionBgpMedOperation(self):
        """Test PolicyDefaultActionBgpMedOperation"""
