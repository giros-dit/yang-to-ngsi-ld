...
class TestNetworkInstanceIpForwarding(unittest.TestCase):
    """NetworkInstanceIpForwarding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIpForwarding:
        """Test NetworkInstanceIpForwarding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIpForwarding`
        """
        model = NetworkInstanceIpForwarding()
        if include_optional:
            return NetworkInstanceIpForwarding(
                id = '',
                ...
                receive_ipv4_check = None,
                receive_ipv6_check = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceIpForwarding(
    ...
    def testNetworkInstanceIpForwarding(self):
        """Test NetworkInstanceIpForwarding"""
