...
class TestPolicyStatementActionBgpOriginSet(unittest.TestCase):
    """PolicyStatementActionBgpOriginSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpOriginSet:
        """Test PolicyStatementActionBgpOriginSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpOriginSet`
        """
        model = PolicyStatementActionBgpOriginSet()
        if include_optional:
            return PolicyStatementActionBgpOriginSet(
                type = 'Property',
                value = 'igp',
    ...
    def testPolicyStatementActionBgpOriginSet(self):
        """Test PolicyStatementActionBgpOriginSet"""
