...
class TestNetworkInstanceRouteTableIpv6UnicastRouteRouteOwner(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteRouteOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteRouteOwner:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteRouteOwner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteRouteOwner`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteRouteOwner()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteRouteOwner(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteRouteOwner(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteRouteOwner"""
