...
class TestNetworkInstanceProtocolsOspfInstanceRouterId(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceRouterId:
        """Test NetworkInstanceProtocolsOspfInstanceRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceRouterId`
        """
        model = NetworkInstanceProtocolsOspfInstanceRouterId()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceRouterId(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testNetworkInstanceProtocolsOspfInstanceRouterId(self):
        """Test NetworkInstanceProtocolsOspfInstanceRouterId"""
