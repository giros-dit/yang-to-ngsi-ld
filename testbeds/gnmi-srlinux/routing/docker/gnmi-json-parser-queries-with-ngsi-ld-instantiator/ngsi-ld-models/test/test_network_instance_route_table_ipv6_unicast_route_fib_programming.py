...
class TestNetworkInstanceRouteTableIpv6UnicastRouteFibProgramming(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming(
                id = '',
                type = 'NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                suppressed = None,
                last_successful_operation_type = None,
                last_successful_operation_timestamp = None,
                pending_operation_type = None,
                last_failed_operation_type = None,
                last_failed_locations = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming(
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteFibProgramming(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgramming"""
