...
class TestInterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct:
        """Test InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct`
        """
        model = InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct(
                type = 'Property',
                value = 6,
    ...
    def testInterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct(self):
        """Test InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct"""
