...
class TestInterfaceSubinterfaceIpv6AddressType(unittest.TestCase):
    """InterfaceSubinterfaceIpv6AddressType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6AddressType:
        """Test InterfaceSubinterfaceIpv6AddressType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6AddressType`
        """
        model = InterfaceSubinterfaceIpv6AddressType()
        if include_optional:
            return InterfaceSubinterfaceIpv6AddressType(
                type = 'Property',
    ...
    def testInterfaceSubinterfaceIpv6AddressType(self):
        """Test InterfaceSubinterfaceIpv6AddressType"""
