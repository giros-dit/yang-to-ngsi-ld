...
class TestSystemLldpInterfaceStatisticsTlvUnknown(unittest.TestCase):
    """SystemLldpInterfaceStatisticsTlvUnknown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceStatisticsTlvUnknown:
        """Test SystemLldpInterfaceStatisticsTlvUnknown
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceStatisticsTlvUnknown`
        """
        model = SystemLldpInterfaceStatisticsTlvUnknown()
        if include_optional:
            return SystemLldpInterfaceStatisticsTlvUnknown(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceStatisticsTlvUnknown(self):
        """Test SystemLldpInterfaceStatisticsTlvUnknown"""
