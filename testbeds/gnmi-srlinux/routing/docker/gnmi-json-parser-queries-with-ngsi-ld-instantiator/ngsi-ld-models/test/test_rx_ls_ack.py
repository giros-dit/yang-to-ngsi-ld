...
class TestRxLsAck(unittest.TestCase):
    """RxLsAck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RxLsAck:
        """Test RxLsAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RxLsAck`
        """
        model = RxLsAck()
        if include_optional:
            return RxLsAck(
