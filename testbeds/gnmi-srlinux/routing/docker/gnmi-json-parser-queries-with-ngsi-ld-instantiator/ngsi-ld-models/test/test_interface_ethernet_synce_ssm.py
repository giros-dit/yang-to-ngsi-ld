...
class TestInterfaceEthernetSynceSsm(unittest.TestCase):
    """InterfaceEthernetSynceSsm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSynceSsm:
        """Test InterfaceEthernetSynceSsm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSynceSsm`
        """
        model = InterfaceEthernetSynceSsm()
        if include_optional:
            return InterfaceEthernetSynceSsm(
                id = '',
                type = 'InterfaceEthernetSynceSsm',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetSynceSsm(self):
        """Test InterfaceEthernetSynceSsm"""
