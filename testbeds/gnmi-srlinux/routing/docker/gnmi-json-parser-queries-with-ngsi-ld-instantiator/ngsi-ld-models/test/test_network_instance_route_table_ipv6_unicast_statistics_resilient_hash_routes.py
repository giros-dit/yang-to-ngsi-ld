...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsResilientHashRoutes"""
