...
class TestBadNeighbors(unittest.TestCase):
    """BadNeighbors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadNeighbors:
        """Test BadNeighbors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadNeighbors`
        """
        model = BadNeighbors()
        if include_optional:
            return BadNeighbors(
