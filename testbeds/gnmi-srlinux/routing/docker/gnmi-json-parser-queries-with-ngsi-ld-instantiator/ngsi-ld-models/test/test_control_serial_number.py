...
class TestControlSerialNumber(unittest.TestCase):
    """ControlSerialNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlSerialNumber:
        """Test ControlSerialNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlSerialNumber`
        """
        model = ControlSerialNumber()
        if include_optional:
    ...
    def testControlSerialNumber(self):
        """Test ControlSerialNumber"""
