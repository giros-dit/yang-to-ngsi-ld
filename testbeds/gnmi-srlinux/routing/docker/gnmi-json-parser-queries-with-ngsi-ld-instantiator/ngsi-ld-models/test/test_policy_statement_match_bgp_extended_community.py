...
class TestPolicyStatementMatchBgpExtendedCommunity(unittest.TestCase):
    """PolicyStatementMatchBgpExtendedCommunity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpExtendedCommunity:
        """Test PolicyStatementMatchBgpExtendedCommunity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpExtendedCommunity`
        """
        model = PolicyStatementMatchBgpExtendedCommunity()
        if include_optional:
            return PolicyStatementMatchBgpExtendedCommunity(
                id = '',
                type = 'PolicyStatementMatchBgpExtendedCommunity',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchBgpExtendedCommunity(self):
        """Test PolicyStatementMatchBgpExtendedCommunity"""
