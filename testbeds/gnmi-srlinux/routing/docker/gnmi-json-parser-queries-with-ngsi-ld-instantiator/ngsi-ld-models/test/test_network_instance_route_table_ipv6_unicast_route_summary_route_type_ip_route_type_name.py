...
class TestNetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName"""
