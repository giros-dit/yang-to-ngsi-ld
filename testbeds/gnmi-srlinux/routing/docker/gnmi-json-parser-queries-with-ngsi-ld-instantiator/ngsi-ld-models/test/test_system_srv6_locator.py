...
class TestSystemSrv6Locator(unittest.TestCase):
    """SystemSrv6Locator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6Locator:
        """Test SystemSrv6Locator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6Locator`
        """
        model = SystemSrv6Locator()
        if include_optional:
            return SystemSrv6Locator(
                id = '',
                type = 'SystemSrv6Locator',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6Locator(self):
        """Test SystemSrv6Locator"""
