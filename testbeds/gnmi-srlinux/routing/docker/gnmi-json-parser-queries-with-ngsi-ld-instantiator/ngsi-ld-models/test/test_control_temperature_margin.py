...
class TestControlTemperatureMargin(unittest.TestCase):
    """ControlTemperatureMargin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlTemperatureMargin:
        """Test ControlTemperatureMargin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlTemperatureMargin`
        """
        model = ControlTemperatureMargin()
        if include_optional:
            return ControlTemperatureMargin(
                type = 'Property',
                value = 56,
    ...
    def testControlTemperatureMargin(self):
        """Test ControlTemperatureMargin"""
