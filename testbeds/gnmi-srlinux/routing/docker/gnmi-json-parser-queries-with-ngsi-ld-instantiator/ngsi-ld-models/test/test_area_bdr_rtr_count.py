...
class TestAreaBdrRtrCount(unittest.TestCase):
    """AreaBdrRtrCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AreaBdrRtrCount:
        """Test AreaBdrRtrCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AreaBdrRtrCount`
        """
        model = AreaBdrRtrCount()
        if include_optional:
            return AreaBdrRtrCount(
                type = 'Property',
                value = 56,
