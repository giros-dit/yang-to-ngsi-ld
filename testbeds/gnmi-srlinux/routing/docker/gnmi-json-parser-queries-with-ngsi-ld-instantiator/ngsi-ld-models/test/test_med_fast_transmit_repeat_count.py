...
class TestMedFastTransmitRepeatCount(unittest.TestCase):
    """MedFastTransmitRepeatCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MedFastTransmitRepeatCount:
        """Test MedFastTransmitRepeatCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MedFastTransmitRepeatCount`
        """
        model = MedFastTransmitRepeatCount()
        if include_optional:
            return MedFastTransmitRepeatCount(
                type = 'Property',
                value = 1,
    ...
    def testMedFastTransmitRepeatCount(self):
        """Test MedFastTransmitRepeatCount"""
