...
class TestSystemLldpStatisticsFrameOut(unittest.TestCase):
    """SystemLldpStatisticsFrameOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpStatisticsFrameOut:
        """Test SystemLldpStatisticsFrameOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpStatisticsFrameOut`
        """
        model = SystemLldpStatisticsFrameOut()
        if include_optional:
            return SystemLldpStatisticsFrameOut(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpStatisticsFrameOut(self):
        """Test SystemLldpStatisticsFrameOut"""
