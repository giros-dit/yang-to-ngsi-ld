...
class TestControlRebootingAt(unittest.TestCase):
    """ControlRebootingAt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlRebootingAt:
        """Test ControlRebootingAt
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlRebootingAt`
        """
        model = ControlRebootingAt()
        if include_optional:
            return ControlRebootingAt(
                type = 'Property',
                value = '',
    ...
    def testControlRebootingAt(self):
        """Test ControlRebootingAt"""
