...
class TestHelloTimer(unittest.TestCase):
    """HelloTimer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelloTimer:
        """Test HelloTimer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelloTimer`
        """
        model = HelloTimer()
        if include_optional:
            return HelloTimer(
