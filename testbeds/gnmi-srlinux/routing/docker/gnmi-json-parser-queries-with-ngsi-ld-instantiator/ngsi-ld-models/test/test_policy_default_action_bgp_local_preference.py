...
class TestPolicyDefaultActionBgpLocalPreference(unittest.TestCase):
    """PolicyDefaultActionBgpLocalPreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpLocalPreference:
        """Test PolicyDefaultActionBgpLocalPreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpLocalPreference`
        """
        model = PolicyDefaultActionBgpLocalPreference()
        if include_optional:
            return PolicyDefaultActionBgpLocalPreference(
                id = '',
                type = 'PolicyDefaultActionBgpLocalPreference',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpLocalPreference(self):
        """Test PolicyDefaultActionBgpLocalPreference"""
