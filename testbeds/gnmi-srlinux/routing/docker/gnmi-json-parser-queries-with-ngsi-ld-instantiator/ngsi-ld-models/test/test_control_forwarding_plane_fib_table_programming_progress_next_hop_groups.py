...
class TestControlForwardingPlaneFibTableProgrammingProgressNextHopGroups(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups:
        """Test ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups(
                id = '',
                type = 'ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressNextHopGroups(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressNextHopGroups"""
