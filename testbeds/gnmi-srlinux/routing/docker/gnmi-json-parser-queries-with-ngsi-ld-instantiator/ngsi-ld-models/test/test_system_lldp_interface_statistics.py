...
class TestSystemLldpInterfaceStatistics(unittest.TestCase):
    """SystemLldpInterfaceStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceStatistics:
        """Test SystemLldpInterfaceStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceStatistics`
        """
        model = SystemLldpInterfaceStatistics()
        if include_optional:
            return SystemLldpInterfaceStatistics(
                id = '',
                type = 'SystemLldpInterfaceStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceStatistics(self):
        """Test SystemLldpInterfaceStatistics"""
