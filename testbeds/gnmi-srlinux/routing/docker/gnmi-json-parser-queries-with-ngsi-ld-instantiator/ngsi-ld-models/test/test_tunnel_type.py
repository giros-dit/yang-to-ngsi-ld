...
class TestTunnelType(unittest.TestCase):
    """TunnelType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TunnelType:
        """Test TunnelType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TunnelType`
        """
        model = TunnelType()
        if include_optional:
            return TunnelType(
