...
class TestNeighborInterfaceId(unittest.TestCase):
    """NeighborInterfaceId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NeighborInterfaceId:
        """Test NeighborInterfaceId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NeighborInterfaceId`
        """
        model = NeighborInterfaceId()
        if include_optional:
    ...
    def testNeighborInterfaceId(self):
        """Test NeighborInterfaceId"""
