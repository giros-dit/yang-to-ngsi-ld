...
class TestBadSeqNums(unittest.TestCase):
    """BadSeqNums unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadSeqNums:
        """Test BadSeqNums
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadSeqNums`
        """
        model = BadSeqNums()
        if include_optional:
            return BadSeqNums(
