...
class TestLinecardForwardingComplexFabric(unittest.TestCase):
    """LinecardForwardingComplexFabric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFabric:
        """Test LinecardForwardingComplexFabric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFabric`
        """
        model = LinecardForwardingComplexFabric()
        if include_optional:
            return LinecardForwardingComplexFabric(
                id = '',
                type = 'LinecardForwardingComplexFabric',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                utilization_ingress = None,
                utilization_egress = None,
                is_part_of = None
            )
        else:
            return LinecardForwardingComplexFabric(
    ...
    def testLinecardForwardingComplexFabric(self):
        """Test LinecardForwardingComplexFabric"""
