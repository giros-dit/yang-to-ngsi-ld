...
class TestLastOverloadExitTime(unittest.TestCase):
    """LastOverloadExitTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastOverloadExitTime:
        """Test LastOverloadExitTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastOverloadExitTime`
        """
        model = LastOverloadExitTime()
        if include_optional:
            return LastOverloadExitTime(
                type = 'Property',
                value = '',
    ...
    def testLastOverloadExitTime(self):
        """Test LastOverloadExitTime"""
