...
class TestNumMoves(unittest.TestCase):
    """NumMoves unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumMoves:
        """Test NumMoves
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumMoves`
        """
        model = NumMoves()
        if include_optional:
            return NumMoves(
