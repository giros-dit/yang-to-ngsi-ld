...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail"""
