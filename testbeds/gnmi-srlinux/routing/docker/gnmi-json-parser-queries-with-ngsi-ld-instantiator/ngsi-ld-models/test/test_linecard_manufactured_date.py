...
class TestLinecardManufacturedDate(unittest.TestCase):
    """LinecardManufacturedDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardManufacturedDate:
        """Test LinecardManufacturedDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardManufacturedDate`
        """
        model = LinecardManufacturedDate()
        if include_optional:
            return LinecardManufacturedDate(
                type = 'Property',
                value = '',
    ...
    def testLinecardManufacturedDate(self):
        """Test LinecardManufacturedDate"""
