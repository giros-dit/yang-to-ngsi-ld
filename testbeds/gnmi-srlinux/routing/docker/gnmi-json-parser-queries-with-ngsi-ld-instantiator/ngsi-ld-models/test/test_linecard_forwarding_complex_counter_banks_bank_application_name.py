...
class TestLinecardForwardingComplexCounterBanksBankApplicationName(unittest.TestCase):
    """LinecardForwardingComplexCounterBanksBankApplicationName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexCounterBanksBankApplicationName:
        """Test LinecardForwardingComplexCounterBanksBankApplicationName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexCounterBanksBankApplicationName`
        """
        model = LinecardForwardingComplexCounterBanksBankApplicationName()
        if include_optional:
            return LinecardForwardingComplexCounterBanksBankApplicationName(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexCounterBanksBankApplicationName(self):
        """Test LinecardForwardingComplexCounterBanksBankApplicationName"""
