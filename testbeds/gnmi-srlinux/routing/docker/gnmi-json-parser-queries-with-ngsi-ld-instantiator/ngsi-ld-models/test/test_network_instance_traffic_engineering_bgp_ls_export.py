...
class TestNetworkInstanceTrafficEngineeringBgpLsExport(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringBgpLsExport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringBgpLsExport:
        """Test NetworkInstanceTrafficEngineeringBgpLsExport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringBgpLsExport`
        """
        model = NetworkInstanceTrafficEngineeringBgpLsExport()
        if include_optional:
            return NetworkInstanceTrafficEngineeringBgpLsExport(
                id = '',
                type = 'NetworkInstanceTrafficEngineeringBgpLsExport',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceTrafficEngineeringBgpLsExport(self):
        """Test NetworkInstanceTrafficEngineeringBgpLsExport"""
