...
class TestNetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop:
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop`
        """
        model = NetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop(self):
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopNextHop"""
