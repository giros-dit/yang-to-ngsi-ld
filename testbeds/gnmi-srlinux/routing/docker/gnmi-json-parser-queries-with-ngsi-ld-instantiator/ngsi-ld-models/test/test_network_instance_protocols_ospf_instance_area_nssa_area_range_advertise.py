...
class TestNetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise:
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeAdvertise"""
