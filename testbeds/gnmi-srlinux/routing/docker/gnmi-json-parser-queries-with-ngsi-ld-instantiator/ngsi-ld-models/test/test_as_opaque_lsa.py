...
class TestAsOpaqueLsa(unittest.TestCase):
    """AsOpaqueLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsOpaqueLsa:
        """Test AsOpaqueLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsOpaqueLsa`
        """
        model = AsOpaqueLsa()
        if include_optional:
            return AsOpaqueLsa(
