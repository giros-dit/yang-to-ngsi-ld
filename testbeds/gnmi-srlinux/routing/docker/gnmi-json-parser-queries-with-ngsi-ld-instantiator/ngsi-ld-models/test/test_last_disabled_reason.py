...
class TestLastDisabledReason(unittest.TestCase):
    """LastDisabledReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastDisabledReason:
        """Test LastDisabledReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastDisabledReason`
        """
        model = LastDisabledReason()
        if include_optional:
    ...
    def testLastDisabledReason(self):
        """Test LastDisabledReason"""
