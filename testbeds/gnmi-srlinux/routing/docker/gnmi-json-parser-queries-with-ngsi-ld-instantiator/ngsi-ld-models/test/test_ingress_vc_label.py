...
class TestIngressVcLabel(unittest.TestCase):
    """IngressVcLabel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IngressVcLabel:
        """Test IngressVcLabel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IngressVcLabel`
        """
        model = IngressVcLabel()
        if include_optional:
            return IngressVcLabel(
                type = 'Property',
                value = 56,
