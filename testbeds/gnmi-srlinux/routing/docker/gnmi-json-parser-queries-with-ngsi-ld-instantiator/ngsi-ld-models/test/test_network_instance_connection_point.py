...
class TestNetworkInstanceConnectionPoint(unittest.TestCase):
    """NetworkInstanceConnectionPoint unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPoint:
        """Test NetworkInstanceConnectionPoint
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPoint`
        """
        model = NetworkInstanceConnectionPoint()
        if include_optional:
            return NetworkInstanceConnectionPoint(
                id = '',
                type = 'NetworkInstanceConnectionPoint',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceConnectionPoint(self):
        """Test NetworkInstanceConnectionPoint"""
