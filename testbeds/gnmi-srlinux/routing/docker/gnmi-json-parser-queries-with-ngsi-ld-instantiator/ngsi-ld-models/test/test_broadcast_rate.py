...
class TestBroadcastRate(unittest.TestCase):
    """BroadcastRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BroadcastRate:
        """Test BroadcastRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BroadcastRate`
        """
        model = BroadcastRate()
        if include_optional:
