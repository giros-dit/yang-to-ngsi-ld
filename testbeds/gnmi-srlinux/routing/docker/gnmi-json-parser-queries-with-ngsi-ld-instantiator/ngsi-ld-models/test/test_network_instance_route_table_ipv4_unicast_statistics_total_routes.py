...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsTotalRoutes"""
