...
class TestDiskEncrypted(unittest.TestCase):
    """DiskEncrypted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiskEncrypted:
        """Test DiskEncrypted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiskEncrypted`
        """
        model = DiskEncrypted()
        if include_optional:
