...
class TestLinecardForwardingComplexPipeline(unittest.TestCase):
    """LinecardForwardingComplexPipeline unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexPipeline:
        """Test LinecardForwardingComplexPipeline
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexPipeline`
        """
        model = LinecardForwardingComplexPipeline()
        if include_optional:
            return LinecardForwardingComplexPipeline(
                id = '',
                type = 'LinecardForwardingComplexPipeline',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexPipeline(self):
        """Test LinecardForwardingComplexPipeline"""
