...
class TestInterfaceSubinterfaceBridgeTableMacLimitMaximumEntries(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries:
        """Test InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries`
        """
        model = InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceSubinterfaceBridgeTableMacLimitMaximumEntries(self):
        """Test InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries"""
