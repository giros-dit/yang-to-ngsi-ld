...
class TestSystemLldpInterfaceLldpMedNetworkPolicy(unittest.TestCase):
    """SystemLldpInterfaceLldpMedNetworkPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedNetworkPolicy:
        """Test SystemLldpInterfaceLldpMedNetworkPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedNetworkPolicy`
        """
        model = SystemLldpInterfaceLldpMedNetworkPolicy()
        if include_optional:
            return SystemLldpInterfaceLldpMedNetworkPolicy(
                type = 'Relationship',
                object = '',
    ...
    def testSystemLldpInterfaceLldpMedNetworkPolicy(self):
        """Test SystemLldpInterfaceLldpMedNetworkPolicy"""
