...
class TestInterfaceEthernetSymbolMonitorSignalDegradeMultiplier(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorSignalDegradeMultiplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorSignalDegradeMultiplier:
        """Test InterfaceEthernetSymbolMonitorSignalDegradeMultiplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorSignalDegradeMultiplier`
        """
        model = InterfaceEthernetSymbolMonitorSignalDegradeMultiplier()
        if include_optional:
            return InterfaceEthernetSymbolMonitorSignalDegradeMultiplier(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceEthernetSymbolMonitorSignalDegradeMultiplier(self):
        """Test InterfaceEthernetSymbolMonitorSignalDegradeMultiplier"""
