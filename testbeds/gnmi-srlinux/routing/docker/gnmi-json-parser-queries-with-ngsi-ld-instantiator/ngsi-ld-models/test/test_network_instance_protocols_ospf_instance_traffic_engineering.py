...
class TestNetworkInstanceProtocolsOspfInstanceTrafficEngineering(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTrafficEngineering unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTrafficEngineering:
        """Test NetworkInstanceProtocolsOspfInstanceTrafficEngineering
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTrafficEngineering`
        """
        model = NetworkInstanceProtocolsOspfInstanceTrafficEngineering()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTrafficEngineering(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTrafficEngineering(self):
        """Test NetworkInstanceProtocolsOspfInstanceTrafficEngineering"""
