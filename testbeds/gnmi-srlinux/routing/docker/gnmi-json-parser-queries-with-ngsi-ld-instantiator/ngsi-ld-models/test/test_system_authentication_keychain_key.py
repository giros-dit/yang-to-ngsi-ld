...
class TestSystemAuthenticationKeychainKey(unittest.TestCase):
    """SystemAuthenticationKeychainKey unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKey:
        """Test SystemAuthenticationKeychainKey
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKey`
        """
        model = SystemAuthenticationKeychainKey()
        if include_optional:
            return SystemAuthenticationKeychainKey(
                id = '',
                type = 'SystemAuthenticationKeychainKey',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemAuthenticationKeychainKey(self):
        """Test SystemAuthenticationKeychainKey"""
