...
class TestMplsMtu(unittest.TestCase):
    """MplsMtu unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MplsMtu:
        """Test MplsMtu
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MplsMtu`
        """
        model = MplsMtu()
        if include_optional:
            return MplsMtu(
