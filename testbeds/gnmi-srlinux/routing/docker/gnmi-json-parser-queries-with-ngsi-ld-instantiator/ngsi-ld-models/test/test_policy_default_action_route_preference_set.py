...
class TestPolicyDefaultActionRoutePreferenceSet(unittest.TestCase):
    """PolicyDefaultActionRoutePreferenceSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionRoutePreferenceSet:
        """Test PolicyDefaultActionRoutePreferenceSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionRoutePreferenceSet`
        """
        model = PolicyDefaultActionRoutePreferenceSet()
        if include_optional:
            return PolicyDefaultActionRoutePreferenceSet(
                type = 'Property',
                value = 56,
    ...
    def testPolicyDefaultActionRoutePreferenceSet(self):
        """Test PolicyDefaultActionRoutePreferenceSet"""
