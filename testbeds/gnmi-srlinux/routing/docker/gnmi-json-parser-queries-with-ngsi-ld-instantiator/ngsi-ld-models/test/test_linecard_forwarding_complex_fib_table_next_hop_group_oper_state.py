...
class TestLinecardForwardingComplexFibTableNextHopGroupOperState(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroupOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroupOperState:
        """Test LinecardForwardingComplexFibTableNextHopGroupOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroupOperState`
        """
        model = LinecardForwardingComplexFibTableNextHopGroupOperState()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroupOperState(
                type = 'Property',
                value = 'up',
    ...
    def testLinecardForwardingComplexFibTableNextHopGroupOperState(self):
        """Test LinecardForwardingComplexFibTableNextHopGroupOperState"""
