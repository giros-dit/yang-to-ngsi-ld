...
class TestInterfaceTransceiverVoltageLatestValue(unittest.TestCase):
    """InterfaceTransceiverVoltageLatestValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverVoltageLatestValue:
        """Test InterfaceTransceiverVoltageLatestValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverVoltageLatestValue`
        """
        model = InterfaceTransceiverVoltageLatestValue()
        if include_optional:
            return InterfaceTransceiverVoltageLatestValue(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceTransceiverVoltageLatestValue(self):
        """Test InterfaceTransceiverVoltageLatestValue"""
