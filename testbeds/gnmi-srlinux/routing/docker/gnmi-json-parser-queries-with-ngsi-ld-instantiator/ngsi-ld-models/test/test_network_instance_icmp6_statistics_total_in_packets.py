...
class TestNetworkInstanceIcmp6StatisticsTotalInPackets(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTotalInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTotalInPackets:
        """Test NetworkInstanceIcmp6StatisticsTotalInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTotalInPackets`
        """
        model = NetworkInstanceIcmp6StatisticsTotalInPackets()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTotalInPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmp6StatisticsTotalInPackets(self):
        """Test NetworkInstanceIcmp6StatisticsTotalInPackets"""
