...
class TestNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations(
                type = 'Property',
                value = 'complex-14.0',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastFailedLocations"""
