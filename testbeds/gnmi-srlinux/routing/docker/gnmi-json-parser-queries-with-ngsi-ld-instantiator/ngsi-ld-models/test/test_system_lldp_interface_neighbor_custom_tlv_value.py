...
class TestSystemLldpInterfaceNeighborCustomTlvValue(unittest.TestCase):
    """SystemLldpInterfaceNeighborCustomTlvValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborCustomTlvValue:
        """Test SystemLldpInterfaceNeighborCustomTlvValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborCustomTlvValue`
        """
        model = SystemLldpInterfaceNeighborCustomTlvValue()
        if include_optional:
            return SystemLldpInterfaceNeighborCustomTlvValue(
                type = 'Property',
                value = bytes(b'blah'),
    ...
    def testSystemLldpInterfaceNeighborCustomTlvValue(self):
        """Test SystemLldpInterfaceNeighborCustomTlvValue"""
