...
class TestControlTemperatureInstant(unittest.TestCase):
    """ControlTemperatureInstant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlTemperatureInstant:
        """Test ControlTemperatureInstant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlTemperatureInstant`
        """
        model = ControlTemperatureInstant()
        if include_optional:
            return ControlTemperatureInstant(
                type = 'Property',
                value = 56,
    ...
    def testControlTemperatureInstant(self):
        """Test ControlTemperatureInstant"""
