...
class TestNetworkInstanceType(unittest.TestCase):
    """NetworkInstanceType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceType:
        """Test NetworkInstanceType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceType`
        """
        model = NetworkInstanceType()
        if include_optional:
    ...
    def testNetworkInstanceType(self):
        """Test NetworkInstanceType"""
