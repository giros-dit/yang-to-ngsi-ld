...
class TestNetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask:
        """Test NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaAreaRangeIpPrefixMask"""
