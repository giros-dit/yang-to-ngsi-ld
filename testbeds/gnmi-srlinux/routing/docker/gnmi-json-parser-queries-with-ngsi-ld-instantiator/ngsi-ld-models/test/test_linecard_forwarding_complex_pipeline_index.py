...
class TestLinecardForwardingComplexPipelineIndex(unittest.TestCase):
    """LinecardForwardingComplexPipelineIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexPipelineIndex:
        """Test LinecardForwardingComplexPipelineIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexPipelineIndex`
        """
        model = LinecardForwardingComplexPipelineIndex()
        if include_optional:
            return LinecardForwardingComplexPipelineIndex(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexPipelineIndex(self):
        """Test LinecardForwardingComplexPipelineIndex"""
