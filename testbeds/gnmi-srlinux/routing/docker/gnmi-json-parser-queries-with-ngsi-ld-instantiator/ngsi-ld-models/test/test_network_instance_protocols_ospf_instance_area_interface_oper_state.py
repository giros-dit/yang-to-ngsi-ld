...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState(
                type = 'Property',
                value = 'down',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceOperState"""
