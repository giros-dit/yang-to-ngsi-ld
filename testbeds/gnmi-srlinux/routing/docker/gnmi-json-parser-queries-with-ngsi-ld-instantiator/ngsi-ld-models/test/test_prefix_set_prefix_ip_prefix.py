...
class TestPrefixSetPrefixIpPrefix(unittest.TestCase):
    """PrefixSetPrefixIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PrefixSetPrefixIpPrefix:
        """Test PrefixSetPrefixIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PrefixSetPrefixIpPrefix`
        """
        model = PrefixSetPrefixIpPrefix()
        if include_optional:
            return PrefixSetPrefixIpPrefix(
                type = 'Property',
                value = '',
    ...
    def testPrefixSetPrefixIpPrefix(self):
        """Test PrefixSetPrefixIpPrefix"""
