...
class TestLinecardForwardingComplexControlPlaneTraffic(unittest.TestCase):
    """LinecardForwardingComplexControlPlaneTraffic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexControlPlaneTraffic:
        """Test LinecardForwardingComplexControlPlaneTraffic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexControlPlaneTraffic`
        """
        model = LinecardForwardingComplexControlPlaneTraffic()
        if include_optional:
            return LinecardForwardingComplexControlPlaneTraffic(
                id = '',
                type = 'LinecardForwardingComplexControlPlaneTraffic',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                queued_aggregate = None,
                queued_bytes_aggregate = None,
                dropped_aggregate = None,
                dropped_bytes_aggregate = None,
                is_part_of = None
            )
        else:
            return LinecardForwardingComplexControlPlaneTraffic(
    ...
    def testLinecardForwardingComplexControlPlaneTraffic(self):
        """Test LinecardForwardingComplexControlPlaneTraffic"""
