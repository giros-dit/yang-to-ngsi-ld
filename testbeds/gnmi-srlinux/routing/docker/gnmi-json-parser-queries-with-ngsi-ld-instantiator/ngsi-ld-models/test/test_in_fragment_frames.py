...
class TestInFragmentFrames(unittest.TestCase):
    """InFragmentFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InFragmentFrames:
        """Test InFragmentFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InFragmentFrames`
        """
        model = InFragmentFrames()
        if include_optional:
            return InFragmentFrames(
                type = 'Property',
                value = 56,
