...
class TestNetworkInstanceTcpListeningApplicationLocalPort(unittest.TestCase):
    """NetworkInstanceTcpListeningApplicationLocalPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpListeningApplicationLocalPort:
        """Test NetworkInstanceTcpListeningApplicationLocalPort
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpListeningApplicationLocalPort`
        """
        model = NetworkInstanceTcpListeningApplicationLocalPort()
        if include_optional:
            return NetworkInstanceTcpListeningApplicationLocalPort(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceTcpListeningApplicationLocalPort(self):
        """Test NetworkInstanceTcpListeningApplicationLocalPort"""
