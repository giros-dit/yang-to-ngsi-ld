...
class TestInterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets"""
