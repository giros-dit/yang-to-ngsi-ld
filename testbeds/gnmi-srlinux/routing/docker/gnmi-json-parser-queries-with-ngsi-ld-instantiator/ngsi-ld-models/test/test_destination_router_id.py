...
class TestDestinationRouterId(unittest.TestCase):
    """DestinationRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestinationRouterId:
        """Test DestinationRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationRouterId`
        """
        model = DestinationRouterId()
        if include_optional:
    ...
    def testDestinationRouterId(self):
        """Test DestinationRouterId"""
