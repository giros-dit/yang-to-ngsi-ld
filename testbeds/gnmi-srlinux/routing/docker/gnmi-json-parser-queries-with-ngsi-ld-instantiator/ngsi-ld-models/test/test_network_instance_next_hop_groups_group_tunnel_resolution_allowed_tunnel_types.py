...
class TestNetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes:
        """Test NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes`
        """
        model = NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes(self):
        """Test NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes"""
