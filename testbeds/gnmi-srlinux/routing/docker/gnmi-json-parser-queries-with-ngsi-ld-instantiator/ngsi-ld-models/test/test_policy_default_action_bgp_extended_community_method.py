...
class TestPolicyDefaultActionBgpExtendedCommunityMethod(unittest.TestCase):
    """PolicyDefaultActionBgpExtendedCommunityMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpExtendedCommunityMethod:
        """Test PolicyDefaultActionBgpExtendedCommunityMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpExtendedCommunityMethod`
        """
        model = PolicyDefaultActionBgpExtendedCommunityMethod()
        if include_optional:
            return PolicyDefaultActionBgpExtendedCommunityMethod(
                type = 'Property',
                value = 'reference',
    ...
    def testPolicyDefaultActionBgpExtendedCommunityMethod(self):
        """Test PolicyDefaultActionBgpExtendedCommunityMethod"""
