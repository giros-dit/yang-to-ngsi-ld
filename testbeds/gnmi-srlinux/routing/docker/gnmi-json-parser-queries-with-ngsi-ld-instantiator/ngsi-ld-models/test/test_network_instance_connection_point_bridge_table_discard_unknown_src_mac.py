...
class TestNetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac:
        """Test NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac`
        """
        model = NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac(self):
        """Test NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac"""
