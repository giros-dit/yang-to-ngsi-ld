...
class TestInterfaceLinecard(unittest.TestCase):
    """InterfaceLinecard unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceLinecard:
        """Test InterfaceLinecard
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceLinecard`
        """
        model = InterfaceLinecard()
        if include_optional:
            return InterfaceLinecard(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceLinecard(self):
        """Test InterfaceLinecard"""
