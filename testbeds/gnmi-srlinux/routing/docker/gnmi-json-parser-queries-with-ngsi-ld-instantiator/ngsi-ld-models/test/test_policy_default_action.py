...
class TestPolicyDefaultAction(unittest.TestCase):
    """PolicyDefaultAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultAction:
        """Test PolicyDefaultAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultAction`
        """
        model = PolicyDefaultAction()
        if include_optional:
    ...
    def testPolicyDefaultAction(self):
        """Test PolicyDefaultAction"""
