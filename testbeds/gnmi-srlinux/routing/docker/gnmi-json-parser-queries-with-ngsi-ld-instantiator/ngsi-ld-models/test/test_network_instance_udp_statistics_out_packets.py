...
class TestNetworkInstanceUdpStatisticsOutPackets(unittest.TestCase):
    """NetworkInstanceUdpStatisticsOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpStatisticsOutPackets:
        """Test NetworkInstanceUdpStatisticsOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpStatisticsOutPackets`
        """
        model = NetworkInstanceUdpStatisticsOutPackets()
        if include_optional:
            return NetworkInstanceUdpStatisticsOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceUdpStatisticsOutPackets(self):
        """Test NetworkInstanceUdpStatisticsOutPackets"""
