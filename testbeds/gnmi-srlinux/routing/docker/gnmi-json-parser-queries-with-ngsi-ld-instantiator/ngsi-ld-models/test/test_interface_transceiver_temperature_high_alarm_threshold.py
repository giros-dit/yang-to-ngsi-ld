...
class TestInterfaceTransceiverTemperatureHighAlarmThreshold(unittest.TestCase):
    """InterfaceTransceiverTemperatureHighAlarmThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureHighAlarmThreshold:
        """Test InterfaceTransceiverTemperatureHighAlarmThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureHighAlarmThreshold`
        """
        model = InterfaceTransceiverTemperatureHighAlarmThreshold()
        if include_optional:
            return InterfaceTransceiverTemperatureHighAlarmThreshold(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceTransceiverTemperatureHighAlarmThreshold(self):
        """Test InterfaceTransceiverTemperatureHighAlarmThreshold"""
