...
class TestTransitDelay(unittest.TestCase):
    """TransitDelay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransitDelay:
        """Test TransitDelay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransitDelay`
        """
        model = TransitDelay()
        if include_optional:
            return TransitDelay(
