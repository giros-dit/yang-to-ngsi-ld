...
class TestForwardingMode(unittest.TestCase):
    """ForwardingMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForwardingMode:
        """Test ForwardingMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForwardingMode`
        """
