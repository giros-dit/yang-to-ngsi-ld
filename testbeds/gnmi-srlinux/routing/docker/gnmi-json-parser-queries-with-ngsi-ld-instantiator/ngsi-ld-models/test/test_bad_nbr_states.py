...
class TestBadNbrStates(unittest.TestCase):
    """BadNbrStates unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadNbrStates:
        """Test BadNbrStates
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadNbrStates`
        """
        model = BadNbrStates()
        if include_optional:
            return BadNbrStates(
