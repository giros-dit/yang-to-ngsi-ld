...
class TestExternalPreference(unittest.TestCase):
    """ExternalPreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalPreference:
        """Test ExternalPreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalPreference`
        """
        model = ExternalPreference()
        if include_optional:
    ...
    def testExternalPreference(self):
        """Test ExternalPreference"""
