...
class TestInterfaceSubinterfaceIpv4AddressOrigin(unittest.TestCase):
    """InterfaceSubinterfaceIpv4AddressOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4AddressOrigin:
        """Test InterfaceSubinterfaceIpv4AddressOrigin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4AddressOrigin`
        """
        model = InterfaceSubinterfaceIpv4AddressOrigin()
        if include_optional:
            return InterfaceSubinterfaceIpv4AddressOrigin(
                type = 'Property',
                value = 'other',
    ...
    def testInterfaceSubinterfaceIpv4AddressOrigin(self):
        """Test InterfaceSubinterfaceIpv4AddressOrigin"""
