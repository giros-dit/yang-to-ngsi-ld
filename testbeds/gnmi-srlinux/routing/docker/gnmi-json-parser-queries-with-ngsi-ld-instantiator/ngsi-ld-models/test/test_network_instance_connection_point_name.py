...
class TestNetworkInstanceConnectionPointName(unittest.TestCase):
    """NetworkInstanceConnectionPointName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointName:
        """Test NetworkInstanceConnectionPointName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointName`
        """
        model = NetworkInstanceConnectionPointName()
        if include_optional:
            return NetworkInstanceConnectionPointName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceConnectionPointName(self):
        """Test NetworkInstanceConnectionPointName"""
