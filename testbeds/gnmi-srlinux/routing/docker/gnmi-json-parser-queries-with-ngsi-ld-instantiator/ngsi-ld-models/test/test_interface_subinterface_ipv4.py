...
class TestInterfaceSubinterfaceIpv4(unittest.TestCase):
    """InterfaceSubinterfaceIpv4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4:
        """Test InterfaceSubinterfaceIpv4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4`
        """
        model = InterfaceSubinterfaceIpv4()
        if include_optional:
            return InterfaceSubinterfaceIpv4(
                id = '',
    ...
    def testInterfaceSubinterfaceIpv4(self):
        """Test InterfaceSubinterfaceIpv4"""
