...
class TestOperationalMulticastRate(unittest.TestCase):
    """OperationalMulticastRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalMulticastRate:
        """Test OperationalMulticastRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalMulticastRate`
        """
        model = OperationalMulticastRate()
        if include_optional:
            return OperationalMulticastRate(
                type = 'Property',
                value = 56,
    ...
    def testOperationalMulticastRate(self):
        """Test OperationalMulticastRate"""
