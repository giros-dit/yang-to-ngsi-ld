...
class TestSystemLldpLldpMedNetworkPolicyDscp(unittest.TestCase):
    """SystemLldpLldpMedNetworkPolicyDscp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpLldpMedNetworkPolicyDscp:
        """Test SystemLldpLldpMedNetworkPolicyDscp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpLldpMedNetworkPolicyDscp`
        """
        model = SystemLldpLldpMedNetworkPolicyDscp()
        if include_optional:
            return SystemLldpLldpMedNetworkPolicyDscp(
                type = 'Property',
                value = 'CS0',
    ...
    def testSystemLldpLldpMedNetworkPolicyDscp(self):
        """Test SystemLldpLldpMedNetworkPolicyDscp"""
