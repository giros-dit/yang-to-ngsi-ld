...
class TestReferencedAdvRouter(unittest.TestCase):
    """ReferencedAdvRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReferencedAdvRouter:
        """Test ReferencedAdvRouter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReferencedAdvRouter`
        """
        model = ReferencedAdvRouter()
        if include_optional:
            return ReferencedAdvRouter(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testReferencedAdvRouter(self):
        """Test ReferencedAdvRouter"""
