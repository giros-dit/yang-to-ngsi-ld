...
class TestDistinguisher(unittest.TestCase):
    """Distinguisher unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Distinguisher:
        """Test Distinguisher
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Distinguisher`
        """
        model = Distinguisher()
        if include_optional:
