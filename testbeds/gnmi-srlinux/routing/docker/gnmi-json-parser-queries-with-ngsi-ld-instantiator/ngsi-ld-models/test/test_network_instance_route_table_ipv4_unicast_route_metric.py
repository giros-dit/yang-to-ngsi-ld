...
class TestNetworkInstanceRouteTableIpv4UnicastRouteMetric(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteMetric:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteMetric`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteMetric()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteMetric(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteMetric(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteMetric"""
