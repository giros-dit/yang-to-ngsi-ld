...
class TestNetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteLastAppUpdate"""
