...
class TestInterfaceSubinterfaceBridgeTableMacDuplicationAction(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableMacDuplicationAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableMacDuplicationAction:
        """Test InterfaceSubinterfaceBridgeTableMacDuplicationAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableMacDuplicationAction`
        """
        model = InterfaceSubinterfaceBridgeTableMacDuplicationAction()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableMacDuplicationAction(
                type = 'Property',
                value = 'use-net-instance-action',
    ...
    def testInterfaceSubinterfaceBridgeTableMacDuplicationAction(self):
        """Test InterfaceSubinterfaceBridgeTableMacDuplicationAction"""
