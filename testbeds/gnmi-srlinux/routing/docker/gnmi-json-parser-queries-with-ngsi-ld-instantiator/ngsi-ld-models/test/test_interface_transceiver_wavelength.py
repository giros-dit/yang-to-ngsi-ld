...
class TestInterfaceTransceiverWavelength(unittest.TestCase):
    """InterfaceTransceiverWavelength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverWavelength:
        """Test InterfaceTransceiverWavelength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverWavelength`
        """
        model = InterfaceTransceiverWavelength()
        if include_optional:
            return InterfaceTransceiverWavelength(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceTransceiverWavelength(self):
        """Test InterfaceTransceiverWavelength"""
