...
class TestOperationalEgressVcLabel(unittest.TestCase):
    """OperationalEgressVcLabel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalEgressVcLabel:
        """Test OperationalEgressVcLabel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalEgressVcLabel`
        """
        model = OperationalEgressVcLabel()
        if include_optional:
            return OperationalEgressVcLabel(
                type = 'Property',
                value = 56,
    ...
    def testOperationalEgressVcLabel(self):
        """Test OperationalEgressVcLabel"""
