...
class TestMulticastForwarding(unittest.TestCase):
    """MulticastForwarding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MulticastForwarding:
        """Test MulticastForwarding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MulticastForwarding`
        """
        model = MulticastForwarding()
        if include_optional:
    ...
    def testMulticastForwarding(self):
        """Test MulticastForwarding"""
