...
class TestSystemLldpInterfaceLldpMedLocation(unittest.TestCase):
    """SystemLldpInterfaceLldpMedLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedLocation:
        """Test SystemLldpInterfaceLldpMedLocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedLocation`
        """
        model = SystemLldpInterfaceLldpMedLocation()
        if include_optional:
            return SystemLldpInterfaceLldpMedLocation(
                id = '',
                type = 'SystemLldpInterfaceLldpMedLocation',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceLldpMedLocation(self):
        """Test SystemLldpInterfaceLldpMedLocation"""
