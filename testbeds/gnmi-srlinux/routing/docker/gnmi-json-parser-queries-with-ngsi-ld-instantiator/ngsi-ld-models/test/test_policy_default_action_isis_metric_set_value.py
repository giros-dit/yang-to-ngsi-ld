...
class TestPolicyDefaultActionIsisMetricSetValue(unittest.TestCase):
    """PolicyDefaultActionIsisMetricSetValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionIsisMetricSetValue:
        """Test PolicyDefaultActionIsisMetricSetValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionIsisMetricSetValue`
        """
        model = PolicyDefaultActionIsisMetricSetValue()
        if include_optional:
            return PolicyDefaultActionIsisMetricSetValue(
                type = 'Property',
                value = 56,
    ...
    def testPolicyDefaultActionIsisMetricSetValue(self):
        """Test PolicyDefaultActionIsisMetricSetValue"""
