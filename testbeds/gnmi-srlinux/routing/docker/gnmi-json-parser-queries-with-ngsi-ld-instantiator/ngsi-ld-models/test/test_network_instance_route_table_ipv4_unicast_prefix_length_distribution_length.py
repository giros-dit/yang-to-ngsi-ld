...
class TestNetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength:
        """Test NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength`
        """
        model = NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength(
                id = '',
                type = 'NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength(self):
        """Test NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLength"""
