...
class TestSystemSrv6LocatorMicroSegment(unittest.TestCase):
    """SystemSrv6LocatorMicroSegment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorMicroSegment:
        """Test SystemSrv6LocatorMicroSegment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorMicroSegment`
        """
        model = SystemSrv6LocatorMicroSegment()
        if include_optional:
            return SystemSrv6LocatorMicroSegment(
                id = '',
                type = 'SystemSrv6LocatorMicroSegment',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6LocatorMicroSegment(self):
        """Test SystemSrv6LocatorMicroSegment"""
