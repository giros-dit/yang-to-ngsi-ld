...
class TestExternLsaCount(unittest.TestCase):
    """ExternLsaCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternLsaCount:
        """Test ExternLsaCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternLsaCount`
        """
        model = ExternLsaCount()
        if include_optional:
            return ExternLsaCount(
                type = 'Property',
                value = 56,
