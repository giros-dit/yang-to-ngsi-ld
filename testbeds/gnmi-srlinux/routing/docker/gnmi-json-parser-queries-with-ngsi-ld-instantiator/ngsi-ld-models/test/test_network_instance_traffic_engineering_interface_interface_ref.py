...
class TestNetworkInstanceTrafficEngineeringInterfaceInterfaceRef(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringInterfaceInterfaceRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringInterfaceInterfaceRef:
        """Test NetworkInstanceTrafficEngineeringInterfaceInterfaceRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringInterfaceInterfaceRef`
        """
        model = NetworkInstanceTrafficEngineeringInterfaceInterfaceRef()
        if include_optional:
            return NetworkInstanceTrafficEngineeringInterfaceInterfaceRef(
                id = '',
                type = 'NetworkInstanceTrafficEngineeringInterfaceInterfaceRef',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceTrafficEngineeringInterfaceInterfaceRef(self):
        """Test NetworkInstanceTrafficEngineeringInterfaceInterfaceRef"""
