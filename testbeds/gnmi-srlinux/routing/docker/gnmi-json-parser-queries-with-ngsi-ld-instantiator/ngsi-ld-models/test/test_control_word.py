...
class TestControlWord(unittest.TestCase):
    """ControlWord unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlWord:
        """Test ControlWord
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlWord`
        """
        model = ControlWord()
        if include_optional:
            return ControlWord(
