...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsDynamicLoadBalancingRoutes"""
