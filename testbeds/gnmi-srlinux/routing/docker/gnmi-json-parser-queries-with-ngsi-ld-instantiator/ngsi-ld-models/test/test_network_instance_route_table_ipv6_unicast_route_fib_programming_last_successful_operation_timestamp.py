...
class TestNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp"""
