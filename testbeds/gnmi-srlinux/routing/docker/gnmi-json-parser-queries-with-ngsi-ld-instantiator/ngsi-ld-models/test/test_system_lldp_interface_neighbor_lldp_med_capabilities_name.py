...
class TestSystemLldpInterfaceNeighborLldpMedCapabilitiesName(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedCapabilitiesName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedCapabilitiesName:
        """Test SystemLldpInterfaceNeighborLldpMedCapabilitiesName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedCapabilitiesName`
        """
        model = SystemLldpInterfaceNeighborLldpMedCapabilitiesName()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedCapabilitiesName(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborLldpMedCapabilitiesName(self):
        """Test SystemLldpInterfaceNeighborLldpMedCapabilitiesName"""
