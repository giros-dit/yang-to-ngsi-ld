...
class TestControlTemperatureMaximumTime(unittest.TestCase):
    """ControlTemperatureMaximumTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlTemperatureMaximumTime:
        """Test ControlTemperatureMaximumTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlTemperatureMaximumTime`
        """
        model = ControlTemperatureMaximumTime()
        if include_optional:
            return ControlTemperatureMaximumTime(
                type = 'Property',
                value = '',
    ...
    def testControlTemperatureMaximumTime(self):
        """Test ControlTemperatureMaximumTime"""
