...
class TestNetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes"""
