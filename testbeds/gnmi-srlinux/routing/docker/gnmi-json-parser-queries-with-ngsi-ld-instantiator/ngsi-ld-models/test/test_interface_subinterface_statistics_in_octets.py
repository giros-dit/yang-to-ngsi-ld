...
class TestInterfaceSubinterfaceStatisticsInOctets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInOctets:
        """Test InterfaceSubinterfaceStatisticsInOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInOctets`
        """
        model = InterfaceSubinterfaceStatisticsInOctets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInOctets(self):
        """Test InterfaceSubinterfaceStatisticsInOctets"""
