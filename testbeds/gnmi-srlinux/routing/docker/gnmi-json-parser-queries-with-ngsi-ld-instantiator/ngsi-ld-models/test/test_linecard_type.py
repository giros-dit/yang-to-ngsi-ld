...
class TestLinecardType(unittest.TestCase):
    """LinecardType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardType:
        """Test LinecardType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardType`
        """
        model = LinecardType()
        if include_optional:
            return LinecardType(
