...
class TestNetworkInstanceRouteTableIpv6UnicastRouteRouteType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteRouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteRouteType:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteRouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteRouteType`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteRouteType()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteRouteType(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteRouteType(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteRouteType"""
