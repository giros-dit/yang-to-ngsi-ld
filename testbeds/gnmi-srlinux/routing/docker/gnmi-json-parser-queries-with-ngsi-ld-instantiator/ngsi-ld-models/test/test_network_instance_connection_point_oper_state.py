...
class TestNetworkInstanceConnectionPointOperState(unittest.TestCase):
    """NetworkInstanceConnectionPointOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointOperState:
        """Test NetworkInstanceConnectionPointOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointOperState`
        """
        model = NetworkInstanceConnectionPointOperState()
        if include_optional:
            return NetworkInstanceConnectionPointOperState(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceConnectionPointOperState(self):
        """Test NetworkInstanceConnectionPointOperState"""
