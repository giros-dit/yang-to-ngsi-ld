...
class TestCommunitySetMatchSetOptions(unittest.TestCase):
    """CommunitySetMatchSetOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunitySetMatchSetOptions:
        """Test CommunitySetMatchSetOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunitySetMatchSetOptions`
        """
        model = CommunitySetMatchSetOptions()
        if include_optional:
            return CommunitySetMatchSetOptions(
                type = 'Property',
                value = 'all',
    ...
    def testCommunitySetMatchSetOptions(self):
        """Test CommunitySetMatchSetOptions"""
