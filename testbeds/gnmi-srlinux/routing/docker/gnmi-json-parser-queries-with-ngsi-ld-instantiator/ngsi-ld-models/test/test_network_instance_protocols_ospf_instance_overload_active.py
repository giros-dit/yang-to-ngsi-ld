...
class TestNetworkInstanceProtocolsOspfInstanceOverloadActive(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceOverloadActive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceOverloadActive:
        """Test NetworkInstanceProtocolsOspfInstanceOverloadActive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceOverloadActive`
        """
        model = NetworkInstanceProtocolsOspfInstanceOverloadActive()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceOverloadActive(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceOverloadActive(self):
        """Test NetworkInstanceProtocolsOspfInstanceOverloadActive"""
