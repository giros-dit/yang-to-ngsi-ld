...
class TestNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric:
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric`
        """
        model = NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric(self):
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOspfv3ExternalLsaMetric"""
