...
class TestNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationTimestamp"""
