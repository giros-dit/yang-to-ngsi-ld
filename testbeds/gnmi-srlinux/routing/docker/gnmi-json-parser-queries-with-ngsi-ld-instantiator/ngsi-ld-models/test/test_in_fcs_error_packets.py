...
class TestInFcsErrorPackets(unittest.TestCase):
    """InFcsErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InFcsErrorPackets:
        """Test InFcsErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InFcsErrorPackets`
        """
        model = InFcsErrorPackets()
        if include_optional:
            return InFcsErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInFcsErrorPackets(self):
        """Test InFcsErrorPackets"""
