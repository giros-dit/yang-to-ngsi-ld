...
class TestDefaultSourceAddress(unittest.TestCase):
    """DefaultSourceAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DefaultSourceAddress:
        """Test DefaultSourceAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DefaultSourceAddress`
        """
        model = DefaultSourceAddress()
        if include_optional:
    ...
    def testDefaultSourceAddress(self):
        """Test DefaultSourceAddress"""
