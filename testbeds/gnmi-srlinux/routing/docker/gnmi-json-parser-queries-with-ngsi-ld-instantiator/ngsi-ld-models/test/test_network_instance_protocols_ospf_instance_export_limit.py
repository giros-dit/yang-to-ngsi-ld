...
class TestNetworkInstanceProtocolsOspfInstanceExportLimit(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceExportLimit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceExportLimit:
        """Test NetworkInstanceProtocolsOspfInstanceExportLimit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceExportLimit`
        """
        model = NetworkInstanceProtocolsOspfInstanceExportLimit()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceExportLimit(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceExportLimit(self):
        """Test NetworkInstanceProtocolsOspfInstanceExportLimit"""
