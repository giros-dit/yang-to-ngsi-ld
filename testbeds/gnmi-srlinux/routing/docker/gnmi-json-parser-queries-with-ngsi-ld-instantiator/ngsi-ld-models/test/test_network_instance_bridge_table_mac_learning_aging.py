...
class TestNetworkInstanceBridgeTableMacLearningAging(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLearningAging unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLearningAging:
        """Test NetworkInstanceBridgeTableMacLearningAging
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLearningAging`
        """
        model = NetworkInstanceBridgeTableMacLearningAging()
        if include_optional:
            return NetworkInstanceBridgeTableMacLearningAging(
                id = '',
    ...
    def testNetworkInstanceBridgeTableMacLearningAging(self):
        """Test NetworkInstanceBridgeTableMacLearningAging"""
