...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceAdminState"""
