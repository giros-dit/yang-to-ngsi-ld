...
class TestSystemSrv6(unittest.TestCase):
    """SystemSrv6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6:
        """Test SystemSrv6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6`
        """
        model = SystemSrv6()
        if include_optional:
            return SystemSrv6(
