...
class TestNetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteOriginNetworkInstance"""
