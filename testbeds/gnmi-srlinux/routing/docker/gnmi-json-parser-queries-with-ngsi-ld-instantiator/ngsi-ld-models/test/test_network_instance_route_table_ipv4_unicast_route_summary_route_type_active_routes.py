...
class TestNetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes"""
