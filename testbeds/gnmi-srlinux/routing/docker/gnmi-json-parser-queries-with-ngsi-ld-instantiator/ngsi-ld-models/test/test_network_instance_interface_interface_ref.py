...
class TestNetworkInstanceInterfaceInterfaceRef(unittest.TestCase):
    """NetworkInstanceInterfaceInterfaceRef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceInterfaceRef:
        """Test NetworkInstanceInterfaceInterfaceRef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceInterfaceRef`
        """
        model = NetworkInstanceInterfaceInterfaceRef()
        if include_optional:
            return NetworkInstanceInterfaceInterfaceRef(
                id = '',
                type = 'NetworkInstanceInterfaceInterfaceRef',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceInterfaceInterfaceRef(self):
        """Test NetworkInstanceInterfaceInterfaceRef"""
