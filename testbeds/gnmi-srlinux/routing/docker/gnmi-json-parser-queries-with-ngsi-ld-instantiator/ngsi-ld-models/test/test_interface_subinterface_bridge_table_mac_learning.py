...
class TestInterfaceSubinterfaceBridgeTableMacLearning(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableMacLearning unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableMacLearning:
        """Test InterfaceSubinterfaceBridgeTableMacLearning
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableMacLearning`
        """
        model = InterfaceSubinterfaceBridgeTableMacLearning()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableMacLearning(
                id = '',
    ...
    def testInterfaceSubinterfaceBridgeTableMacLearning(self):
        """Test InterfaceSubinterfaceBridgeTableMacLearning"""
