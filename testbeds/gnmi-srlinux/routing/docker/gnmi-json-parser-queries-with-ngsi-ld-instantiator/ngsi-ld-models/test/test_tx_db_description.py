...
class TestTxDbDescription(unittest.TestCase):
    """TxDbDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TxDbDescription:
        """Test TxDbDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TxDbDescription`
        """
        model = TxDbDescription()
        if include_optional:
            return TxDbDescription(
                type = 'Property',
                value = 56,
