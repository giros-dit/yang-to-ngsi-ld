...
class TestInterfaceSubinterfaceIpv6StatisticsOutPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsOutPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsOutPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsOutPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsOutPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsOutPackets"""
