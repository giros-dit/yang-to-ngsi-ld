...
class TestInterfaceSubinterfaceAdminState(unittest.TestCase):
    """InterfaceSubinterfaceAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceAdminState:
        """Test InterfaceSubinterfaceAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceAdminState`
        """
        model = InterfaceSubinterfaceAdminState()
        if include_optional:
            return InterfaceSubinterfaceAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testInterfaceSubinterfaceAdminState(self):
        """Test InterfaceSubinterfaceAdminState"""
