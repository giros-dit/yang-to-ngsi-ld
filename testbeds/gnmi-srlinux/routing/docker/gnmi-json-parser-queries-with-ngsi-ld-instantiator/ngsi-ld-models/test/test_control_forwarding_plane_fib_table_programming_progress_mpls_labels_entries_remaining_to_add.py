...
class TestControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd:
        """Test ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd(
                type = 'Property',
                value = 56,
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsEntriesRemainingToAdd"""
