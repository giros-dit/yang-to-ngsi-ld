...
class TestNetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteDynamicLoadBalancing"""
