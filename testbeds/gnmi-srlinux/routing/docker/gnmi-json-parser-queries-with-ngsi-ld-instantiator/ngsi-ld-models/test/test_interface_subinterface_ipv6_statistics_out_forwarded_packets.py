...
class TestInterfaceSubinterfaceIpv6StatisticsOutForwardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsOutForwardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsOutForwardedPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsOutForwardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsOutForwardedPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsOutForwardedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsOutForwardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsOutForwardedPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsOutForwardedPackets"""
