...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsActiveRoutes"""
