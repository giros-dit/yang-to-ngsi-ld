...
class TestInterfaceSubinterfaceIpv6StatisticsLastClear(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsLastClear:
        """Test InterfaceSubinterfaceIpv6StatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsLastClear`
        """
        model = InterfaceSubinterfaceIpv6StatisticsLastClear()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceIpv6StatisticsLastClear(self):
        """Test InterfaceSubinterfaceIpv6StatisticsLastClear"""
