...
class TestPolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid(unittest.TestCase):
    """PolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid:
        """Test PolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid`
        """
        model = PolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid()
        if include_optional:
            return PolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid(
                id = '',
                type = 'PolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid(self):
        """Test PolicyDefaultActionBgpLabelAllocationLabelAllocationMethodPrefixSid"""
