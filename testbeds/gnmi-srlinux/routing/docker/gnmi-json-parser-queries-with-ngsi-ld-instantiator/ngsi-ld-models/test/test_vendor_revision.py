...
class TestVendorRevision(unittest.TestCase):
    """VendorRevision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VendorRevision:
        """Test VendorRevision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VendorRevision`
        """
