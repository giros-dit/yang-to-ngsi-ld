...
class TestInterfaceTransceiverOperState(unittest.TestCase):
    """InterfaceTransceiverOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverOperState:
        """Test InterfaceTransceiverOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverOperState`
        """
        model = InterfaceTransceiverOperState()
        if include_optional:
            return InterfaceTransceiverOperState(
                type = 'Property',
                value = 'up',
    ...
    def testInterfaceTransceiverOperState(self):
        """Test InterfaceTransceiverOperState"""
