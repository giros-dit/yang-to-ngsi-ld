...
class TestTunnelName(unittest.TestCase):
    """TunnelName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TunnelName:
        """Test TunnelName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TunnelName`
        """
        model = TunnelName()
        if include_optional:
            return TunnelName(
