...
class TestInterfaceSubinterfaceStatisticsOutOriginatedOctets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsOutOriginatedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsOutOriginatedOctets:
        """Test InterfaceSubinterfaceStatisticsOutOriginatedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsOutOriginatedOctets`
        """
        model = InterfaceSubinterfaceStatisticsOutOriginatedOctets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsOutOriginatedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsOutOriginatedOctets(self):
        """Test InterfaceSubinterfaceStatisticsOutOriginatedOctets"""
