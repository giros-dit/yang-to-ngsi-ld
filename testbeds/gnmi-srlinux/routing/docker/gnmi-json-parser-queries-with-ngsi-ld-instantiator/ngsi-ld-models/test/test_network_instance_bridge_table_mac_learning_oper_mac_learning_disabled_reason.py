...
class TestNetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason:
        """Test NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason`
        """
        model = NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason()
        if include_optional:
            return NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason(
                type = 'Property',
    ...
    def testNetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason(self):
        """Test NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason"""
