...
class TestNetworkInstanceRouteTableNextHopGroupProgrammedIndex(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupProgrammedIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupProgrammedIndex:
        """Test NetworkInstanceRouteTableNextHopGroupProgrammedIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupProgrammedIndex`
        """
        model = NetworkInstanceRouteTableNextHopGroupProgrammedIndex()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupProgrammedIndex(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopGroupProgrammedIndex(self):
        """Test NetworkInstanceRouteTableNextHopGroupProgrammedIndex"""
