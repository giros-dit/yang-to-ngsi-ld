...
class TestDacLinkTraining(unittest.TestCase):
    """DacLinkTraining unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DacLinkTraining:
        """Test DacLinkTraining
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DacLinkTraining`
        """
        model = DacLinkTraining()
        if include_optional:
            return DacLinkTraining(
                type = 'Property',
                value = True,
