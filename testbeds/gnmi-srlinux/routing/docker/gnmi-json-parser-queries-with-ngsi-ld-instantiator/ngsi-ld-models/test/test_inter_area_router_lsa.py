...
class TestInterAreaRouterLsa(unittest.TestCase):
    """InterAreaRouterLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterAreaRouterLsa:
        """Test InterAreaRouterLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterAreaRouterLsa`
        """
        model = InterAreaRouterLsa()
        if include_optional:
    ...
    def testInterAreaRouterLsa(self):
        """Test InterAreaRouterLsa"""
