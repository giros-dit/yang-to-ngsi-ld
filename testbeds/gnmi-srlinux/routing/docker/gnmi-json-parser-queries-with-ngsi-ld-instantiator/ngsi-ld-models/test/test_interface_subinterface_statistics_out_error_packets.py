...
class TestInterfaceSubinterfaceStatisticsOutErrorPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsOutErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsOutErrorPackets:
        """Test InterfaceSubinterfaceStatisticsOutErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsOutErrorPackets`
        """
        model = InterfaceSubinterfaceStatisticsOutErrorPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsOutErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsOutErrorPackets(self):
        """Test InterfaceSubinterfaceStatisticsOutErrorPackets"""
