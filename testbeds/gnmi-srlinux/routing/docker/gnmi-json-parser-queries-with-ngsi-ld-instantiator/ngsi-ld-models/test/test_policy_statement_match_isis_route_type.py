...
class TestPolicyStatementMatchIsisRouteType(unittest.TestCase):
    """PolicyStatementMatchIsisRouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchIsisRouteType:
        """Test PolicyStatementMatchIsisRouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchIsisRouteType`
        """
        model = PolicyStatementMatchIsisRouteType()
        if include_optional:
            return PolicyStatementMatchIsisRouteType(
                type = 'Property',
                value = 'internal',
    ...
    def testPolicyStatementMatchIsisRouteType(self):
        """Test PolicyStatementMatchIsisRouteType"""
