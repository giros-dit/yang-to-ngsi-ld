...
class TestHelperMode(unittest.TestCase):
    """HelperMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HelperMode:
        """Test HelperMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HelperMode`
        """
        model = HelperMode()
        if include_optional:
            return HelperMode(
