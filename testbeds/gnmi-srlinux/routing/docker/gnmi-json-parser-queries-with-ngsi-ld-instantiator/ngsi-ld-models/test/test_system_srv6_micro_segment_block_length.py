...
class TestSystemSrv6MicroSegmentBlockLength(unittest.TestCase):
    """SystemSrv6MicroSegmentBlockLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6MicroSegmentBlockLength:
        """Test SystemSrv6MicroSegmentBlockLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6MicroSegmentBlockLength`
        """
        model = SystemSrv6MicroSegmentBlockLength()
        if include_optional:
            return SystemSrv6MicroSegmentBlockLength(
                type = 'Property',
                value = 56,
    ...
    def testSystemSrv6MicroSegmentBlockLength(self):
        """Test SystemSrv6MicroSegmentBlockLength"""
