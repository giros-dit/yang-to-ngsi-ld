...
class TestSystemAuthenticationKeychainKeySendLifetimeStartTime(unittest.TestCase):
    """SystemAuthenticationKeychainKeySendLifetimeStartTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKeySendLifetimeStartTime:
        """Test SystemAuthenticationKeychainKeySendLifetimeStartTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKeySendLifetimeStartTime`
        """
        model = SystemAuthenticationKeychainKeySendLifetimeStartTime()
        if include_optional:
            return SystemAuthenticationKeychainKeySendLifetimeStartTime(
                type = 'Property',
                value = '',
    ...
    def testSystemAuthenticationKeychainKeySendLifetimeStartTime(self):
        """Test SystemAuthenticationKeychainKeySendLifetimeStartTime"""
