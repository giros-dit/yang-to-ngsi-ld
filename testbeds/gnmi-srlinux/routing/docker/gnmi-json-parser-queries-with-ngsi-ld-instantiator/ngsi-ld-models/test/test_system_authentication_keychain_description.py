...
class TestSystemAuthenticationKeychainDescription(unittest.TestCase):
    """SystemAuthenticationKeychainDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainDescription:
        """Test SystemAuthenticationKeychainDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainDescription`
        """
        model = SystemAuthenticationKeychainDescription()
        if include_optional:
            return SystemAuthenticationKeychainDescription(
                type = 'Property',
                value = '',
    ...
    def testSystemAuthenticationKeychainDescription(self):
        """Test SystemAuthenticationKeychainDescription"""
