...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsDynamicLoadBalancingRoutes"""
