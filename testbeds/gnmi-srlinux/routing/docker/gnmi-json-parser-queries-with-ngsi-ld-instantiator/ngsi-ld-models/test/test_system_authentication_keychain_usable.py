...
class TestSystemAuthenticationKeychainUsable(unittest.TestCase):
    """SystemAuthenticationKeychainUsable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainUsable:
        """Test SystemAuthenticationKeychainUsable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainUsable`
        """
        model = SystemAuthenticationKeychainUsable()
        if include_optional:
            return SystemAuthenticationKeychainUsable(
                type = 'Property',
                value = True,
    ...
    def testSystemAuthenticationKeychainUsable(self):
        """Test SystemAuthenticationKeychainUsable"""
