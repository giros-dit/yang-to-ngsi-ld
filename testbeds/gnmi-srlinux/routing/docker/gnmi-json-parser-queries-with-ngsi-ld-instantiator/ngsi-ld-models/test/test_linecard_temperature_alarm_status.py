...
class TestLinecardTemperatureAlarmStatus(unittest.TestCase):
    """LinecardTemperatureAlarmStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardTemperatureAlarmStatus:
        """Test LinecardTemperatureAlarmStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardTemperatureAlarmStatus`
        """
        model = LinecardTemperatureAlarmStatus()
        if include_optional:
            return LinecardTemperatureAlarmStatus(
                type = 'Property',
                value = True,
    ...
    def testLinecardTemperatureAlarmStatus(self):
        """Test LinecardTemperatureAlarmStatus"""
