...
class TestNetworkInstanceProtocolsOspfInstanceTimers(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTimers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTimers:
        """Test NetworkInstanceProtocolsOspfInstanceTimers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTimers`
        """
        model = NetworkInstanceProtocolsOspfInstanceTimers()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTimers(
                id = '',
                ...
                incremental_spf_wait = None,
                lsa_accumulate = None,
                lsa_arrival = None,
                redistribute_delay = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceTimers(
    ...
    def testNetworkInstanceProtocolsOspfInstanceTimers(self):
        """Test NetworkInstanceProtocolsOspfInstanceTimers"""
