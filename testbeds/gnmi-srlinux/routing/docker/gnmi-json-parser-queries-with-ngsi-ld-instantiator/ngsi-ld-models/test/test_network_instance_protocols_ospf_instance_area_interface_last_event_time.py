...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEventTime"""
