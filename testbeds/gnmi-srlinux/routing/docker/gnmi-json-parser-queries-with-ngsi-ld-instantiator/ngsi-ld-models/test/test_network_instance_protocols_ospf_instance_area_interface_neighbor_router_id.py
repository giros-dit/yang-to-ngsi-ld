...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId(
                type = 'Property',
                value = '4.207.188.200',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborRouterId"""
