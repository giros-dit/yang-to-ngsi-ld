...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfacePriority(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfacePriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfacePriority:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfacePriority
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfacePriority`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfacePriority()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfacePriority(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfacePriority(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfacePriority"""
