...
class TestNetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastPrefixLengthDistributionLengthActiveRoutes"""
