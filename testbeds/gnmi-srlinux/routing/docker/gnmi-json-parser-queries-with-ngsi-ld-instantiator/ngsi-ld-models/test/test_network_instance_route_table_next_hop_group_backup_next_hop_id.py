...
class TestNetworkInstanceRouteTableNextHopGroupBackupNextHopId(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupBackupNextHopId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupBackupNextHopId:
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupBackupNextHopId`
        """
        model = NetworkInstanceRouteTableNextHopGroupBackupNextHopId()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupBackupNextHopId(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceRouteTableNextHopGroupBackupNextHopId(self):
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopId"""
