...
class TestNetworkInstanceTrafficEngineeringAdminGroupsGroupName(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringAdminGroupsGroupName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringAdminGroupsGroupName:
        """Test NetworkInstanceTrafficEngineeringAdminGroupsGroupName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringAdminGroupsGroupName`
        """
        model = NetworkInstanceTrafficEngineeringAdminGroupsGroupName()
        if include_optional:
            return NetworkInstanceTrafficEngineeringAdminGroupsGroupName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceTrafficEngineeringAdminGroupsGroupName(self):
        """Test NetworkInstanceTrafficEngineeringAdminGroupsGroupName"""
