...
class TestERouterLsa(unittest.TestCase):
    """ERouterLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ERouterLsa:
        """Test ERouterLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ERouterLsa`
        """
        model = ERouterLsa()
        if include_optional:
            return ERouterLsa(
