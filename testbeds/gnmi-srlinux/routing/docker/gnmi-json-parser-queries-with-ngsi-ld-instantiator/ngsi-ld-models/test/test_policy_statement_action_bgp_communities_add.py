...
class TestPolicyStatementActionBgpCommunitiesAdd(unittest.TestCase):
    """PolicyStatementActionBgpCommunitiesAdd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpCommunitiesAdd:
        """Test PolicyStatementActionBgpCommunitiesAdd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpCommunitiesAdd`
        """
        model = PolicyStatementActionBgpCommunitiesAdd()
        if include_optional:
            return PolicyStatementActionBgpCommunitiesAdd(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementActionBgpCommunitiesAdd(self):
        """Test PolicyStatementActionBgpCommunitiesAdd"""
