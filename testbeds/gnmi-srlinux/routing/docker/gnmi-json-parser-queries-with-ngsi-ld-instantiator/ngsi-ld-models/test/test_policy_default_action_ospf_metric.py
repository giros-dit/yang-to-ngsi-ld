...
class TestPolicyDefaultActionOspfMetric(unittest.TestCase):
    """PolicyDefaultActionOspfMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionOspfMetric:
        """Test PolicyDefaultActionOspfMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionOspfMetric`
        """
        model = PolicyDefaultActionOspfMetric()
        if include_optional:
            return PolicyDefaultActionOspfMetric(
                id = '',
                type = 'PolicyDefaultActionOspfMetric',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionOspfMetric(self):
        """Test PolicyDefaultActionOspfMetric"""
