...
class TestSystemLldpInterfaceBgpAutoDiscovery(unittest.TestCase):
    """SystemLldpInterfaceBgpAutoDiscovery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceBgpAutoDiscovery:
        """Test SystemLldpInterfaceBgpAutoDiscovery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceBgpAutoDiscovery`
        """
        model = SystemLldpInterfaceBgpAutoDiscovery()
        if include_optional:
            return SystemLldpInterfaceBgpAutoDiscovery(
                id = '',
                type = 'SystemLldpInterfaceBgpAutoDiscovery',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceBgpAutoDiscovery(self):
        """Test SystemLldpInterfaceBgpAutoDiscovery"""
