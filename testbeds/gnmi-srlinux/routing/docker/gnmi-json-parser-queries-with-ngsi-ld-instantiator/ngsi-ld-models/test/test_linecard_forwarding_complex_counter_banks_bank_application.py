...
class TestLinecardForwardingComplexCounterBanksBankApplication(unittest.TestCase):
    """LinecardForwardingComplexCounterBanksBankApplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexCounterBanksBankApplication:
        """Test LinecardForwardingComplexCounterBanksBankApplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexCounterBanksBankApplication`
        """
        model = LinecardForwardingComplexCounterBanksBankApplication()
        if include_optional:
            return LinecardForwardingComplexCounterBanksBankApplication(
                id = '',
                type = 'LinecardForwardingComplexCounterBanksBankApplication',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexCounterBanksBankApplication(self):
        """Test LinecardForwardingComplexCounterBanksBankApplication"""
