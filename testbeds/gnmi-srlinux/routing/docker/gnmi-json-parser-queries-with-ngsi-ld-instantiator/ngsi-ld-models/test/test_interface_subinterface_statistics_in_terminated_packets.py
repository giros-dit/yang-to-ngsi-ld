...
class TestInterfaceSubinterfaceStatisticsInTerminatedPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInTerminatedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInTerminatedPackets:
        """Test InterfaceSubinterfaceStatisticsInTerminatedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInTerminatedPackets`
        """
        model = InterfaceSubinterfaceStatisticsInTerminatedPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInTerminatedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInTerminatedPackets(self):
        """Test InterfaceSubinterfaceStatisticsInTerminatedPackets"""
