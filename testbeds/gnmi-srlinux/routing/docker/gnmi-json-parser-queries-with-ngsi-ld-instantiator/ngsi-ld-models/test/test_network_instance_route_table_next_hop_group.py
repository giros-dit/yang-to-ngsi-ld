...
class TestNetworkInstanceRouteTableNextHopGroup(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroup:
        """Test NetworkInstanceRouteTableNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroup`
        """
        model = NetworkInstanceRouteTableNextHopGroup()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroup(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopGroup',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopGroup(self):
        """Test NetworkInstanceRouteTableNextHopGroup"""
