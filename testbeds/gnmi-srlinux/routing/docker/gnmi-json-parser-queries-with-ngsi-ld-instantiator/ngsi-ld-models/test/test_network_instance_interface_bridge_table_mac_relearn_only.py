...
class TestNetworkInstanceInterfaceBridgeTableMacRelearnOnly(unittest.TestCase):
    """NetworkInstanceInterfaceBridgeTableMacRelearnOnly unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceBridgeTableMacRelearnOnly:
        """Test NetworkInstanceInterfaceBridgeTableMacRelearnOnly
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceBridgeTableMacRelearnOnly`
        """
        model = NetworkInstanceInterfaceBridgeTableMacRelearnOnly()
        if include_optional:
            return NetworkInstanceInterfaceBridgeTableMacRelearnOnly(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceInterfaceBridgeTableMacRelearnOnly(self):
        """Test NetworkInstanceInterfaceBridgeTableMacRelearnOnly"""
