...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvType"""
