...
class TestSystemAuthenticationKeychainKeyIndex(unittest.TestCase):
    """SystemAuthenticationKeychainKeyIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKeyIndex:
        """Test SystemAuthenticationKeychainKeyIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKeyIndex`
        """
        model = SystemAuthenticationKeychainKeyIndex()
        if include_optional:
            return SystemAuthenticationKeychainKeyIndex(
                type = 'Property',
                value = 56,
    ...
    def testSystemAuthenticationKeychainKeyIndex(self):
        """Test SystemAuthenticationKeychainKeyIndex"""
