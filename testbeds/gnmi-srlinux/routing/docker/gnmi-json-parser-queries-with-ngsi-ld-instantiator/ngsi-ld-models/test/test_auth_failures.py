...
class TestAuthFailures(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AuthFailures:
        """Test AuthFailures
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuthFailures`
        """
        model = AuthFailures()
        if include_optional:
            return AuthFailures(
