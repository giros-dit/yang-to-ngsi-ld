...
class TestSystemLldpLldpMedNetworkPolicyDot1p(unittest.TestCase):
    """SystemLldpLldpMedNetworkPolicyDot1p unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpLldpMedNetworkPolicyDot1p:
        """Test SystemLldpLldpMedNetworkPolicyDot1p
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpLldpMedNetworkPolicyDot1p`
        """
        model = SystemLldpLldpMedNetworkPolicyDot1p()
        if include_optional:
            return SystemLldpLldpMedNetworkPolicyDot1p(
                type = 'Property',
                value = 0,
    ...
    def testSystemLldpLldpMedNetworkPolicyDot1p(self):
        """Test SystemLldpLldpMedNetworkPolicyDot1p"""
