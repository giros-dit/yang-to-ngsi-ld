...
class TestLinecardTemperatureInstant(unittest.TestCase):
    """LinecardTemperatureInstant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardTemperatureInstant:
        """Test LinecardTemperatureInstant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardTemperatureInstant`
        """
        model = LinecardTemperatureInstant()
        if include_optional:
            return LinecardTemperatureInstant(
                type = 'Property',
                value = 56,
    ...
    def testLinecardTemperatureInstant(self):
        """Test LinecardTemperatureInstant"""
