...
class TestNetworkInstanceRouteTableNextHopTunnelIpInIp(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopTunnelIpInIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopTunnelIpInIp:
        """Test NetworkInstanceRouteTableNextHopTunnelIpInIp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopTunnelIpInIp`
        """
        model = NetworkInstanceRouteTableNextHopTunnelIpInIp()
        if include_optional:
            return NetworkInstanceRouteTableNextHopTunnelIpInIp(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopTunnelIpInIp',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopTunnelIpInIp(self):
        """Test NetworkInstanceRouteTableNextHopTunnelIpInIp"""
