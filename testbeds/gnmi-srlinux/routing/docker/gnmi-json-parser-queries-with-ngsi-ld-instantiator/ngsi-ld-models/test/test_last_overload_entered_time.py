...
class TestLastOverloadEnteredTime(unittest.TestCase):
    """LastOverloadEnteredTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LastOverloadEnteredTime:
        """Test LastOverloadEnteredTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LastOverloadEnteredTime`
        """
        model = LastOverloadEnteredTime()
        if include_optional:
            return LastOverloadEnteredTime(
                type = 'Property',
                value = '',
    ...
    def testLastOverloadEnteredTime(self):
        """Test LastOverloadEnteredTime"""
