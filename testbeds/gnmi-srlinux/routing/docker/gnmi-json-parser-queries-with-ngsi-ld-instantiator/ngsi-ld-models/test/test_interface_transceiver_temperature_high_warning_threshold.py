...
class TestInterfaceTransceiverTemperatureHighWarningThreshold(unittest.TestCase):
    """InterfaceTransceiverTemperatureHighWarningThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureHighWarningThreshold:
        """Test InterfaceTransceiverTemperatureHighWarningThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureHighWarningThreshold`
        """
        model = InterfaceTransceiverTemperatureHighWarningThreshold()
        if include_optional:
            return InterfaceTransceiverTemperatureHighWarningThreshold(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceTransceiverTemperatureHighWarningThreshold(self):
        """Test InterfaceTransceiverTemperatureHighWarningThreshold"""
