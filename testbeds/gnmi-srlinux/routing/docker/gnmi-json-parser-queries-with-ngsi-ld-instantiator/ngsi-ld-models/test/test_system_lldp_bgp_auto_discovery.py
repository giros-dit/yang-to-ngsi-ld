...
class TestSystemLldpBgpAutoDiscovery(unittest.TestCase):
    """SystemLldpBgpAutoDiscovery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpBgpAutoDiscovery:
        """Test SystemLldpBgpAutoDiscovery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpBgpAutoDiscovery`
        """
        model = SystemLldpBgpAutoDiscovery()
        if include_optional:
            return SystemLldpBgpAutoDiscovery(
                id = '',
                type = 'SystemLldpBgpAutoDiscovery',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpBgpAutoDiscovery(self):
        """Test SystemLldpBgpAutoDiscovery"""
