...
class TestInBroadcastPackets(unittest.TestCase):
    """InBroadcastPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InBroadcastPackets:
        """Test InBroadcastPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InBroadcastPackets`
        """
        model = InBroadcastPackets()
        if include_optional:
    ...
    def testInBroadcastPackets(self):
        """Test InBroadcastPackets"""
