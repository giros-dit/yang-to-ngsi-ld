...
class TestInterfaceForwardingComplex(unittest.TestCase):
    """InterfaceForwardingComplex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceForwardingComplex:
        """Test InterfaceForwardingComplex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceForwardingComplex`
        """
        model = InterfaceForwardingComplex()
        if include_optional:
            return InterfaceForwardingComplex(
                type = 'Relationship',
                object = '',
    ...
    def testInterfaceForwardingComplex(self):
        """Test InterfaceForwardingComplex"""
