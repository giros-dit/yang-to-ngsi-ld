...
class TestFrameErrorOut(unittest.TestCase):
    """FrameErrorOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FrameErrorOut:
        """Test FrameErrorOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FrameErrorOut`
        """
        model = FrameErrorOut()
        if include_optional:
            return FrameErrorOut(
                type = 'Property',
                value = 56,
