...
class TestNetworkInstanceConnectionPointPseudowireOperState(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireOperState:
        """Test NetworkInstanceConnectionPointPseudowireOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireOperState`
        """
        model = NetworkInstanceConnectionPointPseudowireOperState()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireOperState(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceConnectionPointPseudowireOperState(self):
        """Test NetworkInstanceConnectionPointPseudowireOperState"""
