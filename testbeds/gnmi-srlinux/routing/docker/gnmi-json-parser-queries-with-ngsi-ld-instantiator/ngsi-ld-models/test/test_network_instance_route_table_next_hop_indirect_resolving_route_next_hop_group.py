...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup"""
