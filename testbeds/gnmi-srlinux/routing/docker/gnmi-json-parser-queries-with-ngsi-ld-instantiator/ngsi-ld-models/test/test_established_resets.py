...
class TestEstablishedResets(unittest.TestCase):
    """EstablishedResets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EstablishedResets:
        """Test EstablishedResets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EstablishedResets`
        """
        model = EstablishedResets()
        if include_optional:
            return EstablishedResets(
                type = 'Property',
                value = 56,
    ...
    def testEstablishedResets(self):
        """Test EstablishedResets"""
