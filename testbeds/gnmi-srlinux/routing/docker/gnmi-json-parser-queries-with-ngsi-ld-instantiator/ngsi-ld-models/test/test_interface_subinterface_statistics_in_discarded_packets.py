...
class TestInterfaceSubinterfaceStatisticsInDiscardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInDiscardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInDiscardedPackets:
        """Test InterfaceSubinterfaceStatisticsInDiscardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInDiscardedPackets`
        """
        model = InterfaceSubinterfaceStatisticsInDiscardedPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInDiscardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInDiscardedPackets(self):
        """Test InterfaceSubinterfaceStatisticsInDiscardedPackets"""
