...
class TestNetworkInstanceRouteTableIpv4UnicastRouteActive(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteActive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteActive:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteActive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteActive`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteActive()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteActive(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteActive(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteActive"""
