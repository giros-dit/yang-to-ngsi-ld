...
class TestMonitoringWindow(unittest.TestCase):
    """MonitoringWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MonitoringWindow:
        """Test MonitoringWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MonitoringWindow`
        """
        model = MonitoringWindow()
        if include_optional:
