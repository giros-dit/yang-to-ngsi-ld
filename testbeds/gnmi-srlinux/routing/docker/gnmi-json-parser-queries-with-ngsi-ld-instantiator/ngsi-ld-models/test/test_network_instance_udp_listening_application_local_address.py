...
class TestNetworkInstanceUdpListeningApplicationLocalAddress(unittest.TestCase):
    """NetworkInstanceUdpListeningApplicationLocalAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpListeningApplicationLocalAddress:
        """Test NetworkInstanceUdpListeningApplicationLocalAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpListeningApplicationLocalAddress`
        """
        model = NetworkInstanceUdpListeningApplicationLocalAddress()
        if include_optional:
            return NetworkInstanceUdpListeningApplicationLocalAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceUdpListeningApplicationLocalAddress(self):
        """Test NetworkInstanceUdpListeningApplicationLocalAddress"""
