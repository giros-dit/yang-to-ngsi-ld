...
class TestNetworkInstanceVxlanInterfaceOperState(unittest.TestCase):
    """NetworkInstanceVxlanInterfaceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceVxlanInterfaceOperState:
        """Test NetworkInstanceVxlanInterfaceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceVxlanInterfaceOperState`
        """
        model = NetworkInstanceVxlanInterfaceOperState()
        if include_optional:
            return NetworkInstanceVxlanInterfaceOperState(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceVxlanInterfaceOperState(self):
        """Test NetworkInstanceVxlanInterfaceOperState"""
