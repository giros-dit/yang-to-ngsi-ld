...
class TestLinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason(unittest.TestCase):
    """LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason:
        """Test LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason`
        """
        model = LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason()
        if include_optional:
            return LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason(
                id = '',
                type = 'LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                reason = None,
                extracted_packets = None,
                extracted_octets = None,
                is_part_of = None
            )
        else:
            return LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason(
    ...
    def testLinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason(self):
        """Test LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason"""
