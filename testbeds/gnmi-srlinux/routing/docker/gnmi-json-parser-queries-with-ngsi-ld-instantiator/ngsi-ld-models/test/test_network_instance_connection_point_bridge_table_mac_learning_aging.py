...
class TestNetworkInstanceConnectionPointBridgeTableMacLearningAging(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacLearningAging unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacLearningAging:
        """Test NetworkInstanceConnectionPointBridgeTableMacLearningAging
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacLearningAging`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacLearningAging()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacLearningAging(
                id = '',
                type = 'NetworkInstanceConnectionPointBridgeTableMacLearningAging',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacLearningAging(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacLearningAging"""
