...
class TestNetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed:
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed`
        """
        model = NetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed(self):
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopResourceAllocationFailed"""
