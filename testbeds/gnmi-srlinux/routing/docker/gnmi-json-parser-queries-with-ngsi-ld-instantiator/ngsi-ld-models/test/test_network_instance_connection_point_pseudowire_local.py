...
class TestNetworkInstanceConnectionPointPseudowireLocal(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireLocal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireLocal:
        """Test NetworkInstanceConnectionPointPseudowireLocal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireLocal`
        """
        model = NetworkInstanceConnectionPointPseudowireLocal()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireLocal(
                id = '',
                type = 'NetworkInstanceConnectionPointPseudowireLocal',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                operational_ingress_vc_label = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceConnectionPointPseudowireLocal(
    ...
    def testNetworkInstanceConnectionPointPseudowireLocal(self):
        """Test NetworkInstanceConnectionPointPseudowireLocal"""
