...
class TestNetworkInstanceProtocolsOspfInstanceAreaLsaTotals(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaLsaTotals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaLsaTotals:
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaTotals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaLsaTotals`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaLsaTotals()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaLsaTotals(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceAreaLsaTotals',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                network_lsa = None,
                e_network_lsa = None,
                network_summary_lsa = None,
                asbr_summary_lsa = None,
                nssa_lsa = None,
                e_nssa_lsa = None,
                area_opaque_lsa = None,
                inter_area_prefix_lsa = None,
                e_inter_area_prefix_lsa = None,
                inter_area_router_lsa = None,
                e_inter_area_router_lsa = None,
                intra_area_prefix_lsa = None,
                e_intra_area_prefix_lsa = None,
                router_info_lsa = None,
                unknown_lsa = None,
                total = None,
                total_lsa_cksum_sum = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceAreaLsaTotals(
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaLsaTotals(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaLsaTotals"""
