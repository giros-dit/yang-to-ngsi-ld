...
class TestNetworkInstanceNextHopGroupsGroupBackupNextHopGroup(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupBackupNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupBackupNextHopGroup:
        """Test NetworkInstanceNextHopGroupsGroupBackupNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupBackupNextHopGroup`
        """
        model = NetworkInstanceNextHopGroupsGroupBackupNextHopGroup()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupBackupNextHopGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupBackupNextHopGroup(self):
        """Test NetworkInstanceNextHopGroupsGroupBackupNextHopGroup"""
