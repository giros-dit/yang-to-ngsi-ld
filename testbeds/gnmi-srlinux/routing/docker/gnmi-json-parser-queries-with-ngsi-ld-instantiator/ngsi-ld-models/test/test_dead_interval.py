...
class TestDeadInterval(unittest.TestCase):
    """DeadInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeadInterval:
        """Test DeadInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeadInterval`
        """
        model = DeadInterval()
        if include_optional:
            return DeadInterval(
