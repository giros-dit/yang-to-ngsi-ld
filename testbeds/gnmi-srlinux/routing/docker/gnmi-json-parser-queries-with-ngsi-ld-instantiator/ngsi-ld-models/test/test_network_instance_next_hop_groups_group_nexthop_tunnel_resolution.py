...
class TestNetworkInstanceNextHopGroupsGroupNexthopTunnelResolution(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution:
        """Test NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution(
                id = '',
                type = 'NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopTunnelResolution(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopTunnelResolution"""
