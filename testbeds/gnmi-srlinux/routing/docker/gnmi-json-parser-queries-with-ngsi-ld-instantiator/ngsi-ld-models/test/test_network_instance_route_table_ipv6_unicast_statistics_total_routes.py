...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsTotalRoutes"""
