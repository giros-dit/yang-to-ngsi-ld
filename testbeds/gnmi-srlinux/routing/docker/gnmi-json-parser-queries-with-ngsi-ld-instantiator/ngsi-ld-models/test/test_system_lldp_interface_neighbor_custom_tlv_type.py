...
class TestSystemLldpInterfaceNeighborCustomTlvType(unittest.TestCase):
    """SystemLldpInterfaceNeighborCustomTlvType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborCustomTlvType:
        """Test SystemLldpInterfaceNeighborCustomTlvType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborCustomTlvType`
        """
        model = SystemLldpInterfaceNeighborCustomTlvType()
        if include_optional:
            return SystemLldpInterfaceNeighborCustomTlvType(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceNeighborCustomTlvType(self):
        """Test SystemLldpInterfaceNeighborCustomTlvType"""
