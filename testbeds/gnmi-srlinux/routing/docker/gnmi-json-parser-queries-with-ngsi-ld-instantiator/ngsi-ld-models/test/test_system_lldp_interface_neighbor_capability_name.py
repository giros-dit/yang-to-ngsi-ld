...
class TestSystemLldpInterfaceNeighborCapabilityName(unittest.TestCase):
    """SystemLldpInterfaceNeighborCapabilityName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborCapabilityName:
        """Test SystemLldpInterfaceNeighborCapabilityName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborCapabilityName`
        """
        model = SystemLldpInterfaceNeighborCapabilityName()
        if include_optional:
            return SystemLldpInterfaceNeighborCapabilityName(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborCapabilityName(self):
        """Test SystemLldpInterfaceNeighborCapabilityName"""
