...
class TestDiscarded(unittest.TestCase):
    """Discarded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Discarded:
        """Test Discarded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Discarded`
        """
        model = Discarded()
        if include_optional:
            return Discarded(
