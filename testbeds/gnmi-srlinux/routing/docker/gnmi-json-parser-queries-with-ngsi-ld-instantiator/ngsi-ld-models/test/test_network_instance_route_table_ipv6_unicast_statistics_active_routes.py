...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsActiveRoutes"""
