...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerInstant"""
