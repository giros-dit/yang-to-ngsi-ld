...
class TestNetworkInstanceConnectionPointPseudowireAdminState(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireAdminState:
        """Test NetworkInstanceConnectionPointPseudowireAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireAdminState`
        """
        model = NetworkInstanceConnectionPointPseudowireAdminState()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceConnectionPointPseudowireAdminState(self):
        """Test NetworkInstanceConnectionPointPseudowireAdminState"""
