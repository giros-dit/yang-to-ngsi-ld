...
class TestInterfaceEthernetCrcMonitorSignalFailureExponent(unittest.TestCase):
    """InterfaceEthernetCrcMonitorSignalFailureExponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitorSignalFailureExponent:
        """Test InterfaceEthernetCrcMonitorSignalFailureExponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitorSignalFailureExponent`
        """
        model = InterfaceEthernetCrcMonitorSignalFailureExponent()
        if include_optional:
            return InterfaceEthernetCrcMonitorSignalFailureExponent(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceEthernetCrcMonitorSignalFailureExponent(self):
        """Test InterfaceEthernetCrcMonitorSignalFailureExponent"""
