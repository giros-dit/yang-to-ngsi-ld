...
class TestQueuedBytesAggregate(unittest.TestCase):
    """QueuedBytesAggregate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueuedBytesAggregate:
        """Test QueuedBytesAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueuedBytesAggregate`
        """
        model = QueuedBytesAggregate()
        if include_optional:
            return QueuedBytesAggregate(
                type = 'Property',
                value = 56,
    ...
    def testQueuedBytesAggregate(self):
        """Test QueuedBytesAggregate"""
