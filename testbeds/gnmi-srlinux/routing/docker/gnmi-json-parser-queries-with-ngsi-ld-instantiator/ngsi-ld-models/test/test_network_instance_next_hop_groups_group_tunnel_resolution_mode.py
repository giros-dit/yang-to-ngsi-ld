...
class TestNetworkInstanceNextHopGroupsGroupTunnelResolutionMode(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupTunnelResolutionMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupTunnelResolutionMode:
        """Test NetworkInstanceNextHopGroupsGroupTunnelResolutionMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupTunnelResolutionMode`
        """
        model = NetworkInstanceNextHopGroupsGroupTunnelResolutionMode()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupTunnelResolutionMode(
                type = 'Property',
                value = 'prefer',
    ...
    def testNetworkInstanceNextHopGroupsGroupTunnelResolutionMode(self):
        """Test NetworkInstanceNextHopGroupsGroupTunnelResolutionMode"""
