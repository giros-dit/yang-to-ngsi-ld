...
class TestRedistributeExternal(unittest.TestCase):
    """RedistributeExternal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RedistributeExternal:
        """Test RedistributeExternal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RedistributeExternal`
        """
        model = RedistributeExternal()
        if include_optional:
            return RedistributeExternal(
                type = 'Property',
                value = True,
    ...
    def testRedistributeExternal(self):
        """Test RedistributeExternal"""
