...
class TestNetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations:
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations`
        """
        model = NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations(
                type = 'Property',
                value = 'complex-14.0',
    ...
    def testNetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations(self):
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedLocations"""
