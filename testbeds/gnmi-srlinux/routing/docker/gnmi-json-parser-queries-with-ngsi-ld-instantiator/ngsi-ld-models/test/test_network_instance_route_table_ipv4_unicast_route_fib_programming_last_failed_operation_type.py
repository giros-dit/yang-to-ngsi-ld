...
class TestNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedOperationType"""
