...
class TestBadChecksum(unittest.TestCase):
    """BadChecksum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadChecksum:
        """Test BadChecksum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadChecksum`
        """
        model = BadChecksum()
        if include_optional:
            return BadChecksum(
