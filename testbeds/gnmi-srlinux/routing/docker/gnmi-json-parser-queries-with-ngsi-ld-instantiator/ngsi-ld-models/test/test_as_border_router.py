...
class TestAsBorderRouter(unittest.TestCase):
    """AsBorderRouter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsBorderRouter:
        """Test AsBorderRouter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsBorderRouter`
        """
        model = AsBorderRouter()
        if include_optional:
            return AsBorderRouter(
                type = 'Property',
                value = True,
