...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName(
                type = 'Property',
                value = 'mgmt0.0',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceInterfaceName"""
