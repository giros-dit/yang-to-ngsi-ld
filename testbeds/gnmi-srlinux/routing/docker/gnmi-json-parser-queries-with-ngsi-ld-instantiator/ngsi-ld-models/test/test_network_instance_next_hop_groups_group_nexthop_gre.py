...
class TestNetworkInstanceNextHopGroupsGroupNexthopGre(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopGre unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopGre:
        """Test NetworkInstanceNextHopGroupsGroupNexthopGre
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopGre`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopGre()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopGre(
                id = '',
                type = 'NetworkInstanceNextHopGroupsGroupNexthopGre',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopGre(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopGre"""
