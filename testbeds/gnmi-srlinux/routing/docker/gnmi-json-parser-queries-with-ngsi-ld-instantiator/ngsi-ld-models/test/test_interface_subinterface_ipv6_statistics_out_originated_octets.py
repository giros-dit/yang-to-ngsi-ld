...
class TestInterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets:
        """Test InterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsOutOriginatedOctets"""
