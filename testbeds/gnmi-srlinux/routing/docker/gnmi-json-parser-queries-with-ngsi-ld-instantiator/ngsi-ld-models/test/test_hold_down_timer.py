...
class TestHoldDownTimer(unittest.TestCase):
    """HoldDownTimer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HoldDownTimer:
        """Test HoldDownTimer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HoldDownTimer`
        """
        model = HoldDownTimer()
        if include_optional:
