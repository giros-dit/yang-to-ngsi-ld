...
class TestAsbrSummaryLsa(unittest.TestCase):
    """AsbrSummaryLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsbrSummaryLsa:
        """Test AsbrSummaryLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsbrSummaryLsa`
        """
        model = AsbrSummaryLsa()
        if include_optional:
