...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceInterfaces"""
