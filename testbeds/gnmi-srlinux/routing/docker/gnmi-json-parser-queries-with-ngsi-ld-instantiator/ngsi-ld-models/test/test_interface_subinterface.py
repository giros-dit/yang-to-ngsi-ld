...
class TestInterfaceSubinterface(unittest.TestCase):
    """InterfaceSubinterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterface:
        """Test InterfaceSubinterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterface`
        """
        model = InterfaceSubinterface()
        if include_optional:
            return InterfaceSubinterface(
                ...
                last_change = None,
                collect_irb_stats = None,
                collect_detailed_stats = None,
                is_part_of = None
            )
        else:
            return InterfaceSubinterface(
    ...
    def testInterfaceSubinterface(self):
        """Test InterfaceSubinterface"""
