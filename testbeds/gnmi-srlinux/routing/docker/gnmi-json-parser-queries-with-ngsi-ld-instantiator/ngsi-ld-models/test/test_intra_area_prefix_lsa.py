...
class TestIntraAreaPrefixLsa(unittest.TestCase):
    """IntraAreaPrefixLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntraAreaPrefixLsa:
        """Test IntraAreaPrefixLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntraAreaPrefixLsa`
        """
        model = IntraAreaPrefixLsa()
        if include_optional:
    ...
    def testIntraAreaPrefixLsa(self):
        """Test IntraAreaPrefixLsa"""
