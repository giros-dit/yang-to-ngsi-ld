...
class TestLinecardMda(unittest.TestCase):
    """LinecardMda unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMda:
        """Test LinecardMda
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMda`
        """
        model = LinecardMda()
        if include_optional:
            return LinecardMda(
