...
class TestPolicyDefaultActionBgpNextHopResolution(unittest.TestCase):
    """PolicyDefaultActionBgpNextHopResolution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpNextHopResolution:
        """Test PolicyDefaultActionBgpNextHopResolution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpNextHopResolution`
        """
        model = PolicyDefaultActionBgpNextHopResolution()
        if include_optional:
            return PolicyDefaultActionBgpNextHopResolution(
                id = '',
                type = 'PolicyDefaultActionBgpNextHopResolution',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpNextHopResolution(self):
        """Test PolicyDefaultActionBgpNextHopResolution"""
