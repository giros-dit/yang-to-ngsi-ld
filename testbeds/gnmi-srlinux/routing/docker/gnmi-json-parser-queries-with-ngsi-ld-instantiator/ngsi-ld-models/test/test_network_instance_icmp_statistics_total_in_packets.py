...
class TestNetworkInstanceIcmpStatisticsTotalInPackets(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTotalInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTotalInPackets:
        """Test NetworkInstanceIcmpStatisticsTotalInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTotalInPackets`
        """
        model = NetworkInstanceIcmpStatisticsTotalInPackets()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTotalInPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmpStatisticsTotalInPackets(self):
        """Test NetworkInstanceIcmpStatisticsTotalInPackets"""
