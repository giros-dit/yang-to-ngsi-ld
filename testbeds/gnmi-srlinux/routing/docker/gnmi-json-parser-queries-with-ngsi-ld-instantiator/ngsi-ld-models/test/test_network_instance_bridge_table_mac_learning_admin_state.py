...
class TestNetworkInstanceBridgeTableMacLearningAdminState(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLearningAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLearningAdminState:
        """Test NetworkInstanceBridgeTableMacLearningAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLearningAdminState`
        """
        model = NetworkInstanceBridgeTableMacLearningAdminState()
        if include_optional:
            return NetworkInstanceBridgeTableMacLearningAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceBridgeTableMacLearningAdminState(self):
        """Test NetworkInstanceBridgeTableMacLearningAdminState"""
