...
class TestPolicyDefaultActionBgpAsPathPrepend(unittest.TestCase):
    """PolicyDefaultActionBgpAsPathPrepend unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpAsPathPrepend:
        """Test PolicyDefaultActionBgpAsPathPrepend
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpAsPathPrepend`
        """
        model = PolicyDefaultActionBgpAsPathPrepend()
        if include_optional:
            return PolicyDefaultActionBgpAsPathPrepend(
                id = '',
                type = 'PolicyDefaultActionBgpAsPathPrepend',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpAsPathPrepend(self):
        """Test PolicyDefaultActionBgpAsPathPrepend"""
