...
class TestInterfaceSubinterfaceIpv4StatisticsInTerminatedPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInTerminatedPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets"""
