...
class TestPolicyStatementMatchInternalTagsMatchSetOptions(unittest.TestCase):
    """PolicyStatementMatchInternalTagsMatchSetOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchInternalTagsMatchSetOptions:
        """Test PolicyStatementMatchInternalTagsMatchSetOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchInternalTagsMatchSetOptions`
        """
        model = PolicyStatementMatchInternalTagsMatchSetOptions()
        if include_optional:
            return PolicyStatementMatchInternalTagsMatchSetOptions(
                type = 'Property',
                value = 'any',
    ...
    def testPolicyStatementMatchInternalTagsMatchSetOptions(self):
        """Test PolicyStatementMatchInternalTagsMatchSetOptions"""
