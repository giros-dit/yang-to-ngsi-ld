...
class TestIpv4Prefix(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Ipv4Prefix:
        """Test Ipv4Prefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Ipv4Prefix`
        """
        model = Ipv4Prefix()
        if include_optional:
            return Ipv4Prefix(
