...
class TestNetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp:
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp`
        """
        model = NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp(self):
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingLastSuccessfulOperationTimestamp"""
