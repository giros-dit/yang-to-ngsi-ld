...
class TestControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime:
        """Test ControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime(
                type = 'Property',
                value = '',
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressTunnelsLastSyncTime"""
