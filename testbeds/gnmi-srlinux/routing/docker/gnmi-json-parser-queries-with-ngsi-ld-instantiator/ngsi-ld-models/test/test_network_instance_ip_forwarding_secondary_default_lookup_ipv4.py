...
class TestNetworkInstanceIpForwardingSecondaryDefaultLookupIpv4(unittest.TestCase):
    """NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4:
        """Test NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4`
        """
        model = NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4()
        if include_optional:
            return NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4(
                type = 'Property',
                value = 'inactive',
    ...
    def testNetworkInstanceIpForwardingSecondaryDefaultLookupIpv4(self):
        """Test NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4"""
