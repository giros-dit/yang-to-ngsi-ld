...
class TestNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastSuccessfulOperationType"""
