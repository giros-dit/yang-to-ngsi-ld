...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceGracefulRestart"""
