...
class TestNetworkInstanceProtocolsOspfInstanceAreaStubSummaries(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaStubSummaries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaStubSummaries:
        """Test NetworkInstanceProtocolsOspfInstanceAreaStubSummaries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaStubSummaries`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaStubSummaries()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaStubSummaries(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaStubSummaries(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaStubSummaries"""
