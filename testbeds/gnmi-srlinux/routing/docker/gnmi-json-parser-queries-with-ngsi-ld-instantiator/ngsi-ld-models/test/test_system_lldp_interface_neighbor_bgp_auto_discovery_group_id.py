...
class TestSystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId(unittest.TestCase):
    """SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId:
        """Test SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId`
        """
        model = SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId()
        if include_optional:
            return SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId(self):
        """Test SystemLldpInterfaceNeighborBgpAutoDiscoveryGroupId"""
