...
class TestNetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing:
        """Test NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing`
        """
        model = NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing(self):
        """Test NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancing"""
