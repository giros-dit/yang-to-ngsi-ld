...
class TestOperationalTunnelId(unittest.TestCase):
    """OperationalTunnelId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalTunnelId:
        """Test OperationalTunnelId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalTunnelId`
        """
        model = OperationalTunnelId()
        if include_optional:
            return OperationalTunnelId(
                type = 'Property',
                value = 56,
    ...
    def testOperationalTunnelId(self):
        """Test OperationalTunnelId"""
