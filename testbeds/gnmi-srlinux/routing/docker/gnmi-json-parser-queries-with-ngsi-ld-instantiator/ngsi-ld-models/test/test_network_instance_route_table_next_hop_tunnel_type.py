...
class TestNetworkInstanceRouteTableNextHopTunnelType(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopTunnelType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopTunnelType:
        """Test NetworkInstanceRouteTableNextHopTunnelType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopTunnelType`
        """
        model = NetworkInstanceRouteTableNextHopTunnelType()
        if include_optional:
            return NetworkInstanceRouteTableNextHopTunnelType(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopTunnelType(self):
        """Test NetworkInstanceRouteTableNextHopTunnelType"""
