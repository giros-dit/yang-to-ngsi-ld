...
class TestAdvertiseSubnet(unittest.TestCase):
    """AdvertiseSubnet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdvertiseSubnet:
        """Test AdvertiseSubnet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdvertiseSubnet`
        """
        model = AdvertiseSubnet()
        if include_optional:
            return AdvertiseSubnet(
                type = 'Property',
                value = True,
