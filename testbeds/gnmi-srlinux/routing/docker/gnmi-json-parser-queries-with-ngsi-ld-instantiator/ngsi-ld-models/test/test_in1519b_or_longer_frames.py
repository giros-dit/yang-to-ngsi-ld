...
class TestIn1519bOrLongerFrames(unittest.TestCase):
    """In1519bOrLongerFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> In1519bOrLongerFrames:
        """Test In1519bOrLongerFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `In1519bOrLongerFrames`
        """
        model = In1519bOrLongerFrames()
        if include_optional:
            return In1519bOrLongerFrames(
                type = 'Property',
                value = 56,
    ...
    def testIn1519bOrLongerFrames(self):
        """Test In1519bOrLongerFrames"""
