...
class TestRisingThresholdAction(unittest.TestCase):
    """RisingThresholdAction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RisingThresholdAction:
        """Test RisingThresholdAction
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RisingThresholdAction`
        """
        model = RisingThresholdAction()
        if include_optional:
            return RisingThresholdAction(
                type = 'Property',
                value = 'none',
    ...
    def testRisingThresholdAction(self):
        """Test RisingThresholdAction"""
