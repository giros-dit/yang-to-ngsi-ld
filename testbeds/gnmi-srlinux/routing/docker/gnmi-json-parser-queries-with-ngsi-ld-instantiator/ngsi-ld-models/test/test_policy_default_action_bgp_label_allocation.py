...
class TestPolicyDefaultActionBgpLabelAllocation(unittest.TestCase):
    """PolicyDefaultActionBgpLabelAllocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpLabelAllocation:
        """Test PolicyDefaultActionBgpLabelAllocation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpLabelAllocation`
        """
        model = PolicyDefaultActionBgpLabelAllocation()
        if include_optional:
            return PolicyDefaultActionBgpLabelAllocation(
                id = '',
                type = 'PolicyDefaultActionBgpLabelAllocation',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpLabelAllocation(self):
        """Test PolicyDefaultActionBgpLabelAllocation"""
