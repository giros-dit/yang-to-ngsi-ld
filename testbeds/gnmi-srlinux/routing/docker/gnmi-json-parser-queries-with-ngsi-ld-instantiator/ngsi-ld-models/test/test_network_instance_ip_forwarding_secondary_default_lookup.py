...
class TestNetworkInstanceIpForwardingSecondaryDefaultLookup(unittest.TestCase):
    """NetworkInstanceIpForwardingSecondaryDefaultLookup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIpForwardingSecondaryDefaultLookup:
        """Test NetworkInstanceIpForwardingSecondaryDefaultLookup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIpForwardingSecondaryDefaultLookup`
        """
        model = NetworkInstanceIpForwardingSecondaryDefaultLookup()
        if include_optional:
            return NetworkInstanceIpForwardingSecondaryDefaultLookup(
                id = '',
                type = 'NetworkInstanceIpForwardingSecondaryDefaultLookup',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceIpForwardingSecondaryDefaultLookup(self):
        """Test NetworkInstanceIpForwardingSecondaryDefaultLookup"""
