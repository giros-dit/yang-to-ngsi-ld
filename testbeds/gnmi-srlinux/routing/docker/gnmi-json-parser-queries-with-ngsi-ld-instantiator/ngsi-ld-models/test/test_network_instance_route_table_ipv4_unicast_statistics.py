...
class TestNetworkInstanceRouteTableIpv4UnicastStatistics(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatistics:
        """Test NetworkInstanceRouteTableIpv4UnicastStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatistics`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatistics()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatistics(
                id = '',
                type = 'NetworkInstanceRouteTableIpv4UnicastStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                active_routes = None,
                active_routes_with_ecmp = None,
                leaked_routes = None,
                resilient_hash_routes = None,
                dynamic_load_balancing_routes = None,
                fib_failed_routes = None,
                fib_suppressed_routes = None,
                routes_with_per_prefix_statistics = None,
                total_routes = None,
                is_part_of = None
            )
        else:
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatistics(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatistics"""
