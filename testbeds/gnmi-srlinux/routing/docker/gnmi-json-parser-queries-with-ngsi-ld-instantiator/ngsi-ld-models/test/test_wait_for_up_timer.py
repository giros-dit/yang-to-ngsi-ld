...
class TestWaitForUpTimer(unittest.TestCase):
    """WaitForUpTimer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WaitForUpTimer:
        """Test WaitForUpTimer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WaitForUpTimer`
        """
        model = WaitForUpTimer()
        if include_optional:
            return WaitForUpTimer(
                type = 'Property',
                value = 1,
