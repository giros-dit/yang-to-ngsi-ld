...
class TestLsaFilterOut(unittest.TestCase):
    """LsaFilterOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LsaFilterOut:
        """Test LsaFilterOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LsaFilterOut`
        """
        model = LsaFilterOut()
        if include_optional:
            return LsaFilterOut(
