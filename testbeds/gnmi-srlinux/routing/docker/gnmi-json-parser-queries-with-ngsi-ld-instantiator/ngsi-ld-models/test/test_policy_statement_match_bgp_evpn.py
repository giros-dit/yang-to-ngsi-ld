...
class TestPolicyStatementMatchBgpEvpn(unittest.TestCase):
    """PolicyStatementMatchBgpEvpn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpEvpn:
        """Test PolicyStatementMatchBgpEvpn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpEvpn`
        """
        model = PolicyStatementMatchBgpEvpn()
        if include_optional:
            return PolicyStatementMatchBgpEvpn(
                id = '',
                type = 'PolicyStatementMatchBgpEvpn',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchBgpEvpn(self):
        """Test PolicyStatementMatchBgpEvpn"""
