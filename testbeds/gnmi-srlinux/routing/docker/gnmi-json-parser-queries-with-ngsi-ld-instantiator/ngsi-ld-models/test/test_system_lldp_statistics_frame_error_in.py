...
class TestSystemLldpStatisticsFrameErrorIn(unittest.TestCase):
    """SystemLldpStatisticsFrameErrorIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpStatisticsFrameErrorIn:
        """Test SystemLldpStatisticsFrameErrorIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpStatisticsFrameErrorIn`
        """
        model = SystemLldpStatisticsFrameErrorIn()
        if include_optional:
            return SystemLldpStatisticsFrameErrorIn(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpStatisticsFrameErrorIn(self):
        """Test SystemLldpStatisticsFrameErrorIn"""
