...
class TestOptionMismatches(unittest.TestCase):
    """OptionMismatches unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OptionMismatches:
        """Test OptionMismatches
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OptionMismatches`
        """
        model = OptionMismatches()
        if include_optional:
            return OptionMismatches(
                type = 'Property',
                value = 56,
