...
class TestSystemLldpInterfaceStatisticsFrameOut(unittest.TestCase):
    """SystemLldpInterfaceStatisticsFrameOut unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceStatisticsFrameOut:
        """Test SystemLldpInterfaceStatisticsFrameOut
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceStatisticsFrameOut`
        """
        model = SystemLldpInterfaceStatisticsFrameOut()
        if include_optional:
            return SystemLldpInterfaceStatisticsFrameOut(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpInterfaceStatisticsFrameOut(self):
        """Test SystemLldpInterfaceStatisticsFrameOut"""
