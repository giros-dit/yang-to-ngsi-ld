...
class TestSystemLldpInterfaceLldpMedOperState(unittest.TestCase):
    """SystemLldpInterfaceLldpMedOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedOperState:
        """Test SystemLldpInterfaceLldpMedOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedOperState`
        """
        model = SystemLldpInterfaceLldpMedOperState()
        if include_optional:
            return SystemLldpInterfaceLldpMedOperState(
                type = 'Property',
                value = 'up',
    ...
    def testSystemLldpInterfaceLldpMedOperState(self):
        """Test SystemLldpInterfaceLldpMedOperState"""
