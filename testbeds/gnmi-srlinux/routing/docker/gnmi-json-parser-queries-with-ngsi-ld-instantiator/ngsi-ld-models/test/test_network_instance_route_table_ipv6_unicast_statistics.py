...
class TestNetworkInstanceRouteTableIpv6UnicastStatistics(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatistics:
        """Test NetworkInstanceRouteTableIpv6UnicastStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatistics`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatistics()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatistics(
                id = '',
                type = 'NetworkInstanceRouteTableIpv6UnicastStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatistics(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatistics"""
