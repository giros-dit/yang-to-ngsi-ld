...
class TestNetworkInstanceSystemIpv4AddressOperState(unittest.TestCase):
    """NetworkInstanceSystemIpv4AddressOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceSystemIpv4AddressOperState:
        """Test NetworkInstanceSystemIpv4AddressOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceSystemIpv4AddressOperState`
        """
        model = NetworkInstanceSystemIpv4AddressOperState()
        if include_optional:
            return NetworkInstanceSystemIpv4AddressOperState(
                type = 'Property',
                value = 'up',
    ...
    def testNetworkInstanceSystemIpv4AddressOperState(self):
        """Test NetworkInstanceSystemIpv4AddressOperState"""
