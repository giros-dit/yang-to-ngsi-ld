...
class TestPhyGroupMembers(unittest.TestCase):
    """PhyGroupMembers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhyGroupMembers:
        """Test PhyGroupMembers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhyGroupMembers`
        """
        model = PhyGroupMembers()
        if include_optional:
            return PhyGroupMembers(
                type = 'Property',
                value = '',
