...
class TestNssaLsa(unittest.TestCase):
    """NssaLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NssaLsa:
        """Test NssaLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NssaLsa`
        """
        model = NssaLsa()
        if include_optional:
            return NssaLsa(
