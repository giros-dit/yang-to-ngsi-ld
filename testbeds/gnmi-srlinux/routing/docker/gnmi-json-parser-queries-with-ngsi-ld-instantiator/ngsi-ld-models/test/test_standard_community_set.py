...
class TestStandardCommunitySet(unittest.TestCase):
    """StandardCommunitySet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardCommunitySet:
        """Test StandardCommunitySet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardCommunitySet`
        """
        model = StandardCommunitySet()
        if include_optional:
            return StandardCommunitySet(
                id = '',
                type = 'StandardCommunitySet',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testStandardCommunitySet(self):
        """Test StandardCommunitySet"""
