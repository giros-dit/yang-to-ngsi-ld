...
class TestMulticastRate(unittest.TestCase):
    """MulticastRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MulticastRate:
        """Test MulticastRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MulticastRate`
        """
        model = MulticastRate()
        if include_optional:
