...
class TestInterfaceEthernetSymbolMonitorSignalFailureExponent(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorSignalFailureExponent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorSignalFailureExponent:
        """Test InterfaceEthernetSymbolMonitorSignalFailureExponent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorSignalFailureExponent`
        """
        model = InterfaceEthernetSymbolMonitorSignalFailureExponent()
        if include_optional:
            return InterfaceEthernetSymbolMonitorSignalFailureExponent(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceEthernetSymbolMonitorSignalFailureExponent(self):
        """Test InterfaceEthernetSymbolMonitorSignalFailureExponent"""
