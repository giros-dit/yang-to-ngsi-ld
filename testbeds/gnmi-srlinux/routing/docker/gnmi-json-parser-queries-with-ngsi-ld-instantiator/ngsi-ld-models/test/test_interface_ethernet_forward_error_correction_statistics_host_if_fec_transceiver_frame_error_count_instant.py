...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant"""
