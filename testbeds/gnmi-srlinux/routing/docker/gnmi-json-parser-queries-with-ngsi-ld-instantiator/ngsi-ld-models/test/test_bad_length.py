...
class TestBadLength(unittest.TestCase):
    """BadLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BadLength:
        """Test BadLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BadLength`
        """
        model = BadLength()
        if include_optional:
            return BadLength(
