...
class TestControlSlot(unittest.TestCase):
    """ControlSlot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlSlot:
        """Test ControlSlot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlSlot`
        """
        model = ControlSlot()
        if include_optional:
            return ControlSlot(
