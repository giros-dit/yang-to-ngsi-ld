...
class TestSuppressThreshold(unittest.TestCase):
    """SuppressThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SuppressThreshold:
        """Test SuppressThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SuppressThreshold`
        """
        model = SuppressThreshold()
        if include_optional:
    ...
    def testSuppressThreshold(self):
        """Test SuppressThreshold"""
