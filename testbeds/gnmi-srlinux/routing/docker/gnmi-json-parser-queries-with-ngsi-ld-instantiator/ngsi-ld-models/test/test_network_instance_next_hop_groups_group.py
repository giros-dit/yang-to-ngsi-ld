...
class TestNetworkInstanceNextHopGroupsGroup(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroup:
        """Test NetworkInstanceNextHopGroupsGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroup`
        """
        model = NetworkInstanceNextHopGroupsGroup()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroup(
                id = '',
    ...
    def testNetworkInstanceNextHopGroupsGroup(self):
        """Test NetworkInstanceNextHopGroupsGroup"""
