...
class TestFunctionalType(unittest.TestCase):
    """FunctionalType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionalType:
        """Test FunctionalType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionalType`
        """
        model = FunctionalType()
        if include_optional:
