...
class TestNetworkInstanceStaticRoutesRoutePrefix(unittest.TestCase):
    """NetworkInstanceStaticRoutesRoutePrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesRoutePrefix:
        """Test NetworkInstanceStaticRoutesRoutePrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesRoutePrefix`
        """
        model = NetworkInstanceStaticRoutesRoutePrefix()
        if include_optional:
            return NetworkInstanceStaticRoutesRoutePrefix(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceStaticRoutesRoutePrefix(self):
        """Test NetworkInstanceStaticRoutesRoutePrefix"""
