...
class TestPolicyStatementActionInternalTags(unittest.TestCase):
    """PolicyStatementActionInternalTags unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionInternalTags:
        """Test PolicyStatementActionInternalTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionInternalTags`
        """
        model = PolicyStatementActionInternalTags()
        if include_optional:
            return PolicyStatementActionInternalTags(
                id = '',
                type = 'PolicyStatementActionInternalTags',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionInternalTags(self):
        """Test PolicyStatementActionInternalTags"""
