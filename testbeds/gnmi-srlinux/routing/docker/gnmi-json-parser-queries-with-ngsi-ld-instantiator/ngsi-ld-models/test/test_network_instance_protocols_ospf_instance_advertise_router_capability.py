...
class TestNetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability:
        """Test NetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability`
        """
        model = NetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability(
                type = 'Property',
                value = 'false',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability(self):
        """Test NetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability"""
