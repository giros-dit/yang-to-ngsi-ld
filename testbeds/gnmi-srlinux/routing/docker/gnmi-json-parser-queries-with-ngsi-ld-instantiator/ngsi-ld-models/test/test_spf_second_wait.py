...
class TestSpfSecondWait(unittest.TestCase):
    """SpfSecondWait unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpfSecondWait:
        """Test SpfSecondWait
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpfSecondWait`
        """
        model = SpfSecondWait()
        if include_optional:
            return SpfSecondWait(
                type = 'Property',
                value = 10,
