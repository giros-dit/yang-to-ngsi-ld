...
class TestNetworkInstanceBridgeTableTldpMacFlush(unittest.TestCase):
    """NetworkInstanceBridgeTableTldpMacFlush unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableTldpMacFlush:
        """Test NetworkInstanceBridgeTableTldpMacFlush
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableTldpMacFlush`
        """
        model = NetworkInstanceBridgeTableTldpMacFlush()
        if include_optional:
            return NetworkInstanceBridgeTableTldpMacFlush(
                id = '',
                type = 'NetworkInstanceBridgeTableTldpMacFlush',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceBridgeTableTldpMacFlush(self):
        """Test NetworkInstanceBridgeTableTldpMacFlush"""
