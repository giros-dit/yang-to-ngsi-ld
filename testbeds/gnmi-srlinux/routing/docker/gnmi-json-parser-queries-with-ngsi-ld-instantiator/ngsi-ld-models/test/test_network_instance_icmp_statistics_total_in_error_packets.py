...
class TestNetworkInstanceIcmpStatisticsTotalInErrorPackets(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTotalInErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTotalInErrorPackets:
        """Test NetworkInstanceIcmpStatisticsTotalInErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTotalInErrorPackets`
        """
        model = NetworkInstanceIcmpStatisticsTotalInErrorPackets()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTotalInErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmpStatisticsTotalInErrorPackets(self):
        """Test NetworkInstanceIcmpStatisticsTotalInErrorPackets"""
