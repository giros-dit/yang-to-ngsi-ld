...
class TestNetworkInstanceConnectionPointPseudowireOperDownReason(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireOperDownReason:
        """Test NetworkInstanceConnectionPointPseudowireOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireOperDownReason`
        """
        model = NetworkInstanceConnectionPointPseudowireOperDownReason()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireOperDownReason(
                type = 'Property',
    ...
    def testNetworkInstanceConnectionPointPseudowireOperDownReason(self):
        """Test NetworkInstanceConnectionPointPseudowireOperDownReason"""
