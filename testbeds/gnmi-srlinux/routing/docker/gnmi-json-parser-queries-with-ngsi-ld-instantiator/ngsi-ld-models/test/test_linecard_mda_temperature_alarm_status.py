...
class TestLinecardMdaTemperatureAlarmStatus(unittest.TestCase):
    """LinecardMdaTemperatureAlarmStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaTemperatureAlarmStatus:
        """Test LinecardMdaTemperatureAlarmStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaTemperatureAlarmStatus`
        """
        model = LinecardMdaTemperatureAlarmStatus()
        if include_optional:
            return LinecardMdaTemperatureAlarmStatus(
                type = 'Property',
                value = True,
    ...
    def testLinecardMdaTemperatureAlarmStatus(self):
        """Test LinecardMdaTemperatureAlarmStatus"""
