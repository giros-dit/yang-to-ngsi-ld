...
class TestNetworkInstanceRouteTableNextHopMplsTunnelOwner(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopMplsTunnelOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopMplsTunnelOwner:
        """Test NetworkInstanceRouteTableNextHopMplsTunnelOwner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopMplsTunnelOwner`
        """
        model = NetworkInstanceRouteTableNextHopMplsTunnelOwner()
        if include_optional:
            return NetworkInstanceRouteTableNextHopMplsTunnelOwner(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopMplsTunnelOwner(self):
        """Test NetworkInstanceRouteTableNextHopMplsTunnelOwner"""
