...
class TestNetworkInstanceProtocolsOspfInstanceSpfLastFullSpf(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf:
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf`
        """
        model = NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                intra_spf_time = None,
                inter_spf_time = None,
                extern_spf_time = None,
                rtm_update_time = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf(
    ...
    def testNetworkInstanceProtocolsOspfInstanceSpfLastFullSpf(self):
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastFullSpf"""
