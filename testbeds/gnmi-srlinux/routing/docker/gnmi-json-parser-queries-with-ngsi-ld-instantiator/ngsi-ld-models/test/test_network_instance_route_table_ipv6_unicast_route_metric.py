...
class TestNetworkInstanceRouteTableIpv6UnicastRouteMetric(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteMetric:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteMetric`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteMetric()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteMetric(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteMetric(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteMetric"""
