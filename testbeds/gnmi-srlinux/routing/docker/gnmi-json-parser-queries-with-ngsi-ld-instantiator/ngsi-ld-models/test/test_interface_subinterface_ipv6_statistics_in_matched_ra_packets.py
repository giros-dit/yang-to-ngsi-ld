...
class TestInterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets:
        """Test InterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets`
        """
        model = InterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets(self):
        """Test InterfaceSubinterfaceIpv6StatisticsInMatchedRaPackets"""
