...
class TestQueuedAggregate(unittest.TestCase):
    """QueuedAggregate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QueuedAggregate:
        """Test QueuedAggregate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QueuedAggregate`
        """
        model = QueuedAggregate()
        if include_optional:
            return QueuedAggregate(
                type = 'Property',
                value = 56,
