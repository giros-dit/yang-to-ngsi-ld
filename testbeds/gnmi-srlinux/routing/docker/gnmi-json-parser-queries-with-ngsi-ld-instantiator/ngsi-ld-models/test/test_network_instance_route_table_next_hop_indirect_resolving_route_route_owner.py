...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner"""
