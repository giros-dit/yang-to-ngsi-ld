...
class TestNetworkInstanceConnectionPointOperDownReason(unittest.TestCase):
    """NetworkInstanceConnectionPointOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointOperDownReason:
        """Test NetworkInstanceConnectionPointOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointOperDownReason`
        """
        model = NetworkInstanceConnectionPointOperDownReason()
        if include_optional:
            return NetworkInstanceConnectionPointOperDownReason(
                type = 'Property',
                value = 'mac-dup-detected',
    ...
    def testNetworkInstanceConnectionPointOperDownReason(self):
        """Test NetworkInstanceConnectionPointOperDownReason"""
