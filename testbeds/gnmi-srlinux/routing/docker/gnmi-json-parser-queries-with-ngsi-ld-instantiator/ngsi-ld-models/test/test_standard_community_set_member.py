...
class TestStandardCommunitySetMember(unittest.TestCase):
    """StandardCommunitySetMember unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandardCommunitySetMember:
        """Test StandardCommunitySetMember
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandardCommunitySetMember`
        """
        model = StandardCommunitySetMember()
        if include_optional:
            return StandardCommunitySetMember(
                type = 'Property',
                value = '',
    ...
    def testStandardCommunitySetMember(self):
        """Test StandardCommunitySetMember"""
