...
class TestSystemTraceOptions(unittest.TestCase):
    """SystemTraceOptions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemTraceOptions:
        """Test SystemTraceOptions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemTraceOptions`
        """
        model = SystemTraceOptions()
        if include_optional:
            return SystemTraceOptions(
                type = 'Property',
                value = 'request',
    ...
    def testSystemTraceOptions(self):
        """Test SystemTraceOptions"""
