...
class TestNetworkInstanceBridgeTableMacDuplicationAdminState(unittest.TestCase):
    """NetworkInstanceBridgeTableMacDuplicationAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacDuplicationAdminState:
        """Test NetworkInstanceBridgeTableMacDuplicationAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacDuplicationAdminState`
        """
        model = NetworkInstanceBridgeTableMacDuplicationAdminState()
        if include_optional:
            return NetworkInstanceBridgeTableMacDuplicationAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceBridgeTableMacDuplicationAdminState(self):
        """Test NetworkInstanceBridgeTableMacDuplicationAdminState"""
