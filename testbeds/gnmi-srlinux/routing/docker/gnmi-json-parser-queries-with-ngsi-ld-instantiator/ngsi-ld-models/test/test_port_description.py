...
class TestPortDescription(unittest.TestCase):
    """PortDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortDescription:
        """Test PortDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortDescription`
        """
        model = PortDescription()
        if include_optional:
