...
class TestELinkLsa(unittest.TestCase):
    """ELinkLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ELinkLsa:
        """Test ELinkLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ELinkLsa`
        """
        model = ELinkLsa()
        if include_optional:
            return ELinkLsa(
