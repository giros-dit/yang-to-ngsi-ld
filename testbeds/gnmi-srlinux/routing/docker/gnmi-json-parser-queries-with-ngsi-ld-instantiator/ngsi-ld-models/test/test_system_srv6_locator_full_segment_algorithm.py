...
class TestSystemSrv6LocatorFullSegmentAlgorithm(unittest.TestCase):
    """SystemSrv6LocatorFullSegmentAlgorithm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorFullSegmentAlgorithm:
        """Test SystemSrv6LocatorFullSegmentAlgorithm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorFullSegmentAlgorithm`
        """
        model = SystemSrv6LocatorFullSegmentAlgorithm()
        if include_optional:
            return SystemSrv6LocatorFullSegmentAlgorithm(
                type = 'Property',
                value = 0,
    ...
    def testSystemSrv6LocatorFullSegmentAlgorithm(self):
        """Test SystemSrv6LocatorFullSegmentAlgorithm"""
