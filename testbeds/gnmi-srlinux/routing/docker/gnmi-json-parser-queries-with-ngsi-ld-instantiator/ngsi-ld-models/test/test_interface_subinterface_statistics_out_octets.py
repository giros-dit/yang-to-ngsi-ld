...
class TestInterfaceSubinterfaceStatisticsOutOctets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsOutOctets:
        """Test InterfaceSubinterfaceStatisticsOutOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsOutOctets`
        """
        model = InterfaceSubinterfaceStatisticsOutOctets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsOutOctets(self):
        """Test InterfaceSubinterfaceStatisticsOutOctets"""
