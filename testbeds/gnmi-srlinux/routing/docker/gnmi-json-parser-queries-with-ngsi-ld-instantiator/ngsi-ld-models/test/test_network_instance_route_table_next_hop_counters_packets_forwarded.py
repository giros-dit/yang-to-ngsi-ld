...
class TestNetworkInstanceRouteTableNextHopCountersPacketsForwarded(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopCountersPacketsForwarded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopCountersPacketsForwarded:
        """Test NetworkInstanceRouteTableNextHopCountersPacketsForwarded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopCountersPacketsForwarded`
        """
        model = NetworkInstanceRouteTableNextHopCountersPacketsForwarded()
        if include_optional:
            return NetworkInstanceRouteTableNextHopCountersPacketsForwarded(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopCountersPacketsForwarded(self):
        """Test NetworkInstanceRouteTableNextHopCountersPacketsForwarded"""
