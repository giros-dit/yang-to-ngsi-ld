...
class TestLinecardMdaManufacturedDate(unittest.TestCase):
    """LinecardMdaManufacturedDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaManufacturedDate:
        """Test LinecardMdaManufacturedDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaManufacturedDate`
        """
        model = LinecardMdaManufacturedDate()
        if include_optional:
            return LinecardMdaManufacturedDate(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaManufacturedDate(self):
        """Test LinecardMdaManufacturedDate"""
