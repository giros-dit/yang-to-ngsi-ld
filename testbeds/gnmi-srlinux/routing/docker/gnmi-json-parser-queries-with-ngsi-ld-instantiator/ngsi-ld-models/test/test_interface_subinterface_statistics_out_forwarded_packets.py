...
class TestInterfaceSubinterfaceStatisticsOutForwardedPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsOutForwardedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsOutForwardedPackets:
        """Test InterfaceSubinterfaceStatisticsOutForwardedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsOutForwardedPackets`
        """
        model = InterfaceSubinterfaceStatisticsOutForwardedPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsOutForwardedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsOutForwardedPackets(self):
        """Test InterfaceSubinterfaceStatisticsOutForwardedPackets"""
