...
class TestNetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteTargetNetworkInstances"""
