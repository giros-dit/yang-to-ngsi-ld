...
class TestControlForwardingPlaneFibTableProgrammingProgressIpRoutes(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressIpRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressIpRoutes:
        """Test ControlForwardingPlaneFibTableProgrammingProgressIpRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressIpRoutes`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressIpRoutes()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressIpRoutes(
                id = '',
                type = 'ControlForwardingPlaneFibTableProgrammingProgressIpRoutes',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressIpRoutes(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressIpRoutes"""
