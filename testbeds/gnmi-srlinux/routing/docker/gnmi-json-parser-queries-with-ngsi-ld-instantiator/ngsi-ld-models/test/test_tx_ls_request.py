...
class TestTxLsRequest(unittest.TestCase):
    """TxLsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TxLsRequest:
        """Test TxLsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TxLsRequest`
        """
        model = TxLsRequest()
        if include_optional:
            return TxLsRequest(
