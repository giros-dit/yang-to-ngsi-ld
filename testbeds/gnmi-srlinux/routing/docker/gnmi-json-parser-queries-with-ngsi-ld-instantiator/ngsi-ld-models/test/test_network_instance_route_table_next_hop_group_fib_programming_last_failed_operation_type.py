...
class TestNetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType:
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType`
        """
        model = NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType(self):
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingLastFailedOperationType"""
