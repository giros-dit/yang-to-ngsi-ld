...
class TestControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime:
        """Test ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime(
                type = 'Property',
                value = '',
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressMplsLabelsLastSyncTime"""
