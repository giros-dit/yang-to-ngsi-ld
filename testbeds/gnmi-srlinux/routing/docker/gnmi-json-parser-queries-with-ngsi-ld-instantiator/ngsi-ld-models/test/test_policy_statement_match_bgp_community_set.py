...
class TestPolicyStatementMatchBgpCommunitySet(unittest.TestCase):
    """PolicyStatementMatchBgpCommunitySet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpCommunitySet:
        """Test PolicyStatementMatchBgpCommunitySet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpCommunitySet`
        """
        model = PolicyStatementMatchBgpCommunitySet()
        if include_optional:
            return PolicyStatementMatchBgpCommunitySet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementMatchBgpCommunitySet(self):
        """Test PolicyStatementMatchBgpCommunitySet"""
