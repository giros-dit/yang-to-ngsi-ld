...
class TestInterfaceSubinterfaceBridgeTableMacDuplication(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableMacDuplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableMacDuplication:
        """Test InterfaceSubinterfaceBridgeTableMacDuplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableMacDuplication`
        """
        model = InterfaceSubinterfaceBridgeTableMacDuplication()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableMacDuplication(
                id = '',
    ...
    def testInterfaceSubinterfaceBridgeTableMacDuplication(self):
        """Test InterfaceSubinterfaceBridgeTableMacDuplication"""
