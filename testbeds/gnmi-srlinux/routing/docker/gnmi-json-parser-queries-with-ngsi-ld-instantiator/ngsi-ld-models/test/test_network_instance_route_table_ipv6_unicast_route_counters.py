...
class TestNetworkInstanceRouteTableIpv6UnicastRouteCounters(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteCounters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteCounters:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteCounters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteCounters`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteCounters()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteCounters(
                id = '',
                type = 'NetworkInstanceRouteTableIpv6UnicastRouteCounters',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteCounters(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteCounters"""
