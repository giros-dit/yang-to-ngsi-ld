...
class TestNetworkInstanceRouteTableNextHopTunnelEncapsulateHeader(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader:
        """Test NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader`
        """
        model = NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader()
        if include_optional:
            return NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader(
                type = 'Property',
                value = 'gre',
    ...
    def testNetworkInstanceRouteTableNextHopTunnelEncapsulateHeader(self):
        """Test NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader"""
