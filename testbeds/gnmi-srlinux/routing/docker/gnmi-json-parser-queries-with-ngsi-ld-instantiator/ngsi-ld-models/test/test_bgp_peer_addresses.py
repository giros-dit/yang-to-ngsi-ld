...
class TestBgpPeerAddresses(unittest.TestCase):
    """BgpPeerAddresses unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BgpPeerAddresses:
        """Test BgpPeerAddresses
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BgpPeerAddresses`
        """
        model = BgpPeerAddresses()
        if include_optional:
            return BgpPeerAddresses(
                type = 'Property',
                value = '',
