...
class TestRestartHelperStatus(unittest.TestCase):
    """RestartHelperStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestartHelperStatus:
        """Test RestartHelperStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestartHelperStatus`
        """
        model = RestartHelperStatus()
        if include_optional:
            return RestartHelperStatus(
                type = 'Property',
                value = 'not-helping',
    ...
    def testRestartHelperStatus(self):
        """Test RestartHelperStatus"""
