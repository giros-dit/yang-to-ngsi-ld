...
class TestNetworkInstanceIcmpStatisticsTotalOutPackets(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTotalOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTotalOutPackets:
        """Test NetworkInstanceIcmpStatisticsTotalOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTotalOutPackets`
        """
        model = NetworkInstanceIcmpStatisticsTotalOutPackets()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTotalOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmpStatisticsTotalOutPackets(self):
        """Test NetworkInstanceIcmpStatisticsTotalOutPackets"""
