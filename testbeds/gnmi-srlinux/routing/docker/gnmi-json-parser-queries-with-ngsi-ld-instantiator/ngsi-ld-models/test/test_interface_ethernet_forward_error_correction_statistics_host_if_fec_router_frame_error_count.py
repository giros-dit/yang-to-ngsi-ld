...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount"""
