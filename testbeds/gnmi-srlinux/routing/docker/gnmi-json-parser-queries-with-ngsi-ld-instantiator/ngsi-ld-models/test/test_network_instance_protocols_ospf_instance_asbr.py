...
class TestNetworkInstanceProtocolsOspfInstanceAsbr(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAsbr unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAsbr:
        """Test NetworkInstanceProtocolsOspfInstanceAsbr
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAsbr`
        """
        model = NetworkInstanceProtocolsOspfInstanceAsbr()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAsbr(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAsbr(self):
        """Test NetworkInstanceProtocolsOspfInstanceAsbr"""
