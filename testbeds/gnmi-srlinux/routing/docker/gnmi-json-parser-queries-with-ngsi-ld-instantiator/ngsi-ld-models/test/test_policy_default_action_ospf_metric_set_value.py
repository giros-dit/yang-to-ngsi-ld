...
class TestPolicyDefaultActionOspfMetricSetValue(unittest.TestCase):
    """PolicyDefaultActionOspfMetricSetValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionOspfMetricSetValue:
        """Test PolicyDefaultActionOspfMetricSetValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionOspfMetricSetValue`
        """
        model = PolicyDefaultActionOspfMetricSetValue()
        if include_optional:
            return PolicyDefaultActionOspfMetricSetValue(
                type = 'Property',
                value = 56,
    ...
    def testPolicyDefaultActionOspfMetricSetValue(self):
        """Test PolicyDefaultActionOspfMetricSetValue"""
