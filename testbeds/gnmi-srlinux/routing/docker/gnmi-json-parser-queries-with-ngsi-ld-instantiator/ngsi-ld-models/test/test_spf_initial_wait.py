...
class TestSpfInitialWait(unittest.TestCase):
    """SpfInitialWait unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpfInitialWait:
        """Test SpfInitialWait
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpfInitialWait`
        """
        model = SpfInitialWait()
        if include_optional:
            return SpfInitialWait(
                type = 'Property',
                value = 10,
