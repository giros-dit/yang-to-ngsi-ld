...
class TestNetworkInstanceRouteTableNextHopTunnelOwner(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopTunnelOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopTunnelOwner:
        """Test NetworkInstanceRouteTableNextHopTunnelOwner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopTunnelOwner`
        """
        model = NetworkInstanceRouteTableNextHopTunnelOwner()
        if include_optional:
            return NetworkInstanceRouteTableNextHopTunnelOwner(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopTunnelOwner(self):
        """Test NetworkInstanceRouteTableNextHopTunnelOwner"""
