...
class TestNetworkInstanceTrafficEngineeringInterface(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringInterface:
        """Test NetworkInstanceTrafficEngineeringInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringInterface`
        """
        model = NetworkInstanceTrafficEngineeringInterface()
        if include_optional:
            return NetworkInstanceTrafficEngineeringInterface(
                id = '',
    ...
    def testNetworkInstanceTrafficEngineeringInterface(self):
        """Test NetworkInstanceTrafficEngineeringInterface"""
