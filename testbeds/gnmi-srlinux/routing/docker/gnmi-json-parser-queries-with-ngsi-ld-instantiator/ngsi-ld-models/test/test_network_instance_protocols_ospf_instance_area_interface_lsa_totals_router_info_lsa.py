...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsaTotalsRouterInfoLsa"""
