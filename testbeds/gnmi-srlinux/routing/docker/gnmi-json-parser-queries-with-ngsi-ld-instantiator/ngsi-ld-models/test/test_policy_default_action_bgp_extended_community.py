...
class TestPolicyDefaultActionBgpExtendedCommunity(unittest.TestCase):
    """PolicyDefaultActionBgpExtendedCommunity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpExtendedCommunity:
        """Test PolicyDefaultActionBgpExtendedCommunity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpExtendedCommunity`
        """
        model = PolicyDefaultActionBgpExtendedCommunity()
        if include_optional:
            return PolicyDefaultActionBgpExtendedCommunity(
                id = '',
                type = 'PolicyDefaultActionBgpExtendedCommunity',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpExtendedCommunity(self):
        """Test PolicyDefaultActionBgpExtendedCommunity"""
