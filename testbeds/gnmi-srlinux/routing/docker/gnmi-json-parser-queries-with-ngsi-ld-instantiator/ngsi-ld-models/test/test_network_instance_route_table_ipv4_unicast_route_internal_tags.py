...
class TestNetworkInstanceRouteTableIpv4UnicastRouteInternalTags(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteInternalTags unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteInternalTags:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteInternalTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteInternalTags`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteInternalTags()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteInternalTags(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteInternalTags(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteInternalTags"""
