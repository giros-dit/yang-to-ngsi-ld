...
class TestCurrentPenalties(unittest.TestCase):
    """CurrentPenalties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrentPenalties:
        """Test CurrentPenalties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrentPenalties`
        """
        model = CurrentPenalties()
        if include_optional:
