...
class TestLldpMedTlvs(unittest.TestCase):
    """LldpMedTlvs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LldpMedTlvs:
        """Test LldpMedTlvs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LldpMedTlvs`
        """
        model = LldpMedTlvs()
        if include_optional:
            return LldpMedTlvs(
