...
class TestSystemLldpStatistics(unittest.TestCase):
    """SystemLldpStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpStatistics:
        """Test SystemLldpStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpStatistics`
        """
        model = SystemLldpStatistics()
        if include_optional:
            return SystemLldpStatistics(
                id = '',
                type = 'SystemLldpStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpStatistics(self):
        """Test SystemLldpStatistics"""
