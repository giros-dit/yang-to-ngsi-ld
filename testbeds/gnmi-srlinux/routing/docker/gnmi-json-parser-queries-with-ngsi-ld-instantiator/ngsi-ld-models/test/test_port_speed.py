...
class TestPortSpeed(unittest.TestCase):
    """PortSpeed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PortSpeed:
        """Test PortSpeed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PortSpeed`
        """
        model = PortSpeed()
        if include_optional:
            return PortSpeed(
