...
class TestNewLsasOriginated(unittest.TestCase):
    """NewLsasOriginated unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewLsasOriginated:
        """Test NewLsasOriginated
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewLsasOriginated`
        """
        model = NewLsasOriginated()
        if include_optional:
            return NewLsasOriginated(
                type = 'Property',
                value = 56,
    ...
    def testNewLsasOriginated(self):
        """Test NewLsasOriginated"""
