...
class TestSidPrefix(unittest.TestCase):
    """SidPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SidPrefix:
        """Test SidPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SidPrefix`
        """
        model = SidPrefix()
        if include_optional:
            return SidPrefix(
