...
class TestNetworkInstanceRouteTableIpv4UnicastRouteCounters(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteCounters unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteCounters:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteCounters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteCounters`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteCounters()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteCounters(
                id = '',
                type = 'NetworkInstanceRouteTableIpv4UnicastRouteCounters',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteCounters(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteCounters"""
