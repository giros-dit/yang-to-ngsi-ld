...
class TestCommunitySet(unittest.TestCase):
    """CommunitySet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunitySet:
        """Test CommunitySet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunitySet`
        """
        model = CommunitySet()
        if include_optional:
            return CommunitySet(
