...
class TestRemoteDiscriminator(unittest.TestCase):
    """RemoteDiscriminator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RemoteDiscriminator:
        """Test RemoteDiscriminator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RemoteDiscriminator`
        """
        model = RemoteDiscriminator()
        if include_optional:
            return RemoteDiscriminator(
                type = 'Property',
                value = 1,
    ...
    def testRemoteDiscriminator(self):
        """Test RemoteDiscriminator"""
