...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborAddress"""
