...
class TestPhysicalMedium(unittest.TestCase):
    """PhysicalMedium unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PhysicalMedium:
        """Test PhysicalMedium
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PhysicalMedium`
        """
        model = PhysicalMedium()
        if include_optional:
