...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceEvents"""
