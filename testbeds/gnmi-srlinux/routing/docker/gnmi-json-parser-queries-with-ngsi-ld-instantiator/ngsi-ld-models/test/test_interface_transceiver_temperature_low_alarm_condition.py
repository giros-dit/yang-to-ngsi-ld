...
class TestInterfaceTransceiverTemperatureLowAlarmCondition(unittest.TestCase):
    """InterfaceTransceiverTemperatureLowAlarmCondition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureLowAlarmCondition:
        """Test InterfaceTransceiverTemperatureLowAlarmCondition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureLowAlarmCondition`
        """
        model = InterfaceTransceiverTemperatureLowAlarmCondition()
        if include_optional:
            return InterfaceTransceiverTemperatureLowAlarmCondition(
                type = 'Property',
                value = True,
    ...
    def testInterfaceTransceiverTemperatureLowAlarmCondition(self):
        """Test InterfaceTransceiverTemperatureLowAlarmCondition"""
