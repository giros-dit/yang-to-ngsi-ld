...
class TestSystemSrv6LocatorFullSegmentPrefix(unittest.TestCase):
    """SystemSrv6LocatorFullSegmentPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorFullSegmentPrefix:
        """Test SystemSrv6LocatorFullSegmentPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorFullSegmentPrefix`
        """
        model = SystemSrv6LocatorFullSegmentPrefix()
        if include_optional:
            return SystemSrv6LocatorFullSegmentPrefix(
                id = '',
                type = 'SystemSrv6LocatorFullSegmentPrefix',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6LocatorFullSegmentPrefix(self):
        """Test SystemSrv6LocatorFullSegmentPrefix"""
