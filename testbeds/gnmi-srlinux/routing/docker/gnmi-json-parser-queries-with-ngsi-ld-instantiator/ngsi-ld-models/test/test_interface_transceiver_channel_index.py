...
class TestInterfaceTransceiverChannelIndex(unittest.TestCase):
    """InterfaceTransceiverChannelIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverChannelIndex:
        """Test InterfaceTransceiverChannelIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverChannelIndex`
        """
        model = InterfaceTransceiverChannelIndex()
        if include_optional:
            return InterfaceTransceiverChannelIndex(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceTransceiverChannelIndex(self):
        """Test InterfaceTransceiverChannelIndex"""
