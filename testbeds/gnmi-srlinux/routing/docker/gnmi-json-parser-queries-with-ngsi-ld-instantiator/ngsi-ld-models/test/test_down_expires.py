...
class TestDownExpires(unittest.TestCase):
    """DownExpires unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DownExpires:
        """Test DownExpires
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DownExpires`
        """
        model = DownExpires()
        if include_optional:
            return DownExpires(
