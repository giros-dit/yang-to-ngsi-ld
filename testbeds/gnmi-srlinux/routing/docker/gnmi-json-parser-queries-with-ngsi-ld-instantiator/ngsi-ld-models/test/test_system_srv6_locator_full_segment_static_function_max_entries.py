...
class TestSystemSrv6LocatorFullSegmentStaticFunctionMaxEntries(unittest.TestCase):
    """SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries:
        """Test SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries`
        """
        model = SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries()
        if include_optional:
            return SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries(
                type = 'Property',
                value = 1,
    ...
    def testSystemSrv6LocatorFullSegmentStaticFunctionMaxEntries(self):
        """Test SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries"""
