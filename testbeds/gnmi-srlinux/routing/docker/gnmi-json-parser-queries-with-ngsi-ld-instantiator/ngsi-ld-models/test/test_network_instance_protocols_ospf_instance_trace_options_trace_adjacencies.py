...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceAdjacencies"""
