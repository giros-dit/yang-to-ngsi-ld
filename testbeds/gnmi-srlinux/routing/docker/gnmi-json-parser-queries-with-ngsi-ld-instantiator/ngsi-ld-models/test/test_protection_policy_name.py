...
class TestProtectionPolicyName(unittest.TestCase):
    """ProtectionPolicyName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProtectionPolicyName:
        """Test ProtectionPolicyName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProtectionPolicyName`
        """
        model = ProtectionPolicyName()
        if include_optional:
    ...
    def testProtectionPolicyName(self):
        """Test ProtectionPolicyName"""
