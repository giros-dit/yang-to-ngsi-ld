...
class TestPolicyStatementActionBgpMedValue(unittest.TestCase):
    """PolicyStatementActionBgpMedValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpMedValue:
        """Test PolicyStatementActionBgpMedValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpMedValue`
        """
        model = PolicyStatementActionBgpMedValue()
        if include_optional:
            return PolicyStatementActionBgpMedValue(
                type = 'Property',
                value = '',
    ...
    def testPolicyStatementActionBgpMedValue(self):
        """Test PolicyStatementActionBgpMedValue"""
