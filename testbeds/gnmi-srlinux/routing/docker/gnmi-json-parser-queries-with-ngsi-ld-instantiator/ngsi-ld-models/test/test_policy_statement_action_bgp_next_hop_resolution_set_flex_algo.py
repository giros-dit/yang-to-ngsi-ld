...
class TestPolicyStatementActionBgpNextHopResolutionSetFlexAlgo(unittest.TestCase):
    """PolicyStatementActionBgpNextHopResolutionSetFlexAlgo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpNextHopResolutionSetFlexAlgo:
        """Test PolicyStatementActionBgpNextHopResolutionSetFlexAlgo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpNextHopResolutionSetFlexAlgo`
        """
        model = PolicyStatementActionBgpNextHopResolutionSetFlexAlgo()
        if include_optional:
            return PolicyStatementActionBgpNextHopResolutionSetFlexAlgo(
                type = 'Property',
                value = 56,
    ...
    def testPolicyStatementActionBgpNextHopResolutionSetFlexAlgo(self):
        """Test PolicyStatementActionBgpNextHopResolutionSetFlexAlgo"""
