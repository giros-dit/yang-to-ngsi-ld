...
class TestNetworkInstanceRouteTableNextHopRedirect(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopRedirect unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopRedirect:
        """Test NetworkInstanceRouteTableNextHopRedirect
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopRedirect`
        """
        model = NetworkInstanceRouteTableNextHopRedirect()
        if include_optional:
            return NetworkInstanceRouteTableNextHopRedirect(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopRedirect',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopRedirect(self):
        """Test NetworkInstanceRouteTableNextHopRedirect"""
