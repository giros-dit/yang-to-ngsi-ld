...
class TestPolicyStatementMatchBgpEvpnRouteType(unittest.TestCase):
    """PolicyStatementMatchBgpEvpnRouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpEvpnRouteType:
        """Test PolicyStatementMatchBgpEvpnRouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpEvpnRouteType`
        """
        model = PolicyStatementMatchBgpEvpnRouteType()
        if include_optional:
            return PolicyStatementMatchBgpEvpnRouteType(
                type = 'Property',
                value = 1,
    ...
    def testPolicyStatementMatchBgpEvpnRouteType(self):
        """Test PolicyStatementMatchBgpEvpnRouteType"""
