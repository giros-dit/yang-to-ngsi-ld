...
class TestNetworkInstanceBridgeTableMacLearningMacRelearnOnly(unittest.TestCase):
    """NetworkInstanceBridgeTableMacLearningMacRelearnOnly unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacLearningMacRelearnOnly:
        """Test NetworkInstanceBridgeTableMacLearningMacRelearnOnly
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacLearningMacRelearnOnly`
        """
        model = NetworkInstanceBridgeTableMacLearningMacRelearnOnly()
        if include_optional:
            return NetworkInstanceBridgeTableMacLearningMacRelearnOnly(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceBridgeTableMacLearningMacRelearnOnly(self):
        """Test NetworkInstanceBridgeTableMacLearningMacRelearnOnly"""
