...
class TestAgeTime(unittest.TestCase):
    """AgeTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgeTime:
        """Test AgeTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgeTime`
        """
        model = AgeTime()
        if include_optional:
            return AgeTime(
