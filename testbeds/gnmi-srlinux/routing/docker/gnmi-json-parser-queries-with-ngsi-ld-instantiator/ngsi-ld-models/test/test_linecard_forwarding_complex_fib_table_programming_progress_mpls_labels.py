...
class TestLinecardForwardingComplexFibTableProgrammingProgressMplsLabels(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressMplsLabels unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressMplsLabels:
        """Test LinecardForwardingComplexFibTableProgrammingProgressMplsLabels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressMplsLabels`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressMplsLabels()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressMplsLabels(
                id = '',
                type = 'LinecardForwardingComplexFibTableProgrammingProgressMplsLabels',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressMplsLabels(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressMplsLabels"""
