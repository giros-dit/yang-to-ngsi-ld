...
class TestHoldDownTime(unittest.TestCase):
    """HoldDownTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HoldDownTime:
        """Test HoldDownTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HoldDownTime`
        """
        model = HoldDownTime()
        if include_optional:
            return HoldDownTime(
