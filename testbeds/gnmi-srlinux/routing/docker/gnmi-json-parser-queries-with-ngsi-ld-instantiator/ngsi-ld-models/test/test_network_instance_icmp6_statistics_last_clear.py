...
class TestNetworkInstanceIcmp6StatisticsLastClear(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsLastClear unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsLastClear:
        """Test NetworkInstanceIcmp6StatisticsLastClear
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsLastClear`
        """
        model = NetworkInstanceIcmp6StatisticsLastClear()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsLastClear(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceIcmp6StatisticsLastClear(self):
        """Test NetworkInstanceIcmp6StatisticsLastClear"""
