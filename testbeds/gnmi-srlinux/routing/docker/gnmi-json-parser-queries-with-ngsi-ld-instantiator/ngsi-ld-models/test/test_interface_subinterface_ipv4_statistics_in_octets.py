...
class TestInterfaceSubinterfaceIpv4StatisticsInOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInOctets:
        """Test InterfaceSubinterfaceIpv4StatisticsInOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInOctets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInOctets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInOctets"""
