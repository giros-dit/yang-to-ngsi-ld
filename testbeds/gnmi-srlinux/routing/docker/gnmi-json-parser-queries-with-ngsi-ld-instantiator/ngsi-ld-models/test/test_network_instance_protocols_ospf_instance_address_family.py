...
class TestNetworkInstanceProtocolsOspfInstanceAddressFamily(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAddressFamily unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAddressFamily:
        """Test NetworkInstanceProtocolsOspfInstanceAddressFamily
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAddressFamily`
        """
        model = NetworkInstanceProtocolsOspfInstanceAddressFamily()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAddressFamily(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAddressFamily(self):
        """Test NetworkInstanceProtocolsOspfInstanceAddressFamily"""
