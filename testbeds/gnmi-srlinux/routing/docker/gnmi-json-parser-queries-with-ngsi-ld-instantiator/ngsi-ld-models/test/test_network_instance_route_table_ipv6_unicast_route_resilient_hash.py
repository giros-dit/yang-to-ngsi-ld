...
class TestNetworkInstanceRouteTableIpv6UnicastRouteResilientHash(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteResilientHash unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteResilientHash:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteResilientHash
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteResilientHash`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteResilientHash()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteResilientHash(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteResilientHash(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteResilientHash"""
