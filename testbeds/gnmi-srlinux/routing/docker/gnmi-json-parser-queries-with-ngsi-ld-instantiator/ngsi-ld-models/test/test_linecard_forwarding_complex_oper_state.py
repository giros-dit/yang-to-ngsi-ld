...
class TestLinecardForwardingComplexOperState(unittest.TestCase):
    """LinecardForwardingComplexOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexOperState:
        """Test LinecardForwardingComplexOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexOperState`
        """
        model = LinecardForwardingComplexOperState()
        if include_optional:
            return LinecardForwardingComplexOperState(
                type = 'Property',
                value = 'up',
    ...
    def testLinecardForwardingComplexOperState(self):
        """Test LinecardForwardingComplexOperState"""
