...
class TestLinecardOperState(unittest.TestCase):
    """LinecardOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardOperState:
        """Test LinecardOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardOperState`
        """
        model = LinecardOperState()
        if include_optional:
            return LinecardOperState(
                type = 'Property',
                value = 'up',
    ...
    def testLinecardOperState(self):
        """Test LinecardOperState"""
