...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterPreFecBerInstant"""
