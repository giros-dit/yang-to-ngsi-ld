...
class TestNetworkInstanceRouteTableNextHopTunnel(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopTunnel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopTunnel:
        """Test NetworkInstanceRouteTableNextHopTunnel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopTunnel`
        """
        model = NetworkInstanceRouteTableNextHopTunnel()
        if include_optional:
            return NetworkInstanceRouteTableNextHopTunnel(
                id = '',
                type = 'NetworkInstanceRouteTableNextHopTunnel',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopTunnel(self):
        """Test NetworkInstanceRouteTableNextHopTunnel"""
