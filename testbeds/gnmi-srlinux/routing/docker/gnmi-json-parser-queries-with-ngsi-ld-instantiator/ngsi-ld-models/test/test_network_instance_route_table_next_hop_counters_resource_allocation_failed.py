...
class TestNetworkInstanceRouteTableNextHopCountersResourceAllocationFailed(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed:
        """Test NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed`
        """
        model = NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed()
        if include_optional:
            return NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopCountersResourceAllocationFailed(self):
        """Test NetworkInstanceRouteTableNextHopCountersResourceAllocationFailed"""
