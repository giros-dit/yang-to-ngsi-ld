...
class TestSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName:
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName`
        """
        model = SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName(self):
        """Test SystemLldpInterfaceNeighborLldpMedNetworkPolicyApplicationTypeName"""
