...
class TestAdjacencyState(unittest.TestCase):
    """AdjacencyState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdjacencyState:
        """Test AdjacencyState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdjacencyState`
        """
        model = AdjacencyState()
        if include_optional:
