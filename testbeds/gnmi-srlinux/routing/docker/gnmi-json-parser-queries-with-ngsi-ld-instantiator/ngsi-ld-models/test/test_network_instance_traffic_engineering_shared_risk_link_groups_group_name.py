...
class TestNetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName:
        """Test NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName`
        """
        model = NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName()
        if include_optional:
            return NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName(self):
        """Test NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupName"""
