...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsResilientHashRoutes"""
