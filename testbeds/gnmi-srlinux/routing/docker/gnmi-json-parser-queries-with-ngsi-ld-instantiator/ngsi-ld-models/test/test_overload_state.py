...
class TestOverloadState(unittest.TestCase):
    """OverloadState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverloadState:
        """Test OverloadState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverloadState`
        """
        model = OverloadState()
        if include_optional:
