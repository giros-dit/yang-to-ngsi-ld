...
class TestSystemLldpInterfaceNeighborBgpAutoDiscovery(unittest.TestCase):
    """SystemLldpInterfaceNeighborBgpAutoDiscovery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborBgpAutoDiscovery:
        """Test SystemLldpInterfaceNeighborBgpAutoDiscovery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborBgpAutoDiscovery`
        """
        model = SystemLldpInterfaceNeighborBgpAutoDiscovery()
        if include_optional:
            return SystemLldpInterfaceNeighborBgpAutoDiscovery(
                id = '',
                type = 'SystemLldpInterfaceNeighborBgpAutoDiscovery',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpInterfaceNeighborBgpAutoDiscovery(self):
        """Test SystemLldpInterfaceNeighborBgpAutoDiscovery"""
