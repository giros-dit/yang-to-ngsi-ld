...
class TestLinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets(unittest.TestCase):
    """LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets:
        """Test LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets`
        """
        model = LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets()
        if include_optional:
            return LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets(self):
        """Test LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractedOctets"""
