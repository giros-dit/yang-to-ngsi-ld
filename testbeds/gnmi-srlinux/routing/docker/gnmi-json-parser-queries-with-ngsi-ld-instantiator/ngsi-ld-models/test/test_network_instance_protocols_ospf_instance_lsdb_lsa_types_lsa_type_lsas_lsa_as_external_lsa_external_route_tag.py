...
class TestNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag:
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag`
        """
        model = NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag(self):
        """Test NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaAsExternalLsaExternalRouteTag"""
