...
class TestNetworkInstanceRouteTableNextHopMplsTunnelTunnelId(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopMplsTunnelTunnelId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopMplsTunnelTunnelId:
        """Test NetworkInstanceRouteTableNextHopMplsTunnelTunnelId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopMplsTunnelTunnelId`
        """
        model = NetworkInstanceRouteTableNextHopMplsTunnelTunnelId()
        if include_optional:
            return NetworkInstanceRouteTableNextHopMplsTunnelTunnelId(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopMplsTunnelTunnelId(self):
        """Test NetworkInstanceRouteTableNextHopMplsTunnelTunnelId"""
