...
class TestAllowDirectedBroadcast(unittest.TestCase):
    """AllowDirectedBroadcast unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AllowDirectedBroadcast:
        """Test AllowDirectedBroadcast
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AllowDirectedBroadcast`
        """
        model = AllowDirectedBroadcast()
        if include_optional:
            return AllowDirectedBroadcast(
                type = 'Property',
                value = True,
    ...
    def testAllowDirectedBroadcast(self):
        """Test AllowDirectedBroadcast"""
