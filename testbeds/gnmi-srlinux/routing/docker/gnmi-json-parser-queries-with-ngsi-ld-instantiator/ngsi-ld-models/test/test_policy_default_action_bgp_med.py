...
class TestPolicyDefaultActionBgpMed(unittest.TestCase):
    """PolicyDefaultActionBgpMed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpMed:
        """Test PolicyDefaultActionBgpMed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpMed`
        """
        model = PolicyDefaultActionBgpMed()
        if include_optional:
            return PolicyDefaultActionBgpMed(
                id = '',
                type = 'PolicyDefaultActionBgpMed',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpMed(self):
        """Test PolicyDefaultActionBgpMed"""
