...
class TestNetworkInstanceRouteTableNextHopTunnelTunnelId(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopTunnelTunnelId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopTunnelTunnelId:
        """Test NetworkInstanceRouteTableNextHopTunnelTunnelId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopTunnelTunnelId`
        """
        model = NetworkInstanceRouteTableNextHopTunnelTunnelId()
        if include_optional:
            return NetworkInstanceRouteTableNextHopTunnelTunnelId(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableNextHopTunnelTunnelId(self):
        """Test NetworkInstanceRouteTableNextHopTunnelTunnelId"""
