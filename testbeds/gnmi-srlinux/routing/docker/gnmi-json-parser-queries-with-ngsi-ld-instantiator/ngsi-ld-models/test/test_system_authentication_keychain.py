...
class TestSystemAuthenticationKeychain(unittest.TestCase):
    """SystemAuthenticationKeychain unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychain:
        """Test SystemAuthenticationKeychain
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychain`
        """
        model = SystemAuthenticationKeychain()
        if include_optional:
            return SystemAuthenticationKeychain(
                id = '',
                type = 'SystemAuthenticationKeychain',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemAuthenticationKeychain(self):
        """Test SystemAuthenticationKeychain"""
