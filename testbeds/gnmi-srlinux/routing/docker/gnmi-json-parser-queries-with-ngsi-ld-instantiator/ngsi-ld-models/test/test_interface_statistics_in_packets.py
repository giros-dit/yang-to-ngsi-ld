...
class TestInterfaceStatisticsInPackets(unittest.TestCase):
    """InterfaceStatisticsInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsInPackets:
        """Test InterfaceStatisticsInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsInPackets`
        """
        model = InterfaceStatisticsInPackets()
        if include_optional:
            return InterfaceStatisticsInPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStatisticsInPackets(self):
        """Test InterfaceStatisticsInPackets"""
