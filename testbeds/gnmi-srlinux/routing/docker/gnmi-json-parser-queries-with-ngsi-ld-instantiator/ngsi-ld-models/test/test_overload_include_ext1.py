...
class TestOverloadIncludeExt1(unittest.TestCase):
    """OverloadIncludeExt1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverloadIncludeExt1:
        """Test OverloadIncludeExt1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverloadIncludeExt1`
        """
        model = OverloadIncludeExt1()
        if include_optional:
            return OverloadIncludeExt1(
                type = 'Property',
                value = True,
    ...
    def testOverloadIncludeExt1(self):
        """Test OverloadIncludeExt1"""
