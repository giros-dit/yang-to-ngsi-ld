...
class TestInUnicastPackets(unittest.TestCase):
    """InUnicastPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InUnicastPackets:
        """Test InUnicastPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InUnicastPackets`
        """
        model = InUnicastPackets()
        if include_optional:
