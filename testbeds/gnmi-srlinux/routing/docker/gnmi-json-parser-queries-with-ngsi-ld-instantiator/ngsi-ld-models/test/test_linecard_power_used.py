...
class TestLinecardPowerUsed(unittest.TestCase):
    """LinecardPowerUsed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardPowerUsed:
        """Test LinecardPowerUsed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardPowerUsed`
        """
        model = LinecardPowerUsed()
        if include_optional:
            return LinecardPowerUsed(
                type = 'Property',
                value = 56,
    ...
    def testLinecardPowerUsed(self):
        """Test LinecardPowerUsed"""
