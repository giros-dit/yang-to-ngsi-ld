...
class TestHoldMultiplier(unittest.TestCase):
    """HoldMultiplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HoldMultiplier:
        """Test HoldMultiplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HoldMultiplier`
        """
        model = HoldMultiplier()
        if include_optional:
