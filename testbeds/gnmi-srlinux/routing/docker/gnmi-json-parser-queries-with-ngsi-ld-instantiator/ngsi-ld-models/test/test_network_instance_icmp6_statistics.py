...
class TestNetworkInstanceIcmp6Statistics(unittest.TestCase):
    """NetworkInstanceIcmp6Statistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6Statistics:
        """Test NetworkInstanceIcmp6Statistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6Statistics`
        """
        model = NetworkInstanceIcmp6Statistics()
        if include_optional:
            return NetworkInstanceIcmp6Statistics(
                id = '',
                type = 'NetworkInstanceIcmp6Statistics',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceIcmp6Statistics(self):
        """Test NetworkInstanceIcmp6Statistics"""
