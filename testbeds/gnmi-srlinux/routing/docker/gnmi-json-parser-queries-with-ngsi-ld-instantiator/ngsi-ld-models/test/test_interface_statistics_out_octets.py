...
class TestInterfaceStatisticsOutOctets(unittest.TestCase):
    """InterfaceStatisticsOutOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsOutOctets:
        """Test InterfaceStatisticsOutOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsOutOctets`
        """
        model = InterfaceStatisticsOutOctets()
        if include_optional:
            return InterfaceStatisticsOutOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStatisticsOutOctets(self):
        """Test InterfaceStatisticsOutOctets"""
