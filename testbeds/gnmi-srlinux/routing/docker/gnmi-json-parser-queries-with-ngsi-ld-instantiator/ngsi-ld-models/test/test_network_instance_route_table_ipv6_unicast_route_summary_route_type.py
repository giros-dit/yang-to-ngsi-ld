...
class TestNetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType(
                id = '',
                type = 'NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType"""
