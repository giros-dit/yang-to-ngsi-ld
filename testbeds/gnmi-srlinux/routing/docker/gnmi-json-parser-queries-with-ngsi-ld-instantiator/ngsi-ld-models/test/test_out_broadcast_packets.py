...
class TestOutBroadcastPackets(unittest.TestCase):
    """OutBroadcastPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutBroadcastPackets:
        """Test OutBroadcastPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutBroadcastPackets`
        """
        model = OutBroadcastPackets()
        if include_optional:
    ...
    def testOutBroadcastPackets(self):
        """Test OutBroadcastPackets"""
