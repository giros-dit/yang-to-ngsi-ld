...
class TestNetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs:
        """Test NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs`
        """
        model = NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs(self):
        """Test NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs"""
