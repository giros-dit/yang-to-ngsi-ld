...
class TestSystemSrv6MicroSegmentBlockPrefixIpPrefix(unittest.TestCase):
    """SystemSrv6MicroSegmentBlockPrefixIpPrefix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6MicroSegmentBlockPrefixIpPrefix:
        """Test SystemSrv6MicroSegmentBlockPrefixIpPrefix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6MicroSegmentBlockPrefixIpPrefix`
        """
        model = SystemSrv6MicroSegmentBlockPrefixIpPrefix()
        if include_optional:
            return SystemSrv6MicroSegmentBlockPrefixIpPrefix(
                type = 'Property',
    ...
    def testSystemSrv6MicroSegmentBlockPrefixIpPrefix(self):
        """Test SystemSrv6MicroSegmentBlockPrefixIpPrefix"""
