...
class TestPolicyDefaultActionBgpAsPathPrependRepeatN(unittest.TestCase):
    """PolicyDefaultActionBgpAsPathPrependRepeatN unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpAsPathPrependRepeatN:
        """Test PolicyDefaultActionBgpAsPathPrependRepeatN
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpAsPathPrependRepeatN`
        """
        model = PolicyDefaultActionBgpAsPathPrependRepeatN()
        if include_optional:
            return PolicyDefaultActionBgpAsPathPrependRepeatN(
                type = 'Property',
                value = 1,
    ...
    def testPolicyDefaultActionBgpAsPathPrependRepeatN(self):
        """Test PolicyDefaultActionBgpAsPathPrependRepeatN"""
