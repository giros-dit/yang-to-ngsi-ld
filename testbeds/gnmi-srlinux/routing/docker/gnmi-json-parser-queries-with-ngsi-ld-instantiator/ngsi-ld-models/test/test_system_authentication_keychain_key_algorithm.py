...
class TestSystemAuthenticationKeychainKeyAlgorithm(unittest.TestCase):
    """SystemAuthenticationKeychainKeyAlgorithm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKeyAlgorithm:
        """Test SystemAuthenticationKeychainKeyAlgorithm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKeyAlgorithm`
        """
        model = SystemAuthenticationKeychainKeyAlgorithm()
        if include_optional:
            return SystemAuthenticationKeychainKeyAlgorithm(
                type = 'Property',
                value = 'cleartext',
    ...
    def testSystemAuthenticationKeychainKeyAlgorithm(self):
        """Test SystemAuthenticationKeychainKeyAlgorithm"""
