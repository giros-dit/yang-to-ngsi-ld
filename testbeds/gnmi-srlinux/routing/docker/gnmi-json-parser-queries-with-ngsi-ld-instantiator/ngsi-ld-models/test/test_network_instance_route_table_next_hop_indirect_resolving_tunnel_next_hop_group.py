...
class TestNetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup:
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup`
        """
        model = NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup()
        if include_optional:
            return NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup(self):
        """Test NetworkInstanceRouteTableNextHopIndirectResolvingTunnelNextHopGroup"""
