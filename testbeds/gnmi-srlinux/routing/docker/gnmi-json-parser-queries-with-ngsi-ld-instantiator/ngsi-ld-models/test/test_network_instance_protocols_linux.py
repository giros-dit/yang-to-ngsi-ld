...
class TestNetworkInstanceProtocolsLinux(unittest.TestCase):
    """NetworkInstanceProtocolsLinux unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsLinux:
        """Test NetworkInstanceProtocolsLinux
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsLinux`
        """
        model = NetworkInstanceProtocolsLinux()
        if include_optional:
            return NetworkInstanceProtocolsLinux(
                id = '',
    ...
    def testNetworkInstanceProtocolsLinux(self):
        """Test NetworkInstanceProtocolsLinux"""
