...
class TestNetworkInstanceRouteTableIpv4UnicastRouteRouteOwner(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteRouteOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteRouteOwner:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteRouteOwner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteRouteOwner`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteRouteOwner()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteRouteOwner(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteRouteOwner(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteRouteOwner"""
