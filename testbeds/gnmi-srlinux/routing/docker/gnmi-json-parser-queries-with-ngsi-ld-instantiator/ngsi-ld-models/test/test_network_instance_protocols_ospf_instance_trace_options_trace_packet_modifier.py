...
class TestNetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier:
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier`
        """
        model = NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier(
                type = 'Property',
                value = 'ingress',
    ...
    def testNetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier(self):
        """Test NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier"""
