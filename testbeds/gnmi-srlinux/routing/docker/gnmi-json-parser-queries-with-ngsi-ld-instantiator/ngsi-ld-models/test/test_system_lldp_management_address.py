...
class TestSystemLldpManagementAddress(unittest.TestCase):
    """SystemLldpManagementAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpManagementAddress:
        """Test SystemLldpManagementAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpManagementAddress`
        """
        model = SystemLldpManagementAddress()
        if include_optional:
            return SystemLldpManagementAddress(
                id = '',
                type = 'SystemLldpManagementAddress',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemLldpManagementAddress(self):
        """Test SystemLldpManagementAddress"""
