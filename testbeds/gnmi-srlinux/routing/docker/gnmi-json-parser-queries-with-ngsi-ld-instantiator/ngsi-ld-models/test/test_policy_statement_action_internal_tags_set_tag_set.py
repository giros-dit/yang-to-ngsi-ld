...
class TestPolicyStatementActionInternalTagsSetTagSet(unittest.TestCase):
    """PolicyStatementActionInternalTagsSetTagSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionInternalTagsSetTagSet:
        """Test PolicyStatementActionInternalTagsSetTagSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionInternalTagsSetTagSet`
        """
        model = PolicyStatementActionInternalTagsSetTagSet()
        if include_optional:
            return PolicyStatementActionInternalTagsSetTagSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementActionInternalTagsSetTagSet(self):
        """Test PolicyStatementActionInternalTagsSetTagSet"""
