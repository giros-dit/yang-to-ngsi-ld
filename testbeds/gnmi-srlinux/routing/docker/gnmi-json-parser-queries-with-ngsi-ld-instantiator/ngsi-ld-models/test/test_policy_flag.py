...
class TestPolicyFlag(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PolicyFlag:
        """Test PolicyFlag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyFlag`
        """
        model = PolicyFlag()
        if include_optional:
            return PolicyFlag(
