...
class TestInterfaceTransceiverChannelWavelength(unittest.TestCase):
    """InterfaceTransceiverChannelWavelength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverChannelWavelength:
        """Test InterfaceTransceiverChannelWavelength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverChannelWavelength`
        """
        model = InterfaceTransceiverChannelWavelength()
        if include_optional:
            return InterfaceTransceiverChannelWavelength(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceTransceiverChannelWavelength(self):
        """Test InterfaceTransceiverChannelWavelength"""
