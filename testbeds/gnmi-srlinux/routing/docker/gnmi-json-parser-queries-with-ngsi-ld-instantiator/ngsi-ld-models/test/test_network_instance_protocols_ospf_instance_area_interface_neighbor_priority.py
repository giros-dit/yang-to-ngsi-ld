...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborPriority"""
