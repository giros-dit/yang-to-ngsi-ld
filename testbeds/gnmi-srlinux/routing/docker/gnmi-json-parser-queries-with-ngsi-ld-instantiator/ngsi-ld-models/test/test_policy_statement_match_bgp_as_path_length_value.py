...
class TestPolicyStatementMatchBgpAsPathLengthValue(unittest.TestCase):
    """PolicyStatementMatchBgpAsPathLengthValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpAsPathLengthValue:
        """Test PolicyStatementMatchBgpAsPathLengthValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpAsPathLengthValue`
        """
        model = PolicyStatementMatchBgpAsPathLengthValue()
        if include_optional:
            return PolicyStatementMatchBgpAsPathLengthValue(
                type = 'Property',
                value = 0,
    ...
    def testPolicyStatementMatchBgpAsPathLengthValue(self):
        """Test PolicyStatementMatchBgpAsPathLengthValue"""
