...
class TestTagSetName(unittest.TestCase):
    """TagSetName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagSetName:
        """Test TagSetName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagSetName`
        """
        model = TagSetName()
        if include_optional:
            return TagSetName(
