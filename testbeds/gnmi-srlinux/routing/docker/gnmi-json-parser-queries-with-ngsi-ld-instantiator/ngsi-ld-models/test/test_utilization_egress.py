...
class TestUtilizationEgress(unittest.TestCase):
    """UtilizationEgress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UtilizationEgress:
        """Test UtilizationEgress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UtilizationEgress`
        """
        model = UtilizationEgress()
        if include_optional:
            return UtilizationEgress(
                type = 'Property',
                value = 56,
    ...
    def testUtilizationEgress(self):
        """Test UtilizationEgress"""
