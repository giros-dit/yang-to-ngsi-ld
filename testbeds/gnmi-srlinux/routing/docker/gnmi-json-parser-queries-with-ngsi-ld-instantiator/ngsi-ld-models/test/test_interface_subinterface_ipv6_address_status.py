...
class TestInterfaceSubinterfaceIpv6AddressStatus(unittest.TestCase):
    """InterfaceSubinterfaceIpv6AddressStatus unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6AddressStatus:
        """Test InterfaceSubinterfaceIpv6AddressStatus
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6AddressStatus`
        """
        model = InterfaceSubinterfaceIpv6AddressStatus()
        if include_optional:
            return InterfaceSubinterfaceIpv6AddressStatus(
                type = 'Property',
                value = 'preferred',
    ...
    def testInterfaceSubinterfaceIpv6AddressStatus(self):
        """Test InterfaceSubinterfaceIpv6AddressStatus"""
