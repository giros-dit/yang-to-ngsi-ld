...
class TestFecOption(unittest.TestCase):
    """FecOption unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FecOption:
        """Test FecOption
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FecOption`
        """
        model = FecOption()
        if include_optional:
            return FecOption(
