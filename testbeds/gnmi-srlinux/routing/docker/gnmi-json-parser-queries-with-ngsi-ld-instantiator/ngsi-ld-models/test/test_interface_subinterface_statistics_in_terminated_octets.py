...
class TestInterfaceSubinterfaceStatisticsInTerminatedOctets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInTerminatedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInTerminatedOctets:
        """Test InterfaceSubinterfaceStatisticsInTerminatedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInTerminatedOctets`
        """
        model = InterfaceSubinterfaceStatisticsInTerminatedOctets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInTerminatedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInTerminatedOctets(self):
        """Test InterfaceSubinterfaceStatisticsInTerminatedOctets"""
