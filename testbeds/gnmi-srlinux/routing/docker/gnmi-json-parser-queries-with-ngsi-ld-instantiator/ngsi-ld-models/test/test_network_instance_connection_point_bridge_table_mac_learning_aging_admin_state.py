...
class TestNetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState:
        """Test NetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacLearningAgingAdminState"""
