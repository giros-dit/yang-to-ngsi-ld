...
class TestInterfaceSubinterfaceOperDownReason(unittest.TestCase):
    """InterfaceSubinterfaceOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceOperDownReason:
        """Test InterfaceSubinterfaceOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceOperDownReason`
        """
        model = InterfaceSubinterfaceOperDownReason()
        if include_optional:
            return InterfaceSubinterfaceOperDownReason(
                type = 'Property',
    ...
    def testInterfaceSubinterfaceOperDownReason(self):
        """Test InterfaceSubinterfaceOperDownReason"""
