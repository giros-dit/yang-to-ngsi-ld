...
class TestSystemAuthenticationKeychainType(unittest.TestCase):
    """SystemAuthenticationKeychainType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainType:
        """Test SystemAuthenticationKeychainType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainType`
        """
        model = SystemAuthenticationKeychainType()
        if include_optional:
            return SystemAuthenticationKeychainType(
                type = 'Property',
                value = 'tcp-md5',
    ...
    def testSystemAuthenticationKeychainType(self):
        """Test SystemAuthenticationKeychainType"""
