...
class TestNetworkInstanceStaticRoutes(unittest.TestCase):
    """NetworkInstanceStaticRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutes:
        """Test NetworkInstanceStaticRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutes`
        """
        model = NetworkInstanceStaticRoutes()
        if include_optional:
    ...
    def testNetworkInstanceStaticRoutes(self):
        """Test NetworkInstanceStaticRoutes"""
