...
class TestLinecardTemperature(unittest.TestCase):
    """LinecardTemperature unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardTemperature:
        """Test LinecardTemperature
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardTemperature`
        """
        model = LinecardTemperature()
        if include_optional:
            return LinecardTemperature(
                id = '',
                type = 'LinecardTemperature',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardTemperature(self):
        """Test LinecardTemperature"""
