...
class TestNetworkInstanceIcmp6StatisticsType(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsType:
        """Test NetworkInstanceIcmp6StatisticsType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsType`
        """
        model = NetworkInstanceIcmp6StatisticsType()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsType(
                id = '',
                type = 'NetworkInstanceIcmp6StatisticsType',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceIcmp6StatisticsType(self):
        """Test NetworkInstanceIcmp6StatisticsType"""
