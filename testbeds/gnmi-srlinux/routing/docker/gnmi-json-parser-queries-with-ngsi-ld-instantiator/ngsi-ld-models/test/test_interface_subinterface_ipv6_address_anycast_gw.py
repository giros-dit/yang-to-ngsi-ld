...
class TestInterfaceSubinterfaceIpv6AddressAnycastGw(unittest.TestCase):
    """InterfaceSubinterfaceIpv6AddressAnycastGw unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6AddressAnycastGw:
        """Test InterfaceSubinterfaceIpv6AddressAnycastGw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6AddressAnycastGw`
        """
        model = InterfaceSubinterfaceIpv6AddressAnycastGw()
        if include_optional:
            return InterfaceSubinterfaceIpv6AddressAnycastGw(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfaceIpv6AddressAnycastGw(self):
        """Test InterfaceSubinterfaceIpv6AddressAnycastGw"""
