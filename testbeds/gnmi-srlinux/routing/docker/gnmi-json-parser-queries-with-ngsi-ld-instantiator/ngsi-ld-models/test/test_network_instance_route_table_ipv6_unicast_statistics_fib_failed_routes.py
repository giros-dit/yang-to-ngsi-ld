...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsFibFailedRoutes"""
