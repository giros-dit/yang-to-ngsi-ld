...
class TestLinkLossForwarding(unittest.TestCase):
    """LinkLossForwarding unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkLossForwarding:
        """Test LinkLossForwarding
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkLossForwarding`
        """
        model = LinkLossForwarding()
        if include_optional:
            return LinkLossForwarding(
                type = 'Property',
                value = True,
    ...
    def testLinkLossForwarding(self):
        """Test LinkLossForwarding"""
