...
class TestLinecardMdaType(unittest.TestCase):
    """LinecardMdaType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaType:
        """Test LinecardMdaType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaType`
        """
        model = LinecardMdaType()
        if include_optional:
            return LinecardMdaType(
                type = 'Property',
                value = '',
