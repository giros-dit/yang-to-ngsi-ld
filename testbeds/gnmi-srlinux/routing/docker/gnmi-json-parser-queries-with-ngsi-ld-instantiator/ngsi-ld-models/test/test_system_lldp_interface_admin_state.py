...
class TestSystemLldpInterfaceAdminState(unittest.TestCase):
    """SystemLldpInterfaceAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceAdminState:
        """Test SystemLldpInterfaceAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceAdminState`
        """
        model = SystemLldpInterfaceAdminState()
        if include_optional:
            return SystemLldpInterfaceAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testSystemLldpInterfaceAdminState(self):
        """Test SystemLldpInterfaceAdminState"""
