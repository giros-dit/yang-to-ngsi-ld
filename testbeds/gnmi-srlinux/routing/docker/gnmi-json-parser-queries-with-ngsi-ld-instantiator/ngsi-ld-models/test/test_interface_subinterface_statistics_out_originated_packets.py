...
class TestInterfaceSubinterfaceStatisticsOutOriginatedPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsOutOriginatedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsOutOriginatedPackets:
        """Test InterfaceSubinterfaceStatisticsOutOriginatedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsOutOriginatedPackets`
        """
        model = InterfaceSubinterfaceStatisticsOutOriginatedPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsOutOriginatedPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsOutOriginatedPackets(self):
        """Test InterfaceSubinterfaceStatisticsOutOriginatedPackets"""
