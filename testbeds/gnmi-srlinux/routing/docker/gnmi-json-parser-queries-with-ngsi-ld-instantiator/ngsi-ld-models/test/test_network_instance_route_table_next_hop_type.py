...
class TestNetworkInstanceRouteTableNextHopType(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopType:
        """Test NetworkInstanceRouteTableNextHopType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopType`
        """
        model = NetworkInstanceRouteTableNextHopType()
        if include_optional:
            return NetworkInstanceRouteTableNextHopType(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopType(self):
        """Test NetworkInstanceRouteTableNextHopType"""
