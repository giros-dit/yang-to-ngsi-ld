...
class TestNetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes"""
