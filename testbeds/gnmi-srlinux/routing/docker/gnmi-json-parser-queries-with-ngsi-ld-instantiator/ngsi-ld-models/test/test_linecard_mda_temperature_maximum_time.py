...
class TestLinecardMdaTemperatureMaximumTime(unittest.TestCase):
    """LinecardMdaTemperatureMaximumTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaTemperatureMaximumTime:
        """Test LinecardMdaTemperatureMaximumTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaTemperatureMaximumTime`
        """
        model = LinecardMdaTemperatureMaximumTime()
        if include_optional:
            return LinecardMdaTemperatureMaximumTime(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaTemperatureMaximumTime(self):
        """Test LinecardMdaTemperatureMaximumTime"""
