...
class TestInterfaceSubinterfaceIpv6AdminState(unittest.TestCase):
    """InterfaceSubinterfaceIpv6AdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6AdminState:
        """Test InterfaceSubinterfaceIpv6AdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6AdminState`
        """
        model = InterfaceSubinterfaceIpv6AdminState()
        if include_optional:
            return InterfaceSubinterfaceIpv6AdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testInterfaceSubinterfaceIpv6AdminState(self):
        """Test InterfaceSubinterfaceIpv6AdminState"""
