...
class TestSystemLldpInterfaceNeighborManagementAddressAddress(unittest.TestCase):
    """SystemLldpInterfaceNeighborManagementAddressAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborManagementAddressAddress:
        """Test SystemLldpInterfaceNeighborManagementAddressAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborManagementAddressAddress`
        """
        model = SystemLldpInterfaceNeighborManagementAddressAddress()
        if include_optional:
            return SystemLldpInterfaceNeighborManagementAddressAddress(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborManagementAddressAddress(self):
        """Test SystemLldpInterfaceNeighborManagementAddressAddress"""
