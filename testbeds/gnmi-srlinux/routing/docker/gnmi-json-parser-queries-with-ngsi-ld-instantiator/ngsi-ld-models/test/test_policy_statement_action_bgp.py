...
class TestPolicyStatementActionBgp(unittest.TestCase):
    """PolicyStatementActionBgp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgp:
        """Test PolicyStatementActionBgp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgp`
        """
        model = PolicyStatementActionBgp()
        if include_optional:
            return PolicyStatementActionBgp(
                id = '',
                type = 'PolicyStatementActionBgp',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgp(self):
        """Test PolicyStatementActionBgp"""
