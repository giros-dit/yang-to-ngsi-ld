...
class TestLsaNotInLsdbs(unittest.TestCase):
    """LsaNotInLsdbs unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LsaNotInLsdbs:
        """Test LsaNotInLsdbs
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LsaNotInLsdbs`
        """
        model = LsaNotInLsdbs()
        if include_optional:
            return LsaNotInLsdbs(
                type = 'Property',
                value = 56,
