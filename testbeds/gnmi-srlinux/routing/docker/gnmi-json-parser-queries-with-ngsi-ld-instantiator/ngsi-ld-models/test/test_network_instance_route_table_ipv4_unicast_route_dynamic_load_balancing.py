...
class TestNetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteDynamicLoadBalancing"""
