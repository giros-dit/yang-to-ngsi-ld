...
class TestTunnelAllowedTunnelTypes(unittest.TestCase):
    """TunnelAllowedTunnelTypes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TunnelAllowedTunnelTypes:
        """Test TunnelAllowedTunnelTypes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TunnelAllowedTunnelTypes`
        """
        model = TunnelAllowedTunnelTypes()
        if include_optional:
            return TunnelAllowedTunnelTypes(
                type = 'Property',
                value = '',
    ...
    def testTunnelAllowedTunnelTypes(self):
        """Test TunnelAllowedTunnelTypes"""
