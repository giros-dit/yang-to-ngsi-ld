...
class TestAnycastGwMac(unittest.TestCase):
    """AnycastGwMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnycastGwMac:
        """Test AnycastGwMac
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnycastGwMac`
        """
        model = AnycastGwMac()
        if include_optional:
            return AnycastGwMac(
