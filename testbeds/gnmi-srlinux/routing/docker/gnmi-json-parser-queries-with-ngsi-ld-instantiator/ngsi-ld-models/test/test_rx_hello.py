...
class TestRxHello(unittest.TestCase):
    """RxHello unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RxHello:
        """Test RxHello
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RxHello`
        """
        model = RxHello()
        if include_optional:
            return RxHello(
