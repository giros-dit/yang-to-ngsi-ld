...
class TestPolicyStatementActionBgpNextHopResolution(unittest.TestCase):
    """PolicyStatementActionBgpNextHopResolution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpNextHopResolution:
        """Test PolicyStatementActionBgpNextHopResolution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpNextHopResolution`
        """
        model = PolicyStatementActionBgpNextHopResolution()
        if include_optional:
            return PolicyStatementActionBgpNextHopResolution(
                id = '',
                type = 'PolicyStatementActionBgpNextHopResolution',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpNextHopResolution(self):
        """Test PolicyStatementActionBgpNextHopResolution"""
