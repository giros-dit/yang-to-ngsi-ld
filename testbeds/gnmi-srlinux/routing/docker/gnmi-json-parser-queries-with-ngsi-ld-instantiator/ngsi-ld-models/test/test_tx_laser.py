...
class TestTxLaser(unittest.TestCase):
    """TxLaser unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TxLaser:
        """Test TxLaser
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TxLaser`
        """
        model = TxLaser()
        if include_optional:
            return TxLaser(
