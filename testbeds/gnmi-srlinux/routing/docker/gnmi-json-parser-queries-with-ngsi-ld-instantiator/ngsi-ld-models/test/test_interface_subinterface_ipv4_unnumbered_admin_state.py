...
class TestInterfaceSubinterfaceIpv4UnnumberedAdminState(unittest.TestCase):
    """InterfaceSubinterfaceIpv4UnnumberedAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4UnnumberedAdminState:
        """Test InterfaceSubinterfaceIpv4UnnumberedAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4UnnumberedAdminState`
        """
        model = InterfaceSubinterfaceIpv4UnnumberedAdminState()
        if include_optional:
            return InterfaceSubinterfaceIpv4UnnumberedAdminState(
                type = 'Property',
                value = 'disable',
    ...
    def testInterfaceSubinterfaceIpv4UnnumberedAdminState(self):
        """Test InterfaceSubinterfaceIpv4UnnumberedAdminState"""
