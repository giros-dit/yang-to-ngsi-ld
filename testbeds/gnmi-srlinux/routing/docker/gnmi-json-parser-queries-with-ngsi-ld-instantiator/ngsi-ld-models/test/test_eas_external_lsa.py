...
class TestEAsExternalLsa(unittest.TestCase):
    """EAsExternalLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EAsExternalLsa:
        """Test EAsExternalLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EAsExternalLsa`
        """
        model = EAsExternalLsa()
        if include_optional:
            return EAsExternalLsa(
                type = 'Property',
                value = 56,
