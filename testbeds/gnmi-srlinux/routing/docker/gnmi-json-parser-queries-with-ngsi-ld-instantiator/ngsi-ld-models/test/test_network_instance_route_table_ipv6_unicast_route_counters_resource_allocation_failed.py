...
class TestNetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed"""
