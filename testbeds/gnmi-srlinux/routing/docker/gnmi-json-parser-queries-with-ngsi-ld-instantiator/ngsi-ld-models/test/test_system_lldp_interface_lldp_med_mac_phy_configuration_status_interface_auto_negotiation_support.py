...
class TestSystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport(unittest.TestCase):
    """SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport:
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport`
        """
        model = SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport()
        if include_optional:
            return SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport(
                type = 'Property',
                value = 'unknown',
    ...
    def testSystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport(self):
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationSupport"""
