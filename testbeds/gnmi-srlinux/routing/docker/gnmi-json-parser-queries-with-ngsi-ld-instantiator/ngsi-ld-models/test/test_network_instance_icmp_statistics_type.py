...
class TestNetworkInstanceIcmpStatisticsType(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsType:
        """Test NetworkInstanceIcmpStatisticsType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsType`
        """
        model = NetworkInstanceIcmpStatisticsType()
        if include_optional:
            return NetworkInstanceIcmpStatisticsType(
                id = '',
                type = 'NetworkInstanceIcmpStatisticsType',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceIcmpStatisticsType(self):
        """Test NetworkInstanceIcmpStatisticsType"""
