...
class TestRestartHelperExitRc(unittest.TestCase):
    """RestartHelperExitRc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RestartHelperExitRc:
        """Test RestartHelperExitRc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RestartHelperExitRc`
        """
        model = RestartHelperExitRc()
        if include_optional:
            return RestartHelperExitRc(
                type = 'Property',
                value = 'none',
    ...
    def testRestartHelperExitRc(self):
        """Test RestartHelperExitRc"""
