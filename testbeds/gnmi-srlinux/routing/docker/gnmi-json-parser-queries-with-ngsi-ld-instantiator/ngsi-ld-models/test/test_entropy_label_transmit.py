...
class TestEntropyLabelTransmit(unittest.TestCase):
    """EntropyLabelTransmit unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntropyLabelTransmit:
        """Test EntropyLabelTransmit
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntropyLabelTransmit`
        """
        model = EntropyLabelTransmit()
        if include_optional:
            return EntropyLabelTransmit(
                type = 'Property',
                value = True,
    ...
    def testEntropyLabelTransmit(self):
        """Test EntropyLabelTransmit"""
