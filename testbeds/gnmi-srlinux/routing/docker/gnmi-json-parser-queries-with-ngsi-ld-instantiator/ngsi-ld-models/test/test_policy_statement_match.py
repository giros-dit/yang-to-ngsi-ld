...
class TestPolicyStatementMatch(unittest.TestCase):
    """PolicyStatementMatch unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatch:
        """Test PolicyStatementMatch
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatch`
        """
        model = PolicyStatementMatch()
        if include_optional:
            return PolicyStatementMatch(
                id = '',
                type = 'PolicyStatementMatch',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                network_instance_leaked_route = None,
                is_part_of = None
            )
        else:
            return PolicyStatementMatch(
    ...
    def testPolicyStatementMatch(self):
        """Test PolicyStatementMatch"""
