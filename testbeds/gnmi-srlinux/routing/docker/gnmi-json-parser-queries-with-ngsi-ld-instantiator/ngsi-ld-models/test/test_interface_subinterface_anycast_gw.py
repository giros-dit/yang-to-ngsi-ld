...
class TestInterfaceSubinterfaceAnycastGw(unittest.TestCase):
    """InterfaceSubinterfaceAnycastGw unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceAnycastGw:
        """Test InterfaceSubinterfaceAnycastGw
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceAnycastGw`
        """
        model = InterfaceSubinterfaceAnycastGw()
        if include_optional:
            return InterfaceSubinterfaceAnycastGw(
                id = '',
    ...
    def testInterfaceSubinterfaceAnycastGw(self):
        """Test InterfaceSubinterfaceAnycastGw"""
