...
class TestControlLocatorState(unittest.TestCase):
    """ControlLocatorState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlLocatorState:
        """Test ControlLocatorState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlLocatorState`
        """
        model = ControlLocatorState()
        if include_optional:
            return ControlLocatorState(
                type = 'Property',
                value = 'inactive',
    ...
    def testControlLocatorState(self):
        """Test ControlLocatorState"""
