...
class TestNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType(
                type = 'Property',
                value = 'add',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteFibProgrammingPendingOperationType"""
