...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax"""
