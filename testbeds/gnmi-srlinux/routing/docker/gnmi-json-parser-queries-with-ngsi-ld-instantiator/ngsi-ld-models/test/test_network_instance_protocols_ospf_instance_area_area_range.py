...
class TestNetworkInstanceProtocolsOspfInstanceAreaAreaRange(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaAreaRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaAreaRange:
        """Test NetworkInstanceProtocolsOspfInstanceAreaAreaRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaAreaRange`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaAreaRange()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaAreaRange(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaAreaRange(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaAreaRange"""
