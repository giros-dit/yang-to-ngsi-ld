...
class TestPolicyStatementMatchBgpAsPathLength(unittest.TestCase):
    """PolicyStatementMatchBgpAsPathLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchBgpAsPathLength:
        """Test PolicyStatementMatchBgpAsPathLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchBgpAsPathLength`
        """
        model = PolicyStatementMatchBgpAsPathLength()
        if include_optional:
            return PolicyStatementMatchBgpAsPathLength(
                id = '',
                type = 'PolicyStatementMatchBgpAsPathLength',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementMatchBgpAsPathLength(self):
        """Test PolicyStatementMatchBgpAsPathLength"""
