...
class TestNetworkInstanceIcmp6StatisticsTypeName(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTypeName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTypeName:
        """Test NetworkInstanceIcmp6StatisticsTypeName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTypeName`
        """
        model = NetworkInstanceIcmp6StatisticsTypeName()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTypeName(
                type = 'Property',
                value = 'dest-unreachable',
    ...
    def testNetworkInstanceIcmp6StatisticsTypeName(self):
        """Test NetworkInstanceIcmp6StatisticsTypeName"""
