...
class TestNetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask:
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaNssaAreaRangeIpPrefixMask"""
