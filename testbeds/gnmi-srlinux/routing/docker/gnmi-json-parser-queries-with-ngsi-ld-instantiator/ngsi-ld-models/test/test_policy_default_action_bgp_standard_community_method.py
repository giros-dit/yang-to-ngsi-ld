...
class TestPolicyDefaultActionBgpStandardCommunityMethod(unittest.TestCase):
    """PolicyDefaultActionBgpStandardCommunityMethod unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpStandardCommunityMethod:
        """Test PolicyDefaultActionBgpStandardCommunityMethod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpStandardCommunityMethod`
        """
        model = PolicyDefaultActionBgpStandardCommunityMethod()
        if include_optional:
            return PolicyDefaultActionBgpStandardCommunityMethod(
                type = 'Property',
                value = 'reference',
    ...
    def testPolicyDefaultActionBgpStandardCommunityMethod(self):
        """Test PolicyDefaultActionBgpStandardCommunityMethod"""
