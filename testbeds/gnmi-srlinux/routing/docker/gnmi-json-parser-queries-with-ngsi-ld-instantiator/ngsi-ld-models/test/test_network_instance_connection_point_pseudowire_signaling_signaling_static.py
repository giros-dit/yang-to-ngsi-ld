...
class TestNetworkInstanceConnectionPointPseudowireSignalingSignalingStatic(unittest.TestCase):
    """NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic:
        """Test NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic`
        """
        model = NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic()
        if include_optional:
            return NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic(
                id = '',
                type = 'NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                ingress_vc_label = None,
                egress_vc_label = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic(
    ...
    def testNetworkInstanceConnectionPointPseudowireSignalingSignalingStatic(self):
        """Test NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic"""
