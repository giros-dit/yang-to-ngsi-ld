...
class TestOutMulticastPackets(unittest.TestCase):
    """OutMulticastPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutMulticastPackets:
        """Test OutMulticastPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutMulticastPackets`
        """
        model = OutMulticastPackets()
        if include_optional:
    ...
    def testOutMulticastPackets(self):
        """Test OutMulticastPackets"""
