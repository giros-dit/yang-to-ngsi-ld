...
class TestNetworkInstanceRouteTableIpv4UnicastRouteRouteType(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteRouteType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteRouteType:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteRouteType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteRouteType`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteRouteType()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteRouteType(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteRouteType(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteRouteType"""
