...
class TestPolicyDefaultActionBgpLocalPreferenceSet(unittest.TestCase):
    """PolicyDefaultActionBgpLocalPreferenceSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpLocalPreferenceSet:
        """Test PolicyDefaultActionBgpLocalPreferenceSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpLocalPreferenceSet`
        """
        model = PolicyDefaultActionBgpLocalPreferenceSet()
        if include_optional:
            return PolicyDefaultActionBgpLocalPreferenceSet(
                type = 'Property',
                value = 56,
    ...
    def testPolicyDefaultActionBgpLocalPreferenceSet(self):
        """Test PolicyDefaultActionBgpLocalPreferenceSet"""
