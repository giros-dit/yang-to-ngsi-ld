...
class TestPolicyStatementActionBgpAsPath(unittest.TestCase):
    """PolicyStatementActionBgpAsPath unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpAsPath:
        """Test PolicyStatementActionBgpAsPath
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpAsPath`
        """
        model = PolicyStatementActionBgpAsPath()
        if include_optional:
            return PolicyStatementActionBgpAsPath(
                id = '',
                type = 'PolicyStatementActionBgpAsPath',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpAsPath(self):
        """Test PolicyStatementActionBgpAsPath"""
