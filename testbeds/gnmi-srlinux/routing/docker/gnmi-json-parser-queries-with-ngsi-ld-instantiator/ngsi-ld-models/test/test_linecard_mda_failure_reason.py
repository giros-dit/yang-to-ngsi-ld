...
class TestLinecardMdaFailureReason(unittest.TestCase):
    """LinecardMdaFailureReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaFailureReason:
        """Test LinecardMdaFailureReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaFailureReason`
        """
        model = LinecardMdaFailureReason()
        if include_optional:
            return LinecardMdaFailureReason(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaFailureReason(self):
        """Test LinecardMdaFailureReason"""
