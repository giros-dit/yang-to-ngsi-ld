...
class TestNetworkInstanceProtocolsOspfInstanceOperState(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceOperState:
        """Test NetworkInstanceProtocolsOspfInstanceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceOperState`
        """
        model = NetworkInstanceProtocolsOspfInstanceOperState()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceOperState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceProtocolsOspfInstanceOperState(self):
        """Test NetworkInstanceProtocolsOspfInstanceOperState"""
