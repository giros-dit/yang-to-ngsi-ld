...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceMetric"""
