...
class TestNetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded"""
