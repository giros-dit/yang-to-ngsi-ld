...
class TestNetworkInstanceRouteTableIpv6UnicastRouteActive(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteActive unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteActive:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteActive
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteActive`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteActive()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteActive(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteActive(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteActive"""
