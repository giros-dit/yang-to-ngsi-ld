...
class TestNetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes:
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes`
        """
        model = NetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes(self):
        """Test NetworkInstanceRouteTableIpv4UnicastStatisticsLeakedRoutes"""
