...
class TestDecapsulateHeader(unittest.TestCase):
    """DecapsulateHeader unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DecapsulateHeader:
        """Test DecapsulateHeader
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DecapsulateHeader`
        """
        model = DecapsulateHeader()
        if include_optional:
            return DecapsulateHeader(
                type = 'Property',
                value = 'gre',
    ...
    def testDecapsulateHeader(self):
        """Test DecapsulateHeader"""
