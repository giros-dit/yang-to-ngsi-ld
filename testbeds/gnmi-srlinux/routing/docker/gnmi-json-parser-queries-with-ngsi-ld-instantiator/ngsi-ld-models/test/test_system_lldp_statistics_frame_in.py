...
class TestSystemLldpStatisticsFrameIn(unittest.TestCase):
    """SystemLldpStatisticsFrameIn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpStatisticsFrameIn:
        """Test SystemLldpStatisticsFrameIn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpStatisticsFrameIn`
        """
        model = SystemLldpStatisticsFrameIn()
        if include_optional:
            return SystemLldpStatisticsFrameIn(
                type = 'Property',
                value = 56,
    ...
    def testSystemLldpStatisticsFrameIn(self):
        """Test SystemLldpStatisticsFrameIn"""
