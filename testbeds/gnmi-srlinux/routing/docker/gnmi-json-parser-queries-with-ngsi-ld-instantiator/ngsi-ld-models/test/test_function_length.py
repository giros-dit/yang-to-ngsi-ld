...
class TestFunctionLength(unittest.TestCase):
    """FunctionLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FunctionLength:
        """Test FunctionLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FunctionLength`
        """
        model = FunctionLength()
        if include_optional:
