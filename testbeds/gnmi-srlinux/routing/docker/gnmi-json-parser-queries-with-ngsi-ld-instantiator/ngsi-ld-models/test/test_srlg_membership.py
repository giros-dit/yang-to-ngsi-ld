...
class TestSrlgMembership(unittest.TestCase):
    """SrlgMembership unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SrlgMembership:
        """Test SrlgMembership
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SrlgMembership`
        """
        model = SrlgMembership()
        if include_optional:
            return SrlgMembership(
                type = 'Relationship',
                object = '',
