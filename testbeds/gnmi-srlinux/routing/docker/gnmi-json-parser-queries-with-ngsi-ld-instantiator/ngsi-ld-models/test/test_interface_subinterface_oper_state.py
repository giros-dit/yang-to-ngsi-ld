...
class TestInterfaceSubinterfaceOperState(unittest.TestCase):
    """InterfaceSubinterfaceOperState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceOperState:
        """Test InterfaceSubinterfaceOperState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceOperState`
        """
        model = InterfaceSubinterfaceOperState()
        if include_optional:
            return InterfaceSubinterfaceOperState(
                type = 'Property',
                value = 'up',
    ...
    def testInterfaceSubinterfaceOperState(self):
        """Test InterfaceSubinterfaceOperState"""
