...
class TestMaxPenalties(unittest.TestCase):
    """MaxPenalties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaxPenalties:
        """Test MaxPenalties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaxPenalties`
        """
        model = MaxPenalties()
        if include_optional:
            return MaxPenalties(
