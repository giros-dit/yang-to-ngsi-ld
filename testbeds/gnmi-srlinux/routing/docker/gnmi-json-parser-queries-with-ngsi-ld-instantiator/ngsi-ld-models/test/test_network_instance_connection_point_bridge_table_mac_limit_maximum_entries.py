...
class TestNetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries:
        """Test NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries(
                type = 'Property',
                value = 1,
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries"""
