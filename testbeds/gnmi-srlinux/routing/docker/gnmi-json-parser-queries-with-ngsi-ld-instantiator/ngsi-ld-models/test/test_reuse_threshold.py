...
class TestReuseThreshold(unittest.TestCase):
    """ReuseThreshold unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReuseThreshold:
        """Test ReuseThreshold
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReuseThreshold`
        """
        model = ReuseThreshold()
        if include_optional:
            return ReuseThreshold(
                type = 'Property',
                value = 1,
