...
class TestOutUnicastPackets(unittest.TestCase):
    """OutUnicastPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutUnicastPackets:
        """Test OutUnicastPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutUnicastPackets`
        """
        model = OutUnicastPackets()
        if include_optional:
    ...
    def testOutUnicastPackets(self):
        """Test OutUnicastPackets"""
