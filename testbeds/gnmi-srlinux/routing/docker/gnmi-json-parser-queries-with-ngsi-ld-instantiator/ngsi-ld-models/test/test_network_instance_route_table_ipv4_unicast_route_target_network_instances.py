...
class TestNetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteTargetNetworkInstances"""
