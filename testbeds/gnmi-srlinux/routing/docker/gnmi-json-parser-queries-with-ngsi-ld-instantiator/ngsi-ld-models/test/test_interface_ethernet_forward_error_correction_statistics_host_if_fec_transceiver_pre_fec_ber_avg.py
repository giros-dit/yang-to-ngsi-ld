...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg(
                type = 'Property',
                value = 1.337,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverPreFecBerAvg"""
