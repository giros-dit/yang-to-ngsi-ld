...
class TestLinecardLastChange(unittest.TestCase):
    """LinecardLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardLastChange:
        """Test LinecardLastChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardLastChange`
        """
        model = LinecardLastChange()
        if include_optional:
            return LinecardLastChange(
                type = 'Property',
                value = '',
    ...
    def testLinecardLastChange(self):
        """Test LinecardLastChange"""
