...
class TestNetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteNextHopGroup"""
