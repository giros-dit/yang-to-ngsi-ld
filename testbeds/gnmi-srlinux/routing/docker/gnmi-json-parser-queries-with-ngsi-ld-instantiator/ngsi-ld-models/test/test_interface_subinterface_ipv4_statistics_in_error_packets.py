...
class TestInterfaceSubinterfaceIpv4StatisticsInErrorPackets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInErrorPackets:
        """Test InterfaceSubinterfaceIpv4StatisticsInErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInErrorPackets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInErrorPackets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInErrorPackets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInErrorPackets"""
