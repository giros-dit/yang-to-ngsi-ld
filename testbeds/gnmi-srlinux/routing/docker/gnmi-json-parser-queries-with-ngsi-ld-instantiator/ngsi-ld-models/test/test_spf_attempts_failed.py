...
class TestSpfAttemptsFailed(unittest.TestCase):
    """SpfAttemptsFailed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SpfAttemptsFailed:
        """Test SpfAttemptsFailed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SpfAttemptsFailed`
        """
        model = SpfAttemptsFailed()
        if include_optional:
            return SpfAttemptsFailed(
                type = 'Property',
                value = 56,
    ...
    def testSpfAttemptsFailed(self):
        """Test SpfAttemptsFailed"""
