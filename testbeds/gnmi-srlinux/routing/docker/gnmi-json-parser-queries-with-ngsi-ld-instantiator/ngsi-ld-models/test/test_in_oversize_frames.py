...
class TestInOversizeFrames(unittest.TestCase):
    """InOversizeFrames unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InOversizeFrames:
        """Test InOversizeFrames
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InOversizeFrames`
        """
        model = InOversizeFrames()
        if include_optional:
            return InOversizeFrames(
                type = 'Property',
                value = 56,
