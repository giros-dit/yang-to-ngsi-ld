...
class TestNetworkInstanceRouteTableIpv6UnicastRouteId(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRouteId unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRouteId:
        """Test NetworkInstanceRouteTableIpv6UnicastRouteId
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRouteId`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRouteId()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRouteId(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRouteId(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRouteId"""
