...
class TestInterfaceTransceiverTemperatureMaximum(unittest.TestCase):
    """InterfaceTransceiverTemperatureMaximum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceTransceiverTemperatureMaximum:
        """Test InterfaceTransceiverTemperatureMaximum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceTransceiverTemperatureMaximum`
        """
        model = InterfaceTransceiverTemperatureMaximum()
        if include_optional:
            return InterfaceTransceiverTemperatureMaximum(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceTransceiverTemperatureMaximum(self):
        """Test InterfaceTransceiverTemperatureMaximum"""
