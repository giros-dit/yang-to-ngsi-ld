...
class TestSendFlushOnFailure(unittest.TestCase):
    """SendFlushOnFailure unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendFlushOnFailure:
        """Test SendFlushOnFailure
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendFlushOnFailure`
        """
        model = SendFlushOnFailure()
        if include_optional:
            return SendFlushOnFailure(
                type = 'Property',
                value = True,
    ...
    def testSendFlushOnFailure(self):
        """Test SendFlushOnFailure"""
