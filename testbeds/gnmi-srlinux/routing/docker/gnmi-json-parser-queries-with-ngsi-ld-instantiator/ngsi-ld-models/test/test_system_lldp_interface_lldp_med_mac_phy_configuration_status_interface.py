...
class TestSystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface(unittest.TestCase):
    """SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface:
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface`
        """
        model = SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface()
        if include_optional:
            return SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface(
                id = '',
                type = 'SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                auto_negotiation_support = None,
                auto_negotiation_enabled = None,
                auto_negotiation_capabilities = None,
                is_part_of = None
            )
        else:
            return SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface(
    ...
    def testSystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface(self):
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterface"""
