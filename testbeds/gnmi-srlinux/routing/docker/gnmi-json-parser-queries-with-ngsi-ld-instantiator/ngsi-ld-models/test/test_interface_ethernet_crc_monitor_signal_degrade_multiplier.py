...
class TestInterfaceEthernetCrcMonitorSignalDegradeMultiplier(unittest.TestCase):
    """InterfaceEthernetCrcMonitorSignalDegradeMultiplier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetCrcMonitorSignalDegradeMultiplier:
        """Test InterfaceEthernetCrcMonitorSignalDegradeMultiplier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetCrcMonitorSignalDegradeMultiplier`
        """
        model = InterfaceEthernetCrcMonitorSignalDegradeMultiplier()
        if include_optional:
            return InterfaceEthernetCrcMonitorSignalDegradeMultiplier(
                type = 'Property',
                value = 1,
    ...
    def testInterfaceEthernetCrcMonitorSignalDegradeMultiplier(self):
        """Test InterfaceEthernetCrcMonitorSignalDegradeMultiplier"""
