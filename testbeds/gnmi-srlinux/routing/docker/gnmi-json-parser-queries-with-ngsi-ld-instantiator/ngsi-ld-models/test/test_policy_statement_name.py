...
class TestPolicyStatementName(unittest.TestCase):
    """PolicyStatementName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementName:
        """Test PolicyStatementName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementName`
        """
        model = PolicyStatementName()
        if include_optional:
            return PolicyStatementName(
                type = 'Property',
                value = '',
    ...
    def testPolicyStatementName(self):
        """Test PolicyStatementName"""
