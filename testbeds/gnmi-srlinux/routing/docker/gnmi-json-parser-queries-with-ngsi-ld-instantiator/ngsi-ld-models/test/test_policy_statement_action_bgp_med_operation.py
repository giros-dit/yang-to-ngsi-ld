...
class TestPolicyStatementActionBgpMedOperation(unittest.TestCase):
    """PolicyStatementActionBgpMedOperation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpMedOperation:
        """Test PolicyStatementActionBgpMedOperation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpMedOperation`
        """
        model = PolicyStatementActionBgpMedOperation()
        if include_optional:
            return PolicyStatementActionBgpMedOperation(
                type = 'Property',
                value = 'set',
    ...
    def testPolicyStatementActionBgpMedOperation(self):
        """Test PolicyStatementActionBgpMedOperation"""
