...
class TestOvldLsaLimitRemInterval(unittest.TestCase):
    """OvldLsaLimitRemInterval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OvldLsaLimitRemInterval:
        """Test OvldLsaLimitRemInterval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OvldLsaLimitRemInterval`
        """
        model = OvldLsaLimitRemInterval()
        if include_optional:
            return OvldLsaLimitRemInterval(
                type = 'Property',
                value = 0,
    ...
    def testOvldLsaLimitRemInterval(self):
        """Test OvldLsaLimitRemInterval"""
