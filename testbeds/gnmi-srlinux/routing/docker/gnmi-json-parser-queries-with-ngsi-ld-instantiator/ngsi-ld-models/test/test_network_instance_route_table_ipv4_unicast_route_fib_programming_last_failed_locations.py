...
class TestNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations(
                type = 'Property',
                value = 'complex-14.0',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteFibProgrammingLastFailedLocations"""
