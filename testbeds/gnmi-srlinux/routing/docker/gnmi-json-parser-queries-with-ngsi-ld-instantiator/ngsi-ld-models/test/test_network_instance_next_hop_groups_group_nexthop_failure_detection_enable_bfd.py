...
class TestNetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd:
        """Test NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd(
                id = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopFailureDetectionEnableBfd"""
