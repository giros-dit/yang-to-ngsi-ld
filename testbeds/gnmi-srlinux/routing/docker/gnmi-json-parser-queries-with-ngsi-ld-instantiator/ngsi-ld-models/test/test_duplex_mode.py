...
class TestDuplexMode(unittest.TestCase):
    """DuplexMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DuplexMode:
        """Test DuplexMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DuplexMode`
        """
        model = DuplexMode()
        if include_optional:
            return DuplexMode(
