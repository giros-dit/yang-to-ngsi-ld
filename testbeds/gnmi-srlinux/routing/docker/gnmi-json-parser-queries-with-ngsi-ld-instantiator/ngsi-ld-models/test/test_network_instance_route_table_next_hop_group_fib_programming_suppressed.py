...
class TestNetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed:
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed`
        """
        model = NetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed(self):
        """Test NetworkInstanceRouteTableNextHopGroupFibProgrammingSuppressed"""
