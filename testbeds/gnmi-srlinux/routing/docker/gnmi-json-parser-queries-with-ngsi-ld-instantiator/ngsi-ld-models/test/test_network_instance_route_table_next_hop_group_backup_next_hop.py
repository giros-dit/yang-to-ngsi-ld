...
class TestNetworkInstanceRouteTableNextHopGroupBackupNextHop(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupBackupNextHop unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupBackupNextHop:
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHop
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupBackupNextHop`
        """
        model = NetworkInstanceRouteTableNextHopGroupBackupNextHop()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupBackupNextHop(
                id = None,
                type = 'NetworkInstanceRouteTableNextHopGroupBackupNextHop',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableNextHopGroupBackupNextHop(self):
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHop"""
