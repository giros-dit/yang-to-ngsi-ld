...
class TestSystemSrv6LocatorMicroSegmentUn(unittest.TestCase):
    """SystemSrv6LocatorMicroSegmentUn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorMicroSegmentUn:
        """Test SystemSrv6LocatorMicroSegmentUn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorMicroSegmentUn`
        """
        model = SystemSrv6LocatorMicroSegmentUn()
        if include_optional:
            return SystemSrv6LocatorMicroSegmentUn(
                id = '',
                type = 'SystemSrv6LocatorMicroSegmentUn',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemSrv6LocatorMicroSegmentUn(self):
        """Test SystemSrv6LocatorMicroSegmentUn"""
