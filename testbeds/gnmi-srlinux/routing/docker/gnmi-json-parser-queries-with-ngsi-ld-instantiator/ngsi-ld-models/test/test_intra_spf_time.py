...
class TestIntraSpfTime(unittest.TestCase):
    """IntraSpfTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntraSpfTime:
        """Test IntraSpfTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntraSpfTime`
        """
        model = IntraSpfTime()
        if include_optional:
            return IntraSpfTime(
