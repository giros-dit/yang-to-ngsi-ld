...
class TestPolicyDefaultActionIsis(unittest.TestCase):
    """PolicyDefaultActionIsis unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionIsis:
        """Test PolicyDefaultActionIsis
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionIsis`
        """
        model = PolicyDefaultActionIsis()
        if include_optional:
            return PolicyDefaultActionIsis(
                id = '',
                type = 'PolicyDefaultActionIsis',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionIsis(self):
        """Test PolicyDefaultActionIsis"""
