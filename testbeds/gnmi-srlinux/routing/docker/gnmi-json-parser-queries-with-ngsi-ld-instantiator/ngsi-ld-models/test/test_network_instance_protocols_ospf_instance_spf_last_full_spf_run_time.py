...
class TestNetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime:
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime`
        """
        model = NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime(self):
        """Test NetworkInstanceProtocolsOspfInstanceSpfLastFullSpfRunTime"""
