...
class TestNetworkInstanceConnectionPointRedundancyStandbySignaling(unittest.TestCase):
    """NetworkInstanceConnectionPointRedundancyStandbySignaling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointRedundancyStandbySignaling:
        """Test NetworkInstanceConnectionPointRedundancyStandbySignaling
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointRedundancyStandbySignaling`
        """
        model = NetworkInstanceConnectionPointRedundancyStandbySignaling()
        if include_optional:
            return NetworkInstanceConnectionPointRedundancyStandbySignaling(
                type = 'Property',
                value = 'follower',
    ...
    def testNetworkInstanceConnectionPointRedundancyStandbySignaling(self):
        """Test NetworkInstanceConnectionPointRedundancyStandbySignaling"""
