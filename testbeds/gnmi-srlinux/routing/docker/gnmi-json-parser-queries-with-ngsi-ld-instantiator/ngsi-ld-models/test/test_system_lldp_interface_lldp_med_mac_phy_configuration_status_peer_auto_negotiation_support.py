...
class TestSystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport(unittest.TestCase):
    """SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport:
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport`
        """
        model = SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport()
        if include_optional:
            return SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport(
                type = 'Property',
                value = 'unknown',
    ...
    def testSystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport(self):
        """Test SystemLldpInterfaceLldpMedMacPhyConfigurationStatusPeerAutoNegotiationSupport"""
