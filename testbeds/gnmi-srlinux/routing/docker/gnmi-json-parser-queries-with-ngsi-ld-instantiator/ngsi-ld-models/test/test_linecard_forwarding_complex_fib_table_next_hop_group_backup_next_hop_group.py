...
class TestLinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup(unittest.TestCase):
    """LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup:
        """Test LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup`
        """
        model = LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup()
        if include_optional:
            return LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup(
                type = 'Relationship',
                object = '',
    ...
    def testLinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup(self):
        """Test LinecardForwardingComplexFibTableNextHopGroupBackupNextHopGroup"""
