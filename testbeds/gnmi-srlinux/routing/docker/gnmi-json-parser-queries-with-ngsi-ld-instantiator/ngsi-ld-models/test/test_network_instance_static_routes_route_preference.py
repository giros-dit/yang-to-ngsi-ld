...
class TestNetworkInstanceStaticRoutesRoutePreference(unittest.TestCase):
    """NetworkInstanceStaticRoutesRoutePreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesRoutePreference:
        """Test NetworkInstanceStaticRoutesRoutePreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesRoutePreference`
        """
        model = NetworkInstanceStaticRoutesRoutePreference()
        if include_optional:
            return NetworkInstanceStaticRoutesRoutePreference(
                type = 'Property',
                value = 0,
    ...
    def testNetworkInstanceStaticRoutesRoutePreference(self):
        """Test NetworkInstanceStaticRoutesRoutePreference"""
