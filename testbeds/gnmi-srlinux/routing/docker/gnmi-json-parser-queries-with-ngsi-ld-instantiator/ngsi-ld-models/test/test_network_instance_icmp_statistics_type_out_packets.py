...
class TestNetworkInstanceIcmpStatisticsTypeOutPackets(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTypeOutPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTypeOutPackets:
        """Test NetworkInstanceIcmpStatisticsTypeOutPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTypeOutPackets`
        """
        model = NetworkInstanceIcmpStatisticsTypeOutPackets()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTypeOutPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceIcmpStatisticsTypeOutPackets(self):
        """Test NetworkInstanceIcmpStatisticsTypeOutPackets"""
