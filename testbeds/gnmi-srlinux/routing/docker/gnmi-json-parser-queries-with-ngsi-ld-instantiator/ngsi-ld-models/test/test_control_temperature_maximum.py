...
class TestControlTemperatureMaximum(unittest.TestCase):
    """ControlTemperatureMaximum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlTemperatureMaximum:
        """Test ControlTemperatureMaximum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlTemperatureMaximum`
        """
        model = ControlTemperatureMaximum()
        if include_optional:
            return ControlTemperatureMaximum(
                type = 'Property',
                value = 56,
    ...
    def testControlTemperatureMaximum(self):
        """Test ControlTemperatureMaximum"""
