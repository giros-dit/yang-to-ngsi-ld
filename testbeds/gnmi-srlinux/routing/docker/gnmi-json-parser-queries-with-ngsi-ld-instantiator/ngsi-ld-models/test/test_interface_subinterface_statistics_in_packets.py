...
class TestInterfaceSubinterfaceStatisticsInPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInPackets:
        """Test InterfaceSubinterfaceStatisticsInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInPackets`
        """
        model = InterfaceSubinterfaceStatisticsInPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInPackets(self):
        """Test InterfaceSubinterfaceStatisticsInPackets"""
