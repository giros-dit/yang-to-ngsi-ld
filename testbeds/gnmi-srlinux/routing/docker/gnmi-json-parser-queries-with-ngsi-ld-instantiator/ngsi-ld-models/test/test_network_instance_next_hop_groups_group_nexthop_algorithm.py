...
class TestNetworkInstanceNextHopGroupsGroupNexthopAlgorithm(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopAlgorithm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopAlgorithm:
        """Test NetworkInstanceNextHopGroupsGroupNexthopAlgorithm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopAlgorithm`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopAlgorithm()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopAlgorithm(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopAlgorithm(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopAlgorithm"""
