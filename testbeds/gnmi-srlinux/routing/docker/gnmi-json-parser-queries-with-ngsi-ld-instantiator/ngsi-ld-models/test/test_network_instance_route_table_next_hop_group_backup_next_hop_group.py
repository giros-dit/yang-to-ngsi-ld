...
class TestNetworkInstanceRouteTableNextHopGroupBackupNextHopGroup(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupBackupNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupBackupNextHopGroup:
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupBackupNextHopGroup`
        """
        model = NetworkInstanceRouteTableNextHopGroupBackupNextHopGroup()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupBackupNextHopGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableNextHopGroupBackupNextHopGroup(self):
        """Test NetworkInstanceRouteTableNextHopGroupBackupNextHopGroup"""
