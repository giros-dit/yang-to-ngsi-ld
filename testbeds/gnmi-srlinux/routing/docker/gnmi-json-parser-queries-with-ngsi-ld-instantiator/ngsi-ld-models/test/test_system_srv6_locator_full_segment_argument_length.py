...
class TestSystemSrv6LocatorFullSegmentArgumentLength(unittest.TestCase):
    """SystemSrv6LocatorFullSegmentArgumentLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorFullSegmentArgumentLength:
        """Test SystemSrv6LocatorFullSegmentArgumentLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorFullSegmentArgumentLength`
        """
        model = SystemSrv6LocatorFullSegmentArgumentLength()
        if include_optional:
            return SystemSrv6LocatorFullSegmentArgumentLength(
                type = 'Property',
                value = 56,
    ...
    def testSystemSrv6LocatorFullSegmentArgumentLength(self):
        """Test SystemSrv6LocatorFullSegmentArgumentLength"""
