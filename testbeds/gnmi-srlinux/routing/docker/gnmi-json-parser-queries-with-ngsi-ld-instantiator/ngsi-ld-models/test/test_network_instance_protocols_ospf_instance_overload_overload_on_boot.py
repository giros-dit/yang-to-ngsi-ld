...
class TestNetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot:
        """Test NetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot`
        """
        model = NetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot(self):
        """Test NetworkInstanceProtocolsOspfInstanceOverloadOverloadOnBoot"""
