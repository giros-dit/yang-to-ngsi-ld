...
class TestNetworkInstanceInterfaceBridgeTable(unittest.TestCase):
    """NetworkInstanceInterfaceBridgeTable unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceBridgeTable:
        """Test NetworkInstanceInterfaceBridgeTable
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceBridgeTable`
        """
        model = NetworkInstanceInterfaceBridgeTable()
        if include_optional:
            return NetworkInstanceInterfaceBridgeTable(
                id = '',
                type = 'NetworkInstanceInterfaceBridgeTable',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                mac_relearn_only = None,
                multicast_forwarding = None,
                oper_mac_learning = None,
                oper_mac_learning_disabled_reason = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceInterfaceBridgeTable(
    ...
    def testNetworkInstanceInterfaceBridgeTable(self):
        """Test NetworkInstanceInterfaceBridgeTable"""
