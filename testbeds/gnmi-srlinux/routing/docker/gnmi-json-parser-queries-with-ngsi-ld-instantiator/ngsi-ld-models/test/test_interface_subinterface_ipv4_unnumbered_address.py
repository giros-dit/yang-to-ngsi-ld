...
class TestInterfaceSubinterfaceIpv4UnnumberedAddress(unittest.TestCase):
    """InterfaceSubinterfaceIpv4UnnumberedAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4UnnumberedAddress:
        """Test InterfaceSubinterfaceIpv4UnnumberedAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4UnnumberedAddress`
        """
        model = InterfaceSubinterfaceIpv4UnnumberedAddress()
        if include_optional:
            return InterfaceSubinterfaceIpv4UnnumberedAddress(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceIpv4UnnumberedAddress(self):
        """Test InterfaceSubinterfaceIpv4UnnumberedAddress"""
