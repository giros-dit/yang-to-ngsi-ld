...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket(
                id = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTracePacket"""
