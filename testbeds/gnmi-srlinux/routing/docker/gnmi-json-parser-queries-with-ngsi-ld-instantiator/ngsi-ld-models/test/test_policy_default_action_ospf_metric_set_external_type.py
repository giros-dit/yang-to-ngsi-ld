...
class TestPolicyDefaultActionOspfMetricSetExternalType(unittest.TestCase):
    """PolicyDefaultActionOspfMetricSetExternalType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionOspfMetricSetExternalType:
        """Test PolicyDefaultActionOspfMetricSetExternalType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionOspfMetricSetExternalType`
        """
        model = PolicyDefaultActionOspfMetricSetExternalType()
        if include_optional:
            return PolicyDefaultActionOspfMetricSetExternalType(
                type = 'Property',
                value = 'type-1',
    ...
    def testPolicyDefaultActionOspfMetricSetExternalType(self):
        """Test PolicyDefaultActionOspfMetricSetExternalType"""
