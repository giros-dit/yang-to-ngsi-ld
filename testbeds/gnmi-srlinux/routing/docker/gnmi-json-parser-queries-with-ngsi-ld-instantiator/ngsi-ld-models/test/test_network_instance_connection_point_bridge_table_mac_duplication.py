...
class TestNetworkInstanceConnectionPointBridgeTableMacDuplication(unittest.TestCase):
    """NetworkInstanceConnectionPointBridgeTableMacDuplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceConnectionPointBridgeTableMacDuplication:
        """Test NetworkInstanceConnectionPointBridgeTableMacDuplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceConnectionPointBridgeTableMacDuplication`
        """
        model = NetworkInstanceConnectionPointBridgeTableMacDuplication()
        if include_optional:
            return NetworkInstanceConnectionPointBridgeTableMacDuplication(
                id = '',
                type = 'NetworkInstanceConnectionPointBridgeTableMacDuplication',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceConnectionPointBridgeTableMacDuplication(self):
        """Test NetworkInstanceConnectionPointBridgeTableMacDuplication"""
