...
class TestPolicyStatementActionBgpCommunities(unittest.TestCase):
    """PolicyStatementActionBgpCommunities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpCommunities:
        """Test PolicyStatementActionBgpCommunities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpCommunities`
        """
        model = PolicyStatementActionBgpCommunities()
        if include_optional:
            return PolicyStatementActionBgpCommunities(
                id = '',
                type = 'PolicyStatementActionBgpCommunities',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpCommunities(self):
        """Test PolicyStatementActionBgpCommunities"""
