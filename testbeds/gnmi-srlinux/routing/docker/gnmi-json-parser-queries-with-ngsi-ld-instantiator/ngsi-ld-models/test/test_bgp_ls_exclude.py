...
class TestBgpLsExclude(unittest.TestCase):
    """BgpLsExclude unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BgpLsExclude:
        """Test BgpLsExclude
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BgpLsExclude`
        """
        model = BgpLsExclude()
        if include_optional:
            return BgpLsExclude(
