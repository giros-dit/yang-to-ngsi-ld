...
class TestInterfaceSubinterfaceIfindex(unittest.TestCase):
    """InterfaceSubinterfaceIfindex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIfindex:
        """Test InterfaceSubinterfaceIfindex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIfindex`
        """
        model = InterfaceSubinterfaceIfindex()
        if include_optional:
            return InterfaceSubinterfaceIfindex(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIfindex(self):
        """Test InterfaceSubinterfaceIfindex"""
