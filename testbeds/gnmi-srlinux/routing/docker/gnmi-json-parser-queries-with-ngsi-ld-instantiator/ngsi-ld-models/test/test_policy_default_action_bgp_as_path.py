...
class TestPolicyDefaultActionBgpAsPath(unittest.TestCase):
    """PolicyDefaultActionBgpAsPath unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpAsPath:
        """Test PolicyDefaultActionBgpAsPath
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpAsPath`
        """
        model = PolicyDefaultActionBgpAsPath()
        if include_optional:
            return PolicyDefaultActionBgpAsPath(
                id = '',
                type = 'PolicyDefaultActionBgpAsPath',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionBgpAsPath(self):
        """Test PolicyDefaultActionBgpAsPath"""
