...
class TestNetworkInstanceStaticRoutesRouteAdminState(unittest.TestCase):
    """NetworkInstanceStaticRoutesRouteAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesRouteAdminState:
        """Test NetworkInstanceStaticRoutesRouteAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesRouteAdminState`
        """
        model = NetworkInstanceStaticRoutesRouteAdminState()
        if include_optional:
            return NetworkInstanceStaticRoutesRouteAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testNetworkInstanceStaticRoutesRouteAdminState(self):
        """Test NetworkInstanceStaticRoutesRouteAdminState"""
