...
class TestNetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode:
        """Test NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode(
                type = 'Property',
                value = 'prefer',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopTunnelResolutionMode"""
