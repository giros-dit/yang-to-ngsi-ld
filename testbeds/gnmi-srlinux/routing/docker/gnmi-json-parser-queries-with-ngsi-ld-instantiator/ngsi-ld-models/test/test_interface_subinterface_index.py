...
class TestInterfaceSubinterfaceIndex(unittest.TestCase):
    """InterfaceSubinterfaceIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIndex:
        """Test InterfaceSubinterfaceIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIndex`
        """
        model = InterfaceSubinterfaceIndex()
        if include_optional:
            return InterfaceSubinterfaceIndex(
                type = 'Property',
                value = 0,
    ...
    def testInterfaceSubinterfaceIndex(self):
        """Test InterfaceSubinterfaceIndex"""
