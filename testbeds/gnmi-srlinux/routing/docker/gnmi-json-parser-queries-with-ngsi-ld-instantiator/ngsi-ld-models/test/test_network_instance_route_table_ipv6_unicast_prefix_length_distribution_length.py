...
class TestNetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength:
        """Test NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength`
        """
        model = NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength(
                id = '',
                type = 'NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength(self):
        """Test NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength"""
