...
class TestSystemProtectionPoliciesPolicy(unittest.TestCase):
    """SystemProtectionPoliciesPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemProtectionPoliciesPolicy:
        """Test SystemProtectionPoliciesPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemProtectionPoliciesPolicy`
        """
        model = SystemProtectionPoliciesPolicy()
        if include_optional:
            return SystemProtectionPoliciesPolicy(
                id = '',
                type = 'SystemProtectionPoliciesPolicy',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemProtectionPoliciesPolicy(self):
        """Test SystemProtectionPoliciesPolicy"""
