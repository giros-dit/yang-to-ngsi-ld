...
class TestVendorManufactureDate(unittest.TestCase):
    """VendorManufactureDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VendorManufactureDate:
        """Test VendorManufactureDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VendorManufactureDate`
        """
        model = VendorManufactureDate()
        if include_optional:
            return VendorManufactureDate(
                type = 'Property',
                value = '',
    ...
    def testVendorManufactureDate(self):
        """Test VendorManufactureDate"""
