...
class TestInterfaceStatisticsInOctets(unittest.TestCase):
    """InterfaceStatisticsInOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsInOctets:
        """Test InterfaceStatisticsInOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsInOctets`
        """
        model = InterfaceStatisticsInOctets()
        if include_optional:
            return InterfaceStatisticsInOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStatisticsInOctets(self):
        """Test InterfaceStatisticsInOctets"""
