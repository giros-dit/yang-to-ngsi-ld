...
class TestPolicyStatementActionBgpExtendedCommunityReferencedSets(unittest.TestCase):
    """PolicyStatementActionBgpExtendedCommunityReferencedSets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpExtendedCommunityReferencedSets:
        """Test PolicyStatementActionBgpExtendedCommunityReferencedSets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpExtendedCommunityReferencedSets`
        """
        model = PolicyStatementActionBgpExtendedCommunityReferencedSets()
        if include_optional:
            return PolicyStatementActionBgpExtendedCommunityReferencedSets(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementActionBgpExtendedCommunityReferencedSets(self):
        """Test PolicyStatementActionBgpExtendedCommunityReferencedSets"""
