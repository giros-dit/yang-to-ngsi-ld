...
class TestLinkOpaqueLsa(unittest.TestCase):
    """LinkOpaqueLsa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkOpaqueLsa:
        """Test LinkOpaqueLsa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkOpaqueLsa`
        """
        model = LinkOpaqueLsa()
        if include_optional:
