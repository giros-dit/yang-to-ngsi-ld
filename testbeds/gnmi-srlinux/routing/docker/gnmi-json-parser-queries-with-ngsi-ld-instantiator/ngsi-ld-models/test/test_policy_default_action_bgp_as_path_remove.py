...
class TestPolicyDefaultActionBgpAsPathRemove(unittest.TestCase):
    """PolicyDefaultActionBgpAsPathRemove unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpAsPathRemove:
        """Test PolicyDefaultActionBgpAsPathRemove
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpAsPathRemove`
        """
        model = PolicyDefaultActionBgpAsPathRemove()
        if include_optional:
            return PolicyDefaultActionBgpAsPathRemove(
                type = 'Property',
                value = True,
    ...
    def testPolicyDefaultActionBgpAsPathRemove(self):
        """Test PolicyDefaultActionBgpAsPathRemove"""
