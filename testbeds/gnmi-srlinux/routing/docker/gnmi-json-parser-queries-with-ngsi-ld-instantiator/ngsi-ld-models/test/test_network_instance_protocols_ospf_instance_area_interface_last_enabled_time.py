...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceLastEnabledTime"""
