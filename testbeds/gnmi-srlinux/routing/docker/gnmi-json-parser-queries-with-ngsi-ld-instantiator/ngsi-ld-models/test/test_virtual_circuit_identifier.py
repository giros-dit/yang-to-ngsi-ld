...
class TestVirtualCircuitIdentifier(unittest.TestCase):
    """VirtualCircuitIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VirtualCircuitIdentifier:
        """Test VirtualCircuitIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VirtualCircuitIdentifier`
        """
        model = VirtualCircuitIdentifier()
        if include_optional:
            return VirtualCircuitIdentifier(
                type = 'Property',
                value = 56,
    ...
    def testVirtualCircuitIdentifier(self):
        """Test VirtualCircuitIdentifier"""
