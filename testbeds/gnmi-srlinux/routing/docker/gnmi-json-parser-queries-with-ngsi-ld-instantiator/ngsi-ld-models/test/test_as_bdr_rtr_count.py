...
class TestAsBdrRtrCount(unittest.TestCase):
    """AsBdrRtrCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AsBdrRtrCount:
        """Test AsBdrRtrCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AsBdrRtrCount`
        """
        model = AsBdrRtrCount()
        if include_optional:
            return AsBdrRtrCount(
                type = 'Property',
                value = 56,
