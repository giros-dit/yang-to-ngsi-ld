...
class TestNetworkInstanceBridgeTableMacDuplication(unittest.TestCase):
    """NetworkInstanceBridgeTableMacDuplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceBridgeTableMacDuplication:
        """Test NetworkInstanceBridgeTableMacDuplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceBridgeTableMacDuplication`
        """
        model = NetworkInstanceBridgeTableMacDuplication()
        if include_optional:
            return NetworkInstanceBridgeTableMacDuplication(
                id = '',
    ...
    def testNetworkInstanceBridgeTableMacDuplication(self):
        """Test NetworkInstanceBridgeTableMacDuplication"""
