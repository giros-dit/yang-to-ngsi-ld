...
class TestControlForwardingPlaneFibTableProgrammingProgressTunnels(unittest.TestCase):
    """ControlForwardingPlaneFibTableProgrammingProgressTunnels unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlForwardingPlaneFibTableProgrammingProgressTunnels:
        """Test ControlForwardingPlaneFibTableProgrammingProgressTunnels
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlForwardingPlaneFibTableProgrammingProgressTunnels`
        """
        model = ControlForwardingPlaneFibTableProgrammingProgressTunnels()
        if include_optional:
            return ControlForwardingPlaneFibTableProgrammingProgressTunnels(
                id = '',
                type = 'ControlForwardingPlaneFibTableProgrammingProgressTunnels',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testControlForwardingPlaneFibTableProgrammingProgressTunnels(self):
        """Test ControlForwardingPlaneFibTableProgrammingProgressTunnels"""
