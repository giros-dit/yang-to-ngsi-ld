...
class TestNetworkInstanceTcpStatistics(unittest.TestCase):
    """NetworkInstanceTcpStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpStatistics:
        """Test NetworkInstanceTcpStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpStatistics`
        """
        model = NetworkInstanceTcpStatistics()
        if include_optional:
            return NetworkInstanceTcpStatistics(
                id = '',
                type = 'NetworkInstanceTcpStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                passive_opens = None,
                attempt_fails = None,
                established_resets = None,
                in_segments = None,
                out_segments = None,
                retransmitted_segments = None,
                in_error_segments = None,
                out_rst_segments = None,
    ...
    def testNetworkInstanceTcpStatistics(self):
        """Test NetworkInstanceTcpStatistics"""
