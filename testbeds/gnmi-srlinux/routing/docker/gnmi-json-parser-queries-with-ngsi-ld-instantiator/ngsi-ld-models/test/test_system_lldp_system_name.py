...
class TestSystemLldpSystemName(unittest.TestCase):
    """SystemLldpSystemName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpSystemName:
        """Test SystemLldpSystemName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpSystemName`
        """
        model = SystemLldpSystemName()
        if include_optional:
            return SystemLldpSystemName(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpSystemName(self):
        """Test SystemLldpSystemName"""
