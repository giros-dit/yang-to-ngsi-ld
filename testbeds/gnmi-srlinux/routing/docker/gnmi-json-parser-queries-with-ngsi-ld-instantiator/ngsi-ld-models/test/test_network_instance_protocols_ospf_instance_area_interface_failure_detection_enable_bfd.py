...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd"""
