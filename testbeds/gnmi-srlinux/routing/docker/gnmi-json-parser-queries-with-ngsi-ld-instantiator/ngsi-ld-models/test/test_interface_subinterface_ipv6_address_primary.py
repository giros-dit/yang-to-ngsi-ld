...
class TestInterfaceSubinterfaceIpv6AddressPrimary(unittest.TestCase):
    """InterfaceSubinterfaceIpv6AddressPrimary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv6AddressPrimary:
        """Test InterfaceSubinterfaceIpv6AddressPrimary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv6AddressPrimary`
        """
        model = InterfaceSubinterfaceIpv6AddressPrimary()
        if include_optional:
            return InterfaceSubinterfaceIpv6AddressPrimary(
                type = 'Property',
                value = '',
    ...
    def testInterfaceSubinterfaceIpv6AddressPrimary(self):
        """Test InterfaceSubinterfaceIpv6AddressPrimary"""
