...
class TestLinecardForwardingComplexCounterBanksBank(unittest.TestCase):
    """LinecardForwardingComplexCounterBanksBank unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexCounterBanksBank:
        """Test LinecardForwardingComplexCounterBanksBank
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexCounterBanksBank`
        """
        model = LinecardForwardingComplexCounterBanksBank()
        if include_optional:
            return LinecardForwardingComplexCounterBanksBank(
                id = '',
                type = 'LinecardForwardingComplexCounterBanksBank',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testLinecardForwardingComplexCounterBanksBank(self):
        """Test LinecardForwardingComplexCounterBanksBank"""
