...
class TestNetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled:
        """Test NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled`
        """
        model = NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled()
        if include_optional:
            return NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled(self):
        """Test NetworkInstanceRouteTableNextHopGroupDynamicLoadBalancingEnabled"""
