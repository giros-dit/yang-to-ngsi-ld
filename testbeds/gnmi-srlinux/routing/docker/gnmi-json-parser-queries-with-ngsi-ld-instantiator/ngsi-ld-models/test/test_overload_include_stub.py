...
class TestOverloadIncludeStub(unittest.TestCase):
    """OverloadIncludeStub unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverloadIncludeStub:
        """Test OverloadIncludeStub
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverloadIncludeStub`
        """
        model = OverloadIncludeStub()
        if include_optional:
            return OverloadIncludeStub(
                type = 'Property',
                value = True,
    ...
    def testOverloadIncludeStub(self):
        """Test OverloadIncludeStub"""
