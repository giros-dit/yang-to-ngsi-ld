...
class TestInterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac:
        """Test InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac`
        """
        model = InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac(
                type = 'Property',
                value = True,
    ...
    def testInterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac(self):
        """Test InterfaceSubinterfaceBridgeTableDiscardUnknownSrcMac"""
