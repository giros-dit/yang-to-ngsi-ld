...
class TestNetworkInstanceLeakedRoute(unittest.TestCase):
    """NetworkInstanceLeakedRoute unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceLeakedRoute:
        """Test NetworkInstanceLeakedRoute
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceLeakedRoute`
        """
        model = NetworkInstanceLeakedRoute()
        if include_optional:
            return NetworkInstanceLeakedRoute(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceLeakedRoute(self):
        """Test NetworkInstanceLeakedRoute"""
