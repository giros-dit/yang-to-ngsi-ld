...
class TestNetworkInstanceInterfaceName(unittest.TestCase):
    """NetworkInstanceInterfaceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceName:
        """Test NetworkInstanceInterfaceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceName`
        """
        model = NetworkInstanceInterfaceName()
        if include_optional:
            return NetworkInstanceInterfaceName(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceInterfaceName(self):
        """Test NetworkInstanceInterfaceName"""
