...
class TestNetworkInstanceInterfaceInterfaceRefInterface(unittest.TestCase):
    """NetworkInstanceInterfaceInterfaceRefInterface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceInterfaceInterfaceRefInterface:
        """Test NetworkInstanceInterfaceInterfaceRefInterface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceInterfaceInterfaceRefInterface`
        """
        model = NetworkInstanceInterfaceInterfaceRefInterface()
        if include_optional:
            return NetworkInstanceInterfaceInterfaceRefInterface(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceInterfaceInterfaceRefInterface(self):
        """Test NetworkInstanceInterfaceInterfaceRefInterface"""
