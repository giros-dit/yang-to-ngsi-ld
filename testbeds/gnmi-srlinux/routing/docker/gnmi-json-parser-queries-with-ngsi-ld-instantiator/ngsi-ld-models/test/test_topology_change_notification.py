...
class TestTopologyChangeNotification(unittest.TestCase):
    """TopologyChangeNotification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TopologyChangeNotification:
        """Test TopologyChangeNotification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TopologyChangeNotification`
        """
        model = TopologyChangeNotification()
        if include_optional:
    ...
    def testTopologyChangeNotification(self):
        """Test TopologyChangeNotification"""
