...
class TestReloadDelay(unittest.TestCase):
    """ReloadDelay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReloadDelay:
        """Test ReloadDelay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReloadDelay`
        """
        model = ReloadDelay()
        if include_optional:
            return ReloadDelay(
