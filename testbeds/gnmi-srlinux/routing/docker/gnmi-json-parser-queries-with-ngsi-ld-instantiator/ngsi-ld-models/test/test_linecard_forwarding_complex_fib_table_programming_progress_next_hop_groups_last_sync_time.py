...
class TestLinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime:
        """Test LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime(
                type = 'Property',
                value = '',
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsLastSyncTime"""
