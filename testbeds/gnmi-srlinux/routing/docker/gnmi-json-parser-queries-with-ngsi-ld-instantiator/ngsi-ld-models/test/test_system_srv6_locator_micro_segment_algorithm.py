...
class TestSystemSrv6LocatorMicroSegmentAlgorithm(unittest.TestCase):
    """SystemSrv6LocatorMicroSegmentAlgorithm unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorMicroSegmentAlgorithm:
        """Test SystemSrv6LocatorMicroSegmentAlgorithm
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorMicroSegmentAlgorithm`
        """
        model = SystemSrv6LocatorMicroSegmentAlgorithm()
        if include_optional:
            return SystemSrv6LocatorMicroSegmentAlgorithm(
                type = 'Property',
                value = 0,
    ...
    def testSystemSrv6LocatorMicroSegmentAlgorithm(self):
        """Test SystemSrv6LocatorMicroSegmentAlgorithm"""
