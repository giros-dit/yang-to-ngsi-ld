...
class TestReloadDelayExpires(unittest.TestCase):
    """ReloadDelayExpires unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReloadDelayExpires:
        """Test ReloadDelayExpires
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReloadDelayExpires`
        """
        model = ReloadDelayExpires()
        if include_optional:
            return ReloadDelayExpires(
                type = 'Property',
                value = '',
    ...
    def testReloadDelayExpires(self):
        """Test ReloadDelayExpires"""
