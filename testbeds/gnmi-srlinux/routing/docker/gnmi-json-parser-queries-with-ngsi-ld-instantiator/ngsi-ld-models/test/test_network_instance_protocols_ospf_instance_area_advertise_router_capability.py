...
class TestNetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability:
        """Test NetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability(
                type = 'Property',
                value = True,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaAdvertiseRouterCapability"""
