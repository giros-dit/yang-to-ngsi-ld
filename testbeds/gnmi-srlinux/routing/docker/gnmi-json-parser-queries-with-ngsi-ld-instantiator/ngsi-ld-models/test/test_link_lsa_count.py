...
class TestLinkLsaCount(unittest.TestCase):
    """LinkLsaCount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinkLsaCount:
        """Test LinkLsaCount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinkLsaCount`
        """
        model = LinkLsaCount()
        if include_optional:
            return LinkLsaCount(
