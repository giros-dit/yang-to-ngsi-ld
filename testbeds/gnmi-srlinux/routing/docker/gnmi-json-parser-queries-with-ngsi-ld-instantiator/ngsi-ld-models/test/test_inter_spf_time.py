...
class TestInterSpfTime(unittest.TestCase):
    """InterSpfTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterSpfTime:
        """Test InterSpfTime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterSpfTime`
        """
        model = InterSpfTime()
        if include_optional:
            return InterSpfTime(
