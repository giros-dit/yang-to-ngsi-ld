...
class TestInterfaceSubinterfaceIpv4StatisticsInForwardedOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsInForwardedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsInForwardedOctets:
        """Test InterfaceSubinterfaceIpv4StatisticsInForwardedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsInForwardedOctets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsInForwardedOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsInForwardedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsInForwardedOctets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsInForwardedOctets"""
