...
class TestNetworkInstanceTcpStatisticsInChecksumErrors(unittest.TestCase):
    """NetworkInstanceTcpStatisticsInChecksumErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpStatisticsInChecksumErrors:
        """Test NetworkInstanceTcpStatisticsInChecksumErrors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpStatisticsInChecksumErrors`
        """
        model = NetworkInstanceTcpStatisticsInChecksumErrors()
        if include_optional:
            return NetworkInstanceTcpStatisticsInChecksumErrors(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceTcpStatisticsInChecksumErrors(self):
        """Test NetworkInstanceTcpStatisticsInChecksumErrors"""
