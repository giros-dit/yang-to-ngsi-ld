...
class TestPolicyStatementMatchMulticastGroupAddressPrefixSet(unittest.TestCase):
    """PolicyStatementMatchMulticastGroupAddressPrefixSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementMatchMulticastGroupAddressPrefixSet:
        """Test PolicyStatementMatchMulticastGroupAddressPrefixSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementMatchMulticastGroupAddressPrefixSet`
        """
        model = PolicyStatementMatchMulticastGroupAddressPrefixSet()
        if include_optional:
            return PolicyStatementMatchMulticastGroupAddressPrefixSet(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementMatchMulticastGroupAddressPrefixSet(self):
        """Test PolicyStatementMatchMulticastGroupAddressPrefixSet"""
