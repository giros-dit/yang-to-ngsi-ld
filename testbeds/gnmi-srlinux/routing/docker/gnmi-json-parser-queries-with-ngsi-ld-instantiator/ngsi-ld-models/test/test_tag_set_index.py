...
class TestTagSetIndex(unittest.TestCase):
    """TagSetIndex unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TagSetIndex:
        """Test TagSetIndex
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TagSetIndex`
        """
        model = TagSetIndex()
        if include_optional:
            return TagSetIndex(
