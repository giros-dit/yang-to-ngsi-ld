...
class TestAnycastGwMacOrigin(unittest.TestCase):
    """AnycastGwMacOrigin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnycastGwMacOrigin:
        """Test AnycastGwMacOrigin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnycastGwMacOrigin`
        """
        model = AnycastGwMacOrigin()
        if include_optional:
            return AnycastGwMacOrigin(
                type = 'Property',
                value = 'configured',
    ...
    def testAnycastGwMacOrigin(self):
        """Test AnycastGwMacOrigin"""
