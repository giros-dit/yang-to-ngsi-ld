...
class TestPolicyStatementActionBgpSrv6Locator(unittest.TestCase):
    """PolicyStatementActionBgpSrv6Locator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpSrv6Locator:
        """Test PolicyStatementActionBgpSrv6Locator
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpSrv6Locator`
        """
        model = PolicyStatementActionBgpSrv6Locator()
        if include_optional:
            return PolicyStatementActionBgpSrv6Locator(
                type = 'Relationship',
                object = '',
    ...
    def testPolicyStatementActionBgpSrv6Locator(self):
        """Test PolicyStatementActionBgpSrv6Locator"""
