...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets(
                id = '',
                type = 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                bad_network = None,
                bad_area = None,
                bad_dest_address = None,
                bad_neighbors = None,
                bad_packet_type = None,
                bad_length = None,
                bad_hello_interval = None,
                bad_dead_interval = None,
                bad_options = None,
                bad_checksum = None,
                bad_auth_type = None,
                auth_failures = None,
                bad_virtual_link = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets(
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceBadPackets"""
