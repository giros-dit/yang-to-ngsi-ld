...
class TestDestinationIp(unittest.TestCase):
    """DestinationIp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestinationIp:
        """Test DestinationIp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationIp`
        """
        model = DestinationIp()
        if include_optional:
