...
class TestLinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify(unittest.TestCase):
    """LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify:
        """Test LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify`
        """
        model = LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify()
        if include_optional:
            return LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify(
                type = 'Property',
                value = 56,
    ...
    def testLinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify(self):
        """Test LinecardForwardingComplexFibTableProgrammingProgressNextHopGroupsEntriesRemainingToModify"""
