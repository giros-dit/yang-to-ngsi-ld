...
class TestNetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack:
        """Test NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack`
        """
        model = NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack(self):
        """Test NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack"""
