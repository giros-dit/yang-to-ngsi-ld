...
class TestSystemLldpInterfaceNeighborLldpMedInventorySerialNumber(unittest.TestCase):
    """SystemLldpInterfaceNeighborLldpMedInventorySerialNumber unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborLldpMedInventorySerialNumber:
        """Test SystemLldpInterfaceNeighborLldpMedInventorySerialNumber
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborLldpMedInventorySerialNumber`
        """
        model = SystemLldpInterfaceNeighborLldpMedInventorySerialNumber()
        if include_optional:
            return SystemLldpInterfaceNeighborLldpMedInventorySerialNumber(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborLldpMedInventorySerialNumber(self):
        """Test SystemLldpInterfaceNeighborLldpMedInventorySerialNumber"""
