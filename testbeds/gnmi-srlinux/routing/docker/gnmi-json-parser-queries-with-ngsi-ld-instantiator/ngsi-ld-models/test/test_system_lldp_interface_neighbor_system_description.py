...
class TestSystemLldpInterfaceNeighborSystemDescription(unittest.TestCase):
    """SystemLldpInterfaceNeighborSystemDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldpInterfaceNeighborSystemDescription:
        """Test SystemLldpInterfaceNeighborSystemDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldpInterfaceNeighborSystemDescription`
        """
        model = SystemLldpInterfaceNeighborSystemDescription()
        if include_optional:
            return SystemLldpInterfaceNeighborSystemDescription(
                type = 'Property',
                value = '',
    ...
    def testSystemLldpInterfaceNeighborSystemDescription(self):
        """Test SystemLldpInterfaceNeighborSystemDescription"""
