...
class TestNetworkInstanceNextHopGroupsGroupTunnelResolution(unittest.TestCase):
    """NetworkInstanceNextHopGroupsGroupTunnelResolution unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceNextHopGroupsGroupTunnelResolution:
        """Test NetworkInstanceNextHopGroupsGroupTunnelResolution
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceNextHopGroupsGroupTunnelResolution`
        """
        model = NetworkInstanceNextHopGroupsGroupTunnelResolution()
        if include_optional:
            return NetworkInstanceNextHopGroupsGroupTunnelResolution(
                id = '',
                type = 'NetworkInstanceNextHopGroupsGroupTunnelResolution',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceNextHopGroupsGroupTunnelResolution(self):
        """Test NetworkInstanceNextHopGroupsGroupTunnelResolution"""
