...
class TestNetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue:
        """Test NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue`
        """
        model = NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue()
        if include_optional:
            return NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue(self):
        """Test NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroupValue"""
