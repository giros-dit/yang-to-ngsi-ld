...
class TestNetworkInstanceIcmp6StatisticsTotal(unittest.TestCase):
    """NetworkInstanceIcmp6StatisticsTotal unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmp6StatisticsTotal:
        """Test NetworkInstanceIcmp6StatisticsTotal
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmp6StatisticsTotal`
        """
        model = NetworkInstanceIcmp6StatisticsTotal()
        if include_optional:
            return NetworkInstanceIcmp6StatisticsTotal(
                id = '',
                type = 'NetworkInstanceIcmp6StatisticsTotal',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceIcmp6StatisticsTotal(self):
        """Test NetworkInstanceIcmp6StatisticsTotal"""
