...
class TestSystemAuthenticationKeychainKeySendLifetime(unittest.TestCase):
    """SystemAuthenticationKeychainKeySendLifetime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemAuthenticationKeychainKeySendLifetime:
        """Test SystemAuthenticationKeychainKeySendLifetime
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemAuthenticationKeychainKeySendLifetime`
        """
        model = SystemAuthenticationKeychainKeySendLifetime()
        if include_optional:
            return SystemAuthenticationKeychainKeySendLifetime(
                id = '',
                type = 'SystemAuthenticationKeychainKeySendLifetime',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testSystemAuthenticationKeychainKeySendLifetime(self):
        """Test SystemAuthenticationKeychainKeySendLifetime"""
