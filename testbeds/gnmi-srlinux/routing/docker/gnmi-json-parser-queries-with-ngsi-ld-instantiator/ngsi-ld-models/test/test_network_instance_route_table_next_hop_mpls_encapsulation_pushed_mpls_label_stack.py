...
class TestNetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack(unittest.TestCase):
    """NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack:
        """Test NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack`
        """
        model = NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack()
        if include_optional:
            return NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack(self):
        """Test NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack"""
