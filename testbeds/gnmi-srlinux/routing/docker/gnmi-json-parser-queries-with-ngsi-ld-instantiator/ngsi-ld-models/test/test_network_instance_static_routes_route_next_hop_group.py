...
class TestNetworkInstanceStaticRoutesRouteNextHopGroup(unittest.TestCase):
    """NetworkInstanceStaticRoutesRouteNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceStaticRoutesRouteNextHopGroup:
        """Test NetworkInstanceStaticRoutesRouteNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceStaticRoutesRouteNextHopGroup`
        """
        model = NetworkInstanceStaticRoutesRouteNextHopGroup()
        if include_optional:
            return NetworkInstanceStaticRoutesRouteNextHopGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceStaticRoutesRouteNextHopGroup(self):
        """Test NetworkInstanceStaticRoutesRouteNextHopGroup"""
