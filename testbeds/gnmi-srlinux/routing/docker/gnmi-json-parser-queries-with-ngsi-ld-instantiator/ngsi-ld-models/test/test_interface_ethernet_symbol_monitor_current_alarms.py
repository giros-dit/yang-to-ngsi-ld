...
class TestInterfaceEthernetSymbolMonitorCurrentAlarms(unittest.TestCase):
    """InterfaceEthernetSymbolMonitorCurrentAlarms unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetSymbolMonitorCurrentAlarms:
        """Test InterfaceEthernetSymbolMonitorCurrentAlarms
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetSymbolMonitorCurrentAlarms`
        """
        model = InterfaceEthernetSymbolMonitorCurrentAlarms()
        if include_optional:
            return InterfaceEthernetSymbolMonitorCurrentAlarms(
                type = 'Property',
                value = 'none',
    ...
    def testInterfaceEthernetSymbolMonitorCurrentAlarms(self):
        """Test InterfaceEthernetSymbolMonitorCurrentAlarms"""
