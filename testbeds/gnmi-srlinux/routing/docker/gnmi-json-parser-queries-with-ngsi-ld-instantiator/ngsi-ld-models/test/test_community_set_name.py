...
class TestCommunitySetName(unittest.TestCase):
    """CommunitySetName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CommunitySetName:
        """Test CommunitySetName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CommunitySetName`
        """
        model = CommunitySetName()
        if include_optional:
            return CommunitySetName(
                type = 'Property',
                value = '',
