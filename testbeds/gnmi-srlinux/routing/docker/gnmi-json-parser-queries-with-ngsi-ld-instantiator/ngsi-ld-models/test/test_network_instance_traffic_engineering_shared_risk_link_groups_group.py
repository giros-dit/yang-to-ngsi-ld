...
class TestNetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup(unittest.TestCase):
    """NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup:
        """Test NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup`
        """
        model = NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup()
        if include_optional:
            return NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup(
                id = '',
    ...
    def testNetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup(self):
        """Test NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup"""
