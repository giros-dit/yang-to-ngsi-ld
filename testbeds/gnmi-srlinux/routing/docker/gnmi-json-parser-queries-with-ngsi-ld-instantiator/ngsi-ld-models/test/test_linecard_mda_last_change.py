...
class TestLinecardMdaLastChange(unittest.TestCase):
    """LinecardMdaLastChange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardMdaLastChange:
        """Test LinecardMdaLastChange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardMdaLastChange`
        """
        model = LinecardMdaLastChange()
        if include_optional:
            return LinecardMdaLastChange(
                type = 'Property',
                value = '',
    ...
    def testLinecardMdaLastChange(self):
        """Test LinecardMdaLastChange"""
