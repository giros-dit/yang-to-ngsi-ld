...
class TestNumBreakoutPorts(unittest.TestCase):
    """NumBreakoutPorts unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NumBreakoutPorts:
        """Test NumBreakoutPorts
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NumBreakoutPorts`
        """
        model = NumBreakoutPorts()
        if include_optional:
            return NumBreakoutPorts(
                type = 'Property',
                value = '1',
