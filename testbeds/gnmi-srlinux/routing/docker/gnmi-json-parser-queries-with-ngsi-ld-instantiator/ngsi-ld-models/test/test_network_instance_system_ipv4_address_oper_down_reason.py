...
class TestNetworkInstanceSystemIpv4AddressOperDownReason(unittest.TestCase):
    """NetworkInstanceSystemIpv4AddressOperDownReason unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceSystemIpv4AddressOperDownReason:
        """Test NetworkInstanceSystemIpv4AddressOperDownReason
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceSystemIpv4AddressOperDownReason`
        """
        model = NetworkInstanceSystemIpv4AddressOperDownReason()
        if include_optional:
            return NetworkInstanceSystemIpv4AddressOperDownReason(
                type = 'Property',
    ...
    def testNetworkInstanceSystemIpv4AddressOperDownReason(self):
        """Test NetworkInstanceSystemIpv4AddressOperDownReason"""
