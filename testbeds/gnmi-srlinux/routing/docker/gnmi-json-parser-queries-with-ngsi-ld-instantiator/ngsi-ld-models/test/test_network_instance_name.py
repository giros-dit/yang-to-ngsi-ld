...
class TestNetworkInstanceName(unittest.TestCase):
    """NetworkInstanceName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceName:
        """Test NetworkInstanceName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceName`
        """
        model = NetworkInstanceName()
        if include_optional:
    ...
    def testNetworkInstanceName(self):
        """Test NetworkInstanceName"""
