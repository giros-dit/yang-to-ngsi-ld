...
class TestPolicyDefaultActionInternalTags(unittest.TestCase):
    """PolicyDefaultActionInternalTags unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionInternalTags:
        """Test PolicyDefaultActionInternalTags
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionInternalTags`
        """
        model = PolicyDefaultActionInternalTags()
        if include_optional:
            return PolicyDefaultActionInternalTags(
                id = '',
                type = 'PolicyDefaultActionInternalTags',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyDefaultActionInternalTags(self):
        """Test PolicyDefaultActionInternalTags"""
