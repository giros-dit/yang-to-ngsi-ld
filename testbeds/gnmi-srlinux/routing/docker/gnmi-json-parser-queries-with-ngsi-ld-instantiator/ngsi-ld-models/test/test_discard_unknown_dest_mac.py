...
class TestDiscardUnknownDestMac(unittest.TestCase):
    """DiscardUnknownDestMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscardUnknownDestMac:
        """Test DiscardUnknownDestMac
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscardUnknownDestMac`
        """
        model = DiscardUnknownDestMac()
        if include_optional:
            return DiscardUnknownDestMac(
                type = 'Property',
                value = True,
    ...
    def testDiscardUnknownDestMac(self):
        """Test DiscardUnknownDestMac"""
