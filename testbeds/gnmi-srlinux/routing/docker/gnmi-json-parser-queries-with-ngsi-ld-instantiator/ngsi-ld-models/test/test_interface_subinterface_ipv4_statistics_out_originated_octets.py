...
class TestInterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets(unittest.TestCase):
    """InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets:
        """Test InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets`
        """
        model = InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets()
        if include_optional:
            return InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets(self):
        """Test InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets"""
