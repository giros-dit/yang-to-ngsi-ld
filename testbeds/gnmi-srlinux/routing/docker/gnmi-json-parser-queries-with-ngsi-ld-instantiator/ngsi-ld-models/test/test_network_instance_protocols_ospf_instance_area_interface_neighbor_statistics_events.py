...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceNeighborStatisticsEvents"""
