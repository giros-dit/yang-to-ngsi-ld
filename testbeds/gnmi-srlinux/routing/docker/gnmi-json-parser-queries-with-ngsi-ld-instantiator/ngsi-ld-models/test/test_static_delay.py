...
class TestStaticDelay(unittest.TestCase):
    """StaticDelay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StaticDelay:
        """Test StaticDelay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StaticDelay`
        """
        model = StaticDelay()
        if include_optional:
            return StaticDelay(
