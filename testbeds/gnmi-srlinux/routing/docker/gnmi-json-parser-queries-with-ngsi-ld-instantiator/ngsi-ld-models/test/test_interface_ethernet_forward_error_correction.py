...
class TestInterfaceEthernetForwardErrorCorrection(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrection:
        """Test InterfaceEthernetForwardErrorCorrection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrection`
        """
        model = InterfaceEthernetForwardErrorCorrection()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrection(
                id = '',
                type = 'InterfaceEthernetForwardErrorCorrection',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceEthernetForwardErrorCorrection(self):
        """Test InterfaceEthernetForwardErrorCorrection"""
