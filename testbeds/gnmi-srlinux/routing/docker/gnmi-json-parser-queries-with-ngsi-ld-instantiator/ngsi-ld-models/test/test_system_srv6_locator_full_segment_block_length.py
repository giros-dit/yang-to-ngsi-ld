...
class TestSystemSrv6LocatorFullSegmentBlockLength(unittest.TestCase):
    """SystemSrv6LocatorFullSegmentBlockLength unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemSrv6LocatorFullSegmentBlockLength:
        """Test SystemSrv6LocatorFullSegmentBlockLength
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemSrv6LocatorFullSegmentBlockLength`
        """
        model = SystemSrv6LocatorFullSegmentBlockLength()
        if include_optional:
            return SystemSrv6LocatorFullSegmentBlockLength(
                type = 'Property',
                value = 56,
    ...
    def testSystemSrv6LocatorFullSegmentBlockLength(self):
        """Test SystemSrv6LocatorFullSegmentBlockLength"""
