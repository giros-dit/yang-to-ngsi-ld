...
class TestControlManufacturedDate(unittest.TestCase):
    """ControlManufacturedDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlManufacturedDate:
        """Test ControlManufacturedDate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlManufacturedDate`
        """
        model = ControlManufacturedDate()
        if include_optional:
            return ControlManufacturedDate(
                type = 'Property',
                value = '',
    ...
    def testControlManufacturedDate(self):
        """Test ControlManufacturedDate"""
