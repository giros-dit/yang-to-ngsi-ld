...
class TestYANGIdentityBroader(unittest.TestCase):
    """YANGIdentityBroader unit test stubs"""
    ...
    def make_instance(self, include_optional) -> YANGIdentityBroader:
        """Test YANGIdentityBroader
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `YANGIdentityBroader`
        """
        model = YANGIdentityBroader()
        if include_optional:
            return YANGIdentityBroader(
                type = 'Relationship',
                object = '',
    ...
    def testYANGIdentityBroader(self):
        """Test YANGIdentityBroader"""
