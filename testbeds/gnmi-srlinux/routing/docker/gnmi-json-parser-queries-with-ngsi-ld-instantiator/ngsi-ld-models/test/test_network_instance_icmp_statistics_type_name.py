...
class TestNetworkInstanceIcmpStatisticsTypeName(unittest.TestCase):
    """NetworkInstanceIcmpStatisticsTypeName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceIcmpStatisticsTypeName:
        """Test NetworkInstanceIcmpStatisticsTypeName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceIcmpStatisticsTypeName`
        """
        model = NetworkInstanceIcmpStatisticsTypeName()
        if include_optional:
            return NetworkInstanceIcmpStatisticsTypeName(
                type = 'Property',
                value = 'echo-reply',
    ...
    def testNetworkInstanceIcmpStatisticsTypeName(self):
        """Test NetworkInstanceIcmpStatisticsTypeName"""
