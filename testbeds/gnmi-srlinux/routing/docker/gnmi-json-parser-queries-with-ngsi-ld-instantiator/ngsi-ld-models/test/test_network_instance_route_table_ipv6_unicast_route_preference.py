...
class TestNetworkInstanceRouteTableIpv6UnicastRoutePreference(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastRoutePreference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastRoutePreference:
        """Test NetworkInstanceRouteTableIpv6UnicastRoutePreference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastRoutePreference`
        """
        model = NetworkInstanceRouteTableIpv6UnicastRoutePreference()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastRoutePreference(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastRoutePreference(self):
        """Test NetworkInstanceRouteTableIpv6UnicastRoutePreference"""
