...
class TestInterfaceStatisticsOutErrorPackets(unittest.TestCase):
    """InterfaceStatisticsOutErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceStatisticsOutErrorPackets:
        """Test InterfaceStatisticsOutErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceStatisticsOutErrorPackets`
        """
        model = InterfaceStatisticsOutErrorPackets()
        if include_optional:
            return InterfaceStatisticsOutErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceStatisticsOutErrorPackets(self):
        """Test InterfaceStatisticsOutErrorPackets"""
