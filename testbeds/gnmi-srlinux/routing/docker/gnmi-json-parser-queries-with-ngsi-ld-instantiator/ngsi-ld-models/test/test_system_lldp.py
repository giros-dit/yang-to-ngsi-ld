...
class TestSystemLldp(unittest.TestCase):
    """SystemLldp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SystemLldp:
        """Test SystemLldp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SystemLldp`
        """
        model = SystemLldp()
        if include_optional:
            return SystemLldp(
