...
class TestPolicyStatementActionBgpProtectionSrtePolicy(unittest.TestCase):
    """PolicyStatementActionBgpProtectionSrtePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpProtectionSrtePolicy:
        """Test PolicyStatementActionBgpProtectionSrtePolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpProtectionSrtePolicy`
        """
        model = PolicyStatementActionBgpProtectionSrtePolicy()
        if include_optional:
            return PolicyStatementActionBgpProtectionSrtePolicy(
                id = '',
                type = 'PolicyStatementActionBgpProtectionSrtePolicy',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testPolicyStatementActionBgpProtectionSrtePolicy(self):
        """Test PolicyStatementActionBgpProtectionSrtePolicy"""
