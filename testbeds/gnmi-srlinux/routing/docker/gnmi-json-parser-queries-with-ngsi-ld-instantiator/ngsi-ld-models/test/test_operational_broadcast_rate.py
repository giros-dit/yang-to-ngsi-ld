...
class TestOperationalBroadcastRate(unittest.TestCase):
    """OperationalBroadcastRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OperationalBroadcastRate:
        """Test OperationalBroadcastRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OperationalBroadcastRate`
        """
        model = OperationalBroadcastRate()
        if include_optional:
            return OperationalBroadcastRate(
                type = 'Property',
                value = 56,
    ...
    def testOperationalBroadcastRate(self):
        """Test OperationalBroadcastRate"""
