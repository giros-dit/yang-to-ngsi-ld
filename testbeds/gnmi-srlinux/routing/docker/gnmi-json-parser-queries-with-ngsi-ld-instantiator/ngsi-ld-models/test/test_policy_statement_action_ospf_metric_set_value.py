...
class TestPolicyStatementActionOspfMetricSetValue(unittest.TestCase):
    """PolicyStatementActionOspfMetricSetValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionOspfMetricSetValue:
        """Test PolicyStatementActionOspfMetricSetValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionOspfMetricSetValue`
        """
        model = PolicyStatementActionOspfMetricSetValue()
        if include_optional:
            return PolicyStatementActionOspfMetricSetValue(
                type = 'Property',
                value = 56,
    ...
    def testPolicyStatementActionOspfMetricSetValue(self):
        """Test PolicyStatementActionOspfMetricSetValue"""
