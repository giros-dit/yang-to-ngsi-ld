...
class TestInterfaceSubinterfaceStatisticsInErrorPackets(unittest.TestCase):
    """InterfaceSubinterfaceStatisticsInErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceStatisticsInErrorPackets:
        """Test InterfaceSubinterfaceStatisticsInErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceStatisticsInErrorPackets`
        """
        model = InterfaceSubinterfaceStatisticsInErrorPackets()
        if include_optional:
            return InterfaceSubinterfaceStatisticsInErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceStatisticsInErrorPackets(self):
        """Test InterfaceSubinterfaceStatisticsInErrorPackets"""
