...
class TestForwardReceivedPackets(unittest.TestCase):
    """ForwardReceivedPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForwardReceivedPackets:
        """Test ForwardReceivedPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForwardReceivedPackets`
        """
        model = ForwardReceivedPackets()
        if include_optional:
            return ForwardReceivedPackets(
                type = 'Property',
                value = True,
    ...
    def testForwardReceivedPackets(self):
        """Test ForwardReceivedPackets"""
