...
class TestNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies(unittest.TestCase):
    """NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies:
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies`
        """
        model = NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies()
        if include_optional:
            return NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies(
                type = 'Property',
                value = '',
    ...
    def testNetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies(self):
        """Test NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies"""
