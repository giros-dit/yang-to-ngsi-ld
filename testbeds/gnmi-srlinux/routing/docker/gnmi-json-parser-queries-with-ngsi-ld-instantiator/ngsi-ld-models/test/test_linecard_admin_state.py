...
class TestLinecardAdminState(unittest.TestCase):
    """LinecardAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardAdminState:
        """Test LinecardAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardAdminState`
        """
        model = LinecardAdminState()
        if include_optional:
            return LinecardAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testLinecardAdminState(self):
        """Test LinecardAdminState"""
