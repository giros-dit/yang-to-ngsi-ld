...
class TestNetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes(unittest.TestCase):
    """NetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes:
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes`
        """
        model = NetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes()
        if include_optional:
            return NetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes(self):
        """Test NetworkInstanceRouteTableIpv6UnicastStatisticsLeakedRoutes"""
