...
class TestPolicyStatementActionBgpExtendedCommunityOperation(unittest.TestCase):
    """PolicyStatementActionBgpExtendedCommunityOperation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpExtendedCommunityOperation:
        """Test PolicyStatementActionBgpExtendedCommunityOperation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpExtendedCommunityOperation`
        """
        model = PolicyStatementActionBgpExtendedCommunityOperation()
        if include_optional:
            return PolicyStatementActionBgpExtendedCommunityOperation(
                type = 'Property',
                value = 'add',
    ...
    def testPolicyStatementActionBgpExtendedCommunityOperation(self):
        """Test PolicyStatementActionBgpExtendedCommunityOperation"""
