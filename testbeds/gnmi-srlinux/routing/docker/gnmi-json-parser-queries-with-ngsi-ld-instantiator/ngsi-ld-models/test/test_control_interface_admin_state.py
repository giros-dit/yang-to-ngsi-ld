...
class TestControlInterfaceAdminState(unittest.TestCase):
    """ControlInterfaceAdminState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ControlInterfaceAdminState:
        """Test ControlInterfaceAdminState
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ControlInterfaceAdminState`
        """
        model = ControlInterfaceAdminState()
        if include_optional:
            return ControlInterfaceAdminState(
                type = 'Property',
                value = 'enable',
    ...
    def testControlInterfaceAdminState(self):
        """Test ControlInterfaceAdminState"""
