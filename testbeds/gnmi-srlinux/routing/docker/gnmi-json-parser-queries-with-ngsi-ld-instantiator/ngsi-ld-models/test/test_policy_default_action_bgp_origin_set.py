...
class TestPolicyDefaultActionBgpOriginSet(unittest.TestCase):
    """PolicyDefaultActionBgpOriginSet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyDefaultActionBgpOriginSet:
        """Test PolicyDefaultActionBgpOriginSet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyDefaultActionBgpOriginSet`
        """
        model = PolicyDefaultActionBgpOriginSet()
        if include_optional:
            return PolicyDefaultActionBgpOriginSet(
                type = 'Property',
                value = 'igp',
    ...
    def testPolicyDefaultActionBgpOriginSet(self):
        """Test PolicyDefaultActionBgpOriginSet"""
