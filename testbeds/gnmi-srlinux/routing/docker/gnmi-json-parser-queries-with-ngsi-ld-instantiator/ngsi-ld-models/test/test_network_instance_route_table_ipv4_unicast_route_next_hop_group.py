...
class TestNetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup(unittest.TestCase):
    """NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup:
        """Test NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup`
        """
        model = NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup()
        if include_optional:
            return NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup(
                type = 'Relationship',
                object = '',
    ...
    def testNetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup(self):
        """Test NetworkInstanceRouteTableIpv4UnicastRouteNextHopGroup"""
