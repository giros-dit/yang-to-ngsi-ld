...
class TestTxLsAck(unittest.TestCase):
    """TxLsAck unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TxLsAck:
        """Test TxLsAck
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TxLsAck`
        """
        model = TxLsAck()
        if include_optional:
            return TxLsAck(
