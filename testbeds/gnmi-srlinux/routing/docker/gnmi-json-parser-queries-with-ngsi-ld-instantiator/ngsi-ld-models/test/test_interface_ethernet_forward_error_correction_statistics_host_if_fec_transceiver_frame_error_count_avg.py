...
class TestInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg(unittest.TestCase):
    """InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg:
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg`
        """
        model = InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg()
        if include_optional:
            return InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg(self):
        """Test InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg"""
