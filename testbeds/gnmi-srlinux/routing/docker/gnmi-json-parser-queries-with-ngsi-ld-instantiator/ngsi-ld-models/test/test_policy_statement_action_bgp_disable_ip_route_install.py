...
class TestPolicyStatementActionBgpDisableIpRouteInstall(unittest.TestCase):
    """PolicyStatementActionBgpDisableIpRouteInstall unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PolicyStatementActionBgpDisableIpRouteInstall:
        """Test PolicyStatementActionBgpDisableIpRouteInstall
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PolicyStatementActionBgpDisableIpRouteInstall`
        """
        model = PolicyStatementActionBgpDisableIpRouteInstall()
        if include_optional:
            return PolicyStatementActionBgpDisableIpRouteInstall(
                type = 'Property',
                value = True,
    ...
    def testPolicyStatementActionBgpDisableIpRouteInstall(self):
        """Test PolicyStatementActionBgpDisableIpRouteInstall"""
