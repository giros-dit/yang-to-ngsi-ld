...
class NetworkInstanceIpForwardingSecondaryDefaultLookup(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceIpForwardingSecondaryDefaultLookup.")
    ...
    ipv4: Optional[NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4] = None
    ipv6: Optional[NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipv4", "ipv6", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceIpForwardingSecondaryDefaultLookup']):
            raise ValueError("must be one of enum values ('NetworkInstanceIpForwardingSecondaryDefaultLookup')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceIpForwardingSecondaryDefaultLookup',
            ...
            "ipv4": NetworkInstanceIpForwardingSecondaryDefaultLookupIpv4.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
            "ipv6": NetworkInstanceIpForwardingSecondaryDefaultLookupIpv6.from_dict(obj["ipv6"]) if obj.get("ipv6") is not None else None,
