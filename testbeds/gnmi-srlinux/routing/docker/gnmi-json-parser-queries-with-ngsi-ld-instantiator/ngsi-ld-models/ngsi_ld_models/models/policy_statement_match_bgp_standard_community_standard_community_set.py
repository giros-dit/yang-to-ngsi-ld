...
class PolicyStatementMatchBgpStandardCommunityStandardCommunitySet(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type StandardCommunitySet.")
