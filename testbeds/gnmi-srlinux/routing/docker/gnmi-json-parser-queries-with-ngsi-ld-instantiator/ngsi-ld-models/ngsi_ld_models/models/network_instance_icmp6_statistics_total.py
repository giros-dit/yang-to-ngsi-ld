...
class NetworkInstanceIcmp6StatisticsTotal(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceIcmp6StatisticsTotal.")
    ...
    in_packets: Optional[NetworkInstanceIcmp6StatisticsTotalInPackets] = Field(default=None, alias="inPackets")
    in_error_packets: Optional[NetworkInstanceIcmp6StatisticsTotalInErrorPackets] = Field(default=None, alias="inErrorPackets")
    out_packets: Optional[NetworkInstanceIcmp6StatisticsTotalOutPackets] = Field(default=None, alias="outPackets")
    out_error_packets: Optional[NetworkInstanceIcmp6StatisticsTotalOutErrorPackets] = Field(default=None, alias="outErrorPackets")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceIcmp6StatisticsTotal']):
            raise ValueError("must be one of enum values ('NetworkInstanceIcmp6StatisticsTotal')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceIcmp6StatisticsTotal',
            ...
            "inPackets": NetworkInstanceIcmp6StatisticsTotalInPackets.from_dict(obj["inPackets"]) if obj.get("inPackets") is not None else None,
            "inErrorPackets": NetworkInstanceIcmp6StatisticsTotalInErrorPackets.from_dict(obj["inErrorPackets"]) if obj.get("inErrorPackets") is not None else None,
            "outPackets": NetworkInstanceIcmp6StatisticsTotalOutPackets.from_dict(obj["outPackets"]) if obj.get("outPackets") is not None else None,
            "outErrorPackets": NetworkInstanceIcmp6StatisticsTotalOutErrorPackets.from_dict(obj["outErrorPackets"]) if obj.get("outErrorPackets") is not None else None,
