...
class NetworkInstanceNextHopGroupsGroupTunnelResolution(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceNextHopGroupsGroupTunnelResolution.")
    ...
    mode: Optional[NetworkInstanceNextHopGroupsGroupTunnelResolutionMode] = None
    allowed_tunnel_types: Optional[NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes] = Field(default=None, alias="allowedTunnelTypes")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "mode", "allowedTunnelTypes", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceNextHopGroupsGroupTunnelResolution']):
            raise ValueError("must be one of enum values ('NetworkInstanceNextHopGroupsGroupTunnelResolution')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceNextHopGroupsGroupTunnelResolution',
            ...
            "mode": NetworkInstanceNextHopGroupsGroupTunnelResolutionMode.from_dict(obj["mode"]) if obj.get("mode") is not None else None,
            "allowedTunnelTypes": NetworkInstanceNextHopGroupsGroupTunnelResolutionAllowedTunnelTypes.from_dict(obj["allowedTunnelTypes"]) if obj.get("allowedTunnelTypes") is not None else None,
