...
class NetworkInstanceRouteTableIpv6UnicastRouteCounters(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableIpv6UnicastRouteCounters.")
    ...
    resource_allocation_failed: Optional[NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed] = Field(default=None, alias="resourceAllocationFailed")
    packets_forwarded: Optional[NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded] = Field(default=None, alias="packetsForwarded")
    octets_forwarded: Optional[NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded] = Field(default=None, alias="octetsForwarded")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "resourceAllocationFailed", "packetsForwarded", "octetsForwarded", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableIpv6UnicastRouteCounters']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableIpv6UnicastRouteCounters')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of packets_forwarded
        if self.packets_forwarded:
            _dict['packetsForwarded'] = self.packets_forwarded.to_dict()
        # override the default output from pydantic by calling `to_dict()` of octets_forwarded
        if self.octets_forwarded:
            _dict['octetsForwarded'] = self.octets_forwarded.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableIpv6UnicastRouteCounters',
            ...
            "resourceAllocationFailed": NetworkInstanceRouteTableIpv6UnicastRouteCountersResourceAllocationFailed.from_dict(obj["resourceAllocationFailed"]) if obj.get("resourceAllocationFailed") is not None else None,
            "packetsForwarded": NetworkInstanceRouteTableIpv6UnicastRouteCountersPacketsForwarded.from_dict(obj["packetsForwarded"]) if obj.get("packetsForwarded") is not None else None,
            "octetsForwarded": NetworkInstanceRouteTableIpv6UnicastRouteCountersOctetsForwarded.from_dict(obj["octetsForwarded"]) if obj.get("octetsForwarded") is not None else None,
