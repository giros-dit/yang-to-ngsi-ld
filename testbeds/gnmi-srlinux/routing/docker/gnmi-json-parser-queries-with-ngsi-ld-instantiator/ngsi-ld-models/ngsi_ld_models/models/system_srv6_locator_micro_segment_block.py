...
class SystemSrv6LocatorMicroSegmentBlock(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtraction.")
