...
class PolicyDefaultActionBgpCommunities(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpCommunities.")
    ...
    add: Optional[PolicyDefaultActionBgpCommunitiesAdd] = None
    remove: Optional[PolicyDefaultActionBgpCommunitiesRemove] = None
    replace: Optional[PolicyDefaultActionBgpCommunitiesReplace] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpCommunities']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpCommunities')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpCommunities',
            ...
            "add": PolicyDefaultActionBgpCommunitiesAdd.from_dict(obj["add"]) if obj.get("add") is not None else None,
            "remove": PolicyDefaultActionBgpCommunitiesRemove.from_dict(obj["remove"]) if obj.get("remove") is not None else None,
            "replace": PolicyDefaultActionBgpCommunitiesReplace.from_dict(obj["replace"]) if obj.get("replace") is not None else None,
