...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetection(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetection.")
    ...
    enable_bfd: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd] = Field(default=None, alias="enableBfd")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "enableBfd", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetection']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetection')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of enable_bfd
        if self.enable_bfd:
            _dict['enableBfd'] = self.enable_bfd.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetection',
            ...
            "enableBfd": NetworkInstanceProtocolsOspfInstanceAreaInterfaceFailureDetectionEnableBfd.from_dict(obj["enableBfd"]) if obj.get("enableBfd") is not None else None,
