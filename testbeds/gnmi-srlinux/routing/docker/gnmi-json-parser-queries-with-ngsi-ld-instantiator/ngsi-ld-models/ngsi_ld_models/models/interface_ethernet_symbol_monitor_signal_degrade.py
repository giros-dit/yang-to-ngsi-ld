...
class InterfaceEthernetSymbolMonitorSignalDegrade(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetSymbolMonitorSignalDegrade.")
    ...
    exponent: Optional[InterfaceEthernetSymbolMonitorSignalDegradeExponent] = None
    multiplier: Optional[InterfaceEthernetSymbolMonitorSignalDegradeMultiplier] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetSymbolMonitorSignalDegrade']):
            raise ValueError("must be one of enum values ('InterfaceEthernetSymbolMonitorSignalDegrade')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetSymbolMonitorSignalDegrade',
            ...
            "exponent": InterfaceEthernetSymbolMonitorSignalDegradeExponent.from_dict(obj["exponent"]) if obj.get("exponent") is not None else None,
            "multiplier": InterfaceEthernetSymbolMonitorSignalDegradeMultiplier.from_dict(obj["multiplier"]) if obj.get("multiplier") is not None else None,
