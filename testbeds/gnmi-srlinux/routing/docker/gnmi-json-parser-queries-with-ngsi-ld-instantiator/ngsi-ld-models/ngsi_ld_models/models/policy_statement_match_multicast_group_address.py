...
class PolicyStatementMatchMulticastGroupAddress(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchMulticastGroupAddress.")
    ...
    prefix_set: Optional[PolicyStatementMatchMulticastGroupAddressPrefixSet] = Field(default=None, alias="prefixSet")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchMulticastGroupAddress']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchMulticastGroupAddress')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchMulticastGroupAddress',
            ...
            "prefixSet": PolicyStatementMatchMulticastGroupAddressPrefixSet.from_dict(obj["prefixSet"]) if obj.get("prefixSet") is not None else None,
