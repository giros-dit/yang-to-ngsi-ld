...
class NetworkInstanceIcmpStatisticsType(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceIcmpStatisticsType.")
    ...
    name: Optional[NetworkInstanceIcmpStatisticsTypeName] = None
    in_packets: Optional[NetworkInstanceIcmpStatisticsTypeInPackets] = Field(default=None, alias="inPackets")
    out_packets: Optional[NetworkInstanceIcmpStatisticsTypeOutPackets] = Field(default=None, alias="outPackets")
    out_error_packets: Optional[NetworkInstanceIcmpStatisticsTypeOutErrorPackets] = Field(default=None, alias="outErrorPackets")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceIcmpStatisticsType']):
            raise ValueError("must be one of enum values ('NetworkInstanceIcmpStatisticsType')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceIcmpStatisticsType',
            ...
            "name": NetworkInstanceIcmpStatisticsTypeName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "inPackets": NetworkInstanceIcmpStatisticsTypeInPackets.from_dict(obj["inPackets"]) if obj.get("inPackets") is not None else None,
            "outPackets": NetworkInstanceIcmpStatisticsTypeOutPackets.from_dict(obj["outPackets"]) if obj.get("outPackets") is not None else None,
            "outErrorPackets": NetworkInstanceIcmpStatisticsTypeOutErrorPackets.from_dict(obj["outErrorPackets"]) if obj.get("outErrorPackets") is not None else None,
