...
class InterfaceTransceiver(BaseModel):
    ...
    firmware_version: Optional[FirmwareVersion] = Field(default=None, alias="firmwareVersion")
    ...
    link_length_information: Optional[LinkLengthInformation] = Field(default=None, alias="linkLengthInformation")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "functionalType", "txLaser", "operState", "operDownReason", "ddmEvents", "formFactor", "ethernetPmd", "connectorType", "vendor", "vendorPartNumber", "vendorRevision", "vendorLotNumber", "serialNumber", "dateCode", "firmwareVersion", "faultCondition", "wavelength", "linkLengthInformation", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceTransceiver']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of link_length_information
        if self.link_length_information:
            _dict['linkLengthInformation'] = self.link_length_information.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firmwareVersion": FirmwareVersion.from_dict(obj["firmwareVersion"]) if obj.get("firmwareVersion") is not None else None,
            ...
            "linkLengthInformation": LinkLengthInformation.from_dict(obj["linkLengthInformation"]) if obj.get("linkLengthInformation") is not None else None,
