...
class InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter.")
    ...
    status: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus] = None
    frame_error_count: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount] = Field(default=None, alias="frameErrorCount")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "status", "frameErrorCount", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter']):
            raise ValueError("must be one of enum values ('InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of frame_error_count
        if self.frame_error_count:
            _dict['frameErrorCount'] = self.frame_error_count.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouter',
            ...
            "status": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
            "frameErrorCount": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecRouterFrameErrorCount.from_dict(obj["frameErrorCount"]) if obj.get("frameErrorCount") is not None else None,
