...
class InterfaceSubinterfaceIpv6Address(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceIpv6Address.")
    ...
    ip_prefix: Optional[InterfaceSubinterfaceIpv6AddressIpPrefix] = Field(default=None, alias="ipPrefix")
    address_type: Optional[InterfaceSubinterfaceIpv6AddressType] = Field(default=None, alias="addressType")
    anycast_gw: Optional[InterfaceSubinterfaceIpv6AddressAnycastGw] = Field(default=None, alias="anycastGw")
    origin: Optional[InterfaceSubinterfaceIpv6AddressOrigin] = None
    primary: Optional[InterfaceSubinterfaceIpv6AddressPrimary] = None
    status: Optional[InterfaceSubinterfaceIpv6AddressStatus] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipPrefix", "addressType", "anycastGw", "origin", "primary", "status", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceIpv6Address']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceIpv6Address')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of address_type
        if self.address_type:
            _dict['addressType'] = self.address_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of anycast_gw
        if self.anycast_gw:
            _dict['anycastGw'] = self.anycast_gw.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceIpv6Address',
            ...
            "ipPrefix": InterfaceSubinterfaceIpv6AddressIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
            "addressType": InterfaceSubinterfaceIpv6AddressType.from_dict(obj["addressType"]) if obj.get("addressType") is not None else None,
            "anycastGw": InterfaceSubinterfaceIpv6AddressAnycastGw.from_dict(obj["anycastGw"]) if obj.get("anycastGw") is not None else None,
            "origin": InterfaceSubinterfaceIpv6AddressOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "primary": InterfaceSubinterfaceIpv6AddressPrimary.from_dict(obj["primary"]) if obj.get("primary") is not None else None,
            "status": InterfaceSubinterfaceIpv6AddressStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
