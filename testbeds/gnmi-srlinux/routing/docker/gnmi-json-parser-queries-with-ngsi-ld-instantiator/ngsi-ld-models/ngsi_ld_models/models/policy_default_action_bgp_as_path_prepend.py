...
class PolicyDefaultActionBgpAsPathPrepend(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpAsPathPrepend.")
    ...
    as_number: Optional[PolicyDefaultActionBgpAsPathPrependAsNumber] = Field(default=None, alias="asNumber")
    repeat_n: Optional[PolicyDefaultActionBgpAsPathPrependRepeatN] = Field(default=None, alias="repeatN")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "asNumber", "repeatN", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpAsPathPrepend']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpAsPathPrepend')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of as_number
        if self.as_number:
            _dict['asNumber'] = self.as_number.to_dict()
        # override the default output from pydantic by calling `to_dict()` of repeat_n
        if self.repeat_n:
            _dict['repeatN'] = self.repeat_n.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpAsPathPrepend',
            ...
            "asNumber": PolicyDefaultActionBgpAsPathPrependAsNumber.from_dict(obj["asNumber"]) if obj.get("asNumber") is not None else None,
            "repeatN": PolicyDefaultActionBgpAsPathPrependRepeatN.from_dict(obj["repeatN"]) if obj.get("repeatN") is not None else None,
