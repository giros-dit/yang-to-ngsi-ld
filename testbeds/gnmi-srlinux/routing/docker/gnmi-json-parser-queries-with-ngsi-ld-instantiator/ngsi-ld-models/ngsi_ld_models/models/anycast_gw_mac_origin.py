...
class AnycastGwMacOrigin(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['configured', 'vrid-auto-derived']):
            raise ValueError("must be one of enum values ('configured', 'vrid-auto-derived')")
        return value
