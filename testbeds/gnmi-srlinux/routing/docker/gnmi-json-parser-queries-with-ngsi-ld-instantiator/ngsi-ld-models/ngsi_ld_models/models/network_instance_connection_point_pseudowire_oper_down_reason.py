...
class NetworkInstanceConnectionPointPseudowireOperDownReason(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['admin-disabled', 'network-instance-oper-down', 'no-ingress-vc-label', 'no-egress-vc-label', 'network-instance-mtu-mismatch', 'remote-system-fault-status-bits', 'evpn-route-conflict', 'transport-tunnel-oper-down', 'no-destination-id', 'connection-point-dup-detect']):
            raise ValueError("must be one of enum values ('admin-disabled', 'network-instance-oper-down', 'no-ingress-vc-label', 'no-egress-vc-label', 'network-instance-mtu-mismatch', 'remote-system-fault-status-bits', 'evpn-route-conflict', 'transport-tunnel-oper-down', 'no-destination-id', 'connection-point-dup-detect')")
        return value
