...
class NetworkInstanceRouteTableIpv4UnicastRouteCounters(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableIpv4UnicastRouteCounters.")
    ...
    resource_allocation_failed: Optional[NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed] = Field(default=None, alias="resourceAllocationFailed")
    packets_forwarded: Optional[NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded] = Field(default=None, alias="packetsForwarded")
    octets_forwarded: Optional[NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded] = Field(default=None, alias="octetsForwarded")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableIpv4UnicastRouteCounters']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableIpv4UnicastRouteCounters')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableIpv4UnicastRouteCounters',
            ...
            "resourceAllocationFailed": NetworkInstanceRouteTableIpv4UnicastRouteCountersResourceAllocationFailed.from_dict(obj["resourceAllocationFailed"]) if obj.get("resourceAllocationFailed") is not None else None,
            "packetsForwarded": NetworkInstanceRouteTableIpv4UnicastRouteCountersPacketsForwarded.from_dict(obj["packetsForwarded"]) if obj.get("packetsForwarded") is not None else None,
            "octetsForwarded": NetworkInstanceRouteTableIpv4UnicastRouteCountersOctetsForwarded.from_dict(obj["octetsForwarded"]) if obj.get("octetsForwarded") is not None else None,
