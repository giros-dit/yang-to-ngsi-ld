...
class LinecardMdaTemperature(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardMdaTemperature.")
    ...
    instant: Optional[LinecardMdaTemperatureInstant] = None
    maximum: Optional[LinecardMdaTemperatureMaximum] = None
    maximum_time: Optional[LinecardMdaTemperatureMaximumTime] = Field(default=None, alias="maximumTime")
    alarm_status: Optional[LinecardMdaTemperatureAlarmStatus] = Field(default=None, alias="alarmStatus")
    margin: Optional[LinecardMdaTemperatureMargin] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "instant", "maximum", "maximumTime", "alarmStatus", "margin", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardMdaTemperature']):
            raise ValueError("must be one of enum values ('LinecardMdaTemperature')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of alarm_status
        if self.alarm_status:
            _dict['alarmStatus'] = self.alarm_status.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardMdaTemperature',
            ...
            "instant": LinecardMdaTemperatureInstant.from_dict(obj["instant"]) if obj.get("instant") is not None else None,
            "maximum": LinecardMdaTemperatureMaximum.from_dict(obj["maximum"]) if obj.get("maximum") is not None else None,
            "maximumTime": LinecardMdaTemperatureMaximumTime.from_dict(obj["maximumTime"]) if obj.get("maximumTime") is not None else None,
            "alarmStatus": LinecardMdaTemperatureAlarmStatus.from_dict(obj["alarmStatus"]) if obj.get("alarmStatus") is not None else None,
            "margin": LinecardMdaTemperatureMargin.from_dict(obj["margin"]) if obj.get("margin") is not None else None,
