...
class NetworkInstanceRouteTableNextHopIndirectResolvingRoute(BaseModel):
    """
     YANG module: srl_nokia-ip-route-tables.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopIndirectResolvingRoute.")
    ...
    next_hop_group: Optional[NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup] = Field(default=None, alias="nextHopGroup")
    ip_prefix: Optional[NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix] = Field(default=None, alias="ipPrefix")
    route_type: Optional[NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType] = Field(default=None, alias="routeType")
    route_owner: Optional[NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner] = Field(default=None, alias="routeOwner")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "nextHopGroup", "ipPrefix", "routeType", "routeOwner", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopIndirectResolvingRoute']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopIndirectResolvingRoute')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopIndirectResolvingRoute',
            ...
            "nextHopGroup": NetworkInstanceRouteTableNextHopIndirectResolvingRouteNextHopGroup.from_dict(obj["nextHopGroup"]) if obj.get("nextHopGroup") is not None else None,
            "ipPrefix": NetworkInstanceRouteTableNextHopIndirectResolvingRouteIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
            "routeType": NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteType.from_dict(obj["routeType"]) if obj.get("routeType") is not None else None,
            "routeOwner": NetworkInstanceRouteTableNextHopIndirectResolvingRouteRouteOwner.from_dict(obj["routeOwner"]) if obj.get("routeOwner") is not None else None,
