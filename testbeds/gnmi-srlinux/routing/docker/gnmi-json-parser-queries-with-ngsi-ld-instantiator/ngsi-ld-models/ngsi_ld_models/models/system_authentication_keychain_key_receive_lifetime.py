...
class SystemAuthenticationKeychainKeyReceiveLifetime(BaseModel):
    """
     YANG module: srl_nokia-keychains.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemAuthenticationKeychainKeyReceiveLifetime.")
    ...
    start_time: Optional[SystemAuthenticationKeychainKeyReceiveLifetimeStartTime] = Field(default=None, alias="startTime")
    end_time: Optional[EndTime] = Field(default=None, alias="endTime")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "startTime", "endTime", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemAuthenticationKeychainKeyReceiveLifetime']):
            raise ValueError("must be one of enum values ('SystemAuthenticationKeychainKeyReceiveLifetime')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemAuthenticationKeychainKeyReceiveLifetime',
            ...
            "startTime": SystemAuthenticationKeychainKeyReceiveLifetimeStartTime.from_dict(obj["startTime"]) if obj.get("startTime") is not None else None,
            "endTime": EndTime.from_dict(obj["endTime"]) if obj.get("endTime") is not None else None,
