...
class NetworkInstanceConnectionPointBridgeTableMacLimit(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointBridgeTableMacLimit.")
    ...
    maximum_entries: Optional[NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries] = Field(default=None, alias="maximumEntries")
    warning_threshold_pct: Optional[NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct] = Field(default=None, alias="warningThresholdPct")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "maximumEntries", "warningThresholdPct", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointBridgeTableMacLimit']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointBridgeTableMacLimit')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of maximum_entries
        if self.maximum_entries:
            _dict['maximumEntries'] = self.maximum_entries.to_dict()
        # override the default output from pydantic by calling `to_dict()` of warning_threshold_pct
        if self.warning_threshold_pct:
            _dict['warningThresholdPct'] = self.warning_threshold_pct.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointBridgeTableMacLimit',
            ...
            "maximumEntries": NetworkInstanceConnectionPointBridgeTableMacLimitMaximumEntries.from_dict(obj["maximumEntries"]) if obj.get("maximumEntries") is not None else None,
            "warningThresholdPct": NetworkInstanceConnectionPointBridgeTableMacLimitWarningThresholdPct.from_dict(obj["warningThresholdPct"]) if obj.get("warningThresholdPct") is not None else None,
