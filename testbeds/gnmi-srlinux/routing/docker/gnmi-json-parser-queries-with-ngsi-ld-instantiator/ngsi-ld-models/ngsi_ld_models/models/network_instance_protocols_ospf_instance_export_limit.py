...
class NetworkInstanceProtocolsOspfInstanceExportLimit(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceExportLimit.")
    ...
    number: Number
    log_percent: Optional[LogPercent] = Field(default=None, alias="logPercent")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "number", "logPercent", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceExportLimit']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceExportLimit')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of log_percent
        if self.log_percent:
            _dict['logPercent'] = self.log_percent.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceExportLimit',
            ...
            "number": Number.from_dict(obj["number"]) if obj.get("number") is not None else None,
            "logPercent": LogPercent.from_dict(obj["logPercent"]) if obj.get("logPercent") is not None else None,
