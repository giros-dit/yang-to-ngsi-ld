...
class PolicyDefaultActionBgpStandardCommunity(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpStandardCommunity.")
    ...
    operation: Optional[PolicyDefaultActionBgpStandardCommunityOperation] = None
    referenced_sets: Optional[PolicyDefaultActionBgpStandardCommunityReferencedSets] = Field(default=None, alias="referencedSets")
    method: Optional[PolicyDefaultActionBgpStandardCommunityMethod] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpStandardCommunity']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpStandardCommunity')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpStandardCommunity',
            ...
            "operation": PolicyDefaultActionBgpStandardCommunityOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
            "referencedSets": PolicyDefaultActionBgpStandardCommunityReferencedSets.from_dict(obj["referencedSets"]) if obj.get("referencedSets") is not None else None,
            "method": PolicyDefaultActionBgpStandardCommunityMethod.from_dict(obj["method"]) if obj.get("method") is not None else None,
