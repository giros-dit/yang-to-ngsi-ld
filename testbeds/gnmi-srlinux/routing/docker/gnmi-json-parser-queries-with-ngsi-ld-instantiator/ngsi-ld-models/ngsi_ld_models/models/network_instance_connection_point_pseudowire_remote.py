...
class NetworkInstanceConnectionPointPseudowireRemote(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointPseudowireRemote.")
    ...
    pseudowire_status: Optional[NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus] = Field(default=None, alias="pseudowireStatus")
    operational_egress_vc_label: Optional[OperationalEgressVcLabel] = Field(default=None, alias="operationalEgressVcLabel")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "pseudowireStatus", "operationalEgressVcLabel", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointPseudowireRemote']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointPseudowireRemote')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of pseudowire_status
        if self.pseudowire_status:
            _dict['pseudowireStatus'] = self.pseudowire_status.to_dict()
        # override the default output from pydantic by calling `to_dict()` of operational_egress_vc_label
        if self.operational_egress_vc_label:
            _dict['operationalEgressVcLabel'] = self.operational_egress_vc_label.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointPseudowireRemote',
            ...
            "pseudowireStatus": NetworkInstanceConnectionPointPseudowireRemotePseudowireStatus.from_dict(obj["pseudowireStatus"]) if obj.get("pseudowireStatus") is not None else None,
            "operationalEgressVcLabel": OperationalEgressVcLabel.from_dict(obj["operationalEgressVcLabel"]) if obj.get("operationalEgressVcLabel") is not None else None,
