...
class NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp.")
    ...
    virtual_circuit_type: Optional[VirtualCircuitType] = Field(default=None, alias="virtualCircuitType")
    advertise_l2_mtu: Optional[AdvertiseL2Mtu] = Field(default=None, alias="advertiseL2Mtu")
    ignore_mtu_mismatch: Optional[IgnoreMtuMismatch] = Field(default=None, alias="ignoreMtuMismatch")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "virtualCircuitType", "advertiseL2Mtu", "ignoreMtuMismatch", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of virtual_circuit_type
        if self.virtual_circuit_type:
            _dict['virtualCircuitType'] = self.virtual_circuit_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of advertise_l2_mtu
        if self.advertise_l2_mtu:
            _dict['advertiseL2Mtu'] = self.advertise_l2_mtu.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ignore_mtu_mismatch
        if self.ignore_mtu_mismatch:
            _dict['ignoreMtuMismatch'] = self.ignore_mtu_mismatch.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointPseudowireSignalingSignalingTldp',
            ...
            "virtualCircuitType": VirtualCircuitType.from_dict(obj["virtualCircuitType"]) if obj.get("virtualCircuitType") is not None else None,
            "advertiseL2Mtu": AdvertiseL2Mtu.from_dict(obj["advertiseL2Mtu"]) if obj.get("advertiseL2Mtu") is not None else None,
            "ignoreMtuMismatch": IgnoreMtuMismatch.from_dict(obj["ignoreMtuMismatch"]) if obj.get("ignoreMtuMismatch") is not None else None,
