...
class PolicyDefaultActionBgpAsPath(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpAsPath.")
    ...
    remove: Optional[PolicyDefaultActionBgpAsPathRemove] = None
    replace: Optional[PolicyDefaultActionBgpAsPathReplace] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpAsPath']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpAsPath')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpAsPath',
            ...
            "remove": PolicyDefaultActionBgpAsPathRemove.from_dict(obj["remove"]) if obj.get("remove") is not None else None,
            "replace": PolicyDefaultActionBgpAsPathReplace.from_dict(obj["replace"]) if obj.get("replace") is not None else None,
