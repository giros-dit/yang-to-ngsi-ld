...
class PolicyStatementMatchBgpAsPath(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchBgpAsPath.")
    ...
    as_path_set: Optional[PolicyStatementMatchBgpAsPathAsPathSet] = Field(default=None, alias="asPathSet")
    match_set_options: Optional[PolicyStatementMatchBgpAsPathMatchSetOptions] = Field(default=None, alias="matchSetOptions")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "asPathSet", "matchSetOptions", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchBgpAsPath']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchBgpAsPath')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of as_path_set
        if self.as_path_set:
            _dict['asPathSet'] = self.as_path_set.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchBgpAsPath',
            ...
            "asPathSet": PolicyStatementMatchBgpAsPathAsPathSet.from_dict(obj["asPathSet"]) if obj.get("asPathSet") is not None else None,
            "matchSetOptions": PolicyStatementMatchBgpAsPathMatchSetOptions.from_dict(obj["matchSetOptions"]) if obj.get("matchSetOptions") is not None else None,
