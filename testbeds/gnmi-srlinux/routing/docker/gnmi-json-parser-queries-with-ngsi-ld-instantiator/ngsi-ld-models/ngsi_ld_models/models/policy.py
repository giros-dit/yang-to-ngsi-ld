...
class Policy(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be Policy.")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Policy']):
            raise ValueError("must be one of enum values ('Policy')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'Policy',
            ...
            "name": PolicyName.from_dict(obj["name"]) if obj.get("name") is not None else None
        })
