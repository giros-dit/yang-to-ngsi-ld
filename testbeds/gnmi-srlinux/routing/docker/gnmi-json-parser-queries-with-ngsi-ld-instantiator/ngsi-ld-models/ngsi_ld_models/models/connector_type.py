...
class ConnectorType(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SC', 'FC-STYLE1-COPPER', 'FC-STYLE2-COPPER', 'BNC-OR-TNC', 'FC-COAX', 'FIBER-JACK', 'LC', 'MT-RJ', 'MU', 'SG', 'OPTICAL-PIGTAIL', 'MPO-1x12', 'MPO-2x16', 'HSSDC', 'COPPER-PIGTAIL', 'RJ45', 'no-separable-connector', 'MXC-2x16', 'CS-OPTICAL-CONNECTOR', 'SN-OPTICAL-CONNECTOR', 'MPO-2x12', 'MPO-1x16', 'unknown']):
            raise ValueError("must be one of enum values ('SC', 'FC-STYLE1-COPPER', 'FC-STYLE2-COPPER', 'BNC-OR-TNC', 'FC-COAX', 'FIBER-JACK', 'LC', 'MT-RJ', 'MU', 'SG', 'OPTICAL-PIGTAIL', 'MPO-1x12', 'MPO-2x16', 'HSSDC', 'COPPER-PIGTAIL', 'RJ45', 'no-separable-connector', 'MXC-2x16', 'CS-OPTICAL-CONNECTOR', 'SN-OPTICAL-CONNECTOR', 'MPO-2x12', 'MPO-1x16', 'unknown')")
        return value
