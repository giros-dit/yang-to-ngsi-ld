...
class PolicyDefaultActionInternalTags(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionInternalTags.")
    ...
    set_tag_set: Optional[PolicyDefaultActionInternalTagsSetTagSet] = Field(default=None, alias="setTagSet")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionInternalTags']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionInternalTags')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionInternalTags',
            ...
            "setTagSet": PolicyDefaultActionInternalTagsSetTagSet.from_dict(obj["setTagSet"]) if obj.get("setTagSet") is not None else None,
