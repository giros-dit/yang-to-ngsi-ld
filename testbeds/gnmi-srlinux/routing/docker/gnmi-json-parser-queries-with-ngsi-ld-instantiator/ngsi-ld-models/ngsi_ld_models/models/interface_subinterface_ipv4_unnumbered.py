...
class InterfaceSubinterfaceIpv4Unnumbered(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceIpv4Unnumbered.")
    ...
    admin_state: Optional[InterfaceSubinterfaceIpv4UnnumberedAdminState] = Field(default=None, alias="adminState")
    interface: Optional[InterfaceSubinterfaceIpv4UnnumberedInterface] = None
    address: Optional[InterfaceSubinterfaceIpv4UnnumberedAddress] = None
    unavailable_address_reason: Optional[UnavailableAddressReason] = Field(default=None, alias="unavailableAddressReason")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adminState", "interface", "address", "unavailableAddressReason", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceIpv4Unnumbered']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceIpv4Unnumbered')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of unavailable_address_reason
        if self.unavailable_address_reason:
            _dict['unavailableAddressReason'] = self.unavailable_address_reason.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceIpv4Unnumbered',
            ...
            "adminState": InterfaceSubinterfaceIpv4UnnumberedAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "interface": InterfaceSubinterfaceIpv4UnnumberedInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "address": InterfaceSubinterfaceIpv4UnnumberedAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "unavailableAddressReason": UnavailableAddressReason.from_dict(obj["unavailableAddressReason"]) if obj.get("unavailableAddressReason") is not None else None,
