...
class CommunitySet(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be CommunitySet.")
    ...
    member: Optional[CommunitySetMember] = None
    match_set_options: Optional[CommunitySetMatchSetOptions] = Field(default=None, alias="matchSetOptions")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "member", "matchSetOptions"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CommunitySet']):
            raise ValueError("must be one of enum values ('CommunitySet')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'CommunitySet',
            ...
            "name": CommunitySetName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "member": CommunitySetMember.from_dict(obj["member"]) if obj.get("member") is not None else None,
            "matchSetOptions": CommunitySetMatchSetOptions.from_dict(obj["matchSetOptions"]) if obj.get("matchSetOptions") is not None else None
        })
