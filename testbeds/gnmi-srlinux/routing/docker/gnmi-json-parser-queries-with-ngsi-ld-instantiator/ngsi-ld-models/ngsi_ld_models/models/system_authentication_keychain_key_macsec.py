...
class SystemAuthenticationKeychainKeyMacsec(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemAuthenticationKeychainKeyMacsec.")
    ...
    cak: Cak
    key_name: KeyName = Field(alias="keyName")
    admin_state: Optional[SystemAuthenticationKeychainKeyMacsecAdminState] = Field(default=None, alias="adminState")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "cak", "keyName", "adminState", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemAuthenticationKeychainKeyMacsec']):
            raise ValueError("must be one of enum values ('SystemAuthenticationKeychainKeyMacsec')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of cak
        if self.cak:
            _dict['cak'] = self.cak.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemAuthenticationKeychainKeyMacsec',
            ...
            "cak": Cak.from_dict(obj["cak"]) if obj.get("cak") is not None else None,
            "keyName": KeyName.from_dict(obj["keyName"]) if obj.get("keyName") is not None else None,
            "adminState": SystemAuthenticationKeychainKeyMacsecAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
