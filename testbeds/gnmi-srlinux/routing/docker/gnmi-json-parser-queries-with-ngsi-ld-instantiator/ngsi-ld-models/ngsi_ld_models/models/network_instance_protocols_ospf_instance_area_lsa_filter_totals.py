...
class NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals.")
    ...
    export_filtered: Optional[ExportFiltered] = Field(default=None, alias="exportFiltered")
    import_filtered: Optional[ImportFiltered] = Field(default=None, alias="importFiltered")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "exportFiltered", "importFiltered", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of export_filtered
        if self.export_filtered:
            _dict['exportFiltered'] = self.export_filtered.to_dict()
        # override the default output from pydantic by calling `to_dict()` of import_filtered
        if self.import_filtered:
            _dict['importFiltered'] = self.import_filtered.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaLsaFilterTotals',
            ...
            "exportFiltered": ExportFiltered.from_dict(obj["exportFiltered"]) if obj.get("exportFiltered") is not None else None,
            "importFiltered": ImportFiltered.from_dict(obj["importFiltered"]) if obj.get("importFiltered") is not None else None,
