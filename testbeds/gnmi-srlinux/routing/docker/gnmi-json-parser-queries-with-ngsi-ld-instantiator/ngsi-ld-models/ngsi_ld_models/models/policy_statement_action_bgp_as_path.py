...
class PolicyStatementActionBgpAsPath(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpAsPath.")
    ...
    remove: Optional[PolicyStatementActionBgpAsPathRemove] = None
    replace: Optional[PolicyStatementActionBgpAsPathReplace] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "remove", "replace", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpAsPath']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpAsPath')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpAsPath',
            ...
            "remove": PolicyStatementActionBgpAsPathRemove.from_dict(obj["remove"]) if obj.get("remove") is not None else None,
            "replace": PolicyStatementActionBgpAsPathReplace.from_dict(obj["replace"]) if obj.get("replace") is not None else None,
