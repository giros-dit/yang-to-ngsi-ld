...
class PolicyStatementMatchOspf(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchOspf.")
    ...
    area_id: Optional[PolicyStatementMatchOspfAreaId] = Field(default=None, alias="areaId")
    route_type: Optional[PolicyStatementMatchOspfRouteType] = Field(default=None, alias="routeType")
    instance_id: Optional[PolicyStatementMatchOspfInstanceId] = Field(default=None, alias="instanceId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "areaId", "routeType", "instanceId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchOspf']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchOspf')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchOspf',
            ...
            "areaId": PolicyStatementMatchOspfAreaId.from_dict(obj["areaId"]) if obj.get("areaId") is not None else None,
            "routeType": PolicyStatementMatchOspfRouteType.from_dict(obj["routeType"]) if obj.get("routeType") is not None else None,
            "instanceId": PolicyStatementMatchOspfInstanceId.from_dict(obj["instanceId"]) if obj.get("instanceId") is not None else None,
