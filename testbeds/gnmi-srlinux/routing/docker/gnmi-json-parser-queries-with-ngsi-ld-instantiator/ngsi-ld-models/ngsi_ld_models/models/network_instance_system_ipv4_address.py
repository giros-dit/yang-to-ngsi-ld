...
class NetworkInstanceSystemIpv4Address(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceSystemIpv4Address.")
    ...
    oper_state: Optional[NetworkInstanceSystemIpv4AddressOperState] = Field(default=None, alias="operState")
    oper_down_reason: Optional[NetworkInstanceSystemIpv4AddressOperDownReason] = Field(default=None, alias="operDownReason")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "operState", "operDownReason", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceSystemIpv4Address']):
            raise ValueError("must be one of enum values ('NetworkInstanceSystemIpv4Address')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceSystemIpv4Address',
            ...
            "operState": NetworkInstanceSystemIpv4AddressOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
            "operDownReason": NetworkInstanceSystemIpv4AddressOperDownReason.from_dict(obj["operDownReason"]) if obj.get("operDownReason") is not None else None,
