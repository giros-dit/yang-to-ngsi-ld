...
class NetworkInstanceBridgeTableMacLearning(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceBridgeTableMacLearning.")
    ...
    admin_state: Optional[NetworkInstanceBridgeTableMacLearningAdminState] = Field(default=None, alias="adminState")
    oper_mac_learning: Optional[NetworkInstanceBridgeTableMacLearningOperMacLearning] = Field(default=None, alias="operMacLearning")
    oper_mac_learning_disabled_reason: Optional[NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason] = Field(default=None, alias="operMacLearningDisabledReason")
    mac_relearn_only: Optional[NetworkInstanceBridgeTableMacLearningMacRelearnOnly] = Field(default=None, alias="macRelearnOnly")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adminState", "operMacLearning", "operMacLearningDisabledReason", "macRelearnOnly", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceBridgeTableMacLearning']):
            raise ValueError("must be one of enum values ('NetworkInstanceBridgeTableMacLearning')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceBridgeTableMacLearning',
            ...
            "adminState": NetworkInstanceBridgeTableMacLearningAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "operMacLearning": NetworkInstanceBridgeTableMacLearningOperMacLearning.from_dict(obj["operMacLearning"]) if obj.get("operMacLearning") is not None else None,
            "operMacLearningDisabledReason": NetworkInstanceBridgeTableMacLearningOperMacLearningDisabledReason.from_dict(obj["operMacLearningDisabledReason"]) if obj.get("operMacLearningDisabledReason") is not None else None,
            "macRelearnOnly": NetworkInstanceBridgeTableMacLearningMacRelearnOnly.from_dict(obj["macRelearnOnly"]) if obj.get("macRelearnOnly") is not None else None,
