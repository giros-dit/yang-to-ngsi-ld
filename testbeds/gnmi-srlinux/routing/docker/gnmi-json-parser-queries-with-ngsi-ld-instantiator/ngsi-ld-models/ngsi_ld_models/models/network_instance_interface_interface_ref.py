...
class NetworkInstanceInterfaceInterfaceRef(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceInterfaceInterfaceRef.")
    ...
    interface: Optional[NetworkInstanceInterfaceInterfaceRefInterface] = None
    subinterface: Optional[NetworkInstanceInterfaceInterfaceRefSubinterface] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceInterfaceInterfaceRef']):
            raise ValueError("must be one of enum values ('NetworkInstanceInterfaceInterfaceRef')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceInterfaceInterfaceRef',
            ...
            "interface": NetworkInstanceInterfaceInterfaceRefInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "subinterface": NetworkInstanceInterfaceInterfaceRefSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
