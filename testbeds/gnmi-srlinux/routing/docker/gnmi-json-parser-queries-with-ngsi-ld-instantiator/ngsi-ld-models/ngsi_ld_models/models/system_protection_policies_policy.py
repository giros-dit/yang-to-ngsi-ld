...
class SystemProtectionPoliciesPolicy(BaseModel):
    """
     YANG module: srl_nokia-protection-policies.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemProtectionPoliciesPolicy.")
    ...
    protection_policy_name: Optional[ProtectionPolicyName] = Field(default=None, alias="protectionPolicyName")
    revert_timer: Optional[RevertTimer] = Field(default=None, alias="revertTimer")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "protectionPolicyName", "revertTimer", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemProtectionPoliciesPolicy']):
            raise ValueError("must be one of enum values ('SystemProtectionPoliciesPolicy')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of protection_policy_name
        if self.protection_policy_name:
            _dict['protectionPolicyName'] = self.protection_policy_name.to_dict()
        # override the default output from pydantic by calling `to_dict()` of revert_timer
        if self.revert_timer:
            _dict['revertTimer'] = self.revert_timer.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemProtectionPoliciesPolicy',
            ...
            "protectionPolicyName": ProtectionPolicyName.from_dict(obj["protectionPolicyName"]) if obj.get("protectionPolicyName") is not None else None,
            "revertTimer": RevertTimer.from_dict(obj["revertTimer"]) if obj.get("revertTimer") is not None else None,
