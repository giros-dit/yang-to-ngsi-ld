...
class LinecardForwardingComplexFibTableNextHopGroupNextHop(BaseModel):
    """
     YANG module: srl_nokia-platform-linecard-fib.yang 
    """ # noqa: E501
    id: Optional[LinecardForwardingComplexFibTableNextHopGroupNextHopId] = None
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplexFibTableNextHopGroupNextHop.")
    ...
    next_hop: Optional[LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop] = Field(default=None, alias="nextHop")
    oper_state: Optional[LinecardForwardingComplexFibTableNextHopGroupNextHopOperState] = Field(default=None, alias="operState")
    normalized_weight: Optional[NormalizedWeight] = Field(default=None, alias="normalizedWeight")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "nextHop", "operState", "normalizedWeight", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplexFibTableNextHopGroupNextHop']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplexFibTableNextHopGroupNextHop')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of normalized_weight
        if self.normalized_weight:
            _dict['normalizedWeight'] = self.normalized_weight.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": LinecardForwardingComplexFibTableNextHopGroupNextHopId.from_dict(obj["id"]) if obj.get("id") is not None else None,
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplexFibTableNextHopGroupNextHop',
            ...
            "nextHop": LinecardForwardingComplexFibTableNextHopGroupNextHopNextHop.from_dict(obj["nextHop"]) if obj.get("nextHop") is not None else None,
            "operState": LinecardForwardingComplexFibTableNextHopGroupNextHopOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
            "normalizedWeight": NormalizedWeight.from_dict(obj["normalizedWeight"]) if obj.get("normalizedWeight") is not None else None,
