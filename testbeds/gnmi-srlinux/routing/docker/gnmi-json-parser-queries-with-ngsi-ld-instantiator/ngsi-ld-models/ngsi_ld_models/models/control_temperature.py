...
class ControlTemperature(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be ControlTemperature.")
    ...
    instant: Optional[ControlTemperatureInstant] = None
    maximum: Optional[ControlTemperatureMaximum] = None
    maximum_time: Optional[ControlTemperatureMaximumTime] = Field(default=None, alias="maximumTime")
    alarm_status: Optional[ControlTemperatureAlarmStatus] = Field(default=None, alias="alarmStatus")
    margin: Optional[ControlTemperatureMargin] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ControlTemperature']):
            raise ValueError("must be one of enum values ('ControlTemperature')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'ControlTemperature',
            ...
            "instant": ControlTemperatureInstant.from_dict(obj["instant"]) if obj.get("instant") is not None else None,
            "maximum": ControlTemperatureMaximum.from_dict(obj["maximum"]) if obj.get("maximum") is not None else None,
            "maximumTime": ControlTemperatureMaximumTime.from_dict(obj["maximumTime"]) if obj.get("maximumTime") is not None else None,
            "alarmStatus": ControlTemperatureAlarmStatus.from_dict(obj["alarmStatus"]) if obj.get("alarmStatus") is not None else None,
            "margin": ControlTemperatureMargin.from_dict(obj["margin"]) if obj.get("margin") is not None else None,
