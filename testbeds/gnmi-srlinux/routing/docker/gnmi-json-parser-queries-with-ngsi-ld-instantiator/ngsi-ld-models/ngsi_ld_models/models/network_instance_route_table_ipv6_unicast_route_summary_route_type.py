...
class NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType(BaseModel):
    """
     YANG module: srl_nokia-ip-route-tables.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType.")
    ...
    ip_route_type_name: Optional[NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName] = Field(default=None, alias="ipRouteTypeName")
    active_routes: Optional[NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes] = Field(default=None, alias="activeRoutes")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteType',
            ...
            "ipRouteTypeName": NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeIpRouteTypeName.from_dict(obj["ipRouteTypeName"]) if obj.get("ipRouteTypeName") is not None else None,
            "activeRoutes": NetworkInstanceRouteTableIpv6UnicastRouteSummaryRouteTypeActiveRoutes.from_dict(obj["activeRoutes"]) if obj.get("activeRoutes") is not None else None,
