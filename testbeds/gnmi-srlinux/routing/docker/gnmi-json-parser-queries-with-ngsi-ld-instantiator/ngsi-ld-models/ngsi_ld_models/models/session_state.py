...
class SessionState(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['closed', 'syn-sent', 'syn-received', 'established', 'fin-wait1', 'fin-wait2', 'close-wait', 'last-ack', 'closing', 'time-wait', 'delete-tcb']):
            raise ValueError("must be one of enum values ('closed', 'syn-sent', 'syn-received', 'established', 'fin-wait1', 'fin-wait2', 'close-wait', 'last-ack', 'closing', 'time-wait', 'delete-tcb')")
        return value
