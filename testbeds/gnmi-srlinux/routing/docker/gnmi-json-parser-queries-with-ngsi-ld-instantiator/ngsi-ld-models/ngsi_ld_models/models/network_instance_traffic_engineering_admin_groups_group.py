...
class NetworkInstanceTrafficEngineeringAdminGroupsGroup(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceTrafficEngineeringAdminGroupsGroup.")
    ...
    name: Optional[NetworkInstanceTrafficEngineeringAdminGroupsGroupName] = None
    bit_position: BitPosition = Field(alias="bitPosition")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "bitPosition", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceTrafficEngineeringAdminGroupsGroup']):
            raise ValueError("must be one of enum values ('NetworkInstanceTrafficEngineeringAdminGroupsGroup')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of bit_position
        if self.bit_position:
            _dict['bitPosition'] = self.bit_position.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceTrafficEngineeringAdminGroupsGroup',
            ...
            "name": NetworkInstanceTrafficEngineeringAdminGroupsGroupName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "bitPosition": BitPosition.from_dict(obj["bitPosition"]) if obj.get("bitPosition") is not None else None,
