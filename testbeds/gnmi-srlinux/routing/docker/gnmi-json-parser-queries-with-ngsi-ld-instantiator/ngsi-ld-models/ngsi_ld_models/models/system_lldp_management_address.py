...
class SystemLldpManagementAddress(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpManagementAddress.")
    ...
    subinterface: Optional[SystemLldpManagementAddressSubinterface] = None
    managementaddress_type: Optional[SystemLldpManagementAddressType] = Field(default=None, alias="managementaddressType")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "subinterface", "managementaddressType", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpManagementAddress']):
            raise ValueError("must be one of enum values ('SystemLldpManagementAddress')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpManagementAddress',
            ...
            "subinterface": SystemLldpManagementAddressSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
            "managementaddressType": SystemLldpManagementAddressType.from_dict(obj["managementaddressType"]) if obj.get("managementaddressType") is not None else None,
