...
class SystemLldpInterface(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterface.")
    ...
    name: Optional[SystemLldpInterfaceName] = None
    admin_state: Optional[SystemLldpInterfaceAdminState] = Field(default=None, alias="adminState")
    oper_state: Optional[SystemLldpInterfaceOperState] = Field(default=None, alias="operState")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterface']):
            raise ValueError("must be one of enum values ('SystemLldpInterface')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterface',
            ...
            "name": SystemLldpInterfaceName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "adminState": SystemLldpInterfaceAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "operState": SystemLldpInterfaceOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
