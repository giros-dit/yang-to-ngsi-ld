...
class PrefixSetPrefix(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PrefixSetPrefix.")
    ...
    ip_prefix: Optional[PrefixSetPrefixIpPrefix] = Field(default=None, alias="ipPrefix")
    mask_length_range: Optional[MaskLengthRange] = Field(default=None, alias="maskLengthRange")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipPrefix", "maskLengthRange", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PrefixSetPrefix']):
            raise ValueError("must be one of enum values ('PrefixSetPrefix')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of mask_length_range
        if self.mask_length_range:
            _dict['maskLengthRange'] = self.mask_length_range.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PrefixSetPrefix',
            ...
            "ipPrefix": PrefixSetPrefixIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
            "maskLengthRange": MaskLengthRange.from_dict(obj["maskLengthRange"]) if obj.get("maskLengthRange") is not None else None,
