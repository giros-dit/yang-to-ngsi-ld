...
class NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['gre', 'ipv4', 'ipv6', 'mpls']):
            raise ValueError("must be one of enum values ('gre', 'ipv4', 'ipv6', 'mpls')")
        return value
