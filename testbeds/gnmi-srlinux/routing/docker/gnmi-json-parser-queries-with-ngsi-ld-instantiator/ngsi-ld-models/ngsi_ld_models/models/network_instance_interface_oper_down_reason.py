...
class NetworkInstanceInterfaceOperDownReason(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ip-addr-missing', 'ip-addr-overlap', 'subif-down', 'net-inst-down', 'vrf-type-mismatch', 'mac-dup-detected', 'associated-mac-vrf-down', 'mac-vrf-association-missing', 'ip-vrf-association-missing', 'associated-ip-vrf-down', 'evpn-mh-standby', 'interface-ref-missing', 'stp-not-forwarding']):
            raise ValueError("must be one of enum values ('ip-addr-missing', 'ip-addr-overlap', 'subif-down', 'net-inst-down', 'vrf-type-mismatch', 'mac-dup-detected', 'associated-mac-vrf-down', 'mac-vrf-association-missing', 'ip-vrf-association-missing', 'associated-ip-vrf-down', 'evpn-mh-standby', 'interface-ref-missing', 'stp-not-forwarding')")
        return value
