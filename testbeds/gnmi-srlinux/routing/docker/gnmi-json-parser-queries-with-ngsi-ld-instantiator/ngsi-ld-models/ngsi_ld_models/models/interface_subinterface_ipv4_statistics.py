...
class InterfaceSubinterfaceIpv4Statistics(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceIpv4Statistics.")
    ...
    in_packets: Optional[InterfaceSubinterfaceIpv4StatisticsInPackets] = Field(default=None, alias="inPackets")
    in_octets: Optional[InterfaceSubinterfaceIpv4StatisticsInOctets] = Field(default=None, alias="inOctets")
    in_error_packets: Optional[InterfaceSubinterfaceIpv4StatisticsInErrorPackets] = Field(default=None, alias="inErrorPackets")
    in_discarded_packets: Optional[InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets] = Field(default=None, alias="inDiscardedPackets")
    in_terminated_packets: Optional[InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets] = Field(default=None, alias="inTerminatedPackets")
    in_terminated_octets: Optional[InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets] = Field(default=None, alias="inTerminatedOctets")
    in_forwarded_packets: Optional[InterfaceSubinterfaceIpv4StatisticsInForwardedPackets] = Field(default=None, alias="inForwardedPackets")
    in_forwarded_octets: Optional[InterfaceSubinterfaceIpv4StatisticsInForwardedOctets] = Field(default=None, alias="inForwardedOctets")
    in_matched_ra_packets: Optional[InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets] = Field(default=None, alias="inMatchedRaPackets")
    out_forwarded_packets: Optional[InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets] = Field(default=None, alias="outForwardedPackets")
    out_forwarded_octets: Optional[InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets] = Field(default=None, alias="outForwardedOctets")
    out_originated_packets: Optional[InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets] = Field(default=None, alias="outOriginatedPackets")
    out_originated_octets: Optional[InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets] = Field(default=None, alias="outOriginatedOctets")
    out_error_packets: Optional[InterfaceSubinterfaceIpv4StatisticsOutErrorPackets] = Field(default=None, alias="outErrorPackets")
    out_discarded_packets: Optional[InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets] = Field(default=None, alias="outDiscardedPackets")
    out_packets: Optional[InterfaceSubinterfaceIpv4StatisticsOutPackets] = Field(default=None, alias="outPackets")
    out_octets: Optional[InterfaceSubinterfaceIpv4StatisticsOutOctets] = Field(default=None, alias="outOctets")
    last_clear: Optional[InterfaceSubinterfaceIpv4StatisticsLastClear] = Field(default=None, alias="lastClear")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceIpv4Statistics']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceIpv4Statistics')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceIpv4Statistics',
            ...
            "inPackets": InterfaceSubinterfaceIpv4StatisticsInPackets.from_dict(obj["inPackets"]) if obj.get("inPackets") is not None else None,
            "inOctets": InterfaceSubinterfaceIpv4StatisticsInOctets.from_dict(obj["inOctets"]) if obj.get("inOctets") is not None else None,
            "inErrorPackets": InterfaceSubinterfaceIpv4StatisticsInErrorPackets.from_dict(obj["inErrorPackets"]) if obj.get("inErrorPackets") is not None else None,
            "inDiscardedPackets": InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets.from_dict(obj["inDiscardedPackets"]) if obj.get("inDiscardedPackets") is not None else None,
            "inTerminatedPackets": InterfaceSubinterfaceIpv4StatisticsInTerminatedPackets.from_dict(obj["inTerminatedPackets"]) if obj.get("inTerminatedPackets") is not None else None,
            "inTerminatedOctets": InterfaceSubinterfaceIpv4StatisticsInTerminatedOctets.from_dict(obj["inTerminatedOctets"]) if obj.get("inTerminatedOctets") is not None else None,
            "inForwardedPackets": InterfaceSubinterfaceIpv4StatisticsInForwardedPackets.from_dict(obj["inForwardedPackets"]) if obj.get("inForwardedPackets") is not None else None,
            "inForwardedOctets": InterfaceSubinterfaceIpv4StatisticsInForwardedOctets.from_dict(obj["inForwardedOctets"]) if obj.get("inForwardedOctets") is not None else None,
            "inMatchedRaPackets": InterfaceSubinterfaceIpv4StatisticsInMatchedRaPackets.from_dict(obj["inMatchedRaPackets"]) if obj.get("inMatchedRaPackets") is not None else None,
            "outForwardedPackets": InterfaceSubinterfaceIpv4StatisticsOutForwardedPackets.from_dict(obj["outForwardedPackets"]) if obj.get("outForwardedPackets") is not None else None,
            "outForwardedOctets": InterfaceSubinterfaceIpv4StatisticsOutForwardedOctets.from_dict(obj["outForwardedOctets"]) if obj.get("outForwardedOctets") is not None else None,
            "outOriginatedPackets": InterfaceSubinterfaceIpv4StatisticsOutOriginatedPackets.from_dict(obj["outOriginatedPackets"]) if obj.get("outOriginatedPackets") is not None else None,
            "outOriginatedOctets": InterfaceSubinterfaceIpv4StatisticsOutOriginatedOctets.from_dict(obj["outOriginatedOctets"]) if obj.get("outOriginatedOctets") is not None else None,
            "outErrorPackets": InterfaceSubinterfaceIpv4StatisticsOutErrorPackets.from_dict(obj["outErrorPackets"]) if obj.get("outErrorPackets") is not None else None,
            "outDiscardedPackets": InterfaceSubinterfaceIpv4StatisticsOutDiscardedPackets.from_dict(obj["outDiscardedPackets"]) if obj.get("outDiscardedPackets") is not None else None,
            "outPackets": InterfaceSubinterfaceIpv4StatisticsOutPackets.from_dict(obj["outPackets"]) if obj.get("outPackets") is not None else None,
            "outOctets": InterfaceSubinterfaceIpv4StatisticsOutOctets.from_dict(obj["outOctets"]) if obj.get("outOctets") is not None else None,
            "lastClear": InterfaceSubinterfaceIpv4StatisticsLastClear.from_dict(obj["lastClear"]) if obj.get("lastClear") is not None else None,
