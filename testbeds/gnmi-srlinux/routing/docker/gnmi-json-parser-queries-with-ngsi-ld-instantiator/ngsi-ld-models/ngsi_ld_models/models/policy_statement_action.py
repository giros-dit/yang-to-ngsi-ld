...
class PolicyStatementAction(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementAction.")
    ...
    policy_result: Optional[PolicyStatementActionPolicyResult] = Field(default=None, alias="policyResult")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "policyResult", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementAction']):
            raise ValueError("must be one of enum values ('PolicyStatementAction')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of policy_result
        if self.policy_result:
            _dict['policyResult'] = self.policy_result.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementAction',
            ...
            "policyResult": PolicyStatementActionPolicyResult.from_dict(obj["policyResult"]) if obj.get("policyResult") is not None else None,
