...
class PolicyStatementMatchIsis(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchIsis.")
    ...
    level: Optional[PolicyStatementMatchIsisLevel] = None
    route_type: Optional[PolicyStatementMatchIsisRouteType] = Field(default=None, alias="routeType")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "level", "routeType", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchIsis']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchIsis')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchIsis',
            ...
            "level": PolicyStatementMatchIsisLevel.from_dict(obj["level"]) if obj.get("level") is not None else None,
            "routeType": PolicyStatementMatchIsisRouteType.from_dict(obj["routeType"]) if obj.get("routeType") is not None else None,
