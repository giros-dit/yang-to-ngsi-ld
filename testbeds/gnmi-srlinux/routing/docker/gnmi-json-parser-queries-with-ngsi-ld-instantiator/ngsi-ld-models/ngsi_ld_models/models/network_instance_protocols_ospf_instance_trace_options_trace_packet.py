...
class NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacket(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacket.")
    ...
    packet_type: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType] = Field(default=None, alias="packetType")
    modifier: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier] = None
    detail: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacket']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacket')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacket',
            ...
            "packetType": NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketType.from_dict(obj["packetType"]) if obj.get("packetType") is not None else None,
            "modifier": NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketModifier.from_dict(obj["modifier"]) if obj.get("modifier") is not None else None,
            "detail": NetworkInstanceProtocolsOspfInstanceTraceOptionsTracePacketDetail.from_dict(obj["detail"]) if obj.get("detail") is not None else None,
