...
class InterfaceEthernetStatistics(BaseModel):
    ...
    in_undersize_frames: Optional[InUndersizeFrames] = Field(default=None, alias="inUndersizeFrames")
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "inMacPauseFrames", "inOversizeFrames", "inUndersizeFrames", "inJabberFrames", "inFragmentFrames", "inCrcErrorFrames", "outMacPauseFrames", "in64bFrames", "in65bTo127bFrames", "in128bTo255bFrames", "in256bTo511bFrames", "in512bTo1023bFrames", "in1024bTo1518bFrames", "in1519bOrLongerFrames", "out64bFrames", "out65bTo127bFrames", "out128bTo255bFrames", "out256bTo511bFrames", "out512bTo1023bFrames", "out1024bTo1518bFrames", "out1519bOrLongerFrames", "lastClear", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetStatistics']):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of in_undersize_frames
        if self.in_undersize_frames:
            _dict['inUndersizeFrames'] = self.in_undersize_frames.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inUndersizeFrames": InUndersizeFrames.from_dict(obj["inUndersizeFrames"]) if obj.get("inUndersizeFrames") is not None else None,
