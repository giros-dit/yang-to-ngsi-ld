...
class NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs.")
    ...
    igp_identifier: Optional[NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier] = Field(default=None, alias="igpIdentifier")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "igpIdentifier", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of igp_identifier
        if self.igp_identifier:
            _dict['igpIdentifier'] = self.igp_identifier.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLs',
            ...
            "igpIdentifier": NetworkInstanceProtocolsOspfInstanceTeDatabaseInstallBgpLsIgpIdentifier.from_dict(obj["igpIdentifier"]) if obj.get("igpIdentifier") is not None else None,
