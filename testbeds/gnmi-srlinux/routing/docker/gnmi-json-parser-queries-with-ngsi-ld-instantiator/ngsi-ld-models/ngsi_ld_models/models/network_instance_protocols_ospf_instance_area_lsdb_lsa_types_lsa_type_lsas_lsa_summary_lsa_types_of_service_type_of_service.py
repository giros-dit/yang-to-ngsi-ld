...
class NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfService(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfService.")
    ...
    tos: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfServiceTos] = None
    metric: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfServiceMetric] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfService']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfService')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfService',
            ...
            "tos": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfServiceTos.from_dict(obj["tos"]) if obj.get("tos") is not None else None,
            "metric": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaSummaryLsaTypesOfServiceTypeOfServiceMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
