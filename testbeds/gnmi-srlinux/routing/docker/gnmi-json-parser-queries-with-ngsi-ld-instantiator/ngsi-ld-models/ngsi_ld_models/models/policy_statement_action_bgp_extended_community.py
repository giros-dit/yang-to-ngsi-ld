...
class PolicyStatementActionBgpExtendedCommunity(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpExtendedCommunity.")
    ...
    operation: Optional[PolicyStatementActionBgpExtendedCommunityOperation] = None
    referenced_sets: Optional[PolicyStatementActionBgpExtendedCommunityReferencedSets] = Field(default=None, alias="referencedSets")
    method: Optional[PolicyStatementActionBgpExtendedCommunityMethod] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpExtendedCommunity']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpExtendedCommunity')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpExtendedCommunity',
            ...
            "operation": PolicyStatementActionBgpExtendedCommunityOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
            "referencedSets": PolicyStatementActionBgpExtendedCommunityReferencedSets.from_dict(obj["referencedSets"]) if obj.get("referencedSets") is not None else None,
            "method": PolicyStatementActionBgpExtendedCommunityMethod.from_dict(obj["method"]) if obj.get("method") is not None else None,
