...
class PolicyStatementMatch(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatch.")
    ...
    call_policy: Optional[CallPolicy] = Field(default=None, alias="callPolicy")
    origin_network_instance: Optional[PolicyStatementMatchOriginNetworkInstance] = Field(default=None, alias="originNetworkInstance")
    network_instance_leaked_route: Optional[NetworkInstanceLeakedRoute] = Field(default=None, alias="networkInstanceLeakedRoute")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "family", "protocol", "callPolicy", "originNetworkInstance", "networkInstanceLeakedRoute", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatch']):
            raise ValueError("must be one of enum values ('PolicyStatementMatch')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of network_instance_leaked_route
        if self.network_instance_leaked_route:
            _dict['networkInstanceLeakedRoute'] = self.network_instance_leaked_route.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatch',
            ...
            "callPolicy": CallPolicy.from_dict(obj["callPolicy"]) if obj.get("callPolicy") is not None else None,
            "originNetworkInstance": PolicyStatementMatchOriginNetworkInstance.from_dict(obj["originNetworkInstance"]) if obj.get("originNetworkInstance") is not None else None,
            "networkInstanceLeakedRoute": NetworkInstanceLeakedRoute.from_dict(obj["networkInstanceLeakedRoute"]) if obj.get("networkInstanceLeakedRoute") is not None else None,
