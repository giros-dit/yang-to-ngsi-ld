...
class PrefixSet(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PrefixSet.")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PrefixSet']):
            raise ValueError("must be one of enum values ('PrefixSet')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PrefixSet',
            ...
            "name": PrefixSetName.from_dict(obj["name"]) if obj.get("name") is not None else None
        })
