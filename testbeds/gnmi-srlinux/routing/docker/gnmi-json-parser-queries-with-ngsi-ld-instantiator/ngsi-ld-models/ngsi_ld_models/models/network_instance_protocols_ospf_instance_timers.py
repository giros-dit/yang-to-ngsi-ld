...
class NetworkInstanceProtocolsOspfInstanceTimers(BaseModel):
    """
    Enter the timers context  YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTimers.")
    ...
    incremental_spf_wait: Optional[IncrementalSpfWait] = Field(default=None, alias="incrementalSpfWait")
    lsa_accumulate: Optional[LsaAccumulate] = Field(default=None, alias="lsaAccumulate")
    lsa_arrival: Optional[LsaArrival] = Field(default=None, alias="lsaArrival")
    redistribute_delay: Optional[RedistributeDelay] = Field(default=None, alias="redistributeDelay")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "incrementalSpfWait", "lsaAccumulate", "lsaArrival", "redistributeDelay", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTimers']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTimers')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of incremental_spf_wait
        if self.incremental_spf_wait:
            _dict['incrementalSpfWait'] = self.incremental_spf_wait.to_dict()
        # override the default output from pydantic by calling `to_dict()` of lsa_accumulate
        if self.lsa_accumulate:
            _dict['lsaAccumulate'] = self.lsa_accumulate.to_dict()
        # override the default output from pydantic by calling `to_dict()` of lsa_arrival
        if self.lsa_arrival:
            _dict['lsaArrival'] = self.lsa_arrival.to_dict()
        # override the default output from pydantic by calling `to_dict()` of redistribute_delay
        if self.redistribute_delay:
            _dict['redistributeDelay'] = self.redistribute_delay.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTimers',
            ...
            "incrementalSpfWait": IncrementalSpfWait.from_dict(obj["incrementalSpfWait"]) if obj.get("incrementalSpfWait") is not None else None,
            "lsaAccumulate": LsaAccumulate.from_dict(obj["lsaAccumulate"]) if obj.get("lsaAccumulate") is not None else None,
            "lsaArrival": LsaArrival.from_dict(obj["lsaArrival"]) if obj.get("lsaArrival") is not None else None,
            "redistributeDelay": RedistributeDelay.from_dict(obj["redistributeDelay"]) if obj.get("redistributeDelay") is not None else None,
