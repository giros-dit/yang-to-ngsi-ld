...
class PolicyStatementActionBgpProtectionSrtePolicy(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpProtectionSrtePolicy.")
    ...
    protection_policy: Optional[ProtectionPolicy] = Field(default=None, alias="protectionPolicy")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "protectionPolicy", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpProtectionSrtePolicy']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpProtectionSrtePolicy')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpProtectionSrtePolicy',
            ...
            "protectionPolicy": ProtectionPolicy.from_dict(obj["protectionPolicy"]) if obj.get("protectionPolicy") is not None else None,
