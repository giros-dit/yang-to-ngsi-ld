...
class SystemAuthenticationKeychainKeyAlgorithm(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['cleartext', 'md5', 'hmac-md5', 'hmac-sha-1', 'hmac-sha-256', 'aes-128-cmac', 'aes-256-cmac']):
            raise ValueError("must be one of enum values ('cleartext', 'md5', 'hmac-md5', 'hmac-sha-1', 'hmac-sha-256', 'aes-128-cmac', 'aes-256-cmac')")
        return value
