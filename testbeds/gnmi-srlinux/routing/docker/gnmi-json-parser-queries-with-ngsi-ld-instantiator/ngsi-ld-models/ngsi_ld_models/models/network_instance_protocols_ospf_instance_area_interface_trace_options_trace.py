...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTrace(BaseModel):
    """
    Tracing parameter flags  YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTrace.")
    ...
    adjacencies: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies] = None
    interfaces: Optional[NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adjacencies", "interfaces", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTrace']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTrace')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTrace',
            ...
            "adjacencies": NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceAdjacencies.from_dict(obj["adjacencies"]) if obj.get("adjacencies") is not None else None,
            "interfaces": NetworkInstanceProtocolsOspfInstanceAreaInterfaceTraceOptionsTraceInterfaces.from_dict(obj["interfaces"]) if obj.get("interfaces") is not None else None,
