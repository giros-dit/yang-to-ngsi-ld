...
class PolicyStatementMatchInternalTags(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchInternalTags.")
    ...
    tag_set: Optional[PolicyStatementMatchInternalTagsTagSet] = Field(default=None, alias="tagSet")
    match_set_options: Optional[PolicyStatementMatchInternalTagsMatchSetOptions] = Field(default=None, alias="matchSetOptions")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "tagSet", "matchSetOptions", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchInternalTags']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchInternalTags')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchInternalTags',
            ...
            "tagSet": PolicyStatementMatchInternalTagsTagSet.from_dict(obj["tagSet"]) if obj.get("tagSet") is not None else None,
            "matchSetOptions": PolicyStatementMatchInternalTagsMatchSetOptions.from_dict(obj["matchSetOptions"]) if obj.get("matchSetOptions") is not None else None,
