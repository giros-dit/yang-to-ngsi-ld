...
class InterfaceSubinterfaceAnycastGw(BaseModel):
    """
     YANG module: srl_nokia-interfaces.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceAnycastGw.")
    ...
    virtual_router_id: Optional[VirtualRouterId] = Field(default=None, alias="virtualRouterId")
    anycast_gw_mac: Optional[AnycastGwMac] = Field(default=None, alias="anycastGwMac")
    anycast_gw_mac_origin: Optional[AnycastGwMacOrigin] = Field(default=None, alias="anycastGwMacOrigin")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "virtualRouterId", "anycastGwMac", "anycastGwMacOrigin", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceAnycastGw']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceAnycastGw')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of anycast_gw_mac
        if self.anycast_gw_mac:
            _dict['anycastGwMac'] = self.anycast_gw_mac.to_dict()
        # override the default output from pydantic by calling `to_dict()` of anycast_gw_mac_origin
        if self.anycast_gw_mac_origin:
            _dict['anycastGwMacOrigin'] = self.anycast_gw_mac_origin.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceAnycastGw',
            ...
            "virtualRouterId": VirtualRouterId.from_dict(obj["virtualRouterId"]) if obj.get("virtualRouterId") is not None else None,
            "anycastGwMac": AnycastGwMac.from_dict(obj["anycastGwMac"]) if obj.get("anycastGwMac") is not None else None,
            "anycastGwMacOrigin": AnycastGwMacOrigin.from_dict(obj["anycastGwMacOrigin"]) if obj.get("anycastGwMacOrigin") is not None else None,
