...
class PolicyStatementActionBgpSrv6(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpSrv6.")
    ...
    locator: Optional[PolicyStatementActionBgpSrv6Locator] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "locator", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpSrv6']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpSrv6')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpSrv6',
            ...
            "locator": PolicyStatementActionBgpSrv6Locator.from_dict(obj["locator"]) if obj.get("locator") is not None else None,
