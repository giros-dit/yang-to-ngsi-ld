...
class FormFactor(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['CFP2', 'CFP2-ACO', 'CFP4', 'QSFP', 'QSFPplus', 'QSFP28', 'QSFPDD', 'SFP', 'SFPplus', 'Non-pluggable', 'Other', 'SFP28', 'SFPDD', 'QSFP56', 'SFP56', 'CSFP', 'OSFP', 'QSFPCMIS']):
            raise ValueError("must be one of enum values ('CFP2', 'CFP2-ACO', 'CFP4', 'QSFP', 'QSFPplus', 'QSFP28', 'QSFPDD', 'SFP', 'SFPplus', 'Non-pluggable', 'Other', 'SFP28', 'SFPDD', 'QSFP56', 'SFP56', 'CSFP', 'OSFP', 'QSFPCMIS')")
        return value
