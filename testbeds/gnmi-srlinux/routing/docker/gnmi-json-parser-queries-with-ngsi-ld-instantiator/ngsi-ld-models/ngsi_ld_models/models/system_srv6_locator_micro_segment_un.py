...
class SystemSrv6LocatorMicroSegmentUn(BaseModel):
    """
    Enter the un context  YANG module: srl_nokia-srv6.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6LocatorMicroSegmentUn.")
    ...
    srh_mode: Optional[SrhMode] = Field(default=None, alias="srhMode")
    value: SystemSrv6LocatorMicroSegmentUnValue
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "srhMode", "value", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6LocatorMicroSegmentUn']):
            raise ValueError("must be one of enum values ('SystemSrv6LocatorMicroSegmentUn')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of srh_mode
        if self.srh_mode:
            _dict['srhMode'] = self.srh_mode.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6LocatorMicroSegmentUn',
            ...
            "srhMode": SrhMode.from_dict(obj["srhMode"]) if obj.get("srhMode") is not None else None,
            "value": SystemSrv6LocatorMicroSegmentUnValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
