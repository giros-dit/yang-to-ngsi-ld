...
class NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType(BaseModel):
    """
     YANG module: srl_nokia-ip-route-tables.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType.")
    ...
    ip_route_type_name: Optional[NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName] = Field(default=None, alias="ipRouteTypeName")
    active_routes: Optional[NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes] = Field(default=None, alias="activeRoutes")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipRouteTypeName", "activeRoutes", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of ip_route_type_name
        if self.ip_route_type_name:
            _dict['ipRouteTypeName'] = self.ip_route_type_name.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteType',
            ...
            "ipRouteTypeName": NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeIpRouteTypeName.from_dict(obj["ipRouteTypeName"]) if obj.get("ipRouteTypeName") is not None else None,
            "activeRoutes": NetworkInstanceRouteTableIpv4UnicastRouteSummaryRouteTypeActiveRoutes.from_dict(obj["activeRoutes"]) if obj.get("activeRoutes") is not None else None,
