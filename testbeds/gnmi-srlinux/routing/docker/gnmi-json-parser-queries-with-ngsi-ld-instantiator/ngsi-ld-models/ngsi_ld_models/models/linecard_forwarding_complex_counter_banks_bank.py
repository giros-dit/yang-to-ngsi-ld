...
class LinecardForwardingComplexCounterBanksBank(BaseModel):
    """
     YANG module: srl_nokia-platform-lc.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplexCounterBanksBank.")
    ...
    bank_id: Optional[BankId] = Field(default=None, alias="bankId")
    bank_size: Optional[BankSize] = Field(default=None, alias="bankSize")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "bankId", "bankSize", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplexCounterBanksBank']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplexCounterBanksBank')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of bank_size
        if self.bank_size:
            _dict['bankSize'] = self.bank_size.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplexCounterBanksBank',
            ...
            "bankId": BankId.from_dict(obj["bankId"]) if obj.get("bankId") is not None else None,
            "bankSize": BankSize.from_dict(obj["bankSize"]) if obj.get("bankSize") is not None else None,
