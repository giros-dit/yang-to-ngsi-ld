...
class NetworkInstanceRouteTableNextHopTunnel(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopTunnel.")
    ...
    encapsulate_header: Optional[NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader] = Field(default=None, alias="encapsulateHeader")
    ip_prefix: Optional[NetworkInstanceRouteTableNextHopTunnelIpPrefix] = Field(default=None, alias="ipPrefix")
    tunnel_type: Optional[NetworkInstanceRouteTableNextHopTunnelType] = Field(default=None, alias="tunnelType")
    owner: Optional[NetworkInstanceRouteTableNextHopTunnelOwner] = None
    tunnel_id: Optional[NetworkInstanceRouteTableNextHopTunnelTunnelId] = Field(default=None, alias="tunnelId")
    network_instance: Optional[NetworkInstanceRouteTableNextHopTunnelNetworkInstance] = Field(default=None, alias="networkInstance")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "encapsulateHeader", "ipPrefix", "tunnelType", "owner", "tunnelId", "networkInstance", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopTunnel']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopTunnel')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of ip_prefix
        if self.ip_prefix:
            _dict['ipPrefix'] = self.ip_prefix.to_dict()
        # override the default output from pydantic by calling `to_dict()` of tunnel_type
        if self.tunnel_type:
            _dict['tunnelType'] = self.tunnel_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of owner
        if self.owner:
            _dict['owner'] = self.owner.to_dict()
        # override the default output from pydantic by calling `to_dict()` of tunnel_id
        if self.tunnel_id:
            _dict['tunnelId'] = self.tunnel_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of network_instance
        if self.network_instance:
            _dict['networkInstance'] = self.network_instance.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopTunnel',
            ...
            "encapsulateHeader": NetworkInstanceRouteTableNextHopTunnelEncapsulateHeader.from_dict(obj["encapsulateHeader"]) if obj.get("encapsulateHeader") is not None else None,
            "ipPrefix": NetworkInstanceRouteTableNextHopTunnelIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
            "tunnelType": NetworkInstanceRouteTableNextHopTunnelType.from_dict(obj["tunnelType"]) if obj.get("tunnelType") is not None else None,
            "owner": NetworkInstanceRouteTableNextHopTunnelOwner.from_dict(obj["owner"]) if obj.get("owner") is not None else None,
            "tunnelId": NetworkInstanceRouteTableNextHopTunnelTunnelId.from_dict(obj["tunnelId"]) if obj.get("tunnelId") is not None else None,
            "networkInstance": NetworkInstanceRouteTableNextHopTunnelNetworkInstance.from_dict(obj["networkInstance"]) if obj.get("networkInstance") is not None else None,
