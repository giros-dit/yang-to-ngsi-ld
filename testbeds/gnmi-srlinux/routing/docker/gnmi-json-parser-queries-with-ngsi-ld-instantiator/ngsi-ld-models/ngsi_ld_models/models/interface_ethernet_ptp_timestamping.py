...
class InterfaceEthernetPtpTimestamping(BaseModel):
    """
     YANG module: srl_nokia-interfaces.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetPtpTimestamping.")
    ...
    disable_ip_timestamping: Optional[DisableIpTimestamping] = Field(default=None, alias="disableIpTimestamping")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "disableIpTimestamping", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetPtpTimestamping']):
            raise ValueError("must be one of enum values ('InterfaceEthernetPtpTimestamping')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of disable_ip_timestamping
        if self.disable_ip_timestamping:
            _dict['disableIpTimestamping'] = self.disable_ip_timestamping.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetPtpTimestamping',
            ...
            "disableIpTimestamping": DisableIpTimestamping.from_dict(obj["disableIpTimestamping"]) if obj.get("disableIpTimestamping") is not None else None,
