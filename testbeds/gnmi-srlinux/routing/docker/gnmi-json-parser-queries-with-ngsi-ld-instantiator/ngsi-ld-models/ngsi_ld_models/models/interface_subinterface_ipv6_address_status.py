...
class InterfaceSubinterfaceIpv6AddressStatus(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['preferred', 'deprecated', 'invalid', 'inaccessible', 'unknown', 'tentative', 'duplicate', 'optimistic']):
            raise ValueError("must be one of enum values ('preferred', 'deprecated', 'invalid', 'inaccessible', 'unknown', 'tentative', 'duplicate', 'optimistic')")
        return value
