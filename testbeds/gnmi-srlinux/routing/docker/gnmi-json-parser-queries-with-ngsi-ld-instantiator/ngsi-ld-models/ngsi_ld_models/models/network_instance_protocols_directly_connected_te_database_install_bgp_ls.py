...
class NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs.")
    ...
    igp_identifier: Optional[NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier] = Field(default=None, alias="igpIdentifier")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLs',
            ...
            "igpIdentifier": NetworkInstanceProtocolsDirectlyConnectedTeDatabaseInstallBgpLsIgpIdentifier.from_dict(obj["igpIdentifier"]) if obj.get("igpIdentifier") is not None else None,
