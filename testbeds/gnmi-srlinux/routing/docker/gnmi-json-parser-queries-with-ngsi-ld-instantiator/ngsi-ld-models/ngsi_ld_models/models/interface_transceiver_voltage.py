...
class InterfaceTransceiverVoltage(BaseModel):
    """
     YANG module: srl_nokia-interfaces.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceTransceiverVoltage.")
    ...
    latest_value: Optional[InterfaceTransceiverVoltageLatestValue] = Field(default=None, alias="latestValue")
    high_alarm_condition: Optional[InterfaceTransceiverVoltageHighAlarmCondition] = Field(default=None, alias="highAlarmCondition")
    high_alarm_threshold: Optional[InterfaceTransceiverVoltageHighAlarmThreshold] = Field(default=None, alias="highAlarmThreshold")
    low_alarm_condition: Optional[InterfaceTransceiverVoltageLowAlarmCondition] = Field(default=None, alias="lowAlarmCondition")
    low_alarm_threshold: Optional[InterfaceTransceiverVoltageLowAlarmThreshold] = Field(default=None, alias="lowAlarmThreshold")
    high_warning_condition: Optional[InterfaceTransceiverVoltageHighWarningCondition] = Field(default=None, alias="highWarningCondition")
    high_warning_threshold: Optional[InterfaceTransceiverVoltageHighWarningThreshold] = Field(default=None, alias="highWarningThreshold")
    low_warning_condition: Optional[InterfaceTransceiverVoltageLowWarningCondition] = Field(default=None, alias="lowWarningCondition")
    low_warning_threshold: Optional[InterfaceTransceiverVoltageLowWarningThreshold] = Field(default=None, alias="lowWarningThreshold")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "latestValue", "highAlarmCondition", "highAlarmThreshold", "lowAlarmCondition", "lowAlarmThreshold", "highWarningCondition", "highWarningThreshold", "lowWarningCondition", "lowWarningThreshold", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceTransceiverVoltage']):
            raise ValueError("must be one of enum values ('InterfaceTransceiverVoltage')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceTransceiverVoltage',
            ...
            "latestValue": InterfaceTransceiverVoltageLatestValue.from_dict(obj["latestValue"]) if obj.get("latestValue") is not None else None,
            "highAlarmCondition": InterfaceTransceiverVoltageHighAlarmCondition.from_dict(obj["highAlarmCondition"]) if obj.get("highAlarmCondition") is not None else None,
            "highAlarmThreshold": InterfaceTransceiverVoltageHighAlarmThreshold.from_dict(obj["highAlarmThreshold"]) if obj.get("highAlarmThreshold") is not None else None,
            "lowAlarmCondition": InterfaceTransceiverVoltageLowAlarmCondition.from_dict(obj["lowAlarmCondition"]) if obj.get("lowAlarmCondition") is not None else None,
            "lowAlarmThreshold": InterfaceTransceiverVoltageLowAlarmThreshold.from_dict(obj["lowAlarmThreshold"]) if obj.get("lowAlarmThreshold") is not None else None,
            "highWarningCondition": InterfaceTransceiverVoltageHighWarningCondition.from_dict(obj["highWarningCondition"]) if obj.get("highWarningCondition") is not None else None,
            "highWarningThreshold": InterfaceTransceiverVoltageHighWarningThreshold.from_dict(obj["highWarningThreshold"]) if obj.get("highWarningThreshold") is not None else None,
            "lowWarningCondition": InterfaceTransceiverVoltageLowWarningCondition.from_dict(obj["lowWarningCondition"]) if obj.get("lowWarningCondition") is not None else None,
            "lowWarningThreshold": InterfaceTransceiverVoltageLowWarningThreshold.from_dict(obj["lowWarningThreshold"]) if obj.get("lowWarningThreshold") is not None else None,
