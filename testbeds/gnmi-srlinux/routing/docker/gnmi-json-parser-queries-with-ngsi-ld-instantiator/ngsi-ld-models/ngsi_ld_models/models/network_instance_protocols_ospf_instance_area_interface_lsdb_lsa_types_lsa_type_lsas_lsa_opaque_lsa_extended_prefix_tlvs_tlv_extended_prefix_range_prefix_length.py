...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaExtendedPrefixTlvsTlvExtendedPrefixRangePrefixLength(BaseModel):
    """
    ...
    value: Annotated[int, Field(le=32, strict=True, ge=0)]
