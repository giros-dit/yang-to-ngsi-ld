...
class InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount.")
    ...
    instant: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant] = None
    avg: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg] = None
    min: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin] = None
    max: Optional[InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount']):
            raise ValueError("must be one of enum values ('InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCount',
            ...
            "instant": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountInstant.from_dict(obj["instant"]) if obj.get("instant") is not None else None,
            "avg": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountAvg.from_dict(obj["avg"]) if obj.get("avg") is not None else None,
            "min": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMin.from_dict(obj["min"]) if obj.get("min") is not None else None,
            "max": InterfaceEthernetForwardErrorCorrectionStatisticsHostIfFecTransceiverFrameErrorCountMax.from_dict(obj["max"]) if obj.get("max") is not None else None,
