...
class PolicyStatementActionOspfMetric(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionOspfMetric.")
    ...
    set_external_type: Optional[PolicyStatementActionOspfMetricSetExternalType] = Field(default=None, alias="setExternalType")
    set_value: Optional[PolicyStatementActionOspfMetricSetValue] = Field(default=None, alias="setValue")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "setExternalType", "setValue", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionOspfMetric']):
            raise ValueError("must be one of enum values ('PolicyStatementActionOspfMetric')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of set_external_type
        if self.set_external_type:
            _dict['setExternalType'] = self.set_external_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionOspfMetric',
            ...
            "setExternalType": PolicyStatementActionOspfMetricSetExternalType.from_dict(obj["setExternalType"]) if obj.get("setExternalType") is not None else None,
            "setValue": PolicyStatementActionOspfMetricSetValue.from_dict(obj["setValue"]) if obj.get("setValue") is not None else None,
