...
class LinecardForwardingComplexCounterBanksBankApplication(BaseModel):
    """
     YANG module: srl_nokia-platform-lc.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplexCounterBanksBankApplication.")
    ...
    name: Optional[LinecardForwardingComplexCounterBanksBankApplicationName] = None
    entries: Optional[Entries] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "entries", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplexCounterBanksBankApplication']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplexCounterBanksBankApplication')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplexCounterBanksBankApplication',
            ...
            "name": LinecardForwardingComplexCounterBanksBankApplicationName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "entries": Entries.from_dict(obj["entries"]) if obj.get("entries") is not None else None,
