...
class PolicyStatementActionInternalTags(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionInternalTags.")
    ...
    set_tag_set: Optional[PolicyStatementActionInternalTagsSetTagSet] = Field(default=None, alias="setTagSet")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "setTagSet", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionInternalTags']):
            raise ValueError("must be one of enum values ('PolicyStatementActionInternalTags')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionInternalTags',
            ...
            "setTagSet": PolicyStatementActionInternalTagsSetTagSet.from_dict(obj["setTagSet"]) if obj.get("setTagSet") is not None else None,
