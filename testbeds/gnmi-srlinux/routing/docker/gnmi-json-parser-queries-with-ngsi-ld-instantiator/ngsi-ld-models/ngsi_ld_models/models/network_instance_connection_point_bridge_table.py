...
class NetworkInstanceConnectionPointBridgeTable(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointBridgeTable.")
    ...
    discard_unknown_src_mac: Optional[NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac] = Field(default=None, alias="discardUnknownSrcMac")
    split_horizon_group: Optional[NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup] = Field(default=None, alias="splitHorizonGroup")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "discardUnknownSrcMac", "splitHorizonGroup", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointBridgeTable']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointBridgeTable')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of discard_unknown_src_mac
        if self.discard_unknown_src_mac:
            _dict['discardUnknownSrcMac'] = self.discard_unknown_src_mac.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointBridgeTable',
            ...
            "discardUnknownSrcMac": NetworkInstanceConnectionPointBridgeTableDiscardUnknownSrcMac.from_dict(obj["discardUnknownSrcMac"]) if obj.get("discardUnknownSrcMac") is not None else None,
            "splitHorizonGroup": NetworkInstanceConnectionPointBridgeTableSplitHorizonGroup.from_dict(obj["splitHorizonGroup"]) if obj.get("splitHorizonGroup") is not None else None,
