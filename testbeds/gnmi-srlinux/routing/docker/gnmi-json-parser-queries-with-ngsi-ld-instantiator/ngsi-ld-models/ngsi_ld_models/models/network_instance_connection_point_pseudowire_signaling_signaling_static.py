...
class NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic.")
    ...
    ingress_vc_label: Optional[IngressVcLabel] = Field(default=None, alias="ingressVcLabel")
    egress_vc_label: Optional[EgressVcLabel] = Field(default=None, alias="egressVcLabel")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ingressVcLabel", "egressVcLabel", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of ingress_vc_label
        if self.ingress_vc_label:
            _dict['ingressVcLabel'] = self.ingress_vc_label.to_dict()
        # override the default output from pydantic by calling `to_dict()` of egress_vc_label
        if self.egress_vc_label:
            _dict['egressVcLabel'] = self.egress_vc_label.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointPseudowireSignalingSignalingStatic',
            ...
            "ingressVcLabel": IngressVcLabel.from_dict(obj["ingressVcLabel"]) if obj.get("ingressVcLabel") is not None else None,
            "egressVcLabel": EgressVcLabel.from_dict(obj["egressVcLabel"]) if obj.get("egressVcLabel") is not None else None,
