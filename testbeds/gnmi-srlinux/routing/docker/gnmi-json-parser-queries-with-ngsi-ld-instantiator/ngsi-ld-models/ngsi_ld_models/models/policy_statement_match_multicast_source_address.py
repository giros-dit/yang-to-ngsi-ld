...
class PolicyStatementMatchMulticastSourceAddress(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchMulticastSourceAddress.")
    ...
    prefix_set: Optional[PolicyStatementMatchMulticastSourceAddressPrefixSet] = Field(default=None, alias="prefixSet")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "prefixSet", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchMulticastSourceAddress']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchMulticastSourceAddress')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchMulticastSourceAddress',
            ...
            "prefixSet": PolicyStatementMatchMulticastSourceAddressPrefixSet.from_dict(obj["prefixSet"]) if obj.get("prefixSet") is not None else None,
