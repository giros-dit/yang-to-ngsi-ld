...
class NetworkInstance(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstance.")
    ...
    networkinstance_type: Optional[NetworkInstanceType] = Field(default=None, alias="networkinstanceType")
    admin_state: Optional[NetworkInstanceAdminState] = Field(default=None, alias="adminState")
    oper_state: Optional[NetworkInstanceOperState] = Field(default=None, alias="operState")
    oper_down_reason: Optional[NetworkInstanceOperDownReason] = Field(default=None, alias="operDownReason")
    oper_mac_vrf_mtu: Optional[OperMacVrfMtu] = Field(default=None, alias="operMacVrfMtu")
    oper_vpws_mtu: Optional[OperVpwsMtu] = Field(default=None, alias="operVpwsMtu")
    description: Optional[NetworkInstanceDescription] = None
    router_id: Optional[NetworkInstanceRouterId] = Field(default=None, alias="routerId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "networkinstanceType", "adminState", "operState", "operDownReason", "operMacVrfMtu", "operVpwsMtu", "description", "routerId"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstance']):
            raise ValueError("must be one of enum values ('NetworkInstance')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of networkinstance_type
        if self.networkinstance_type:
            _dict['networkinstanceType'] = self.networkinstance_type.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of oper_mac_vrf_mtu
        if self.oper_mac_vrf_mtu:
            _dict['operMacVrfMtu'] = self.oper_mac_vrf_mtu.to_dict()
        # override the default output from pydantic by calling `to_dict()` of oper_vpws_mtu
        if self.oper_vpws_mtu:
            _dict['operVpwsMtu'] = self.oper_vpws_mtu.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstance',
            ...
            "name": NetworkInstanceName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "networkinstanceType": NetworkInstanceType.from_dict(obj["networkinstanceType"]) if obj.get("networkinstanceType") is not None else None,
            "adminState": NetworkInstanceAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "operState": NetworkInstanceOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
            "operDownReason": NetworkInstanceOperDownReason.from_dict(obj["operDownReason"]) if obj.get("operDownReason") is not None else None,
            "operMacVrfMtu": OperMacVrfMtu.from_dict(obj["operMacVrfMtu"]) if obj.get("operMacVrfMtu") is not None else None,
            "operVpwsMtu": OperVpwsMtu.from_dict(obj["operVpwsMtu"]) if obj.get("operVpwsMtu") is not None else None,
            "description": NetworkInstanceDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "routerId": NetworkInstanceRouterId.from_dict(obj["routerId"]) if obj.get("routerId") is not None else None
        })
