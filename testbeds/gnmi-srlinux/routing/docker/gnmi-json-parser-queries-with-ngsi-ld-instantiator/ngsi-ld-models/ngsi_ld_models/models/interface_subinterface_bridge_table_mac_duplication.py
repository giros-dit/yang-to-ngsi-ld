...
class InterfaceSubinterfaceBridgeTableMacDuplication(BaseModel):
    """
     YANG module: srl_nokia-interfaces.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceBridgeTableMacDuplication.")
    ...
    action: Optional[InterfaceSubinterfaceBridgeTableMacDuplicationAction] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "action", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceBridgeTableMacDuplication']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceBridgeTableMacDuplication')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceBridgeTableMacDuplication',
            ...
            "action": InterfaceSubinterfaceBridgeTableMacDuplicationAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
