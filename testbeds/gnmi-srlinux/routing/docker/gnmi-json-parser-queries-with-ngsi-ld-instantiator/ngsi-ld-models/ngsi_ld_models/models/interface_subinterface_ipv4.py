...
class InterfaceSubinterfaceIpv4(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceIpv4.")
    ...
    admin_state: Optional[InterfaceSubinterfaceIpv4AdminState] = Field(default=None, alias="adminState")
    allow_directed_broadcast: Optional[AllowDirectedBroadcast] = Field(default=None, alias="allowDirectedBroadcast")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adminState", "allowDirectedBroadcast", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceIpv4']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceIpv4')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of allow_directed_broadcast
        if self.allow_directed_broadcast:
            _dict['allowDirectedBroadcast'] = self.allow_directed_broadcast.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceIpv4',
            ...
            "adminState": InterfaceSubinterfaceIpv4AdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "allowDirectedBroadcast": AllowDirectedBroadcast.from_dict(obj["allowDirectedBroadcast"]) if obj.get("allowDirectedBroadcast") is not None else None,
