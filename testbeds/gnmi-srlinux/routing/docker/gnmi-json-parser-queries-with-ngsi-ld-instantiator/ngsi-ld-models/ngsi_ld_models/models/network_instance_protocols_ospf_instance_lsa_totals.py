...
class NetworkInstanceProtocolsOspfInstanceLsaTotals(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceLsaTotals.")
    ...
    as_external_lsa: Optional[NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa] = Field(default=None, alias="asExternalLsa")
    e_as_external_lsa: Optional[EAsExternalLsa] = Field(default=None, alias="eAsExternalLsa")
    as_opaque_lsa: Optional[AsOpaqueLsa] = Field(default=None, alias="asOpaqueLsa")
    router_info_lsa: Optional[NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa] = Field(default=None, alias="routerInfoLsa")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "asExternalLsa", "eAsExternalLsa", "asOpaqueLsa", "routerInfoLsa", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceLsaTotals']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceLsaTotals')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of as_external_lsa
        if self.as_external_lsa:
            _dict['asExternalLsa'] = self.as_external_lsa.to_dict()
        # override the default output from pydantic by calling `to_dict()` of e_as_external_lsa
        if self.e_as_external_lsa:
            _dict['eAsExternalLsa'] = self.e_as_external_lsa.to_dict()
        # override the default output from pydantic by calling `to_dict()` of as_opaque_lsa
        if self.as_opaque_lsa:
            _dict['asOpaqueLsa'] = self.as_opaque_lsa.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceLsaTotals',
            ...
            "asExternalLsa": NetworkInstanceProtocolsOspfInstanceLsaTotalsAsExternalLsa.from_dict(obj["asExternalLsa"]) if obj.get("asExternalLsa") is not None else None,
            "eAsExternalLsa": EAsExternalLsa.from_dict(obj["eAsExternalLsa"]) if obj.get("eAsExternalLsa") is not None else None,
            "asOpaqueLsa": AsOpaqueLsa.from_dict(obj["asOpaqueLsa"]) if obj.get("asOpaqueLsa") is not None else None,
            "routerInfoLsa": NetworkInstanceProtocolsOspfInstanceLsaTotalsRouterInfoLsa.from_dict(obj["routerInfoLsa"]) if obj.get("routerInfoLsa") is not None else None,
