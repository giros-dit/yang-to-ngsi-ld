...
class PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid.")
    ...
    reuse_igp: Optional[PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp] = Field(default=None, alias="reuseIgp")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "reuseIgp", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of reuse_igp
        if self.reuse_igp:
            _dict['reuseIgp'] = self.reuse_igp.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSid',
            ...
            "reuseIgp": PolicyStatementActionBgpLabelAllocationLabelAllocationMethodPrefixSidReuseIgp.from_dict(obj["reuseIgp"]) if obj.get("reuseIgp") is not None else None,
