...
class SystemLldpInterfaceLldpMedLocation(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceLldpMedLocation.")
    ...
    system_coordinates: Optional[SystemCoordinates] = Field(default=None, alias="systemCoordinates")
    elin: Optional[Elin] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "systemCoordinates", "elin", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceLldpMedLocation']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceLldpMedLocation')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of system_coordinates
        if self.system_coordinates:
            _dict['systemCoordinates'] = self.system_coordinates.to_dict()
        # override the default output from pydantic by calling `to_dict()` of elin
        if self.elin:
            _dict['elin'] = self.elin.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceLldpMedLocation',
            ...
            "systemCoordinates": SystemCoordinates.from_dict(obj["systemCoordinates"]) if obj.get("systemCoordinates") is not None else None,
            "elin": Elin.from_dict(obj["elin"]) if obj.get("elin") is not None else None,
