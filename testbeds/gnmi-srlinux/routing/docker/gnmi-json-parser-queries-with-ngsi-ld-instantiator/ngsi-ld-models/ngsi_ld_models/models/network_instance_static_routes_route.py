...
class NetworkInstanceStaticRoutesRoute(BaseModel):
    """
     YANG module: srl_nokia-static-routes.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceStaticRoutesRoute.")
    ...
    prefix: Optional[NetworkInstanceStaticRoutesRoutePrefix] = None
    admin_state: Optional[NetworkInstanceStaticRoutesRouteAdminState] = Field(default=None, alias="adminState")
    metric: Optional[NetworkInstanceStaticRoutesRouteMetric] = None
    preference: Optional[NetworkInstanceStaticRoutesRoutePreference] = None
    next_hop_group: Optional[NetworkInstanceStaticRoutesRouteNextHopGroup] = Field(default=None, alias="nextHopGroup")
    tag_set: Optional[NetworkInstanceStaticRoutesRouteTagSet] = Field(default=None, alias="tagSet")
    tag_value: Optional[NetworkInstanceStaticRoutesRouteTagValue] = Field(default=None, alias="tagValue")
    installed: Optional[Installed] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "prefix", "adminState", "metric", "preference", "nextHopGroup", "tagSet", "tagValue", "installed", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceStaticRoutesRoute']):
            raise ValueError("must be one of enum values ('NetworkInstanceStaticRoutesRoute')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of tag_set
        if self.tag_set:
            _dict['tagSet'] = self.tag_set.to_dict()
        # override the default output from pydantic by calling `to_dict()` of tag_value
        if self.tag_value:
            _dict['tagValue'] = self.tag_value.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceStaticRoutesRoute',
            ...
            "prefix": NetworkInstanceStaticRoutesRoutePrefix.from_dict(obj["prefix"]) if obj.get("prefix") is not None else None,
            "adminState": NetworkInstanceStaticRoutesRouteAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "metric": NetworkInstanceStaticRoutesRouteMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "preference": NetworkInstanceStaticRoutesRoutePreference.from_dict(obj["preference"]) if obj.get("preference") is not None else None,
            "nextHopGroup": NetworkInstanceStaticRoutesRouteNextHopGroup.from_dict(obj["nextHopGroup"]) if obj.get("nextHopGroup") is not None else None,
            "tagSet": NetworkInstanceStaticRoutesRouteTagSet.from_dict(obj["tagSet"]) if obj.get("tagSet") is not None else None,
            "tagValue": NetworkInstanceStaticRoutesRouteTagValue.from_dict(obj["tagValue"]) if obj.get("tagValue") is not None else None,
            "installed": Installed.from_dict(obj["installed"]) if obj.get("installed") is not None else None,
