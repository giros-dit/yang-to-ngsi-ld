...
class StandardCommunitySet(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be StandardCommunitySet.")
    ...
    name: StandardCommunitySetName
    member: Optional[StandardCommunitySetMember] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "member"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['StandardCommunitySet']):
            raise ValueError("must be one of enum values ('StandardCommunitySet')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'StandardCommunitySet',
            ...
            "name": StandardCommunitySetName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "member": StandardCommunitySetMember.from_dict(obj["member"]) if obj.get("member") is not None else None
        })
