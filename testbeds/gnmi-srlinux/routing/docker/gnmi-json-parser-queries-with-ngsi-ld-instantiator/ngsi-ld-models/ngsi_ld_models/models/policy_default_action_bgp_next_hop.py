...
class PolicyDefaultActionBgpNextHop(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpNextHop.")
    ...
    set: Optional[PolicyDefaultActionBgpNextHopSet] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpNextHop']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpNextHop')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpNextHop',
            ...
            "set": PolicyDefaultActionBgpNextHopSet.from_dict(obj["set"]) if obj.get("set") is not None else None,
