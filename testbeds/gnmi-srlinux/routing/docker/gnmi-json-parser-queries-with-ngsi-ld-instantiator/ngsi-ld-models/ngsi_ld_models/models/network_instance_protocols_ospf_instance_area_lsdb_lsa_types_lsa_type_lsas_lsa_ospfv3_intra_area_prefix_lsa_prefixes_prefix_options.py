...
class NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3IntraAreaPrefixLsaPrefixesPrefixOptions(BaseModel):
    """
    Prefix options.  YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3IntraAreaPrefixLsaPrefixesPrefixOptions.")
    ...
    prefix_options: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3IntraAreaPrefixLsaPrefixesPrefixOptionsPrefixOptions] = Field(default=None, alias="prefixOptions")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "prefixOptions", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3IntraAreaPrefixLsaPrefixesPrefixOptions']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3IntraAreaPrefixLsaPrefixesPrefixOptions')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of prefix_options
        if self.prefix_options:
            _dict['prefixOptions'] = self.prefix_options.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3IntraAreaPrefixLsaPrefixesPrefixOptions',
            ...
            "prefixOptions": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3IntraAreaPrefixLsaPrefixesPrefixOptionsPrefixOptions.from_dict(obj["prefixOptions"]) if obj.get("prefixOptions") is not None else None,
