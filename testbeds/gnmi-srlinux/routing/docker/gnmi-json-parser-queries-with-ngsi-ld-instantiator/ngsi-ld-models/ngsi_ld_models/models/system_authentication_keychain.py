...
class SystemAuthenticationKeychain(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemAuthenticationKeychain.")
    ...
    name: Optional[SystemAuthenticationKeychainName] = None
    admin_state: Optional[SystemAuthenticationKeychainAdminState] = Field(default=None, alias="adminState")
    description: Optional[SystemAuthenticationKeychainDescription] = None
    tolerance: Optional[Tolerance] = None
    keychain_type: Optional[SystemAuthenticationKeychainType] = Field(default=None, alias="keychainType")
    usable: Optional[SystemAuthenticationKeychainUsable] = None
    expired: Optional[Expired] = None
    active_key_for_send: Optional[ActiveKeyForSend] = Field(default=None, alias="activeKeyForSend")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "adminState", "description", "tolerance", "keychainType", "usable", "expired", "activeKeyForSend", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemAuthenticationKeychain']):
            raise ValueError("must be one of enum values ('SystemAuthenticationKeychain')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of keychain_type
        if self.keychain_type:
            _dict['keychainType'] = self.keychain_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of usable
        if self.usable:
            _dict['usable'] = self.usable.to_dict()
        # override the default output from pydantic by calling `to_dict()` of expired
        if self.expired:
            _dict['expired'] = self.expired.to_dict()
        # override the default output from pydantic by calling `to_dict()` of active_key_for_send
        if self.active_key_for_send:
            _dict['activeKeyForSend'] = self.active_key_for_send.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemAuthenticationKeychain',
            ...
            "name": SystemAuthenticationKeychainName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "adminState": SystemAuthenticationKeychainAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "description": SystemAuthenticationKeychainDescription.from_dict(obj["description"]) if obj.get("description") is not None else None,
            "tolerance": Tolerance.from_dict(obj["tolerance"]) if obj.get("tolerance") is not None else None,
            "keychainType": SystemAuthenticationKeychainType.from_dict(obj["keychainType"]) if obj.get("keychainType") is not None else None,
            "usable": SystemAuthenticationKeychainUsable.from_dict(obj["usable"]) if obj.get("usable") is not None else None,
            "expired": Expired.from_dict(obj["expired"]) if obj.get("expired") is not None else None,
            "activeKeyForSend": ActiveKeyForSend.from_dict(obj["activeKeyForSend"]) if obj.get("activeKeyForSend") is not None else None,
