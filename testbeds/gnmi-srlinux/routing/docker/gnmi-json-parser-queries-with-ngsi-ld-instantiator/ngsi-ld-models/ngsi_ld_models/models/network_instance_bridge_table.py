...
class NetworkInstanceBridgeTable(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceBridgeTable.")
    ...
    discard_unknown_dest_mac: Optional[DiscardUnknownDestMac] = Field(default=None, alias="discardUnknownDestMac")
    protect_anycast_gw_mac: Optional[ProtectAnycastGwMac] = Field(default=None, alias="protectAnycastGwMac")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "discardUnknownDestMac", "protectAnycastGwMac", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceBridgeTable']):
            raise ValueError("must be one of enum values ('NetworkInstanceBridgeTable')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of discard_unknown_dest_mac
        if self.discard_unknown_dest_mac:
            _dict['discardUnknownDestMac'] = self.discard_unknown_dest_mac.to_dict()
        # override the default output from pydantic by calling `to_dict()` of protect_anycast_gw_mac
        if self.protect_anycast_gw_mac:
            _dict['protectAnycastGwMac'] = self.protect_anycast_gw_mac.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceBridgeTable',
            ...
            "discardUnknownDestMac": DiscardUnknownDestMac.from_dict(obj["discardUnknownDestMac"]) if obj.get("discardUnknownDestMac") is not None else None,
            "protectAnycastGwMac": ProtectAnycastGwMac.from_dict(obj["protectAnycastGwMac"]) if obj.get("protectAnycastGwMac") is not None else None,
