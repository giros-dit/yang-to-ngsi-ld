...
class NetworkInstanceRouteTableNextHopGroupBackupNextHopResolved(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['true', 'false', 'not-applicable']):
            raise ValueError("must be one of enum values ('true', 'false', 'not-applicable')")
        return value
