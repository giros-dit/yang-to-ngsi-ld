...
class NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLink(BaseModel):
    """
    Router LSA link.  YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLink.")
    ...
    interface_id: Optional[InterfaceId] = Field(default=None, alias="interfaceId")
    neighbor_interface_id: Optional[NeighborInterfaceId] = Field(default=None, alias="neighborInterfaceId")
    neighbor_router_id: Optional[NeighborRouterId] = Field(default=None, alias="neighborRouterId")
    link_type: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLinkType] = Field(default=None, alias="linkType")
    metric: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLinkMetric] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "interfaceId", "neighborInterfaceId", "neighborRouterId", "linkType", "metric", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLink']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLink')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of interface_id
        if self.interface_id:
            _dict['interfaceId'] = self.interface_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of neighbor_interface_id
        if self.neighbor_interface_id:
            _dict['neighborInterfaceId'] = self.neighbor_interface_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of neighbor_router_id
        if self.neighbor_router_id:
            _dict['neighborRouterId'] = self.neighbor_router_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLink',
            ...
            "interfaceId": InterfaceId.from_dict(obj["interfaceId"]) if obj.get("interfaceId") is not None else None,
            "neighborInterfaceId": NeighborInterfaceId.from_dict(obj["neighborInterfaceId"]) if obj.get("neighborInterfaceId") is not None else None,
            "neighborRouterId": NeighborRouterId.from_dict(obj["neighborRouterId"]) if obj.get("neighborRouterId") is not None else None,
            "linkType": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLinkType.from_dict(obj["linkType"]) if obj.get("linkType") is not None else None,
            "metric": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLinkMetric.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
