...
class GeometryPolygon(BaseModel):
    ...
    coordinates: Optional[GeometryPolygon] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "coordinates": GeometryPolygon.from_dict(obj["coordinates"]) if obj.get("coordinates") is not None else None
        })
...
GeometryPolygon.model_rebuild(raise_errors=False)
