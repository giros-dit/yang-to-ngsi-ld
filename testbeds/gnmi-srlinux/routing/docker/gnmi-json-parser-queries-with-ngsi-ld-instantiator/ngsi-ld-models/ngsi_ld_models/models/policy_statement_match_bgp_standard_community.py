...
class PolicyStatementMatchBgpStandardCommunity(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchBgpStandardCommunity.")
    ...
    standard_community_set: Optional[PolicyStatementMatchBgpStandardCommunityStandardCommunitySet] = Field(default=None, alias="standardCommunitySet")
    match_set_options: Optional[PolicyStatementMatchBgpStandardCommunityMatchSetOptions] = Field(default=None, alias="matchSetOptions")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "standardCommunitySet", "matchSetOptions", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchBgpStandardCommunity']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchBgpStandardCommunity')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of standard_community_set
        if self.standard_community_set:
            _dict['standardCommunitySet'] = self.standard_community_set.to_dict()
        # override the default output from pydantic by calling `to_dict()` of match_set_options
        if self.match_set_options:
            _dict['matchSetOptions'] = self.match_set_options.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchBgpStandardCommunity',
            ...
            "standardCommunitySet": PolicyStatementMatchBgpStandardCommunityStandardCommunitySet.from_dict(obj["standardCommunitySet"]) if obj.get("standardCommunitySet") is not None else None,
            "matchSetOptions": PolicyStatementMatchBgpStandardCommunityMatchSetOptions.from_dict(obj["matchSetOptions"]) if obj.get("matchSetOptions") is not None else None,
