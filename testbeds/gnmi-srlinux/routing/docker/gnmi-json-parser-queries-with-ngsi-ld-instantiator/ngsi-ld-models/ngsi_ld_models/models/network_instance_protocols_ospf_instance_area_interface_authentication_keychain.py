...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceAuthenticationKeychain(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type Keychain.")
