...
class SystemLldpInterfaceNeighborCapability(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemLldpInterfaceNeighborCapability.")
    ...
    name: Optional[SystemLldpInterfaceNeighborCapabilityName] = None
    enabled: Optional[SystemLldpInterfaceNeighborCapabilityEnabled] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "enabled", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemLldpInterfaceNeighborCapability']):
            raise ValueError("must be one of enum values ('SystemLldpInterfaceNeighborCapability')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemLldpInterfaceNeighborCapability',
            ...
            "name": SystemLldpInterfaceNeighborCapabilityName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "enabled": SystemLldpInterfaceNeighborCapabilityEnabled.from_dict(obj["enabled"]) if obj.get("enabled") is not None else None,
