...
class NetworkInstanceConnectionPoint(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPoint.")
    ...
    name: Optional[NetworkInstanceConnectionPointName] = None
    oper_state: Optional[NetworkInstanceConnectionPointOperState] = Field(default=None, alias="operState")
    oper_down_reason: Optional[NetworkInstanceConnectionPointOperDownReason] = Field(default=None, alias="operDownReason")
    index: Optional[NetworkInstanceConnectionPointIndex] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "operState", "operDownReason", "index", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPoint']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPoint')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPoint',
            ...
            "name": NetworkInstanceConnectionPointName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "operState": NetworkInstanceConnectionPointOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
            "operDownReason": NetworkInstanceConnectionPointOperDownReason.from_dict(obj["operDownReason"]) if obj.get("operDownReason") is not None else None,
            "index": NetworkInstanceConnectionPointIndex.from_dict(obj["index"]) if obj.get("index") is not None else None,
