...
class PolicyStatementMatchBgpSrv6(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchBgpSrv6.")
    ...
    sid_prefix: Optional[SidPrefix] = Field(default=None, alias="sidPrefix")
    tlv: Optional[PolicyStatementMatchBgpSrv6Tlv] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "sidPrefix", "tlv", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchBgpSrv6']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchBgpSrv6')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of sid_prefix
        if self.sid_prefix:
            _dict['sidPrefix'] = self.sid_prefix.to_dict()
        # override the default output from pydantic by calling `to_dict()` of tlv
        if self.tlv:
            _dict['tlv'] = self.tlv.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchBgpSrv6',
            ...
            "sidPrefix": SidPrefix.from_dict(obj["sidPrefix"]) if obj.get("sidPrefix") is not None else None,
            "tlv": PolicyStatementMatchBgpSrv6Tlv.from_dict(obj["tlv"]) if obj.get("tlv") is not None else None,
