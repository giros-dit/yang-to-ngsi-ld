...
class PolicyStatementActionBgpCommunities(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpCommunities.")
    ...
    add: Optional[PolicyStatementActionBgpCommunitiesAdd] = None
    remove: Optional[PolicyStatementActionBgpCommunitiesRemove] = None
    replace: Optional[PolicyStatementActionBgpCommunitiesReplace] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "add", "remove", "replace", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpCommunities']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpCommunities')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpCommunities',
            ...
            "add": PolicyStatementActionBgpCommunitiesAdd.from_dict(obj["add"]) if obj.get("add") is not None else None,
            "remove": PolicyStatementActionBgpCommunitiesRemove.from_dict(obj["remove"]) if obj.get("remove") is not None else None,
            "replace": PolicyStatementActionBgpCommunitiesReplace.from_dict(obj["replace"]) if obj.get("replace") is not None else None,
