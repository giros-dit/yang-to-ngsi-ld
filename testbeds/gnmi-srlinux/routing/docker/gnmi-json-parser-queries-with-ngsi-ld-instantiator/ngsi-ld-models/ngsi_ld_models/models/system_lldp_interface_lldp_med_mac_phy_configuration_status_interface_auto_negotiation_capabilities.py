...
class SystemLldpInterfaceLldpMedMacPhyConfigurationStatusInterfaceAutoNegotiationCapabilities(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['other', '10baseT', '10baseTFD', '100baseT4', '100baseTX', '100baseTXFD', '100baseT2', '100baseT2FD', 'FdxPause', 'FdxAPause', 'FdxSPause', 'FdxBPause', '1000baseX', '1000baseXFD', '1000baseT', '1000baseTFD']):
            raise ValueError("must be one of enum values ('other', '10baseT', '10baseTFD', '100baseT4', '100baseTX', '100baseTXFD', '100baseT2', '100baseT2FD', 'FdxPause', 'FdxAPause', 'FdxSPause', 'FdxBPause', '1000baseX', '1000baseXFD', '1000baseT', '1000baseTFD')")
        return value
