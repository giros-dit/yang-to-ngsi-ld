...
class PolicyDefaultActionBgpNextHopResolution(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpNextHopResolution.")
    ...
    set_tag_set: Optional[PolicyDefaultActionBgpNextHopResolutionSetTagSet] = Field(default=None, alias="setTagSet")
    set_flex_algo: Optional[PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo] = Field(default=None, alias="setFlexAlgo")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpNextHopResolution']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpNextHopResolution')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpNextHopResolution',
            ...
            "setTagSet": PolicyDefaultActionBgpNextHopResolutionSetTagSet.from_dict(obj["setTagSet"]) if obj.get("setTagSet") is not None else None,
            "setFlexAlgo": PolicyDefaultActionBgpNextHopResolutionSetFlexAlgo.from_dict(obj["setFlexAlgo"]) if obj.get("setFlexAlgo") is not None else None,
