...
class NetworkInstanceRouteTableNextHopRedirect(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopRedirect.")
    ...
    network_instance: Optional[NetworkInstanceRouteTableNextHopRedirectNetworkInstance] = Field(default=None, alias="networkInstance")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "networkInstance", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopRedirect']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopRedirect')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopRedirect',
            ...
            "networkInstance": NetworkInstanceRouteTableNextHopRedirectNetworkInstance.from_dict(obj["networkInstance"]) if obj.get("networkInstance") is not None else None,
