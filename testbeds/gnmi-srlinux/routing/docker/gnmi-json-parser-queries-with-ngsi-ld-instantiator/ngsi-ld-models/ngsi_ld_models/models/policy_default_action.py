...
class PolicyDefaultAction(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultAction.")
    ...
    policy_result: Optional[PolicyDefaultActionPolicyResult] = Field(default=None, alias="policyResult")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultAction']):
            raise ValueError("must be one of enum values ('PolicyDefaultAction')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultAction',
            ...
            "policyResult": PolicyDefaultActionPolicyResult.from_dict(obj["policyResult"]) if obj.get("policyResult") is not None else None,
