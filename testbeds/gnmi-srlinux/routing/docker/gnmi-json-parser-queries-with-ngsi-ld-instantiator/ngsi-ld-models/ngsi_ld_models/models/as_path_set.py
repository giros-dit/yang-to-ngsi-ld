...
class AsPathSet(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be AsPathSet.")
    ...
    name: AsPathSetName
    regex_mode: Optional[RegexMode] = Field(default=None, alias="regexMode")
    as_path_set_member: Optional[AsPathSetMember] = Field(default=None, alias="asPathSetMember")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "regexMode", "asPathSetMember"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['AsPathSet']):
            raise ValueError("must be one of enum values ('AsPathSet')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of regex_mode
        if self.regex_mode:
            _dict['regexMode'] = self.regex_mode.to_dict()
        # override the default output from pydantic by calling `to_dict()` of as_path_set_member
        if self.as_path_set_member:
            _dict['asPathSetMember'] = self.as_path_set_member.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'AsPathSet',
            ...
            "name": AsPathSetName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "regexMode": RegexMode.from_dict(obj["regexMode"]) if obj.get("regexMode") is not None else None,
            "asPathSetMember": AsPathSetMember.from_dict(obj["asPathSetMember"]) if obj.get("asPathSetMember") is not None else None
        })
