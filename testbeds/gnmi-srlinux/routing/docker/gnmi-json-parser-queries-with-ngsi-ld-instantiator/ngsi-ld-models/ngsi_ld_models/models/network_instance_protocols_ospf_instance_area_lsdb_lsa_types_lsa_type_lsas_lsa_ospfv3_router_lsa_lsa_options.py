...
class NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLsaOptions(BaseModel):
    """
    OSPFv3 LSA options.  YANG module: srl_nokia-ospf.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLsaOptions.")
    ...
    lsa_options: Optional[NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLsaOptionsLsaOptions] = Field(default=None, alias="lsaOptions")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLsaOptions']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLsaOptions')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLsaOptions',
            ...
            "lsaOptions": NetworkInstanceProtocolsOspfInstanceAreaLsdbLsaTypesLsaTypeLsasLsaOspfv3RouterLsaLsaOptionsLsaOptions.from_dict(obj["lsaOptions"]) if obj.get("lsaOptions") is not None else None,
