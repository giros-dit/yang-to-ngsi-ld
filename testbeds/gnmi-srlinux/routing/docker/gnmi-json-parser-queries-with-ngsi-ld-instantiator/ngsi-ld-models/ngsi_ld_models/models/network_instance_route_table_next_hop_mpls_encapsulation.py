...
class NetworkInstanceRouteTableNextHopMplsEncapsulation(BaseModel):
    """
     YANG module: srl_nokia-ip-route-tables.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableNextHopMplsEncapsulation.")
    ...
    pushed_mpls_label_stack: Optional[NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack] = Field(default=None, alias="pushedMplsLabelStack")
    entropy_label_transmit: Optional[EntropyLabelTransmit] = Field(default=None, alias="entropyLabelTransmit")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "pushedMplsLabelStack", "entropyLabelTransmit", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableNextHopMplsEncapsulation']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableNextHopMplsEncapsulation')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of entropy_label_transmit
        if self.entropy_label_transmit:
            _dict['entropyLabelTransmit'] = self.entropy_label_transmit.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableNextHopMplsEncapsulation',
            ...
            "pushedMplsLabelStack": NetworkInstanceRouteTableNextHopMplsEncapsulationPushedMplsLabelStack.from_dict(obj["pushedMplsLabelStack"]) if obj.get("pushedMplsLabelStack") is not None else None,
            "entropyLabelTransmit": EntropyLabelTransmit.from_dict(obj["entropyLabelTransmit"]) if obj.get("entropyLabelTransmit") is not None else None,
