...
class PolicyDefaultActionIsis(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionIsis.")
    ...
    level: Optional[PolicyDefaultActionIsisLevel] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionIsis']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionIsis')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionIsis',
            ...
            "level": PolicyDefaultActionIsisLevel.from_dict(obj["level"]) if obj.get("level") is not None else None,
