...
class PolicyDefaultActionOspfMetric(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionOspfMetric.")
    ...
    set_external_type: Optional[PolicyDefaultActionOspfMetricSetExternalType] = Field(default=None, alias="setExternalType")
    set_value: Optional[PolicyDefaultActionOspfMetricSetValue] = Field(default=None, alias="setValue")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionOspfMetric']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionOspfMetric')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionOspfMetric',
            ...
            "setExternalType": PolicyDefaultActionOspfMetricSetExternalType.from_dict(obj["setExternalType"]) if obj.get("setExternalType") is not None else None,
            "setValue": PolicyDefaultActionOspfMetricSetValue.from_dict(obj["setValue"]) if obj.get("setValue") is not None else None,
