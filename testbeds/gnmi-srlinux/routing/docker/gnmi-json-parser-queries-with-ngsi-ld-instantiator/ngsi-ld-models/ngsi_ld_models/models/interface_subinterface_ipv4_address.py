...
class InterfaceSubinterfaceIpv4Address(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceIpv4Address.")
    ...
    ip_prefix: Optional[InterfaceSubinterfaceIpv4AddressIpPrefix] = Field(default=None, alias="ipPrefix")
    anycast_gw: Optional[InterfaceSubinterfaceIpv4AddressAnycastGw] = Field(default=None, alias="anycastGw")
    origin: Optional[InterfaceSubinterfaceIpv4AddressOrigin] = None
    primary: Optional[InterfaceSubinterfaceIpv4AddressPrimary] = None
    status: Optional[InterfaceSubinterfaceIpv4AddressStatus] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipPrefix", "anycastGw", "origin", "primary", "status", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceIpv4Address']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceIpv4Address')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceIpv4Address',
            ...
            "ipPrefix": InterfaceSubinterfaceIpv4AddressIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
            "anycastGw": InterfaceSubinterfaceIpv4AddressAnycastGw.from_dict(obj["anycastGw"]) if obj.get("anycastGw") is not None else None,
            "origin": InterfaceSubinterfaceIpv4AddressOrigin.from_dict(obj["origin"]) if obj.get("origin") is not None else None,
            "primary": InterfaceSubinterfaceIpv4AddressPrimary.from_dict(obj["primary"]) if obj.get("primary") is not None else None,
            "status": InterfaceSubinterfaceIpv4AddressStatus.from_dict(obj["status"]) if obj.get("status") is not None else None,
