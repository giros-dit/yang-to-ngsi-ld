...
class NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlv(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlv.")
    ...
    unknowntlv_type: Optional[NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlvType] = Field(default=None, alias="unknowntlvType")
    length: Optional[NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlvLength] = None
    value: Optional[NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlvValue] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlv']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlv')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlv',
            ...
            "unknowntlvType": NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlvType.from_dict(obj["unknowntlvType"]) if obj.get("unknowntlvType") is not None else None,
            "length": NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlvLength.from_dict(obj["length"]) if obj.get("length") is not None else None,
            "value": NetworkInstanceProtocolsOspfInstanceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaRouterInformationTlvsTlvUnknownTlvValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
