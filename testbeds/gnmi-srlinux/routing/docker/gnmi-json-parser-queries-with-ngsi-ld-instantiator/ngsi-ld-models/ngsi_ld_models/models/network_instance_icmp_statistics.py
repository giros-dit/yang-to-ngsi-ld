...
class NetworkInstanceIcmpStatistics(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceIcmpStatistics.")
    ...
    last_clear: Optional[NetworkInstanceIcmpStatisticsLastClear] = Field(default=None, alias="lastClear")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "lastClear", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceIcmpStatistics']):
            raise ValueError("must be one of enum values ('NetworkInstanceIcmpStatistics')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceIcmpStatistics',
            ...
            "lastClear": NetworkInstanceIcmpStatisticsLastClear.from_dict(obj["lastClear"]) if obj.get("lastClear") is not None else None,
