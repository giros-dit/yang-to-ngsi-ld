...
class InterfaceSubinterfaceOperDownReason(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['admin-disabled', 'port-down', 'ip-mtu-resource-exceeded', 'mpls-mtu-resource-exceeded', 'ip-mtu-too-large', 'mpls-mtu-too-large', 'l2-mtu-too-large', 'no-ip-config', 'ip-mtu-larger-than-oper-mac-vrf-mtu', 'irb-mac-address-not-programmed', 'missing-xdp-state', 'no-underlay-egress-next-hop-resources', 'cfm-ccm-defect', 'no-irb-hardware-resources', 'other']):
            raise ValueError("must be one of enum values ('admin-disabled', 'port-down', 'ip-mtu-resource-exceeded', 'mpls-mtu-resource-exceeded', 'ip-mtu-too-large', 'mpls-mtu-too-large', 'l2-mtu-too-large', 'no-ip-config', 'ip-mtu-larger-than-oper-mac-vrf-mtu', 'irb-mac-address-not-programmed', 'missing-xdp-state', 'no-underlay-egress-next-hop-resources', 'cfm-ccm-defect', 'no-irb-hardware-resources', 'other')")
        return value
