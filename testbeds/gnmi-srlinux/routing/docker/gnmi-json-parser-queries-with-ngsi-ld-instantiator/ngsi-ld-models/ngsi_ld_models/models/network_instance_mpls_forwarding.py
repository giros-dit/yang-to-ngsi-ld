...
class NetworkInstanceMplsForwarding(BaseModel):
    """
     YANG module: srl_nokia-network-instance.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceMplsForwarding.")
    ...
    forward_received_packets: Optional[ForwardReceivedPackets] = Field(default=None, alias="forwardReceivedPackets")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "forwardReceivedPackets", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceMplsForwarding']):
            raise ValueError("must be one of enum values ('NetworkInstanceMplsForwarding')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of forward_received_packets
        if self.forward_received_packets:
            _dict['forwardReceivedPackets'] = self.forward_received_packets.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceMplsForwarding',
            ...
            "forwardReceivedPackets": ForwardReceivedPackets.from_dict(obj["forwardReceivedPackets"]) if obj.get("forwardReceivedPackets") is not None else None,
