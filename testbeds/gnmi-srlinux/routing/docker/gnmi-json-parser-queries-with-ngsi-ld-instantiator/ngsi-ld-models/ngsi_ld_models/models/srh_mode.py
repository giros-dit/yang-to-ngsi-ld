...
class SrhMode(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['psp', 'usp', 'psp-usd', 'usp-usd', 'psp-usp-usd']):
            raise ValueError("must be one of enum values ('psp', 'usp', 'psp-usd', 'usp-usd', 'psp-usp-usd')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value") if obj.get("value") is not None else 'psp',
