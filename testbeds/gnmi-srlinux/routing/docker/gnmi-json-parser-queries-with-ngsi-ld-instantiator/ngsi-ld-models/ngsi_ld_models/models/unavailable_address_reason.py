...
class UnavailableAddressReason(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['not-same-network-instance', 'referenced-interface-is-down', 'referenced-interface-ipv4-is-down', 'referenced-interface-has-no-ipv4-addresses']):
            raise ValueError("must be one of enum values ('not-same-network-instance', 'referenced-interface-is-down', 'referenced-interface-ipv4-is-down', 'referenced-interface-has-no-ipv4-addresses')")
        return value
