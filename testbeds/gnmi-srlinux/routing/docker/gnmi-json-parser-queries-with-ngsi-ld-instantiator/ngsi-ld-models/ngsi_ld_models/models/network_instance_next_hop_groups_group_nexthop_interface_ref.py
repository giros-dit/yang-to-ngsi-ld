...
class NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef.")
    ...
    interface: Optional[NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface] = None
    subinterface: Optional[NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef']):
            raise ValueError("must be one of enum values ('NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceNextHopGroupsGroupNexthopInterfaceRef',
            ...
            "interface": NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefInterface.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
            "subinterface": NetworkInstanceNextHopGroupsGroupNexthopInterfaceRefSubinterface.from_dict(obj["subinterface"]) if obj.get("subinterface") is not None else None,
