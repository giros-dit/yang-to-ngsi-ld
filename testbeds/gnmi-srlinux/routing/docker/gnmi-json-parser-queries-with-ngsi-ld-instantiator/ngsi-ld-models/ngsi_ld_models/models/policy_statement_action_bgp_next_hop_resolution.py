...
class PolicyStatementActionBgpNextHopResolution(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementActionBgpNextHopResolution.")
    ...
    set_tag_set: Optional[PolicyStatementActionBgpNextHopResolutionSetTagSet] = Field(default=None, alias="setTagSet")
    set_flex_algo: Optional[PolicyStatementActionBgpNextHopResolutionSetFlexAlgo] = Field(default=None, alias="setFlexAlgo")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "setTagSet", "setFlexAlgo", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementActionBgpNextHopResolution']):
            raise ValueError("must be one of enum values ('PolicyStatementActionBgpNextHopResolution')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of set_tag_set
        if self.set_tag_set:
            _dict['setTagSet'] = self.set_tag_set.to_dict()
        # override the default output from pydantic by calling `to_dict()` of set_flex_algo
        if self.set_flex_algo:
            _dict['setFlexAlgo'] = self.set_flex_algo.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementActionBgpNextHopResolution',
            ...
            "setTagSet": PolicyStatementActionBgpNextHopResolutionSetTagSet.from_dict(obj["setTagSet"]) if obj.get("setTagSet") is not None else None,
            "setFlexAlgo": PolicyStatementActionBgpNextHopResolutionSetFlexAlgo.from_dict(obj["setFlexAlgo"]) if obj.get("setFlexAlgo") is not None else None,
