...
class LinecardForwardingComplexLoadBalancingHashUser(BaseModel):
    """
     YANG module: srl_nokia-platform-lc.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplexLoadBalancingHashUser.")
    ...
    hash_polynomial: Optional[HashPolynomial] = Field(default=None, alias="hashPolynomial")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "user", "hashPolynomial", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplexLoadBalancingHashUser']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplexLoadBalancingHashUser')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of hash_polynomial
        if self.hash_polynomial:
            _dict['hashPolynomial'] = self.hash_polynomial.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplexLoadBalancingHashUser',
            ...
            "hashPolynomial": HashPolynomial.from_dict(obj["hashPolynomial"]) if obj.get("hashPolynomial") is not None else None,
