...
class NetworkInstanceTrafficEngineering(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceTrafficEngineering.")
    ...
    autonomous_system: Optional[AutonomousSystem] = Field(default=None, alias="autonomousSystem")
    ipv4_te_router_id: Optional[Ipv4TeRouterId] = Field(default=None, alias="ipv4TeRouterId")
    ipv6_te_router_id: Optional[Ipv6TeRouterId] = Field(default=None, alias="ipv6TeRouterId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "autonomousSystem", "ipv4TeRouterId", "ipv6TeRouterId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceTrafficEngineering']):
            raise ValueError("must be one of enum values ('NetworkInstanceTrafficEngineering')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of autonomous_system
        if self.autonomous_system:
            _dict['autonomousSystem'] = self.autonomous_system.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ipv4_te_router_id
        if self.ipv4_te_router_id:
            _dict['ipv4TeRouterId'] = self.ipv4_te_router_id.to_dict()
        # override the default output from pydantic by calling `to_dict()` of ipv6_te_router_id
        if self.ipv6_te_router_id:
            _dict['ipv6TeRouterId'] = self.ipv6_te_router_id.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceTrafficEngineering',
            ...
            "autonomousSystem": AutonomousSystem.from_dict(obj["autonomousSystem"]) if obj.get("autonomousSystem") is not None else None,
            "ipv4TeRouterId": Ipv4TeRouterId.from_dict(obj["ipv4TeRouterId"]) if obj.get("ipv4TeRouterId") is not None else None,
            "ipv6TeRouterId": Ipv6TeRouterId.from_dict(obj["ipv6TeRouterId"]) if obj.get("ipv6TeRouterId") is not None else None,
