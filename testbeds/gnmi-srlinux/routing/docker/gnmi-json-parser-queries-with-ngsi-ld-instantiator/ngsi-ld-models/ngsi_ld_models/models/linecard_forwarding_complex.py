...
class LinecardForwardingComplex(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardForwardingComplex.")
    ...
    name: Optional[LinecardForwardingComplexName] = None
    interfaces: Optional[LinecardForwardingComplexInterfaces] = None
    oper_state: Optional[LinecardForwardingComplexOperState] = Field(default=None, alias="operState")
    last_booted: Optional[LinecardForwardingComplexLastBooted] = Field(default=None, alias="lastBooted")
    last_booted_reason: Optional[LinecardForwardingComplexLastBootedReason] = Field(default=None, alias="lastBootedReason")
    last_change: Optional[LinecardForwardingComplexLastChange] = Field(default=None, alias="lastChange")
    part_number: Optional[LinecardForwardingComplexPartNumber] = Field(default=None, alias="partNumber")
    removable: Optional[LinecardForwardingComplexRemovable] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "name", "interfaces", "operState", "lastBooted", "lastBootedReason", "lastChange", "partNumber", "removable", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['LinecardForwardingComplex']):
            raise ValueError("must be one of enum values ('LinecardForwardingComplex')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardForwardingComplex',
            ...
            "name": LinecardForwardingComplexName.from_dict(obj["name"]) if obj.get("name") is not None else None,
            "interfaces": LinecardForwardingComplexInterfaces.from_dict(obj["interfaces"]) if obj.get("interfaces") is not None else None,
            "operState": LinecardForwardingComplexOperState.from_dict(obj["operState"]) if obj.get("operState") is not None else None,
            "lastBooted": LinecardForwardingComplexLastBooted.from_dict(obj["lastBooted"]) if obj.get("lastBooted") is not None else None,
            "lastBootedReason": LinecardForwardingComplexLastBootedReason.from_dict(obj["lastBootedReason"]) if obj.get("lastBootedReason") is not None else None,
            "lastChange": LinecardForwardingComplexLastChange.from_dict(obj["lastChange"]) if obj.get("lastChange") is not None else None,
            "partNumber": LinecardForwardingComplexPartNumber.from_dict(obj["partNumber"]) if obj.get("partNumber") is not None else None,
            "removable": LinecardForwardingComplexRemovable.from_dict(obj["removable"]) if obj.get("removable") is not None else None,
