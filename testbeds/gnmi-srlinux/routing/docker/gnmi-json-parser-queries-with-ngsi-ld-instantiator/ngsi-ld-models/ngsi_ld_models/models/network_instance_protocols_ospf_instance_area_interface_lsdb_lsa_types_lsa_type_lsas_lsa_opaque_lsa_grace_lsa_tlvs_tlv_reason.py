...
class NetworkInstanceProtocolsOspfInstanceAreaInterfaceLsdbLsaTypesLsaTypeLsasLsaOpaqueLsaGraceLsaTlvsTlvReason(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['UNKNOWN', 'SOFTWARE_RESTART', 'SOFTWARE_RELOAD_UPGRADE', 'CONTROL_PROCESSOR_SWITCH']):
            raise ValueError("must be one of enum values ('UNKNOWN', 'SOFTWARE_RESTART', 'SOFTWARE_RELOAD_UPGRADE', 'CONTROL_PROCESSOR_SWITCH')")
        return value
