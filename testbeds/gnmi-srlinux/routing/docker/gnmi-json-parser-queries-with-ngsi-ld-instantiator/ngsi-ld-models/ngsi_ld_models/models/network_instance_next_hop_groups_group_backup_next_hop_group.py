...
class NetworkInstanceNextHopGroupsGroupBackupNextHopGroup(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type NetworkInstanceNextHopGroupsGroup.")
