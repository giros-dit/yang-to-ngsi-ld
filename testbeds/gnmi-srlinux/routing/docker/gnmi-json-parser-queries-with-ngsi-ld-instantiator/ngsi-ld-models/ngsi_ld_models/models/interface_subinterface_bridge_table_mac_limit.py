...
class InterfaceSubinterfaceBridgeTableMacLimit(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceBridgeTableMacLimit.")
    ...
    maximum_entries: Optional[InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries] = Field(default=None, alias="maximumEntries")
    warning_threshold_pct: Optional[InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct] = Field(default=None, alias="warningThresholdPct")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceBridgeTableMacLimit']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceBridgeTableMacLimit')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceBridgeTableMacLimit',
            ...
            "maximumEntries": InterfaceSubinterfaceBridgeTableMacLimitMaximumEntries.from_dict(obj["maximumEntries"]) if obj.get("maximumEntries") is not None else None,
            "warningThresholdPct": InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct.from_dict(obj["warningThresholdPct"]) if obj.get("warningThresholdPct") is not None else None,
