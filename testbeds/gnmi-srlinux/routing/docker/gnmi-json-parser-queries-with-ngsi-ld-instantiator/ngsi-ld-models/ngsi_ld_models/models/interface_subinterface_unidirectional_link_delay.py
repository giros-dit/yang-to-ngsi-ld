...
class InterfaceSubinterfaceUnidirectionalLinkDelay(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceUnidirectionalLinkDelay.")
    ...
    static_delay: Optional[StaticDelay] = Field(default=None, alias="staticDelay")
    last_reported_dynamic_delay: Optional[LastReportedDynamicDelay] = Field(default=None, alias="lastReportedDynamicDelay")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "staticDelay", "lastReportedDynamicDelay", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceSubinterfaceUnidirectionalLinkDelay']):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceUnidirectionalLinkDelay')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of static_delay
        if self.static_delay:
            _dict['staticDelay'] = self.static_delay.to_dict()
        # override the default output from pydantic by calling `to_dict()` of last_reported_dynamic_delay
        if self.last_reported_dynamic_delay:
            _dict['lastReportedDynamicDelay'] = self.last_reported_dynamic_delay.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceUnidirectionalLinkDelay',
            ...
            "staticDelay": StaticDelay.from_dict(obj["staticDelay"]) if obj.get("staticDelay") is not None else None,
            "lastReportedDynamicDelay": LastReportedDynamicDelay.from_dict(obj["lastReportedDynamicDelay"]) if obj.get("lastReportedDynamicDelay") is not None else None,
