...
class SystemSrv6LocatorFullSegmentStaticFunction(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6LocatorFullSegmentStaticFunction.")
    ...
    max_entries: Optional[SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries] = Field(default=None, alias="maxEntries")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "maxEntries", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6LocatorFullSegmentStaticFunction']):
            raise ValueError("must be one of enum values ('SystemSrv6LocatorFullSegmentStaticFunction')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of max_entries
        if self.max_entries:
            _dict['maxEntries'] = self.max_entries.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6LocatorFullSegmentStaticFunction',
            ...
            "maxEntries": SystemSrv6LocatorFullSegmentStaticFunctionMaxEntries.from_dict(obj["maxEntries"]) if obj.get("maxEntries") is not None else None,
