...
class NetworkInstanceNextHopGroupsGroupBlackhole(BaseModel):
    """
     YANG module: srl_nokia-next-hop-groups.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceNextHopGroupsGroupBlackhole.")
    ...
    generate_icmp: Optional[GenerateIcmp] = Field(default=None, alias="generateIcmp")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "generateIcmp", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceNextHopGroupsGroupBlackhole']):
            raise ValueError("must be one of enum values ('NetworkInstanceNextHopGroupsGroupBlackhole')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of generate_icmp
        if self.generate_icmp:
            _dict['generateIcmp'] = self.generate_icmp.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceNextHopGroupsGroupBlackhole',
            ...
            "generateIcmp": GenerateIcmp.from_dict(obj["generateIcmp"]) if obj.get("generateIcmp") is not None else None,
