...
class NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdb(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdb.")
    ...
    lsdb_type: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType] = Field(default=None, alias="lsdbType")
    router_id: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId] = Field(default=None, alias="routerId")
    link_state_id: Optional[NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId] = Field(default=None, alias="linkStateId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "lsdbType", "routerId", "linkStateId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdb']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdb')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of lsdb_type
        if self.lsdb_type:
            _dict['lsdbType'] = self.lsdb_type.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdb',
            ...
            "lsdbType": NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbType.from_dict(obj["lsdbType"]) if obj.get("lsdbType") is not None else None,
            "routerId": NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbRouterId.from_dict(obj["routerId"]) if obj.get("routerId") is not None else None,
            "linkStateId": NetworkInstanceProtocolsOspfInstanceTraceOptionsTraceLsdbLinkStateId.from_dict(obj["linkStateId"]) if obj.get("linkStateId") is not None else None,
