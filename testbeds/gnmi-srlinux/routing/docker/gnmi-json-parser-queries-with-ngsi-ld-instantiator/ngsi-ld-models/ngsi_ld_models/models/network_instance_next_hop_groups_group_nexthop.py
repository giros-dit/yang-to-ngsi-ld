...
class NetworkInstanceNextHopGroupsGroupNexthop(BaseModel):
    """
     YANG module: srl_nokia-next-hop-groups.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceNextHopGroupsGroupNexthop.")
    ...
    index: Optional[NetworkInstanceNextHopGroupsGroupNexthopIndex] = None
    ip_address: Optional[NetworkInstanceNextHopGroupsGroupNexthopIpAddress] = Field(default=None, alias="ipAddress")
    admin_state: Optional[NetworkInstanceNextHopGroupsGroupNexthopAdminState] = Field(default=None, alias="adminState")
    resolve: Optional[Resolve] = None
    pushed_mpls_label_stack: Optional[NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack] = Field(default=None, alias="pushedMplsLabelStack")
    encapsulate_header: Optional[NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader] = Field(default=None, alias="encapsulateHeader")
    algorithm: Optional[NetworkInstanceNextHopGroupsGroupNexthopAlgorithm] = None
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "index", "ipAddress", "adminState", "resolve", "pushedMplsLabelStack", "encapsulateHeader", "algorithm", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceNextHopGroupsGroupNexthop']):
            raise ValueError("must be one of enum values ('NetworkInstanceNextHopGroupsGroupNexthop')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of resolve
        if self.resolve:
            _dict['resolve'] = self.resolve.to_dict()
        # override the default output from pydantic by calling `to_dict()` of pushed_mpls_label_stack
        if self.pushed_mpls_label_stack:
            _dict['pushedMplsLabelStack'] = self.pushed_mpls_label_stack.to_dict()
        # override the default output from pydantic by calling `to_dict()` of encapsulate_header
        if self.encapsulate_header:
            _dict['encapsulateHeader'] = self.encapsulate_header.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceNextHopGroupsGroupNexthop',
            ...
            "index": NetworkInstanceNextHopGroupsGroupNexthopIndex.from_dict(obj["index"]) if obj.get("index") is not None else None,
            "ipAddress": NetworkInstanceNextHopGroupsGroupNexthopIpAddress.from_dict(obj["ipAddress"]) if obj.get("ipAddress") is not None else None,
            "adminState": NetworkInstanceNextHopGroupsGroupNexthopAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "resolve": Resolve.from_dict(obj["resolve"]) if obj.get("resolve") is not None else None,
            "pushedMplsLabelStack": NetworkInstanceNextHopGroupsGroupNexthopPushedMplsLabelStack.from_dict(obj["pushedMplsLabelStack"]) if obj.get("pushedMplsLabelStack") is not None else None,
            "encapsulateHeader": NetworkInstanceNextHopGroupsGroupNexthopEncapsulateHeader.from_dict(obj["encapsulateHeader"]) if obj.get("encapsulateHeader") is not None else None,
            "algorithm": NetworkInstanceNextHopGroupsGroupNexthopAlgorithm.from_dict(obj["algorithm"]) if obj.get("algorithm") is not None else None,
