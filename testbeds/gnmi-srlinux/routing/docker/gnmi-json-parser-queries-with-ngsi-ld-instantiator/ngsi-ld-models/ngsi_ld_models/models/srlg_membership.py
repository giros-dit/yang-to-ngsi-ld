...
class SrlgMembership(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type NetworkInstanceTrafficEngineeringSharedRiskLinkGroupsGroup.")
