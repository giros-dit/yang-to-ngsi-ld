...
class SystemAuthenticationKeychainKey(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemAuthenticationKeychainKey.")
    ...
    index: Optional[SystemAuthenticationKeychainKeyIndex] = None
    algorithm: Optional[SystemAuthenticationKeychainKeyAlgorithm] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "index", "algorithm", "authenticationKey", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemAuthenticationKeychainKey']):
            raise ValueError("must be one of enum values ('SystemAuthenticationKeychainKey')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemAuthenticationKeychainKey',
            ...
            "index": SystemAuthenticationKeychainKeyIndex.from_dict(obj["index"]) if obj.get("index") is not None else None,
            "algorithm": SystemAuthenticationKeychainKeyAlgorithm.from_dict(obj["algorithm"]) if obj.get("algorithm") is not None else None,
