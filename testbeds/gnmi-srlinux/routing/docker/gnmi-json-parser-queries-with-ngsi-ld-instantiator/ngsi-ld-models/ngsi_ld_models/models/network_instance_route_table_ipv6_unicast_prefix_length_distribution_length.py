...
class NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength.")
    ...
    prefix_length: Optional[NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength] = Field(default=None, alias="prefixLength")
    active_routes: Optional[NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes] = Field(default=None, alias="activeRoutes")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength']):
            raise ValueError("must be one of enum values ('NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLength',
            ...
            "prefixLength": NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthPrefixLength.from_dict(obj["prefixLength"]) if obj.get("prefixLength") is not None else None,
            "activeRoutes": NetworkInstanceRouteTableIpv6UnicastPrefixLengthDistributionLengthActiveRoutes.from_dict(obj["activeRoutes"]) if obj.get("activeRoutes") is not None else None,
