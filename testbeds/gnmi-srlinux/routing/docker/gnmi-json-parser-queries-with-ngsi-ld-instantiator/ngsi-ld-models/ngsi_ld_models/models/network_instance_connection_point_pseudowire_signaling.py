...
class NetworkInstanceConnectionPointPseudowireSignaling(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceConnectionPointPseudowireSignaling.")
    ...
    virtual_circuit_identifier: VirtualCircuitIdentifier = Field(alias="virtualCircuitIdentifier")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "virtualCircuitIdentifier", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceConnectionPointPseudowireSignaling']):
            raise ValueError("must be one of enum values ('NetworkInstanceConnectionPointPseudowireSignaling')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of virtual_circuit_identifier
        if self.virtual_circuit_identifier:
            _dict['virtualCircuitIdentifier'] = self.virtual_circuit_identifier.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceConnectionPointPseudowireSignaling',
            ...
            "virtualCircuitIdentifier": VirtualCircuitIdentifier.from_dict(obj["virtualCircuitIdentifier"]) if obj.get("virtualCircuitIdentifier") is not None else None,
