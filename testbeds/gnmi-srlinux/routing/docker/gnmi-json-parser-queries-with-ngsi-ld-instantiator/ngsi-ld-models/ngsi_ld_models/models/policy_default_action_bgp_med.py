...
class PolicyDefaultActionBgpMed(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyDefaultActionBgpMed.")
    ...
    value: Optional[PolicyDefaultActionBgpMedValue] = None
    operation: Optional[PolicyDefaultActionBgpMedOperation] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyDefaultActionBgpMed']):
            raise ValueError("must be one of enum values ('PolicyDefaultActionBgpMed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyDefaultActionBgpMed',
            ...
            "value": PolicyDefaultActionBgpMedValue.from_dict(obj["value"]) if obj.get("value") is not None else None,
            "operation": PolicyDefaultActionBgpMedOperation.from_dict(obj["operation"]) if obj.get("operation") is not None else None,
