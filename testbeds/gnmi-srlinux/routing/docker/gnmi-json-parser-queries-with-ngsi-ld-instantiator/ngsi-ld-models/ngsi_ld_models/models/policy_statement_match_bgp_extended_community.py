...
class PolicyStatementMatchBgpExtendedCommunity(BaseModel):
    """
     YANG module: srl_nokia-routing-policy.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be PolicyStatementMatchBgpExtendedCommunity.")
    ...
    extended_community_set: Optional[PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet] = Field(default=None, alias="extendedCommunitySet")
    match_set_options: Optional[PolicyStatementMatchBgpExtendedCommunityMatchSetOptions] = Field(default=None, alias="matchSetOptions")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "extendedCommunitySet", "matchSetOptions", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PolicyStatementMatchBgpExtendedCommunity']):
            raise ValueError("must be one of enum values ('PolicyStatementMatchBgpExtendedCommunity')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of extended_community_set
        if self.extended_community_set:
            _dict['extendedCommunitySet'] = self.extended_community_set.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'PolicyStatementMatchBgpExtendedCommunity',
            ...
            "extendedCommunitySet": PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet.from_dict(obj["extendedCommunitySet"]) if obj.get("extendedCommunitySet") is not None else None,
            "matchSetOptions": PolicyStatementMatchBgpExtendedCommunityMatchSetOptions.from_dict(obj["matchSetOptions"]) if obj.get("matchSetOptions") is not None else None,
