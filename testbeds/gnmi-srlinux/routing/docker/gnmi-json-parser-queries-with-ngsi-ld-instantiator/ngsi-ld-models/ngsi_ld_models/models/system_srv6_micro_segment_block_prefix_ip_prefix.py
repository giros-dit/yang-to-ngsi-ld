...
class SystemSrv6MicroSegmentBlockPrefixIpPrefix(BaseModel):
    """
    ...
    def value_validate_regular_expression(cls, value):
        ...
        if not re.match(r"[0:]+1?\/128|[fF][fF][0-9a-fA-F][0-9a-fA-F].*\/([89]|[1-9][0-9]+)", value):
            raise ValueError(r"must validate the regular expression /[0:]+1?\/128|[fF][fF][0-9a-fA-F][0-9a-fA-F].*\/([89]|[1-9][0-9]+)/")
        return value
