...
class PolicyStatementMatchBgpExtendedCommunityExtendedCommunitySet(BaseModel):
    """
    ...
    object: StrictStr = Field(description="Relationship with Entity type ExtendedCommunitySet.")
