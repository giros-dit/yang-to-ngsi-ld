...
class InterfaceEthernetSymbolMonitor(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetSymbolMonitor.")
    ...
    admin_state: Optional[InterfaceEthernetSymbolMonitorAdminState] = Field(default=None, alias="adminState")
    window_size: Optional[InterfaceEthernetSymbolMonitorWindowSize] = Field(default=None, alias="windowSize")
    current_alarms: Optional[InterfaceEthernetSymbolMonitorCurrentAlarms] = Field(default=None, alias="currentAlarms")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "adminState", "windowSize", "currentAlarms", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetSymbolMonitor']):
            raise ValueError("must be one of enum values ('InterfaceEthernetSymbolMonitor')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.window_size:
            _dict['windowSize'] = self.window_size.to_dict()
        # override the default output from pydantic by calling `to_dict()` of current_alarms
        if self.current_alarms:
            _dict['currentAlarms'] = self.current_alarms.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetSymbolMonitor',
            ...
            "adminState": InterfaceEthernetSymbolMonitorAdminState.from_dict(obj["adminState"]) if obj.get("adminState") is not None else None,
            "windowSize": InterfaceEthernetSymbolMonitorWindowSize.from_dict(obj["windowSize"]) if obj.get("windowSize") is not None else None,
            "currentAlarms": InterfaceEthernetSymbolMonitorCurrentAlarms.from_dict(obj["currentAlarms"]) if obj.get("currentAlarms") is not None else None,
