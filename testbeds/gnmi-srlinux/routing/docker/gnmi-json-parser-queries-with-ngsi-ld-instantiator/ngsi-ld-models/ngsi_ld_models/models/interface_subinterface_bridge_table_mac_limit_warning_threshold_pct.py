...
class InterfaceSubinterfaceBridgeTableMacLimitWarningThresholdPct(BaseModel):
    """
    ...
    value: Annotated[int, Field(le=100, strict=True, ge=6)]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": obj.get("value") if obj.get("value") is not None else 95,
