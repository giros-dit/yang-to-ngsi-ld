...
class NetworkInstanceProtocolsOspfInstanceAdvertiseRouterCapability(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['false', 'link', 'area', 'as']):
            raise ValueError("must be one of enum values ('false', 'link', 'area', 'as')")
        return value
