...
class NetworkInstanceProtocolsOspfInstanceGracefulRestart(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceProtocolsOspfInstanceGracefulRestart.")
    ...
    helper_mode: Optional[HelperMode] = Field(default=None, alias="helperMode")
    strict_lsa_checking: Optional[StrictLsaChecking] = Field(default=None, alias="strictLsaChecking")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "helperMode", "strictLsaChecking", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceProtocolsOspfInstanceGracefulRestart']):
            raise ValueError("must be one of enum values ('NetworkInstanceProtocolsOspfInstanceGracefulRestart')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of helper_mode
        if self.helper_mode:
            _dict['helperMode'] = self.helper_mode.to_dict()
        # override the default output from pydantic by calling `to_dict()` of strict_lsa_checking
        if self.strict_lsa_checking:
            _dict['strictLsaChecking'] = self.strict_lsa_checking.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceProtocolsOspfInstanceGracefulRestart',
            ...
            "helperMode": HelperMode.from_dict(obj["helperMode"]) if obj.get("helperMode") is not None else None,
            "strictLsaChecking": StrictLsaChecking.from_dict(obj["strictLsaChecking"]) if obj.get("strictLsaChecking") is not None else None,
