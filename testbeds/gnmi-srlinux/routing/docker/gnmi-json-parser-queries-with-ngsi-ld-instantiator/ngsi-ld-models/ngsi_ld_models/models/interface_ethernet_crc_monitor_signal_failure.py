...
class InterfaceEthernetCrcMonitorSignalFailure(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceEthernetCrcMonitorSignalFailure.")
    ...
    exponent: Optional[InterfaceEthernetCrcMonitorSignalFailureExponent] = None
    multiplier: Optional[InterfaceEthernetCrcMonitorSignalFailureMultiplier] = None
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['InterfaceEthernetCrcMonitorSignalFailure']):
            raise ValueError("must be one of enum values ('InterfaceEthernetCrcMonitorSignalFailure')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceEthernetCrcMonitorSignalFailure',
            ...
            "exponent": InterfaceEthernetCrcMonitorSignalFailureExponent.from_dict(obj["exponent"]) if obj.get("exponent") is not None else None,
            "multiplier": InterfaceEthernetCrcMonitorSignalFailureMultiplier.from_dict(obj["multiplier"]) if obj.get("multiplier") is not None else None,
