...
class SystemSrv6SourceAddress(BaseModel):
    """
    List of sourcess addresses  YANG module: srl_nokia-srv6.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6SourceAddress.")
    ...
    ip_address: Optional[SystemSrv6SourceAddressIpAddress] = Field(default=None, alias="ipAddress")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipAddress", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6SourceAddress']):
            raise ValueError("must be one of enum values ('SystemSrv6SourceAddress')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6SourceAddress',
            ...
            "ipAddress": SystemSrv6SourceAddressIpAddress.from_dict(obj["ipAddress"]) if obj.get("ipAddress") is not None else None,
