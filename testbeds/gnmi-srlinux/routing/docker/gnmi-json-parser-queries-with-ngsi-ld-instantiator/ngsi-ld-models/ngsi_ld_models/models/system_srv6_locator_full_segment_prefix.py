...
class SystemSrv6LocatorFullSegmentPrefix(BaseModel):
    """
    Enter the prefix context  YANG module: srl_nokia-srv6.yang 
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Entity id. ")
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be SystemSrv6LocatorFullSegmentPrefix.")
    ...
    ip_prefix: SystemSrv6LocatorFullSegmentPrefixIpPrefix = Field(alias="ipPrefix")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "ipPrefix", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['SystemSrv6LocatorFullSegmentPrefix']):
            raise ValueError("must be one of enum values ('SystemSrv6LocatorFullSegmentPrefix')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'SystemSrv6LocatorFullSegmentPrefix',
            ...
            "ipPrefix": SystemSrv6LocatorFullSegmentPrefixIpPrefix.from_dict(obj["ipPrefix"]) if obj.get("ipPrefix") is not None else None,
