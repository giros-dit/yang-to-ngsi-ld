...
class TestInErrorSegments(unittest.TestCase):
    """InErrorSegments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InErrorSegments:
        """Test InErrorSegments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InErrorSegments`
        """
        model = InErrorSegments()
        if include_optional:
            return InErrorSegments(
                type = 'Property',
                value = 56,
