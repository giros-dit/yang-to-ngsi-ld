...
class TestActiveOpens(unittest.TestCase):
    """ActiveOpens unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveOpens:
        """Test ActiveOpens
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActiveOpens`
        """
        model = ActiveOpens()
        if include_optional:
            return ActiveOpens(
