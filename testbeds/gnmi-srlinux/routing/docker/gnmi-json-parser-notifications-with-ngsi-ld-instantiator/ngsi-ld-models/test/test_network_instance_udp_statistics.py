...
class TestNetworkInstanceUdpStatistics(unittest.TestCase):
    """NetworkInstanceUdpStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpStatistics:
        """Test NetworkInstanceUdpStatistics
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpStatistics`
        """
        model = NetworkInstanceUdpStatistics()
        if include_optional:
            return NetworkInstanceUdpStatistics(
                id = '',
                type = 'NetworkInstanceUdpStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
                ...
                in_packets = None,
                in_no_open_ports_packets = None,
                in_error_packets = None,
                out_packets = None,
                receive_buffer_errors = None,
                send_buffer_errors = None,
                in_checksum_errors = None,
                ignored_multicast_packets = None,
                is_part_of = None
            )
        else:
            return NetworkInstanceUdpStatistics(
    ...
    def testNetworkInstanceUdpStatistics(self):
        """Test NetworkInstanceUdpStatistics"""
