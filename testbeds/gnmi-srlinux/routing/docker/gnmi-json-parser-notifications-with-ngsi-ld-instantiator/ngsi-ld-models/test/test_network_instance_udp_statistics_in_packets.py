...
class TestNetworkInstanceUdpStatisticsInPackets(unittest.TestCase):
    """NetworkInstanceUdpStatisticsInPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpStatisticsInPackets:
        """Test NetworkInstanceUdpStatisticsInPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpStatisticsInPackets`
        """
        model = NetworkInstanceUdpStatisticsInPackets()
        if include_optional:
            return NetworkInstanceUdpStatisticsInPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceUdpStatisticsInPackets(self):
        """Test NetworkInstanceUdpStatisticsInPackets"""
