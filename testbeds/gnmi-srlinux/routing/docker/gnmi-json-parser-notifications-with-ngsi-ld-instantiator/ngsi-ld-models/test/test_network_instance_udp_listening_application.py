...
class TestNetworkInstanceUdpListeningApplication(unittest.TestCase):
    """NetworkInstanceUdpListeningApplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpListeningApplication:
        """Test NetworkInstanceUdpListeningApplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpListeningApplication`
        """
        model = NetworkInstanceUdpListeningApplication()
        if include_optional:
            return NetworkInstanceUdpListeningApplication(
                id = '',
                type = 'NetworkInstanceUdpListeningApplication',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceUdpListeningApplication(self):
        """Test NetworkInstanceUdpListeningApplication"""
