...
class TestOutSegments(unittest.TestCase):
    """OutSegments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutSegments:
        """Test OutSegments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutSegments`
        """
        model = OutSegments()
        if include_optional:
            return OutSegments(
