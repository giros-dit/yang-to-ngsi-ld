...
class TestNetworkInstanceTcpConnectionLocalPort(unittest.TestCase):
    """NetworkInstanceTcpConnectionLocalPort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpConnectionLocalPort:
        """Test NetworkInstanceTcpConnectionLocalPort
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpConnectionLocalPort`
        """
        model = NetworkInstanceTcpConnectionLocalPort()
        if include_optional:
            return NetworkInstanceTcpConnectionLocalPort(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceTcpConnectionLocalPort(self):
        """Test NetworkInstanceTcpConnectionLocalPort"""
