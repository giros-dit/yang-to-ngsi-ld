...
class TestNetworkInstanceTcpConnection(unittest.TestCase):
    """NetworkInstanceTcpConnection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpConnection:
        """Test NetworkInstanceTcpConnection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpConnection`
        """
        model = NetworkInstanceTcpConnection()
        if include_optional:
            return NetworkInstanceTcpConnection(
                id = '',
                type = 'NetworkInstanceTcpConnection',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceTcpConnection(self):
        """Test NetworkInstanceTcpConnection"""
