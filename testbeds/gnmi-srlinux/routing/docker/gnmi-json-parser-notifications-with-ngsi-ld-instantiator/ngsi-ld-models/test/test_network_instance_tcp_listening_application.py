...
class TestNetworkInstanceTcpListeningApplication(unittest.TestCase):
    """NetworkInstanceTcpListeningApplication unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceTcpListeningApplication:
        """Test NetworkInstanceTcpListeningApplication
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceTcpListeningApplication`
        """
        model = NetworkInstanceTcpListeningApplication()
        if include_optional:
            return NetworkInstanceTcpListeningApplication(
                id = '',
                type = 'NetworkInstanceTcpListeningApplication',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testNetworkInstanceTcpListeningApplication(self):
        """Test NetworkInstanceTcpListeningApplication"""
