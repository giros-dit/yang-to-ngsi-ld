...
class TestNetworkInstanceUdpStatisticsInErrorPackets(unittest.TestCase):
    """NetworkInstanceUdpStatisticsInErrorPackets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NetworkInstanceUdpStatisticsInErrorPackets:
        """Test NetworkInstanceUdpStatisticsInErrorPackets
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NetworkInstanceUdpStatisticsInErrorPackets`
        """
        model = NetworkInstanceUdpStatisticsInErrorPackets()
        if include_optional:
            return NetworkInstanceUdpStatisticsInErrorPackets(
                type = 'Property',
                value = 56,
    ...
    def testNetworkInstanceUdpStatisticsInErrorPackets(self):
        """Test NetworkInstanceUdpStatisticsInErrorPackets"""
