...
class TestReceiveBufferErrors(unittest.TestCase):
    """ReceiveBufferErrors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReceiveBufferErrors:
        """Test ReceiveBufferErrors
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReceiveBufferErrors`
        """
        model = ReceiveBufferErrors()
        if include_optional:
    ...
    def testReceiveBufferErrors(self):
        """Test ReceiveBufferErrors"""
