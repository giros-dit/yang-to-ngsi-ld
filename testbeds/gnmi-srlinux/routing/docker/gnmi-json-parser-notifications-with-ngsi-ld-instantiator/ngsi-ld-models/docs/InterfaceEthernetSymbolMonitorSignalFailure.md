# InterfaceEthernetSymbolMonitorSignalFailure
...
interface_ethernet_symbol_monitor_signal_failure_from_dict = InterfaceEthernetSymbolMonitorSignalFailure.from_dict(interface_ethernet_symbol_monitor_signal_failure_dict)
```
