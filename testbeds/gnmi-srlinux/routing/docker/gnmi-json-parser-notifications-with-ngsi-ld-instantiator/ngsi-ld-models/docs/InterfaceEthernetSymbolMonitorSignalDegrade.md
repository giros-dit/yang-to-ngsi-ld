# InterfaceEthernetSymbolMonitorSignalDegrade
...
interface_ethernet_symbol_monitor_signal_degrade_from_dict = InterfaceEthernetSymbolMonitorSignalDegrade.from_dict(interface_ethernet_symbol_monitor_signal_degrade_dict)
```
