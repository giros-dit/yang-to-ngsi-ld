...
interface_ethernet_crc_monitor_signal_degrade_from_dict = InterfaceEthernetCrcMonitorSignalDegrade.from_dict(interface_ethernet_crc_monitor_signal_degrade_dict)
```
