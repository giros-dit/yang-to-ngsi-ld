...
**rising_threshold_action** | [**RisingThresholdAction**](RisingThresholdAction.md) |  | [optional] 
...
interface_ethernet_storm_control_from_dict = InterfaceEthernetStormControl.from_dict(interface_ethernet_storm_control_dict)
```
