...
Container for subinterface statistics, including all IPv4, IPv6 and MPLS packets belonging to a routed subinterface, or including just one of these protocols on a routed subinterface, or for all frames on a bridged subinterface  YANG module: srl_nokia-interfaces.yang 
...
interface_subinterface_ipv4_statistics_from_dict = InterfaceSubinterfaceIpv4Statistics.from_dict(interface_subinterface_ipv4_statistics_dict)
```
