# InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets

The number of packets which originated on the CPM and which the router attempted to forward out this subinterface  YANG module: srl_nokia-interfaces.yang 
...
interface_subinterface_ipv6_statistics_out_originated_packets_from_dict = InterfaceSubinterfaceIpv6StatisticsOutOriginatedPackets.from_dict(interface_subinterface_ipv6_statistics_out_originated_packets_dict)
```
