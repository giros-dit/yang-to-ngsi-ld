...
interface_subinterface_ipv6_statistics_in_discarded_packets_from_dict = InterfaceSubinterfaceIpv6StatisticsInDiscardedPackets.from_dict(interface_subinterface_ipv6_statistics_in_discarded_packets_dict)
```
