# InterfaceTransceiverTemperatureLatestValue
...
interface_transceiver_temperature_latest_value_from_dict = InterfaceTransceiverTemperatureLatestValue.from_dict(interface_transceiver_temperature_latest_value_dict)
```
