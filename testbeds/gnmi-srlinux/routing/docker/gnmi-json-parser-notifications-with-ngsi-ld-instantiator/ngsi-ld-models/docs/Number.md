...
Maximum number of routes or prefixes to be exported into IGP instance from route table  YANG module: srl_nokia-ospf.yang 
...
```python
from ngsi_ld_models.models.number import Number
