...
interface_subinterface_ipv4_statistics_in_packets_from_dict = InterfaceSubinterfaceIpv4StatisticsInPackets.from_dict(interface_subinterface_ipv4_statistics_in_packets_dict)
```
