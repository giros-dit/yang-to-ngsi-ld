...
Indicates the trigger of the last switchover  This field is not populated if the system has not performed a switchover since initial startup.  YANG module: srl_nokia-platform-control.yang 
...
```python
from ngsi_ld_models.models.trigger import Trigger
