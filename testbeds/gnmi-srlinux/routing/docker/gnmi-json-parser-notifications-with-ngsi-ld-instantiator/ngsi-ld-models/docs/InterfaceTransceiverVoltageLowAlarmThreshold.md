# InterfaceTransceiverVoltageLowAlarmThreshold
...
interface_transceiver_voltage_low_alarm_threshold_from_dict = InterfaceTransceiverVoltageLowAlarmThreshold.from_dict(interface_transceiver_voltage_low_alarm_threshold_dict)
```
