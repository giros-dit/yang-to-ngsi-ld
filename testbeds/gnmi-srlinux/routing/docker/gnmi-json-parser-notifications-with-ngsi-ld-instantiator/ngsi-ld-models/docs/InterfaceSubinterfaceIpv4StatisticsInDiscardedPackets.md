...
interface_subinterface_ipv4_statistics_in_discarded_packets_from_dict = InterfaceSubinterfaceIpv4StatisticsInDiscardedPackets.from_dict(interface_subinterface_ipv4_statistics_in_discarded_packets_dict)
```
