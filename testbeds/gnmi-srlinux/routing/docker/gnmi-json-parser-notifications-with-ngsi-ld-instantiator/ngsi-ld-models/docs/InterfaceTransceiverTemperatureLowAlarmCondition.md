# InterfaceTransceiverTemperatureLowAlarmCondition
...
interface_transceiver_temperature_low_alarm_condition_from_dict = InterfaceTransceiverTemperatureLowAlarmCondition.from_dict(interface_transceiver_temperature_low_alarm_condition_dict)
```
