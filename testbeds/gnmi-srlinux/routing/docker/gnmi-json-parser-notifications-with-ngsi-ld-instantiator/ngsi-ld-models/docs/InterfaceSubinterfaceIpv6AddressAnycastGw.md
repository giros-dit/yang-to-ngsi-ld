...
interface_subinterface_ipv6_address_anycast_gw_from_dict = InterfaceSubinterfaceIpv6AddressAnycastGw.from_dict(interface_subinterface_ipv6_address_anycast_gw_dict)
```
