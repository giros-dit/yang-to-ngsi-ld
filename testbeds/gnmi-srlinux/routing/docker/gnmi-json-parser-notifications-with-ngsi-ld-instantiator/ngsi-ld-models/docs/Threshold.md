...
Minimum number of up seamless-BFD sessions for up te-policy  YANG module: srl_nokia-protection-policies.yang 
...
```python
from ngsi_ld_models.models.threshold import Threshold
