# InterfaceTransceiverVoltageLatestValue
...
interface_transceiver_voltage_latest_value_from_dict = InterfaceTransceiverVoltageLatestValue.from_dict(interface_transceiver_voltage_latest_value_dict)
```
