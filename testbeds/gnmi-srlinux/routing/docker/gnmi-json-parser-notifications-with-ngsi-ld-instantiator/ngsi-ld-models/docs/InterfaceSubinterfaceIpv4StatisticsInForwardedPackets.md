...
interface_subinterface_ipv4_statistics_in_forwarded_packets_from_dict = InterfaceSubinterfaceIpv4StatisticsInForwardedPackets.from_dict(interface_subinterface_ipv4_statistics_in_forwarded_packets_dict)
```
