# InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets

The total number of packets, originating and transit, that should have been sent out this subinterface but were dropped  This includes IP packets dropped by egress interface ACL drop action.  YANG module: srl_nokia-interfaces.yang 
...
interface_subinterface_ipv6_statistics_out_discarded_packets_from_dict = InterfaceSubinterfaceIpv6StatisticsOutDiscardedPackets.from_dict(interface_subinterface_ipv6_statistics_out_discarded_packets_dict)
```
