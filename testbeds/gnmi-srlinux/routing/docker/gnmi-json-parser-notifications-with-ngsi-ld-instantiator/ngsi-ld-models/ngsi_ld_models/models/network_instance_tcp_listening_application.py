...
class NetworkInstanceTcpListeningApplication(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkInstanceTcpListeningApplication.")
    ...
    local_address: Optional[NetworkInstanceTcpListeningApplicationLocalAddress] = Field(default=None, alias="localAddress")
    local_port: Optional[NetworkInstanceTcpListeningApplicationLocalPort] = Field(default=None, alias="localPort")
    process_id: Optional[NetworkInstanceTcpListeningApplicationProcessId] = Field(default=None, alias="processId")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NetworkInstanceTcpListeningApplication']):
            raise ValueError("must be one of enum values ('NetworkInstanceTcpListeningApplication')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkInstanceTcpListeningApplication',
            ...
            "localAddress": NetworkInstanceTcpListeningApplicationLocalAddress.from_dict(obj["localAddress"]) if obj.get("localAddress") is not None else None,
            "localPort": NetworkInstanceTcpListeningApplicationLocalPort.from_dict(obj["localPort"]) if obj.get("localPort") is not None else None,
            "processId": NetworkInstanceTcpListeningApplicationProcessId.from_dict(obj["processId"]) if obj.get("processId") is not None else None,
