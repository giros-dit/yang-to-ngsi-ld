...
class NetworkNode(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkNode.")
    ...
    node_id: Optional[NodeId] = Field(default=None, alias="nodeId")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "nodeId", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NetworkNode'):
            raise ValueError("must be one of enum values ('NetworkNode')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkNode',
            ...
            "nodeId": NodeId.from_dict(obj["nodeId"]) if obj.get("nodeId") is not None else None,
