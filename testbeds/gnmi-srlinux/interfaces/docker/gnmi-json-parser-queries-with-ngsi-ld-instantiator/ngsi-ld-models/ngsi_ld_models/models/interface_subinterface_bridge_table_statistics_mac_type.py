...
class InterfaceSubinterfaceBridgeTableStatisticsMacType(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceBridgeTableStatisticsMacType.")
    ...
    mactype_type: Optional[InterfaceSubinterfaceBridgeTableStatisticsMacTypeType] = Field(default=None, alias="mactypeType")
    active_entries: Optional[InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries] = Field(default=None, alias="activeEntries")
    total_entries: Optional[InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries] = Field(default=None, alias="totalEntries")
    failed_entries: Optional[InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries] = Field(default=None, alias="failedEntries")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "mactypeType", "activeEntries", "totalEntries", "failedEntries", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfaceBridgeTableStatisticsMacType'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceBridgeTableStatisticsMacType')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of mactype_type
        if self.mactype_type:
            _dict['mactypeType'] = self.mactype_type.to_dict()
        # override the default output from pydantic by calling `to_dict()` of active_entries
        if self.active_entries:
            _dict['activeEntries'] = self.active_entries.to_dict()
        # override the default output from pydantic by calling `to_dict()` of total_entries
        if self.total_entries:
            _dict['totalEntries'] = self.total_entries.to_dict()
        # override the default output from pydantic by calling `to_dict()` of failed_entries
        if self.failed_entries:
            _dict['failedEntries'] = self.failed_entries.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceBridgeTableStatisticsMacType',
            ...
            "mactypeType": InterfaceSubinterfaceBridgeTableStatisticsMacTypeType.from_dict(obj["mactypeType"]) if obj.get("mactypeType") is not None else None,
            "activeEntries": InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries.from_dict(obj["activeEntries"]) if obj.get("activeEntries") is not None else None,
            "totalEntries": InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries.from_dict(obj["totalEntries"]) if obj.get("totalEntries") is not None else None,
            "failedEntries": InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries.from_dict(obj["failedEntries"]) if obj.get("failedEntries") is not None else None,
