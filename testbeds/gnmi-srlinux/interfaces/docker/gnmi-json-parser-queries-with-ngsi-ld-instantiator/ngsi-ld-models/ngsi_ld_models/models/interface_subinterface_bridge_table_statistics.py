...
class InterfaceSubinterfaceBridgeTableStatistics(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be InterfaceSubinterfaceBridgeTableStatistics.")
    ...
    active_entries: Optional[InterfaceSubinterfaceBridgeTableStatisticsActiveEntries] = Field(default=None, alias="activeEntries")
    total_entries: Optional[InterfaceSubinterfaceBridgeTableStatisticsTotalEntries] = Field(default=None, alias="totalEntries")
    failed_entries: Optional[InterfaceSubinterfaceBridgeTableStatisticsFailedEntries] = Field(default=None, alias="failedEntries")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "activeEntries", "totalEntries", "failedEntries", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfaceBridgeTableStatistics'):
            raise ValueError("must be one of enum values ('InterfaceSubinterfaceBridgeTableStatistics')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'InterfaceSubinterfaceBridgeTableStatistics',
            ...
            "activeEntries": InterfaceSubinterfaceBridgeTableStatisticsActiveEntries.from_dict(obj["activeEntries"]) if obj.get("activeEntries") is not None else None,
            "totalEntries": InterfaceSubinterfaceBridgeTableStatisticsTotalEntries.from_dict(obj["totalEntries"]) if obj.get("totalEntries") is not None else None,
            "failedEntries": InterfaceSubinterfaceBridgeTableStatisticsFailedEntries.from_dict(obj["failedEntries"]) if obj.get("failedEntries") is not None else None,
