...
class InterfaceSubinterfaceIpv6AddressType(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('global-unicast', 'link-local-unicast'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceSubinterfaceIpv6AddressType) in the input: " + _key)
