...
class TestInterfaceSubinterfaceBridgeTableStatisticsTotalEntries(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableStatisticsTotalEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableStatisticsTotalEntries:
        """Test InterfaceSubinterfaceBridgeTableStatisticsTotalEntries
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableStatisticsTotalEntries`
        """
        model = InterfaceSubinterfaceBridgeTableStatisticsTotalEntries()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableStatisticsTotalEntries(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceBridgeTableStatisticsTotalEntries(self):
        """Test InterfaceSubinterfaceBridgeTableStatisticsTotalEntries"""
