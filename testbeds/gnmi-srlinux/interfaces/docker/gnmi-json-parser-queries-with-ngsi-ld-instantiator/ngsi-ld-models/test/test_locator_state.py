...
class TestLocatorState(unittest.TestCase):
    """LocatorState unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LocatorState:
        """Test LocatorState
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LocatorState`
        """
        model = LocatorState()
        if include_optional:
            return LocatorState(
