...
class TestRebootingAt(unittest.TestCase):
    """RebootingAt unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RebootingAt:
        """Test RebootingAt
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RebootingAt`
        """
        model = RebootingAt()
        if include_optional:
            return RebootingAt(
