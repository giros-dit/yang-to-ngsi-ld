...
class TestDiscardUnknownSrcMac(unittest.TestCase):
    """DiscardUnknownSrcMac unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiscardUnknownSrcMac:
        """Test DiscardUnknownSrcMac
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiscardUnknownSrcMac`
        """
        model = DiscardUnknownSrcMac()
        if include_optional:
            return DiscardUnknownSrcMac(
                type = 'Property',
                value = True,
    ...
    def testDiscardUnknownSrcMac(self):
        """Test DiscardUnknownSrcMac"""
