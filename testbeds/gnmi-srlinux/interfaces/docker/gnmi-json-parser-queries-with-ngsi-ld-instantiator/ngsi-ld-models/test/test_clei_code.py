...
class TestCleiCode(unittest.TestCase):
    """CleiCode unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CleiCode:
        """Test CleiCode
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CleiCode`
        """
        model = CleiCode()
        if include_optional:
            return CleiCode(
