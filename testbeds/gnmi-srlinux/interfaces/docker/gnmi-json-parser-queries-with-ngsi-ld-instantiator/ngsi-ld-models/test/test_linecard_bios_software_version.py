...
class TestLinecardBiosSoftwareVersion(unittest.TestCase):
    """LinecardBiosSoftwareVersion unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LinecardBiosSoftwareVersion:
        """Test LinecardBiosSoftwareVersion
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LinecardBiosSoftwareVersion`
        """
        model = LinecardBiosSoftwareVersion()
        if include_optional:
            return LinecardBiosSoftwareVersion(
                type = 'Property',
                value = '',
    ...
    def testLinecardBiosSoftwareVersion(self):
        """Test LinecardBiosSoftwareVersion"""
