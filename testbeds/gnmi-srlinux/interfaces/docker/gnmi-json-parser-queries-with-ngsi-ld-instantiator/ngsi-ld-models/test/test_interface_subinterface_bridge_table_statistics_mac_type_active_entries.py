...
class TestInterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries:
        """Test InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries`
        """
        model = InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries(self):
        """Test InterfaceSubinterfaceBridgeTableStatisticsMacTypeActiveEntries"""
