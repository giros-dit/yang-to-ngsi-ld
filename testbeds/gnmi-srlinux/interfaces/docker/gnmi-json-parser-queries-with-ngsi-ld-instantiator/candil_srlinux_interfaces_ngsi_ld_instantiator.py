...
from candil_srlinux_interfaces_json_parser_queries import parse_gnmi_query
...
print("First, I will process YANG Identities within SR Linux YANG modules and generates the data structures of their corresponding NGSI-LD Entities to be published.")
...
while True:
    for message in consumer:
        ...
        event_time, dict_buffers = parse_gnmi_query(message)
