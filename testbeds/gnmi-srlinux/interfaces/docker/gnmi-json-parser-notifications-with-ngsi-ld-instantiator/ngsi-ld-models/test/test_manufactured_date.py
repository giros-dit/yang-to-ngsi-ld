...
class TestManufacturedDate(unittest.TestCase):
    """ManufacturedDate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManufacturedDate:
        """Test ManufacturedDate
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManufacturedDate`
        """
        model = ManufacturedDate()
        if include_optional:
