...
class LinecardTemperature(BaseModel):
    ...
    alarm_status: Optional[AlarmStatus] = Field(default=None, alias="alarmStatus")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('LinecardTemperature'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "instant": Instant.from_dict(obj["instant"]) if obj.get("instant") is not None else None,
            ...
            "alarmStatus": AlarmStatus.from_dict(obj["alarmStatus"]) if obj.get("alarmStatus") is not None else None,
