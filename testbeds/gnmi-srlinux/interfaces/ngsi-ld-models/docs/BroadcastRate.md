...
The maximum rate allowed for ingress broadcast frames on the interface  YANG module: srl_nokia-interfaces.yang 
...
broadcast_rate_form_dict = broadcast_rate.from_dict(broadcast_rate_dict)
```
