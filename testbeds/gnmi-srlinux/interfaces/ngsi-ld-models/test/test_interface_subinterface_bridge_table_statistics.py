...
class TestInterfaceSubinterfaceBridgeTableStatistics(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableStatistics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableStatistics:
        """Test InterfaceSubinterfaceBridgeTableStatistics
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableStatistics`
        """
        model = InterfaceSubinterfaceBridgeTableStatistics()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableStatistics(
                id = '',
                type = 'InterfaceSubinterfaceBridgeTableStatistics',
                scope = None,
                location = {
                    'key' : null
                    },
    ...
    def testInterfaceSubinterfaceBridgeTableStatistics(self):
        """Test InterfaceSubinterfaceBridgeTableStatistics"""
