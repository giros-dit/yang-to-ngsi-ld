...
class TestMaximumEntries(unittest.TestCase):
    """MaximumEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MaximumEntries:
        """Test MaximumEntries
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MaximumEntries`
        """
        model = MaximumEntries()
        if include_optional:
