...
class TestInterfaces(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Interfaces:
        """Test Interfaces
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Interfaces`
        """
        model = Interfaces()
        if include_optional:
            return Interfaces(
                type = 'Property',
                value = 'vhn-UR,rZ#UM/?R,Fp^l6$ARjbhJk C>',
