...
class TestInterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries:
        """Test InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries`
        """
        model = InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries(self):
        """Test InterfaceSubinterfaceBridgeTableStatisticsMacTypeFailedEntries"""
