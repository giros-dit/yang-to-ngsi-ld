...
class TestWarningThresholdPct(unittest.TestCase):
    """WarningThresholdPct unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WarningThresholdPct:
        """Test WarningThresholdPct
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WarningThresholdPct`
        """
        model = WarningThresholdPct()
        if include_optional:
    ...
    def testWarningThresholdPct(self):
        """Test WarningThresholdPct"""
