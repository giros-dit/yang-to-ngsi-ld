...
class InterfaceSubinterfaceBridgeTable(BaseModel):
    ...
    discard_unknown_src_mac: Optional[DiscardUnknownSrcMac] = Field(default=None, alias="discardUnknownSrcMac")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfaceBridgeTable'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "discardUnknownSrcMac": DiscardUnknownSrcMac.from_dict(obj["discardUnknownSrcMac"]) if obj.get("discardUnknownSrcMac") is not None else None,
