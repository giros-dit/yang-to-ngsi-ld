...
class FormFactor(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('CFP2', 'CFP2-ACO', 'CFP4', 'QSFP', 'QSFPplus', 'QSFP28', 'QSFPDD', 'SFP', 'SFPplus', 'Non-pluggable', 'Other', 'SFP28', 'SFPDD', 'QSFP56', 'SFP56'):
            raise ValueError("must be one of enum values ('CFP2', 'CFP2-ACO', 'CFP4', 'QSFP', 'QSFPplus', 'QSFP28', 'QSFPDD', 'SFP', 'SFPplus', 'Non-pluggable', 'Other', 'SFP28', 'SFPDD', 'QSFP56', 'SFP56')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in FormFactor) in the input: " + _key)
