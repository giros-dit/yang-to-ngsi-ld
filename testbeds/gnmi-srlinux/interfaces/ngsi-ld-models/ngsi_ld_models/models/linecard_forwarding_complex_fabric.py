...
class LinecardForwardingComplexFabric(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "availability", "utilizationIngress", "utilizationEgress", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('LinecardForwardingComplexFabric'):
