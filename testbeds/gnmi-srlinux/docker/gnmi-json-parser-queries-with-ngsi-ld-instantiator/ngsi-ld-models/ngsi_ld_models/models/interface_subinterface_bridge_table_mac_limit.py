...
class InterfaceSubinterfaceBridgeTableMacLimit(BaseModel):
    ...
    maximum_entries: Optional[MaximumEntries] = Field(default=None, alias="maximumEntries")
    warning_threshold_pct: Optional[WarningThresholdPct] = Field(default=None, alias="warningThresholdPct")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('InterfaceSubinterfaceBridgeTableMacLimit'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maximumEntries": MaximumEntries.from_dict(obj["maximumEntries"]) if obj.get("maximumEntries") is not None else None,
            "warningThresholdPct": WarningThresholdPct.from_dict(obj["warningThresholdPct"]) if obj.get("warningThresholdPct") is not None else None,
