...
class InterfaceSubinterfaceOperDownReason(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('admin-disabled', 'port-down', 'ip-mtu-resource-exceeded', 'mpls-mtu-resource-exceeded', 'ip-mtu-too-large', 'mpls-mtu-too-large', 'l2-mtu-too-large', 'no-ip-config', 'ip-mtu-larger-than-oper-mac-vrf-mtu', 'irb-mac-address-not-programmed', 'missing-xdp-state', 'no-underlay-egress-next-hop-resources', 'cfm-ccm-defect', 'other'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceSubinterfaceOperDownReason) in the input: " + _key)
