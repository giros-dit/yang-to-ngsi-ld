...
class LinecardBios(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be LinecardBios.")
    ...
    software_version: Optional[LinecardBiosSoftwareVersion] = Field(default=None, alias="softwareVersion")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "manufacturer", "softwareVersion", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('LinecardBios'):
            raise ValueError("must be one of enum values ('LinecardBios')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'LinecardBios',
            ...
            "softwareVersion": LinecardBiosSoftwareVersion.from_dict(obj["softwareVersion"]) if obj.get("softwareVersion") is not None else None,
