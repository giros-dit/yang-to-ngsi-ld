...
class InterfaceSubinterfaceBridgeTableStatisticsMacTypeType(BaseModel):
    """
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('static', 'duplicate', 'learnt', 'irb-interface', 'evpn', 'evpn-static', 'irb-interface-anycast', 'proxy-anti-spoof', 'reserved', 'eth-cfm'):
            raise ValueError("must be one of enum values ('static', 'duplicate', 'learnt', 'irb-interface', 'evpn', 'evpn-static', 'irb-interface-anycast', 'proxy-anti-spoof', 'reserved', 'eth-cfm')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceSubinterfaceBridgeTableStatisticsMacTypeType) in the input: " + _key)
