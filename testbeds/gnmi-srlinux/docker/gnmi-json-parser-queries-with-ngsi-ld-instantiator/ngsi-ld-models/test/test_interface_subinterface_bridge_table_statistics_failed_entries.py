...
class TestInterfaceSubinterfaceBridgeTableStatisticsFailedEntries(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableStatisticsFailedEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableStatisticsFailedEntries:
        """Test InterfaceSubinterfaceBridgeTableStatisticsFailedEntries
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableStatisticsFailedEntries`
        """
        model = InterfaceSubinterfaceBridgeTableStatisticsFailedEntries()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableStatisticsFailedEntries(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceBridgeTableStatisticsFailedEntries(self):
        """Test InterfaceSubinterfaceBridgeTableStatisticsFailedEntries"""
