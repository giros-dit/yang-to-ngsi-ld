...
Details the percentage bandwidth available to the fabric for the line card  YANG module: srl_nokia-platform-lc.yang 
...
```python
from ngsi_ld_models.models.availability import Availability
