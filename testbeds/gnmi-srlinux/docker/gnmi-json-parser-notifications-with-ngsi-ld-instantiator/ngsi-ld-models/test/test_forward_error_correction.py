...
class TestForwardErrorCorrection(unittest.TestCase):
    """ForwardErrorCorrection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForwardErrorCorrection:
        """Test ForwardErrorCorrection
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForwardErrorCorrection`
        """
        model = ForwardErrorCorrection()
        if include_optional:
