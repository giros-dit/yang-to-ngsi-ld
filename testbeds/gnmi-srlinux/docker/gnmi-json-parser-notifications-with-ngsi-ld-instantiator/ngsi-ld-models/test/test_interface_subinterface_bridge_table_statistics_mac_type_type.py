...
class TestInterfaceSubinterfaceBridgeTableStatisticsMacTypeType(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableStatisticsMacTypeType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableStatisticsMacTypeType:
        """Test InterfaceSubinterfaceBridgeTableStatisticsMacTypeType
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableStatisticsMacTypeType`
        """
        model = InterfaceSubinterfaceBridgeTableStatisticsMacTypeType()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableStatisticsMacTypeType(
                type = 'Property',
                value = 'static',
    ...
    def testInterfaceSubinterfaceBridgeTableStatisticsMacTypeType(self):
        """Test InterfaceSubinterfaceBridgeTableStatisticsMacTypeType"""
