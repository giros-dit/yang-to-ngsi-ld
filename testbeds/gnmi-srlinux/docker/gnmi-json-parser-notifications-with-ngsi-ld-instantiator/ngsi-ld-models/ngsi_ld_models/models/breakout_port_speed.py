...
class BreakoutPortSpeed(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('10G', '25G', '50G', '100G', '200G'):
            raise ValueError("must be one of enum values ('10G', '25G', '50G', '100G', '200G')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in BreakoutPortSpeed) in the input: " + _key)
