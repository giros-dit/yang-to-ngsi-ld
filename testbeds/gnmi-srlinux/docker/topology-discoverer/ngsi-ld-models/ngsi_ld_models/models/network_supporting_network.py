...
class NetworkSupportingNetwork(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkSupportingNetwork.")
    ...
    network_ref: Optional[NetworkSupportingNetworkNetworkRef] = Field(default=None, alias="networkRef")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NetworkSupportingNetwork'):
            raise ValueError("must be one of enum values ('NetworkSupportingNetwork')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkSupportingNetwork',
            ...
            "networkRef": NetworkSupportingNetworkNetworkRef.from_dict(obj["networkRef"]) if obj.get("networkRef") is not None else None,
