...
class NetworkNodeSupportingNode(BaseModel):
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkNodeSupportingNode.")
    ...
    network_ref: Optional[NetworkNodeSupportingNodeNetworkRef] = Field(default=None, alias="networkRef")
    node_ref: Optional[NetworkNodeSupportingNodeNodeRef] = Field(default=None, alias="nodeRef")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "networkRef": NetworkNodeSupportingNodeNetworkRef.from_dict(obj["networkRef"]) if obj.get("networkRef") is not None else None,
            "nodeRef": NetworkNodeSupportingNodeNodeRef.from_dict(obj["nodeRef"]) if obj.get("nodeRef") is not None else None,
