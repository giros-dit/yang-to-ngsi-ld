...
class NetworkLinkSource(BaseModel):
    """
    ...
    type: StrictStr = Field(description="NGSI-LD Entity identifier. It has to be NetworkLinkSource.")
    ...
    source_node: Optional[SourceNode] = Field(default=None, alias="sourceNode")
    source_tp: Optional[SourceTp] = Field(default=None, alias="sourceTp")
    is_part_of: IsPartOf = Field(alias="isPartOf")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "type", "scope", "location", "observationSpace", "operationSpace", "createdAt", "modifiedAt", "deletedAt", "sourceNode", "sourceTp", "isPartOf"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('NetworkLinkSource'):
            raise ValueError("must be one of enum values ('NetworkLinkSource')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.source_node:
            _dict['sourceNode'] = self.source_node.to_dict()
        # override the default output from pydantic by calling `to_dict()` of source_tp
        if self.source_tp:
            _dict['sourceTp'] = self.source_tp.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "type": obj.get("type") if obj.get("type") is not None else 'NetworkLinkSource',
            ...
            "sourceNode": SourceNode.from_dict(obj["sourceNode"]) if obj.get("sourceNode") is not None else None,
            "sourceTp": SourceTp.from_dict(obj["sourceTp"]) if obj.get("sourceTp") is not None else None,
