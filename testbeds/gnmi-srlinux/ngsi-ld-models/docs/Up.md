...
```python
from ngsi_ld_models.models.up import Up

# TODO update the JSON string below
json = "{}"
# create an instance of Up from a JSON string
up_instance = Up.from_json(json)
# print the JSON string representation of the object
print Up.to_json()

# convert the object into a dict
up_dict = up_instance.to_dict()
# create an instance of Up from a dict
up_form_dict = up.from_dict(up_dict)
```
