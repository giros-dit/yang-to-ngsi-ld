...
The reason the component transitioned to a failed state  Field is empty if the component is not currently in a failure state  YANG module: srl_nokia-platform-lc.yang 
