...
class TestStandbySignaling(unittest.TestCase):
    """StandbySignaling unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StandbySignaling:
        """Test StandbySignaling
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StandbySignaling`
        """
        model = StandbySignaling()
        if include_optional:
            return StandbySignaling(
                type = 'Property',
                value = 'power-off',
