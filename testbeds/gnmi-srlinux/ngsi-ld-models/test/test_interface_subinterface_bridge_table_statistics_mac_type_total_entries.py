...
class TestInterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries(unittest.TestCase):
    """InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries:
        """Test InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries`
        """
        model = InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries()
        if include_optional:
            return InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries(
                type = 'Property',
                value = 56,
    ...
    def testInterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries(self):
        """Test InterfaceSubinterfaceBridgeTableStatisticsMacTypeTotalEntries"""
