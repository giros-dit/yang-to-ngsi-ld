...
class LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('LinecardForwardingComplexPipelinePipelineCountersHostInterfaceBlockPacketExtractionExtractionReason'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reason": Reason.from_dict(obj["reason"]) if obj.get("reason") is not None else None,
