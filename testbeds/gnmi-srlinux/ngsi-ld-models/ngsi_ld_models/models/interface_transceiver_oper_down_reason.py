...
class InterfaceTransceiverOperDownReason(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('not-present', 'read-failure', 'checksum-failure', 'unknown-transceiver', 'tx-laser-disabled', 'unsupported-breakout', 'port-disabled', 'connector-transceiver-down'):
            raise ValueError("must be one of enum values ('not-present', 'read-failure', 'checksum-failure', 'unknown-transceiver', 'tx-laser-disabled', 'unsupported-breakout', 'port-disabled', 'connector-transceiver-down')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in InterfaceTransceiverOperDownReason) in the input: " + _key)
