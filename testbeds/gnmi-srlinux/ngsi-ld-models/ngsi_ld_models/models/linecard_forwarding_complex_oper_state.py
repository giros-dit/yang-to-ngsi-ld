...
class LinecardForwardingComplexOperState(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('up', 'down', 'empty', 'downloading', 'booting', 'starting', 'failed', 'synchronizing', 'upgrading', 'low-power', 'degraded', 'warm-reboot', 'waiting'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in LinecardForwardingComplexOperState) in the input: " + _key)
