...
class LinecardPower(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allocated": Allocated.from_dict(obj["allocated"]) if obj.get("allocated") is not None else None,
            "used": Used.from_dict(obj["used"]) if obj.get("used") is not None else None,
            "required": Required.from_dict(obj["required"]) if obj.get("required") is not None else None,
