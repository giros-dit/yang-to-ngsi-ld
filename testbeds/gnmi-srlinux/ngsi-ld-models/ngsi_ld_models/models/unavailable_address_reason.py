...
class UnavailableAddressReason(BaseModel):
    ...
    def value_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('not-same-network-instance', 'referenced-interface-is-down', 'referenced-interface-ipv4-is-down', 'referenced-interface-has-no-ipv4-addresses'):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        for _key in obj.keys():
            if _key not in cls.__properties:
                raise ValueError("Error due to additional fields (not defined in UnavailableAddressReason) in the input: " + _key)
